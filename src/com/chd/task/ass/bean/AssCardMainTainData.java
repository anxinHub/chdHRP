 ...
 * @Version: 1.0
 */
@Table("ass_card_maintain_mobile")
@PK({ "ass_card_no", "create_date","create_emp","dept_id" })
public class AssCardMainTainData {
	...
	@Column("maintain_hours")
	@ColDefine(notNull = true)
	private int maintain_hours;
	
	@Column("maintain_money")
	@ColDefine(notNull = true)
	private int maintain_money;
	
	@Column("maintain_unit")
	@ColDefine(notNull = true)
	private int maintain_unit;
	...
	/**
	 * @return the maintain_hours
	 */
	public int getMaintain_hours() {
		return maintain_hours;
	}

	/**
	 * @param maintain_hours the maintain_hours to set
	 */
	public void setMaintain_hours(int maintain_hours) {
		this.maintain_hours = maintain_hours;
	}

	/**
	 * @return the maintain_money
	 */
	public int getMaintain_money() {
		return maintain_money;
	}

	/**
	 * @param maintain_money the maintain_money to set
	 */
	public void setMaintain_money(int maintain_money) {
		this.maintain_money = maintain_money;
	}

	/**
	 * @return the maintain_unit
	 */
	public int getMaintain_unit() {
		return maintain_unit;
	}

	/**
	 * @param maintain_unit the maintain_unit to set
	 */
	public void setMaintain_unit(int maintain_unit) {
