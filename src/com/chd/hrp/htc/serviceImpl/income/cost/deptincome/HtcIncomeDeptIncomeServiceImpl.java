...
package com.chd.hrp.htc.serviceImpl.income.cost.deptincome;
...
import com.chd.hrp.htc.dao.income.cost.deptincome.HtcIncomeDeptIncomeMapper;
...
@Service("htcIncomeDeptIncomeService")
public class HtcIncomeDeptIncomeServiceImpl implements HtcIncomeDeptIncomeService {

	private static Logger logger = Logger.getLogger(HtcIncomeDeptIncomeServiceImpl.class);
	
	@Resource(name = "htcIncomeDeptIncomeMapper")
	private final HtcIncomeDeptIncomeMapper htcIncomeDeptIncomeMapper = null;
	...
	public String addHtcIncomeDeptIncome(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			htcIncomeDeptIncomeMapper.addHtcIncomeDeptIncome(entityMap);
	...
	public String queryHtcIncomeDeptIncome(Map<String,Object> entityMap) throws DataAccessException{
		...
		if(sysPage.getTotal() == -1){
			...
			List<HtcIncomeDeptIncome> list = htcIncomeDeptIncomeMapper.queryHtcIncomeDeptIncome(entityMap);
			...
			List<HtcIncomeDeptIncome> list = htcIncomeDeptIncomeMapper.queryHtcIncomeDeptIncome(entityMap, rowBounds);
	...
	public HtcIncomeDeptIncome queryHtcIncomeDeptIncomeByCode(Map<String,Object> entityMap)throws DataAccessException{
		return htcIncomeDeptIncomeMapper.queryHtcIncomeDeptIncomeByCode(entityMap);
	}
	...
	try {
		   htcIncomeDeptIncomeMapper.updateHtcIncomeDeptIncome(entityMap);
	...
	@Override
	public String deleteHtcIncomeDeptIncome(Map<String, Object> entityMap)
			throws DataAccessException {
		// TODO Auto-generated method stub
		try {
			   htcIncomeDeptIncomeMapper.deleteHtcIncomeDeptIncome(entityMap);
	...
	@Override
	public String deleteBatchHtcIncomeDeptIncome(List<Map<String, Object>> list)
			throws DataAccessException {
		// TODO Auto-generated method stub
			try {
				   htcIncomeDeptIncomeMapper.deleteBatchHtcIncomeDeptIncome(list);
	...
	@Override
	public String impHtcIncomeDeptIncome(Map<String, Object> entityMap)
			throws DataAccessException {
		// TODO Auto-generated method stub
		...
		try {
			...
			for (Map<String, List<String>> map : list) {
			   ...
			   if(resultSet.size() > 0 ){
				   ...
				   htcIncomeDeptIncomeMapper.addBatchHtcIncomeDeptIncome(resultSet);
			   }
