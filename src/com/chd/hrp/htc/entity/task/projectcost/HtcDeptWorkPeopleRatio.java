...
public class HtcDeptWorkPeopleRatio implements Serializable {
	...
	public void setOper_percent(double oper_percent) {
		this.oper_percent = oper_percent;
	}
}