...
public interface SupTypeMapper extends SqlMapper{
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<SupType> querySupType(Map<String,Object> entityMap) throws DataAccessException;
	...
	*/
	...
	/**
	 * 用于集团化管理   集团供应商类型
	 * @Description 查询GroupSupType分页
	 * @param  entityMap RowBounds
	 * @return List<SupType>
	 * @throws DataAccessException
	*/
	public List<SupType> queryGroupSupType(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;

	/**
	 *  用于集团化管理   集团供应商类型
	 * @Description 查询GroupSupType所有数据
	 * @param  entityMap
	 * @return List<SupType>
	 * @throws DataAccessException
	*/
	public List<SupType> queryGroupSupType(Map<String,Object> entityMap) throws DataAccessException;
