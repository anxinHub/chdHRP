...
public interface FacDictMapper extends SqlMapper{
	...
	*/
	...
	public List<FacDict> queryFacDictList(Map<String, Object> paramMap) throws DataAccessException;

	public List<FacDict> queryFacDictList(Map<String, Object> paramMap, RowBounds rowBounds) throws DataAccessException;
}
