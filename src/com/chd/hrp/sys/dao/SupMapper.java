...
public interface SupMapper extends SqlMapper{
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<Sup> querySup(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<Sup> querySup(Map<String,Object> entityMap) throws DataAccessException;
	...
	*/
	...
	public Sup  querySupMaxTypeCode(Map<String, Object> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	String querySupMaxCodeNext(Map<String, Object> entityMap) throws DataAccessException;
	
	
	
	public Sup  querySupMaxCode(Map<String, Object> entityMap)throws DataAccessException;
	
	
	public Sup  querySupMaxTypePy(Map<String, Object> entityMap)throws DataAccessException;
	/**
	 * 添加、修改供应商 时 查询  与输入供应商编码或供应商名称相同的 供应商记录（ 判断输入供应商编码、供应商名称是否已存在）
	 * @param entityMap
	 * @return
	 */
	public List<Sup> querySupById(Map<String, Object> entityMap)throws DataAccessException;
	/**
	...
	public int existsGroupSupByAdd(Map<String, Object> entityMap);
	public int existsHosIdByCode(Map<String, Object> entityMap);
	public int addBatchGroupSupByCode(Map<String, Object> entityMap);
	
	public Integer queryNextMaxSupCode(Map<String, Object> entityMap) throws DataAccessException;
}
