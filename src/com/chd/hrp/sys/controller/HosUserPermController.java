...
@Controller
public class HosUserPermController extends BaseController{
	private static Logger logger = Logger.getLogger(HosUserPermController.class);
	...
	// 维护页面跳转
	@RequestMapping(value = "/hrp/sys/hosuserperm/hosUserPermMainPage", method = RequestMethod.GET)
	public String userPermMainPage(Model mode) throws Exception {

		return "hrp/sys/hosuserperm/userPermMain";

	}

	// 添加页面
	@RequestMapping(value = "/hrp/sys/hosuserperm/hosUserPermAddPage", method = RequestMethod.GET)
	public String userPermAddPage(Model mode) throws Exception {

		return "hrp/sys/hosuserperm/userPermAdd";

	}

	// 保存
	@RequestMapping(value = "/hrp/sys/hosuserperm/addHosUserPerm", method = RequestMethod.POST)
	@ResponseBody
	...
	// 查询
	@RequestMapping(value = "/hrp/sys/hosuserperm/queryHosUserPerm", method = RequestMethod.POST)
	@ResponseBody
	...
	//删除
	@RequestMapping(value = "/hrp/sys/hosuserperm/deleteHosUserPerm", method = RequestMethod.POST)
	@ResponseBody
	...
	// 修改页面跳转
	@RequestMapping(value = "/hrp/sys/hosuserperm/hosUserPermUpdatePage", method = RequestMethod.GET)
	...
	public String userPermUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/sys/hosuserperm/userPermUpdate";
	}
		
	// 修改保存
	@RequestMapping(value = "/hrp/sys/hosuserperm/updateHosUserPerm", method = RequestMethod.POST)
	@ResponseBody
	...
	// 导入
	@RequestMapping(value = "/hrp/sys/hosuserperm/importHosUserPerm", method = RequestMethod.POST)
	@ResponseBody
	...
	// 查询权限菜单
		@RequestMapping(value = "/hrp/sys/hosuserperm/queryHosUserPermByMenu", method = RequestMethod.POST)
		@ResponseBody
