...
import com.chd.hrp.sys.dao.baseData.SysAccCheckItemTypeMapper;
...
@Service("sysAccCheckItemTypeService")
public class SysAccCheckItemTypeServiceImpl implements SysAccCheckItemTypeService {

	private static Logger logger = Logger.getLogger(SysAccCheckItemTypeServiceImpl.class);
	
	@Resource(name = "sysAccCheckItemTypeMapper")
	private final SysAccCheckItemTypeMapper sysAccCheckItemTypeMapper = null;
	...
	public Map<Object,Object> getCheckTypeMap(){
        ...
        List<AccCheckItemType> list = sysAccCheckItemTypeMapper.queryAccCheckItemType(mapVo);
	...
	*/
	...
	public String addAccCheckItemType(Map<String,Object> entityMap)throws DataAccessException{
			...
			int state = sysAccCheckItemTypeMapper.addAccCheckItemType(entityMap);
	...
	*/
	...
	public String addBatchAccCheckItemType(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			sysAccCheckItemTypeMapper.addBatchAccCheckItemType(entityList);
	...
	*/
	...
	public String queryAccCheckItemType(Map<String,Object> entityMap) throws DataAccessException{
		...
		List<AccCheckItemType> list = sysAccCheckItemTypeMapper.queryAccCheckItemType(entityMap, rowBounds);
	...
	*/
	...
	public int queryAccCheckItemTypeByName(Map<String,Object> entityMap)throws DataAccessException{
		...
		return sysAccCheckItemTypeMapper.queryAccCheckItemTypeByName(entityMap);
	...
	*/
	...
	public AccCheckItemType queryAccCheckItemTypeById(Map<String,Object> entityMap)throws DataAccessException{
		...
		return sysAccCheckItemTypeMapper.queryAccCheckItemTypeById(entityMap);
	...
	*/
	...
	public String deleteBatchAccCheckItemType(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
				...
				int state = sysAccCheckItemTypeMapper.deleteBatchAccCheckItemType(entityList);
  ...
  public String deleteAccCheckItemType(List<Map<String, Object>> listVo) throws DataAccessException {
		...
		try {
			for(Map<String,Object> item : listVo){
				int count = sysAccCheckItemTypeMapper.queryIsUsed(item);
				if(count>0){
					return "{\"error\":\"[分类编码:" + item.get("type_code").toString() + "]正在被引用,不能删除.\"}"; 
				}
				
				sysAccCheckItemTypeMapper.deleteAccCheckItemType(item);
			}
			return "{\"msg\":\"删除成功.\",\"state\":\"true\"}";
		}
		catch (Exception e) {
	...
	*/
	...
	public String updateAccCheckItemType(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			sysAccCheckItemTypeMapper.updateAccCheckItemType(entityMap);
	...
	private AccCheckItemType queryAccCheckItemTypeByCode(Map<String, Object> entityMap) {
		return sysAccCheckItemTypeMapper.queryAccCheckItemTypeByCode(entityMap);
	}
	...
	*/
	...
	public String updateBatchAccCheckItemType(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			sysAccCheckItemTypeMapper.updateBatchAccCheckItemType(entityList);
	...
	*/
	...
	public String queryAccCheckItemTypeBySelect(Map<String, Object> entityMap)
			throws DataAccessException {
		return JSON.toJSONString(sysAccCheckItemTypeMapper.queryAccCheckItemTypeBySelect(entityMap));
	}
	...
	public String queryCheckTable(Map<String, Object> entityMap) throws DataAccessException {
		...
		return JSON.toJSONString(sysAccCheckItemTypeMapper.queryCheckTable(entityMap));
	}
	...
	public String queryCheckTypeBySubjId(Map<String, Object> entityMap) throws DataAccessException {
		...
		return JSON.toJSONString(sysAccCheckItemTypeMapper.queryCheckTypeBySubjId(entityMap));
	}

	@Override
	public List<Map<String, Object>> queryAccCheckItemTypePrint(
			Map<String, Object> entityMap) throws DataAccessException {
		// TODO Auto-generated method stub
		List<Map<String, Object>> list = sysAccCheckItemTypeMapper.queryAccCheckItemTypePrint(entityMap);
		return list;
	}
