...
@Service("prmDeptSchemeAuditService")
public class PrmDeptSchemeAuditServiceImpl implements PrmDeptSchemeAuditService {

	private static Logger logger = Logger.getLogger(PrmDeptSchemeAuditServiceImpl.class);
	...
	@Override
	public String auditPrmDeptScheme(Map<String, Object> entityMap)
	...
	@Override
	public String reAuditPrmDeptScheme(Map<String, Object> entityMap)
			throws DataAccessException {
		// TODO Auto-generated method stub
		  PrmGoal prmGoal = prmGoalMapper.queryPrmGoalByCode(entityMap);   
