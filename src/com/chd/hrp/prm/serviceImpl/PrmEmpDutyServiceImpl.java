...
@Service("prmEmpDutyService")
public class PrmEmpDutyServiceImpl implements PrmEmpDutyService {

	private static Logger logger = Logger.getLogger(PrmEmpDutyServiceImpl.class);
	...
	public String addPrmEmpDuty(Map<String,Object> entityMap)throws DataAccessException{
			...
			try{
				...
				int state = prmEmpDutyMapper.addPrmEmpDuty(entityMap);
	...
	public String queryEmpDuty(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<PrmEmpDuty> list = prmEmpDutyMapper.queryPrmEmpDuty(entityMap);
			...
			List<PrmEmpDuty> list = prmEmpDutyMapper.queryPrmEmpDuty(entityMap, rowBounds);
	...
	public String deleteBatchPrmEmpDuty(List<Map<String, Object>> entityMap) throws DataAccessException {
		try {
			...
			prmEmpDutyMapper.deleteBatchPrmEmpDuty(entityMap);
	 ...
	 */
	@Override
	public PrmEmpDuty queryPrmEmpDutyByCode(Map<String, Object> entityMap)
			throws DataAccessException {
		
		return prmEmpDutyMapper.queryPrmEmpDutyByCode(entityMap);
	}
