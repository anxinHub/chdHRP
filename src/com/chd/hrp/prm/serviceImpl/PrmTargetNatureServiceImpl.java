...
import com.chd.hrp.prm.dao.PrmTargetNatureMapper;
import com.chd.hrp.prm.entity.PrmTargetNature;
import com.chd.hrp.prm.service.PrmTargetNatureService;
...
@Service("prmTargetNatureService")
public class PrmTargetNatureServiceImpl implements PrmTargetNatureService {

	private static Logger logger = Logger.getLogger(PrmTargetNatureServiceImpl.class);
	//引入DAO操作
	@Resource(name = "prmTargetNatureMapper")
	private final PrmTargetNatureMapper prmTargetNatureMapper = null;
	...
	*/
	...
	public String addPrmTargetNature(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象9902 指标性质字典表
		PrmTargetNature prmTargetNature = queryPrmTargetNatureByCode(entityMap);
		...
		try {
			...
			int state = prmTargetNatureMapper.addPrmTargetNature(entityMap);
	...
	*/
	...
	public String addBatchPrmTargetNature(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			prmTargetNatureMapper.addBatchPrmTargetNature(entityList);
	...
	*/
	...
	public String updatePrmTargetNature(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = prmTargetNatureMapper.updatePrmTargetNature(entityMap);
	...
	*/
	...
	public String updateBatchPrmTargetNature(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  prmTargetNatureMapper.updateBatchPrmTargetNature(entityList);
	...
	*/
    ...
    try {
			...
			int state = prmTargetNatureMapper.deletePrmTargetNature(entityMap);
	...
	*/
	...
	public String deleteBatchPrmTargetNature(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			prmTargetNatureMapper.deleteBatchPrmTargetNature(entityList);
	...
	*/
	...
	public String queryPrmTargetNature(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<PrmTargetNature> list = prmTargetNatureMapper.queryPrmTargetNature(entityMap);
			...
			List<PrmTargetNature> list = prmTargetNatureMapper.queryPrmTargetNature(entityMap, rowBounds);
	...
	*/
	...
	public PrmTargetNature queryPrmTargetNatureByCode(Map<String,Object> entityMap)throws DataAccessException{
		return prmTargetNatureMapper.queryPrmTargetNatureByCode(entityMap);
	}
