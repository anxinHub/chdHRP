...
public interface PrmFunMapper extends SqlMapper{ 
	/**
	 * @Description 
	 * 添加9908 绩效函数表<BR> 
	 * @param  entityMap
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<PrmFun> queryPrmFun(Map<String,Object> entityMap) throws DataAccessException;
	
	public List<PrmFun> queryPrmFunByFile(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<PrmFun> queryPrmFun(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	/**
	 * @Description 
	 * 获取9908 绩效函数表<BR> 
	 * @param  entityMap
	...
	*/
	...
	public PrmFun queryPrmFunByPrcName(Map<String,Object> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public Map<String,Object> collectPro(Map<String, Object> updateMap) throws DataAccessException;

	public Map<String,Object> collectFun(Map<String, Object> updateMap) throws DataAccessException;
