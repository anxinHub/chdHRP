...
public interface PrmTargetNatureMapper extends SqlMapper{
	/**
	 * @Description 
	 * 添加9902 指标性质字典表<BR> 
	 * @param  entityMap
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<PrmTargetNature> queryPrmTargetNature(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<PrmTargetNature> queryPrmTargetNature(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	/**
	 * @Description 
	 * 获取9902 指标性质字典表<BR> 
	 * @param  entityMap
