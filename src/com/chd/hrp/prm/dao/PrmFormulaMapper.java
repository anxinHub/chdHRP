...
public interface PrmFormulaMapper extends SqlMapper{
	/**
	 * @Description 
	 * 添加9906 绩效计算公式表<BR> 
	 * @param  entityMap
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<PrmFormula> queryPrmFormula(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<PrmFormula> queryPrmFormula(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	/**
	 * @Description 
	 * 获取9906 绩效计算公式表<BR> 
	 * @param  entityMap
