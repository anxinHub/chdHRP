...
public interface PrmDeptKindMapper extends SqlMapper{
	/**
	 * @Description 
	 * 添加8803 科室分类字典表<BR> 
	 * @param  entityMap
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<PrmDeptKind> queryPrmDeptKind(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<PrmDeptKind> queryPrmDeptKind(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	/**
	 * @Description 
	 * 获取8803 科室分类字典表<BR> 
	 * @param  entityMap
