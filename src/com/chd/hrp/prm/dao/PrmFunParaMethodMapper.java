...
public interface PrmFunParaMethodMapper extends SqlMapper{
	/**
	 * @Description 
	 * 添加9912 绩效函数参数取值表<BR> 
	 * @param  entityMap
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<PrmFunParaMethod> queryPrmFunParaMethod(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<PrmFunParaMethod> queryPrmFunParaMethod(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	/**
	 * @Description 
	 * 获取9912 绩效函数参数取值表<BR> 
	 * @param  entityMap
