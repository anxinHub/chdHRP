...
public interface PrmDeptMapingMapper extends SqlMapper{
	/**
	 * @Description 
	 * 添加8806 奖金科室映射表<BR> 
	 * @param  entityMap
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<PrmDeptMaping> queryPrmDeptMaping(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<PrmDeptMaping> queryPrmDeptMaping(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	/**
	 * @Description 
	 * 获取8806 奖金科室映射表<BR> 
	 * @param  entityMap
