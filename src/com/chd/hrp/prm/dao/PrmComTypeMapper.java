...
public interface PrmComTypeMapper extends SqlMapper{
	/**
	 * @Description 
	 * 添加9913 绩效部件类型表<BR> 
	 * @param  entityMap
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<PrmComType> queryPrmComType(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<PrmComType> queryPrmComType(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	/**
	 * @Description 
	 * 获取9913 绩效部件类型表<BR> 
	 * @param  entityMap
