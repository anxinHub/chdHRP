...
import com.chd.hrp.hip.dao.HipDeptRefMapper;
...
@Service("hipDeptRefService")
public class HipDeptRefServiceImpl implements HipDeptRefService {

	private static Logger logger = Logger.getLogger(HipDeptRefServiceImpl.class);

	@Resource(name = "hipDeptRefMapper")
	private final HipDeptRefMapper hipDeptRefMapper = null;
	...
	public String queryHipDeptRef(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<HipDeptRef> list = hipDeptRefMapper.queryHipDeptRef(entityMap);
			...
			List<HipDeptRef> list = hipDeptRefMapper.queryHipDeptRef(entityMap, rowBounds);
	...
	public HipDeptRef queryHipDeptRefByCode(Map<String, Object> entityMap) throws DataAccessException {
		...
		return hipDeptRefMapper.queryHipDeptRefByCode(entityMap);
	}
	...
	public String addHipDeptRef(Map<String, Object> entityMap) throws DataAccessException {
		try {
			...
			if ("1".equals(saveFlag)) {
				...
				hipDeptRefMapper.deleteHipDeptRef(map);

			}

			HipDeptRef apt = hipDeptRefMapper.queryHipDeptRefByCode(entityMap);
			...
			hipDeptRefMapper.addHipDeptRef(entityMap);
	...
	public String delHipDeptRef(Map<String, Object> entityMap) throws DataAccessException {
		try {
			...
			hipDeptRefMapper.deleteHipDeptRef(entityMap);
	...
	public String addBatchHipDeptRef(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			hipDeptRefMapper.addBatchHipDeptRef(entityList);
	...
	public String deleteBatchHipDeptRef(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			hipDeptRefMapper.deleteBatchHipDeptRef(entityList);
	...
	@Override
	public String imphipDeptRefReadFiles(Map<String, Object> entityMap)
		...
		try {
			...
			for (Map<String, List<String>> map2 : list) {
				...
				mapVo.put("ds_code", map2.get("ds_code").get(1));
				
				mapVo.put("hip_dept_code", map2.get("hip_dept_code").get(1));
				
				mapVo.put("hrp_dept_code", map2.get("hrp_dept_code").get(1));
				
				mapVo.put("doc_type", is_naturs_map.get(map2.get("doc_type").get(1)));
				...
				map_code.put("ds_code", mapVo.get("ds_code"));
				
				map_code.put("hip_dept_code", mapVo.get("hip_dept_code"));
				
				map_code.put("hrp_dept_code", mapVo.get("hrp_dept_code"));
				
				map_code.put("doc_type", mapVo.get("doc_type"));
				
				HipDeptRef data_exc_extis_code = hipDeptRefMapper.queryHipDeptRefByCode(map_code);
