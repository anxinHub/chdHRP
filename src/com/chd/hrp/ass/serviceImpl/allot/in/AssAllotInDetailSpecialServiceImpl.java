...
@Service("assAllotInDetailSpecialService")
public class AssAllotInDetailSpecialServiceImpl implements AssAllotInDetailSpecialService {

	private static Logger logger = Logger.getLogger(AssAllotInDetailSpecialServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssAllotInDetailSpecial assAllotInDetailSpecial = queryByCode(entityMap);

		if (assAllotInDetailSpecial != null) {
		...
		try {
			...
			int state = assAllotInDetailSpecialMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assAllotInDetailSpecialMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assAllotInDetailSpecialMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assAllotInDetailSpecialMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assAllotInDetailSpecialMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		try {
			...
			List<AssAllotInDetailSpecial> list = (List<AssAllotInDetailSpecial>)assAllotInDetailSpecialMapper.queryExists(inMapVo);
			...
			if(list != null){
				for(AssAllotInDetailSpecial temp :  list ){
					price += temp.getPrice();
			...
			assAllotInSpecialMapper.updateInMoney(inMapVo);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssAllotInDetailSpecial> list = (List<AssAllotInDetailSpecial>)assAllotInDetailSpecialMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssAllotInDetailSpecial> list = (List<AssAllotInDetailSpecial>)assAllotInDetailSpecialMapper.query(entityMap);
			...
			List<AssAllotInDetailSpecial> list = (List<AssAllotInDetailSpecial>)assAllotInDetailSpecialMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assAllotInDetailSpecialMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssAllotInDetailSpecial
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assAllotInDetailSpecialMapper.queryByUniqueness(entityMap);
	}
