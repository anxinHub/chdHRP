...
import com.chd.hrp.ass.entity.allot.in.AssAllotInDetailGeneral;
 ...
 * 
 * @Description:
 * 050901 资产无偿调拨入库明细(一般设备)
 * @Table:
 * ASS_ALLOT_IN_DETAIL_GENERAL
 * @Author: bell
...
@Service("assAllotInDetailGeneralService")
public class AssAllotInDetailGeneralServiceImpl implements AssAllotInDetailGeneralService {

	private static Logger logger = Logger.getLogger(AssAllotInDetailGeneralServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象050901 资产无偿调拨入库明细(一般设备)
		AssAllotInDetailGeneral assAllotInDetailGeneral = queryByCode(entityMap);

		if (assAllotInDetailGeneral != null) {
		...
		try {
			...
			int state = assAllotInDetailGeneralMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assAllotInDetailGeneralMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assAllotInDetailGeneralMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assAllotInDetailGeneralMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assAllotInDetailGeneralMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		try {
			...
			List<AssAllotInDetailGeneral> list = (List<AssAllotInDetailGeneral>)assAllotInDetailGeneralMapper.queryExists(inMapVo);
			...
			if(list != null){
				for(AssAllotInDetailGeneral temp :  list ){
					price += temp.getPrice();
			...
			assAllotInGeneralMapper.updateInMoney(inMapVo);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		//判断是否存在对象050901 资产无偿调拨入库明细(一般设备)
		...
		List<AssAllotInDetailGeneral> list = (List<AssAllotInDetailGeneral>)assAllotInDetailGeneralMapper.queryExists(mapVo);
	...
	/**
	 * @Description 
	 * 查询结果集050901 资产无偿调拨入库明细(一般设备)<BR> 
	 * @param  entityMap
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssAllotInDetailGeneral> list = (List<AssAllotInDetailGeneral>)assAllotInDetailGeneralMapper.query(entityMap);
			...
			List<AssAllotInDetailGeneral> list = (List<AssAllotInDetailGeneral>)assAllotInDetailGeneralMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assAllotInDetailGeneralMapper.queryByCode(entityMap);
	}
	
	/**
	 * @Description 
	 * 获取050901 资产无偿调拨入库明细(一般设备)<BR> 
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssAllotInDetailGeneral
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assAllotInDetailGeneralMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssAllotInDetailGeneral>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assAllotInDetailGeneralMapper.queryExists(entityMap);
	}
	@Override
	public List<AssAllotInDetailGeneral> queryByAssInNo(Map<String, Object> entityMap) throws DataAccessException {
		return assAllotInDetailGeneralMapper.queryByAssInNo(entityMap);
	}
	
	@Override
	public List<Map<String, Object>> queryByInit(Map<String, Object> entityMap) throws DataAccessException {
		return assAllotInDetailGeneralMapper.queryByInit(entityMap);
	}
