...
@Service("assAllotOutSpecialService")
public class AssAllotOutSpecialServiceImpl implements AssAllotOutSpecialService {

	private static Logger logger = Logger.getLogger(AssAllotOutSpecialServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象050901 资产无偿调拨出库单主表（专用设备）
		AssAllotOutSpecial assAllotOutSpecial = queryByCode(entityMap);
		...
		try {
			...
			int state = assAllotOutSpecialMapper.add(entityMap);
	...
	/**
	 * @Description 
	 * 批量添加050901 资产无偿调拨出库单主表（专用设备）<BR> 
	 * @param  entityList
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assAllotOutSpecialMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assAllotOutSpecialMapper.update(entityMap);
	...
	/**
	 * @Description 
	 * 批量更新050901 资产无偿调拨出库单主表（专用设备）<BR> 
	 * @param  entityList
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assAllotOutSpecialMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assAllotOutSpecialMapper.delete(entityMap);
	...
	/**
	 * @Description 
	 * 批量删除050901 资产无偿调拨出库单主表（专用设备）<BR> 
	 * @param  entityList
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assAllotOutSpecialMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		List<AssAllotOutSpecial> list = (List<AssAllotOutSpecial>) assAllotOutSpecialMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			if (list.size() > 0) {
				assAllotOutSpecialMapper.update(entityMap);
			} else {
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_ALLOT_OUT_SPECIAL");
				String allot_out_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("allot_out_no", allot_out_no);
				assAllotOutSpecialMapper.add(entityMap);
			...
			for (Map<String, Object> detailVo : detail) {
				...
				String results = collectAssAllotOutSpecial(detailVo);
			...
			assAllotOutSourceSpecialMapper.delete(entityMap);
			assAllotOutDetailSpecialMapper.delete(entityMap);
			assAllotOutDetailSpecialMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assAllotOutSourceSpecialMapper.addBatch(listSourceVo);
			}
			...
			assAllotOutSpecialMapper.updateAllotOutMoney(entityMap);
	...
	/**
	 * @Description 
	 * 查询结果集050901 资产无偿调拨出库单主表（专用设备）<BR> 
	 * @param  entityMap
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssAllotOutSpecial> list = (List<AssAllotOutSpecial>)assAllotOutSpecialMapper.query(entityMap);
			...
			List<AssAllotOutSpecial> list = (List<AssAllotOutSpecial>)assAllotOutSpecialMapper.query(entityMap, rowBounds);
	...
	/**
	 * @Description 
	 * 获取对象050901 资产无偿调拨出库单主表（专用设备）<BR> 
	 * @param  entityMap<BR>
	 *  参数为主键
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assAllotOutSpecialMapper.queryByCode(entityMap);
	}
	
	/**
	 * @Description 
	 * 获取050901 资产无偿调拨出库单主表（专用设备）<BR> 
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssAllotOutSpecial
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assAllotOutSpecialMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssAllotOutSpecial>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assAllotOutSpecialMapper.queryExists(entityMap);
	}
	@Override
	public String updateAllotOutConfirm(List<Map<String, Object>> entityMap, List<Map<String, Object>> cardEntityMap)
			throws DataAccessException {
		try {
			assAllotOutSpecialMapper.updateConfirm(entityMap);
	...
	public String collectAssAllotOutSpecial(Map<String, Object> entityMap) {
		WebApplicationContext ctx = ContextLoader.getCurrentWebApplicationContext();
		...
		assAllotOutSpecialMapper.collectAssAllotOutSpecial(entityMap);
	...
	public String queryByAllotInImport(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssAllotOutSpecial> list = (List<AssAllotOutSpecial>)assAllotOutSpecialMapper.queryByAllotInImport(entityMap);
			...
			List<AssAllotOutSpecial> list = (List<AssAllotOutSpecial>)assAllotOutSpecialMapper.queryByAllotInImport(entityMap, rowBounds);
	...
	public String queryByAllotInImportView(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssAllotOutSpecial> list = (List<AssAllotOutSpecial>)assAllotOutSpecialMapper.queryByAllotInImportView(entityMap);
			...
			List<AssAllotOutSpecial> list = (List<AssAllotOutSpecial>)assAllotOutSpecialMapper.queryByAllotInImportView(entityMap, rowBounds);
	 ...
	 */
	@Override
	public Map<String, Object> queryAssAllotOutSpecialByPrintTemlatePrint(Map<String, Object> entityMap)throws DataAccessException {
		
		try{
			
			Map<String,Object> reMap=new HashMap<String,Object>();
			WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
			AssAllotOutSpecialMapper assAllotOutSpecialMapper = (AssAllotOutSpecialMapper)context.getBean("assAllotOutSpecialMapper");
			 
			//主页面 批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				
				//查询 专用设备 资产调剂 出库 主表数据（主页面）
				List<Map<String,Object>> map= assAllotOutSpecialMapper.queryAssAllotOutSpecialPrintTemlateByMainBatch(entityMap);
				//查询 专用设备 资产调剂 出库明细表数据
				List<Map<String,Object>> list= assAllotOutSpecialMapper.queryAssAllotOutSpecialPrintTemlateByDetail(entityMap);
				...
				//查询 专用设备 资产调剂 出库 主表数据（修改页面）
				Map<String,Object> map= assAllotOutSpecialMapper.queryAssAllotOutSpecialPrintTemlateByMain(entityMap);
				//查询 专用设备 资产调剂 出库明细表数据
				List<Map<String,Object>> list= assAllotOutSpecialMapper.queryAssAllotOutSpecialPrintTemlateByDetail(entityMap);
	...
	public List<String> queryAssAllotOutSpecialState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return assAllotOutSpecialMapper.queryAssAllotOutSpecialState(mapVo);
	}
	@Override
	public String queryDetails(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assAllotOutSpecialMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assAllotOutSpecialMapper.queryDetails(entityMap, rowBounds);
