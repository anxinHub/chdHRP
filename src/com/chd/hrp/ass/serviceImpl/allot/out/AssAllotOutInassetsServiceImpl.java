...
@Service("assAllotOutInassetsService")
public class AssAllotOutInassetsServiceImpl implements AssAllotOutInassetsService {

	private static Logger logger = Logger.getLogger(AssAllotOutInassetsServiceImpl.class);
	// 引入DAO操作
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		AssAllotOutInassets assAllotOutInassets = queryByCode(entityMap);
		...
		try {
			...
			int state = assAllotOutInassetsMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assAllotOutInassetsMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assAllotOutInassetsMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assAllotOutInassetsMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assAllotOutInassetsMapper.delete(entityMap);
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assAllotOutInassetsMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssAllotOutInassets> list = (List<AssAllotOutInassets>) assAllotOutInassetsMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			if (list.size() > 0) {
				assAllotOutInassetsMapper.update(entityMap);
			} else {
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_ALLOT_OUT_INASSETS");
				String allot_out_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("allot_out_no", allot_out_no);
				assAllotOutInassetsMapper.add(entityMap);
			...
			assAllotOutSourceInassetsMapper.delete(entityMap);
			assAllotOutDetailInassetsMapper.delete(entityMap);
			assAllotOutDetailInassetsMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assAllotOutSourceInassetsMapper.addBatch(listSourceVo);
			}
			...
			assAllotOutInassetsMapper.updateAllotOutMoney(entityMap);
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssAllotOutInassets> list = (List<AssAllotOutInassets>) assAllotOutInassetsMapper.query(entityMap);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assAllotOutInassetsMapper.queryByCode(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssAllotOutInassets
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assAllotOutInassetsMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssAllotOutInassets>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assAllotOutInassetsMapper.queryExists(entityMap);
	}
	...
	public String updateAllotOutConfirm(List<Map<String, Object>> entityMap, List<Map<String, Object>> cardEntityMap)
			throws DataAccessException {
		try {
			assAllotOutInassetsMapper.updateConfirm(entityMap);
	...
	public String collectAssAllotOutInassets(Map<String, Object> entityMap) {
		...
		assAllotOutInassetsMapper.collectAssAllotOutInassets(entityMap);
	...
	public String queryByAllotInImport(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssAllotOutInassets> list = (List<AssAllotOutInassets>) assAllotOutInassetsMapper
	 ...
	 */
	@Override
	public Map<String, Object> queryAssAllotOutInassetsByPrintTemlatePrint(Map<String, Object> entityMap)throws DataAccessException {
		
		try{
			
			Map<String,Object> reMap=new HashMap<String,Object>();
			WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
			AssAllotOutInassetsMapper assAllotOutInassetsMapper = (AssAllotOutInassetsMapper)context.getBean("assAllotOutInassetsMapper");
			 
			//主页面 批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				
				//查询 其他无形资产 资产调剂 出库 主表数据（主页面）
				List<Map<String,Object>> map= assAllotOutInassetsMapper.queryAssAllotOutInassetsPrintTemlateByMainBatch(entityMap);
				//查询 其他无形资产 资产调剂 出库明细表数据
				List<Map<String,Object>> list= assAllotOutInassetsMapper.queryAssAllotOutInassetsPrintTemlateByDetail(entityMap);
				...
				//查询 其他无形资产 资产调剂 出库 主表数据（修改页面）
				Map<String,Object> map= assAllotOutInassetsMapper.queryAssAllotOutInassetsPrintTemlateByMain(entityMap);
				//查询 其他无形资产 资产调剂 出库明细表数据
				List<Map<String,Object>> list= assAllotOutInassetsMapper.queryAssAllotOutInassetsPrintTemlateByDetail(entityMap);
	...
	/**
	 * 其他无形资产 资产调剂 出库 出库单状态查询  （打印时校验数据专用）
	 */
	@Override
	public List<String> queryAssAllotOutInassetsState(Map<String, Object> mapVo) throws DataAccessException {
		
		return assAllotOutInassetsMapper.queryAssAllotOutInassetsState(mapVo);
	}
	...
	public String queryDetails(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assAllotOutInassetsMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assAllotOutInassetsMapper.queryDetails(entityMap, rowBounds);
