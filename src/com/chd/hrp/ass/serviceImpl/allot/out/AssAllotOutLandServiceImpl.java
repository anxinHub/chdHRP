...
@Service("assAllotOutLandService")
public class AssAllotOutLandServiceImpl implements AssAllotOutLandService {

	private static Logger logger = Logger.getLogger(AssAllotOutLandServiceImpl.class);
	// 引入DAO操作
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		AssAllotOutLand assAllotOutLand = queryByCode(entityMap);
		...
		try {
			...
			int state = assAllotOutLandMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assAllotOutLandMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assAllotOutLandMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assAllotOutLandMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assAllotOutLandMapper.delete(entityMap);
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assAllotOutLandMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssAllotOutLand> list = (List<AssAllotOutLand>) assAllotOutLandMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			if (list.size() > 0) {
				assAllotOutLandMapper.update(entityMap);
			} else {
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_ALLOT_OUT_LAND");
				String allot_out_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("allot_out_no", allot_out_no);
				assAllotOutLandMapper.add(entityMap);
			...
			assAllotOutSourceLandMapper.delete(entityMap);
			assAllotOutDetailLandMapper.delete(entityMap);
			assAllotOutDetailLandMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assAllotOutSourceLandMapper.addBatch(listSourceVo);
			}
			...
			assAllotOutLandMapper.updateAllotOutMoney(entityMap);
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssAllotOutLand> list = (List<AssAllotOutLand>) assAllotOutLandMapper.query(entityMap);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assAllotOutLandMapper.queryByCode(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssAllotOutLand
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assAllotOutLandMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssAllotOutLand>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assAllotOutLandMapper.queryExists(entityMap);
	}
	...
	public String updateAllotOutConfirm(List<Map<String, Object>> entityMap, List<Map<String, Object>> cardEntityMap)
			throws DataAccessException {
		try {
			assAllotOutLandMapper.updateConfirm(entityMap);
	...
	public String collectAssAllotOutLand(Map<String, Object> entityMap) {
		...
		assAllotOutLandMapper.collectAssAllotOutLand(entityMap);
	...
	public String queryByAllotInImport(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssAllotOutLand> list = (List<AssAllotOutLand>) assAllotOutLandMapper
	...
	@Override
	public Map<String,Object> printAssAllotOutLandData(Map<String, Object> map)throws DataAccessException {
		
		try{
			Map<String,Object> reMap=new HashMap<String,Object>();
			WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
			AssAllotOutLandMapper assAllotOutLandMapper = (AssAllotOutLandMapper)context.getBean("assAllotOutLandMapper");
			
			//查询凭证主表
			List<Map<String,Object>> mainList=assAllotOutLandMapper.queryAssAllotOutLandByAssInNo(map);
					
			//查询凭证明细表
			List<Map<String,Object>> detailList=assAllotOutLandMapper.queryAssAllotOutLandDetailByAssInNo(map);
	 ...
	 */
	@Override
	public List<String> queryAssAllotOutLandStates(Map<String, Object> mapVo) throws DataAccessException {
		
		return assAllotOutLandMapper.queryAssAllotOutLandStates(mapVo);
	}
	...
	public String queryDetails(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assAllotOutLandMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assAllotOutLandMapper.queryDetails(entityMap, rowBounds);
