...
import com.chd.hrp.ass.dao.assdisposal.land.AssDisposalApplyLandMapper;
import com.chd.hrp.ass.dao.assdisposal.land.AssDisposalApplySourceLandMapper;
 ...
 * @Version: 1.0
 */
@Service("assDisposalApplyLandService")
public class AssDisposalApplyLandServiceImpl implements AssDisposalApplyLandService {
 
	private static Logger logger = Logger.getLogger(AssDisposalApplyLandServiceImpl.class);
	// 引入DAO操作
	@Resource(name = "assDisposalApplyLandMapper")
	private final AssDisposalApplyLandMapper assDisposalApplyLandMapper = null;
	...
	@Resource(name = "assDisposalApplySourceLandMapper")
	private final AssDisposalApplySourceLandMapper assDisposalApplySourceLandMapper = null;
	...
	/**
	 * @Description 添加051001资产处置申报(土地)<BR>
	 * @param entityMap
	 * @return String JSON
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		// 获取对象051001资产处置申报(土地)
		AssDisposalApplyLand assDisposalAland = queryByCode(entityMap);
		...
		try {
			...
			int state = assDisposalApplyLandMapper.add(entityMap);
	...
	/**
	 * @Description 批量添加051001资产处置申报(土地)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assDisposalApplyLandMapper.addBatch(entityList);
	...
	/**
	 * @Description 更新051001资产处置申报(土地)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assDisposalApplyLandMapper.update(entityMap);
	...
	/**
	 * @Description 批量更新051001资产处置申报(土地)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assDisposalApplyLandMapper.updateBatch(entityList);
	...
	/**
	 * @Description 删除051001资产处置申报(土地)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assDisposalApplyLandMapper.delete(entityMap);
	...
	/**
	 * @Description 批量删除051001资产处置申报(土地)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			assDisposalApplySourceLandMapper.deleteBatch(entityList);
	    	assDisposalApplyDetailLandMapper.deleteBatch(entityList);
			assDisposalApplyLandMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssDisposalApplyLand> list = (List<AssDisposalApplyLand>) assDisposalApplyLandMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			if (list.size() > 0) {
				assDisposalApplyLandMapper.update(entityMap);
			} else {
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_DISPOSAL_A_LAND");
				String dis_a_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("dis_a_no", dis_a_no);
				assDisposalApplyLandMapper.add(entityMap);
			...
			for (Map<String, Object> detailVo : detail) {
				...
				String results = collectAssDisposalApplyLand(detailVo);
			...
			assDisposalApplySourceLandMapper.delete(entityMap);
			assDisposalApplyDetailLandMapper.delete(entityMap);
			assDisposalApplyDetailLandMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assDisposalApplySourceLandMapper.addBatch(listSourceVo);
			}
	...
	public String collectAssDisposalApplyLand(Map<String, Object> entityMap) {
		WebApplicationContext ctx = ContextLoader.getCurrentWebApplicationContext();
		...
		assDisposalApplyLandMapper.collectAssDisposalApplyLand(entityMap);
	...
	/**
	 * @Description 查询结果集051001资产处置申报(土地)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssDisposalApplyLand> list = (List<AssDisposalApplyLand>) assDisposalApplyLandMapper
					.query(entityMap);
	...
	/**
	 * @Description 获取对象051001资产处置申报(土地)<BR>
	 * @param entityMap<BR>
	 *            参数为主键
	 * @return String JSON
	 * @throws DataAccessException
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assDisposalApplyLandMapper.queryByCode(entityMap);
	}

	/**
	 * @Description 获取051001资产处置申报(土地)<BR>
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssDisposalApplyLand
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assDisposalApplyLandMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssDisposalApplyLand>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assDisposalApplyLandMapper.queryExists(entityMap);
	}

	@Override
	public String updateConfirmDisposalApplyLand(List<Map<String, Object>> listVo,
			List<Map<String, Object>> listCardVo) throws DataAccessException {
		try {
			assDisposalApplyLandMapper.updateBatchConfirm(listVo);
			assCardLandMapper.updateDisposalApplyConfirm(listCardVo);
	...
	public String queryAssApplyDeptByPlanDept(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssDisposalApplyLand> list = assDisposalApplyLandMapper.queryAssApplyDeptByPlanDept(entityMap);
			...
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<AssDisposalApplyLand> list = assDisposalApplyLandMapper.queryAssApplyDeptByPlanDept(entityMap, rowBounds);
	...
	public String queryDetails(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assDisposalApplyLandMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assDisposalApplyLandMapper.queryDetails(entityMap, rowBounds);
