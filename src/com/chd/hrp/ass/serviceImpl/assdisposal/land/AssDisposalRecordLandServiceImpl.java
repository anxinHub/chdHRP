...
package com.chd.hrp.ass.serviceImpl.assdisposal.land;
...
import com.chd.hrp.ass.dao.assdisposal.land.AssDisposalApplyDetailLandMapper;
import com.chd.hrp.ass.dao.assdisposal.land.AssDisposalArMapLandMapper;
import com.chd.hrp.ass.dao.assdisposal.land.AssDisposalRecordDetailLandMapper;
import com.chd.hrp.ass.dao.assdisposal.land.AssDisposalRecordLandMapper;
import com.chd.hrp.ass.dao.assdisposal.land.AssDisposalRecordSourceLandMapper;
...
/**
 * 
 * @Description: 051001资产处置明细(土地)
 * @Table: ASS_DISPOSAL_A_LAND
 * @Author: bell
 * @email: bell@e-tonggroup.com
 * @Version: 1.0
 */
@Service("assDisposalRecordLandService")
public class AssDisposalRecordLandServiceImpl implements AssDisposalRecordLandService {
 
	private static Logger logger = Logger.getLogger(AssDisposalRecordLandServiceImpl.class);
	// 引入DAO操作
	@Resource(name = "assDisposalRecordLandMapper")
	private final AssDisposalRecordLandMapper assDisposalRecordLandMapper = null;
	
	@Resource(name = "assDisposalRecordDetailLandMapper")
	private final AssDisposalRecordDetailLandMapper assDisposalRecordDetailLandMapper = null;
	
	@Resource(name = "assDisposalApplyDetailLandMapper")
	private final AssDisposalApplyDetailLandMapper assDisposalApplyDetailLandMapper = null;
	
	@Resource(name = "assDisposalRecordSourceLandMapper")
	private final AssDisposalRecordSourceLandMapper assDisposalRecordSourceLandMapper = null;
	
	@Resource(name = "assDisposalArMapLandMapper")
	private final AssDisposalArMapLandMapper assDisposalArMapLandMapper = null;
	...
	/**
	 * @Description 添加051001资产处置明细(土地)<BR>
	 * @param entityMap
	 * @return String JSON
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		// 获取对象051001资产处置明细(土地)
		AssDisposalRecordLand assDisposalAland = queryByCode(entityMap);
		...
		try {
			...
			int state = assDisposalRecordLandMapper.add(entityMap);
	...
	/**
	 * @Description 批量添加051001资产处置明细(土地)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assDisposalRecordLandMapper.addBatch(entityList);
	...
	/**
	 * @Description 更新051001资产处置明细(土地)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assDisposalRecordLandMapper.update(entityMap);
	...
	/**
	 * @Description 批量更新051001资产处置明细(土地)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assDisposalRecordLandMapper.updateBatch(entityList);
	...
	/**
	 * @Description 删除051001资产处置明细(土地)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assDisposalRecordLandMapper.delete(entityMap);
	...
	/**
	 * @Description 批量删除051001资产处置明细(土地)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			assDisposalRecordSourceLandMapper.deleteBatch(entityList);
	    	assDisposalRecordDetailLandMapper.deleteBatch(entityList);
			assDisposalRecordLandMapper.deleteBatch(entityList);
			assDisposalArMapLandMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssDisposalRecordLand> list = (List<AssDisposalRecordLand>) assDisposalRecordLandMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			if (list.size() > 0) {
				assDisposalRecordLandMapper.update(entityMap);
			} else {
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_DISPOSAL_R_LAND");
				String dis_r_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("dis_r_no", dis_r_no);
				assDisposalRecordLandMapper.add(entityMap);
			...
			for (Map<String, Object> detailVo : detail) {
				...
				String results = collectAssDisposalRecordLand(detailVo);
			...
			assDisposalRecordSourceLandMapper.delete(entityMap);
			assDisposalRecordDetailLandMapper.delete(entityMap);
			assDisposalRecordDetailLandMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assDisposalRecordSourceLandMapper.addBatch(listSourceVo);
			}
	...
	public String collectAssDisposalRecordLand(Map<String, Object> entityMap) {
		WebApplicationContext ctx = ContextLoader.getCurrentWebApplicationContext();
		...
		assDisposalRecordLandMapper.collectAssDisposalRecordLand(entityMap);
	...
	/**
	 * @Description 查询结果集051001资产处置明细(土地)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssDisposalRecordLand> list = (List<AssDisposalRecordLand>) assDisposalRecordLandMapper
					.query(entityMap);
	...
	/**
	 * @Description 获取对象051001资产处置明细(土地)<BR>
	 * @param entityMap<BR>
	 *            参数为主键
	 * @return String JSON
	 * @throws DataAccessException
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assDisposalRecordLandMapper.queryByCode(entityMap);
	}

	/**
	 * @Description 获取051001资产处置明细(土地)<BR>
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssDisposalRecordLand
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assDisposalRecordLandMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssDisposalRecordLand>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assDisposalRecordLandMapper.queryExists(entityMap);
	}

	@Override
	public String updateConfirmDisposalRecordLand(List<Map<String, Object>> listVo,
			List<Map<String, Object>> listCardVo) throws DataAccessException {
		try {
			assDisposalRecordLandMapper.updateBatchConfirm(listVo);
			assCardLandMapper.updateDisposalRecordConfirm(listCardVo);
	...
	@Override
	public Map<String,Object> printAssDisposalRecordLandData(Map<String, Object> map)throws DataAccessException {
		
		try{
			Map<String,Object> reMap=new HashMap<String,Object>();
			WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
			AssDisposalRecordLandMapper assDisposalRecordLandMapper = (AssDisposalRecordLandMapper)context.getBean("assDisposalRecordLandMapper");
			
			//查询凭证主表
			List<Map<String,Object>> mainList=assDisposalRecordLandMapper.queryAssAllotOutLandByAssInNo(map);
					
			//查询凭证明细表
			List<Map<String,Object>> detailList=assDisposalRecordLandMapper.queryAssAllotOutLandDetailByAssInNo(map);
	...
	public String initAssCheckSpecial(Map<String, Object> entityMap) {
		...
		List<AssDisposalApplyDetailLand> 	assDisposalAdetailLand=(List<AssDisposalApplyDetailLand>) assDisposalApplyDetailLandMapper.query(entityMap);
			entityMap.put("bill_table", "ASS_DISPOSAL_R_LAND");
			String dis_r_no = assBaseService.getBillNOSeqNo(entityMap);
			entityMap.put("dis_r_no", dis_r_no);
			entityMap.put("state", 0);
			...
			for (String temp : carno.toString().split(",")) {// 循环生成单据的明细ID
				...
				assDisposalRecordLandMapper.addAssPlanDeptImportBid(planApplyMapvo);
			}
			
			Map<String, Object> maps = new HashMap<String, Object>();
			
			if(null!=assDisposalAdetailLand&&0!=assDisposalAdetailLand.size()){
				maps.put("group_id", assDisposalAdetailLand.get(0).getGroup_id());
				maps.put("hos_id", assDisposalAdetailLand.get(0).getHos_id());
				maps.put("copy_code", assDisposalAdetailLand.get(0).getCopy_code());
				maps.put("dis_r_no", dis_r_no);
				maps.put("dis_a_no", assDisposalAdetailLand.get(0).getDis_a_no());
				maps.put("dispose_type", entityMap.get("dispose_type"));
			}	
			
			for (AssDisposalApplyDetailLand assDisposalApplyDetailLand : assDisposalAdetailLand) {
				
				Map<String, Object> map = new HashMap<String, Object>();
				
				map.put("group_id", assDisposalApplyDetailLand.getGroup_id());
				
				map.put("hos_id", assDisposalApplyDetailLand.getHos_id());
				
				map.put("copy_code", assDisposalApplyDetailLand.getCopy_code());
				
				map.put("dis_r_no", dis_r_no);
				
				map.put("dis_a_no", assDisposalApplyDetailLand.getDis_a_no());
				
				map.put("dispose_type", entityMap.get("dispose_type"));
				
				map.put("ass_card_no", assDisposalApplyDetailLand.getAss_card_no());
				
				map.put("price", assDisposalApplyDetailLand.getPrice());


				map.put("add_depre",assDisposalApplyDetailLand.getAdd_depre());

				map.put("add_manage_depre", assDisposalApplyDetailLand.getAdd_manage_depre());

				map.put("cur_money",assDisposalApplyDetailLand.getCur_money());

				map.put("fore_money", assDisposalApplyDetailLand.getFore_money());
				...
				String results = collectAssDisposalRecordLand(map);
			...
			assDisposalRecordDetailLandMapper.delete(entityMap);
			assDisposalRecordDetailLandMapper.addBatch(listVo);
			assDisposalArMapLandMapper.add(maps);
			if (listSourceVo.size() > 0) {
				assDisposalRecordSourceLandMapper.addBatch(listSourceVo);
			}
			//entityMap.put("back_money", back_money);
	    ...
	    */
		...
		public String deleteBatchAssApplyPlanMap(List<Map<String, Object>> listVo) throws DataAccessException {
			try {
				...
				assDisposalRecordLandMapper.deleteBatchAssApplyPlanMap(listVo);
				return "{\"msg\":\"删除成功.\",\"state\":\"true\"}";
		 ...
		 */
		@Override
		public List<String> queryAssDisposalRecordLandStates(Map<String, Object> mapVo) throws DataAccessException {
			
			return assDisposalRecordLandMapper.queryAssDisposalRecordLandStates(mapVo);
		}
		...
		public String queryDetails(Map<String, Object> entityMap) {
			...
			if (sysPage.getTotal() == -1) {
				...
				List<Map<String, Object>> list = (List<Map<String, Object>>) assDisposalRecordLandMapper.queryDetails(entityMap);
				...
				List<Map<String, Object>> list = (List<Map<String, Object>>) assDisposalRecordLandMapper.queryDetails(entityMap, rowBounds);
