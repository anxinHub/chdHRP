...
@Service("assInDetailGeneralService")
public class AssInDetailGeneralServiceImpl implements AssInDetailGeneralService {

	private static Logger logger = Logger.getLogger(AssInDetailGeneralServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象资产入库明细(一般设备)
		AssInDetailGeneral assInDetailGeneral = queryByCode(entityMap);

		if (assInDetailGeneral != null) {
		...
		try {
			...
			int state = assInDetailGeneralMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assInDetailGeneralMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assInDetailGeneralMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assInDetailGeneralMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assInDetailGeneralMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			List<AssInDetailGeneral> list = (List<AssInDetailGeneral>)assInDetailGeneralMapper.queryExists(inMapVo);
			
			double in_money=0;
			if(list != null){
				for(AssInDetailGeneral temp :  list ){
					in_money += temp.getPrice() * temp.getIn_amount();
				}
			}
			inMapVo.put("in_money", in_money+"");
			assInMainGeneralMapper.updateInMoney(inMapVo);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssInDetailGeneral> list = (List<AssInDetailGeneral>)assInDetailGeneralMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssInDetailGeneral> list = (List<AssInDetailGeneral>)assInDetailGeneralMapper.query(entityMap);
			...
			List<AssInDetailGeneral> list = (List<AssInDetailGeneral>)assInDetailGeneralMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assInDetailGeneralMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssInDetailGeneral
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assInDetailGeneralMapper.queryByUniqueness(entityMap);
	}
