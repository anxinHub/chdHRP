...
@Service("assInRestDetailSpecialService")
public class AssInRestDetailSpecialServiceImpl implements AssInRestDetailSpecialService {

	private static Logger logger = Logger.getLogger(AssInRestDetailSpecialServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssInRestDetailSpecial assInRestDetailSpecial = queryByCode(entityMap);

		if (assInRestDetailSpecial != null) {
		...
		try {
			...
			int state = assInRestDetailSpecialMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assInRestDetailSpecialMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assInRestDetailSpecialMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assInRestDetailSpecialMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assInRestDetailSpecialMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			List<AssInRestDetailSpecial> list = (List<AssInRestDetailSpecial>)assInRestDetailSpecialMapper.queryExists(inMapVo);
			
			double in_money=0;
			if(list != null){
				for(AssInRestDetailSpecial temp :  list ){
					in_money += temp.getPrice() * temp.getIn_amount();
				}
			}
			inMapVo.put("in_money", in_money+"");
			assInRestMainSpecialMapper.updateInMoney(inMapVo);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssInRestDetailSpecial> list = (List<AssInRestDetailSpecial>)assInRestDetailSpecialMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssInRestDetailSpecial> list = (List<AssInRestDetailSpecial>)assInRestDetailSpecialMapper.query(entityMap);
			...
			List<AssInRestDetailSpecial> list = (List<AssInRestDetailSpecial>)assInRestDetailSpecialMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assInRestDetailSpecialMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssInRestDetailSpecial
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assInRestDetailSpecialMapper.queryByUniqueness(entityMap);
	}
