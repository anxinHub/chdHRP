...
@Service("assInRestMainGeneralService")
public class AssInRestMainGeneralServiceImpl implements AssInRestMainGeneralService {

	private static Logger logger = Logger.getLogger(AssInRestMainGeneralServiceImpl.class);
	// 引入DAO操作
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		AssInRestMainGeneral assInRestMainGeneral = queryByCode(entityMap);
		...
		try {
			...
			int state = assInRestMainGeneralMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assInRestMainGeneralMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assInRestMainGeneralMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assInRestMainGeneralMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assInRestMainGeneralMapper.delete(entityMap);
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		try {
			...
			assInRestMainGeneralMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssInRestMainGeneral> list = (List<AssInRestMainGeneral>) assInRestMainGeneralMapper.queryExists(mapVo);
		try {
			if (list.size() > 0) {
				int state = assInRestMainGeneralMapper.update(entityMap);
			} else {
				...
				entityMap.put("bill_table", "ASS_IN_REST_MAIN_GENERAL");
			...
			assInRestDetailGeneralMapper.delete(entityMap);
			assInRestDetailGeneralMapper.addBatch(listVo);
			entityMap.put("in_money", in_money+"");
			assInRestMainGeneralMapper.updateInMoney(entityMap);
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssInRestMainGeneral> list = (List<AssInRestMainGeneral>) assInRestMainGeneralMapper.query(entityMap);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assInRestMainGeneralMapper.queryByCode(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssInRestMainGeneral
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assInRestMainGeneralMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssInRestMainGeneral>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assInRestMainGeneralMapper.queryExists(entityMap);
	}
	...
	@Override
	public String initAssInCardGeneral(Map<String, Object> map) throws DataAccessException {
		List<Map<String, Object>> listVo = new ArrayList<Map<String, Object>>();
		...
		try {
			...
			List<Map<String, Object>> list = assInRestDetailGeneralMapper.queryByInit(map);
	...
	public String updateAudit(List<Map<String, Object>> entityMap) throws DataAccessException {
		try {
			assInRestMainGeneralMapper.updateAudit(entityMap);
	...
	public String updateReAudit(List<Map<String, Object>> entityMap) throws DataAccessException {
		try {
			assInRestMainGeneralMapper.updateReAudit(entityMap);
	...
	public String updateConfirm(List<Map<String, Object>> entityMap) throws DataAccessException {
		try {
			assInRestMainGeneralMapper.updateConfirm(entityMap);
	...
	public Map<String, Object> queryAssInRestGeneralByPrintTemlatePrint(Map<String, Object> entityMap)throws DataAccessException {
		...
		try{
			...
			AssInRestMainGeneralMapper assInRestMainGeneralMapper = (AssInRestMainGeneralMapper)context.getBean("assInRestMainGeneralMapper");
			 
			//主页面 一般设备 其它入库   批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				
				//查询 一般设备 其它入库   入库主表数据
				List<Map<String,Object>> map= assInRestMainGeneralMapper.queryAssInRestGeneralPrintTemlateByMainBatch(entityMap);
				//查询 一般设备 其它入库    入库明细表数据
				List<Map<String,Object>> list= assInRestMainGeneralMapper.queryAssInRestGeneralPrintTemlateByDetail(entityMap);
				...
				//查询 一般设备 其它入库   入库主表数据
				Map<String,Object> map= assInRestMainGeneralMapper.queryAssInRestGeneralPrintTemlateByMain(entityMap);
				//查询 一般设备 其它入库    入库明细表数据
				List<Map<String,Object>> list= assInRestMainGeneralMapper.queryAssInRestGeneralPrintTemlateByDetail(entityMap);
	...
	public List<String> queryAssInRestGeneralState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return assInRestMainGeneralMapper.queryAssInRestGeneralState(mapVo);
	}
	 ...
	 */
	@Override
	public String initAssInRestBatchCardGeneral(Map<String, Object> map) throws DataAccessException {
		List<Map<String, Object>> listVo = new ArrayList<Map<String, Object>>();
		List<Map<String, Object>> reSourceListVo = new ArrayList<Map<String, Object>>();
		try {
			String basePath = "ass";
	...
	public String queryDetails(Map<String, Object> entityMap)
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assInRestMainGeneralMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assInRestMainGeneralMapper.queryDetails(entityMap, rowBounds);
