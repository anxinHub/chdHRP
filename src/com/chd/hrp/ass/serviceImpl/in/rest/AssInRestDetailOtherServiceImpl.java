...
@Service("assInRestDetailOtherService")
public class AssInRestDetailOtherServiceImpl implements AssInRestDetailOtherService {

	private static Logger logger = Logger.getLogger(AssInRestDetailOtherServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssInRestDetailOther assInRestDetailOther = queryByCode(entityMap);

		if (assInRestDetailOther != null) {
		...
		try {
			...
			int state = assInRestDetailOtherMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assInRestDetailOtherMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assInRestDetailOtherMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assInRestDetailOtherMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assInRestDetailOtherMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			List<AssInRestDetailOther> list = (List<AssInRestDetailOther>)assInRestDetailOtherMapper.queryExists(inMapVo);
			
			double in_money=0;
			if(list != null){
				for(AssInRestDetailOther temp :  list ){
					in_money += temp.getPrice() * temp.getIn_amount();
				}
			}
			inMapVo.put("in_money", in_money+"");
			assInRestMainOtherMapper.updateInMoney(inMapVo);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssInRestDetailOther> list = (List<AssInRestDetailOther>)assInRestDetailOtherMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssInRestDetailOther> list = (List<AssInRestDetailOther>)assInRestDetailOtherMapper.query(entityMap);
			...
			List<AssInRestDetailOther> list = (List<AssInRestDetailOther>)assInRestDetailOtherMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assInRestDetailOtherMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssInRestDetailOther
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assInRestDetailOtherMapper.queryByUniqueness(entityMap);
	}
