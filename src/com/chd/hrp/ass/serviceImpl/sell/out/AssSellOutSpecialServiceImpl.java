...
@Service("assSellOutSpecialService")
public class AssSellOutSpecialServiceImpl implements AssSellOutSpecialService {

	private static Logger logger = Logger.getLogger(AssSellOutSpecialServiceImpl.class);
	// 引入DAO操作
	...
	/**
	 * @Description 添加050901 资产有偿调拨出库单主表（专用设备）<BR>
	 * @param entityMap
	 * @return String JSON
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		// 获取对象050901 资产有偿调拨出库单主表（专用设备）
		AssSellOutSpecial assSellOutSpecial = queryByCode(entityMap);
		...
		try {
			...
			int state = assSellOutSpecialMapper.add(entityMap);
	...
	/**
	 * @Description 批量添加050901 资产有偿调拨出库单主表（专用设备）<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assSellOutSpecialMapper.addBatch(entityList);
	...
	/**
	 * @Description 更新050901 资产有偿调拨出库单主表（专用设备）<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assSellOutSpecialMapper.update(entityMap);
	...
	/**
	 * @Description 批量更新050901 资产有偿调拨出库单主表（专用设备）<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assSellOutSpecialMapper.updateBatch(entityList);
	...
	/**
	 * @Description 删除050901 资产有偿调拨出库单主表（专用设备）<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assSellOutSpecialMapper.delete(entityMap);
	...
	/**
	 * @Description 批量删除050901 资产有偿调拨出库单主表（专用设备）<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assSellOutSpecialMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssSellOutSpecial> list = (List<AssSellOutSpecial>) assSellOutSpecialMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			if (list.size() > 0) {
				assSellOutSpecialMapper.update(entityMap);
			} else {
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_SELL_OUT_SPECIAL");
				String sell_out_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("sell_out_no", sell_out_no);
				assSellOutSpecialMapper.add(entityMap);
			...
			assSellOutSourceSpecialMapper.delete(entityMap);
			assSellOutDetailSpecialMapper.delete(entityMap);
			assSellOutDetailSpecialMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assSellOutSourceSpecialMapper.addBatch(listSourceVo);
			}
			...
			assSellOutSpecialMapper.updateSellOutMoney(entityMap);
	...
	/**
	 * @Description 查询结果集050901 资产有偿调拨出库单主表（专用设备）<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssSellOutSpecial> list = (List<AssSellOutSpecial>) assSellOutSpecialMapper.query(entityMap);
	...
	/**
	 * @Description 获取对象050901 资产有偿调拨出库单主表（专用设备）<BR>
	 * @param entityMap<BR>
	 *            参数为主键
	 * @return String JSON
	 * @throws DataAccessException
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutSpecialMapper.queryByCode(entityMap);
	}

	/**
	 * @Description 获取050901 资产有偿调拨出库单主表（专用设备）<BR>
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssSellOutSpecial
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutSpecialMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssSellOutSpecial>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutSpecialMapper.queryExists(entityMap);
	}
	...
	public String collectAssAllotOutSpecial(Map<String, Object> entityMap) {
		...
		assSellOutSpecialMapper.collectAssSellOutSpecial(entityMap);
	...
	public String updateSellOutConfirm(List<Map<String, Object>> entityMap, List<Map<String, Object>> cardEntityMap)
			throws DataAccessException {
		try {
			assSellOutSpecialMapper.updateConfirm(entityMap);
			assCardSpecialMapper.updateSellOutConfirm(cardEntityMap);
	...
	public String queryBySellInImport(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssSellOutSpecial> list = (List<AssSellOutSpecial>)assSellOutSpecialMapper.queryBySellInImport(entityMap);
			...
			List<AssSellOutSpecial> list = (List<AssSellOutSpecial>)assSellOutSpecialMapper.queryBySellInImport(entityMap, rowBounds);
	...
	public String queryBySellInImportView(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssSellOutSpecial> list = (List<AssSellOutSpecial>)assSellOutSpecialMapper.queryBySellInImportView(entityMap);
			...
			List<AssSellOutSpecial> list = (List<AssSellOutSpecial>)assSellOutSpecialMapper.queryBySellInImportView(entityMap, rowBounds);
	...
	/**
	 * 专用设备 资产调拨出库 新版打印  调用的方法
	 * @param entityMap
	 * @return
	 * @throws DataAccessException
	 */
	@Override
	public Map<String, Object> queryAssSellOutSpecialByPrintTemlatePrint(Map<String, Object> entityMap)throws DataAccessException {
		
		try{
			
			Map<String,Object> reMap=new HashMap<String,Object>();
			WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
			AssSellOutSpecialMapper assSellOutSpecialMapper = (AssSellOutSpecialMapper)context.getBean("assSellOutSpecialMapper");
			 
			//主页面 批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				
				//查询 专用设备 资产调拨出库 主表数据
				List<Map<String,Object>> map= assSellOutSpecialMapper.queryAssSellOutSpecialPrintTemlateByMainBatch(entityMap);
				//查询 专用设备 资产调拨出库 明细表数据
				List<Map<String,Object>> list= assSellOutSpecialMapper.queryAssSellOutSpecialPrintTemlateByDetail(entityMap);
				...
				//查询 专用设备 资产调拨出库 主表数据
				Map<String,Object> map= assSellOutSpecialMapper.queryAssSellOutSpecialPrintTemlateByMain(entityMap);
				//查询 专用设备 资产调拨出库 明细表数据
				List<Map<String,Object>> list= assSellOutSpecialMapper.queryAssSellOutSpecialPrintTemlateByDetail(entityMap);
	...
	public List<String> queryAssSellOutSpecialState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return assSellOutSpecialMapper.queryAssSellOutSpecialState(mapVo);
	}
	...
	public String queryDetails(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assSellOutSpecialMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assSellOutSpecialMapper.queryDetails(entityMap, rowBounds);
