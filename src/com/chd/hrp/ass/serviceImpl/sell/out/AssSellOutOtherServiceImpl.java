...
@Service("assSellOutOtherService")
public class AssSellOutOtherServiceImpl implements AssSellOutOtherService {

	private static Logger logger = Logger.getLogger(AssSellOutOtherServiceImpl.class);
	// 引入DAO操作
	...
	/**
	 * @Description 添加050901 资产有偿调拨出库单主表（其他固定资产）<BR>
	 * @param entityMap
	 * @return String JSON
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		// 获取对象050901 资产有偿调拨出库单主表（其他固定资产）
		AssSellOutOther assSellOutOther = queryByCode(entityMap);
		...
		try {
			...
			int state = assSellOutOtherMapper.add(entityMap);
	...
	/**
	 * @Description 批量添加050901 资产有偿调拨出库单主表（其他固定资产）<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assSellOutOtherMapper.addBatch(entityList);
	...
	/**
	 * @Description 更新050901 资产有偿调拨出库单主表（其他固定资产）<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assSellOutOtherMapper.update(entityMap);
	...
	/**
	 * @Description 批量更新050901 资产有偿调拨出库单主表（其他固定资产）<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assSellOutOtherMapper.updateBatch(entityList);
	...
	/**
	 * @Description 删除050901 资产有偿调拨出库单主表（其他固定资产）<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assSellOutOtherMapper.delete(entityMap);
	...
	/**
	 * @Description 批量删除050901 资产有偿调拨出库单主表（其他固定资产）<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assSellOutOtherMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssSellOutOther> list = (List<AssSellOutOther>) assSellOutOtherMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			if (list.size() > 0) {
				assSellOutOtherMapper.update(entityMap);
			} else {
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_SELL_OUT_OTHER");
				String sell_out_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("sell_out_no", sell_out_no);
				assSellOutOtherMapper.add(entityMap);
			...
			assSellOutSourceOtherMapper.delete(entityMap);
			assSellOutDetailOtherMapper.delete(entityMap);
			assSellOutDetailOtherMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assSellOutSourceOtherMapper.addBatch(listSourceVo);
			}
			...
			assSellOutOtherMapper.updateSellOutMoney(entityMap);
	...
	/**
	 * @Description 查询结果集050901 资产有偿调拨出库单主表（其他固定资产）<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssSellOutOther> list = (List<AssSellOutOther>) assSellOutOtherMapper.query(entityMap);
	...
	/**
	 * @Description 获取对象050901 资产有偿调拨出库单主表（其他固定资产）<BR>
	 * @param entityMap<BR>
	 *            参数为主键
	 * @return String JSON
	 * @throws DataAccessException
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutOtherMapper.queryByCode(entityMap);
	}

	/**
	 * @Description 获取050901 资产有偿调拨出库单主表（其他固定资产）<BR>
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssSellOutOther
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutOtherMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssSellOutOther>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutOtherMapper.queryExists(entityMap);
	}
	...
	public String collectAssAllotOutOther(Map<String, Object> entityMap) {
		...
		assSellOutOtherMapper.collectAssSellOutOther(entityMap);
	...
	public String updateSellOutConfirm(List<Map<String, Object>> entityMap, List<Map<String, Object>> cardEntityMap)
			throws DataAccessException {
		try {
			assSellOutOtherMapper.updateConfirm(entityMap);
			assCardOtherMapper.updateSellOutConfirm(cardEntityMap);
	...
	public String queryBySellInImport(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssSellOutOther> list = (List<AssSellOutOther>)assSellOutOtherMapper.queryBySellInImport(entityMap);
			...
			List<AssSellOutOther> list = (List<AssSellOutOther>)assSellOutOtherMapper.queryBySellInImport(entityMap, rowBounds);
	...
	public String queryBySellInImportView(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssSellOutOther> list = (List<AssSellOutOther>)assSellOutOtherMapper.queryBySellInImportView(entityMap);
			...
			List<AssSellOutOther> list = (List<AssSellOutOther>)assSellOutOtherMapper.queryBySellInImportView(entityMap, rowBounds);
	...
	public Map<String, Object> queryAssSellOutOtherByPrintTemlatePrint(Map<String, Object> entityMap)throws DataAccessException {
		...
		try{
			...
			AssSellOutOtherMapper assSellOutOtherMapper = (AssSellOutOtherMapper)context.getBean("assSellOutOtherMapper");
			 
			//主页面 批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				
				//查询 其他固定资产 资产调拨出库 主表数据
				List<Map<String,Object>> map= assSellOutOtherMapper.queryAssSellOutOtherPrintTemlateByMainBatch(entityMap);
				//查询 其他固定资产 资产调拨出库 明细表数据
				List<Map<String,Object>> list= assSellOutOtherMapper.queryAssSellOutOtherPrintTemlateByDetail(entityMap);
				...
				//查询 其他固定资产 资产调拨出库 主表数据
				Map<String,Object> map= assSellOutOtherMapper.queryAssSellOutOtherPrintTemlateByMain(entityMap);
				//查询 其他固定资产 资产调拨出库 明细表数据
				List<Map<String,Object>> list= assSellOutOtherMapper.queryAssSellOutOtherPrintTemlateByDetail(entityMap);
	...
	public List<String> queryAssSellOutOtherState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return assSellOutOtherMapper.queryAssSellOutOtherState(mapVo);
	}
	...
	public String queryDetails(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assSellOutOtherMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assSellOutOtherMapper.queryDetails(entityMap, rowBounds);
