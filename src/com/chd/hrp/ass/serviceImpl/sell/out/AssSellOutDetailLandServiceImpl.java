...
@Service("assSellOutDetailLandService")
public class AssSellOutDetailLandServiceImpl implements AssSellOutDetailLandService {

	private static Logger logger = Logger.getLogger(AssSellOutDetailLandServiceImpl.class);
	// 引入DAO操作
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		AssSellOutDetailLand assSellOutDetailLand = queryByCode(entityMap);

		if (assSellOutDetailLand != null) {
		...
		try {
			...
			int state = assSellOutDetailLandMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assSellOutDetailLandMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assSellOutDetailLandMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assSellOutDetailLandMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assSellOutDetailLandMapper.delete(entityMap);
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		try {
			...
			List<AssSellOutDetailLand> list = (List<AssSellOutDetailLand>) assSellOutDetailLandMapper
					.queryExists(inMapVo);
			...
			if (list != null) {
				for (AssSellOutDetailLand temp : list) {
					price += temp.getPrice();
			...
			assSellOutLandMapper.updateSellOutMoney(inMapVo);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutDetailLandMapper.queryByCode(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssSellOutDetailLand
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutDetailLandMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssSellOutDetailLand>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutDetailLandMapper.queryExists(entityMap);
	}

	@Override
	public List<AssSellOutDetailLand> queryByAssSellOutNo(Map<String, Object> entityMap)
			throws DataAccessException {
		return assSellOutDetailLandMapper.queryBySellOutNo(entityMap);
	}
