...
@Service("assSellOutGeneralService")
public class AssSellOutGeneralServiceImpl implements AssSellOutGeneralService {

	private static Logger logger = Logger.getLogger(AssSellOutGeneralServiceImpl.class);
	// 引入DAO操作
	...
	/**
	 * @Description 添加050901 资产有偿调拨出库单主表（一般设备）<BR>
	 * @param entityMap
	 * @return String JSON
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		// 获取对象050901 资产有偿调拨出库单主表（一般设备）
		AssSellOutGeneral assSellOutGeneral = queryByCode(entityMap);
		...
		try {
			...
			int state = assSellOutGeneralMapper.add(entityMap);
	...
	/**
	 * @Description 批量添加050901 资产有偿调拨出库单主表（一般设备）<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assSellOutGeneralMapper.addBatch(entityList);
	...
	/**
	 * @Description 更新050901 资产有偿调拨出库单主表（一般设备）<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assSellOutGeneralMapper.update(entityMap);
	...
	/**
	 * @Description 批量更新050901 资产有偿调拨出库单主表（一般设备）<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assSellOutGeneralMapper.updateBatch(entityList);
	...
	/**
	 * @Description 删除050901 资产有偿调拨出库单主表（一般设备）<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assSellOutGeneralMapper.delete(entityMap);
	...
	/**
	 * @Description 批量删除050901 资产有偿调拨出库单主表（一般设备）<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			assSellOutSourceGeneralMapper.deleteBatch(entityList);
			assSellOutDetailGeneralMapper.deleteBatch(entityList);
			assSellOutGeneralMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssSellOutGeneral> list = (List<AssSellOutGeneral>) assSellOutGeneralMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			if (list.size() > 0) {
				assSellOutGeneralMapper.update(entityMap);
			} else {
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_SELL_OUT_GENERAL");
				String sell_out_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("sell_out_no", sell_out_no);
				assSellOutGeneralMapper.add(entityMap);
			...
			assSellOutSourceGeneralMapper.delete(entityMap);
			assSellOutDetailGeneralMapper.delete(entityMap);
			assSellOutDetailGeneralMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assSellOutSourceGeneralMapper.addBatch(listSourceVo);
			}
			...
			assSellOutGeneralMapper.updateSellOutMoney(entityMap);
	...
	/**
	 * @Description 查询结果集050901 资产有偿调拨出库单主表（一般设备）<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssSellOutGeneral> list = (List<AssSellOutGeneral>) assSellOutGeneralMapper.query(entityMap);
	...
	/**
	 * @Description 获取对象050901 资产有偿调拨出库单主表（一般设备）<BR>
	 * @param entityMap<BR>
	 *            参数为主键
	 * @return String JSON
	 * @throws DataAccessException
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutGeneralMapper.queryByCode(entityMap);
	}

	/**
	 * @Description 获取050901 资产有偿调拨出库单主表（一般设备）<BR>
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssSellOutGeneral
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutGeneralMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssSellOutGeneral>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutGeneralMapper.queryExists(entityMap);
	}
	...
	public String collectAssAllotOutGeneral(Map<String, Object> entityMap) {
		...
		assSellOutGeneralMapper.collectAssSellOutGeneral(entityMap);
	...
	public String updateSellOutConfirm(List<Map<String, Object>> entityMap, List<Map<String, Object>> cardEntityMap)
			throws DataAccessException {
		try {
			assSellOutGeneralMapper.updateConfirm(entityMap);
			assCardGeneralMapper.updateSellOutConfirm(cardEntityMap);
	...
	public String queryBySellInImport(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssSellOutGeneral> list = (List<AssSellOutGeneral>)assSellOutGeneralMapper.queryBySellInImport(entityMap);
			...
			List<AssSellOutGeneral> list = (List<AssSellOutGeneral>)assSellOutGeneralMapper.queryBySellInImport(entityMap, rowBounds);
	...
	public String queryBySellInImportView(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssSellOutGeneral> list = (List<AssSellOutGeneral>)assSellOutGeneralMapper.queryBySellInImportView(entityMap);
			...
			List<AssSellOutGeneral> list = (List<AssSellOutGeneral>)assSellOutGeneralMapper.queryBySellInImportView(entityMap, rowBounds);
	...
	public Map<String, Object> queryAssSellOutGeneralByPrintTemlatePrint(Map<String, Object> entityMap)throws DataAccessException {
		...
		try{
			...
			AssSellOutGeneralMapper assSellOutGeneralMapper = (AssSellOutGeneralMapper)context.getBean("assSellOutGeneralMapper");
			 
			//主页面 批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				
				//查询 一般设备 资产调拨出库 主表数据
				List<Map<String,Object>> map= assSellOutGeneralMapper.queryAssSellOutGeneralPrintTemlateByMainBatch(entityMap);
				//查询 一般设备 资产调拨出库 明细表数据
				List<Map<String,Object>> list= assSellOutGeneralMapper.queryAssSellOutGeneralPrintTemlateByDetail(entityMap);
				...
				//查询 一般设备 资产调拨出库 主表数据
				Map<String,Object> map= assSellOutGeneralMapper.queryAssSellOutGeneralPrintTemlateByMain(entityMap);
				//查询 一般设备 资产调拨出库 明细表数据
				List<Map<String,Object>> list= assSellOutGeneralMapper.queryAssSellOutGeneralPrintTemlateByDetail(entityMap);
	...
	public List<String> queryAssSellOutGeneralState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return assSellOutGeneralMapper.queryAssSellOutGeneralState(mapVo);
	}
	...
	public String queryDetails(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assSellOutGeneralMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assSellOutGeneralMapper.queryDetails(entityMap, rowBounds);
