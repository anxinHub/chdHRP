...
@Service("assSellOutLandService")
public class AssSellOutLandServiceImpl implements AssSellOutLandService {

	private static Logger logger = Logger.getLogger(AssSellOutLandServiceImpl.class);
	// 引入DAO操作
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		AssSellOutLand assSellOutLand = queryByCode(entityMap);
		...
		try {
			...
			int state = assSellOutLandMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assSellOutLandMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assSellOutLandMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assSellOutLandMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assSellOutLandMapper.delete(entityMap);
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			assSellOutSourceLandMapper.deleteBatch(entityList);
			assSellOutDetailLandMapper.deleteBatch(entityList);
			assSellOutLandMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssSellOutLand> list = (List<AssSellOutLand>) assSellOutLandMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			if (list.size() > 0) {
				assSellOutLandMapper.update(entityMap);
			} else {
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_SELL_OUT_LAND");
				String sell_out_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("sell_out_no", sell_out_no);
				assSellOutLandMapper.add(entityMap);
			...
			for (Map<String, Object> detailVo : detail) {
				...
				String results = collectAssAllotOutLand(detailVo);
			...
			assSellOutSourceLandMapper.delete(entityMap);
			assSellOutDetailLandMapper.delete(entityMap);
			assSellOutDetailLandMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assSellOutSourceLandMapper.addBatch(listSourceVo);
			}
			...
			assSellOutLandMapper.updateSellOutMoney(entityMap);
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssSellOutLand> list = (List<AssSellOutLand>) assSellOutLandMapper.query(entityMap);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutLandMapper.queryByCode(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssSellOutLand
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutLandMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssSellOutLand>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assSellOutLandMapper.queryExists(entityMap);
	}

	public String collectAssAllotOutLand(Map<String, Object> entityMap) {
		WebApplicationContext ctx = ContextLoader.getCurrentWebApplicationContext();
		...
		assSellOutLandMapper.collectAssSellOutLand(entityMap);
	...
	public String updateSellOutConfirm(List<Map<String, Object>> entityMap, List<Map<String, Object>> cardEntityMap)
			throws DataAccessException {
		try {
			assSellOutLandMapper.updateConfirm(entityMap);
			assCardLandMapper.updateSellOutConfirm(cardEntityMap);
	...
	public String queryBySellInImport(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssSellOutLand> list = (List<AssSellOutLand>) assSellOutLandMapper
	...
	@Override
	public Map<String,Object> printAssSellOutLandData(Map<String, Object> map)throws DataAccessException {
		
		try{
			Map<String,Object> reMap=new HashMap<String,Object>();
			WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
			AssSellOutLandMapper assSellOutLandMapper = (AssSellOutLandMapper)context.getBean("assSellOutLandMapper");
			
			//查询凭证主表
			List<Map<String,Object>> mainList=assSellOutLandMapper.queryAssSellOutLandByAssInNo(map);
					
			//查询凭证明细表
			List<Map<String,Object>> detailList=assSellOutLandMapper.queryAssSellOutLandDetailByAssInNo(map);
	 ...
	 */
	@Override
	public List<String> queryAssSellOutLandStates(Map<String, Object> mapVo) throws DataAccessException {
		
		return assSellOutLandMapper.queryAssSellOutLandStates(mapVo);
	}
	...
	public String queryDetails(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assSellOutLandMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assSellOutLandMapper.queryDetails(entityMap, rowBounds);
