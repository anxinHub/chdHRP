...
@Service("assSellInDetailOtherService")
public class AssSellInDetailOtherServiceImpl implements AssSellInDetailOtherService {

	private static Logger logger = Logger.getLogger(AssSellInDetailOtherServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象050901 资产有偿调拨入库明细(其他固定资产)
		AssSellInDetailOther assSellInDetailOther = queryByCode(entityMap);

		if (assSellInDetailOther != null) {
		...
		try {
			...
			int state = assSellInDetailOtherMapper.add(entityMap);
	...
	/**
	 * @Description 
	 * 批量添加050901 资产有偿调拨入库明细(其他固定资产)<BR> 
	 * @param  entityList
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assSellInDetailOtherMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assSellInDetailOtherMapper.update(entityMap);
	...
	/**
	 * @Description 
	 * 批量更新050901 资产有偿调拨入库明细(其他固定资产)<BR> 
	 * @param  entityList
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assSellInDetailOtherMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assSellInDetailOtherMapper.delete(entityMap);
	...
	/**
	 * @Description 
	 * 批量删除050901 资产有偿调拨入库明细(其他固定资产)<BR> 
	 * @param  entityList
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		try {
			...
			List<AssSellInDetailOther> list = (List<AssSellInDetailOther>)assSellInDetailOtherMapper.queryExists(inMapVo);
			...
			if(list != null){
				for(AssSellInDetailOther temp :  list ){
					price += temp.getPrice();
			...
			assSellInOtherMapper.updateInMoney(inMapVo);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		//判断是否存在对象050901 资产有偿调拨入库明细(其他固定资产)
		...
		List<AssSellInDetailOther> list = (List<AssSellInDetailOther>)assSellInDetailOtherMapper.queryExists(mapVo);
	...
	/**
	 * @Description 
	 * 查询结果集050901 资产有偿调拨入库明细(其他固定资产)<BR> 
	 * @param  entityMap
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssSellInDetailOther> list = (List<AssSellInDetailOther>)assSellInDetailOtherMapper.query(entityMap);
			...
			List<AssSellInDetailOther> list = (List<AssSellInDetailOther>)assSellInDetailOtherMapper.query(entityMap, rowBounds);
	...
	/**
	 * @Description 
	 * 获取对象050901 资产有偿调拨入库明细(其他固定资产)<BR> 
	 * @param  entityMap<BR>
	 *  参数为主键
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assSellInDetailOtherMapper.queryByCode(entityMap);
	}
	
	/**
	 * @Description 
	 * 获取050901 资产有偿调拨入库明细(其他固定资产)<BR> 
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssSellInDetailOther
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assSellInDetailOtherMapper.queryByUniqueness(entityMap);
	}
