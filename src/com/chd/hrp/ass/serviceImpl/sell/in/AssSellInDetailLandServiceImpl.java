...
@Service("assSellInDetailLandService")
public class AssSellInDetailLandServiceImpl implements AssSellInDetailLandService {

	private static Logger logger = Logger.getLogger(AssSellInDetailLandServiceImpl.class);
	// 引入DAO操作
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		AssSellInDetailLand assSellInDetailLand = queryByCode(entityMap);

		if (assSellInDetailLand != null) {
		...
		try {
			...
			int state = assSellInDetailLandMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assSellInDetailLandMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assSellInDetailLandMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assSellInDetailLandMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assSellInDetailLandMapper.delete(entityMap);
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		try {
			...
			List<AssSellInDetailLand> list = (List<AssSellInDetailLand>) assSellInDetailLandMapper
					.queryExists(inMapVo);
			...
			if (list != null) {
				for (AssSellInDetailLand temp : list) {
					price += temp.getPrice();
			...
			assSellInLandMapper.updateInMoney(inMapVo);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assSellInDetailLandMapper.queryByCode(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssSellInDetailLand
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assSellInDetailLandMapper.queryByUniqueness(entityMap);
	}
