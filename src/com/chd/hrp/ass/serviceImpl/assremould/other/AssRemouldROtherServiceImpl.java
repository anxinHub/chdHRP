...
import com.chd.hrp.ass.dao.assremould.other.AssRemouldROtherMapper;
 ...
 * @Table: ASS_REMOULD_R_Other
 * @Author: bell
 * @email: bell@e-tonggroup.com
 * @Version: 1.0
 */
@Service("assRemouldROtherService")
public class AssRemouldROtherServiceImpl implements AssRemouldROtherService {
 
	private static Logger logger = Logger.getLogger(AssRemouldROtherServiceImpl.class);
	// 引入DAO操作 主表
	@Resource(name = "assRemouldROtherMapper")
	private final AssRemouldROtherMapper assRemouldROtherMapper = null;
	// 明细表
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		AssRemouldROther assRemouldROther = queryByCode(entityMap);

		if (assRemouldROther != null) {
		...
		try {
			...
			int state = assRemouldROtherMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assRemouldROtherMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assRemouldROtherMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assRemouldROtherMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assRemouldROtherMapper.delete(entityMap);
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assRemouldROtherMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssChangeOther> list = (List<AssChangeOther>) assRemouldROtherMapper.queryExists(mapVo);
		boolean flag = true;
		try {
			if (list.size() > 0) {
				assRemouldROtherMapper.update(entityMap);
			} else {
				// 调公用方法 生成单号
				...
				entityMap.put("bill_table", "ASS_REMOULD_R_OTHER");
				String record_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("record_no", record_no);
				assRemouldROtherMapper.add(entityMap);
				assBaseService.updateAssBillNoMaxNo(entityMap);
			}
			// 取页面卡片数据
			List<Map> detail = ChdJson.fromJsonAsList(Map.class, entityMap.get("ParamVo").toString());
			// 取明细表卡片呢数据
			List<Map<String, Object>> detailList = assRemouldRdetailOtherMapper.queryByRecordNoMap(mapVo);
			...
			if (detSourceList.size() > 0) {
				assRemouldRsourceOtherMapper.deleteBatch(detSourceList);
			}
			...
			for (Map<String, Object> detailVo : detail) {
				...
				List<Map<String, Object>> existsSource = assRemouldRsourceOtherMapper
			...
			assRemouldRsourceOtherMapper.delete(entityMap);
			assRemouldRdetailOtherMapper.delete(entityMap);
			assRemouldRdetailOtherMapper.addBatch(listVo);

			if (sourceList.size() > 0) {
				assRemouldRsourceOtherMapper.deleteBatch(sourceList);
				assRemouldRsourceOtherMapper.addBatch(sourceList);
			}
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssRemouldROther> list = (List<AssRemouldROther>) assRemouldROtherMapper.query(entityMap);
			...
			List<AssRemouldROther> list = (List<AssRemouldROther>) assRemouldROtherMapper.query(entityMap, rowBounds);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assRemouldROtherMapper.queryByCode(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssRemouldROther
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assRemouldROtherMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssRemouldROther>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assRemouldROtherMapper.queryExists(entityMap);
	}

	@Override
	public String queryAssRemouldSourceOther(Map<String, Object> mapVo) {
		List<Map<String, Object>> list = assRemouldRsourceOtherMapper.queryAssRemouldSourceOther(mapVo);
		return ChdJson.toJson(list);
	}

	@Override
	public String queryAssRemouldRdetailOther(Map<String, Object> mapVo) {
		List<Map<String, Object>> list = assRemouldRdetailOtherMapper.queryByRecordNoMap(mapVo);
		return ChdJson.toJson(list);
	}

	@Override
	public String saveAssRemouldRSourceOther(Map<String, Object> entityMap) {
		List<Map<String, Object>> listVo = new ArrayList<Map<String, Object>>();
		List<Map> detail = ChdJson.fromJsonAsList(Map.class, entityMap.get("ParamVo").toString());
		Double change_price = 0.0;
		Double price = 0.0;
		try {
			...
			assRemouldRsourceOtherMapper.delete(entityMap);
			assRemouldRsourceOtherMapper.addBatch(listVo);

			entityMap.put("change_price", change_price + "");

			assRemouldRdetailOtherMapper.updatePriceBySource(entityMap);
	...
	@Override
	public String updateAssRemouldAOtherConfirmState(List<Map<String, Object>> listVo,
			List<Map<String, Object>> listCardVo) {

		try {
			assRemouldROtherMapper.updateConfirmAssRemouldROther(listVo);
			assCardOtherMapper.updateRemouldROtherConfirm(listCardVo);
	...
	// 删除资金来源
	@Override
	public String deleteAssSourceOther(List<Map<String, Object>> entityMap) {
		try {
			assRemouldRsourceOtherMapper.deleteBatch(entityMap);
			...
			List<Map<String, Object>> listMap = assRemouldRsourceOtherMapper.queryChangeSourceByAssCardNo(mapVo);
			...
			assRemouldRdetailOtherMapper.updatePriceBySource(mapVo);
	 ...
	 */
	@Override
	public String initAssCheckother(Map<String, Object> entityMap) {
		...
		try {
			...
			List<AssRemouldAdetailOther> assRemouldAdetail = (List<AssRemouldAdetailOther>) assRemouldAdetailOtherMapper
					.query(entityMap);
			entityMap.put("bill_table", "ASS_REMOULD_R_OTHER");
			// 调公用方法 生成单号
			String record_no = assBaseService.getBillNOSeqNo(entityMap);
			...
			for (String temp : carno.toString().split(",")) {// 循环生成单据的明细ID
				...
				assRemouldROtherMapper.addAssPlanDeptImportBid(planApplyMapvo);
			}

			assBaseService.updateAssBillNoMaxNo(entityMap);

			for (AssRemouldAdetailOther assRemouldAdetail2 : assRemouldAdetail) {
				...
				String results = collectAssRemoildRother(map);
			...
			if (detSourceList.size() > 0) {
				// assRemouldRsourceotherMapper.deleteBatch(detSourceList);
				assRemouldRsourceOtherMapper.addBatch(detSourceList);
			}
			transactionManager.commit(status);
	...
	public String collectAssRemoildRother(Map<String, Object> entityMap) {
		WebApplicationContext ctx = ContextLoader.getCurrentWebApplicationContext();
		...
		assRemouldROtherMapper.collectAssRemoildRother(entityMap);
	...
	public String deleteBatchAssApplyPlanMap(List<Map<String, Object>> listVo) {
		try {
			...
			assRemouldROtherMapper.deleteBatchAssApplyPlanMap(listVo);
			return "{\"msg\":\"删除成功.\",\"state\":\"true\"}";
