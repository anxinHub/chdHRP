...
import com.chd.hrp.ass.dao.assremould.other.AssRemouldAOtherMapper;
...
@Service("assRemouldAOtherService")
public class AssRemouldAOtherServiceImpl implements AssRemouldAOtherService {

	private static Logger logger = Logger.getLogger(AssRemouldAOtherServiceImpl.class);
	//引入DAO操作//资产改造申报主表
	@Resource(name = "assRemouldAOtherMapper")
	private final AssRemouldAOtherMapper assRemouldAOtherMapper = null;
...
//		vVenMap.put("use_state", "1,2,3,4,5");
		...
		List<AssBackOther> list = (List<AssBackOther>) assRemouldAOtherMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			//boolean flag2 = true;
			if (list.size() > 0) {
				assRemouldAOtherMapper.update(entityMap);
			} else {
				entityMap.put("bill_table", "ASS_REMOULD_A_OTHER");
				String apply_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("apply_no", apply_no);
				assRemouldAOtherMapper.add(entityMap);
		...
		/*	if(!flag2){
			...
			Map<String, Object> vVenMapp = new HashMap<String, Object>();
			vVenMapp.put("group_id", entityMap.get("group_id"));
			vVenMapp.put("hos_id", entityMap.get("hos_id"));
			vVenMapp.put("copy_code", entityMap.get("copy_code"));
			vVenMapp.put("apply_no", entityMap.get("apply_no"));
			assRemouldAsourceOtherMapper.delete(vVenMapp);
			assRemouldAdetailOtherMapper.delete(entityMap);//明细表
			assRemouldAdetailOtherMapper.addBatch(listVo);//明细表
			if (listSourceVo.size() > 0) {
				assRemouldAsourceOtherMapper.deleteBatch(listSourceVo);
				assRemouldAsourceOtherMapper.addBatch(listSourceVo);//资金来源表
	...
	public String collectAssBackOther(Map<String, Object> entityMap) {
		...
		assRemouldAOtherMapper.collectAssBackOther(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assRemouldAOtherMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assRemouldAOtherMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assRemouldAOtherMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assRemouldAOtherMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assRemouldAdetailOtherMapper.deleteBatch(entityList);//明细表
			
			assRemouldAOtherMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssRemouldAdetailOther> list = (List<AssRemouldAdetailOther>)assRemouldAOtherMapper.queryExists(mapVo);
		...
		try {
			...
			int state = assRemouldAOtherMapper.add(entityMap);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssRemouldAdetailOther> list = (List<AssRemouldAdetailOther>)assRemouldAOtherMapper.query(entityMap);
			...
			List<AssRemouldAdetailOther> list = (List<AssRemouldAdetailOther>)assRemouldAOtherMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAOtherMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssRemouldAOther
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAOtherMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssRemouldAOther>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAOtherMapper.queryExists(entityMap);
	}

	@Override
	public String queryAssRemouldADict(Map<String, Object> entityMap) {
		List<Map<String,Object>> list = (List<Map<String,Object>>) assRemouldAdetailOtherMapper.queryAssRemouldADict(entityMap);
		return ChdJson.toJson(list);
	}
	...
	public String updateAssRemouldAOtherConfirmState(List<Map<String, Object>> listVo,
		...
		try {
		assRemouldAOtherMapper.updateAssRemouldAOtherConfirmState(listVo);
		assCardOtherMapper.updateAssRemouldAOtherConfirmState(listCardVo);
		return "{\"msg\":\"更新成功.\",\"state\":\"true\"}";
	} catch (Exception e) {
	...
	public String queryAssApplyDeptByPlanDept(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssRemouldAOther> list = assRemouldAOtherMapper.queryAssApplyDeptByPlanDept(entityMap);
			...
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<AssRemouldAOther> list = assRemouldAOtherMapper.queryAssApplyDeptByPlanDept(entityMap, rowBounds);
