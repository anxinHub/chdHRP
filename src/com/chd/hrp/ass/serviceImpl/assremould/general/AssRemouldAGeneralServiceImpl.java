...
import com.chd.hrp.ass.dao.assremould.general.AssRemouldAGeneralMapper;
...
@Service("assRemouldAGeneralService")
public class AssRemouldAGeneralServiceImpl implements AssRemouldAGeneralService {

	private static Logger logger = Logger.getLogger(AssRemouldAGeneralServiceImpl.class);
	//引入DAO操作//资产改造申报主表
	@Resource(name = "assRemouldAGeneralMapper")
	private final AssRemouldAGeneralMapper assRemouldAGeneralMapper = null;
...
/*		Map<String, Object> vVenMap = new HashMap<String, Object>();
	...
	/*	vVenMap.put("ven_id", entityMap.get("ven_id"));
		...
		List<AssBackGeneral> list = (List<AssBackGeneral>) assRemouldAGeneralMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			//boolean flag2 = true;
			if (list.size() > 0) {
				assRemouldAGeneralMapper.update(entityMap);
			} else {
				entityMap.put("bill_table", "ASS_REMOULD_A_GENERAL");
				String apply_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("apply_no", apply_no);
				assRemouldAGeneralMapper.add(entityMap);
	...
	/*		if(!flag2){
			...
			assRemouldAdetailGeneralMapper.delete(entityMap);//明细表
			assRemouldAdetailGeneralMapper.addBatch(listVo);//明细表
			if (listSourceVo.size() > 0) {
				assRemouldAsourceGeneralMapper.deleteBatch(listSourceVo);
				assRemouldAsourceGeneralMapper.addBatch(listSourceVo);//资金来源表
	...
	public String collectAssBackGeneral(Map<String, Object> entityMap) {
		...
		assRemouldAGeneralMapper.collectAssBackGeneral(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assRemouldAGeneralMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assRemouldAGeneralMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assRemouldAGeneralMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assRemouldAGeneralMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assRemouldAdetailGeneralMapper.deleteBatch(entityList);//明细表
			
			assRemouldAGeneralMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssRemouldAdetailGeneral> list = (List<AssRemouldAdetailGeneral>)assRemouldAGeneralMapper.queryExists(mapVo);
		...
		try {
			...
			int state = assRemouldAGeneralMapper.add(entityMap);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssRemouldAdetailGeneral> list = (List<AssRemouldAdetailGeneral>)assRemouldAGeneralMapper.query(entityMap);
			...
			List<AssRemouldAdetailGeneral> list = (List<AssRemouldAdetailGeneral>)assRemouldAGeneralMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAGeneralMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssRemouldAGeneral
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAGeneralMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssRemouldAGeneral>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAGeneralMapper.queryExists(entityMap);
	}

	@Override
	public String queryAssRemouldADict(Map<String, Object> entityMap) {
		List<Map<String,Object>> list = (List<Map<String,Object>>) assRemouldAdetailGeneralMapper.queryAssRemouldADict(entityMap);
		return ChdJson.toJson(list);
	}
	...
	public String updateAssRemouldAGeneralConfirmState(List<Map<String, Object>> listVo,
		...
		try {
			assRemouldAGeneralMapper.updateAssRemouldAGeneralConfirmState(listVo);
			assCardGeneralMapper.updateAssRemouldAGeneralConfirmState(listCardVo);
	...
	public String queryAssApplyDeptByPlanDept(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssRemouldAGeneral> list = assRemouldAGeneralMapper.queryAssApplyDeptByPlanDept(entityMap);
			...
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<AssRemouldAGeneral> list = assRemouldAGeneralMapper.queryAssApplyDeptByPlanDept(entityMap, rowBounds);
