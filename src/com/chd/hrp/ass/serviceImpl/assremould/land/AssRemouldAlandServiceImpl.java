...
import com.chd.hrp.ass.dao.assremould.land.AssRemouldAlandMapper;
...
@Service("assRemouldAlandService")
public class AssRemouldAlandServiceImpl implements AssRemouldAlandService {

	private static Logger logger = Logger.getLogger(AssRemouldAlandServiceImpl.class);
	//引入DAO操作//资产改造申报主表
	@Resource(name = "assRemouldAlandMapper")
	private final AssRemouldAlandMapper assRemouldAlandMapper = null;
	...
	*/
	...
	/*	Map<String, Object> vVenMap = new HashMap<String, Object>();
		...
		List<AssBackLand> list = (List<AssBackLand>) assRemouldAlandMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			//boolean flag2 = true;
			if (list.size() > 0) {
				assRemouldAlandMapper.update(entityMap);
			} else {
				entityMap.put("bill_table", "ASS_REMOULD_A_LAND");
				String apply_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("apply_no", apply_no);
				assRemouldAlandMapper.add(entityMap);
		...
		/*	if(!flag2){
			...
			*/
			...
			assRemouldAdetailLandMapper.delete(entityMap);//明细表
			assRemouldAdetailLandMapper.addBatch(listVo);//明细表
			if (listSourceVo.size() > 0) {
				assRemouldAsourceLandMapper.deleteBatch(listSourceVo);
				assRemouldAsourceLandMapper.addBatch(listSourceVo);//资金来源表
	...
	public String collectAssBackLand(Map<String, Object> entityMap) {
		...
		assRemouldAlandMapper.collectAssBackLand(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assRemouldAlandMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assRemouldAlandMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assRemouldAlandMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assRemouldAlandMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assRemouldAdetailLandMapper.deleteBatch(entityList);//明细表
			
			assRemouldAlandMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssRemouldAland> list = (List<AssRemouldAland>)assRemouldAlandMapper.queryExists(mapVo);
		...
		try {
			...
			int state = assRemouldAlandMapper.add(entityMap);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssRemouldAland> list = (List<AssRemouldAland>)assRemouldAlandMapper.query(entityMap);
			...
			List<AssRemouldAland> list = (List<AssRemouldAland>)assRemouldAlandMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAlandMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssRemouldAland
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAlandMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssRemouldAland>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAlandMapper.queryExists(entityMap);
	}

	@Override
	public String queryAssRemouldADict(Map<String, Object> entityMap) {
		List<Map<String,Object>> list = (List<Map<String,Object>>) assRemouldAdetailLandMapper.queryAssRemouldADict(entityMap);
		return ChdJson.toJson(list);
	}
	...
	public String updateAssRemouldALandConfirmState(List<Map<String, Object>> listVo,
		...
		try {
		assRemouldAlandMapper.updateAssRemouldAlandConfirmState(listVo);
		assCardLandMapper.updateAssRemouldAlandConfirmState(listCardVo);
		return "{\"msg\":\"更新成功.\",\"state\":\"true\"}";
	} catch (Exception e) {
	...
	public String queryAssApplyDeptByPlanDept(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssRemouldAland> list = assRemouldAlandMapper.queryAssApplyDeptByPlanDept(entityMap);
			...
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<AssRemouldAland> list = assRemouldAlandMapper.queryAssApplyDeptByPlanDept(entityMap, rowBounds);
