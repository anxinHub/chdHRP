...
import com.chd.hrp.ass.dao.assremould.inassets.AssRemouldAinassetsMapper;
import com.chd.hrp.ass.dao.assremould.inassets.AssRemouldAsourceInassetsMapper;
...
@Service("assRemouldAinassetsService")
public class AssRemouldAinassetsServiceImpl implements AssRemouldAinassetsService {

	private static Logger logger = Logger.getLogger(AssRemouldAinassetsServiceImpl.class);
	//引入DAO操作//资产改造申报主表
	@Resource(name = "assRemouldAinassetsMapper")
	private final AssRemouldAinassetsMapper assRemouldAinassetsMapper = null;
	//引入DAO操作 //资产资金来源匹配表_专业设备表 
	@Resource(name = "assRemouldAsourceInassetsMapper")
	private final AssRemouldAsourceInassetsMapper assRemouldAsourceInassetsMapper = null;
	...
	*/
	...
	/*	vVenMap.put("ven_id", entityMap.get("ven_id"));
		...
		List<AssBackInassets> list = (List<AssBackInassets>) assRemouldAinassetsMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			//boolean flag2 = true;
			if (list.size() > 0) {
				assRemouldAinassetsMapper.update(entityMap);
			} else {
				entityMap.put("bill_table", "ASS_REMOULD_A_INASSETS");
				String apply_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("apply_no", apply_no);
				assRemouldAinassetsMapper.add(entityMap);
	...
	/*		if(!flag2){
			...
			*/
			...
			assRemouldAdetailInassetsMapper.delete(entityMap);//明细表
			assRemouldAdetailInassetsMapper.addBatch(listVo);//明细表
			if (listSourceVo.size() > 0) {
				assRemouldAsourceInassetsMapper.deleteBatch(listSourceVo);
				assRemouldAsourceInassetsMapper.addBatch(listSourceVo);//资金来源表
	...
	public String collectAssBackInassets(Map<String, Object> entityMap) {
		...
		assRemouldAinassetsMapper.collectAssBackInassets(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assRemouldAinassetsMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assRemouldAinassetsMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assRemouldAinassetsMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assRemouldAinassetsMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assRemouldAdetailInassetsMapper.deleteBatch(entityList);//明细表
			
			assRemouldAinassetsMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssRemouldAinassets> list = (List<AssRemouldAinassets>)assRemouldAinassetsMapper.queryExists(mapVo);
		...
		try {
			...
			int state = assRemouldAinassetsMapper.add(entityMap);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssRemouldAinassets> list = (List<AssRemouldAinassets>)assRemouldAinassetsMapper.query(entityMap);
			...
			List<AssRemouldAinassets> list = (List<AssRemouldAinassets>)assRemouldAinassetsMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAinassetsMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssRemouldAinassets
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAinassetsMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssRemouldAinassets>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAinassetsMapper.queryExists(entityMap);
	}

	@Override
	public String queryAssRemouldADict(Map<String, Object> entityMap) {
		List<Map<String,Object>> list = (List<Map<String,Object>>) assRemouldAdetailInassetsMapper.queryAssRemouldADict(entityMap);
		return ChdJson.toJson(list);
	}
	...
	public String updateAssRemouldAInassetsConfirmState(List<Map<String, Object>> listVo,
		...
		try {
			assRemouldAinassetsMapper.updateAssRemouldAinassetsConfirmState(listVo);
			assCardInassetsMapper.updateAssRemouldAinassetsConfirmState(listCardVo);
			return "{\"msg\":\"更新成功.\",\"state\":\"true\"}";
		} catch (Exception e) {
	...
	public String queryAssApplyDeptByPlanDept(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssRemouldAinassets> list = assRemouldAinassetsMapper.queryAssApplyDeptByPlanDept(entityMap);
			...
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<AssRemouldAinassets> list = assRemouldAinassetsMapper.queryAssApplyDeptByPlanDept(entityMap, rowBounds);
