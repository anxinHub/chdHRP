...
@Service("assRemouldAspecialService")
public class AssRemouldAspecialServiceImpl implements AssRemouldAspecialService {

	private static Logger logger = Logger.getLogger(AssRemouldAspecialServiceImpl.class);
	//引入DAO操作//资产改造申报主表
...
//		vVenMap.put("use_state", "1,2,3,4,5");
		...
		List<AssBackSpecial> list = (List<AssBackSpecial>) assRemouldAspecialMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			//boolean flag2 = true;
			if (list.size() > 0) {
				assRemouldAspecialMapper.update(entityMap);
			} else {
				...
				assRemouldAspecialMapper.add(entityMap);
			...
			assRemouldAdetailMapper.delete(entityMap);//明细表
			assRemouldAdetailMapper.addBatch(listVo);//明细表
			if (listSourceVo.size() > 0) {
				assRemouldAsourceSpecialMapper.deleteBatch(listSourceVo);
				assRemouldAsourceSpecialMapper.addBatch(listSourceVo);//资金来源表
	...
	public String collectAssBackSpecial(Map<String, Object> entityMap) {
		...
		assRemouldAspecialMapper.collectAssBackSpecial(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assRemouldAspecialMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assRemouldAspecialMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assRemouldAspecialMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assRemouldAspecialMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assRemouldAdetailMapper.deleteBatch(entityList);//明细表
			
			assRemouldAspecialMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssRemouldAspecial> list = (List<AssRemouldAspecial>)assRemouldAspecialMapper.queryExists(mapVo);
		...
		try {
			...
			int state = assRemouldAspecialMapper.add(entityMap);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssRemouldAspecial> list = (List<AssRemouldAspecial>)assRemouldAspecialMapper.query(entityMap);
			...
			List<AssRemouldAspecial> list = (List<AssRemouldAspecial>)assRemouldAspecialMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAspecialMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssRemouldAspecial
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAspecialMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssRemouldAspecial>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assRemouldAspecialMapper.queryExists(entityMap);
	}

	@Override
	public String queryAssRemouldADict(Map<String, Object> entityMap) {
		List<Map<String,Object>> list = (List<Map<String,Object>>) assRemouldAdetailMapper.queryAssRemouldADict(entityMap);
		return ChdJson.toJson(list);
	}
//审核
	@Override
	public String updateAssRemouldAspecialConfirmState(List<Map<String, Object>> listVo,List<Map<String, Object>> listCardVo) throws DataAccessException {
		try {
			assRemouldAspecialMapper.updateAssRemouldAspecialConfirmState(listVo);
			assCardSpecialMapper.updateAssRemouldAspecialConfirmState(listCardVo);
			return "{\"msg\":\"更新成功.\",\"state\":\"true\"}";
		} catch (Exception e) {
	...
	public String queryAssApplyDeptByPlanDept(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssRemouldAspecial> list = assRemouldAspecialMapper.queryAssApplyDeptByPlanDept(entityMap);
			...
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<AssRemouldAspecial> list = assRemouldAspecialMapper.queryAssApplyDeptByPlanDept(entityMap, rowBounds);
