...
import com.chd.hrp.ass.dao.tran.store.AssTranStoreDetailSpecialMapper;
...
@Service("assTranStoreSpecialService")
public class AssTranStoreSpecialServiceImpl implements AssTranStoreSpecialService {

	private static Logger logger = Logger.getLogger(AssTranStoreSpecialServiceImpl.class);
	//引入DAO操作
	@Resource(name = "assTranStoreSpecialMapper")
	private final AssTranStoreSpecialMapper assTranStoreSpecialMapper = null;
	
	@Resource(name = "assTranStoreDetailSpecialMapper")
	private final AssTranStoreDetailSpecialMapper assTranStoreDetailSpecialMapper = null;
	...
	/**
	 * @Description 
	 * 添加050901 资产转移主表(仓库到仓库)_专用设备<BR> 
	 * @param  entityMap
	 * @return String JSON
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象050901 资产转移主表(仓库到仓库)_专用设备
		AssTranStoreSpecial assTranStoreSpecial = queryByCode(entityMap);
		...
		try {
			...
			int state = assTranStoreSpecialMapper.add(entityMap);
	...
	/**
	 * @Description 
	 * 批量添加050901 资产转移主表(仓库到仓库)_专用设备<BR> 
	 * @param  entityList
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assTranStoreSpecialMapper.addBatch(entityList);
		...
		/**
	 * @Description 
	 * 更新050901 资产转移主表(仓库到仓库)_专用设备<BR> 
	 * @param  entityMap
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assTranStoreSpecialMapper.update(entityMap);
	...
	/**
	 * @Description 
	 * 批量更新050901 资产转移主表(仓库到仓库)_专用设备<BR> 
	 * @param  entityList
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assTranStoreSpecialMapper.updateBatch(entityList);
	...
	/**
	 * @Description 
	 * 删除050901 资产转移主表(仓库到仓库)_专用设备<BR> 
	 * @param  entityMap
	 * @return String JSON
	 * @throws DataAccessException
	*/
    ...
    try {
			...
			int state = assTranStoreSpecialMapper.delete(entityMap);
	...
	/**
	 * @Description 
	 * 批量删除050901 资产转移主表(仓库到仓库)_专用设备<BR> 
	 * @param  entityList
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			assTranStoreDetailSpecialMapper.deleteBatch(entityList);
			assTranStoreSpecialMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		List<AssTranStoreSpecial> list = (List<AssTranStoreSpecial>)assTranStoreSpecialMapper.queryExists(mapVo);
		boolean flag = true;
		boolean flag1 = true;
		try {
			if (list.size()>0) {
				assTranStoreSpecialMapper.update(entityMap);
			}else{
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_TRAN_STORE_SPECIAL");
				
				String tran_no = assBaseService.getBillNOSeqNo(entityMap);

				entityMap.put("tran_no", tran_no);
				assTranStoreSpecialMapper.add(entityMap);
			...
			assTranStoreDetailSpecialMapper.delete(entityMap);
			assTranStoreDetailSpecialMapper.addBatch(listVo);
	...
	/**
	 * @Description 
	 * 查询结果集050901 资产转移主表(仓库到仓库)_专用设备<BR> 
	 * @param  entityMap
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssTranStoreSpecial> list = (List<AssTranStoreSpecial>)assTranStoreSpecialMapper.query(entityMap);
			...
			List<AssTranStoreSpecial> list = (List<AssTranStoreSpecial>)assTranStoreSpecialMapper.query(entityMap, rowBounds);
	...
	/**
	 * @Description 
	 * 获取对象050901 资产转移主表(仓库到仓库)_专用设备<BR> 
	 * @param  entityMap<BR>
	 *  参数为主键
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assTranStoreSpecialMapper.queryByCode(entityMap);
	}
	
	/**
	 * @Description 
	 * 获取050901 资产转移主表(仓库到仓库)_专用设备<BR> 
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssTranStoreSpecial
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assTranStoreSpecialMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssTranStoreSpecial>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assTranStoreSpecialMapper.queryExists(entityMap);
	}
	@Override
	public String updateConfirmTranStoreSpecial(List<Map<String, Object>> entityMap,
		...
		try {
			...
			//增加新的使用科室
			assShareDeptRSpecialMapper.addBatch(cardList);
			assShareDeptSpecialMapper.addBatch(cardList);
			
			//更新卡片的仓库已经使用科室
			assCardSpecialMapper.updateTranStoreConfirm(cardList);
			
			//更新转移单据表
			assTranStoreSpecialMapper.updateConfirm(entityMap);
	...
	public List<AssTranStoreDetailSpecial> queryByTranNo(Map<String, Object> entityMap) throws DataAccessException {
		return assTranStoreDetailSpecialMapper.queryByTranNo(entityMap);
	}
	
	@Override
	public List<String> queryState(Map<String, Object> entityMap) throws DataAccessException {
		 return assTranStoreSpecialMapper.queryState(entityMap);
	...
	@Override
	public Map<String,Object> assTranStoreSpecialByPrintTemlate(Map<String, Object> entityMap)
			throws DataAccessException {
		// TODO Auto-generated method stub
		
		Map<String,Object> reMap=new HashMap<String,Object>();
		WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
		AssTranStoreSpecialMapper assTranStoreSpecialMapper = (AssTranStoreSpecialMapper)context.getBean("assTranStoreSpecialMapper");
		
		
		if("1".equals(String.valueOf(entityMap.get("p_num")))){
			//查询移库主表批量
			List<Map<String,Object>> map = assTranStoreSpecialMapper.queryAssTranStoreSpecialPrintTemlateByMainBatch(entityMap);
			//查询移库明细表
			List<Map<String,Object>> list = assTranStoreSpecialMapper.queryAssTranStoreSpecialPrintTemlateByDetail(entityMap);
			...
			//查询移库主表
			Map<String,Object> map = assTranStoreSpecialMapper.queryAssTranStoreSpecialPrintTemlateByMain(entityMap);
			//查询移库明细表
			List<Map<String,Object>> list = assTranStoreSpecialMapper.queryAssTranStoreSpecialPrintTemlateByDetail(entityMap);
	...
	public String queryDetails(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assTranStoreSpecialMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assTranStoreSpecialMapper.queryDetails(entityMap, rowBounds);
