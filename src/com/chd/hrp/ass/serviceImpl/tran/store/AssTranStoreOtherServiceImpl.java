...
import com.chd.hrp.ass.dao.tran.store.AssTranStoreDetailOtherMapper;
import com.chd.hrp.ass.dao.tran.store.AssTranStoreOtherMapper;
...
@Service("assTranStoreOtherService")
public class AssTranStoreOtherServiceImpl implements AssTranStoreOtherService {

	private static Logger logger = Logger.getLogger(AssTranStoreOtherServiceImpl.class);
	//引入DAO操作
	@Resource(name = "assTranStoreOtherMapper")
	private final AssTranStoreOtherMapper assTranStoreOtherMapper = null;
	
	@Resource(name = "assTranStoreDetailOtherMapper")
	private final AssTranStoreDetailOtherMapper assTranStoreDetailOtherMapper = null;
	...
	/**
	 * @Description 
	 * 添加050901 资产转移主表(仓库到仓库)_其他固定资产<BR> 
	 * @param  entityMap
	 * @return String JSON
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象050901 资产转移主表(仓库到仓库)_其他固定资产
		AssTranStoreOther assTranStoreOther = queryByCode(entityMap);
		...
		try {
			...
			int state = assTranStoreOtherMapper.add(entityMap);
	...
	/**
	 * @Description 
	 * 批量添加050901 资产转移主表(仓库到仓库)_其他固定资产<BR> 
	 * @param  entityList
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assTranStoreOtherMapper.addBatch(entityList);
		...
		/**
	 * @Description 
	 * 更新050901 资产转移主表(仓库到仓库)_其他固定资产<BR> 
	 * @param  entityMap
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assTranStoreOtherMapper.update(entityMap);
	...
	/**
	 * @Description 
	 * 批量更新050901 资产转移主表(仓库到仓库)_其他固定资产<BR> 
	 * @param  entityList
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assTranStoreOtherMapper.updateBatch(entityList);
	...
	/**
	 * @Description 
	 * 删除050901 资产转移主表(仓库到仓库)_其他固定资产<BR> 
	 * @param  entityMap
	 * @return String JSON
	 * @throws DataAccessException
	*/
    ...
    try {
			...
			int state = assTranStoreOtherMapper.delete(entityMap);
	...
	/**
	 * @Description 
	 * 批量删除050901 资产转移主表(仓库到仓库)_其他固定资产<BR> 
	 * @param  entityList
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			assTranStoreDetailOtherMapper.deleteBatch(entityList);
			assTranStoreOtherMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		List<AssTranStoreOther> list = (List<AssTranStoreOther>)assTranStoreOtherMapper.queryExists(mapVo);
		boolean flag = true;
		boolean flag1 = true;
		try {
			if (list.size()>0) {
				assTranStoreOtherMapper.update(entityMap);
			}else{
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_TRAN_STORE_OTHER");
				String tran_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("tran_no", tran_no);
				assTranStoreOtherMapper.add(entityMap);
			...
			assTranStoreDetailOtherMapper.delete(entityMap);
			assTranStoreDetailOtherMapper.addBatch(listVo);
	...
	/**
	 * @Description 
	 * 查询结果集050901 资产转移主表(仓库到仓库)_其他固定资产<BR> 
	 * @param  entityMap
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssTranStoreOther> list = (List<AssTranStoreOther>)assTranStoreOtherMapper.query(entityMap);
			...
			List<AssTranStoreOther> list = (List<AssTranStoreOther>)assTranStoreOtherMapper.query(entityMap, rowBounds);
	...
	/**
	 * @Description 
	 * 获取对象050901 资产转移主表(仓库到仓库)_其他固定资产<BR> 
	 * @param  entityMap<BR>
	 *  参数为主键
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assTranStoreOtherMapper.queryByCode(entityMap);
	}
	
	/**
	 * @Description 
	 * 获取050901 资产转移主表(仓库到仓库)_其他固定资产<BR> 
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssTranStoreOther
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assTranStoreOtherMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssTranStoreOther>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assTranStoreOtherMapper.queryExists(entityMap);
	}
	@Override
	public String updateConfirmTranStoreOther(List<Map<String, Object>> entityMap,
		...
		try {
			...
			//更新卡片的仓库已经使用科室
			assCardOtherMapper.updateTranStoreConfirm(cardList);
			
			//更新转移单据表
			assTranStoreOtherMapper.updateConfirm(entityMap);
	...
	public List<AssTranStoreDetailOther> queryByTranNo(Map<String, Object> entityMap) throws DataAccessException {
		return assTranStoreDetailOtherMapper.queryByTranNo(entityMap);
	}
	
	@Override
	public List<String> queryState(Map<String, Object> entityMap) throws DataAccessException {
		 return assTranStoreOtherMapper.queryState(entityMap);
	...
	@Override
	public Map<String,Object> assTranStoreOtherByPrintTemlate(Map<String, Object> entityMap)
			throws DataAccessException {
		// TODO Auto-generated method stub
		
		Map<String,Object> reMap=new HashMap<String,Object>();
		WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
		AssTranStoreOtherMapper assTranStoreOtherMapper = (AssTranStoreOtherMapper)context.getBean("assTranStoreOtherMapper");
		
		
		if("1".equals(String.valueOf(entityMap.get("p_num")))){
			//查询移库主表批量
			List<Map<String,Object>> map = assTranStoreOtherMapper.queryAssTranStoreOtherPrintTemlateByMainBatch(entityMap);
			//查询移库明细表
			List<Map<String,Object>> list = assTranStoreOtherMapper.queryAssTranStoreOtherPrintTemlateByDetail(entityMap);
			...
			//查询移库主表
			Map<String,Object> map = assTranStoreOtherMapper.queryAssTranStoreOtherPrintTemlateByMain(entityMap);
			//查询移库明细表
			List<Map<String,Object>> list = assTranStoreOtherMapper.queryAssTranStoreOtherPrintTemlateByDetail(entityMap);
	...
	public String queryDetails(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assTranStoreOtherMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assTranStoreOtherMapper.queryDetails(entityMap, rowBounds);
