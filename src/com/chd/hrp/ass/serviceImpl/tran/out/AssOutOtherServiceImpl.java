...
import com.chd.hrp.ass.dao.tran.out.AssOutDetailOtherMapper;
import com.chd.hrp.ass.dao.tran.out.AssOutOtherMapper;
import com.chd.hrp.ass.dao.tran.out.map.AssInOutMapOtherMapper;
...
@Service("assOutOtherService")
public class AssOutOtherServiceImpl implements AssOutOtherService {

	private static Logger logger = Logger.getLogger(AssOutOtherServiceImpl.class);
	//引入DAO操作
	@Resource(name = "assOutOtherMapper")
	private final AssOutOtherMapper assOutOtherMapper = null;
	
	@Resource(name = "assOutDetailOtherMapper")
	private final AssOutDetailOtherMapper assOutDetailOtherMapper = null;
	...
	@Resource(name = "assInOutMapOtherMapper")
	private final AssInOutMapOtherMapper assInOutMapOtherMapper = null;
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象050902 资产领用表(其他固定资产)
		AssOutOther assOutOther = queryByCode(entityMap);
		...
		try {
			...
			int state = assOutOtherMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assOutOtherMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assOutOtherMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assOutOtherMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assOutOtherMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			assOutDetailOtherMapper.deleteBatch(entityList);
			assOutOtherMapper.deleteBatch(entityList);
			assInOutMapOtherMapper.deleteBatch(entityList);
			return "{\"msg\":\"删除成功.\",\"state\":\"true\"}";
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
    	...
    	if(bill_type.equals("01")){//科室领用
    		...
    		vStoreAndDeptMap.put("ass_nature", "04");
		...
		List<AssOutOther> list = (List<AssOutOther>)assOutOtherMapper.queryExists(mapVo);
		boolean flag = true;
		boolean flag1 = true;
		try {
			if (list.size()>0) {
				
				assOutOtherMapper.update(entityMap);
			}else{
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_OUT_OTHER");
				String out_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("out_no", out_no);
				assOutOtherMapper.add(entityMap);
			...
			for (Map<String, Object> detailVo : detail) {
				...
				Integer storeAndDeptExists = hrpAssSelectMapper.queryAssExistsOtherCard(vStoreAndDeptMap);
			...
			assOutDetailOtherMapper.delete(entityMap);
			assOutDetailOtherMapper.addBatch(listVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssOutOther> list = (List<AssOutOther>)assOutOtherMapper.query(entityMap);
			...
			List<AssOutOther> list = (List<AssOutOther>)assOutOtherMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assOutOtherMapper.queryByCode(entityMap);
	}
	
	/**
	 * @Description 
	 * 获取050902 资产领用表(其他固定资产)<BR> 
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssOutOther
	 * @throws DataAccessException
	*/
	...
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assOutOtherMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssOutOther>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assOutOtherMapper.queryExists(entityMap);
	}
	@Override
	public String updateConfirmOutOther(List<Map<String, Object>> entityMap, List<Map<String, Object>> cardEntityMap)
			throws DataAccessException {
		try {
			...
			//增加新的使用科室
			if(getList.size() > 0){
				assShareDeptROtherMapper.addBatch(getList);
				assShareDeptOtherMapper.addBatch(getList);
				assCardOtherMapper.updateDeptGetOutConfirm(getList);
			}
			
			if(backList.size() > 0){
				assShareDeptROtherMapper.addBatch(backList);
				assShareDeptOtherMapper.addBatch(backList);
				assCardOtherMapper.updateDeptBackOutConfirm(backList);
			}
			
			assOutOtherMapper.updateConfirm(entityMap);
	...
	public List<AssOutDetailOther> queryByOutNo(Map<String, Object> entityMap) throws DataAccessException {
		return assOutDetailOtherMapper.queryByOutNo(entityMap);
	}
	
	@Override
	public List<String> queryState(Map<String, Object> entityMap) throws DataAccessException {
		 return assOutOtherMapper.queryState(entityMap);
	...
	@Override
	public Map<String,Object> assOutOtherByPrintTemlate(Map<String, Object> entityMap)
			throws DataAccessException {
		// TODO Auto-generated method stub
		
		Map<String,Object> reMap=new HashMap<String,Object>();
		WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
		AssOutOtherMapper assOutOtherMapper = (AssOutOtherMapper)context.getBean("assOutOtherMapper");
		
		
		if("1".equals(String.valueOf(entityMap.get("p_num")))){
			//查询移库主表批量
			List<Map<String,Object>> map = assOutOtherMapper.queryAssOutOtherPrintTemlateByMainBatch(entityMap);
			//查询移库明细表
			List<Map<String,Object>> list = assOutOtherMapper.queryAssOutOtherPrintTemlateByDetail(entityMap);
			...
			//查询移库主表
			Map<String,Object> map = assOutOtherMapper.queryAssOutOtherPrintTemlateByMain(entityMap);
			//查询移库明细表
			List<Map<String,Object>> list = assOutOtherMapper.queryAssOutOtherPrintTemlateByDetail(entityMap);
	...
	public String queryDetails(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assOutOtherMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assOutOtherMapper.queryDetails(entityMap, rowBounds);
	...
	public String importAssInMainByOut(Map<String, Object> map) throws DataAccessException {
		...
		try {
			List<AssInMainOther> assPayMain = assInMainOtherMapper.queryByInitOut(map);
			...
			for (AssInMainOther assInMainSpecial : assPayMain) {
			...
			assOutDetailOtherMapper.addBatch(listVo);
			assInOutMapOtherMapper.addBatch(mapListVo);
	...
	@Override
	public String offsetOutOther(List<Map<String, Object>> entityMap)
			throws DataAccessException {
		try{
			//集团、单位变量
			...
			List<Map<String, Object>> mainList = (List<Map<String, Object>>)assOutOtherMapper.queryAssOutByIds(inMap);
			List<Map<String, Object>> detailList = (List<Map<String, Object>>)assOutOtherMapper.queryAssOutDetailByIds(inMap);
			...
			for(Map<String, Object> mainMap : mainList){ 
				...
				mainMap.put("bill_table", "ASS_OUT_OTHER");
				...
				for(Map<String, Object> detailMap : detailList){
					...
					List<AssOutDetailOther> list = assOutDetailOtherMapper.queryOutOtherCard(mapsd);
					if(list.size() > 0){
						return "{\"msg\":\"冲账失败,不能重复冲账.\",\"state\":\"false\"}";
					}
				}
				assOutOtherMapper.addBatch(insertMainList);
				assBaseService.updateAssBillNoMaxNo(mainMap);
				assOutDetailOtherMapper.addBatch(insertDetailList);
			}
