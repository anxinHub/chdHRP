...
import com.chd.hrp.ass.dao.tran.dept.AssTranDeptDetailSpecialMapper;
...
@Service("assTranDeptSpecialService")
public class AssTranDeptSpecialServiceImpl implements AssTranDeptSpecialService {

	private static Logger logger = Logger.getLogger(AssTranDeptSpecialServiceImpl.class);
	//引入DAO操作
	@Resource(name = "assTranDeptSpecialMapper")
	private final AssTranDeptSpecialMapper assTranDeptSpecialMapper = null;
	
	@Resource(name = "assTranDeptDetailSpecialMapper")
	private final AssTranDeptDetailSpecialMapper assTranDeptDetailSpecialMapper = null;
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssTranDeptSpecial assTranDeptSpecial = queryByCode(entityMap);
		...
		try {
			...
			int state = assTranDeptSpecialMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assTranDeptSpecialMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assTranDeptSpecialMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assTranDeptSpecialMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
    		assTranDeptDetailSpecialMapper.delete(entityMap);
			int state = assTranDeptSpecialMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			assTranDeptDetailSpecialMapper.deleteBatch(entityList);
			assTranDeptSpecialMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		vDeptMap.put("ass_nature", "02");
		vDeptMap.put("use_state", "1,2,3,4,5");
		vDeptMap.put("is_dept", "1");
		vDeptMap.put("dept_id", entityMap.get("out_dept_id"));
		entityMap.put("state", "0");
    	
		List<AssTranDeptSpecial> list = (List<AssTranDeptSpecial>)assTranDeptSpecialMapper.queryExists(mapVo);
		
		try {
			if (list.size()>0) {
				
				assTranDeptSpecialMapper.update(entityMap);
			}else{
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_TRAN_DEPT_SPECIAL");
				String tran_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("tran_no", tran_no);
				assTranDeptSpecialMapper.add(entityMap);
			...
			for (Map<String, Object> detailVo : detail) {
				...
				Integer storeExists = hrpAssSelectMapper.queryAssExistsSpecialCard(vDeptMap);
				if(storeExists == 0){
					flag1 = false;
					break;
				}
			...
			assTranDeptDetailSpecialMapper.delete(entityMap);
			assTranDeptDetailSpecialMapper.addBatch(listVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssTranDeptSpecial> list = (List<AssTranDeptSpecial>)assTranDeptSpecialMapper.query(entityMap);
			...
			List<AssTranDeptSpecial> list = (List<AssTranDeptSpecial>)assTranDeptSpecialMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assTranDeptSpecialMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssTranDeptSpecial
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assTranDeptSpecialMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssTranDeptSpecial>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assTranDeptSpecialMapper.queryExists(entityMap);
	}
	@Override
	public String updateConfirmTranDeptSpecial(List<Map<String, Object>> entityMap,
		...
		try {
			...
			//更新转移单据表
			assTranDeptSpecialMapper.updateConfirm(entityMap);
			assCardSpecialMapper.updateTranDeptConfirm(cardList);
	...
	@Override
	public List<AssTranDeptDetailSpecial> queryByTranNo(Map<String, Object> entityMap) {
		return assTranDeptDetailSpecialMapper.queryByTranNo(entityMap);
	}
	
	@Override
	public List<String> queryState(Map<String, Object> entityMap) throws DataAccessException {
		 return assTranDeptSpecialMapper.queryState(entityMap);
	...
	@Override
	public Map<String,Object> assTranDeptSpecialByPrintTemlate(Map<String, Object> entityMap)
			throws DataAccessException {
		// TODO Auto-generated method stub
		
		Map<String,Object> reMap=new HashMap<String,Object>();
		WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
		AssTranDeptSpecialMapper assTranDeptSpecialMapper = (AssTranDeptSpecialMapper)context.getBean("assTranDeptSpecialMapper");
		
		
		if("1".equals(String.valueOf(entityMap.get("p_num")))){
			//查询移库主表批量
			List<Map<String,Object>> map = assTranDeptSpecialMapper.queryAssTranDeptSpecialPrintTemlateByMainBatch(entityMap);
			//查询移库明细表
			List<Map<String,Object>> list = assTranDeptSpecialMapper.queryAssTranDeptSpecialPrintTemlateByDetail(entityMap);
			...
			//查询移库主表
			Map<String,Object> map = assTranDeptSpecialMapper.queryAssTranDeptSpecialPrintTemlateByMain(entityMap);
			//查询移库明细表
			List<Map<String,Object>> list = assTranDeptSpecialMapper.queryAssTranDeptSpecialPrintTemlateByDetail(entityMap);
	...
	public String queryDetails(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assTranDeptSpecialMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assTranDeptSpecialMapper.queryDetails(entityMap, rowBounds);
