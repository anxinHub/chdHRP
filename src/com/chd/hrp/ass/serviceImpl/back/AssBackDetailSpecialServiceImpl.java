...
@Service("assBackDetailSpecialService")
public class AssBackDetailSpecialServiceImpl implements AssBackDetailSpecialService {

	private static Logger logger = Logger.getLogger(AssBackDetailSpecialServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssBackDetailSpecial assBackDetailSpecial = queryByCode(entityMap);

		if (assBackDetailSpecial != null) {
		...
		try {
			...
			int state = assBackDetailSpecialMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assBackDetailSpecialMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assBackDetailSpecialMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assBackDetailSpecialMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assBackDetailSpecialMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			List<AssBackDetailSpecial> list = (List<AssBackDetailSpecial>)assBackDetailSpecialMapper.queryExists(inMapVo);
			
			double back_money=0;
			if(list != null){
				for(AssBackDetailSpecial temp :  list ){
					back_money += temp.getPrice();
				}
			}
			inMapVo.put("back_money", back_money+"");
			assBackSpecialMapper.updateBackMoney(inMapVo);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssBackDetailSpecial> list = (List<AssBackDetailSpecial>)assBackDetailSpecialMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssBackDetailSpecial> list = (List<AssBackDetailSpecial>)assBackDetailSpecialMapper.query(entityMap);
			...
			List<AssBackDetailSpecial> list = (List<AssBackDetailSpecial>)assBackDetailSpecialMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assBackDetailSpecialMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssBackDetailSpecial
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assBackDetailSpecialMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssBackDetailSpecial>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assBackDetailSpecialMapper.queryExists(entityMap);
	}
	@Override
	public List<AssBackDetailSpecial> queryByAssBackNo(Map<String, Object> entityMap) throws DataAccessException {
		return assBackDetailSpecialMapper.queryByAssBackNo(entityMap);
	}
	@Override
	public String addAssBackSpecial(Map<String, Object> entityMap) {
		try {

			assBackDetailSpecialMapper.addAssBackSpecial(entityMap);
	...
	public String addMoney(Map<String, Object> entityMap) {
		try {
			...
			List<AssBackDetailSpecial> details=assBackDetailSpecialMapper.queryByBackDetailSpecial(inMapVo);
			double back_money=0;
			String ass_back_no = null;
			for(AssBackDetailSpecial temp :  details ){
				back_money += temp.getPrice();
				ass_back_no =temp.getAss_back_no().toString();
			}
			inMapVo.put("back_money", back_money+"");
			assBackSpecialMapper.updateAssBackSpecialMoney(inMapVo);
	...
	public List<Map<String, Object>> queryByInit(Map<String, Object> mapVo) {
		...
		return assBackDetailSpecialMapper.queryByInit(mapVo);
	}
}
