...
import com.chd.hrp.ass.dao.back.AssBackDetailInassetsMapper;
import com.chd.hrp.ass.dao.back.AssBackInInassetsMapMapper;
import com.chd.hrp.ass.dao.back.AssBackInassetsMapper;
import com.chd.hrp.ass.dao.back.source.AssBackSourceInassetsMapper;
...
@Service("assBackInassetsService")
public class AssBackInassetsServiceImpl implements AssBackInassetsService {

	private static Logger logger = Logger.getLogger(AssBackInassetsServiceImpl.class);
	// 引入DAO操作
	@Resource(name = "assBackInassetsMapper")
	private final AssBackInassetsMapper assBackInassetsMapper = null;

	@Resource(name = "assBackDetailInassetsMapper")
	private final AssBackDetailInassetsMapper assBackDetailInassetsMapper = null;

	@Resource(name = "assBackSourceInassetsMapper")
	private final AssBackSourceInassetsMapper assBackSourceInassetsMapper = null;
	...
	/**
	 * @Description 添加050701 资产退货单主表(无形资产)<BR>
	 * @param entityMap
	 * @return String JSON
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		// 获取对象050701 资产退货单主表(无形资产)
		AssBackInassets assBackInassets = queryByCode(entityMap);
		...
		try {
			...
			int state = assBackInassetsMapper.add(entityMap);
	...
	/**
	 * @Description 批量添加050701 资产退货单主表(无形资产)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assBackInassetsMapper.addBatch(entityList);
	...
	/**
	 * @Description 更新050701 资产退货单主表(无形资产)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assBackInassetsMapper.update(entityMap);
	...
	/**
	 * @Description 批量更新050701 资产退货单主表(无形资产)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assBackInassetsMapper.updateBatch(entityList);
	...
	/**
	 * @Description 删除050701 资产退货单主表(无形资产)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assBackInassetsMapper.delete(entityMap);
	...
	/**
	 * @Description 批量删除050701 资产退货单主表(无形资产)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			assBackSourceInassetsMapper.deleteBatch(entityList);
			assBackDetailInassetsMapper.deleteBatch(entityList);
			assBackInassetsMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssBackInassets> list = (List<AssBackInassets>) assBackInassetsMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			boolean flag2 = true;
			if (list.size() > 0) {
				assBackInassetsMapper.update(entityMap);
			} else {
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_BACK_INASSETS");
				String ass_back_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("ass_back_no", ass_back_no);
				assBackInassetsMapper.add(entityMap);
			...
			assBackSourceInassetsMapper.delete(entityMap);
			assBackDetailInassetsMapper.delete(entityMap);
			assBackDetailInassetsMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assBackSourceInassetsMapper.addBatch(listSourceVo);
			}
	...
	public String collectAssBackInassets(Map<String, Object> entityMap) {
		...
		assBackInassetsMapper.collectAssBackInassets(entityMap);
	...
	/**
	 * @Description 查询结果集050701 资产退货单主表(无形资产)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssBackInassets> list = (List<AssBackInassets>) assBackInassetsMapper.query(entityMap);
			...
			List<AssBackInassets> list = (List<AssBackInassets>) assBackInassetsMapper.query(entityMap, rowBounds);
	...
	/**
	 * @Description 获取对象050701 资产退货单主表(无形资产)<BR>
	 * @param entityMap<BR>
	 *            参数为主键
	 * @return String JSON
	 * @throws DataAccessException
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assBackInassetsMapper.queryByCode(entityMap);
	}

	/**
	 * @Description 获取050701 资产退货单主表(无形资产)<BR>
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssBackInassets
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assBackInassetsMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssBackInassets>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assBackInassetsMapper.queryExists(entityMap);
	}
	...
	public String updateBackConfirm(List<Map<String, Object>> entityMap, List<Map<String, Object>> cardEntityMap)
			throws DataAccessException {
		try {
			assBackInassetsMapper.updateBatchConfirm(entityMap);
			assCardInassetsMapper.updateBackConfirm(cardEntityMap);
			
			assPayStageInassetsMapper.updateBatchBackBill(cardEntityMap);
			assPayStageInassetsMapper.updateBatchBackPay(cardEntityMap);
			
			assResourceInassetsMapper.updateBatchByBack(cardEntityMap);
	...
	public Map<String, Object> queryAssBackInassetsByPrintTemlatePrint(Map<String, Object> entityMap)throws DataAccessException {
		...
		try{
			...
			AssBackInassetsMapper assBackInassetsMapper = (AssBackInassetsMapper)context.getBean("assBackInassetsMapper");
			 
			//主页面 批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				
				//查询 其他无形资产 采购退货  退货主表
				List<Map<String,Object>> map= assBackInassetsMapper.queryAssBackInassetsPrintTemlateByMainBatch(entityMap);
				//查询 其他无形资产 采购退货 退货明细表
				List<Map<String,Object>> list= assBackInassetsMapper.queryAssBackInassetsPrintTemlateByDetail(entityMap);
				...
				//
				Map<String,Object> map= assBackInassetsMapper.queryAssBackInassetsPrintTemlateByMain(entityMap);
				//查询 其他无形资产 采购退货 退货明细表
				List<Map<String,Object>> list= assBackInassetsMapper.queryAssBackInassetsPrintTemlateByDetail(entityMap);
	...
	public List<String> queryAssBackInassetsState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return assBackInassetsMapper.queryAssBackInassetsState(mapVo);
	}
	...
	public String queryDetails(Map<String, Object> entityMap)
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assBackInassetsMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assBackInassetsMapper.queryDetails(entityMap, rowBounds);
	...
	public String assImportBackIn(Map<String, Object> entityMap) {
		...
		List<Map<String, Object>> listSourceVo = new ArrayList<Map<String, Object>>();
		try{
			List<AssInMainInassets> assPayMain = assInMainInassetsMapper.queryByInitBack(entityMap);
			...
			//明细表保存
			Double back_money = 0.0;
			for (AssInMainInassets assPayDetailSpecial : assPayMain) {
				...
				for(Map<String, Object> card : cardList){
					...
					String results = collectAssBackInassets(map);
			...
			if(listVo.size() == 0){
			  ...
			  assBaseService.updateAssBillNoMaxNo(entityMap);
			 assBackDetailInassetsMapper.addBatch(listVo);
			 assBackInInassetsMapMapper.addBatch(mapListVo);
			 if (listSourceVo.size() > 0) {
					assBackSourceInassetsMapper.addBatch(listSourceVo);
				}
				entityMap.put("back_money", back_money);
