...
@Service("assBackHouseService")
public class AssBackHouseServiceImpl implements AssBackHouseService {

	private static Logger logger = Logger.getLogger(AssBackHouseServiceImpl.class);
	// 引入DAO操作
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		AssBackHouse assBackHouse = queryByCode(entityMap);
		...
		try {
			...
			int state = assBackHouseMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assBackHouseMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assBackHouseMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assBackHouseMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assBackHouseMapper.delete(entityMap);
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assBackHouseMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssBackHouse> list = (List<AssBackHouse>) assBackHouseMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			boolean flag2 = true;
			if (list.size() > 0) {
				assBackHouseMapper.update(entityMap);
			} else {
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_BACK_HOUSE");
				String ass_back_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("ass_back_no", ass_back_no);
				assBackHouseMapper.add(entityMap);
			...
			assBackSourceHouseMapper.delete(entityMap);
			assBackDetailHouseMapper.delete(entityMap);
			assBackDetailHouseMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assBackSourceHouseMapper.addBatch(listSourceVo);
			}
	...
	public String collectAssBackHouse(Map<String, Object> entityMap) {
		...
		assBackHouseMapper.collectAssBackHouse(entityMap);
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssBackHouse> list = (List<AssBackHouse>) assBackHouseMapper.query(entityMap);
			...
			List<AssBackHouse> list = (List<AssBackHouse>) assBackHouseMapper.query(entityMap, rowBounds);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assBackHouseMapper.queryByCode(entityMap);
	}
	...
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assBackHouseMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssBackHouse>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assBackHouseMapper.queryExists(entityMap);
	}
	...
	public String updateBackConfirm(List<Map<String, Object>> entityMap, List<Map<String, Object>> cardEntityMap)
			throws DataAccessException {
		try {
			assBackHouseMapper.updateBatchConfirm(entityMap);
			assCardHouseMapper.updateBackConfirm(cardEntityMap);
			
			assPayStageHouseMapper.updateBatchBackBill(cardEntityMap);
			assPayStageHouseMapper.updateBatchBackPay(cardEntityMap);
			
			assResourceHouseMapper.updateBatchByBack(cardEntityMap);
	...
	@Override
	public Map<String,Object> printAssBackHouseData(Map<String, Object> map)throws DataAccessException {
		
		try{
			Map<String,Object> reMap=new HashMap<String,Object>();
			WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
			AssBackHouseMapper assBackHouseMapper = (AssBackHouseMapper)context.getBean("assBackHouseMapper");
			
			//查询凭证主表
			List<Map<String,Object>> mainList=assBackHouseMapper.queryAssBackHouseByAssBackNo(map);
					
			//查询凭证明细表
			List<Map<String,Object>> detailList=assBackHouseMapper.queryAssBackHouseDetailByAssBackNo(map);
	 ...
	 */
	@Override
	public List<String> queryAssBackHouseStates(Map<String, Object> mapVo) throws DataAccessException {
		
		return assBackHouseMapper.queryAssBackHouseStates(mapVo);
	}
	...
	public String queryDetails(Map<String, Object> entityMap)
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assBackHouseMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assBackHouseMapper.queryDetails(entityMap, rowBounds);
