...
@Service("assBackGeneralService")
public class AssBackGeneralServiceImpl implements AssBackGeneralService {

	private static Logger logger = Logger.getLogger(AssBackGeneralServiceImpl.class);
	// 引入DAO操作
	...
	/**
	 * @Description 添加050701 资产退货单主表(一般设备)<BR>
	 * @param entityMap
	 * @return String JSON
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		// 获取对象050701 资产退货单主表(一般设备)
		AssBackGeneral assBackGeneral = queryByCode(entityMap);
		...
		try {
			...
			int state = assBackGeneralMapper.add(entityMap);
	...
	/**
	 * @Description 批量添加050701 资产退货单主表(一般设备)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assBackGeneralMapper.addBatch(entityList);
	...
	/**
	 * @Description 更新050701 资产退货单主表(一般设备)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assBackGeneralMapper.update(entityMap);
	...
	/**
	 * @Description 批量更新050701 资产退货单主表(一般设备)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assBackGeneralMapper.updateBatch(entityList);
	...
	/**
	 * @Description 删除050701 资产退货单主表(一般设备)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assBackGeneralMapper.delete(entityMap);
	...
	/**
	 * @Description 批量删除050701 资产退货单主表(一般设备)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			assBackSourceGeneralMapper.deleteBatch(entityList);
			assBackDetailGeneralMapper.deleteBatch(entityList);
			assBackGeneralMapper.deleteBatch(entityList);
			assBackInGeneralMapMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssBackGeneral> list = (List<AssBackGeneral>) assBackGeneralMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			boolean flag2 = true;
			if (list.size() > 0) {
				assBackGeneralMapper.update(entityMap);
			} else {
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_BACK_GENERAL");
				String ass_back_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("ass_back_no", ass_back_no);
				assBackGeneralMapper.add(entityMap);
			...
			assBackSourceGeneralMapper.delete(entityMap);
			assBackDetailGeneralMapper.delete(entityMap);
			assBackDetailGeneralMapper.addBatch(listVo);
	...
	/**
	 * @Description 查询结果集050701 资产退货单主表(一般设备)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssBackGeneral> list = (List<AssBackGeneral>) assBackGeneralMapper.query(entityMap);
			...
			List<AssBackGeneral> list = (List<AssBackGeneral>) assBackGeneralMapper.query(entityMap, rowBounds);
	...
	/**
	 * @Description 获取对象050701 资产退货单主表(一般设备)<BR>
	 * @param entityMap<BR>
	 *            参数为主键
	 * @return String JSON
	 * @throws DataAccessException
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assBackGeneralMapper.queryByCode(entityMap);
	}

	/**
	 * @Description 获取050701 资产退货单主表(一般设备)<BR>
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssBackGeneral
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assBackGeneralMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssBackGeneral>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assBackGeneralMapper.queryExists(entityMap);
	}
	...
	public String updateBackConfirm(List<Map<String, Object>> entityMap, List<Map<String, Object>> cardEntityMap)
			throws DataAccessException {
		try {
			assBackGeneralMapper.updateBatchConfirm(entityMap);
			assCardGeneralMapper.updateBackConfirm(cardEntityMap);
			
			assPayStageGeneralMapper.updateBatchBackBill(cardEntityMap);
			assPayStageGeneralMapper.updateBatchBackPay(cardEntityMap);
			
			assResourceGeneralMapper.updateBatchByBack(cardEntityMap);
	...
	public Map<String, Object> queryAssBackGeneralByPrintTemlatePrint(Map<String, Object> entityMap)throws DataAccessException {
		...
		try{
			...
			AssBackGeneralMapper assBackGeneralMapper = (AssBackGeneralMapper)context.getBean("assBackGeneralMapper");
			 
			//主页面 批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				
				//查询 一般设备 采购退货  退货主表
				List<Map<String,Object>> map= assBackGeneralMapper.queryAssBackGeneralPrintTemlateByMainBatch(entityMap);
				//查询 一般设备 采购退货 退货明细表
				List<Map<String,Object>> list= assBackGeneralMapper.queryAssBackGeneralPrintTemlateByDetail(entityMap);
				...
				//
				Map<String,Object> map= assBackGeneralMapper.queryAssBackGeneralPrintTemlateByMain(entityMap);
				//查询 一般设备 采购退货 退货明细表
				List<Map<String,Object>> list= assBackGeneralMapper.queryAssBackGeneralPrintTemlateByDetail(entityMap);
	...
	public List<String> queryAssBackGeneralState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return assBackGeneralMapper.queryAssBackGeneralState(mapVo);
	}
	...
	public String queryDetails(Map<String, Object> entityMap)
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assBackGeneralMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assBackGeneralMapper.queryDetails(entityMap, rowBounds);
	...
	public String assImportBackIn(Map<String, Object> entityMap) {
		...
		List<Map<String, Object>> listSourceVo = new ArrayList<Map<String, Object>>();
		try{
			List<AssInMainGeneral> assPayMain = assInMainGeneralMapper.queryByInitBack(entityMap);
			...
			//明细表保存
			Double back_money = 0.0;
			for (AssInMainGeneral assPayDetailSpecial : assPayMain) {
	...
	public String updateAssBackMainBillNo(Map<String, Object> entityMap) throws DataAccessException {
		try {
			...
			assBackGeneralMapper.updateAssBackMainBillNo(entityMap);
