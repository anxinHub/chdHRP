...
@Service("assBackRestDetailHouseService")
public class AssBackRestDetailHouseServiceImpl implements AssBackRestDetailHouseService {

	private static Logger logger = Logger.getLogger(AssBackRestDetailHouseServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssBackRestDetailHouse assBackRestDetailHouse = queryByCode(entityMap);

		if (assBackRestDetailHouse != null) {
		...
		try {
			...
			int state = assBackRestDetailHouseMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assBackRestDetailHouseMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assBackRestDetailHouseMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assBackRestDetailHouseMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assBackRestDetailHouseMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			List<AssBackRestDetailHouse> list = (List<AssBackRestDetailHouse>)assBackRestDetailHouseMapper.queryExists(inMapVo);
			
			double back_money=0;
			if(list != null){
				for(AssBackRestDetailHouse temp :  list ){
					back_money += temp.getPrice();
				}
			}
			inMapVo.put("back_money", back_money+"");
			assBackRestHouseMapper.updateBackMoney(inMapVo);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssBackRestDetailHouse> list = (List<AssBackRestDetailHouse>)assBackRestDetailHouseMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssBackRestDetailHouse> list = (List<AssBackRestDetailHouse>)assBackRestDetailHouseMapper.query(entityMap);
			...
			List<AssBackRestDetailHouse> list = (List<AssBackRestDetailHouse>)assBackRestDetailHouseMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assBackRestDetailHouseMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssBackRestDetailHouse
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assBackRestDetailHouseMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssBackRestDetailHouse>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assBackRestDetailHouseMapper.queryExists(entityMap);
	}
	@Override
	public List<AssBackRestDetailHouse> queryByAssBackNo(Map<String, Object> entityMap) throws DataAccessException {
		return assBackRestDetailHouseMapper.queryByAssBackNo(entityMap);
	}
