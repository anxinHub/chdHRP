...
@Service("assBackRestOtherService")
public class AssBackRestOtherServiceImpl implements AssBackRestOtherService {

	private static Logger logger = Logger.getLogger(AssBackRestOtherServiceImpl.class);
	// 引入DAO操作
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		AssBackRestOther assBackRestOther = queryByCode(entityMap);
		...
		try {
			...
			int state = assBackRestOtherMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assBackRestOtherMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assBackRestOtherMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assBackRestOtherMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assBackRestOtherMapper.delete(entityMap);
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assBackRestOtherMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		vBusTypeMap.put("ass_nature", "04");
		vBusTypeMap.put("use_state", "1,2,3,4,5");
		vBusTypeMap.put("bus_type_code", entityMap.get("bus_type_code"));
		
		entityMap.put("state", "0");
		List<AssBackRestOther> list = (List<AssBackRestOther>) assBackRestOtherMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			boolean flag2 = true;
			...
			for (Map<String, Object> detailVo : detail) {
				...
				Integer busTypeExists = hrpAssSelectMapper.queryAssExistsOtherCard(vBusTypeMap);
				if(busTypeExists == 0){
					flag2 = false;
					break;
				}
			...
			assBackRestSourceOtherMapper.delete(entityMap);
			assBackRestDetailOtherMapper.delete(entityMap);
			assBackRestDetailOtherMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assBackRestSourceOtherMapper.addBatch(listSourceVo);
			}
			if(back_money != 0 && back_money != null && back_money != 0.0){
				entityMap.put("back_money", back_money+"");
				assBackRestOtherMapper.updateBackMoney(entityMap);
			}
	...
	public String collectAssBackOther(Map<String, Object> entityMap) {
		...
		assBackRestOtherMapper.collectAssBackOther(entityMap);
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssBackRestOther> list = (List<AssBackRestOther>) assBackRestOtherMapper.query(entityMap);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assBackRestOtherMapper.queryByCode(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssBackRestOther
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assBackRestOtherMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssBackRestOther>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assBackRestOtherMapper.queryExists(entityMap);
	}
	...
	public String updateBackConfirm(List<Map<String, Object>> entityMap, List<Map<String, Object>> cardEntityMap)
			throws DataAccessException {
		try {
			assBackRestOtherMapper.updateBatchConfirm(entityMap);
	...
	/**
	 * 其他固定资产其他退货 批量打印 新版打印  调用的方法
	 */
	@Override
	public Map<String, Object> queryAssBackRestOtherByPrintTemlatePrint(Map<String, Object> entityMap)throws DataAccessException {
		
		try{
			
			Map<String,Object> reMap=new HashMap<String,Object>();
			WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
			AssBackRestOtherMapper assBackRestOtherMapper = (AssBackRestOtherMapper)context.getBean("assBackRestOtherMapper");
			 
			//主页面 批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				
				//查询 其他固定资产其他退货 主表数据
				List<Map<String,Object>> map= assBackRestOtherMapper.queryAssBackOtherPrintTemlateByMainBatch(entityMap);
				//查询 其他固定资产 其他退货 明细表数据
				List<Map<String,Object>> list= assBackRestOtherMapper.queryAssBackOtherPrintTemlateByDetail(entityMap);
				...
				//
				Map<String,Object> map= assBackRestOtherMapper.queryAssBackOtherPrintTemlateByMain(entityMap);
				//查询 其他固定资产 其他退货 明细表数据
				List<Map<String,Object>> list= assBackRestOtherMapper.queryAssBackOtherPrintTemlateByDetail(entityMap);
	...
	/**
	 * 其他固定资产其他退货 退货单状态查询 (批量打印 校验数据用)
	 */
	@Override
	public List<String> queryAssBackRestOtherState(Map<String, Object> mapVo) throws DataAccessException {
		
		return assBackRestOtherMapper.queryAssBackRestOtherState(mapVo);
	}
	...
	public String queryDetails(Map<String, Object> entityMap)
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assBackRestOtherMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assBackRestOtherMapper.queryDetails(entityMap, rowBounds);
