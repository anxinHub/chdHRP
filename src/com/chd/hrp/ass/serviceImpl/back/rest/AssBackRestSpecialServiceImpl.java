...
/**
 * 
 * @Description: 050701 资产其他退货单主表(专用设备)
 * @Table: ASS_BACK_REST_SPECIAL
 * @Author: bell
 * @email: bell@e-tonggroup.com
 * @Version: 1.0
 */
 
@Service("assBackRestSpecialService")
public class AssBackRestSpecialServiceImpl implements AssBackRestSpecialService {

	private static Logger logger = Logger.getLogger(AssBackRestSpecialServiceImpl.class);
	// 引入DAO操作
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		AssBackRestSpecial assBackRestSpecial = queryByCode(entityMap);
		...
		try {
			...
			int state = assBackRestSpecialMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assBackRestSpecialMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assBackRestSpecialMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assBackRestSpecialMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assBackRestSpecialMapper.delete(entityMap);
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assBackRestSpecialMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		vBusTypeMap.put("ass_nature", "02");
		vBusTypeMap.put("use_state", "1,2,3,4,5");
		vBusTypeMap.put("bus_type_code", entityMap.get("bus_type_code"));
		
		entityMap.put("state", "0");
		List<AssBackRestSpecial> list = (List<AssBackRestSpecial>) assBackRestSpecialMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			boolean flag2 = true;
			...
			for (Map<String, Object> detailVo : detail) {
				...
				Integer busTypeExists = hrpAssSelectMapper.queryAssExistsSpecialCard(vBusTypeMap);
				if(busTypeExists == 0){
					flag2 = false;
					break;
				}
			...
			assBackRestSourceSpecialMapper.delete(entityMap);
			assBackRestDetailSpecialMapper.delete(entityMap);
			assBackRestDetailSpecialMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assBackRestSourceSpecialMapper.addBatch(listSourceVo);
			}
			if(back_money != 0 && back_money != null && back_money != 0.0){
				entityMap.put("back_money", back_money+"");
				assBackRestSpecialMapper.updateBackMoney(entityMap);
			}
	...
	public String collectAssBackSpecial(Map<String, Object> entityMap) {
		...
		assBackRestSpecialMapper.collectAssBackSpecial(entityMap);
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssBackRestSpecial> list = (List<AssBackRestSpecial>) assBackRestSpecialMapper.query(entityMap);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assBackRestSpecialMapper.queryByCode(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssBackRestSpecial
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assBackRestSpecialMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssBackRestSpecial>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assBackRestSpecialMapper.queryExists(entityMap);
	}
	...
	public String updateBackConfirm(List<Map<String, Object>> entityMap, List<Map<String, Object>> cardEntityMap)
			throws DataAccessException {
		try {
			assBackRestSpecialMapper.updateBatchConfirm(entityMap);
	...
	public Map<String, Object> queryAssBackRestSpecialByPrintTemlatePrint(Map<String, Object> entityMap)throws DataAccessException {
		...
		try{
			...
			AssBackRestSpecialMapper assBackRestSpecialMapper = (AssBackRestSpecialMapper)context.getBean("assBackRestSpecialMapper");
			 
			//主页面 批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				
				//查询 专用设备 其他退货 主表数据
				List<Map<String,Object>> map= assBackRestSpecialMapper.queryAssBackSpecialPrintTemlateByMainBatch(entityMap);
				//查询 专用设备  其他退货 明细表数据
				List<Map<String,Object>> list= assBackRestSpecialMapper.queryAssBackSpecialPrintTemlateByDetail(entityMap);
				...
				//
				Map<String,Object> map= assBackRestSpecialMapper.queryAssBackSpecialPrintTemlateByMain(entityMap);
				//查询 专用设备  其他退货 明细表数据
				List<Map<String,Object>> list= assBackRestSpecialMapper.queryAssBackSpecialPrintTemlateByDetail(entityMap);
	...
	public List<String> queryAssBackRestSpecialState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return assBackRestSpecialMapper.queryAssBackRestSpecialState(mapVo);
	}
	...
	public String queryDetails(Map<String, Object> entityMap)
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assBackRestSpecialMapper.queryDetails(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assBackRestSpecialMapper.queryDetails(entityMap, rowBounds);
