...
import com.chd.hrp.ass.dao.guanLiReports.AssPriceChangeStoreMapper;
...
@Service("assPriceChangeStoreService")
public class AssPriceChangeStoreServiceImpl implements AssPriceChangeStoreService {

	private static Logger logger = Logger.getLogger(AssPriceChangeStoreServiceImpl.class);
	// 引入DAO操作
	@Resource(name = "assPriceChangeStoreMapper")
	private final AssPriceChangeStoreMapper assPriceChangeStoreMapper = null;
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<Map<String, Object>> busTypesEsixts = assPriceChangeStoreMapper.queryBusTypesStoreExists(entityMap);
		
		if(busTypesEsixts == null || busTypesEsixts.size() == 0) {
			return "{\"error\":\""+"会计期间   "+entityMap.get("year_month_begin")+" 无数据.\"}";
		}
		
		List<Map<String, Object>> busTypes = assPriceChangeStoreMapper.queryBusTypesStore(entityMap);
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) assPriceChangeStoreMapper.query(entityMap);
	...
	@Override
	public Map<String, Object> queryBusTypesStore(Map<String, Object> entityMap) throws DataAccessException {

		Map<String, Object> ret = new HashMap<String, Object>();
		// 增加
		entityMap.put("in_out", "1");
		ret.put("bus_add", ChdJson.toJson(assPriceChangeStoreMapper.queryBusTypesStore(entityMap)));

		// 减少
		entityMap.put("in_out", "0");
		ret.put("bus_dec", ChdJson.toJson(assPriceChangeStoreMapper.queryBusTypesStore(entityMap)));

		return ret;
	}

	@Override
	public List<Map<String, Object>> queryAssPriceChangStoreMainPrint(Map<String, Object> entityMap)
		...
		if (busTypes != null && busTypes.size() > 0) {
			...
			list = assPriceChangeStoreMapper.queryAssPriceChangStoreMainPrint(entityMap);
		}
