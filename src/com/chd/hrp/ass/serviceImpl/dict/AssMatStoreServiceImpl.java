...
import com.chd.hrp.ass.dao.dict.AssMatStoreMapper;
import com.chd.hrp.ass.service.dict.AssMatStoreService;
...
@Service("assMatStoreService")
public class AssMatStoreServiceImpl implements AssMatStoreService {

	private static Logger logger = Logger.getLogger(AssMatStoreServiceImpl.class);
	//引入DAO操作
	@Resource(name = "assMatStoreMapper")
	private final AssMatStoreMapper matStoreMapper = null;
