...
import com.chd.hrp.ass.entity.check.general.AssCheckSdetailGeneral;
...
@Service("assCheckSdetailGeneralService")
public class AssCheckSdetailGeneralServiceImpl implements AssCheckSdetailGeneralService {

	private static Logger logger = Logger.getLogger(AssCheckSdetailGeneralServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象051101 仓库盘点单明细_医用设备
		AssCheckSdetailGeneral assCheckSdetailGeneral = queryByCode(entityMap);

		if (assCheckSdetailGeneral != null) {
		...
		try {
			...
			int state = assCheckSdetailGeneralMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckSdetailGeneralMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assCheckSdetailGeneralMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assCheckSdetailGeneralMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assCheckSdetailGeneralMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckSdetailGeneralMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssCheckSdetailGeneral> list = (List<AssCheckSdetailGeneral>)assCheckSdetailGeneralMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssCheckSdetailGeneral> list = (List<AssCheckSdetailGeneral>)assCheckSdetailGeneralMapper.query(entityMap);
			...
			List<AssCheckSdetailGeneral> list = (List<AssCheckSdetailGeneral>)assCheckSdetailGeneralMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSdetailGeneralMapper.queryByCode(entityMap);
	}
	
	/**
	 * @Description 
	 * 获取051101 仓库盘点单明细_医用设备<BR> 
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssCheckSdetailGeneral
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSdetailGeneralMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssCheckSdetailGeneral>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSdetailGeneralMapper.queryExists(entityMap);
	}
	/**
	 * @Description 复制账面数量
	 * @param mapVo
	...
	public String copyAmount(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		String vr = vo_split(mapVo.get("ass_card_no_all_g").toString());
		mapVo.put("ass_card_no_all_g", vr);
		//根据勾选的卡片复制账面数量
		assCheckSdetailGeneralMapper.copyAmount(mapVo);
	...
	public String delCard(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		//根据勾选的卡片复制账面数量
		assCheckSdetailGeneralMapper.delete(mapVo);
	...
	public Map<String, Object> queryAssInSpecialByPrintTemlatePrint(Map<String, Object> entityMap)throws DataAccessException {
		...
		try{
			...
			AssCheckSdetailGeneralMapper assCheckSdetailGeneralMapper = (AssCheckSdetailGeneralMapper)context.getBean("assCheckSdetailGeneralMapper");
		...
		/*	//主页面 批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				...
				//
				Map<String,Object> map= assCheckSdetailGeneralMapper.queryAssInSpecialPrintTemlateByMain(entityMap);
				//查询 专用设备  入库明细表
				List<Map<String,Object>> list= assCheckSdetailGeneralMapper.queryAssInSpecialPrintTemlateByDetail(entityMap);
	...
	public List<String> queryAssInSpecialState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return assCheckSdetailGeneralMapper.queryAssInSpecialState(mapVo);
	}
	@Override
	public String saveAssCheckSDetailGeneral(Map<String, Object> entityMap)
			throws DataAccessException {
		...
		try{	
			...
			assCheckSdetailGeneralMapper.deleteBatch(listVo);
			assCheckSdetailGeneralMapper.addBatch(listVo);
