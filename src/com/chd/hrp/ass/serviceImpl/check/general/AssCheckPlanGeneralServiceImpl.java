...
@Service("assCheckPlanGeneralService")
public class AssCheckPlanGeneralServiceImpl implements AssCheckPlanGeneralService {

	private static Logger logger = Logger.getLogger(AssCheckPlanGeneralServiceImpl.class);
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		AssCheckPlanGeneral assCheckPlanGeneral = queryByCode(entityMap);

		if (assCheckPlanGeneral != null) {
		...
		entityMap.put("bill_table", "ASS_CHECK_PLAN_GENERAL");
			...
			int state = assCheckPlanGeneralMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assCheckPlanGeneralMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assCheckPlanGeneralMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assCheckPlanGeneralMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> mapVo) throws DataAccessException {
		...
		List<AssCheckPlanGeneral> list = (List<AssCheckPlanGeneral>) queryExists(mapVo);

		for (AssCheckPlanGeneral cs : list) {
		...
		for (Map<String, Object> m : listVo) {
			assCheckPlanGeneralMapper.delete(m);
		}
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			//删除科室盘点单
			assCheckDGeneralMapper.deleteBatch(entityList);
			//删除仓库盘点单
			assCheckSGeneralMapper.deleteBatch(entityList);
			//删除盘点计划

			assCheckPlanGeneralMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssCheckPlanGeneral> list = (List<AssCheckPlanGeneral>) assCheckPlanGeneralMapper.queryExists(mapVo);
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssCheckPlanGeneral> list = (List<AssCheckPlanGeneral>) assCheckPlanGeneralMapper.query(entityMap);
			...
			List<AssCheckPlanGeneral> list = (List<AssCheckPlanGeneral>) assCheckPlanGeneralMapper.query(entityMap, rowBounds);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckPlanGeneralMapper.queryByCode(entityMap);
	}
	 ...
	 * <BR>
	 *            参数为要检索的字段
	 * @return AssCheckPlanGeneral
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckPlanGeneralMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * <BR>
	 *            参数为要检索的字段
	 * @return List<AssCheckPlanGeneral>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckPlanGeneralMapper.queryExists(entityMap);
	}
	...
	public String addGenerateStore(Map<String, Object> entityMap) throws DataAccessException {
		try {
			...
			// 查询仓库信息 按照仓库生成盘点单
			List<Map<String, Object>> store = (List<Map<String, Object>>) assCheckPlanGeneralMapper.queryStores(entityMap);
			...
			for (Map<String, Object> mapS : store) {
				...
				assCheckPlanGeneralMapper.addGenerateStore(s);
				// 更新最大单号
	...
	public String addGenerateDept(Map<String, Object> entityMap) throws DataAccessException {
		try {
			...
			// 查询科室信息 按照科室生成盘点单
			List<Map<String, Object>> depts = (List<Map<String, Object>>) assCheckPlanGeneralMapper.queryDepts(entityMap);
			for (Map<String, Object> mapD : depts) {
				...
				s.put("summary", "");
				s.put("note", "");
				assCheckPlanGeneralMapper.addGenerateDept(s);
				// 更新最大单号
	...
	public List<?> queryByTree(Map<String, Object> entityMap) throws DataAccessException {
		...
		return assCheckPlanGeneralMapper.queryByTree(entityMap);
	...
	public String addGenerateStoreDetail(Map<String, Object> entityMap) throws DataAccessException {
		try {
			assCheckPlanGeneralMapper.addGenerateStoreDetail(entityMap);
			return "{\"msg\":\"生成成功.\",\"state\":\"true\"}";
		}
		catch (Exception e) {
	...
	public String addGenerateDeptDetail(Map<String, Object> entityMap) throws DataAccessException {
		try {
			assCheckPlanGeneralMapper.addGenerateDeptDetail(entityMap);
			return "{\"msg\":\"生成成功.\",\"state\":\"true\"}";
		}
		catch (Exception e) {
	...
	@Override
	public String auditCheckGeneral(Map<String, Object> entityMap) throws DataAccessException {
		try {
			if (entityMap.get("is_dept").toString().equals("0")) {
				AssCheckSGeneral s=	assCheckSGeneralMapper.queryByCode(entityMap);
				...
				AssCheckDGeneral s=	assCheckDGeneralMapper.queryByCode(entityMap);
				if(s==null || s.getState()!=0){
					return "{\"msg\":\"不是新建状态不能提交.\",\"state\":\"true\"}";
				}else{
	...
	@Override
	public String unAuditCheckGeneral(Map<String, Object> entityMap) throws DataAccessException {
