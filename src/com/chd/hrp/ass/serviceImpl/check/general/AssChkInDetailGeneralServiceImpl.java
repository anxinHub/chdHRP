...
import com.chd.hrp.ass.entity.check.general.AssChkInDetailGeneral;
...
@Service("assChkInDetailGeneralService")
public class AssChkInDetailGeneralServiceImpl implements AssChkInDetailGeneralService { 

	private static Logger logger = Logger.getLogger(AssChkInDetailGeneralServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssChkInDetailGeneral assChkInDetailGeneral = queryByCode(entityMap);

		if (assChkInDetailGeneral != null) {
		...
		try {
			...
			int state = assChkInDetailGeneralMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assChkInDetailGeneralMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assChkInDetailGeneralMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assChkInDetailGeneralMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assChkInDetailGeneralMapper.delete(entityMap);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssChkInDetailGeneral> list = (List<AssChkInDetailGeneral>)assChkInDetailGeneralMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssChkInDetailGeneral> list = (List<AssChkInDetailGeneral>)assChkInDetailGeneralMapper.query(entityMap);
			...
			List<AssChkInDetailGeneral> list = (List<AssChkInDetailGeneral>)assChkInDetailGeneralMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInDetailGeneralMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssChkInDetailGeneral
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInDetailGeneralMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssChkInDetailGeneral>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInDetailGeneralMapper.queryExists(entityMap);
	}
	@Override
	public List<Map<String, Object>> queryByInit(Map<String, Object> mapVo) throws DataAccessException {
		return assChkInDetailGeneralMapper.queryByInit(mapVo);
	}
	
	//仓库盘点
	@Override
	public String saveGeneralInventory(List<Map<String, Object>> listVo)
			throws DataAccessException {
		...
		try {
			...
			for( Map<String, Object> listV : listVo){
				...
				List<AssChkDsInGeneralMap> list = (List<AssChkDsInGeneralMap>) assChkDsInGeneralMapMapper.queryy(mapVo4);
				for( AssChkDsInGeneralMap ids: list){
					String ass_in_nos = ids.getAss_in_no();
					mapVo4.put("ass_in_no", ass_in_nos);
					 List<AssChkInMainGeneral>  lists = (List<AssChkInMainGeneral>) assChkInMainGeneralMapper.queryExists(mapVo4);
					 if(lists.size() != 0){
						 return "{\"msg\":\"盘点单"+check_no+"已经生成过盈亏单,不能重复生成\",\"state\":\"true\"}";
					 }
				}
				mapVo4.put("ass_card_no", listV.get("ass_card_no"));
				List<AssChkRdetailGeneral> lists = (List<AssChkRdetailGeneral>) assChkRdetailGeneralMapper.queryExists(mapVo4);
				if(lists.size() != 0){
					 return "{\"msg\":\"盘点单"+check_no+"已经生成过盈亏单,不能重复生成\",\"state\":\"true\"}";
				}
				...
				List<Map<String,Object>> cardMap1 = assChkInDetailGeneralMapper.queryStore(listVo);//盘盈
				for(  Map<String,Object> card : cardMap1){
					...
					//从表数据
						...
						card.put("bill_table", "ASS_CHK_IN_MAIN_GENERAL");
				...
				if(cardMap1.size() != 0){
					//增加关系表 判断时用
					assChkDsInGeneralMapMapper.addBatch(listVo2);
					
					assChkInDetailGeneralMapper.addBatch(listVo2);
					
					
					assChkInMainGeneralMapper.addBatch(listVo1);	
					...
					for(  Map<String,Object> card : cardMap1){
						Map<String, Object> mapVo3 = new HashMap<String, Object>();
							...
							assChkInMainGeneralService.initAssChkInBatchCardGeneral(mapVo3);
					}
				}
				...
				List<Map<String,Object>> cardMap2 = assChkRdetailGeneralMapper.queryStoreStore(listVo);//盘亏
				...
				for(  Map<String,Object> card1 : cardMap2){
					...
					mapVo.put("copy_code", card1.get("copy_code"));	
					card1.put("bill_table", "ASS_CHK_R_GENERAL");
				...
				if(cardMap2.size() != 0){
					assChkRdetailGeneralMapper.addBatch(listVo3);
					assChkRGeneralMapper.addBatch(listVo4);
				}
	...
	//按科室生成盈亏单
	@Override
	public String saveDeptGeneralInventory(List<Map<String, Object>> listVo)
			throws DataAccessException {
		List<Map<String, Object>> listVo1 = new ArrayList<Map<String, Object>>();
		List<Map<String, Object>> listVo2 = new ArrayList<Map<String, Object>>();
		List<Map<String, Object>> listVo3 = new ArrayList<Map<String, Object>>();
		...
		try {
			...
			for( Map<String, Object> listV : listVo){
				...
				List<Map<String,Object>> cardMap1 = assChkInDetailGeneralMapper.queryDept(listVo);//盘盈
				for(  Map<String,Object> card : cardMap1){
					i++;
					Map<String, Object> mapVo1 = new HashMap<String, Object>();
					Map<String, Object> mapVo2 = new HashMap<String, Object>();
				...
				List<Map<String,Object>> cardMap2 = assChkRdetailGeneralMapper.queryDeptDept(listVo);//盘亏
