...
import com.chd.hrp.ass.dao.check.general.AssCheckSpDetailGeneralMapper;
import com.chd.hrp.ass.entity.check.general.AssCheckSpDetailGeneral;
...
@Service("assCheckSpDetailGeneralService")
public class AssCheckSpDetailGeneralServiceImpl implements AssCheckSpDetailGeneralService {

	private static Logger logger = Logger.getLogger(AssCheckSpDetailGeneralServiceImpl.class);
	//引入DAO操作
	@Resource(name = "assCheckSpDetailGeneralMapper")
	private final AssCheckSpDetailGeneralMapper assCheckSpDetailGeneralMapper = null;
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssCheckSpDetailGeneral assCheckSpDetailGeneral = queryByCode(entityMap);

		if (assCheckSpDetailGeneral != null) {
		...
		try {
			...
			int state = assCheckSpDetailGeneralMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckSpDetailGeneralMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assCheckSpDetailGeneralMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assCheckSpDetailGeneralMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assCheckSpDetailGeneralMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckSpDetailGeneralMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		try{	
			...
			assCheckSpDetailGeneralMapper.deleteBatch(listVo);
			assCheckSpDetailGeneralMapper.addBatch(listVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssCheckSpDetailGeneral> list = (List<AssCheckSpDetailGeneral>)assCheckSpDetailGeneralMapper.query(entityMap);
			...
			List<AssCheckSpDetailGeneral> list = (List<AssCheckSpDetailGeneral>)assCheckSpDetailGeneralMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSpDetailGeneralMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssCheckSpDetailGeneral
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSpDetailGeneralMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssCheckSpDetailGeneral>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSpDetailGeneralMapper.queryExists(entityMap);
	}
	//新版打印  调用的方法
		@Override
		public Map<String, Object> queryAssInSpecialByPrintTemlatePrints(Map<String, Object> entityMap)throws DataAccessException {
			...
			try{
				...
				AssCheckSpDetailGeneralMapper assCheckSpDetailGeneralMapper = (AssCheckSpDetailGeneralMapper)context.getBean("assCheckSpDetailGeneralMapper");
			...
			/*	//主页面 批量打印查询
				if("1".equals(String.valueOf(entityMap.get("p_num")))){
					...
					//
					Map<String,Object> map= assCheckSpDetailGeneralMapper.queryAssInSpecialPrintTemlateByMains(entityMap);
					//查询 专用设备  入库明细表
					List<Map<String,Object>> list= assCheckSpDetailGeneralMapper.queryAssInSpecialPrintTemlateByDetails(entityMap);
