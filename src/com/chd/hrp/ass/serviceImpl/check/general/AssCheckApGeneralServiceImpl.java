...
import com.chd.hrp.ass.dao.check.general.AssCheckApDetailGeneralMapper;
import com.chd.hrp.ass.dao.check.general.AssCheckApGeneralMapper;
...
@Service("assCheckApGeneralService")
public class AssCheckApGeneralServiceImpl implements AssCheckApGeneralService {

	private static Logger logger = Logger.getLogger(AssCheckApGeneralServiceImpl.class);
	//引入DAO操作
	@Resource(name = "assCheckApGeneralMapper")
	private final AssCheckApGeneralMapper assCheckApGeneralMapper = null;
	
	@Resource(name = "assCheckApDetailGeneralMapper")
	private final AssCheckApDetailGeneralMapper assCheckApDetailGeneralMapper = null;
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssCheckApGeneral assCheckApGeneral = queryByCode(entityMap);

		if (assCheckApGeneral != null) {
		...
		try {
			...
			int state = assCheckApGeneralMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckApGeneralMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assCheckApGeneralMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assCheckApGeneralMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assCheckApGeneralMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckApDetailGeneralMapper.deleteBatch(entityList);
			assCheckApGeneralMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		List<AssCheckApGeneral> list = (List<AssCheckApGeneral>)assCheckApGeneralMapper.queryExists(entityMap);
		try {
			entityMap.put("state", "0");
			if (list.size()>0) {
				assCheckApGeneralMapper.update(entityMap);
			}else{
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_CHECK_AP_GENERAL");
				String check_ap_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("check_ap_no", check_ap_no);
				assCheckApGeneralMapper.add(entityMap);
			...
			assCheckApDetailGeneralMapper.delete(entityMap);
			assCheckApDetailGeneralMapper.addBatch(listVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssCheckApGeneral> list = (List<AssCheckApGeneral>)assCheckApGeneralMapper.query(entityMap);
			...
			List<AssCheckApGeneral> list = (List<AssCheckApGeneral>)assCheckApGeneralMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckApGeneralMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssCheckApGeneral
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckApGeneralMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssCheckApGeneral>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckApGeneralMapper.queryExists(entityMap);
	}
	@Override
	public String updateConfirmChkAGeneral(List<Map<String, Object>> listVo) throws DataAccessException {
		try {
			assCheckApGeneralMapper.updateBatchConfirm(listVo);
