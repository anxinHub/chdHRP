...
import com.chd.hrp.ass.dao.check.general.AssChkAGeneralMapper;
 ...
 * @Version: 1.0
 */ 
@Service("assChkAGeneralService")
public class AssChkAGeneralServiceImpl implements AssChkAGeneralService {

	private static Logger logger = Logger.getLogger(AssChkAGeneralServiceImpl.class);
	// 引入DAO操作
	@Resource(name = "assChkAGeneralMapper")
	private final AssChkAGeneralMapper assChkAGeneralMapper = null;
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		AssChkAGeneral assDisposalAGeneral = queryByCode(entityMap);
		...
		try {
			...
			int state = assChkAGeneralMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assChkAGeneralMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assChkAGeneralMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assChkAGeneralMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assChkAGeneralMapper.delete(entityMap);
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
	    	...
	    	assChkAdetailGeneralMapper.deleteBatch(entityList);
			assChkAGeneralMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssChkAGeneral> list = (List<AssChkAGeneral>) assChkAGeneralMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			boolean flag2 = true;
			if (list.size() > 0) {
				assChkAGeneralMapper.update(entityMap);
			} else {
				if(entityMap.get("create_date") != null && "".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_CHK_A_GENERAL");
				String ass_chk_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("ass_chk_no", ass_chk_no);
				assChkAGeneralMapper.add(entityMap);
			...
			for (Map<String, Object> detailVo : detail) {
				...
				String results = collectAssChkAGeneral(detailVo);
			...
			assChkAsourceGeneralMapper.delete(entityMap);
			assChkAdetailGeneralMapper.delete(entityMap);
			assChkAdetailGeneralMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assChkAsourceGeneralMapper.addBatch(listSourceVo);
			}
	...
	public String collectAssChkAGeneral(Map<String, Object> entityMap) {
		WebApplicationContext ctx = ContextLoader.getCurrentWebApplicationContext();
		...
		assChkAGeneralMapper.collectAssChkAGeneral(entityMap);
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssChkAGeneral> list = (List<AssChkAGeneral>) assChkAGeneralMapper
					.query(entityMap);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assChkAGeneralMapper.queryByCode(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssChkAGeneral
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assChkAGeneralMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssChkAGeneral>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assChkAGeneralMapper.queryExists(entityMap);
	}

	@Override
	public String updateConfirmChkAGeneral(List<Map<String, Object>> listVo,
			List<Map<String, Object>> listCardVo) throws DataAccessException {
		try {
			assChkAGeneralMapper.updateBatchConfirm(listVo);
			assCardGeneralMapper.updateChkApplyConfirm(listCardVo);
	...
	public String queryAssApplyDeptByPlanDept(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssApplyDept> list = assChkAGeneralMapper.queryAssApplyDeptByPlanDept(entityMap);
			...
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<AssApplyDept> list = assChkAGeneralMapper.queryAssApplyDeptByPlanDept(entityMap, rowBounds);
