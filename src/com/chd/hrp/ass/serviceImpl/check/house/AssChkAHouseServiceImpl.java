...
import com.chd.hrp.ass.dao.check.house.AssChkAHouseMapper;
...
/**
 * 
 * @Description: 051001资产盘亏申报(房屋及建筑)
 * @Table: ASS_CHK_A_House
 * @Author: bell
 * @email: bell@e-tonggroup.com
 * @Version: 1.0
 */ 
@Service("assChkAHouseService")
public class AssChkAHouseServiceImpl implements AssChkAHouseService {

	private static Logger logger = Logger.getLogger(AssChkAHouseServiceImpl.class);
	// 引入DAO操作
	@Resource(name = "assChkAHouseMapper")
	private final AssChkAHouseMapper assChkAHouseMapper = null;
	...
	/**
	 * @Description 添加051001资产盘亏申报(房屋及建筑)<BR>
	 * @param entityMap
	 * @return String JSON
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		// 获取对象051001资产盘亏申报(房屋及建筑)
		AssChkAHouse assDisposalAHouse = queryByCode(entityMap);
		...
		try {
			...
			int state = assChkAHouseMapper.add(entityMap);
	...
	/**
	 * @Description 批量添加051001资产盘亏申报(房屋及建筑)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assChkAHouseMapper.addBatch(entityList);
	...
	/**
	 * @Description 更新051001资产盘亏申报(房屋及建筑)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assChkAHouseMapper.update(entityMap);
	...
	/**
	 * @Description 批量更新051001资产盘亏申报(房屋及建筑)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assChkAHouseMapper.updateBatch(entityList);
	...
	/**
	 * @Description 删除051001资产盘亏申报(房屋及建筑)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assChkAHouseMapper.delete(entityMap);
	...
	/**
	 * @Description 批量删除051001资产盘亏申报(房屋及建筑)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assChkAHouseMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssChkAHouse> list = (List<AssChkAHouse>) assChkAHouseMapper.queryExists(mapVo);
		try {
			boolean flag2 = true;
			if (list.size() > 0) {
				assChkAHouseMapper.update(entityMap);
			} else {
				entityMap.put("bill_table", "ASS_CHK_A_HOUSE");
				String ass_chk_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("ass_chk_no", ass_chk_no);
				assChkAHouseMapper.add(entityMap);
			...
			for (Map<String, Object> detailVo : detail) {
				...
				String results = collectAssChkAHouse(detailVo);
			...
			assChkAsourceHouseMapper.delete(entityMap);
			assChkAdetailHouseMapper.delete(entityMap);
			assChkAdetailHouseMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assChkAsourceHouseMapper.addBatch(listSourceVo);
			}
	...
	public String collectAssChkAHouse(Map<String, Object> entityMap) {
		WebApplicationContext ctx = ContextLoader.getCurrentWebApplicationContext();
		...
		assChkAHouseMapper.collectAssChkAHouse(entityMap);
	...
	/**
	 * @Description 查询结果集051001资产盘亏申报(房屋及建筑)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssChkAHouse> list = (List<AssChkAHouse>) assChkAHouseMapper
					.query(entityMap);
	...
	/**
	 * @Description 获取对象051001资产盘亏申报(房屋及建筑)<BR>
	 * @param entityMap<BR>
	 *            参数为主键
	 * @return String JSON
	 * @throws DataAccessException
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assChkAHouseMapper.queryByCode(entityMap);
	}

	/**
	 * @Description 获取051001资产盘亏申报(房屋及建筑)<BR>
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssChkAHouse
	 * @throws DataAccessException
	...
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assChkAHouseMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssChkAHouse>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assChkAHouseMapper.queryExists(entityMap);
	}

	@Override
	public String updateConfirmChkAHouse(List<Map<String, Object>> listVo,
			List<Map<String, Object>> listCardVo) throws DataAccessException {
		try {
			assChkAHouseMapper.updateBatchConfirm(listVo);
			assCardHouseMapper.updateChkApplyConfirm(listCardVo);
	...
	public String queryAssApplyDeptByPlanDept(Map<String, Object> entityMap) {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssApplyDept> list = assChkAHouseMapper.queryAssApplyDeptByPlanDept(entityMap);
			...
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<AssApplyDept> list = assChkAHouseMapper.queryAssApplyDeptByPlanDept(entityMap, rowBounds);
