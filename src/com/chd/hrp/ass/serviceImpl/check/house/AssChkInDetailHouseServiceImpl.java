...
import com.chd.hrp.ass.entity.check.house.AssChkInDetailHouse;
 ...
 * 
 * @Description:
 * 050701 资产盘盈入库明细(房屋及建筑)
 * @Table:
 * ASS_CHK_IN_DETAIL_House
 * @Author: bell
...
@Service("assChkInDetailHouseService")
public class AssChkInDetailHouseServiceImpl implements AssChkInDetailHouseService {

	private static Logger logger = Logger.getLogger(AssChkInDetailHouseServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象050701 资产盘盈入库明细(房屋及建筑)
		AssChkInDetailHouse assChkInDetailHouse = queryByCode(entityMap);

		if (assChkInDetailHouse != null) {
		...
		try {
			...
			int state = assChkInDetailHouseMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assChkInDetailHouseMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assChkInDetailHouseMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assChkInDetailHouseMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assChkInDetailHouseMapper.delete(entityMap);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssChkInDetailHouse> list = (List<AssChkInDetailHouse>)assChkInDetailHouseMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssChkInDetailHouse> list = (List<AssChkInDetailHouse>)assChkInDetailHouseMapper.query(entityMap);
			...
			List<AssChkInDetailHouse> list = (List<AssChkInDetailHouse>)assChkInDetailHouseMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInDetailHouseMapper.queryByCode(entityMap);
	}
	
	/**
	 * @Description 
	 * 获取050701 资产盘盈入库明细(房屋及建筑)<BR> 
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssChkInDetailHouse
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInDetailHouseMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssChkInDetailHouse>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInDetailHouseMapper.queryExists(entityMap);
	}
	@Override
	public List<Map<String, Object>> queryByInit(Map<String, Object> mapVo) throws DataAccessException {
		return assChkInDetailHouseMapper.queryByInit(mapVo);
	}
	
	//仓库
	@Override
	public String saveHouseInventory(List<Map<String, Object>> listVo)
			throws DataAccessException {
		...
		try {
			...
			for( Map<String, Object> detailVo : listVo){
				...
				List<AssCardHouse> listss = (List<AssCardHouse>) assCardHouseMapper.queryExists(mapVo4);
				for( AssCardHouse ids: listss){
					String ass_in_nos = ids.getAss_in_no();
					mapVo4.put("ass_in_no", ass_in_nos);
				 List<AssChkInMainHouse>  lists = (List<AssChkInMainHouse>) assChkInMainHouseMapper.queryExists(mapVo4);
					 if(lists.size() != 0){
						 return "{\"msg\":\"盘点单"+check_no+"已经生成过盈亏单,不能重复生成\",\"state\":\"true\"}";
					 }
				}
				 mapVo4.put("ass_card_no", detailVo.get("ass_card_no"));
				List<AssChkRdetailHouse> listsss = (List<AssChkRdetailHouse>) assChkRdetailHouseMapper.queryExists(mapVo4);
				if(listsss.size() != 0 ){
					 return "{\"msg\":\"盘点单"+check_no+"已经生成过盈亏单,不能重复生成\",\"state\":\"true\"}";
				}
			}
			for( Map<String, Object> detailVo : listVo){
				...
				mapVo5.put("check_plan_no", detailVo.get("check_plan_no"));
						...
						List<Map<String,Object>> list1 = assCardHouseMapper.queryStore(listVo);//盘盈
						...
						for( Map<String, Object> listMap : list1){
							...
							listMap.put("bill_table", "ASS_CARD_HOUSE");
							...
							listMap.put("bill_table", "ASS_CHK_IN_MAIN_HOUSE");
							...
							assCardHouseService.add(mapVo2);
							
						}
					
							
							//盘亏
							List<Map<String,Object>> list2 = assChkRdetailHouseMapper.queryStoreStore(listVo);//盘亏
							for(  Map<String,Object> card1 : list2){
								...
								mapVo.put("copy_code", card1.get("copy_code"));	
								card1.put("bill_table", "ASS_CHK_R_HOUSE");
							...
							if(list2.size() != 0){
								assChkRdetailHouseMapper.addBatch(listVo3);
								assChkRHouseMapper.addBatch(listVo4);
							}
