...
import com.chd.hrp.ass.dao.check.house.AssCheckDetailHouseMapper;
import com.chd.hrp.ass.entity.check.house.AssCheckDetailHouse;
import com.chd.hrp.ass.entity.check.house.AssCheckDetailHouse;
import com.chd.hrp.ass.service.check.house.AssCheckDetailHouseService;
import com.chd.hrp.ass.serviceImpl.check.house.AssCheckDetailHouseServiceImpl;
import com.github.pagehelper.PageInfo;

/**
 * 
 * @Description:
 * 051101 科室盘点单明细_房屋及建筑
 * @Table:
 * ASS_CHECK_D_DETAIL_House
 * @Author: bell
...
@Service("assCheckDetailHouseService")
public class AssCheckDetailHouseServiceImpl implements AssCheckDetailHouseService {

	private static Logger logger = Logger.getLogger(AssCheckDetailHouseServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssCheckDetailHouse assCheckDdetailHouse = queryByCode(entityMap);

		if (assCheckDdetailHouse != null) {
		...
		try {
			...
			int state = assCheckDetailHouseMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckDetailHouseMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assCheckDetailHouseMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assCheckDetailHouseMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assCheckDetailHouseMapper.delete(entityMap);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssCheckDetailHouse> list = (List<AssCheckDetailHouse>)assCheckDetailHouseMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssCheckDetailHouse> list = (List<AssCheckDetailHouse>)assCheckDetailHouseMapper.query(entityMap);
			...
			List<AssCheckDetailHouse> list = (List<AssCheckDetailHouse>)assCheckDetailHouseMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckDetailHouseMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssCheckDdetailHouse
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckDetailHouseMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssCheckDdetailHouse>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckDetailHouseMapper.queryExists(entityMap);
	}
	/**
	 * @Description 复制账面数量
	 * @param mapVo
	...
	public String copyAmount(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		//根据勾选的卡片复制账面数量
		assCheckDetailHouseMapper.copyAmount(mapVo);
	...
	public String delCard(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		mapVo.put("ass_card_no_all", vr);
		//根据勾选的卡片复制账面数量
		assCheckDetailHouseMapper.delete(mapVo);
	...
	//新版打印  调用的方法
		...
		public Map<String, Object> queryAssInSpecialByPrintTemlatePrints(Map<String, Object> entityMap)throws DataAccessException {
			...
			try{
				...
				AssCheckDetailHouseMapper assCheckDetailHouseMapper = (AssCheckDetailHouseMapper)context.getBean("assCheckDetailHouseMapper");
			...
			/*	//主页面 批量打印查询
				if("1".equals(String.valueOf(entityMap.get("p_num")))){
					...
					//
					Map<String,Object> map= assCheckDetailHouseMapper.queryAssInSpecialPrintTemlateByMains(entityMap);
					//查询 专用设备  入库明细表
					List<Map<String,Object>> list= assCheckDetailHouseMapper.queryAssInSpecialPrintTemlateByDetails(entityMap);
	...
	public List<String> queryAssInSpecialState(Map<String, Object> mapVo) {
		return assCheckDetailHouseMapper.queryAssInSpecialStates(mapVo);

	}
	
	
		@Override
		public String saveAssCheckSDetailHouse(Map<String, Object> entityMap)
				throws DataAccessException {
			...
			try{	
				...
				assCheckDetailHouseMapper.deleteBatch(listVo);
				assCheckDetailHouseMapper.addBatch(listVo);
