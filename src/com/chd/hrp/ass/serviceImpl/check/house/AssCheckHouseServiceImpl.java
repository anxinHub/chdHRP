 ...
 * @Table: ASS_CHECK_D_House
 * @Author: bell
 * @email: bell@e-tonggroup.com
 * @Version: 1.0
 */
 
@Service("assCheckHouseService")
public class AssCheckHouseServiceImpl implements AssCheckHouseService {

	private static Logger logger = Logger.getLogger(AssCheckHouseServiceImpl.class);
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		// 获取对象051101 科室盘点单(土地)
		AssCheckHouse assCheckHouse = queryByCode(entityMap);
		...
		try {
			entityMap.put("bill_table", "ASS_CHECK_D_House");
			...
			entityMap.put("note", "");
			int state = assCheckHouseMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assCheckHouseMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assCheckHouseMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assCheckHouseMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			assCheckDetailHouseMapper.delete(entityMap);

			int state = assCheckHouseMapper.delete(entityMap);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssCheckHouse> list = (List<AssCheckHouse>) assCheckHouseMapper.queryExists(mapVo);
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssCheckHouse> list = (List<AssCheckHouse>) assCheckHouseMapper.query(entityMap);
			...
			List<AssCheckHouse> list = (List<AssCheckHouse>) assCheckHouseMapper.query(entityMap, rowBounds);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckHouseMapper.queryByCode(entityMap);
	}
	 ...
	 * <BR>
	 *            参数为要检索的字段
	 * @return AssCheckDHouse
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckHouseMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * <BR>
	 *            参数为要检索的字段
	 * @return List<AssCheckDHouse>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckHouseMapper.queryExists(entityMap);
	}
	...
	public String auditBatch(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		List<AssCheckHouse> list = (List<AssCheckHouse>) queryExists(mapVo);

		for (AssCheckHouse cs : list) {
	...
	@Override
	public AssCheckHouse queryState(Map<String, Object> mapVo)
			throws DataAccessException {
		// TODO Auto-generated method stub
		return assCheckHouseMapper.queryState(mapVo);
	}
}
