...
import com.chd.hrp.ass.dao.check.inassets.AssChkRsourceInassetsMapper;
 ...
 * @Version: 1.0
 */ 
@Service("assChkRinassetsService")
public class AssChkRinassetsServiceImpl implements AssChkRinassetsService {

	private static Logger logger = Logger.getLogger(AssChkRinassetsServiceImpl.class);
	// 引入DAO操作
	...
	@Resource(name = "assChkRsourceInassetsMapper")
	private final AssChkRsourceInassetsMapper assChkRsourceInassetsMapper = null;
	...
	/**
	 * @Description 添加051001资产盘亏记录(无形资产)<BR>
	 * @param entityMap
	 * @return String JSON
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		// 获取对象051001资产盘亏记录(无形资产)
		AssChkRinassets assDisposalAinassets = queryByCode(entityMap);
		...
		try {
			...
			int state = assChkRinassetsMapper.add(entityMap);
	...
	/**
	 * @Description 批量添加051001资产盘亏记录(无形资产)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assChkRinassetsMapper.addBatch(entityList);
	...
	/**
	 * @Description 更新051001资产盘亏记录(无形资产)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assChkRinassetsMapper.update(entityMap);
	...
	/**
	 * @Description 批量更新051001资产盘亏记录(无形资产)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assChkRinassetsMapper.updateBatch(entityList);
	...
	/**
	 * @Description 删除051001资产盘亏记录(无形资产)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assChkRinassetsMapper.delete(entityMap);
	...
	/**
	 * @Description 批量删除051001资产盘亏记录(无形资产)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			assChkRsourceInassetsMapper.deleteBatch(entityList);
	    	assChkRdetailInassetsMapper.deleteBatch(entityList);
			assChkRinassetsMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssChkRinassets> list = (List<AssChkRinassets>) assChkRinassetsMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			boolean flag2 = true;
			if (list.size() > 0) {
				assChkRinassetsMapper.update(entityMap);
			} else {
				entityMap.put("bill_table", "ASS_CHK_R_INASSETS");
				String ass_chk_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("ass_chk_no", ass_chk_no);
				assChkRinassetsMapper.add(entityMap);
			...
			for (Map<String, Object> detailVo : detail) {
				...
				String results = collectAssChkRinassets(detailVo);
			...
			assChkRsourceInassetsMapper.delete(entityMap);
			assChkRdetailInassetsMapper.delete(entityMap);
			assChkRdetailInassetsMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assChkRsourceInassetsMapper.addBatch(listSourceVo);
			}
	...
	public String collectAssChkRinassets(Map<String, Object> entityMap) {
		WebApplicationContext ctx = ContextLoader.getCurrentWebApplicationContext();
		...
		assChkRinassetsMapper.collectAssChkRinassets(entityMap);
	...
	/**
	 * @Description 查询结果集051001资产盘亏记录(无形资产)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssChkRinassets> list = (List<AssChkRinassets>) assChkRinassetsMapper
					.query(entityMap);
	...
	/**
	 * @Description 获取对象051001资产盘亏记录(无形资产)<BR>
	 * @param entityMap<BR>
	 *            参数为主键
	 * @return String JSON
	 * @throws DataAccessException
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assChkRinassetsMapper.queryByCode(entityMap);
	}

	/**
	 * @Description 获取051001资产盘亏记录(无形资产)<BR>
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssChkRinassets
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assChkRinassetsMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssChkRinassets>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assChkRinassetsMapper.queryExists(entityMap);
	}

	@Override
	public String updateConfirmChkRinassets(List<Map<String, Object>> listVo,
			List<Map<String, Object>> listCardVo) throws DataAccessException {
		try {
			assChkRinassetsMapper.updateBatchConfirm(listVo);
			assCardInassetsMapper.updateChkRecordConfirm(listCardVo);
	...
	@Override
	public String initAssCheckInassets(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			List<AssChkAdetailInassets> assBackDetailSpecial = (List<AssChkAdetailInassets>) assChkAdetailInassetsMapper
					.query(entityMap);
			entityMap.put("bill_table", "ASS_CHK_R_INASSETS");
			...
			for (String temp : carno.toString().split(",")) {// 循环生成单据的明细ID
				...
				assChkRinassetsMapper.addAssPlanDeptImportBid(planApplyMapvo);
			}
			assBaseService.updateAssBillNoMaxNo(entityMap);
			for (AssChkAdetailInassets assChkAdetailSpecial : assBackDetailSpecial) {
				...
				String results = collectAssChkRinassets(map);
	...
	public String deleteBatchAssApplyPlanMap(List<Map<String, Object>> listVo) {
		try {
			...
			assChkRinassetsMapper.deleteBatchAssApplyPlanMap(listVo);
			return "{\"msg\":\"删除成功.\",\"state\":\"true\"}";
