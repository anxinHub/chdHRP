...
import com.chd.hrp.ass.entity.check.inassets.AssCheckDdetailInassets;
...
@Service("assCheckDdetailInassetsService")
public class AssCheckDdetailInassetsServiceImpl implements AssCheckDdetailInassetsService {

	private static Logger logger = Logger.getLogger(AssCheckDdetailInassetsServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssCheckDdetailInassets assCheckDdetailInassets = queryByCode(entityMap);

		if (assCheckDdetailInassets != null) {
		...
		try {
			...
			int state = assCheckDdetailInassetsMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckDdetailInassetsMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assCheckDdetailInassetsMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assCheckDdetailInassetsMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assCheckDdetailInassetsMapper.delete(entityMap);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssCheckDdetailInassets> list = (List<AssCheckDdetailInassets>)assCheckDdetailInassetsMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssCheckDdetailInassets> list = (List<AssCheckDdetailInassets>)assCheckDdetailInassetsMapper.query(entityMap);
			...
			List<AssCheckDdetailInassets> list = (List<AssCheckDdetailInassets>)assCheckDdetailInassetsMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckDdetailInassetsMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssCheckDdetailInassets
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckDdetailInassetsMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssCheckDdetailInassets>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckDdetailInassetsMapper.queryExists(entityMap);
	}
	/**
	 * @Description 复制账面数量
	 * @param mapVo
	...
	public String copyAmount(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		//根据勾选的卡片复制账面数量
		assCheckDdetailInassetsMapper.copyAmount(mapVo);
	...
	public String delCard(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		mapVo.put("ass_card_no_all", vr);
		//根据勾选的卡片复制账面数量
		assCheckDdetailInassetsMapper.delete(mapVo);
	...
	public Map<String, Object> queryAssInSpecialByPrintTemlatePrints(Map<String, Object> entityMap)throws DataAccessException {
		...
		try{
			...
			AssCheckDdetailInassetsMapper assCheckDdetailInassetsMapper = (AssCheckDdetailInassetsMapper)context.getBean("assCheckDdetailInassetsMapper");
		...
		/*	//主页面 批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				...
				//
				Map<String,Object> map= assCheckDdetailInassetsMapper.queryAssInSpecialPrintTemlateByMains(entityMap);
				//查询 专用设备  入库明细表
				List<Map<String,Object>> list= assCheckDdetailInassetsMapper.queryAssInSpecialPrintTemlateByDetails(entityMap);
	...
	public List<String> queryAssInSpecialStates(Map<String, Object> mapVo) throws DataAccessException {
		...
		return assCheckDdetailInassetsMapper.queryAssInSpecialStates(mapVo);
	}
	@Override
	public String saveAssCheckDDetailInassets(Map<String, Object> entityMap)
			throws DataAccessException {
		...
		try{	
			...
			assCheckDdetailInassetsMapper.deleteBatch(listVo);
			assCheckDdetailInassetsMapper.addBatch(listVo);
