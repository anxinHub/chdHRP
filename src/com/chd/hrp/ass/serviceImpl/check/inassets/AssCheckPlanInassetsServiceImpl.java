...
import com.chd.hrp.ass.dao.check.inassets.AssCheckDdetailInassetsMapper;
import com.chd.hrp.ass.dao.check.inassets.AssCheckDinassetsMapper;
import com.chd.hrp.ass.dao.check.inassets.AssCheckPlanInassetsMapper;
...
@Service("assCheckPlanInassetsService")
public class AssCheckPlanInassetsServiceImpl implements AssCheckPlanInassetsService {

	private static Logger logger = Logger.getLogger(AssCheckPlanInassetsServiceImpl.class);

	// 引入DAO操作
	@Resource(name = "assCheckPlanInassetsMapper")
	private final AssCheckPlanInassetsMapper assCheckPlanInassetsMapper = null;
	...
	@Resource(name = "assCheckDdetailInassetsMapper")
	private final AssCheckDdetailInassetsMapper assCheckDdetailInassetsMapper = null;
	
	// 引入DAO操作
	@Resource(name = "assCheckDinassetsMapper")
	private final AssCheckDinassetsMapper assCheckDinassetsMapper = null;

	/**
	 * @Description 添加051101 盘点任务单(无形资产)<BR>
	 * @param entityMap
	 * @return String JSON
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		// 获取对象051101 盘点任务单(无形资产)
		AssCheckPlanInassets assCheckPlanInassets = queryByCode(entityMap);

		if (assCheckPlanInassets != null) {
	...
	/**
	 * @Description 批量添加051101 盘点任务单(无形资产)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assCheckPlanInassetsMapper.addBatch(entityList);
	...
	/**
	 * @Description 更新051101 盘点任务单(无形资产)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assCheckPlanInassetsMapper.update(entityMap);
	...
	/**
	 * @Description 批量更新051101 盘点任务单(无形资产)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assCheckPlanInassetsMapper.updateBatch(entityList);
	...
	/**
	 * @Description 删除051101 盘点任务单(无形资产)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String delete(Map<String, Object> mapVo) throws DataAccessException {
		...
		List<AssCheckPlanInassets> list = (List<AssCheckPlanInassets>) queryExists(mapVo);

		for (AssCheckPlanInassets cs : list) {
		...
		for (Map<String, Object> m : listVo) {
			assCheckPlanInassetsMapper.delete(m);
		}
	...
	/**
	 * @Description 批量删除051101 盘点任务单(无形资产)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			//删除仓库盘点明细
			assCheckSdetailInassetsMapper.deleteBatch(entityList);
			//删除科室盘点明细
			assCheckDdetailInassetsMapper.deleteBatch(entityList);
			//删除科室盘点单
			assCheckDinassetsMapper.deleteBatch(entityList);
			//删除仓库盘点单
			assCheckSinassetsMapper.deleteBatch(entityList);
			//删除盘点计划
			assCheckPlanInassetsMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssCheckPlanInassets> list = (List<AssCheckPlanInassets>) assCheckPlanInassetsMapper.queryExists(mapVo);
	...
	/**
	 * @Description 查询结果集051101 盘点任务单(无形资产)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssCheckPlanInassets> list = (List<AssCheckPlanInassets>) assCheckPlanInassetsMapper.query(entityMap);
			...
			List<AssCheckPlanInassets> list = (List<AssCheckPlanInassets>) assCheckPlanInassetsMapper.query(entityMap, rowBounds);
	...
	/**
	 * @Description 获取对象051101 盘点任务单(无形资产)<BR>
	 * @param entityMap
	 * <BR>
	 *            参数为主键
	 * @return String JSON
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckPlanInassetsMapper.queryByCode(entityMap);
	}

	/**
	 * @Description 获取051101 盘点任务单(无形资产)<BR>
	 * @param entityMap
	 * <BR>
	 *            参数为要检索的字段
	 * @return AssCheckPlanInassets
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckPlanInassetsMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * <BR>
	 *            参数为要检索的字段
	 * @return List<AssCheckPlanInassets>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckPlanInassetsMapper.queryExists(entityMap);
	}
	...
	public String addGenerateStore(Map<String, Object> entityMap) throws DataAccessException {
		try {
			...
			// 查询仓库信息 按照仓库生成盘点单
			List<Map<String, Object>> store = (List<Map<String, Object>>) assCheckPlanInassetsMapper.queryStores(entityMap);
			...
			for (Map<String, Object> mapS : store) {
				...
				// 添加仓库盘点单 主表
				mapS.put("bill_table", "ASS_CHECK_S_INASSETS");
				...
				assCheckPlanInassetsMapper.addGenerateStore(s);
				// 更新最大单号
	...
	public String addGenerateDept(Map<String, Object> entityMap) throws DataAccessException {
		try {
			...
			// 查询科室信息 按照科室生成盘点单
			List<Map<String, Object>> depts = (List<Map<String, Object>>) assCheckPlanInassetsMapper.queryDepts(entityMap);
			for (Map<String, Object> mapD : depts) {
				...
				mapD.put("bill_table", "ASS_CHECK_D_INASSETS");
				...
				s.put("summary", "");
				s.put("note", "");
				assCheckPlanInassetsMapper.addGenerateDept(s);
				// 更新最大单号
	...
	public List<?> queryByTree(Map<String, Object> entityMap) throws DataAccessException {
		...
		return assCheckPlanInassetsMapper.queryByTree(entityMap);
	...
	public String addGenerateStoreDetail(Map<String, Object> entityMap) throws DataAccessException {
		try {
			assCheckPlanInassetsMapper.addGenerateStoreDetail(entityMap);
			return "{\"msg\":\"生成成功.\",\"state\":\"true\"}";
		}
		catch (Exception e) {
	...
	public String addGenerateDeptDetail(Map<String, Object> entityMap) throws DataAccessException {
		try {
			assCheckPlanInassetsMapper.addGenerateDeptDetail(entityMap);
			return "{\"msg\":\"生成成功.\",\"state\":\"true\"}";
		}
		catch (Exception e) {
	...
	public String auditCheckInassets(Map<String, Object> entityMap) throws DataAccessException {
		try {
			if (entityMap.get("is_dept").toString().equals("0")) {
				AssCheckSinassets s=	assCheckSinassetsMapper.queryByCode(entityMap);
				if(s==null || s.getState()!=0){
					return "{\"msg\":\"不是新建状态不能提交.\",\"state\":\"true\"}";
				}else{
					assCheckSinassetsMapper.update(entityMap);
				}
				
			} else if (entityMap.get("is_dept").toString().equals("1")) {
				AssCheckDinassets s=	assCheckDinassetsMapper.queryByCode(entityMap);
				if(s==null || s.getState()!=0){
					return "{\"msg\":\"不是新建状态不能提交.\",\"state\":\"true\"}";
				}else{
					assCheckDinassetsMapper.update(entityMap);
				}
			}else{
				//当前台传递的is_dept不为 0 或者 1 时  不进行操作
			 return "{\"msg\":\"无效的盘点单 is_dept 取值错误.\",\"state\":\"true\"}";
