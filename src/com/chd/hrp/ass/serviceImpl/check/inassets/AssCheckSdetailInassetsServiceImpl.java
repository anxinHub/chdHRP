...
import com.chd.hrp.ass.entity.check.inassets.AssCheckSdetailInassets;
...
@Service("assCheckSdetailInassetsService")
public class AssCheckSdetailInassetsServiceImpl implements AssCheckSdetailInassetsService {

	private static Logger logger = Logger.getLogger(AssCheckSdetailInassetsServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssCheckSdetailInassets assCheckSdetailInassets = queryByCode(entityMap);

		if (assCheckSdetailInassets != null) {
		...
		try {
			...
			int state = assCheckSdetailInassetsMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckSdetailInassetsMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assCheckSdetailInassetsMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assCheckSdetailInassetsMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assCheckSdetailInassetsMapper.delete(entityMap);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssCheckSdetailInassets> list = (List<AssCheckSdetailInassets>)assCheckSdetailInassetsMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssCheckSdetailInassets> list = (List<AssCheckSdetailInassets>)assCheckSdetailInassetsMapper.query(entityMap);
			...
			List<AssCheckSdetailInassets> list = (List<AssCheckSdetailInassets>)assCheckSdetailInassetsMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSdetailInassetsMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssCheckSdetailInassets
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSdetailInassetsMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssCheckSdetailInassets>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSdetailInassetsMapper.queryExists(entityMap);
	}
	/**
	 * @Description 复制账面数量
	 * @param mapVo
	...
	public String copyAmount(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		//根据勾选的卡片复制账面数量
		assCheckSdetailInassetsMapper.copyAmount(mapVo);
	...
	public String delCard(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		mapVo.put("ass_card_no_all", vr);
		//根据勾选的卡片复制账面数量
		assCheckSdetailInassetsMapper.delete(mapVo);
	...
	public Map<String, Object> queryAssInSpecialByPrintTemlatePrint(Map<String, Object> entityMap)throws DataAccessException {
		...
		try{
			...
			AssCheckSdetailInassetsMapper assCheckSdetailInassetsMapper = (AssCheckSdetailInassetsMapper)context.getBean("assCheckSdetailInassetsMapper");
		...
		/*	//主页面 批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				...
				//
				Map<String,Object> map= assCheckSdetailInassetsMapper.queryAssInSpecialPrintTemlateByMain(entityMap);
				//查询 专用设备  入库明细表
				List<Map<String,Object>> list= assCheckSdetailInassetsMapper.queryAssInSpecialPrintTemlateByDetail(entityMap);
	...
	public List<String> queryAssInSpecialState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return assCheckSdetailInassetsMapper.queryAssInSpecialState(mapVo);
	}
	@Override
	public String saveAssCheckSDetailInassets(Map<String, Object> entityMap)
			throws DataAccessException {
		...
		try{	
			...
			assCheckSdetailInassetsMapper.deleteBatch(listVo);
			assCheckSdetailInassetsMapper.addBatch(listVo);
