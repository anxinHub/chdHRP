...
import com.chd.hrp.ass.entity.check.other.AssChkInDetailOther;
...
@Service("assChkInDetailOtherService")
public class AssChkInDetailOtherServiceImpl implements AssChkInDetailOtherService { 

	private static Logger logger = Logger.getLogger(AssChkInDetailOtherServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象050701 资产盘盈入库明细(一般设备)
		AssChkInDetailOther assChkInDetailOther = queryByCode(entityMap);

		if (assChkInDetailOther != null) {
		...
		try {
			...
			int state = assChkInDetailOtherMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assChkInDetailOtherMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assChkInDetailOtherMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assChkInDetailOtherMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assChkInDetailOtherMapper.delete(entityMap);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssChkInDetailOther> list = (List<AssChkInDetailOther>)assChkInDetailOtherMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssChkInDetailOther> list = (List<AssChkInDetailOther>)assChkInDetailOtherMapper.query(entityMap);
			...
			List<AssChkInDetailOther> list = (List<AssChkInDetailOther>)assChkInDetailOtherMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInDetailOtherMapper.queryByCode(entityMap);
	}
	
	/**
	 * @Description 
	 * 获取050701 资产盘盈入库明细(一般设备)<BR> 
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssChkInDetailOther
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInDetailOtherMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssChkInDetailOther>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInDetailOtherMapper.queryExists(entityMap);
	}
	@Override
	public List<Map<String, Object>> queryByInit(Map<String, Object> mapVo) throws DataAccessException {
		return assChkInDetailOtherMapper.queryByInit(mapVo);
	}
	@Override
	public String saveOtherInventory(List<Map<String, Object>> listVo)
			throws DataAccessException {
		...
		try {
			...
			for( Map<String, Object> listV : listVo){
				...
				List<AssChkDsInOtherMap> list = (List<AssChkDsInOtherMap>) assChkDsInOtherMapMapper.queryy(mapVo4);
				for( AssChkDsInOtherMap ids: list){
					String ass_in_nos = ids.getAss_in_no();
					mapVo4.put("ass_in_no", ass_in_nos);
					 List<AssChkInMainOther>  lists = (List<AssChkInMainOther>) assChkInMainOtherMapper.queryExists(mapVo4);
					 if(lists.size() != 0){
						 return "{\"msg\":\"盘点单"+check_no+"已经生成过盈亏单,不能重复生成\",\"state\":\"true\"}";
					 }
				}
				mapVo4.put("ass_card_no", listV.get("ass_card_no"));
				List<AssChkRdetailOther> lists = (List<AssChkRdetailOther>) assChkRdetailOtherMapper.queryExists(mapVo4);
				if(lists.size() != 0){
					 return "{\"msg\":\"盘点单"+check_no+"已经生成过盈亏单,不能重复生成\",\"state\":\"true\"}";
				}
				...
				List<Map<String,Object>> cardMap1 = assChkInDetailOtherMapper.queryStore(listVo);//盘盈
				for(  Map<String,Object> card : cardMap1){
					...
					//从表数据
						...
						card.put("bill_table", "ASS_CHK_IN_MAIN_OTHER");
				...
				if(cardMap1.size() != 0){
					//增加关系表 判断时用
					assChkDsInOtherMapMapper.addBatch(listVo2);
					
					assChkInDetailOtherMapper.addBatch(listVo2);
					
					
					assChkInMainOtherMapper.addBatch(listVo1);	
					...
					for(  Map<String,Object> card : cardMap1){
						...
						assChkInMainOtherService.initAssChkInBatchCardOther(mapVo3);
					}
				}
				...
				List<Map<String,Object>> cardMap2 = assChkRdetailOtherMapper.queryStoreStore(listVo);//盘亏
				...
				for(  Map<String,Object> card1 : cardMap2){
					...
					mapVo.put("copy_code", card1.get("copy_code"));	
					card1.put("bill_table", "ASS_CHK_R_OTHER");
				...
				if(cardMap2.size() != 0){
					assChkRdetailOtherMapper.addBatch(listVo3);
					assChkROtherMapper.addBatch(listVo4);
				}
	...
	//科室
	@Override
	public String saveDeptOtherInventory(List<Map<String, Object>> listVo)
			throws DataAccessException {
		List<Map<String, Object>> listVo1 = new ArrayList<Map<String, Object>>();
		List<Map<String, Object>> listVo2 = new ArrayList<Map<String, Object>>();
		List<Map<String, Object>> listVo3 = new ArrayList<Map<String, Object>>();
		...
		try {
			...
			for( Map<String, Object> listV : listVo){
				...
				for( AssChkDsInOtherMap ids: list){
					String ass_in_nos = ids.getAss_in_no();
					mapVo4.put("ass_in_no", ass_in_nos);
					 List<AssChkDsInOtherMap>  lists = (List<AssChkDsInOtherMap>) assChkInMainOtherMapper.queryExists(mapVo4);
					 if(lists.size() != 0){
						 return "{\"msg\":\"盘点单"+check_no+"已经生成过盈亏单,不能重复生成\",\"state\":\"true\"}";
					 }
				}
				mapVo4.put("ass_card_no", listV.get("ass_card_no"));
				List<AssChkInDetailOther> lists = (List<AssChkInDetailOther>) assChkInDetailOtherMapper.queryExists(mapVo4);
				if(lists.size() != 0){
					 return "{\"msg\":\"盘点单"+check_no+"已经生成过盈亏单,不能重复生成\",\"state\":\"true\"}";
				}
				...
				List<Map<String,Object>> cardMap1 = assChkInDetailOtherMapper.queryDept(listVo);//盘盈
				for(  Map<String,Object> card : cardMap1){
					i++;
					Map<String, Object> mapVo1 = new HashMap<String, Object>();
					Map<String, Object> mapVo2 = new HashMap<String, Object>();
				...
				List<Map<String,Object>> cardMap2 = assChkRdetailOtherMapper.queryDeptDept(listVo);//盘亏
