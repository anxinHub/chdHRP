...
import com.chd.hrp.ass.dao.check.other.AssCheckSpDetailOtherMapper;
import com.chd.hrp.ass.dao.check.special.AssCheckSpDetailSpecialMapper;
import com.chd.hrp.ass.entity.check.other.AssCheckSpDetailOther;
...
@Service("assCheckSpDetailOtherService")
public class AssCheckSpDetailOtherServiceImpl implements AssCheckSpDetailOtherService {

	private static Logger logger = Logger.getLogger(AssCheckSpDetailOtherServiceImpl.class);
	//引入DAO操作
	@Resource(name = "assCheckSpDetailOtherMapper")
	private final AssCheckSpDetailOtherMapper assCheckSpDetailOtherMapper = null;
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssCheckSpDetailOther assCheckSpDetailOther = queryByCode(entityMap);

		if (assCheckSpDetailOther != null) {
		...
		try {
			...
			int state = assCheckSpDetailOtherMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckSpDetailOtherMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assCheckSpDetailOtherMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assCheckSpDetailOtherMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assCheckSpDetailOtherMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckSpDetailOtherMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		try{	
			...
			assCheckSpDetailOtherMapper.deleteBatch(listVo);
			assCheckSpDetailOtherMapper.addBatch(listVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssCheckSpDetailOther> list = (List<AssCheckSpDetailOther>)assCheckSpDetailOtherMapper.query(entityMap);
			...
			List<AssCheckSpDetailOther> list = (List<AssCheckSpDetailOther>)assCheckSpDetailOtherMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSpDetailOtherMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssCheckSpDetailOther
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSpDetailOtherMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssCheckSpDetailOther>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSpDetailOtherMapper.queryExists(entityMap);
	}
	//新版打印  调用的方法
	@Override
	public Map<String, Object> queryAssInSpecialByPrintTemlatePrints(Map<String, Object> entityMap)throws DataAccessException {
		...
		try{
			...
			AssCheckSpDetailOtherMapper assCheckSpDetailOtherMapper = (AssCheckSpDetailOtherMapper)context.getBean("assCheckSpDetailOtherMapper");
		...
		/*	//主页面 批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				...
				//
				Map<String,Object> map= assCheckSpDetailOtherMapper.queryAssInSpecialPrintTemlateByMains(entityMap);
				//查询 专用设备  入库明细表
				List<Map<String,Object>> list= assCheckSpDetailOtherMapper.queryAssInSpecialPrintTemlateByDetails(entityMap);
