 ...
 * @Table: ASS_CHECK_D_Other
 * @Author: bell
 * @email: bell@e-tonggroup.com
 * @Version: 1.0
 */
 
@Service("assCheckDOtherService")
public class AssCheckDOtherServiceImpl implements AssCheckDOtherService {

	private static Logger logger = Logger.getLogger(AssCheckDOtherServiceImpl.class);
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		AssCheckDOther assCheckDOther = queryByCode(entityMap);

		if (assCheckDOther != null) {
		...
		try {
			entityMap.put("bill_table", "ASS_CHECK_D_OTHER");
			...
			entityMap.put("note", "");
			int state = assCheckDOtherMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assCheckDOtherMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assCheckDOtherMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assCheckDOtherMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			assCheckDdetailOtherMapper.delete(entityMap);

			int state = assCheckDOtherMapper.delete(entityMap);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssCheckDOther> list = (List<AssCheckDOther>) assCheckDOtherMapper.queryExists(mapVo);
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssCheckDOther> list = (List<AssCheckDOther>) assCheckDOtherMapper.query(entityMap);
			...
			List<AssCheckDOther> list = (List<AssCheckDOther>) assCheckDOtherMapper.query(entityMap, rowBounds);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckDOtherMapper.queryByCode(entityMap);
	}
	 ...
	 * <BR>
	 *            参数为要检索的字段
	 * @return AssCheckDOther
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckDOtherMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * <BR>
	 *            参数为要检索的字段
	 * @return List<AssCheckDOther>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckDOtherMapper.queryExists(entityMap);
	}
	...
	public String auditBatch(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		List<AssCheckDOther> list = (List<AssCheckDOther>) queryExists(mapVo);

		for (AssCheckDOther cs : list) {
	...
	@Override
	public AssCheckDOther queryState(Map<String, Object> mapVo)
			throws DataAccessException {
		// TODO Auto-generated method stub
		return assCheckDOtherMapper.queryState(mapVo);
	}
}
