 ...
 * @Table: ASS_CHECK_S_Other
 * @Author: bell
 * @email: bell@e-tonggroup.com
 * @Version: 1.0
 */
 
@Service("assCheckSOtherService")
public class AssCheckSOtherServiceImpl implements AssCheckSOtherService {

	private static Logger logger = Logger.getLogger(AssCheckSOtherServiceImpl.class);
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		AssCheckSOther assCheckSOther = queryByCode(entityMap);

		if (assCheckSOther != null) {
		...
		try {
			entityMap.put("bill_table", "ASS_CHECK_S_OTHER");
			// 添加仓库盘点单 主表
			...
			int state = assCheckSOtherMapper.add(entityMap);
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assCheckSOtherMapper.addBatch(entityList);
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assCheckSOtherMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assCheckSOtherMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			assCheckSdetailOtherMapper.delete(entityMap);
			int state = assCheckSOtherMapper.delete(entityMap);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssCheckSOther> list = (List<AssCheckSOther>) assCheckSOtherMapper.queryExists(mapVo);
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssCheckSOther> list = (List<AssCheckSOther>) assCheckSOtherMapper.query(entityMap);
			...
			List<AssCheckSOther> list = (List<AssCheckSOther>) assCheckSOtherMapper.query(entityMap, rowBounds);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckSOtherMapper.queryByCode(entityMap);
	}
	 ...
	 * <BR>
	 *            参数为要检索的字段
	 * @return AssCheckSOther
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckSOtherMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * <BR>
	 *            参数为要检索的字段
	 * @return List<AssCheckSOther>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckSOtherMapper.queryExists(entityMap);
	}
	/**
	 * @Description 审核
	 * @param mapVo
	...
	public String auditBatch(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		List<AssCheckSOther> list = (List<AssCheckSOther>) queryExists(mapVo);

		for (AssCheckSOther cs : list) {
	...
	@Override
	public AssCheckSOther queryState(Map<String, Object> mapVo)
			throws DataAccessException {
		// TODO Auto-generated method stub
		return assCheckSOtherMapper.queryState(mapVo);
	}
}
