...
import com.chd.hrp.ass.dao.check.other.AssChkAsourceOtherMapper;
import com.chd.hrp.ass.dao.check.other.AssChkAOtherMapper;
...
/**
 * 
 * @Description: 051001资产盘亏申报(一般设备)
 * @Table: ASS_CHK_A_Other
 * @Author: bell
 * @email: bell@e-tonggroup.com
 * @Version: 1.0
 */ 
@Service("assChkAOtherService")
public class AssChkAOtherServiceImpl implements AssChkAOtherService {

	private static Logger logger = Logger.getLogger(AssChkAOtherServiceImpl.class);
	// 引入DAO操作
	@Resource(name = "assChkAOtherMapper")
	private final AssChkAOtherMapper assChkAOtherMapper = null;
	
	@Resource(name = "assChkAdetailOtherMapper")
	private final AssChkAdetailOtherMapper assChkAdetailOtherMapper = null;
	
	@Resource(name = "assChkAsourceOtherMapper")
	private final AssChkAsourceOtherMapper assChkAsourceOtherMapper = null;
	...
	/**
	 * @Description 添加051001资产盘亏申报(一般设备)<BR>
	 * @param entityMap
	 * @return String JSON
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		// 获取对象051001资产盘亏申报(一般设备)
		AssChkAOther assDisposalAOther = queryByCode(entityMap);
		...
		try {
			...
			int state = assChkAOtherMapper.add(entityMap);
	...
	/**
	 * @Description 批量添加051001资产盘亏申报(一般设备)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assChkAOtherMapper.addBatch(entityList);
	...
	/**
	 * @Description 更新051001资产盘亏申报(一般设备)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assChkAOtherMapper.update(entityMap);
	...
	/**
	 * @Description 批量更新051001资产盘亏申报(一般设备)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assChkAOtherMapper.updateBatch(entityList);
	...
	/**
	 * @Description 删除051001资产盘亏申报(一般设备)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assChkAOtherMapper.delete(entityMap);
	...
	/**
	 * @Description 批量删除051001资产盘亏申报(一般设备)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			assChkAsourceOtherMapper.deleteBatch(entityList);
	    	assChkAdetailOtherMapper.deleteBatch(entityList);
			assChkAOtherMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssChkAOther> list = (List<AssChkAOther>) assChkAOtherMapper.queryExists(mapVo);
		try {
			boolean flag = true;
			boolean flag1 = true;
			boolean flag2 = true;
			if (list.size() > 0) {
				assChkAOtherMapper.update(entityMap);
			} else {
				entityMap.put("bill_table", "ASS_CHK_A_OTHER");
				String ass_chk_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("ass_chk_no", ass_chk_no);
				assChkAOtherMapper.add(entityMap);
			...
			for (Map<String, Object> detailVo : detail) {
				...
				String results = collectAssChkAOther(detailVo);
			...
			assChkAsourceOtherMapper.delete(entityMap);
			assChkAdetailOtherMapper.delete(entityMap);
			assChkAdetailOtherMapper.addBatch(listVo);
			if (listSourceVo.size() > 0) {
				assChkAsourceOtherMapper.addBatch(listSourceVo);
			}
	...
	public String collectAssChkAOther(Map<String, Object> entityMap) {
		WebApplicationContext ctx = ContextLoader.getCurrentWebApplicationContext();
		...
		assChkAOtherMapper.collectAssChkAOther(entityMap);
	...
	/**
	 * @Description 查询结果集051001资产盘亏申报(一般设备)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssChkAOther> list = (List<AssChkAOther>) assChkAOtherMapper
					.query(entityMap);
	...
	/**
	 * @Description 获取对象051001资产盘亏申报(一般设备)<BR>
	 * @param entityMap<BR>
	 *            参数为主键
	 * @return String JSON
	 * @throws DataAccessException
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assChkAOtherMapper.queryByCode(entityMap);
	}

	/**
	 * @Description 获取051001资产盘亏申报(一般设备)<BR>
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return AssChkAOther
	 * @throws DataAccessException
	...
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assChkAOtherMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param entityMap<BR>
	 *            参数为要检索的字段
	 * @return List<AssChkAOther>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assChkAOtherMapper.queryExists(entityMap);
	}

	@Override
	public String updateConfirmChkAOther(List<Map<String, Object>> listVo,
			List<Map<String, Object>> listCardVo) throws DataAccessException {
		try {
			assChkAOtherMapper.updateBatchConfirm(listVo);
			assCardOtherMapper.updateChkApplyConfirm(listCardVo);
	...
	public String queryAssApplyDeptByPlanDept(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssApplyDept> list = assChkAOtherMapper.queryAssApplyDeptByPlanDept(entityMap);
			...
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<AssApplyDept> list = assChkAOtherMapper.queryAssApplyDeptByPlanDept(entityMap, rowBounds);
