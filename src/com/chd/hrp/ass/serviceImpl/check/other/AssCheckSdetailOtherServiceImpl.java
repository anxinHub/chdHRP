...
import com.chd.hrp.ass.entity.check.other.AssCheckSdetailOther;
...
@Service("assCheckSdetailOtherService")
public class AssCheckSdetailOtherServiceImpl implements AssCheckSdetailOtherService {

	private static Logger logger = Logger.getLogger(AssCheckSdetailOtherServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssCheckSdetailOther assCheckSdetailOther = queryByCode(entityMap);

		if (assCheckSdetailOther != null) {
		...
		try {
			...
			int state = assCheckSdetailOtherMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckSdetailOtherMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assCheckSdetailOtherMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assCheckSdetailOtherMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assCheckSdetailOtherMapper.delete(entityMap);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssCheckSdetailOther> list = (List<AssCheckSdetailOther>)assCheckSdetailOtherMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssCheckSdetailOther> list = (List<AssCheckSdetailOther>)assCheckSdetailOtherMapper.query(entityMap);
			...
			List<AssCheckSdetailOther> list = (List<AssCheckSdetailOther>)assCheckSdetailOtherMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSdetailOtherMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssCheckSdetailOther
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSdetailOtherMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssCheckSdetailOther>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSdetailOtherMapper.queryExists(entityMap);
	}
	/**
	 * @Description 复制账面数量
	 * @param mapVo
	...
	public String copyAmount(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		String vr = vo_split(mapVo.get("ass_card_no_all_o").toString());
		mapVo.put("ass_card_no_all_o", vr);
		//根据勾选的卡片复制账面数量
		assCheckSdetailOtherMapper.copyAmount(mapVo);
	...
	public String delCard(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		//根据勾选的卡片复制账面数量
		assCheckSdetailOtherMapper.delete(mapVo);
	...
	//新版打印  调用的方法
			...
			public Map<String, Object> queryAssInSpecialByPrintTemlatePrint(Map<String, Object> entityMap)throws DataAccessException {
				...
				try{
					...
					AssCheckSdetailOtherMapper assCheckSdetailOtherMapper = (AssCheckSdetailOtherMapper)context.getBean("assCheckSdetailOtherMapper");
				...
				/*	//主页面 批量打印查询
					if("1".equals(String.valueOf(entityMap.get("p_num")))){
						...
						//
						Map<String,Object> map= assCheckSdetailOtherMapper.queryAssInSpecialPrintTemlateByMain(entityMap);
						//查询 专用设备  入库明细表
						List<Map<String,Object>> list= assCheckSdetailOtherMapper.queryAssInSpecialPrintTemlateByDetail(entityMap);
			...
			public List<String> queryAssInSpecialState(Map<String, Object> mapVo) throws DataAccessException {
				...
				return assCheckSdetailOtherMapper.queryAssInSpecialState(mapVo);
			}
			@Override
			public String saveAssCheckSDetailOther(Map<String, Object> entityMap)
					throws DataAccessException {
				...
				try{	
					...
					assCheckSdetailOtherMapper.deleteBatch(listVo);
					assCheckSdetailOtherMapper.addBatch(listVo);
