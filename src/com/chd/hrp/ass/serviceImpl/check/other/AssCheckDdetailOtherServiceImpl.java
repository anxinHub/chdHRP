...
import com.chd.hrp.ass.entity.check.other.AssCheckDdetailOther;
...
@Service("assCheckDdetailOtherService")
public class AssCheckDdetailOtherServiceImpl implements AssCheckDdetailOtherService {

	private static Logger logger = Logger.getLogger(AssCheckDdetailOtherServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssCheckDdetailOther assCheckDdetailOther = queryByCode(entityMap);

		if (assCheckDdetailOther != null) {
		...
		try {
			...
			int state = assCheckDdetailOtherMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckDdetailOtherMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assCheckDdetailOtherMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assCheckDdetailOtherMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assCheckDdetailOtherMapper.delete(entityMap);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssCheckDdetailOther> list = (List<AssCheckDdetailOther>)assCheckDdetailOtherMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssCheckDdetailOther> list = (List<AssCheckDdetailOther>)assCheckDdetailOtherMapper.query(entityMap);
			...
			List<AssCheckDdetailOther> list = (List<AssCheckDdetailOther>)assCheckDdetailOtherMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckDdetailOtherMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssCheckDdetailOther
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckDdetailOtherMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssCheckDdetailOther>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckDdetailOtherMapper.queryExists(entityMap);
	}
	/**
	 * @Description 复制账面数量
	 * @param mapVo
	...
	public String copyAmount(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		//根据勾选的卡片复制账面数量
		assCheckDdetailOtherMapper.copyAmount(mapVo);
	...
	public String delCard(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		mapVo.put("ass_card_no_all", vr);
		//根据勾选的卡片复制账面数量
		assCheckDdetailOtherMapper.delete(mapVo);
	...
	public Map<String, Object> queryAssInSpecialByPrintTemlatePrints(Map<String, Object> entityMap)throws DataAccessException {
		...
		try{
			...
			AssCheckDdetailOtherMapper assCheckDdetailOtherMapper = (AssCheckDdetailOtherMapper)context.getBean("assCheckDdetailOtherMapper");
		...
		/*	//主页面 批量打印查询
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				...
				//
				Map<String,Object> map= assCheckDdetailOtherMapper.queryAssInSpecialPrintTemlateByMains(entityMap);
				//查询 专用设备  入库明细表
				List<Map<String,Object>> list= assCheckDdetailOtherMapper.queryAssInSpecialPrintTemlateByDetails(entityMap);
	...
	public List<String> queryAssInSpecialStates(Map<String, Object> mapVo) throws DataAccessException {
		...
		return assCheckDdetailOtherMapper.queryAssInSpecialStates(mapVo);
	}
	@Override
	public String saveAssCheckDDetailOther(Map<String, Object> entityMap)
			throws DataAccessException {
		...
		try{	
			...
			assCheckDdetailOtherMapper.deleteBatch(listVo);
			assCheckDdetailOtherMapper.addBatch(listVo);
