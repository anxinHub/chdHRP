...
import com.chd.hrp.ass.dao.check.land.AssCheckPlanLandMapper;
...
@Service("assCheckPlanLandService")
public class AssCheckPlanLandServiceImpl implements AssCheckPlanLandService {

	private static Logger logger = Logger.getLogger(AssCheckPlanLandServiceImpl.class);

	// 引入DAO操作
	@Resource(name = "assCheckPlanLandMapper")
	private final AssCheckPlanLandMapper assCheckPlanLandMapper = null;
	...
	/**
	 * @Description 添加051101 盘点任务单(土地)<BR>
	 * @param entityMap
	 * @return String JSON
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		// 获取对象051101 盘点任务单(土地)
		AssCheckPlanLand assCheckPlanLand = queryByCode(entityMap);
	...
	/**
	 * @Description 批量添加051101 盘点任务单(土地)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assCheckPlanLandMapper.addBatch(entityList);
	...
	/**
	 * @Description 更新051101 盘点任务单(土地)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = assCheckPlanLandMapper.update(entityMap);
	...
	/**
	 * @Description 批量更新051101 盘点任务单(土地)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			assCheckPlanLandMapper.updateBatch(entityList);
	...
	/**
	 * @Description 删除051101 盘点任务单(土地)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String delete(Map<String, Object> mapVo) throws DataAccessException {
		...
		List<AssCheckPlanLand> list = (List<AssCheckPlanLand>) queryExists(mapVo);

		for (AssCheckPlanLand cs : list) {
		...
		for (Map<String, Object> m : listVo) {
			assCheckPlanLandMapper.delete(m);
		}
	...
	/**
	 * @Description 批量删除051101 盘点任务单(土地)<BR>
	 * @param entityList
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		//删除科室盘点单
			...
			/*	//删除仓库盘点单
			assCheckSLandMapper.deleteBatch(entityList);*/
			//删除盘点计划
			assCheckPlanLandMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<AssCheckPlanLand> list = (List<AssCheckPlanLand>) assCheckPlanLandMapper.queryExists(mapVo);
	...
	/**
	 * @Description 查询结果集051101 盘点任务单(土地)<BR>
	 * @param entityMap
	 * @return String JSON
	 * @throws DataAccessException
	 */
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<AssCheckPlanLand> list = (List<AssCheckPlanLand>) assCheckPlanLandMapper.query(entityMap);
			...
			List<AssCheckPlanLand> list = (List<AssCheckPlanLand>) assCheckPlanLandMapper.query(entityMap, rowBounds);
	...
	/**
	 * @Description 获取对象051101 盘点任务单(土地)<BR>
	 * @param entityMap
	 * <BR>
	 *            参数为主键
	 * @return String JSON
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckPlanLandMapper.queryByCode(entityMap);
	}

	/**
	 * @Description 获取051101 盘点任务单(土地)<BR>
	 * @param entityMap
	 * <BR>
	 *            参数为要检索的字段
	 * @return AssCheckPlanLand
	 * @throws DataAccessException
	 */
	@Override
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckPlanLandMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * <BR>
	 *            参数为要检索的字段
	 * @return List<AssCheckPlanLand>
	 * @throws DataAccessException
	 */
	@Override
	public List<?> queryExists(Map<String, Object> entityMap) throws DataAccessException {
		return assCheckPlanLandMapper.queryExists(entityMap);
	}
	...
	public String generate(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			// 添加盘点单 主表
			entityMap.put("bill_table", "ASS_CHECK_LAND");
			...
			assCheckPlanLandMapper.addGenerate(entityMap);
			// 更新最大单号
			assBaseService.updateAssBillNoMaxNo(entityMap);
		// 添加盘点单 主从表
	...
	public String generateDetail(Map<String, Object> entityMap) throws DataAccessException {
		try {
			...
			if(entityMap.get("check_no") == null || "".equals(entityMap.get("check_no"))){
				...
				assCheckPlanLandMapper.addAssCheckLand(entityMap);
				
				assBaseService.updateAssBillNoMaxNo(entityMap);
			}else{
				check_no = entityMap.get("check_no").toString();
			}
			assCheckPlanLandMapper.addGenerateDetail(entityMap);
			// 添加科室盘点单 主从表
	...
	public List<?> queryByTree(Map<String, Object> entityMap) throws DataAccessException {
		...
		return assCheckPlanLandMapper.queryByTree(entityMap);
	...
	public String auditCheckLand(Map<String, Object> entityMap) throws DataAccessException {
		try {
			AssCheckLand s=	assCheckLandMapper.queryByCode(entityMap);
			if(s==null || s.getState()!=0){
				return "{\"msg\":\"不是新建状态不能提交.\",\"state\":\"true\"}";
			}else{
				assCheckLandMapper.update(entityMap);
			}
