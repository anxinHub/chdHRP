...
import com.chd.hrp.ass.dao.check.special.AssCheckSpDetailSpecialMapper;
...
@Service("assCheckSpDetailSpecialService")
public class AssCheckSpDetailSpecialServiceImpl implements AssCheckSpDetailSpecialService {

	private static Logger logger = Logger.getLogger(AssCheckSpDetailSpecialServiceImpl.class);
	//引入DAO操作
	@Resource(name = "assCheckSpDetailSpecialMapper")
	private final AssCheckSpDetailSpecialMapper assCheckSpDetailSpecialMapper = null;
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssCheckSpDetailSpecial assCheckSpDetailSpecial = queryByCode(entityMap);

		if (assCheckSpDetailSpecial != null) {
		...
		try {
			...
			int state = assCheckSpDetailSpecialMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckSpDetailSpecialMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assCheckSpDetailSpecialMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assCheckSpDetailSpecialMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assCheckSpDetailSpecialMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckSpDetailSpecialMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		try{	
			...
			assCheckSpDetailSpecialMapper.deleteBatch(listVo);
			assCheckSpDetailSpecialMapper.addBatch(listVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssCheckSpDetailSpecial> list = (List<AssCheckSpDetailSpecial>)assCheckSpDetailSpecialMapper.query(entityMap);
			...
			List<AssCheckSpDetailSpecial> list = (List<AssCheckSpDetailSpecial>)assCheckSpDetailSpecialMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSpDetailSpecialMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssCheckSpDetailSpecial
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSpDetailSpecialMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssCheckSpDetailSpecial>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSpDetailSpecialMapper.queryExists(entityMap);
	}
	//新版打印  调用的方法
			@Override
			public Map<String, Object> queryAssInSpecialByPrintTemlatePrints(Map<String, Object> entityMap)throws DataAccessException {
				...
				try{
					...
					AssCheckSpDetailSpecialMapper assCheckSpDetailSpecialMapper = (AssCheckSpDetailSpecialMapper)context.getBean("assCheckSpDetailSpecialMapper");
				...
				/*	//主页面 批量打印查询
					if("1".equals(String.valueOf(entityMap.get("p_num")))){
						...
						//
						Map<String,Object> map= assCheckSpDetailSpecialMapper.queryAssInSpecialPrintTemlateByMains(entityMap);
						//查询 专用设备  入库明细表
						List<Map<String,Object>> list= assCheckSpDetailSpecialMapper.queryAssInSpecialPrintTemlateByDetails(entityMap);
			...
			public String queryAll(Map<String, Object> entityMap) throws DataAccessException {
				...
				if (sysPage.getTotal()==-1){
					...
					List<AssCheckSpDetailSpecial> list = (List<AssCheckSpDetailSpecial>)assCheckSpDetailSpecialMapper.queryAll(entityMap);
					...
					List<AssCheckSpDetailSpecial> list = (List<AssCheckSpDetailSpecial>)assCheckSpDetailSpecialMapper.queryAll(entityMap, rowBounds);
