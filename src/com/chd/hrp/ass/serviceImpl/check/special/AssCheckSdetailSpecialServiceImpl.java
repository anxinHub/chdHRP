...
@Service("assCheckSdetailSpecialService")
public class AssCheckSdetailSpecialServiceImpl implements AssCheckSdetailSpecialService {

	private static Logger logger = Logger.getLogger(AssCheckSdetailSpecialServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssCheckSdetailSpecial assCheckSdetailSpecial = queryByCode(entityMap);

		if (assCheckSdetailSpecial != null) {
		...
		try {
			...
			int state = assCheckSdetailSpecialMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assCheckSdetailSpecialMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assCheckSdetailSpecialMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assCheckSdetailSpecialMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assCheckSdetailSpecialMapper.delete(entityMap);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssCheckSdetailSpecial> list = (List<AssCheckSdetailSpecial>)assCheckSdetailSpecialMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssCheckSdetailSpecial> list = (List<AssCheckSdetailSpecial>)assCheckSdetailSpecialMapper.query(entityMap);
			...
			List<AssCheckSdetailSpecial> list = (List<AssCheckSdetailSpecial>)assCheckSdetailSpecialMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSdetailSpecialMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssCheckSdetailSpecial
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSdetailSpecialMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssCheckSdetailSpecial>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assCheckSdetailSpecialMapper.queryExists(entityMap);
	}
	/**
	 * @Description 复制账面数量
	 * @param mapVo
	...
	public String copyAmount(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		//根据勾选的卡片复制账面数量
		assCheckSdetailSpecialMapper.copyAmount(mapVo);
	...
	public String delCard(@RequestParam Map<String, Object> mapVo) throws DataAccessException {
		...
		mapVo.put("ass_card_no_all", vr);
		//根据勾选的卡片复制账面数量
		assCheckSdetailSpecialMapper.delete(mapVo);
	...
	//新版打印  调用的方法
		...
		public Map<String, Object> queryAssInSpecialByPrintTemlatePrint(Map<String, Object> entityMap)throws DataAccessException {
			...
			try{
				...
				AssCheckSdetailSpecialMapper assCheckSdetailSpecialMapper = (AssCheckSdetailSpecialMapper)context.getBean("assCheckSdetailSpecialMapper");
			...
			/*	//主页面 批量打印查询
				if("1".equals(String.valueOf(entityMap.get("p_num")))){
					...
					//
					Map<String,Object> map= assCheckSdetailSpecialMapper.queryAssInSpecialPrintTemlateByMain(entityMap);
					//查询 专用设备  入库明细表
					List<Map<String,Object>> list= assCheckSdetailSpecialMapper.queryAssInSpecialPrintTemlateByDetail(entityMap);
		...
		public List<String> queryAssInSpecialState(Map<String, Object> mapVo) throws DataAccessException {
			...
			return assCheckSdetailSpecialMapper.queryAssInSpecialState(mapVo);
		}
		@Override
		public String saveAssCheckSDetailSpecial(Map<String, Object> entityMap)
				throws DataAccessException {
			...
			try{	
				...
				assCheckSdetailSpecialMapper.deleteBatch(listVo);
				assCheckSdetailSpecialMapper.addBatch(listVo);
