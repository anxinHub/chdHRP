...
import com.chd.hrp.ass.dao.check.special.AssChkInDetailSpecialMapper;
...
@Service("assChkInDetailSpecialService")
public class AssChkInDetailSpecialServiceImpl implements AssChkInDetailSpecialService { 

	private static Logger logger = Logger.getLogger(AssChkInDetailSpecialServiceImpl.class);
	//引入DAO操作
	@Resource(name = "assChkInDetailSpecialMapper")
	private final AssChkInDetailSpecialMapper assChkInDetailSpecialMapper = null;
	
	@Resource(name = "assChkInMainSpecialService")
	private final AssChkInMainSpecialService assChkInMainSpecialService = null;
	
	@Resource(name = "assChkInMainSpecialMapper")
	private final AssChkInMainSpecialMapper assChkInMainSpecialMapper = null;
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象050701 资产盘盈入库明细(专用设备)
		AssChkInDetailSpecial assChkInDetailSpecial = queryByCode(entityMap);

		if (assChkInDetailSpecial != null) {
		...
		try {
			...
			int state = assChkInDetailSpecialMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assChkInDetailSpecialMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assChkInDetailSpecialMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assChkInDetailSpecialMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assChkInDetailSpecialMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assChkInDetailSpecialMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<AssChkInDetailSpecial> list = (List<AssChkInDetailSpecial>)assChkInDetailSpecialMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssChkInDetailSpecial> list = (List<AssChkInDetailSpecial>)assChkInDetailSpecialMapper.query(entityMap);
			...
			List<AssChkInDetailSpecial> list = (List<AssChkInDetailSpecial>)assChkInDetailSpecialMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInDetailSpecialMapper.queryByCode(entityMap);
	}
	
	/**
	 * @Description 
	 * 获取050701 资产盘盈入库明细(专用设备)<BR> 
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssChkInDetailSpecial
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInDetailSpecialMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssChkInDetailSpecial>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInDetailSpecialMapper.queryExists(entityMap);
	}
	@Override
	public List<Map<String, Object>> queryByInit(Map<String, Object> mapVo) throws DataAccessException {
		return assChkInDetailSpecialMapper.queryByInit(mapVo);
	}
	
	
	//仓库盘点
	@Override
	public String saveInventory(List<Map<String, Object>> listVo)
			throws DataAccessException {
		...
		try {
			...
			for( Map<String, Object> listV : listVo){
				...
				List<AssChkDsInMap> list = (List<AssChkDsInMap>) assChkDsInMapMapper.queryy(mapVo4);
				for( AssChkDsInMap ids: list){
					String ass_in_nos = ids.getAss_in_no();
					mapVo4.put("ass_in_no", ass_in_nos);
					 List<AssChkInMainSpecial>  lists = (List<AssChkInMainSpecial>) assChkInMainSpecialMapper.queryExists(mapVo4);
					 if(lists.size() != 0){
						 return "{\"msg\":\"盘点单"+check_no+"已经生成过盈亏单,不能重复生成\",\"state\":\"true\"}";
					 }
				}
				mapVo4.put("ass_card_no", listV.get("ass_card_no"));
				List<AssChkRdetailSpecial> lists = (List<AssChkRdetailSpecial>) assChkRdetailSpecialMapper.queryExists(mapVo4);
				if(lists.size() != 0){
					 return "{\"msg\":\"盘点单"+check_no+"已经生成过盈亏单,不能重复生成\",\"state\":\"true\"}";
				}
				...
				List<Map<String,Object>> cardMap1 = assChkInDetailSpecialMapper.queryStore(listVo);//盘盈
				for(  Map<String,Object> card : cardMap1){
					...
					//从表数据
						...
						card.put("bill_table", "ASS_CHK_IN_MAIN_SPECIAL");
				...
				if(cardMap1.size() != 0){
					//增加关系表 判断时用
					assChkDsInMapMapper.addBatch(listVo2);
					
					assChkInDetailSpecialMapper.addBatch(listVo2);
					
					
					assChkInMainSpecialMapper.addBatch(listVo1);	
					...
					for(  Map<String,Object> card : cardMap1){
						...
						assChkInMainSpecialService.initAssChkInBatchCardSpecial(mapVo3);
					}
				}
				...
				List<Map<String,Object>> cardMap2 = assChkRdetailSpecialMapper.queryStoreStore(listVo);//盘亏
				...
				for(  Map<String,Object> card1 : cardMap2){
					...
					mapVo.put("copy_code", card1.get("copy_code"));	
					card1.put("bill_table", "ASS_CHK_R_SPECIAL");
				...
				if(cardMap2.size() != 0){
					assChkRdetailSpecialMapper.addBatch(listVo3);
					assChkRspecialMapper.addBatch(listVo4);
				}
	...
	//按科室盘点
	@Override
	public String saveDeptInventory(List<Map<String, Object>> listVo)
			throws DataAccessException {
		List<Map<String, Object>> listVo1 = new ArrayList<Map<String, Object>>();
		List<Map<String, Object>> listVo2 = new ArrayList<Map<String, Object>>();
		List<Map<String, Object>> listVo3 = new ArrayList<Map<String, Object>>();
		...
		try {
			...
			for( Map<String, Object> listV : listVo){
				...
				for( AssChkDsInMap ids: list){
					String ass_in_nos = ids.getAss_in_no();
					mapVo4.put("ass_in_no", ass_in_nos);
					 List<AssChkDsInMap>  lists = (List<AssChkDsInMap>) assChkInMainSpecialMapper.queryExists(mapVo4);
					 if(lists.size() != 0){
						 return "{\"msg\":\"盘点单"+check_no+"已经生成过盈亏单,不能重复生成\",\"state\":\"true\"}";
					 }
				}
				...
				List<Map<String,Object>> cardMap1 = assChkInDetailSpecialMapper.queryDept(listVo);//盘盈
				for(  Map<String,Object> card : cardMap1){
					i++;
					Map<String, Object> mapVo1 = new HashMap<String, Object>();
					Map<String, Object> mapVo2 = new HashMap<String, Object>();
				...
				List<Map<String,Object>> cardMap2 = assChkRdetailSpecialMapper.queryDeptDept(listVo);//盘亏
				...
				if(cardMap2.size() != 0){
					//增加关系表 判断时用
					//assChkDsInMapMapper.addBatch(listVo3);
					assChkRdetailSpecialMapper.addBatch(listVo3);
					assChkRspecialMapper.addBatch(listVo4);
				}
