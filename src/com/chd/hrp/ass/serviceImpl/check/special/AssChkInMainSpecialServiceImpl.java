...
@Service("assChkInMainSpecialService")
public class AssChkInMainSpecialServiceImpl implements AssChkInMainSpecialService {    

	private static Logger logger = Logger.getLogger(AssChkInMainSpecialServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象050701 资产盘盈入库主表(专用设备)
		AssChkInMainSpecial assChkInMainSpecial = queryByCode(entityMap);

		if (assChkInMainSpecial != null) {
		...
		try {
			...
			int state = assChkInMainSpecialMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assChkInMainSpecialMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assChkInMainSpecialMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assChkInMainSpecialMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assChkInMainSpecialMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assChkInMainSpecialMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		List<AssChkInMainSpecial> list = (List<AssChkInMainSpecial>)assChkInMainSpecialMapper.queryExists(mapVo);
		try {
			entityMap.put("state", "0");
			if (list.size()>0) {
				assChkInMainSpecialMapper.update(entityMap);
			}else{
				entityMap.put("bill_table", "ASS_CHK_IN_MAIN_SPECIAL");
				String ass_in_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("ass_in_no", ass_in_no);
				assChkInMainSpecialMapper.add(entityMap);
			...
			assChkInDetailSpecialMapper.delete(entityMap);
			assChkInDetailSpecialMapper.addBatch(listVo);
			entityMap.put("in_money", in_money);
			assChkInMainSpecialMapper.updateInMoney(entityMap);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssChkInMainSpecial> list = (List<AssChkInMainSpecial>)assChkInMainSpecialMapper.query(entityMap);
			...
			List<AssChkInMainSpecial> list = (List<AssChkInMainSpecial>)assChkInMainSpecialMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInMainSpecialMapper.queryByCode(entityMap);
	}
	
	/**
	 * @Description 
	 * 获取050701 资产盘盈入库主表(专用设备)<BR> 
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssChkInMainSpecial
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInMainSpecialMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssChkInMainSpecial>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assChkInMainSpecialMapper.queryExists(entityMap);
	}
	...
	@Override
	public String initAssChkInCardSpecial(Map<String, Object> map) throws DataAccessException {
		List<Map<String, Object>> listVo = new ArrayList<Map<String, Object>>();
		...
		try {
			...
			List<Map<String, Object>> list = assChkInDetailSpecialMapper.queryByInit(map);
	...
	public String updateConfirmChkInSpecial(List<Map<String, Object>> listVo) throws DataAccessException {
		try {
			...
			assCardSpecialMapper.updateConfirm(listVo);
			assChkInMainSpecialMapper.updateConfirmChkInSpecial(listVo);
	...
	public List<String> queryState(Map<String, Object> entityMap) throws DataAccessException {
		 return assChkInMainSpecialMapper.queryState(entityMap);
	...
	@Override
	public Map<String,Object> assChkInMainSpecialByPrintTemlate(Map<String, Object> entityMap)
			throws DataAccessException {
		// TODO Auto-generated method stub
		
		Map<String,Object> reMap=new HashMap<String,Object>();
		WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
		AssChkInMainSpecialMapper assChkInMainSpecialMapper = (AssChkInMainSpecialMapper)context.getBean("assChkInMainSpecialMapper");
		
		
		if("1".equals(String.valueOf(entityMap.get("p_num")))){
			//查询移库主表批量
			List<Map<String,Object>> map = assChkInMainSpecialMapper.queryAssChkInMainSpecialPrintTemlateByMainBatch(entityMap);
			//查询移库明细表
			List<Map<String,Object>> list = assChkInMainSpecialMapper.queryAssChkInMainSpecialPrintTemlateByDetail(entityMap);
			...
			//查询移库主表
			Map<String,Object> map = assChkInMainSpecialMapper.queryAssChkInMainSpecialPrintTemlateByMain(entityMap);
			//查询移库明细表
			List<Map<String,Object>> list = assChkInMainSpecialMapper.queryAssChkInMainSpecialPrintTemlateByDetail(entityMap);
	...
	@Override
	public String initAssChkInBatchCardSpecial(Map<String, Object> map) throws DataAccessException {
		List<Map<String, Object>> listVo = new ArrayList<Map<String, Object>>();
		List<Map<String, Object>> reSourceListVo = new ArrayList<Map<String, Object>>();
		try {
			String basePath = "ass";
