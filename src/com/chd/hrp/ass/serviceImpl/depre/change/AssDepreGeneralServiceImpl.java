...
import com.chd.hrp.ass.dao.depre.change.AssDepreDetailGeneralMapper;
import com.chd.hrp.ass.dao.depre.change.AssDepreGeneralMapper;
import com.chd.hrp.ass.dao.depre.change.AssDepreGeneralMapper;
import com.chd.hrp.ass.dao.depre.change.source.AssDepreSourceGeneralMapper;
import com.chd.hrp.ass.dao.resource.AssResourceGeneralMapper;
import com.chd.hrp.ass.entity.depre.change.AssDepreGeneral;
import com.chd.hrp.ass.entity.depre.change.AssDepreGeneral;
import com.chd.hrp.ass.entity.depre.change.source.AssDepreSourceGeneral;
...
@Service("assDepreGeneralService")
public class AssDepreGeneralServiceImpl implements AssDepreGeneralService {

	private static Logger logger = Logger.getLogger(AssDepreGeneralServiceImpl.class);
	//引入DAO操作
	@Resource(name = "assDepreGeneralMapper")
	private final AssDepreGeneralMapper assDepreGeneralMapper = null;
	
	@Resource(name = "assDepreDetailGeneralMapper")
	private final AssDepreDetailGeneralMapper assDepreDetailGeneralMapper = null;
	
	@Resource(name = "assDepreSourceGeneralMapper")
	private final AssDepreSourceGeneralMapper assDepreSourceGeneralMapper = null;
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象050806 资产累计折旧变动(一般设备)
		AssDepreGeneral assDepreGeneral = queryByCode(entityMap);
		...
		try {
			...
			int state = assDepreGeneralMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assDepreGeneralMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assDepreGeneralMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assDepreGeneralMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assDepreGeneralMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			assDepreSourceGeneralMapper.deleteBatch(entityList);
			assDepreDetailGeneralMapper.deleteBatch(entityList);
			assDepreGeneralMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		List<AssDepreGeneral> list = (List<AssDepreGeneral>)assDepreGeneralMapper.queryExists(mapVo);
		boolean flag = true;
		try {
			if (list.size()>0) {
				assDepreGeneralMapper.update(entityMap);
			}else{
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_DEPRE_GENERAL");
				String change_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("change_no", change_no);
				assDepreGeneralMapper.add(entityMap);
				assBaseService.updateAssBillNoMaxNo(entityMap);
			}
			
			List<Map> detail = ChdJson.fromJsonAsList(Map.class, entityMap.get("ParamVo").toString());
			
			List<Map<String, Object>> detailList = assDepreDetailGeneralMapper.queryByChangeNoMap(mapVo);
			...
			if(detSourceList.size() > 0){
				assDepreSourceGeneralMapper.deleteBatch(detSourceList);
			}
			...
			for (Map<String, Object> detailVo : detail) {
				...
				List<Map<String, Object>> existsSource = assDepreSourceGeneralMapper.queryDepreSourceByAssCardNo(detailVo);
			...
			assDepreDetailGeneralMapper.delete(entityMap);
			assDepreDetailGeneralMapper.addBatch(listVo);
			
			if(sourceList.size() > 0 ){
				assDepreSourceGeneralMapper.deleteBatch(sourceList);
				assDepreSourceGeneralMapper.addBatch(sourceList);
			}
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssDepreGeneral> list = (List<AssDepreGeneral>)assDepreGeneralMapper.query(entityMap);
			...
			List<AssDepreGeneral> list = (List<AssDepreGeneral>)assDepreGeneralMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assDepreGeneralMapper.queryByCode(entityMap);
	}
	
	/**
	 * @Description 
	 * 获取050806 资产累计折旧变动(一般设备)<BR> 
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssDepreGeneral
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assDepreGeneralMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssDepreGeneral>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assDepreGeneralMapper.queryExists(entityMap);
	}
	@Override
	public String deleteAssDepreSourceGeneral(List<Map<String, Object>> entityMap) throws DataAccessException {
		try {
			assDepreSourceGeneralMapper.deleteBatch(entityMap);
	    	...
	    	Double change_depre = 0.0;
			Double new_depre = 0.0;
			List<Map<String, Object>> listMap = assDepreSourceGeneralMapper.queryDepreSourceByAssCardNo(mapVo);
			...
			assDepreDetailGeneralMapper.updateDepreBySource(mapVo);
	...
	@Override
	public String queryAssDepreSourceGeneral(Map<String, Object> entityMap) throws DataAccessException {
		SysPage sysPage = new SysPage();
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssDepreSourceGeneral> list = (List<AssDepreSourceGeneral>)assDepreSourceGeneralMapper.query(entityMap);
			...
			List<AssDepreSourceGeneral> list = (List<AssDepreSourceGeneral>)assDepreSourceGeneralMapper.query(entityMap, rowBounds);
	...
	@Override
	public String saveAssDepreSourceGeneral(Map<String, Object> entityMap) throws DataAccessException {
		List<Map<String, Object>> listVo = new ArrayList<Map<String, Object>>();
		List<Map> detail = ChdJson.fromJsonAsList(Map.class, entityMap.get("ParamVo").toString());
		Double change_depre = 0.0;
		Double new_depre = 0.0;
		try {
			...
			assDepreSourceGeneralMapper.delete(entityMap);
			assDepreSourceGeneralMapper.addBatch(listVo);
			
			entityMap.put("change_depre", change_depre + "");
			entityMap.put("new_depre", new_depre + "");
			
			assDepreDetailGeneralMapper.updateDepreBySource(entityMap);
	...
	public String updateConfirm(List<Map<String, Object>> entityMap) throws DataAccessException {
		...
		try {
			for(Map<String, Object> map : entityMap){
				List<Map<String,Object>> detailMap = assDepreDetailGeneralMapper.queryByChangeNoMap(map);
				if(detailMap == null ||detailMap.size() == 0){
					TransactionAspectSupport.currentTransactionStatus().setRollbackOnly();
					return "{\"warn\":\"存在没有明细数据的单据,不能确认.\"}";
				}
				for(Map<String,Object> detail : detailMap){
					List<Map<String,Object>> sourceMap = assDepreSourceGeneralMapper.queryDepreSourceByAssCardNo(detail);
			...
			assDepreGeneralMapper.updateConfirm(entityMap);//更新主表状态
			assCardGeneralMapper.updateDepreMoneyConfirm(cardList);//更新卡片原值
			if(reSourceUpdateList.size() > 0){
				assResourceGeneralMapper.updateBatchByDepre(reSourceUpdateList);
			}
