...
import com.chd.hrp.ass.dao.depre.change.AssDepreDetailSpecialMapper;
import com.chd.hrp.ass.dao.depre.change.AssDepreSpecialMapper;
import com.chd.hrp.ass.dao.depre.change.source.AssDepreSourceSpecialMapper;
import com.chd.hrp.ass.dao.resource.AssResourceSpecialMapper;
import com.chd.hrp.ass.entity.depre.change.AssDepreSpecial;
import com.chd.hrp.ass.entity.depre.change.source.AssDepreSourceSpecial;
...
@Service("assDepreSpecialService")
public class AssDepreSpecialServiceImpl implements AssDepreSpecialService {

	private static Logger logger = Logger.getLogger(AssDepreSpecialServiceImpl.class);
	//引入DAO操作
	@Resource(name = "assDepreSpecialMapper")
	private final AssDepreSpecialMapper assDepreSpecialMapper = null;
	
	@Resource(name = "assDepreDetailSpecialMapper")
	private final AssDepreDetailSpecialMapper assDepreDetailSpecialMapper = null;
	
	@Resource(name = "assDepreSourceSpecialMapper")
	private final AssDepreSourceSpecialMapper assDepreSourceSpecialMapper = null;
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		AssDepreSpecial assDepreSpecial = queryByCode(entityMap);
		...
		try {
			...
			int state = assDepreSpecialMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			assDepreSpecialMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = assDepreSpecialMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  assDepreSpecialMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = assDepreSpecialMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			assDepreSourceSpecialMapper.deleteBatch(entityList);
			assDepreDetailSpecialMapper.deleteBatch(entityList);
			assDepreSpecialMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		List<AssDepreSpecial> list = (List<AssDepreSpecial>)assDepreSpecialMapper.queryExists(mapVo);
		boolean flag = true;
		try {
			if (list.size()>0) {
				assDepreSpecialMapper.update(entityMap);
			}else{
				if(entityMap.get("create_date") != null && !"".equals(entityMap.get("create_date"))){
					entityMap.put("year", entityMap.get("create_date").toString().substring(0,4));
					entityMap.put("month", entityMap.get("create_date").toString().substring(5,7));
				}
				entityMap.put("bill_table", "ASS_DEPRE_SPECIAL");
				String change_no = assBaseService.getBillNOSeqNo(entityMap);
				entityMap.put("change_no", change_no);
				assDepreSpecialMapper.add(entityMap);
				assBaseService.updateAssBillNoMaxNo(entityMap);
			}
			
			List<Map> detail = ChdJson.fromJsonAsList(Map.class, entityMap.get("ParamVo").toString());
			
			List<Map<String, Object>> detailList = assDepreDetailSpecialMapper.queryByChangeNoMap(mapVo);
			...
			if(detSourceList.size() > 0){
				assDepreSourceSpecialMapper.deleteBatch(detSourceList);
			}
			...
			for (Map<String, Object> detailVo : detail) {
				...
				List<Map<String, Object>> existsSource = assDepreSourceSpecialMapper.queryDepreSourceByAssCardNo(detailVo);
			...
			assDepreDetailSpecialMapper.delete(entityMap);
			assDepreDetailSpecialMapper.addBatch(listVo);
			
			if(sourceList.size() > 0 ){
				assDepreSourceSpecialMapper.deleteBatch(sourceList);
				assDepreSourceSpecialMapper.addBatch(sourceList);
			}
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssDepreSpecial> list = (List<AssDepreSpecial>)assDepreSpecialMapper.query(entityMap);
			...
			List<AssDepreSpecial> list = (List<AssDepreSpecial>)assDepreSpecialMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return assDepreSpecialMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return AssDepreSpecial
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return assDepreSpecialMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<AssDepreSpecial>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return assDepreSpecialMapper.queryExists(entityMap);
	}
	@Override
	public String deleteAssDepreSourceSpecial(List<Map<String, Object>> entityMap) throws DataAccessException {
		try {
			assDepreSourceSpecialMapper.deleteBatch(entityMap);
	    	...
	    	Double change_depre = 0.0;
			Double new_depre = 0.0;
			List<Map<String, Object>> listMap = assDepreSourceSpecialMapper.queryDepreSourceByAssCardNo(mapVo);
			...
			assDepreDetailSpecialMapper.updateDepreBySource(mapVo);
	...
	@Override
	public String queryAssDepreSourceSpecial(Map<String, Object> entityMap) throws DataAccessException {
		SysPage sysPage = new SysPage();
		...
		if (sysPage.getTotal()==-1){
			...
			List<AssDepreSourceSpecial> list = (List<AssDepreSourceSpecial>)assDepreSourceSpecialMapper.query(entityMap);
			...
			List<AssDepreSourceSpecial> list = (List<AssDepreSourceSpecial>)assDepreSourceSpecialMapper.query(entityMap, rowBounds);
	...
	@Override
	public String saveAssDepreSourceSpecial(Map<String, Object> entityMap) throws DataAccessException {
		List<Map<String, Object>> listVo = new ArrayList<Map<String, Object>>();
		List<Map> detail = ChdJson.fromJsonAsList(Map.class, entityMap.get("ParamVo").toString());
		Double change_depre = 0.0;
		Double new_depre = 0.0;
		Double new_depres = 0.0;
		Double prices = 0.0;
		try {
			for (Map<String, Object> detailVo : detail) { 
				...
				if(detailVo.get("new_depre") == null && "".equals(detailVo.get("new_depre"))){
					 new_depres = Double.parseDouble(detailVo.get("new_depre").toString());
				} else {
					new_depres = 0.0;
				}
				
				if(detailVo.get("price").toString() == null && "".equals(detailVo.get("price"))){
					prices = Double.parseDouble(detailVo.get("price").toString());
				} else {
					prices = 0.0;
				}
				
				if ( new_depres > prices) {
					TransactionAspectSupport.currentTransactionStatus().setRollbackOnly();
			...
			assDepreSourceSpecialMapper.delete(entityMap);
			assDepreSourceSpecialMapper.addBatch(listVo);
			
			entityMap.put("change_depre", change_depre + "");
			entityMap.put("new_depre", new_depre + "");
			
			assDepreDetailSpecialMapper.updateDepreBySource(entityMap);
	...
	public String updateConfirm(List<Map<String, Object>> entityMap) throws DataAccessException {
		...
		try {
			for(Map<String, Object> map : entityMap){
				List<Map<String,Object>> detailMap = assDepreDetailSpecialMapper.queryByChangeNoMap(map);
				if(detailMap == null ||detailMap.size() == 0){
					return "{\"warn\":\"存在没有明细数据的单据,不能确认.\"}";
				}
				for(Map<String,Object> detail : detailMap){
					List<Map<String,Object>> sourceMap = assDepreSourceSpecialMapper.queryDepreSourceByAssCardNo(detail);
			...
			assDepreSpecialMapper.updateConfirm(entityMap);//更新主表状态
			assCardSpecialMapper.updateDepreMoneyConfirm(cardList);//更新卡片原值
			if(reSourceUpdateList.size() > 0){
				assResourceSpecialMapper.updateBatchByDepre(reSourceUpdateList);
			}
