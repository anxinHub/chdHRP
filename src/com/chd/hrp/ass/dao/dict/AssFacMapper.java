...
public interface AssFacMapper extends SqlMapper{
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<AssFac> queryFac(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<AssFac> queryFac(Map<String,Object> entityMap) throws DataAccessException;
	...
	*/
	 ...
	 * @return
	 */
	public List<AssFac> queryFacById(Map<String, Object> entityMap)throws DataAccessException;
	/**
	 * 根据修改输入时的生产厂商排序号 查询 与该排序号的生产厂商记录 （判断 输入的 生产厂商排序号 是否已经存在）
	 * @param entityMap
	 * @return
	 */
	public AssFac queryFac_sort(Map<String, Object> entityMap)throws DataAccessException;
	/**
	 * 查询当前集团/医院下的 生产 厂商的最大排序号
	 * @param entityMap
	 * @return
	 */
	public AssFac queryMaxFac_sort(Map<String, Object> entityMap);
	
	
    public AssFac  queryFacMaxTypeCode(Map<String, Object> entityMap)throws DataAccessException;
	
	public AssFac  queryFacMaxTypePy(Map<String, Object> entityMap)throws DataAccessException;
