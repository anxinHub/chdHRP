...
public interface AssDepreDetailInassetsMapper extends SqlMapper{
	List<AssDepreDetailInassets> queryByChangeNo(Map<String,Object> entityMap)throws DataAccessException;
