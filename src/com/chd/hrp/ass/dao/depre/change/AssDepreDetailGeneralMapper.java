...
public interface AssDepreDetailGeneralMapper extends SqlMapper{
	List<AssDepreDetailGeneral> queryByChangeNo(Map<String,Object> entityMap)throws DataAccessException;
