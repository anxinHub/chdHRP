...
public interface AssResourceLandMapper extends SqlMapper{
	public List<AssResourceLand> queryByAssCardNo(Map<String,Object> entityMap) throws DataAccessException;
