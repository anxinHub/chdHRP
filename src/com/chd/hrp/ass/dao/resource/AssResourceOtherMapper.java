...
public interface AssResourceOtherMapper extends SqlMapper{
	
	public List<AssResourceOther> queryByAssCardNo(Map<String,Object> entityMap) throws DataAccessException;
