...
public interface AssResourceGeneralMapper extends SqlMapper{
	
	public List<AssResourceGeneral> queryByAssCardNo(Map<String,Object> entityMap) throws DataAccessException;
	...
	public List<Map<String, Object>> queryByAssCardIn(Map<String, Object> cardMap);
}
