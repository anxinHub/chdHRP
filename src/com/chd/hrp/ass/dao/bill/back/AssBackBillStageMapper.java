...
public interface AssBackBillStageMapper extends SqlMapper{
	...
	List<AssBackBillStage> queryBackBillStageByBillNo(Map<String,Object> entityMap)throws DataAccessException;	
	
	List<AssBackBillStage> queryBackBillStageByBillNo(Map<String,Object> entityMap, RowBounds rowBounds)throws DataAccessException;	
