...
public interface AssBackBillDetailMapper extends SqlMapper{
	...
	List<AssBackBillDetail> queryByImportPay(Map<String, Object> entityMap)throws DataAccessException;
}
