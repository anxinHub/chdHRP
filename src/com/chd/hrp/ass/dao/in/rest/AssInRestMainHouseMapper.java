...
public interface AssInRestMainHouseMapper extends SqlMapper{
	...
	List<Map<String, Object>> queryAssInRestMainHouseByAssInNo(Map<String, Object> map);

	List<Map<String, Object>> queryAssInRestMainHouseDetailByAssInNo(Map<String, Object> map);

	Integer queryBydept(Map<String, Object> entityMap);

	Integer queryByRdept(Map<String, Object> entityMap);

	List<String> queryAssInRestMainHouseStates(Map<String, Object> mapVo);
