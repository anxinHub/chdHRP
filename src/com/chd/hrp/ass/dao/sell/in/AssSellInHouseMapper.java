...
public interface AssSellInHouseMapper extends SqlMapper{
	...
	public List<Map<String, Object>> queryAssSellInHouseByAssInNo(Map<String, Object> map);

	public List<Map<String, Object>> queryAssSellInHouseDetailByAssInNo(Map<String, Object> map);
