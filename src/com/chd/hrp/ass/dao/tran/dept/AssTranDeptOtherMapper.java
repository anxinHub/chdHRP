...
public interface AssTranDeptOtherMapper extends SqlMapper{
	 ...
	 */
	public Map<String, Object> queryAssTranDeptOtherPrintTemlateByMain(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryAssTranDeptOtherPrintTemlateByMainBatch(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryAssTranDeptOtherPrintTemlateByDetail(Map<String,Object> entityMap) throws DataAccessException;
