...
public interface AssOutSpecialMapper extends SqlMapper{
	 ...
	 */
	public Map<String, Object> queryAssOutSpecialPrintTemlateByMain(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryAssOutSpecialPrintTemlateByMainBatch(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryAssOutSpecialPrintTemlateByDetail(Map<String,Object> entityMap) throws DataAccessException;
