...
public interface AssOutOtherMapper extends SqlMapper{
	 ...
	 */
	public Map<String, Object> queryAssOutOtherPrintTemlateByMain(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryAssOutOtherPrintTemlateByMainBatch(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryAssOutOtherPrintTemlateByDetail(Map<String,Object> entityMap) throws DataAccessException;
