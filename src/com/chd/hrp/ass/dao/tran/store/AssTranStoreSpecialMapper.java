...
public interface AssTranStoreSpecialMapper extends SqlMapper{
	 ...
	 */
	public Map<String, Object> queryAssTranStoreSpecialPrintTemlateByMain(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryAssTranStoreSpecialPrintTemlateByMainBatch(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryAssTranStoreSpecialPrintTemlateByDetail(Map<String,Object> entityMap) throws DataAccessException;
