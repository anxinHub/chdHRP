...
public interface AssAllotInInassetsMapper extends SqlMapper{
	...
	/**
	 * 其他无形资产 资产调剂入库 主页面 入库主表查询
	 * @param entityMap
	 * @return
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryAssAllotInInassetsPrintTemlateByMainBatch(Map<String, Object> entityMap)throws DataAccessException;
	
	/**
	 * 其他无形资产  资产调剂入库 入库明细表查询
	 * @param entityMap
	 * @return
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryAssAllotInInassetsPrintTemlateByDetail(Map<String, Object> entityMap)throws DataAccessException;
	
	/**
	 * 其他无形资产 资产调剂入库 修改页面 入库主表查询
	 * @param entityMap
	 * @return
	 * @throws DataAccessException
	 */
	public Map<String, Object> queryAssAllotInInassetsPrintTemlateByMain(Map<String, Object> entityMap)throws DataAccessException;
