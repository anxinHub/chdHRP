...
public interface AssAllotInSpecialMapper extends SqlMapper{
	...
	/**
	 * 专用设备 资产调剂入库 主页面 入库主表查询
	 * @param entityMap
	 * @return
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryAssAllotInSpecialPrintTemlateByMainBatch(Map<String, Object> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryAssAllotInSpecialPrintTemlateByDetail(Map<String, Object> entityMap)throws DataAccessException;
	
	/**
	 * 专用设备 资产调剂入库 修改页面 入库主表查询
	 * @param entityMap
	 * @return
	 * @throws DataAccessException
	 */
	public Map<String, Object> queryAssAllotInSpecialPrintTemlateByMain(Map<String, Object> entityMap)throws DataAccessException;
