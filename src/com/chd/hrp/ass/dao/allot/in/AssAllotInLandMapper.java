...
public interface AssAllotInLandMapper extends SqlMapper{
	...
	public List<Map<String, Object>> queryAssAllotInLandByAssInNo(Map<String, Object> map);

	public List<Map<String, Object>> queryAssAllotInLandDetailByAssInNo(Map<String, Object> map);
