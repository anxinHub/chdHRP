...
public interface AssChangeDetailHouseMapper extends SqlMapper{
	List<AssChangeDetailHouse> queryByChangeNo(Map<String,Object> entityMap)throws DataAccessException;
