...
public interface AssChangeDetailGeneralMapper extends SqlMapper{
	List<AssChangeDetailGeneral> queryByChangeNo(Map<String,Object> entityMap)throws DataAccessException;
