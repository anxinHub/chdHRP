...
public interface AssChangeDetailOtherMapper extends SqlMapper{
	List<AssChangeDetailOther> queryByChangeNo(Map<String,Object> entityMap)throws DataAccessException;
