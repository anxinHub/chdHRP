...
public interface AssChangeDetailSpecialMapper extends SqlMapper{
	List<AssChangeDetailSpecial> queryByChangeNo(Map<String,Object> entityMap)throws DataAccessException;
