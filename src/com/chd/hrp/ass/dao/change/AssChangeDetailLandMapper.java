...
public interface AssChangeDetailLandMapper extends SqlMapper{
	List<AssChangeDetailLand> queryByChangeNo(Map<String,Object> entityMap)throws DataAccessException;
