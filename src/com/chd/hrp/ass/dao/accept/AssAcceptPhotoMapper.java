...
public interface AssAcceptPhotoMapper extends SqlMapper{
	public List<Map<String,Object>> queryAssAcceptPhoto(List<Map<String, Object>> entityList) throws DataAccessException;
