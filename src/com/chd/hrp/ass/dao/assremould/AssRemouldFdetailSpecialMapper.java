...
public interface AssRemouldFdetailSpecialMapper extends SqlMapper{
	...
	List<Map<String, Object>> queryAssRemouldFDetailSpecial(Map<String, Object> mapVo);
