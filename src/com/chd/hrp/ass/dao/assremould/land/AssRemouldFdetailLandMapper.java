...
public interface AssRemouldFdetailLandMapper extends SqlMapper{
	...
	List<Map<String, Object>> queryAssRemouldFDetailLand(Map<String, Object> mapVo);
	...
	List<AssRemouldFdetailLand> queryByDisANo(Map<String, Object> mapVo);
