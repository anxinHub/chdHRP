...
public interface AssRemouldFsourceGeneralMapper extends SqlMapper{

	List<Map<String, Object>> queryAssRemouldFSourceGeneral(Map<String, Object> entityMap);
