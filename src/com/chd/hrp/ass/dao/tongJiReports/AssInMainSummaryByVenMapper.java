...
public interface AssInMainSummaryByVenMapper extends SqlMapper{
	...
	*/
	public List<Map<String,Object>> queryAssInMainSummaryByVen(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
