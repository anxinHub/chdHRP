...
public interface AssSellInInassetsService extends SqlService {
	public String initAssSellInCardInassets(Map<String,Object> entityMap)throws DataAccessException;
	...
	public String initAssSellInBatchCardInassets(Map<String, Object> mapVo) throws DataAccessException;
