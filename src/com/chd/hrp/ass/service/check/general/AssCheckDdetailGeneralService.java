...
public interface AssCheckDdetailGeneralService extends SqlService {
	/**
	 * @Description 
	 * 复制账面数量<BR> 
	 * @param  entityMap
	...
	*/
	...
	public String saveAssCheckDDetailGeneral(Map<String, Object> mapVo)throws DataAccessException;
}
