...
public interface AssCheckSdetailSpecialService extends SqlService {
	/**
	 * @Description 
	 * 复制账面数量<BR> 
	 * @param  entityMap
	...
	*/
	...
	List<String> queryAssInSpecialState(Map<String, Object> mapVo) throws DataAccessException;
	public String saveAssCheckSDetailSpecial(Map<String, Object> mapVo) throws DataAccessException;
}
