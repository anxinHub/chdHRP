...
public interface AssCheckDdetailInassetsService extends SqlService {
	/**
	 * @Description 
	 * 复制账面数量<BR> 
	 * @param  entityMap
	...
	*/
	...
	public String saveAssCheckDDetailInassets(Map<String, Object> mapVo) throws DataAccessException;
}
