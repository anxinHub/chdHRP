...
public interface AssCheckSdetailInassetsService extends SqlService {
	/**
	 * @Description 
	 * 复制账面数量<BR> 
	 * @param  entityMap
	...
	*/
	...
	public String saveAssCheckSDetailInassets(Map<String, Object> mapVo) throws DataAccessException;
}
