...
public interface AssCheckSinassetsService extends SqlService {
	/**
	 * @Description 
	 * 审核数据<BR> 
	 * @param  entityMap
	...
	*/
	...
	public AssCheckSinassets queryState(Map<String, Object> mapVo)throws DataAccessException;
