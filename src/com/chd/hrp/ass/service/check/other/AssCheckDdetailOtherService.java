...
public interface AssCheckDdetailOtherService extends SqlService {
	/**
	 * @Description 
	 * 复制账面数量<BR> 
	 * @param  entityMap
	...
	*/
	...
	public String saveAssCheckDDetailOther(Map<String, Object> mapVo) throws DataAccessException;
}
