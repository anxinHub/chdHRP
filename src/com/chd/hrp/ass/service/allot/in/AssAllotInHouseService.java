...
public interface AssAllotInHouseService extends SqlService {
	public String initAssAllotInCardHouse(Map<String, Object> entityMap) throws DataAccessException;
	...
	Map<String, Object> printAssAllotInHouseData(Map<String, Object> map) throws DataAccessException;

	public String initAssAllotInBatchCardHouse(Map<String, Object> mapVo) throws DataAccessException;
