...
public interface AssAllotInOtherService extends SqlService {
	public String initAssAllotInCardOther(Map<String,Object> entityMap)throws DataAccessException;
	...
	public String initAssAllotInBatchCardOther(Map<String, Object> mapVo)throws DataAccessException;
