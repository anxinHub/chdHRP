...
public interface AssAllotOutDetailSpecialService extends SqlService {
	public List<AssAllotOutDetailSpecial> queryByAssAllotOutNo(Map<String,Object> entityMap)throws DataAccessException;
