...
public interface AssCardGeneralService extends SqlService {
public Integer queryCardExistsByAssInNo(Map<String,Object> entityMap)throws DataAccessException;
	...
	public List<AssCardGeneral> queryCount(Map<String, Object> vCreateDateMap)throws DataAccessException;
