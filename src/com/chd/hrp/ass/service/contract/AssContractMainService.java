...
public interface AssContractMainService {
	/**
	 * 获取当前的序列号
	 * @return
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public String addBatchAssContractMain(List<Map<String, Object>> entityMap)throws DataAccessException;
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public String updateBatchAssContractMain(List<Map<String, Object>> entityMap)throws DataAccessException;
	/**
	 * @Description 
	 * 删除050501 资产合同主表<BR> 
	 * @param  entityMap
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public String deleteBatchAssContractMain(List<Map<String, Object>> entityMap)throws DataAccessException;
	
	/**
	 * @Description 
	 * 添加或者更新050501 资产合同主表<BR> 
	 * @param  entityMap
	 * @return int
	 * @throws DataAccessException
	*/
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public String updateToPerform(List<Map<String,Object>> entityMap)throws DataAccessException;
	/**
	 * @Description 
	 * 取消履行<BR> 
	 * @param  entityMap
	 ...
	 * @throws DataAccessException
	*/
	public String updateNotToPerform(List<Map<String,Object>> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public String updateToFile(List<Map<String,Object>> entityMap)throws DataAccessException;
	/**
	 * @Description 
	 * 取消归档<BR> 
	 * @param  entityMap
	 ...
	 * @throws DataAccessException
	*/
	public String updateNotToFile(List<Map<String,Object>> entityMap)throws DataAccessException;
}
