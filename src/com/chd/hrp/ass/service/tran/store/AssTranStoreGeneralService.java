...
public interface AssTranStoreGeneralService extends SqlService {
	public String updateConfirmTranStoreGeneral(List<Map<String, Object>> entityMap,List<Map<String, Object>> cardEntityMap)throws DataAccessException;
	 ...
	 */
	public Map<String, Object> assTranStoreGeneralByPrintTemlate(Map<String, Object> entityMap) throws DataAccessException;
