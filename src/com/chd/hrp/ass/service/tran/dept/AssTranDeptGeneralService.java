...
public interface AssTranDeptGeneralService extends SqlService {
	public String updateConfirmTranDeptGeneral(List<Map<String, Object>> entityMap,List<Map<String, Object>> cardEntityMap)throws DataAccessException;
	 ...
	 */
	public Map<String, Object> assTranDeptGeneralByPrintTemlate(Map<String, Object> entityMap) throws DataAccessException;
