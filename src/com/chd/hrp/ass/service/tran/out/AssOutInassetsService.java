...
public interface AssOutInassetsService extends SqlService {
	public String updateConfirmOutInassets(List<Map<String, Object>> entityMap,List<Map<String, Object>> cardEntityMap)throws DataAccessException;
	 ...
	 */
	public Map<String, Object> assOutInassetsByPrintTemlate(Map<String, Object> entityMap) throws DataAccessException;
