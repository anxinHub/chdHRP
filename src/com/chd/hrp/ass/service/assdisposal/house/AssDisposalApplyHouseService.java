 ...
 * @Version: 1.0
 */ 
public interface AssDisposalApplyHouseService extends SqlService{

	String updateConfirmDisposalApplyHouse(List<Map<String, Object>> listVo, List<Map<String, Object>> listCardVo)throws DataAccessException;
