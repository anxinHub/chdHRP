...
public interface AssInMainSpecialService extends SqlService {
	public String initAssInCardSpecial(Map<String,Object> entityMap)throws DataAccessException;
	
	public String initAssInBatchCardSpecial(Map<String,Object> entityMap)throws DataAccessException;
	...
	public String queryAssBackInMainSpecial(Map<String, Object> page) throws DataAccessException;

	public String queryInMap(Map<String, Object> page) throws DataAccessException;

	public Integer querycountStore(Map<String, Object> vStoreMap) throws DataAccessException;

	public Integer querycountVen(Map<String, Object> vVenMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public String offsetInSpecial(List<Map<String, Object>> listVo) throws DataAccessException;
