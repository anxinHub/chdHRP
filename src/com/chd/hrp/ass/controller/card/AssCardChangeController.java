...
@Controller
public class AssCardChangeController extends BaseController{
	...
	@RequestMapping(value = "/hrp/ass/asscard/queryAssChangeCard", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryAssChangeCard(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
