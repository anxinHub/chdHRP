...
@Controller
public class InassClosingAccountController extends BaseController {

	@Resource(name = "inassClosingAccountService")
	private final InassClosingAccountService inassClosingAccountService = null;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assendaccount/assClosingAccountMainInassPage", method = RequestMethod.GET)
	public String assClosingAccountMainInassPage(Model mode) throws Exception {
		...
		if(SysYearMonth == null){
			...
			return "hrp/ass/assendaccount/assClosingAccountMainInass";
		}

		Map<String, Object> costCur = inassClosingAccountService.queryInassCurYearMonth(mapVo);
		...
		if (costCur == null) {
			...
			//if (costCur.get("ass_flag").toString().equals("1")) {
				...
				if (mon > sessmon) {
					...
					// 查询系统启用日期是否结账
					Map<String, Object> costCurSysYearMonth = queryInassSysYearMonth(mapVo);
	...
	// 递归查询没有结账的月份
	public Map<String, Object> queryInassSysYearMonth(Map<String, Object> mapVo) {

		Map<String, Object> costCurSysYearMonth = inassClosingAccountService
				.queryInassSysYearMonth(mapVo);

		if (costCurSysYearMonth != null
				&& costCurSysYearMonth.get("inass_flag").toString().equals("1")) {
			...
			if (SysMoth > 12) {
				...
				mapVo.put("SysYearMonth", SysYearMonth);
				return queryInassSysYearMonth(mapVo);
			} else {
	...
	@RequestMapping(value = "/hrp/ass/assendaccount/queryInassYearMonth", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryInassYearMonth(
		...
		mapVo.put("copy_code", SessionManager.getCopyCode());
		mapVo.put("mod_code", "0501");
		String assAllotInSpecial = inassClosingAccountService
				.queryInassYearMonth(getPage(mapVo));

		return JSONObject.parseObject(assAllotInSpecial);
	}

	@RequestMapping(value = "/hrp/ass/assendaccount/assColsingInassAccount", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> assColsingInassAccount(
			@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		...
		mapVo.put("copy_code", SessionManager.getCopyCode());
		mapVo.put("mod_code", "0501");
		String str = inassClosingAccountService.collectInassDepreALL(mapVo);

		return JSONObject.parseObject(str);
	}

	@RequestMapping(value = "/hrp/ass/assendaccount/assDelColsingInassAccount", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> assDelColsingInassAccount(
			@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		...
		String str = inassClosingAccountService.collectInassDelDepreALL(mapVo);
