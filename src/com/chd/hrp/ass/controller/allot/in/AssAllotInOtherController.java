...
@Controller
public class AssAllotInOtherController extends BaseController{

	private static Logger logger = Logger.getLogger(AssAllotInOtherController.class);

	// 引入Service服务
	@Resource(name = "assAllotInOtherService")
	private final AssAllotInOtherService assAllotInOtherService = null;

	@Resource(name = "assAllotInDetailOtherService")
	private final AssAllotInDetailOtherService assAllotInDetailOtherService = null;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assother/assallotin/assAllotInOtherMainPage", method = RequestMethod.GET)
	public String assAllotInOtherMainPage(Model mode) throws Exception {
		
		mode.addAttribute("ass_05005",MyConfig.getSysPara("05005"));
		mode.addAttribute("ass_05006",MyConfig.getSysPara("05006"));
		mode.addAttribute("ass_05038",MyConfig.getSysPara("05038"));
		
		return "hrp/ass/assother/assallotin/main";
	}
	
	@RequestMapping(value = "/hrp/ass/assother/assallotin/assImportAllotOutOtherPage", method = RequestMethod.GET)
	public String assImportAllotOutOtherPage(@RequestParam Map<String, Object> mapVo,Model mode) throws Exception {
		...
		return "hrp/ass/assother/assallotin/importoutmain";
	}
	
	@RequestMapping(value = "/hrp/ass/assother/assallotin/assViewAllotOutOtherPage", method = RequestMethod.GET)
	public String assViewAllotOutOtherPage(@RequestParam Map<String, Object> mapVo,Model mode) throws Exception {
		mode.addAttribute("out_group_id", mapVo.get("out_group_id"));
		mode.addAttribute("out_hos_id", mapVo.get("out_hos_id"));
		mode.addAttribute("out_store_id", mapVo.get("out_store_id"));
		mode.addAttribute("out_store_no", mapVo.get("out_store_no"));
		...
		return "hrp/ass/assother/assallotin/viewoutmain";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assother/assallotin/assAllotInOtherAddPage", method = RequestMethod.GET)
	public String assAllotInOtherAddPage(Model mode) throws Exception {
		
		mode.addAttribute("ass_05005",MyConfig.getSysPara("05005"));
		mode.addAttribute("ass_05006",MyConfig.getSysPara("05006"));
		
		return "hrp/ass/assother/assallotin/add";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assother/assallotin/saveAssAllotInOther", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addAssAllotInOther(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		...
		AssAllotInOther assAllotInOther = assAllotInOtherService.queryByCode(mapVo);
		if(assAllotInOther != null){
			if(assAllotInOther.getState() > 0){
				return JSONObject.parseObject("{\"warn\":\"已入库确认的数据不能保存! \"}");
			}
		}

		String assAllotInOtherJson = assAllotInOtherService.addOrUpdate(mapVo);

		return JSONObject.parseObject(assAllotInOtherJson);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assother/assallotin/assAllotInOtherUpdatePage", method = RequestMethod.GET)
	public String assAllotInOtherUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		AssAllotInOther assAllotInOther = new AssAllotInOther();

		assAllotInOther = assAllotInOtherService.queryByCode(mapVo);
		mode.addAttribute("is_import", mapVo.get("is_import"));
		mode.addAttribute("group_id", assAllotInOther.getGroup_id());
		mode.addAttribute("hos_id", assAllotInOther.getHos_id());
		mode.addAttribute("copy_code", assAllotInOther.getCopy_code());
		mode.addAttribute("allot_in_no", assAllotInOther.getAllot_in_no());
		mode.addAttribute("in_store_id", assAllotInOther.getIn_store_id());
		mode.addAttribute("in_store_no", assAllotInOther.getIn_store_no());
		mode.addAttribute("in_store_code", assAllotInOther.getIn_store_code());
		mode.addAttribute("in_store_name", assAllotInOther.getIn_store_name());
		mode.addAttribute("out_group_id", assAllotInOther.getOut_group_id());
		mode.addAttribute("out_group_name", assAllotInOther.getOut_group_name());
		mode.addAttribute("out_hos_id", assAllotInOther.getOut_hos_id());
		mode.addAttribute("out_hos_name", assAllotInOther.getOut_hos_name());
		mode.addAttribute("out_store_id", assAllotInOther.getOut_store_id());
		mode.addAttribute("out_store_no", assAllotInOther.getOut_store_no());
		mode.addAttribute("out_store_code", assAllotInOther.getOut_store_code());
		mode.addAttribute("out_store_name", assAllotInOther.getOut_store_name());
		mode.addAttribute("price", assAllotInOther.getPrice());
		mode.addAttribute("add_depre", assAllotInOther.getAdd_depre());
		mode.addAttribute("cur_money", assAllotInOther.getCur_money());
		mode.addAttribute("fore_money", assAllotInOther.getFore_money());
		mode.addAttribute("create_emp", assAllotInOther.getCreate_emp());
		mode.addAttribute("create_emp_name", assAllotInOther.getCreate_emp_name());
		mode.addAttribute("create_date", DateUtil.dateToString(assAllotInOther.getCreate_date(),"yyyy-MM-dd"));
		mode.addAttribute("audit_emp", assAllotInOther.getAudit_emp());
		mode.addAttribute("audit_emp_name", assAllotInOther.getAudit_emp_name());
		mode.addAttribute("audit_date", DateUtil.dateToString(assAllotInOther.getAudit_date(),"yyyy-MM-dd"));
		mode.addAttribute("state", assAllotInOther.getState());
		mode.addAttribute("state_name", assAllotInOther.getState_name());
		mode.addAttribute("note", assAllotInOther.getNote());

		mode.addAttribute("ass_05005",MyConfig.getSysPara("05005"));
		mode.addAttribute("ass_05006",MyConfig.getSysPara("05006"));
		mode.addAttribute("ass_05038",MyConfig.getSysPara("05038"));
		
		return "hrp/ass/assother/assallotin/update";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assother/assallotin/updateConfirmAllotInMainOther", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateConfirmAllotInMainOther(@RequestParam(value = "ParamVo") String paramVo, Model mode)
			throws Exception {
		...
		for (String id : paramVo.split(",")) {
			...
			AssAllotInOther assAllotInOther = assAllotInOtherService.queryByCode(mapVo);
			if (assAllotInOther.getState() == 2) {
				continue;
			}
			if(DateUtil.compareDate(assAllotInOther.getCreate_date(), new Date())){
				return JSONObject.parseObject("{\"warn\":\"确认日期不能小于制单日期,不能入库! \"}");
			}
			List<Map<String, Object>> list = assAllotInDetailOtherService.queryByInit(mapVo);
			if(list.size() == 0){
		...
		try {
			assInMainJson = assAllotInOtherService.updateConfirm(listVo);
		} catch (Exception e) {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assother/assallotin/deleteAssAllotInOther", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteAssAllotInOther(@RequestParam(value = "ParamVo") String paramVo, Model mode)
			throws Exception {
		...
		for (String id : paramVo.split(",")) {
			...
			AssAllotInOther assInOther = assAllotInOtherService.queryByCode(mapVo);
		...
		String assAllotInOtherJson = assAllotInOtherService.deleteBatch(listVo);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assother/assallotin/queryAssAllotInOther", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryAssAllotInOther(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		...
		String assAllotInOther = null;
		
		if("0".equals(mapVo.get("show_detail").toString())){
		
			assAllotInOther = assAllotInOtherService.query(getPage(mapVo));
		
		}else{
			
			assAllotInOther = assAllotInOtherService.queryDetails(getPage(mapVo));
	...
	@RequestMapping(value = "/hrp/ass/assother/assallotin/initAssAllotInOther", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> initAssAllotInOther(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		...
		String assAllotInOther = assAllotInOtherService.initAssAllotInOther(mapVo);
	...
	//查询出库单引入使用
	@RequestMapping(value = "/hrp/ass/assother/assallotin/queryByAllotInImport", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryByAllotInImport(@RequestParam Map<String, Object> mapVo, Model mode)
		...
		String assAllotInOther = assAllotOutOtherService.queryByAllotInImport(getPage(mapVo));

		return JSONObject.parseObject(assAllotInOther);
	}
	
	@RequestMapping(value = "/hrp/ass/assother/assallotin/queryByAllotInImportView", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryByAllotInImportView(@RequestParam Map<String, Object> mapVo, Model mode)
		...
		String assAllotInOther = assAllotOutOtherService.queryByAllotInImportView(getPage(mapVo));
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assother/assallotin/deleteAssAllotInDetailOther", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteAssAllotInDetailOther(@RequestParam(value = "ParamVo") String paramVo,
		...
		String assAllotInDetailOtherJson = assAllotInDetailOtherService.deleteBatch(listVo);

		return JSONObject.parseObject(assAllotInDetailOtherJson);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assother/assallotin/queryAssAllotInDetailOther", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryAssAllotInDetailOther(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		...
		String assAllotInDetailOther = assAllotInDetailOtherService.query(getPage(mapVo));

		return JSONObject.parseObject(assAllotInDetailOther);

	}
	
	
	@RequestMapping(value = "/hrp/ass/assother/assallotin/queryAssAllotInCardOther", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/hrp/ass/assother/assallotin/initAssAllotInCardOther", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> initAssInCardOther(@RequestParam Map<String, Object> mapVo, Model mode)
		...
		try {
			...
			assCard = assAllotInOtherService.initAssAllotInCardOther(mapVo);
		} catch (Exception e) {
			return JSONObject.parseObject("{\"error\":\"" + e.getMessage() + " \"}");
		}
	...
	@RequestMapping(value = "/hrp/ass/assother/assallotin/initAssAllotInBatchCardOther", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> initAssAllotInBatchCardOther(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		...
		String assCard = "";
		try {
			AssAllotInOther assAllotInSpecial = assAllotInOtherService.queryByCode(mapVo);
			...
			assCard = assAllotInOtherService.initAssAllotInBatchCardOther(mapVo);
		} catch (Exception e) {
			return JSONObject.parseObject("{\"error\":\"" + e.getMessage() + " \"}");
		}
	...
	@RequestMapping(value = "/hrp/ass/assother/assallotin/deleteAssAllotInCardOther", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/hrp/ass/assother/assallotin/assAllotOutOtherViewPage", method = RequestMethod.GET)
	public String assAllotOutOtherViewPage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/ass/assother/assallotin/viewout";
	}
	
	
	@RequestMapping(value = "/hrp/ass/assother/assallotin/queryAllotOutDetByAllotInOther", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryAllotOutDetByAllotInOther(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assother/assallotin/queryAssAllotInOtherState", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryAssAllotInOtherState(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		...
		//入库单状态查询  （打印时校验数据专用）
		List<String> list = assAllotInOtherService.queryAssAllotInOtherState(mapVo);
