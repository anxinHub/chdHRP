...
@Controller
public class AssContractDetailController extends BaseController {

	private static Logger logger = Logger.getLogger(AssContractDetailController.class);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/asscontractdetail/assContractDetailMainPage", method = RequestMethod.GET)
	public String assContractDetailMainPage(Model mode) throws Exception {

		return "hrp/ass/asscontractdetail/assContractDetailMain";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/asscontractdetail/assContractDetailAddPage", method = RequestMethod.GET)
	public String assContractDetailAddPage(Model mode) throws Exception {

		return "hrp/ass/asscontractdetail/assContractDetailAdd";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/asscontractdetail/addAssContractDetail", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addAssContractDetail(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/asscontractdetail/assContractDetailUpdatePage", method = RequestMethod.GET)
	public String assContractDetailUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/ass/asscontractdetail/assContractDetailUpdate";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/asscontractdetail/updateAssContractDetail", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateAssContractDetail(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/asscontractdetail/addOrUpdateAssContractDetail", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateAssContractDetail(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/asscontractdetail/deleteAssContractDetail", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteAssContractDetail(@RequestParam(value = "ParamVo") String paramVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/asscontractdetail/queryAssContractDetail", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryAssContractDetail(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/asscontractdetail/assContractDetailImportPage", method = RequestMethod.GET)
	public String assContractDetailImportPage(Model mode) throws Exception {

		return "hrp/ass/asscontractdetail/assContractDetailImport";
	 ...
	 * @throws IOException
	 */
	@RequestMapping(value = "hrp/ass/asscontractdetail/downTemplate", method = RequestMethod.GET)
	 ...
	 * @throws IOException
	 */
	@RequestMapping(value = "/hrp/ass/asscontractdetail/readAssContractDetailFiles", method = RequestMethod.POST)
	public String readAssContractDetailFiles(Plupload plupload, HttpServletRequest request,
	 ...
	 * @throws IOException
	 */
	@RequestMapping(value = "/hrp/ass/asscontractdetail/addBatchAssContractDetail", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addBatchAssContractDetail(@RequestParam(value = "ParamVo") String paramVo, Model mode)
			throws Exception {
