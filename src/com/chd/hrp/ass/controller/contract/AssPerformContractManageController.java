...
@Controller
public class AssPerformContractManageController extends BaseController {

	private static Logger logger = Logger.getLogger(AssPerformContractManageController.class);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assperformcontractmain/assPerformContractManageAddPage", method = RequestMethod.GET)
	public String assPerformContractManageAddPage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		...
		System.out.println("contract_id:" + mapVo.get("contract_id"));
		...
		return "hrp/ass/assperformcontractmain/assPerformContractManageAdd";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assperformcontractmain/addAssPerformContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addAssPerformContractManage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assperformcontractmain/assPerformContractManageUpdatePage", method = RequestMethod.GET)
	public String assPerformContractManageUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		...
		return "hrp/ass/assperformcontractmain/assPerformContractManageUpdate";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assperformcontractmain/updateAssPerformContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateAssPerformContractManage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assperformcontractmain/addOrUpdateAssPerformContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateAssPerformContractManage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assperformcontractmain/deleteAssPerformContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteAssPerformContractManage(@RequestParam(value = "ParamVo") String paramVo,
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assperformcontractmain/queryAssPerformContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryAssPerformContractManage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		System.out.println("年度：" + SessionManager.getAcctYear());
		if (mapVo.get("group_id") == null) {
