...
@Controller
public class AssFileContractManageController extends BaseController {

	private static Logger logger = Logger.getLogger(AssFileContractManageController.class);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assfilecontractmain/assFileContractManageAddPage", method = RequestMethod.GET)
	public String assFileContractManageAddPage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/ass/assfilecontractmain/assFileContractManageAdd";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assfilecontractmain/addAssFileContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addAssFileContractManage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assfilecontractmain/assFileContractManageUpdatePage", method = RequestMethod.GET)
	public String assFileContractManageUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		...
		return "hrp/ass/assfilecontractmain/assFileContractManageUpdate";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assfilecontractmain/updateAssFileContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateAssFileContractManage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		String assContractManageJson = "";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assfilecontractmain/addOrUpdateAssFileContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateAssFileContractManage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assfilecontractmain/deleteAssFileContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteAssFileContractManage(@RequestParam(value = "ParamVo") String paramVo, Model mode)
			throws Exception {
		String assContractManageJson = "";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assfilecontractmain/queryAssFileContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryAssFileContractManage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
