...
@Controller
public class AssInitContractDetailController extends BaseController {

	private static Logger logger = Logger.getLogger(AssInitContractDetailController.class);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractdetail/assInitContractDetailMainPage", method = RequestMethod.GET)
	public String assInitContractDetailMainPage(Model mode) throws Exception {

		return "hrp/ass/assinitcontractdetail/assInitContractDetailMain";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractdetail/assInitContractDetailAddPage", method = RequestMethod.GET)
	public String assInitContractDetailAddPage(Model mode) throws Exception {

		return "hrp/ass/assinitcontractdetail/assInitContractDetailAdd";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractdetail/addAssInitContractDetail", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addAssInitContractDetail(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractdetail/assInitContractDetailUpdatePage", method = RequestMethod.GET)
	public String assInitContractDetailUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		...
		return "hrp/ass/assinitcontractdetail/assInitContractDetailUpdate";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractdetail/updateAssInitContractDetail", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateAssInitContractDetail(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractdetail/addOrUpdateAssInitContractDetail", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateAssInitContractDetail(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractdetail/deleteAssInitContractDetail", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteAssInitContractDetail(@RequestParam(value = "ParamVo") String paramVo, Model mode)
			throws Exception {
		String assContractDetailJson = "";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractdetail/queryAssInitContractDetail", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryAssInitContractDetail(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractdetail/assInitContractDetailImportPage", method = RequestMethod.GET)
	public String assInitContractDetailImportPage(Model mode) throws Exception {

		return "hrp/ass/assinitcontractdetail/assInitContractDetailImport";
	 ...
	 * @throws IOException
	 */
	@RequestMapping(value = "hrp/ass/assinitcontractdetail/downTemplate", method = RequestMethod.GET)
	 ...
	 * @throws IOException
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractdetail/readAssInitContractDetailFiles", method = RequestMethod.POST)
	public String readAssInitContractDetailFiles(Plupload plupload, HttpServletRequest request,
	 ...
	 * @throws IOException
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractdetail/addBatchAssInitContractDetail", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addBatchAssInitContractDetail(@RequestParam(value = "ParamVo") String paramVo,
