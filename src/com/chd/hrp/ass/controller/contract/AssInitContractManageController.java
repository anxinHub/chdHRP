...
@Controller
public class AssInitContractManageController extends BaseController {

	private static Logger logger = Logger.getLogger(AssInitContractManageController.class);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractmain/assInitContractManageAddPage", method = RequestMethod.GET)
	public String assInitContractManageAddPage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/ass/assinitcontractmain/assInitContractManageAdd";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractmain/addAssInitContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addAssInitContractManage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractmain/assInitContractManageUpdatePage", method = RequestMethod.GET)
	public String assInitContractManageUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		...
		return "hrp/ass/assinitcontractmain/assInitContractManageUpdate";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractmain/updateAssInitContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateAssInitContractManage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
		String assContractManageJson = "";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractmain/addOrUpdateAssInitContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateAssInitContractManage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractmain/deleteAssInitContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteAssInitContractManage(@RequestParam(value = "ParamVo") String paramVo, Model mode)
			throws Exception {
		String assContractManageJson = "";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/ass/assinitcontractmain/queryAssInitContractManage", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryAssInitContractManage(@RequestParam Map<String, Object> mapVo, Model mode)
			throws Exception {
