...
public class AssDepreciationSectionMain implements Serializable{
	...
	private Double zc_price;
	private Double cz_price;
	private Double jx_price;
	private Double ky_price;
	
	public Double getZc_price() {
		return zc_price;
	}

	public void setZc_price(Double zc_price) {
		this.zc_price = zc_price;
	}

	public Double getCz_price() {
		return cz_price;
	}

	public void setCz_price(Double cz_price) {
		this.cz_price = cz_price;
	}

	public Double getJx_price() {
		return jx_price;
	}

	public void setJx_price(Double jx_price) {
		this.jx_price = jx_price;
	}

	public Double getKy_price() {
		return ky_price;
	}

	public void setKy_price(Double ky_price) {
		this.ky_price = ky_price;
	}
