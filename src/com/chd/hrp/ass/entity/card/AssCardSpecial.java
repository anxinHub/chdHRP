...
public class AssCardSpecial implements Serializable {   
  ...
  /**
	...
	public String getRepair_personnel() {
		return repair_personnel;
	}

	public void setRepair_personnel(String repair_personnel) {
		this.repair_personnel = repair_personnel;
	}
