...
public class AssNoDict implements Serializable {
  ...
  /**
	...
	* @param value 
	*/
	public void setAss_type_id(Long value) {
	...
	*/
	...
	/**
	 * @return the ass_id_no
	 */
	public String getAss_id_no() {
		return ass_id_no;
	}

	/**
	 * @param ass_id_no the ass_id_no to set
	 */
	public void setAss_id_no(String ass_id_no) {
		this.ass_id_no = ass_id_no;
	}
