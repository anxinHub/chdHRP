...
public class AssLandSourceDict implements Serializable {
	 ...
	 * 土地来源名称
	 */
	private String land_source_name;
  ...
  /**
	...
	* @param value 
	*/
	public void setLand_source_name(String value) {
		this.land_source_name = value;
	}
	...
	* @return String
	*/
	public String getLand_source_name() {
		return this.land_source_name;
	}
	/**
	* 设置 拼音码
	* @param value 
