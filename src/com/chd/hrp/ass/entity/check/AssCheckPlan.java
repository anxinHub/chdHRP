package com.chd.hrp.ass.entity.check;

import java.util.Date;

public class AssCheckPlan {
	...
	private String check_plan_no_s;
	
	private String check_plan_no_g;
	
	private String check_plan_no_o;
  ...
  /**
	...
	public final String getCheck_plan_no_s() {
		return check_plan_no_s;
	}
	
	public final void setCheck_plan_no_s(String check_plan_no_s) {
		this.check_plan_no_s = check_plan_no_s;
	}
	
	public final String getCheck_plan_no_g() {
		return check_plan_no_g;
	}
	
	public final void setCheck_plan_no_g(String check_plan_no_g) {
		this.check_plan_no_g = check_plan_no_g;
	}
	
	public final String getCheck_plan_no_o() {
		return check_plan_no_o;
	}
	
	public final void setCheck_plan_no_o(String check_plan_no_o) {
		this.check_plan_no_o = check_plan_no_o;
	}
