...
public class AssInvArrt implements Serializable {
  ...
  /**
	...
	*/
	...
	public String getIs_mat_name() {
		return is_mat_name;
	}

	public void setIs_mat_name(String is_mat_name) {
		this.is_mat_name = is_mat_name;
	}
