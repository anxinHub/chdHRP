...
public class AssBillDetail implements Serializable {
  ...
  /**
	...
	*/
	...
	public Double getNc_d() {
		return nc_d;
	}

	public void setNc_d(Double nc_d) {
		this.nc_d = nc_d;
	}

	public Double getNc_c() {
		return nc_c;
	}

	public void setNc_c(Double nc_c) {
		this.nc_c = nc_c;
	}
}