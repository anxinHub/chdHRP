...
public class HtcgDrgsType implements Serializable {
	...
	public String getDrgs_type_note() {
		return drgs_type_note;
	}
	...
	public void setDrgs_type_note(String drgs_type_note) {
		this.drgs_type_note = drgs_type_note;
	}
