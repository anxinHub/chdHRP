...
public interface HtcgSchemeDrgsService {
 
	public String addHtcgSchemeDrgs(Map<String,Object> entityMap)throws DataAccessException;
				   
	public String addBatchHtcgSchemeDrgs(List<Map<String,Object>> list)throws DataAccessException;
	...
	public String deleteBatchHtcgSchemeDrgs(List<Map<String,Object>> list)throws DataAccessException;
