...
package com.chd.hrp.mat.service.requrie.store;
import java.util.*;
...
public interface MatStoreRequirePlanService extends SqlService{
	/**
	 * 仓库需求计划编制--查询
	 * @param entityMap
	 * @return
	 ...
	 * @throws DataAccessException
	 */
	public String updateSubmitMatStorePlan(List<Map<String, Object>> entityList) throws DataAccessException;
	/**
	 * 取消提交
	 * @param listVo
	 * @return
	 * @throws DataAccessException
	 */
	public String updateUnSubmitMatStorePlan(List<Map<String, Object>> listVo) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public String abortMatStoreRequriedPlan(List<Map<String, Object>> listVo) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public String submitMatStoreRequriedConfirm(List<Map<String, Object>> listVo) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public String unSubmitMatStoreRequriedConfirm(List<Map<String, Object>> listVo) throws DataAccessException;
	/**
	 * 组装汇总数据
	 * @param mapVo
	 * @return
	 ...
	 * @throws DataAccessException
	 */
	public String copyMatStorePlan(List<Map<String, Object>> listVo) throws DataAccessException;
	
	
	Map<String, Object> printMatStoreRequireMainData(Map<String, Object> map) throws DataAccessException;
