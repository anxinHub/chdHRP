...
public interface MatDuraCheckStoreService{
	...
	*/
	 ...
	 * @throws DataAccessException
	 */
	public String queryMatInvByBalance(Map<String, Object> mapVo) throws DataAccessException;
	/**
	 * 选择材料
	 * @param mapVo
	 * @return
	 * @throws DataAccessException
	 */
	public String queryMatDuraInvChoiceByStore(Map<String, Object> mapVo) throws DataAccessException;
}
