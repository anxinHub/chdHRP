...
public class MatInv implements Serializable {
	...
	private Integer source_plan;
	
	private Integer is_inv_bar;
	
	private String is_inv_bar_no;
	
	public String getIs_inv_bar_no() {
		return is_inv_bar_no;
	}

	public void setIs_inv_bar_no( String is_inv_bar_no) {
		this.is_inv_bar_no = is_inv_bar_no;
	}
	...
	*/
	...
	/**
	 * @return the source_plan
	 */
	public Integer getSource_plan() {
		return source_plan;
	}

	/**
	 * @param source_plan the source_plan to set
	 */
	public void setSource_plan(Integer source_plan) {
