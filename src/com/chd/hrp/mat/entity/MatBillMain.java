...
public class MatBillMain implements Serializable {
...
/**
	...
	*/
	...
	public String getBill_state_name() {
		return bill_state_name;
	}

	public void setBill_state_name(String bill_state_name) {
		this.bill_state_name = bill_state_name;
	}
}