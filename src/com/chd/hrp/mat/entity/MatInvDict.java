...
public class MatInvDict implements Serializable {
...
/**
	...
	* @param value 
	*/
	public void setMat_type_no(Long value) {
		this.mat_type_no = value;
	}
	...
	* @param value 
	*/
	public void setInv_attr_code(Integer value) {
		this.inv_attr_code = value;
	}
	...
	* @return Integer
	*/
	public Integer getInv_attr_code() {
		return this.inv_attr_code;
	}
	/**
	* 设置 摊销方式
	* @param value 
