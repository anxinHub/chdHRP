...
@Service("matAffiOutCommonService")
public class MatAffiOutCommonServiceImpl implements MatAffiOutCommonService{
	private static Logger logger = Logger.getLogger(MatAffiOutCommonServiceImpl.class);
	//引入dao
...
//		}
		...
		if (sysPage.getTotal()==-1){
			List<?> list = matAffiOutCommonMapper.query(entityMap);
			
			return ChdJson.toJson(list);
		}else{
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<?> list = matAffiOutCommonMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		try{
			...
			//取出主表ID（自增序列）
			entityMap.put("out_id", matAffiOutMapper.queryMatAffiOutMainSeq());
			//自动生成代销代销出库单据号
			...
			if(entityMap.get("detailData") != null && !"".equals(entityMap.get("detailData"))){
							...
							if(validateJSON(String.valueOf(jsonObj.get("sum_amount"))) && validateJSON(String.valueOf(jsonObj.get("amount")))&& validateJSON(String.valueOf(jsonObj.get("inv_detail_data"))) && String.valueOf(jsonObj.get("sum_amount")
								...
								for(Map<String, Object> m : JsonListMapUtil.getListMap(jsonObj.get("inv_detail_data").toString())){
									...
									if(m.get("inv_id") != null && !"".equals(String.valueOf(m.get("inv_id")))){
										...
										detailNewMap.put("detail_id", matAffiOutMapper.queryMatAffiOutDetailSeq());
				...
				//新增入库主表数据
				matAffiOutMapper.addMatAffiOutMain(entityMap);
				//新增入库明细数据
				ChdJson.toJson(detailList);
				matAffiOutMapper.addMatAffiOutDetail(detailList);
	...
	*/
	...
	public String queryByCodeDetail(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<?> list = matAffiOutMapper.queryByCodeDetail(entityMap);
		return ChdJson.toJson(list);
	...
	*/
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		try {
						...
						for(Map<String, Object> m : JsonListMapUtil.getListMap(jsonObj.get("inv_detail_data").toString())){
							...
							if(m.get("inv_id") != null && !"".equals(String.valueOf(m.get("inv_id")))){
								...
								if (validateJSON(String.valueOf(m.get("detail_id")))) {
									...
									detailMap.put("detail_id", matAffiOutMapper.queryMatAffiOutDetailSeq());
								}
			...
			matAffiOutMapper.updateMatAffiOutMain(entityMap);// 保存主表
			matAffiOutMapper.deleteMatAffiOutDetail(entityMap);//删除明细
			matAffiOutMapper.addMatAffiOutDetail(out_detail_batch);// 保存明细表
	...
	*/
	...
	public String queryMatAffiOutMatchDetail(Map<String, Object> entityMap) throws DataAccessException {
		...
		return ChdJson.toJson(matAffiOutCommonMapper.queryMatAffiOutMatchDetail(entityMap));
	...
	*/
	...
	public String queryAffiInMain(Map<String, Object> entityMap) throws DataAccessException {
		...
		sysPage = (SysPage) entityMap.get("sysPage");
		if (sysPage.getTotal() == -1) {
			List<Map<String, Object>> list = (List<Map<String, Object>>) matAffiOutCommonMapper.queryAffiInMain(entityMap);
			return ChdJson.toJsonLower(list);
		} else {
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<Map<String, Object>> list = (List<Map<String, Object>>) matAffiOutCommonMapper.queryAffiInMain(entityMap, rowBounds);
			PageInfo page = new PageInfo(list);
	...
	*/
	...
	public String queryAffiInInv(Map<String, Object> entityMap) throws DataAccessException {
		...
		sysPage = (SysPage) entityMap.get("sysPage");
		if (sysPage.getTotal() == -1) {
			List<Map<String, Object>> list = (List<Map<String, Object>>) matAffiOutCommonMapper.queryAffiInInv(entityMap);
			return ChdJson.toJsonLower(list);
		} else {
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<Map<String, Object>> list = (List<Map<String, Object>>) matAffiOutCommonMapper.queryAffiInInv(entityMap, rowBounds);
			PageInfo page = new PageInfo(list);
			return ChdJson.toJsonLower(list, page.getTotal());
	...
	*/
	...
	try {
		...
		return ChdJson.toJson(matAffiOutCommonMapper.queryAffiInWholeDetail(entityMap));
		}catch (Exception e) {
			logger.error(e.getMessage(), e);
			
			return "{\"error\":\"整单出库失败  数据库异常 请联系管理员! 方法 queryAffiInWholeDetail\"}";
		}
		/*List<Map<String, Object>> list = (List<Map<String, Object>>)matAffiOutCommonMapper.queryAffiInWholeDetail(entityMap);
		return ChdJson.toJsonLower(list);*/
	}
	...
	*/
	...
	public String auditMatAffiOutCommon(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {	
			...
			matAffiOutCommonMapper.auditMatAffiOutCommon(entityList);
	...
	*/
	...
	public String unAuditMatAffiOutCommon(List<Map<String, Object>> entityList) throws DataAccessException {
		try {	
			...
			matAffiOutCommonMapper.unAuditMatAffiOutCommon(entityList);
	...
	*/
	...
	public String deleteMatAffiOutCommon(List<Map<String, Object>> entityList) throws DataAccessException {
		try {	
			...
			int flag = matAffiOutMapper.queryNotByUserId(mapVo);
			if(flag > 0 ){
			...
			//	matAffiOutMapper.deleteBatchMatAffiTranRela(mapVo);
			
			//5、删除明细表
				matAffiOutMapper.deleteBatchMatAffiOutDetail(entityList);
			//6、删除主表
				matAffiOutMapper.deleteBatchMatAffiOutMain(entityList);
	...
	*/
	...
	public String queryMatAffiOutByInvHold(Map<String, Object> entityMap) throws DataAccessException {
		...
		sysPage = (SysPage) entityMap.get("sysPage");
		if (sysPage.getTotal() == -1) {
			List<Map<String, Object>> list = (List<Map<String, Object>>) matAffiOutCommonMapper.queryMatAffiOutByInvHold(entityMap);
			return ChdJson.toJsonLower(list);
		} else {
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<Map<String, Object>> list = (List<Map<String, Object>>) matAffiOutCommonMapper.queryMatAffiOutByInvHold(entityMap, rowBounds);
			PageInfo page = new PageInfo(list);
			return ChdJson.toJsonLower(list, page.getTotal());
		}		
	}
	...
	public String queryMatAffiOutByFifoBalance(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {	
			...
			if (flag!=null && "fifo".equals(flag)) {//没有选择明细数据 走先进先出
				List<Map<String, Object>> list = (List<Map<String, Object>>) matAffiOutCommonMapper.queryMatAffiOutByFifoBalance(entityMap);	
				if (list.size() > 0) {
				...
				try {
					while (detail_it.hasNext()) {					
						...
						List<Map<String, Object>> list = (List<Map<String, Object>>) matAffiOutCommonMapper.queryMatAffiOutByFifoBalance(mapDetailVo);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) matAffiOutCommonMapper.queryMatAffiOutByFifoBalance(entityMap,rowBounds);
	...
	public String copyMatAffiOutCommon(List<Map<String,Object>> entityList)throws DataAccessException{
		try {
			...
			for(Map<String, Object> tmp : entityList){				
				Map<String, Object> mom = (Map<String, Object>) matAffiOutMapper.queryByCode(tmp);
				...
				mainMap.put("out_id",matAffiOutMapper.queryMatAffiOutMainSeq());
				mainMap.put("state", "1");
				...
				//查询明细表
				List<Map<String, Object>> list_detail = (List<Map<String, Object>>)matAffiOutMapper.queryByCodeDetail(tmp);
			...
			matAffiOutMapper.addMatAffiOutMainBatch(mainList);
			matAffiOutMapper.addMatAffiOutDetail(detailList);
	...
	public String offsetMatAffiOutCommon(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			for(Map<String, Object> tmp : entityList){				
				Map<String, Object> mom = (Map<String, Object>) matAffiOutMapper.queryByCode(tmp);				
				Map<String, Object> mainMap = defaultBeanToMap(mom);				
				Long out_id = matAffiOutMapper.queryMatAffiOutMainSeq();// 查询序列				
	...
	public String confirmMatAffiOutCommon(List<Map<String, Object>> entityList) throws DataAccessException {
		try{
		    ...
		    */  
			...
			//修改状态为出库确认
			matAffiOutMapper.updateBatchConfirm(listMainUpdate);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return matAffiOutMapper.queryByCode(entityMap);
	}
	...
	public Map<String, Object> queryAffiOutIds(Map<String, Object> entityMap) throws DataAccessException {
		...
		String out_idUp = matAffiOutCommonMapper.queryAffiUpOutId(entityMap);//上一张ID
		if(out_idUp == null){
		...
		String out_idNext = matAffiOutCommonMapper.queryAffiNextOutId(entityMap); //下一张ID
		if(out_idNext == null){
	...
	public String queryAffiOutDetailById(Map<String, Object> entityMap) throws DataAccessException {
		...
		sysPage = (SysPage) entityMap.get("sysPage");
		if (sysPage.getTotal() == -1) {
			List<Map<String, Object>> list = (List<Map<String, Object>>) matAffiOutMapper.queryAffiOutDetailById(entityMap);
			return ChdJson.toJsonLower(list);
		} else {
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<Map<String, Object>> list = (List<Map<String, Object>>) matAffiOutMapper.queryAffiOutDetailById(entityMap, rowBounds);
			PageInfo page = new PageInfo(list);
			return ChdJson.toJsonLower(list, page.getTotal());
		}
	}
	...
	@Override
	public String queryAffiOutDetailByCode(Map<String, Object> entityMap) throws DataAccessException {
		List<Map<String, Object>> list = (List<Map<String, Object>>) matAffiOutMapper.queryAffiOutDetailByCode(entityMap);
	...
	//出库模板打印（包含主从表）
		...
		@Override
		public String matAffiOutCommonService(Map<String, Object> entityMap)
				throws DataAccessException {
			try {
				//查询入库主表
				if("1".equals(String.valueOf(entityMap.get("p_num")))){ 
					List<Map<String, Object>> map =matAffiOutCommonMapper.queryMatAffiOutPrintTemlateByMainBatch(entityMap);
					List<Map<String,Object>> list=matAffiOutCommonMapper.queryMatAffiOutPrintTemlateByDetail(entityMap);
					return superPrintService.getBatchListByPrintTemplateJson(entityMap,map,list);
				}else{
					//查询出库主表
					Map<String,Object> map=matAffiOutCommonMapper.queryMatAffiOutPrintTemlateByMain(entityMap);
		...
		public String queryMatAffiInvBatchList(Map<String, Object> entityMap) throws DataAccessException {
			...
			if (sysPage.getTotal() == -1) {
				...
				List<Map<String, Object>> list = JsonListMapUtil.toListMapLower(matAffiOutCommonMapper.queryMatAffiInvBatchList(entityMap));
				
				return ChdJson.toJson(list);
			} else {
				
				RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
				List<Map<String, Object>> list = JsonListMapUtil.toListMapLower(matAffiOutCommonMapper.queryMatAffiInvBatchList(entityMap, rowBounds));
				PageInfo page = new PageInfo(list);
		...
		public String queryDetails(Map<String,Object> entityMap) throws DataAccessException{
			...
			if (sysPage.getTotal()==-1){
				List<Map<String,Object>> list = matAffiOutCommonMapper.queryDetails(entityMap);			
				return ChdJson.toJsonLower(list);
			}else{
				RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
				List<Map<String,Object>> list = matAffiOutCommonMapper.queryDetails(entityMap, rowBounds);
				PageInfo page = new PageInfo(list);			
				return ChdJson.toJsonLower(list, page.getTotal());
			}
		}
		...
		public Map<String, Object> matAffiOutCommonTemplate(Map<String, Object> entityMap)
			...
			try {
				...
				MatAffiOutCommonMapper matAffiOutCommonMapper = (MatAffiOutCommonMapper)context.getBean("matAffiOutCommonMapper");
		...
		public void updateMatAffiOutRela(Map<String, Object> entityMap) throws DataAccessException {
			List<Map<String,Object>> relaList= JsonListMapUtil.toListMapLower(matAffiOutCommonMapper.queryMatAffiOutRela(entityMap));
			if(relaList.size()>0){
				matAffiOutCommonMapper.deleteMatAffiOutRela(relaList);
			}
		 ...
		 */
		@Override
		public int queryMatAffiOutIsApply(Map<String, Object> entityMap) throws DataAccessException {
			Integer  is_apply = matAffiOutCommonMapper.queryMatOutMainIsApply(entityMap);
			return is_apply;
		}
}
