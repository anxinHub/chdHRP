...
package com.chd.hrp.mat.serviceImpl.affi.check;
...
import com.chd.hrp.mat.dao.affi.check.MatAffiCheckDetailMapper;
import com.chd.hrp.mat.dao.affi.check.MatAffiCheckMainMapper;
import com.chd.hrp.mat.dao.affi.check.MatAffiCheckRelaMapper;
...
@Service("matAffiCheckMainService")
public class MatAffiCheckMainServiceImpl implements  MatAffiCheckMainService{

	private static Logger logger = Logger.getLogger(MatAffiCheckMainServiceImpl.class);
	//引入DAO操作
	@Resource(name = "matAffiCheckMainMapper")
	private final MatAffiCheckMainMapper matAffiCheckMainMapper = null;
	
	@Resource(name = "matAffiCheckDetailMapper")
	private final MatAffiCheckDetailMapper matAffiCheckDetailMapper = null;
	...
	@Resource(name = "matAffiCheckRelaMapper")
	private final MatAffiCheckRelaMapper matAffiCheckRelaMapper = null;
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {			
			...
			Long check_id = matAffiCheckMainMapper.queryMatAffiCheckMainSeq();// 查询序列
			...
			while (check_detail_it.hasNext()) {
				...
				if(jsonObj.get("inv_id") != null && !"".equals(String.valueOf(jsonObj.get("inv_id")))){
					mapDetailVo.put("detail_id", matAffiCheckDetailMapper.queryMatAffiCheckDetailSeq());
			...
			if(check_detail_batch.size() > 0){
				...
				matAffiCheckMainMapper.add(entityMap);		
				matAffiCheckDetailMapper.addBatch(check_detail_batch);
			}else{
	 ...
	 */
		public String getNextIn_no(Map<String, Object> entityMap) {
			...
			map.put("table_code", "MAT_AFFI_CHECK_MAIN");
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{	
		try {		
			matAffiCheckMainMapper.addBatch(entityList);			
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{		
		try {		
			...
			if(check_detail_batch.size() > 0){
				...
				matAffiCheckMainMapper.update(entityMap);			
				matAffiCheckDetailMapper.delete(entityMap);			
				matAffiCheckDetailMapper.addBatch(check_detail_batch);			
			}else{
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{	
		try {			
			matAffiCheckMainMapper.updateBatch(entityList);			
	...
	*/
    ...
    try {		
			int state = matAffiCheckMainMapper.delete(entityMap);				
		}catch (Exception e) {
			logger.error(e.getMessage(), e);
			throw new SysException("{\"error\":\"更新失败\"}");
		}
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{		
		try {			
			matAffiCheckDetailMapper.deleteBatch(entityList);			
			matAffiCheckMainMapper.deleteBatch(entityList);			
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<MatAffiCheckMain> list = (List<MatAffiCheckMain>)matAffiCheckMainMapper.queryExists(mapVo);		
		if (list.size()>0) {
			int state = matAffiCheckMainMapper.update(entityMap);			
			return "{\"msg\":\"更新成功.\",\"state\":\"true\"}";
		}
		
		try {			
			int state = matAffiCheckMainMapper.add(entityMap);			
			return "{\"msg\":\"添加成功.\",\"state\":\"true\"}";
		}catch (Exception e) {
			logger.error(e.getMessage(), e);
			throw new SysException("{\"error\":\"更新失败\"}");
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{		
		...
		if (sysPage.getTotal()==-1){			
			List<MatAffiCheckMain> list = (List<MatAffiCheckMain>)matAffiCheckMainMapper.query(entityMap);			
			return ChdJson.toJson(list);			
		}else{			
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());			
			List<MatAffiCheckMain> list = (List<MatAffiCheckMain>)matAffiCheckMainMapper.query(entityMap, rowBounds);			
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return matAffiCheckMainMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return MatAffiCheckMain
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return matAffiCheckMainMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<MatAffiCheckMain>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return matAffiCheckMainMapper.queryExists(entityMap);
	}
	/**
	 * 获取主表信息
	 */
	...
	public String queryMatAffiCheckMain(Map<String, Object> entityMap) throws DataAccessException {		
		...
		sysPage = (SysPage) entityMap.get("sysPage");		
		if (sysPage.getTotal()==-1){
			List<Map<String,Object>> list = (List<Map<String,Object>>)matAffiCheckMainMapper.queryMatAffiCheckMain(entityMap);			
			return ChdJson.toJsonLower(list);			
		}else{			
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());			
			List<Map<String,Object>> list = (List<Map<String,Object>>)matAffiCheckMainMapper.queryMatAffiCheckMain(entityMap, rowBounds);			
			PageInfo page = new PageInfo(list);			
	...
	public String auditMatAffiCheckMain(List<Map<String, Object>> entityMap) throws DataAccessException {
		...
		try {
			...
			matAffiCheckMainMapper.updateAuditBatch(mainList);		
			
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
			throw new SysException("{\"error\":\"操作失败\"}");
			//return "{\"error\":\"审核失败 数据库异常 请联系管理员! 方法 auditMatAffiCheckMain\"}";
		}
	...
	public String unAuditMatAffiCheckMain(List<Map<String, Object>> entityMap) throws DataAccessException {
		...
		try {
			...
			logger.error(e.getMessage(), e);
			throw new SysException("{\"error\":\"操作失败\"}");
			//return "{\"error\":\"消审失败 数据库异常 请联系管理员! 方法 unAuditMatAffiCheckMain\"}";
		}
	...
	public String createInOut(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			for(Map<String, Object> entityMap : entityList){
				//获取选中的主表数据
				Map<String, Object> mainMap = toMapLower(matAffiCheckMainMapper.queryMatAffiCheckMainForInOut(entityMap));
				//获取明细盘盈数据
				List<Map<String, Object>> inCheckList = toListMapLower(matAffiCheckDetailMapper.queryMatAffiCheckDetailProfitForInOut(entityMap));
				//获取明细盘亏数据
				List<Map<String, Object>> outCheckList = toListMapLower(matAffiCheckDetailMapper.queryMatAffiCheckDetailLossForInOut(entityMap));
				...
				if(outCheckList.size() > 0){
					...
					//单据ID
					outMap.put("out_id", matAffiOutMapper.queryMatAffiOutMainSeq());
					...
					for(Map<String, Object> map : outCheckList){
						...
						//按先进先出匹配批次信息
						List<Map<String, Object>> fifoList = toListMapLower((List<Map<String, Object>>) matCommonMapper.queryMatAffiOutDetailInvList(map));
						...
						for(Map<String, Object> fifomap : fifoList){
							...
							invMap.putAll(map);
							invMap.put("detail_id", matAffiOutMapper.queryMatAffiOutDetailSeq());
				...
				if(inCheckList.size() > 0){
					...
					for(Map<String, Object> map : inCheckList){
						...
						map.put("detail_id", matAffiInMapper.queryAffiInDetailSeq());
						map.put("sale_price", "0");
						map.put("sell_price", "0");
						map.put("allot_price", "0");
						...
						if(invBatchSnMap.get(batchKey) == null){
							/*自动生成批次-------begin--------*/
							//查询该批号最大批次
							batchSnMap.put("c_value", invMap.get("inv_id").toString());//材料ID
							batchSnMap.put("c_value1", invMap.get("batch_no").toString());//材料批号
			...
			//保存盘点单与出入库单对应关系
			matAffiCheckRelaMapper.addBatch(relaList);
			//修改盘点单状态为3:已生成
			matAffiCheckMainMapper.updateStateBatch(entityList);
	...
	public String queryMatAffiCheckMainByMatInv(Map<String, Object> entityMap) throws DataAccessException {
		List<Map<String,Object>> list = (List<Map<String,Object>>)matAffiCheckMainMapper.queryMatAffiCheckMainByMatInv(entityMap);			
		return ChdJson.toJsonLower(list);	
		/*
		SysPage sysPage = new SysPage();		
		sysPage = (SysPage) entityMap.get("sysPage");		
		if (sysPage.getTotal()==-1){			
			...
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());			
			List<Map<String,Object>> list = (List<Map<String,Object>>)matAffiCheckMainMapper.queryMatAffiCheckMainByMatInv(entityMap, rowBounds);			
			PageInfo page = new PageInfo(list);			
			return ChdJson.toJsonLower(list, page.getTotal());			
		}*/
	}
	...
	public MatAffiCheckMain queryMatAffiCheckMainByCode(Map<String, Object> entityMap) throws DataAccessException {
		return matAffiCheckMainMapper.queryMatAffiCheckMainByCode(entityMap);
	}

	@Override
	public String queryMatAffiCheckDetailByCheckID(Map<String, Object> entityMap) throws DataAccessException {
			
		List<Map<String,Object>> list = (List<Map<String,Object>>)matAffiCheckDetailMapper.queryMatAffiCheckDetailByCheckID(entityMap);
	...
	@Override
	public Map<String,Object> queryMatAffiCheckByPrintTemlate(Map<String, Object> entityMap)throws DataAccessException {
		
		try{
			Map<String,Object> reMap=new HashMap<String,Object>();
			WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
			MatAffiCheckMainMapper matAffiCheckMainMapper = (MatAffiCheckMainMapper)context.getBean("matAffiCheckMainMapper");
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				List<Map<String,Object>> map=matAffiCheckMainMapper.queryAffiCheckPrintTemlateByMainBatch(entityMap);
				List<Map<String,Object>> list = matAffiCheckMainMapper.queryAffiCheckPrintTemlateByDetail(entityMap);
				reMap.put("main", map);
				reMap.put("detail", list);
			}else{
				//查询盘点点主表
				Map<String,Object> map = matAffiCheckMainMapper.queryAffiCheckPrintTemlateByMain(entityMap);
	 ...
	 */
	@Override
	public String queryMatAffiStoreInvDetail(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<Map<String, Object>> list= matAffiCheckMainMapper.queryMatAffiStoreInvDetail(detailList);
		return ChdJson.toJsonLower(list);
