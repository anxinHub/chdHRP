...
@Service("matInvCertRelaService")
public class MatInvCertRelaServiceImpl implements MatInvCertRelaService {

	private static Logger logger = Logger.getLogger(MatInvCertRelaServiceImpl.class);
	//引入DAO操作
...
<BR> 
	...
	*/
	@Override
	public String addBatchMatInvCertRela(List<Map<String,Object>> entityList)throws DataAccessException{
		
		try {
			
			matInvCertRelaMapper.addBatchMatInvCertRela(entityList);
	...
	*/
	...
	public String updateMatInvCertRela(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = matInvCertRelaMapper.updateMatInvCertRela(entityMap);
			...
			return "{\"error\":\"更新失败 数据库异常 请联系管理员! 方法 updateMatInvCertRela\"}";
...
<BR> 
	...
	*/
	@Override
	public String updateBatchMatInvCertRela(List<Map<String,Object>> entityList)throws DataAccessException{
		
		try {
			
		  matInvCertRelaMapper.updateBatchMatInvCertRela(entityList);
			...
			return "{\"error\":\"更新失败 数据库异常 请联系管理员! 方法 updateBatchMatInvCertRela\"}";
...
<BR> 
	...
	*/
	@Override
	public String deleteBatchMatInvCertRela(List<Map<String,Object>> entityList)throws DataAccessException{
	...
	*/
	...
	public String addOrUpdateMatInvCertRela(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			return "{\"error\":\"添加失败 数据库异常 请联系管理员! 方法 addOrUpdateMatInvCertRela\"}";
