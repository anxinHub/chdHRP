package com.chd.hrp.mat.serviceImpl.info.filetype;
...
import com.chd.hrp.mat.dao.info.filetype.MatFileTypeMapper;
import com.chd.hrp.mat.entity.MatFileType;
import com.chd.hrp.mat.service.info.filetype.MatFileTypeService;
 ...
 * @Version: 1.0
 */
@Service("matFileTypeService")
public class MatFileTypeServiceImpl implements MatFileTypeService {
	
	private static Logger logger = Logger.getLogger(MatFileTypeServiceImpl.class);
	
	@Resource(name = "matFileTypeMapper")
	private MatFileTypeMapper matFileTypeMapper = null;
	...
	*/
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		MatFileType matFileType = matFileTypeMapper.queryByCode(entityMap);//先查询编码是否已经存在
		...
		matFileTypeMapper.add(entityMap);
	...
	*/
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		...
		matFileTypeMapper.update(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String, Object>> entityMap) throws DataAccessException {
		...
		map.put("dict_code", "MAT_FILE_TYPE");
		...
		//批量删除
		int state = matFileTypeMapper.deleteBatch(entityMap);
	...
	*/
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if(sysPage.getTotal() == -1){
			...
			List<?> list = matFileTypeMapper.query(entityMap);
			...
			List<?> list = matFileTypeMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		...
		return matFileTypeMapper.queryByCode(entityMap);
	}
