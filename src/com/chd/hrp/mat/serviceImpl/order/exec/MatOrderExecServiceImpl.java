package com.chd.hrp.mat.serviceImpl.order.exec;
...
import com.chd.hrp.mat.dao.order.exec.MatOrderExecMapper;
import com.chd.hrp.mat.service.base.MatCommonService;
import com.chd.hrp.mat.service.order.exec.MatOrderExecService;
import com.github.pagehelper.PageInfo;

@Service("matOrderExecService")
public class MatOrderExecServiceImpl implements MatOrderExecService {
	private static Logger logger = Logger.getLogger(MatOrderExecServiceImpl.class);
	
	//引入dao
	@Resource(name = "matOrderExecMapper")
	private final MatOrderExecMapper matOrderExecMapper = null;
	...
	*/
	...
	public String queryMatOrderExec(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal()==-1){
			List<?> list = matOrderExecMapper.queryMatOrderExec(entityMap);
			
			return ChdJson.toJson(list);
		}else{
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<?> list = matOrderExecMapper.queryMatOrderExec(entityMap, rowBounds);
