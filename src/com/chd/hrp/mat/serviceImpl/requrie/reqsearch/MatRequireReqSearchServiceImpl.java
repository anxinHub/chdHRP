...
package com.chd.hrp.mat.serviceImpl.requrie.reqsearch;
...
import com.chd.hrp.mat.dao.requrie.reqsearch.MatRequireReqSearchMapper;
...
@Service("matRequireReqSearchService")
public class MatRequireReqSearchServiceImpl implements MatRequireReqSearchService {

	private static Logger logger = Logger.getLogger(MatRequireReqSearchServiceImpl.class);

	@Resource(name = "matRequireReqSearchMapper")
	private final MatRequireReqSearchMapper matRequireReqSearchMapper = null;
	...
	public String queryMatDeptStatQToDept(Map<String, Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			List<Map<String, Object>> list = matRequireReqSearchMapper.queryMatDeptStatQToDept(entityMap);
			
			return ChdJson.toJson(list);
		}else{
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<Map<String, Object>> list = matRequireReqSearchMapper.queryMatDeptStatQToDept(entityMap, rowBounds);
