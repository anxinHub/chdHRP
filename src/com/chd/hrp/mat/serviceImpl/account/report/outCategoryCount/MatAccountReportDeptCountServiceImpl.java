...
@Service("matAccountReportDeptCountService")
public class MatAccountReportDeptCountServiceImpl implements MatAccountReportDeptCountService {
	private static Logger logger = Logger.getLogger(MatAccountReportDeptCountServiceImpl.class);
	
	@Resource(name = "matAccountReportDeptCountMapper")
	private final MatAccountReportDeptCountMapper matAccountReportDeptCountMapper = null;
	...
	public String queryMatAccountReportDeptCount(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<Map<String, Object>> list = matAccountReportDeptCountMapper.queryMatAccountReportDeptCount(entityMap);
	...
	public String queryMatTransferCount(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<Map<String, Object>> list = JsonListMapUtil.toListMapLower(matAccountReportDeptCountMapper.queryMatTransferCount(entityMap));
	...
	@Override
	public List<Map<String, Object>> queryMatTransferCountprint(Map<String, Object> entityMap)
