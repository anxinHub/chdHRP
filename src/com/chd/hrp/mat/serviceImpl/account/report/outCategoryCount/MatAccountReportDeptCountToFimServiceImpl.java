...
@Service("matAccountReportDeptCountToFimService")
public class MatAccountReportDeptCountToFimServiceImpl implements MatAccountReportDeptCountToFimService {
	private static Logger logger = Logger.getLogger(MatAccountReportDeptCountToFimServiceImpl.class);
	
	@Resource(name = "matAccountReportDeptCountToFimMapper")
	private final MatAccountReportDeptCountToFimMapper matAccountReportDeptCountToFimMapper = null;
	
	@Override
	public String queryMatAccountReportDeptCount(Map<String, Object> entityMap) throws DataAccessException {
				
		
				List<Map<String, Object>> list = matAccountReportDeptCountToFimMapper.queryMatAccountReportDeptCount(entityMap);
	...
	@Override
	public List<Map<String, Object>> queryMatAccountReportDeptCountPrint(Map<String, Object> entityMap)
