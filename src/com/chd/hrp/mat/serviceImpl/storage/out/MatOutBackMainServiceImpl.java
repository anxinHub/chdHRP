...
import com.chd.hrp.mat.dao.storage.out.MatOutBackDetailMapper;
import com.chd.hrp.mat.dao.storage.out.MatOutBackMainMapper; 
...
@Service("matOutBackMainService")
public class MatOutBackMainServiceImpl implements MatOutBackMainService {

	private static Logger logger = Logger.getLogger(MatOutBackMainServiceImpl.class);
	// 引入DAO操作
	@Resource(name = "matOutBackMainMapper")
	private final MatOutBackMainMapper matOutBackMainMapper = null;

	// 引入DAO操作
	@Resource(name = "matOutBackDetailMapper")
	private final MatOutBackDetailMapper matOutBackDetailMapper = null;
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			// 查询序列
			Long out_id = matOutBackMainMapper.queryMatOutBackMainSeq();
					...
					if(validateJSON(String.valueOf(jsonObj.get("sum_amount"))) && validateJSON(String.valueOf(jsonObj.get("amount"))) && validateJSON(String.valueOf(jsonObj.get("inv_detail_data"))) && String.valueOf(jsonObj.get("sum_amount")).equals(String.valueOf(jsonObj.get("amount")))){
						...
						for(Map<String, Object> m : JsonListMapUtil.getListMap(jsonObj.get("inv_detail_data").toString())){
							...
							if(m.get("inv_id") != null && !"".equals(String.valueOf(m.get("inv_id")))){
								...
								detailMap.put("out_detail_id", matOutBackDetailMapper.queryMatOutBackDetailSeq());
			...
			matOutBackMainMapper.add(entityMap);// 保存主表

			matOutBackDetailMapper.addBatch(out_detail_batch);// 保存明细表
	...
	public String addBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			matOutBackMainMapper.addBatch(entityList);
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
		...
		try {
			...
			while (out_detail_it.hasNext()) {
				...
				if (validateJSON(String.valueOf(jsonObj.get("inv_id")))) {
					...
					if (validateJSON(String.valueOf(jsonObj.get("sale_price")))) {mapDetailVo.put("sale_price", jsonObj.get("sale_price").toString());}
					if (validateJSON(String.valueOf(jsonObj.get("sell_price")))) {mapDetailVo.put("sell_price", jsonObj.get("sell_price").toString());}
					if (validateJSON(String.valueOf(jsonObj.get("inva_date")))) {mapDetailVo.put("inva_date", DateUtil.stringToDate(jsonObj.get("inva_date").toString(), "yyyy-MM-dd"));}
					if (validateJSON(String.valueOf(jsonObj.get("disinfect_date")))) {mapDetailVo.put("disinfect_date", DateUtil.stringToDate(jsonObj.get("disinfect_date").toString(), "yyyy-MM-dd"));}
					if (validateJSON(String.valueOf(jsonObj.get("location_id")))) {
						mapDetailVo.put("location_id", jsonObj.get("location_id").toString());
					}else{
						mapDetailVo.put("location_id", "0");//货位
						...
						for(Map<String, Object> m : JsonListMapUtil.getListMap(jsonObj.get("inv_detail_data").toString())){
							...
							if(m.get("inv_id") != null && !"".equals(String.valueOf(m.get("inv_id")))){
								...
								if (validateJSON(String.valueOf(m.get("out_detail_id")))) {
									detailMap.put("out_detail_id", m.get("out_detail_id").toString());
								}else{
									detailMap.put("out_detail_id", String.valueOf(matOutBackDetailMapper.queryMatOutBackDetailSeq()));
								}
								if (validateJSON(String.valueOf(m.get("batch_sn")))) {detailMap.put("batch_sn", m.get("batch_sn").toString());}
								if (validateJSON(String.valueOf(m.get("amount")))) {detailMap.put("amount", m.get("amount").toString());}
								if (validateJSON(String.valueOf(m.get("amount_money")))) {
			...
			//明细总金额
			entityMap.put("amount_money", money_sum);
			matOutBackMainMapper.update(entityMap);// 保存主表
			
			matOutBackDetailMapper.delete(entityMap);
	...
	public String updateBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			matOutBackMainMapper.updateBatch(entityList);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			int state = matOutBackMainMapper.delete(entityMap);
		} catch (Exception e) {
	...
	public String copyMatOutBackMain(List<Map<String, Object>> entityMap) throws DataAccessException {
		...
		try {
			...
			for(Map<String, Object> tmp:entityMap){
				...
				MatOutMain mom = (MatOutMain) matOutBackMainMapper.queryByCode(tmp);
				...
				Long out_id = matOutBackMainMapper.queryMatOutBackMainSeq();// 查询序列
				...
				double money_sum = 0;//记录明细总金额
				//查询明细表
				List<Map<String, Object>> list_detail = JsonListMapUtil.toListMapLower(matOutBackDetailMapper.queryBackDetailForCopy(tmp));
			...
			matOutBackMainMapper.addBatch(mainList);
			matOutBackDetailMapper.addBatch(detailList);
	...
	public String deleteBatch(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			//删除明细
			matOutBackDetailMapper.deleteBatch(entityList);
			//删除主表
			matOutBackMainMapper.deleteBatch(entityList);
	...
	public String addOrUpdate(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (matOutMain != null) {
			...
			int state = matOutBackMainMapper.update(entityMap);
		...
		try {
			...
			int state = matOutBackMainMapper.add(entityMap);
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<MatOutMain> list = (List<MatOutMain>) matOutBackMainMapper.query(entityMap);
			...
			List<MatOutMain> list = (List<MatOutMain>) matOutBackMainMapper.query(entityMap, rowBounds);
	...
	public String queryMatOutBackMain(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryMatOutBackMain(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryMatOutBackMain(entityMap, rowBounds);
	...
	public String queryMatInMainByIsDir(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryMatInMainByIsDir(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryMatInMainByIsDir(entityMap, rowBounds);
	...
	public String queryMatInDetailByIsDir(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryMatInDetailByIsDir(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryMatInDetailByIsDir(entityMap, rowBounds);
	...
	public <T> T queryByCode(Map<String, Object> entityMap) throws DataAccessException {
		return matOutBackMainMapper.queryByCode(entityMap);
	}
	...
	public <T> T queryByUniqueness(Map<String, Object> entityMap) throws DataAccessException {
		...
		return matOutBackMainMapper.queryByUniqueness(entityMap);
	...
	public String queryMatOutMainByInvHold(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryMatOutMainByInvHold(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryMatOutMainByInvHold(entityMap, rowBounds);
	...
	public String queryMatOutMainByFifoBalance(Map<String, Object> entityMap) throws DataAccessException {
		...
		if(sysPage.getTotal() == -1){
			...
			if (flag!=null && "fifo".equals(flag)) {//没有选择明细数据 走先进先出
				if(entityMap.get("mainData") != null){
					...
					while (it.hasNext()) {
						...
						if( !"".equals(jsonObj.get("inv_id")) && jsonObj.get("inv_id") != null){
							...
							//获取该材料各批次数据
							List<Map<String, Object>> list = JsonListMapUtil.toListMapLower(matOutBackMainMapper.queryMatOutMainByFifoBalance(mapVo));
							if(list.size()>0){
				...
				List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryMatOutMainByFifoBalance(entityMap);
				return ChdJson.toJsonLower(list);
			}	
		}else{
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryMatOutMainByFifoBalance(entityMap, rowBounds);
			PageInfo page = new PageInfo(list);
			return ChdJson.toJsonLower(list, page.getTotal());
		}
	}
			...
			if (flag!=null && "fifo".equals(flag)) {//没有选择明细数据 走先进先出
				...
				try {
					while (detail_it.hasNext()) {
						...
						//获取该材料各批次数据
						List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryMatOutMainByFifoBalance(mapDetailVo);
						if (list.size() > 0) {
							for (Map<String, Object> map : list) {
								Map<String, Object> viewMap = new HashMap<String, Object>();
								// 首先转换成小写的KEY
	...
	public String queryMatOutDetailByIsDir(Map<String, Object> entityMap) throws DataAccessException {
		try {
			...
			return ChdJson.toJsonLower(matOutBackDetailMapper.queryMatOutDetailByIsDir(entityMap));
		}catch (Exception e) {
			logger.error(e.getMessage(), e);
	...
	public String queryMatOutDetailHistory(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackDetailMapper.queryMatOutDetailByHistory(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackDetailMapper.queryMatOutDetailByHistory(entityMap, rowBounds);
	...
	*/
	...
	public String unAuditMatOutBackMain(List<Map<String, Object>> entityMap) throws DataAccessException {
		...
		try {
			...
			matOutBackMainMapper.updateAuditBatch(mainList);
...
/**	出库确认
	...
	@Override
	public synchronized String confirmOutMatOutBackMain(List<Map<String, Object>> entityList) throws DataAccessException {
		try {
			
			//出库判断 (1)
			//String date = DateUtil.dateToString(new Date(), "yyyy/MM/dd");
			String year = entityList.get(0).get("year").toString();
			String month = entityList.get(0).get("month").toString();
			...
			checkMap.put("day", entityList.get(0).get("confirm_date").toString().substring(8, 10));
			int flag = matCommonMapper.existsMatYearMonthIsAccount(checkMap);
			if(flag != 0){
				return "{\"error\":\"当月已结账不能确认！\",\"state\":\"false\"}";
			}
			//校验出库单状态
			flag = matOutBackMainMapper.existsMatOutBackStateForConfirm(entityList);
			if(flag != 0){
			...
			//获取所选单据中的所有材料
			List<MatOutDetail> detailList = matOutBackDetailMapper.queryMatOutBackDetailForConfirm(entityList);
			//查询帐表所需
			...
			if(start_dura > 0){
				...
				//获取所选单据中的所有材料
				List<Map<String, Object>> duraList = JsonListMapUtil.toListMapLower(matOutBackDetailMapper.queryMatOutBackForDura(entityList));
			...
			//修改状态为出库确认
			matOutBackMainMapper.updateConfirmBatch(entityList);
	...
	public String queryMatDeptMatchByMatchd(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryMatDeptMatchByMatchd(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryMatDeptMatchByMatchd(entityMap, rowBounds);
	...
	public Map<String, Object> queryMatOutBackMainByCode(Map<String, Object> entityMap) throws DataAccessException {
		return JsonListMapUtil.toMapLower((Map<String, Object>) matOutBackMainMapper.queryMatOutBackMainByCode(entityMap));
	}

	@Override
	public String queryMatOutBackDetailByOutId(Map<String, Object> entityMap) throws DataAccessException {

		List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackDetailMapper.queryMatOutBackDetailByOutId(entityMap);
	...
	public String queryMatOutBackDetailByCode(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackDetailMapper.queryMatOutBackDetailByCode(entityMap);
	...
	public String queryMatOutBackMainBeforeOrNext(Map<String,Object> entityMap) throws DataAccessException{
		try {	
			...
			if("before".equals(entityMap.get("type").toString())){
				out_id = matOutBackMainMapper.queryMatOutBackMainPre(entityMap);
				if(out_id == 0){
					return "{\"msg\":\"已经是第一张单据了！\",\"state\":\"false\"}";
				}
			}else if("next".equals(entityMap.get("type").toString())){//下一张
				out_id = matOutBackMainMapper.queryMatOutBackMainNext(entityMap);
				if(out_id == 0){
					return "{\"state\":\"false\"}";
				}
			}else{
	...
	public String queryMatOutByPrintTemlate(Map<String, Object> entityMap)
		...
		if("1".equals(String.valueOf(entityMap.get("p_num")))){
			...
			//查询出库主表批量
			List<Map<String,Object>> map=matOutBackMainMapper.queryMatOutPrintTemlateByMainBatch(entityMap);
			//查询出库明细表
			List<Map<String,Object>> list=matOutBackMainMapper.queryMatOutPrintTemlateByDetail(entityMap);
			return superPrintService.getBatchListByPrintTemplateJson(entityMap,map,list);
		}else{
			//查询出库主表
			Map<String,Object> map=matOutBackMainMapper.queryMatOutPrintTemlateByMain(entityMap);
			//查询出库明细表
			List<Map<String,Object>> list=matOutBackMainMapper.queryMatOutPrintTemlateByDetail(entityMap);
	...
	private final SuperPrintService superPrintService = null;
	@Override
	public Map<String,Object> queryMatOutBackByPrintTemlate(Map<String, Object> entityMap)
			throws DataAccessException {
		// TODO Auto-generated method stub
		
		Map<String,Object> reMap=new HashMap<String,Object>();
		WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
		MatOutBackMainMapper matOutBackMainMapper = (MatOutBackMainMapper)context.getBean("matOutBackMainMapper");

		entityMap.put("hos_name", SessionManager.getHosName());
		
		if("1".equals(String.valueOf(entityMap.get("p_num")))){ 
			//查询出库主表批量
			List<Map<String,Object>> map=matOutBackMainMapper.queryMatOutBackPrintTemlateByMainBatch(entityMap);
			//查询出库明细表
			List<Map<String,Object>> list=matOutBackMainMapper.queryMatOutBackPrintTemlateByDetail(entityMap);
			...
			//查询出库主表
			Map<String,Object> map=matOutBackMainMapper.queryMatOutBackPrintTemlateByMain(entityMap);
			//查询出库明细表
			List<Map<String,Object>> list=matOutBackMainMapper.queryMatOutBackPrintTemlateByDetail(entityMap);
	...
	public String mergeOffsetMatOutMain(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<Map<String, Object>> list= (List<Map<String, Object>>) matOutBackDetailMapper.mergeOffsetMatOutMain(entityMap);
	...
	public String queryMatApplyMainOut(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = JsonListMapUtil.toListMapLower(matOutBackMainMapper.queryMatApplyMainOut(entityMap));
			
			return ChdJson.toJson(list);
		} else {
			
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<Map<String, Object>> list = JsonListMapUtil.toListMapLower(matOutBackMainMapper.queryMatApplyMainOut(entityMap, rowBounds));
			PageInfo page = new PageInfo(list);
	...
	public String queryMatApplyDetailOut(Map<String,Object> entityMap) throws DataAccessException{
		...
		List<Map<String, Object>> list = JsonListMapUtil.toListMapLower(matOutBackMainMapper.queryMatApplyDetailOut(entityMap));
	...
	public Map<String, Object> queryOutMainByAppCollect(Map<String,Object> entityMap) throws DataAccessException{
		...
		List<Map<String, Object>> mainList = JsonListMapUtil.toListMapLower(matOutBackMainMapper.queryOutMainByAppCollect(entityMap));
		if(mainList.size() > 1){
	...
	public String queryOutDetailByAppCollect(Map<String,Object> entityMap) throws DataAccessException{//存放出库单明细信息
		try {
			//明细信息
			List<Map<String, Object>> detailList = toListMapLower((List<Map<String, Object>>) matOutBackMainMapper.queryOutDetailByAppCollect(entityMap));
	...
	public String queryMatInvBatchList(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal() == -1) {
			...
			List<Map<String, Object>> list = JsonListMapUtil.toListMapLower(matOutBackMainMapper.queryMatInvBatchList(entityMap));
			
			return ChdJson.toJson(list);
		} else {
			
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<Map<String, Object>> list = JsonListMapUtil.toListMapLower(matOutBackMainMapper.queryMatInvBatchList(entityMap, rowBounds));
			PageInfo page = new PageInfo(list);
	...
	public String queryOutBackDetails(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryOutBackDetails(entityMap);
			return ChdJson.toJsonLower(list);
		} else {
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<Map<String, Object>> list = (List<Map<String, Object>>) matOutBackMainMapper.queryOutBackDetails(entityMap, rowBounds);
			PageInfo page = new PageInfo(list);
			return ChdJson.toJsonLower(list, page.getTotal());
