...
@Controller
public class MatModController extends BaseController{
	private static Logger logger = Logger.getLogger(MatModController.class);
	...
	// 维护页面跳转
	@RequestMapping(value = "/hrp/mat/matsysset/matModMainPage", method = RequestMethod.GET)
	public String modMainPage(Model mode) throws Exception {

		return "hrp/mat/matsysset/matModMain";

	}

	// 添加页面
	@RequestMapping(value = "/hrp/mat/matsysset/matModAddPage", method = RequestMethod.GET)
	public String modAddPage(Model mode) throws Exception {

		return "hrp/mat/matsysset/matModAdd";

	}

	// 保存
	@RequestMapping(value = "/hrp/mat/matsysset/addMod", method = RequestMethod.POST)
	@ResponseBody
	...
	// 查询
	@RequestMapping(value = "/hrp/mat/matsysset/queryMod", method = RequestMethod.POST)
	@ResponseBody
	...
	//删除
	@RequestMapping(value = "/hrp/mat/matsysset/deleteMod", method = RequestMethod.POST)
	@ResponseBody
	...
	// 修改页面跳转
	@RequestMapping(value = "/hrp/mat/matsysset/matModUpdatePage", method = RequestMethod.GET)
	...
	public String modUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/mat/matsysset/matModUpdate";
	}
		
	// 修改保存
	@RequestMapping(value = "/hrp/mat/matsysset/updateMod", method = RequestMethod.POST)
	@ResponseBody
	...
	// 导入
	@RequestMapping(value = "/hrp/mat/matsysset/importMod", method = RequestMethod.POST)
	@ResponseBody
