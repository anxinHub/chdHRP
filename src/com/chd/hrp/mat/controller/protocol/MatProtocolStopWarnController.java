...
@Controller
public class MatProtocolStopWarnController extends BaseController{
	
	private static Logger logger = Logger.getLogger(MatProtocolStopWarnController.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolstopwarn/matProtocolStopWarnMainPage", method = RequestMethod.GET)
	public String matProtocolMainMainPage(Model mode) throws Exception {

		return "hrp/mat/protocol/matprotocolstopwarn/matProtocolStopWarnMain";

	}

	@RequestMapping(value = "/hrp/mat/protocol/matprotocolstopwarn/matInvDetailPage", method = RequestMethod.GET)
...
/**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolstopwarn/matProtocolStopWarnUpdatePage", method = RequestMethod.GET)
	public String matProtocolMainUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/mat/protocol/matprotocolstopwarn/matProtocolStopWarnUpdate";
	}
	/**
	 * 查看协议文档
	 * @param mapVo
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolstopwarn/matProtocolFilePage", method = RequestMethod.GET)
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolstopwarn/updateMatProtocolStopWarn", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolstopwarn/addOrUpdateMatProtocolStopWarn", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateMatProtocolStopWarn(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolstopwarn/queryMatProtocolStopWarn", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryMatProtocolStopWarn(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
