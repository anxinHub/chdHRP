...
@Controller
public class MatProtocolIntController extends BaseController{
	
	private static Logger logger = Logger.getLogger(MatProtocolIntController.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolint/matProtocolIntMainPage", method = RequestMethod.GET)
	public String matProtocolMainMainPage(Model mode) throws Exception {

		return "hrp/mat/protocol/matprotocolint/matProtocolIntMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolint/matProtocolIntAddPage", method = RequestMethod.GET)
	public String matProtocolMainAddPage(Model mode) throws Exception {

		return "hrp/mat/protocol/matprotocolint/matProtocolIntAdd";
	}
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolint/matInvDetailPage", method = RequestMethod.GET)
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolint/addMatProtocolInt", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addMatProtocolInt(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		mapVo.put("is_init", 1);
		String matProtocolIntJson = matProtocolMainService.addMatProtocolMain(mapVo);

		return JSONObject.parseObject(matProtocolIntJson);
...
/**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolint/matProtocolIntUpdatePage", method = RequestMethod.GET)
	public String matProtocolMainUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/mat/protocol/matprotocolint/matProtocolIntUpdate";
	}
	/**
	 * 查看协议文档
	 * @param mapVo
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolint/matProtocolFilePage", method = RequestMethod.GET)
	public String matProtocolFilePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		MatProtocolFile file = new MatProtocolFile();
		
		file = matProtocolFileService.queryMatProtocolFileByCode(mapVo);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolint/updateMatProtocolInt", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateMatProtocolInt(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolint/updateStateInt", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolint/addOrUpdateMatProtocolInt", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateMatProtocolInt(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolint/deleteMatProtocolInt", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteMatProtocolInt(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolint/queryMatProtocolInt", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryMatProtocolInt(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolint/matProtocolIntImportPage", method = RequestMethod.GET)
	public String matProtocolMainImportPage(Model mode) throws Exception {

		return "hrp/mat/protocol/matprotocolint/matProtocolIntImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/mat/protocol/matprotocolint/downTemplate", method = RequestMethod.GET)  
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/mat/protocol/matprotocolint/readMatProtocolIntFiles",method = RequestMethod.POST)  
...
s	 * @param  plupload
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/mat/protocol/matprotocolint/addBatchMatProtocolInt", method = RequestMethod.POST)
	@ResponseBody
