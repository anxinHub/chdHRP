...
public interface MatAccountBalanceInvHoldMapper extends SqlMapper{
	...
	*/
	public List<MatAccountBalanceInvHold> queryMatAccountBalanceInvHold(Map<String,Object> entityMap) throws DataAccessException;
