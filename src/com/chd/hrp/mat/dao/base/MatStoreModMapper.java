...
public interface MatStoreModMapper extends SqlMapper {
	 ...
	 * @throws DataAccessException
	 */
	public List<MatStoreMod> queryStoreMod(Map<String, Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	
	public List<MatStoreMod> queryStoreModList(Map<String, Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<MatStoreMod> queryStoreMod(Map<String, Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public MatStoreMod queryStoreModByCode(Map<String, Object> entityMap) throws DataAccessException;
