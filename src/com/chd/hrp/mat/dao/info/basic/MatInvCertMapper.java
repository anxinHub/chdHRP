...
public interface MatInvCertMapper extends SqlMapper{
	/**
	 * @Description 
	 * 添加MAT_INV_CERT<BR> 
	 * @param  entityMap
	...
	*/
	public int addMatInvCert(Map<String,Object> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int addBatchMatInvCert(List<Map<String, Object>> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int updateMatInvCert(Map<String,Object> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int updateBatchMatInvCert(List<Map<String, Object>> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int deleteMatInvCert(Map<String,Object> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int deleteBatchMatInvCert(List<Map<String, Object>> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<MatInvCert> queryMatInvCert(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<MatInvCert> queryMatInvCert(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	/**
	 * @Description 
	 * 获取MAT_INV_CERT<BR> 
	 * @param  entityMap <BR>
	...
	*/
	 ...
	 * @throws DataAccessException
	 */
	public List<MatInvCert> queryMatInvCertNew(Map<String, Object> entityMap) throws DataAccessException;
	/**
	 ...
	 * @throws DataAccessException
	 */
	public List<MatInvCert> queryMatInvCertNew(Map<String, Object> entityMap,RowBounds rowBounds) throws DataAccessException;
	/**
	 ...
	 * @throws DataAccessException
	 */
	public List<MatInvCert> queryMatInvCertByID(Map<String, Object> entityMap) throws DataAccessException;
	/**
	...
	*/
	 ...
	 * @return
	 */
	public List<Map<String, Object>> queryDataForTemplatePrint(
