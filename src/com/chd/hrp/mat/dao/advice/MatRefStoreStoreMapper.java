...
public interface MatRefStoreStoreMapper extends SqlMapper{
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<HrpMatSelect> queryMatRefStoreList(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
}
