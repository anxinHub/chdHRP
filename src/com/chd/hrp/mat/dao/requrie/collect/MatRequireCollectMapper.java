...
package com.chd.hrp.mat.dao.requrie.collect;
import java.util.*;
...
public interface MatRequireCollectMapper extends SqlMapper{
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryMatCollectDetail(Map<String, Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<MatRequireMain> queryCollectNotCheck(Map<String, Object> entityMap) throws DataAccessException;
	public List<MatRequireMain> queryCollectNotCheck(Map<String, Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<MatRequireMain> queryDirCollectNotCheck(Map<String, Object> entityMap) throws DataAccessException;
	public List<MatRequireMain> queryDirCollectNotCheck(Map<String, Object> entityMap, RowBounds rowBounds) throws DataAccessException;
}
