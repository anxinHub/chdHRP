...
public interface MatRequirePlanMapper extends SqlMapper{
	/**
	 * 科室需求计划编制--查询
	 * @param entityMap
	 * @return
	 ...
	 * @throws DataAccessException
	 */
	public int updateAbortMatDeptPlan(List<Map<String, Object>> entityList) throws DataAccessException;
	 ...
	 * @return
	 */
	public int updateSubmitMatDeptPlan(List<Map<String, Object>> entityList) throws DataAccessException;
	 ...
	 * @return
	 */
	public int updateUnSubmitMatDeptPlan(List<Map<String, Object>> entityList) throws DataAccessException;
