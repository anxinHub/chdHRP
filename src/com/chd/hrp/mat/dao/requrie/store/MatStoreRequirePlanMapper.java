...
package com.chd.hrp.mat.dao.requrie.store;
import java.util.*;
...
public interface MatStoreRequirePlanMapper extends SqlMapper{
	/**
	 * 仓库需求计划编制--查询
	 * @param entityMap
	 * @return
	 ...
	 * @throws DataAccessException
	 */
	public void updateSubmitMatStorePlan(List<Map<String, Object>> detailList) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public void updateUnSubmitMatStorePlan(List<Map<String, Object>> detailList) throws DataAccessException;
	/**
	 * 中止单据
	 * @param detailList
	 * @throws DataAccessException
	 */
	public void abortMatStoreRequriedPlan(List<Map<String, Object>> detailList) throws DataAccessException;
	/**
	 * 审核
	 * @param detailList
	 * @throws DataAccessException
	 */
	public void submitMatStoreRequriedConfirm(List<Map<String, Object>> detailList) throws DataAccessException;
	/**
	 * 取消审核
	 * @param detailList
	 * @throws DataAccessException
	 */
	public void unSubmitMatStoreRequriedConfirm(List<Map<String, Object>> detailList) throws DataAccessException;
	...
	*//**
	 ...
	 * @throws DataAccessException
	 */
	public List<?> queryStoreSupport(Map<String, Object> entityMap) throws DataAccessException;
	public List<?> queryStoreSupport(Map<String, Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	public List<Map<String, Object>> queryMatStoreSupportData(List<Map<String, Object>> detailList) throws DataAccessException;
