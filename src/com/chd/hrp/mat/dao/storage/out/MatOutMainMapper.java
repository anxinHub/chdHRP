...
public interface MatOutMainMapper extends SqlMapper{
	 ...
	 */
	public Long queryMatOutMainSeq() throws DataAccessException;
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<Map<String,Object>> queryMatOutMain(Map<String,Object> entityMap) throws DataAccessException;
	/**
	 * @Description 
	 ...
	 * @throws DataAccessException
	*/
	public List<Map<String,Object>> queryMatOutMain(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public <T> T queryMatOutMainByCode(Map<String,Object> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public int queryMatOutMainNext(Map<String, Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public int queryMatOutMainPre(Map<String, Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int existsMatOutStateForConfirm(List<Map<String,Object>> entityList) throws DataAccessException;

	//入库主表模板打印
	public Map<String, Object> queryMatOutPrintTemlateByMain(Map<String,Object> entityMap) throws DataAccessException;
   
	public List<Map<String, Object>> queryMatOutPrintTemlateByMainBatch(Map<String,Object> entityMap) throws DataAccessException;
		
	//入库明细表模板打印
	public List<Map<String, Object>> queryMatOutPrintTemlateByDetail(Map<String,Object> entityMap) throws DataAccessException;
	//入库明细表模板打印按类别
	public List<Map<String, Object>> queryMatOutPrintTemlateByDetailType(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryMatDeptRequireData(Map<String, Object> entityMap) throws DataAccessException;
	public List<Map<String, Object>> queryMatDeptRequireData(Map<String, Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryMatDeptRequireDataDetail(Map<String, Object> entityMap) throws DataAccessException;
	public List<Map<String, Object>> queryMatDeptRequireDataDetail(Map<String, Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryOutMainByDeptReqCollect(Map<String, Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryOutDetailByDeptReqCollect(Map<String, Object> entityMap) throws DataAccessException;

	public int queryMatDeptReqDataCount(List<Map<String, Object>> entityList) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public int updateMatDeptReqCloseInv(List<Map<String, Object>> entityList) throws DataAccessException;
