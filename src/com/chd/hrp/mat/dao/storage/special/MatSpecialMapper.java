...
public interface MatSpecialMapper extends SqlMapper{
	...
	*/
	 ...
	 * @throws DataAccessException
	 */
	public List<?> queryMatSpecial(Map<String,Object> entityMap) throws DataAccessException;
	/**
	 * 专购品 入库单查询 分页
	 * @param entityMap
	 * @return
	 * @throws DataAccessException
	 */
	public List<?> queryMatSpecial(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	/**
	 * @Description 
	 * 批量入库确认<BR> 
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<?> queryMatAffiDetail(Map<String,Object> entityMap) throws DataAccessException;
	...
	*/
	 ...
	 * @throws DataAccessException
	 */
	public int addMatSpecialRela(Map<String, Object> relaMap) throws DataAccessException;
	/**
	 * 批量维护专购品与出入库对应关系
	 * @param relaMap
	 * @throws DataAccessException
	 */
	public int addMatSpecialRelaBatch(List<Map<String, Object>> relaList) throws DataAccessException;
	
	public int addAffiRelaBatch(List<Map<String, Object>> relaList) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public int addMatOutDetailBatch(List<Map<String, Object>> detailList) throws DataAccessException;
	/**
	 * 专购品 更新页面回值查询
	 * @param mapVo
	 * @return
	 ...
	 * @return
	 */
	public int existsMatSpecialStateForConfrim(List<Map<String, Object>> entityList) throws DataAccessException;
	/**
	 * 确认使用
	 * @param entityList
	 * @return
	 ...
	 * @throws DataAccessException
	 */
	public int confirmMatSpecialIn(List<Map<String, Object>> listVo) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public int confirmMatSpecialOut(List<Map<String, Object>> listVo) throws DataAccessException;
	/**
	 ...
	 * @throws DataAccessException
	 */
	public int deleteMatInSourceBatch(List<Map<String, Object>> entityList) throws DataAccessException;
	/**
	 * 冲账 批量新增  专购品入库 主表数据
	 * @param outMainList
	 * @return
	 ...
	 * @throws DataAccessException
	 */
	public Long queryMatSpecialNextval() throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public int addMatSpecialDetailBatch(List<Map<String, Object>> detailList) throws DataAccessException;
	/**
	 * 出库单明细 序列
	 * @return
	 * @throws DataAccessException
	 ...
	 * @throws DataAccessException
	 */
	public void deleteMatOutSourceBatch(List<Map<String, Object>> entityList) throws DataAccessException;
	/**
	 * 修改 专购品主表数据
	 * @param entityMap
	 * @return
	 ...
	 * @throws DataAccessException
	 */
	public int updateMatOutMain(Map<String, Object> entityMap) throws DataAccessException;
	/**
	 * 获取对象专购品明细数据
	 * @param entityMap
	 * @return
	 */
	public List<Map<String, Object>> queryMatSpecialDetailByCode(Map<String, Object> entityMap) throws DataAccessException;
	/** 
	 * 获取 专购品明细表 序列
	 * @return
	 * @throws DataAccessException
	 */
	public Long queryMatSpecialDetailSeq() throws DataAccessException;
	/**
	 * 批量添加 专购品订单关系
	 * @param orderRelaList
	 * @throws DataAccessException
	 ...
	 * @throws DataAccessException
	 */
	public int deleteMatSpecialDetailForUpdate(Map<String, Object> pageMap) throws DataAccessException;
	/**
	 * 专购品明细表修改（批量）
	 * @param detailUpdateList
	 * @return
	 */
	public int updateMatSpecialDetailBatch(List<Map<String, Object>> detailUpdateList) throws DataAccessException;
	/**
	 * 修改出库资金来源表
	 * @param entityMap
	 * @throws DataAccessException
	 */
	public void updateMatOutResource(Map<String, Object> entityMap) throws DataAccessException;
	/**
	 * 专购品主表  批量审核、消审
	 * @param listVo
	 * @throws DataAccessException
	 ...
	 * @throws DataAccessException
	 */
	public int confirmMatSpecial(List<Map<String, Object>> listVo) throws DataAccessException;
	/**
	 ...
	 * @throws DataAccessException
	 */
	public Map<String, Object> queryMatSpecialById(Map<String, Object> entityMap) throws DataAccessException;
	/**
	 * 根据 ID查询专购品入库单主表 数据
	 * @param entityMap
	 * @return
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryMatInDetailById(Map<String, Object> entityMap) throws DataAccessException;
	/**
	 * 根据 ID查询专购品出库单明细表 数据
	 * @param dataMap
	 * @return
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryMatOutDetailById(Map<String, Object> entityMap) throws DataAccessException;
	/**
	 * 批量新增专购品主表数据
	 * @param specialList
	 * @throws DataAccessException
	 */
	public int addMatSpecialMainBatch(List<Map<String, Object>> specialList) throws DataAccessException;
	/**
	 * 查询入库资金来源
	 * @param entityMap
	 * @return
	 * @throws DataAccessException
	 */
	public Map<String, Object> queryMatInResource(Map<String, Object> entityMap) throws DataAccessException;
	/**
	 * 查询出库资金来源
	 * @param entityMap
	 * @return
	 * @throws DataAccessException
	 */
	public Map<String, Object> queryMatOutResource(Map<String, Object> entityMap) throws DataAccessException;
	/**
	 * 批量新增 专购品入库 资金来源 数据
	 ...
	 * @throws DataAccessException
	 */
	public Map<String, Object> queryMatSpecialBefore(Map<String, Object> mapVo) throws DataAccessException;
	/**
	 * 查询下一张 单据数据
	 * @param mapVo
	 * @return
	 * @throws DataAccessException
	 */
	public Map<String, Object> queryMatSpecialNext(Map<String, Object> mapVo) throws DataAccessException;
	/**
	 * 更改代销出库单  是否已生成专购品  状态
	 * @param mapVo
	 * @return
	...
	//入库主表模板打印
	public Map<String, Object> queryMatSpecialPrintTemlateByMain(Map<String,Object> entityMap) throws DataAccessException;
	//入库主表批量模板打印
	public List<Map<String, Object>> queryMatSpecialPrintTemlateByMainBatch(Map<String,Object> entityMap) throws DataAccessException;
	
	//入库明细表模板打印
	public List<Map<String, Object>> queryMatSpecialPrintTemlateByDetail(Map<String,Object> entityMap) throws DataAccessException;
	
	//入库明细表模板汇总打印
	public List<Map<String, Object>> queryMatSpecialPrintTemlateByDetailCollect(Map<String,Object> entityMap) throws DataAccessException;
	
	//组装明细数据
	public List<Map<String, Object>> queryMatAffiOutDetail(Map<String, Object> entityList) throws DataAccessException;
	
	//代销生成专购品 查询
	public List<?> queryMatAffiSpecial(Map<String, Object> entityMap) throws DataAccessException;
	public List<?> queryMatAffiSpecial(Map<String, Object> entityMap,RowBounds rowBounds) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int updateMatSpecialInvoice(Map<String,Object> entityMap) throws DataAccessException;

	public List<Map<String, Object>> queryMatSpecailInvBatch(Map<String, Object> entityMap) throws DataAccessException;
	public List<Map<String, Object>> queryMatSpecailInvBatch(Map<String, Object> entityMap, RowBounds rowBounds) throws DataAccessException;

	public List<Map<String, Object>> queryMatSpecailInvDetail(List<Map<String, Object>> invList) throws DataAccessException;
	/**
	 * 明细查询
	 * @param entityMap
	 * @return
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryMatSpecialDetail(Map<String, Object> entityMap) throws DataAccessException;
	public List<Map<String, Object>> queryMatSpecialDetail(Map<String, Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int addMatOutMainBySpecialBatch(List<Map<String,Object>> entityList) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int addMatOutDetailBySpecialBatch(List<Map<String,Object>> entityList) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<?> queryMatSpecialMainByIds(Map<String,Object> entityMap)throws DataAccessException;	
	 ...
	 * @throws DataAccessException
	*/
	public List<?> queryMatSpecialDetailByIds(Map<String,Object> entityMap)throws DataAccessException;	
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryMatSpecailInvDetailByIds(Map<String, Object> entityMap) throws DataAccessException;	
