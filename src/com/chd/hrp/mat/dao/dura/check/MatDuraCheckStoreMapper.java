...
public interface MatDuraCheckStoreMapper extends SqlMapper{
	...
	*/
	 ...
	 * @return
	 */
	public List<Map<String, Object>> queryMatInvByBalance(Map<String, Object> mapVo) throws DataAccessException;
	/**
	 * 选择材料
	 * @param mapVo
	 * @return
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryMatDuraInvChoiceByStore(
