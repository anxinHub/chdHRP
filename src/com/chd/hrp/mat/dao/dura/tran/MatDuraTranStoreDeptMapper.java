...
package com.chd.hrp.mat.dao.dura.tran;
...
public interface MatDuraTranStoreDeptMapper extends SqlMapper{
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public int addMainBatch(List<Map<String, Object>> entityList)throws DataAccessException;
