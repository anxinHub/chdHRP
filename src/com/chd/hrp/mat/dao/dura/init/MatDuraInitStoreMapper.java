...
public interface MatDuraInitStoreMapper extends SqlMapper{
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<Map<String, Object>> queryStoreListForImport(Map<String,Object> entityMap) throws DataAccessException;
