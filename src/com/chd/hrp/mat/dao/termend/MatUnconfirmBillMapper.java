 ...
 * @Version: 1.0
 */
public interface MatUnconfirmBillMapper extends SqlMapper{
	//查询
	public Map<String, Object> query(List<Map<String, Object>> entityMap)throws DataAccessException;
    //常备未确认入库结转下月
	public int updateUnconfirmBillByMatIn(Map<String, Object> entityMap)throws DataAccessException;
	//常备未确认出库结转下月
	public int updateUnconfirmBillByMatOut(Map<String, Object> entityMap)throws DataAccessException;
	//常备未确认调拨结转下月
	public int updateUnconfirmBillByMatTran(Map<String, Object> entityMap)throws DataAccessException;
	//代销未确认入库结转下月
