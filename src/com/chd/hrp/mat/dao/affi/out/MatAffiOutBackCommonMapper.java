...
public interface MatAffiOutBackCommonMapper extends SqlMapper{
	/**
	 * 配套导入查询明细
	 * @param entityMap
	 * @return
	 ...
	 * @throws DataAccessException
	 */
	public int auditMatAffiOutBackCommon(List<Map<String, Object>> entityList) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public int unAuditMatAffiOutBackCommon(List<Map<String, Object>> entityList) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public String queryAffiNextOutBackId(Map<String, Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public String queryAffiUpOutBackId(Map<String, Object> entityMap) throws DataAccessException;
	...
	//入库主表模板打印
	public Map<String, Object> queryMatAffiOutBackPrintTemlateByMain(Map<String,Object> entityMap) throws DataAccessException;
			
	public List<Map<String, Object>> queryMatAffiOutBackPrintTemlateByMainBatch(Map<String,Object> entityMap) throws DataAccessException;
	//入库明细表模板打印
	public List<Map<String, Object>> queryMatAffiOutBackPrintTemlateByDetail(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public Integer queryMatOutBackMainIsApply(Map<String, Object> entityMap) throws DataAccessException;
