package com.chd.hrp.hr.entity.salarymanagement.empWage;
...
public class HrWage {
	...
	private Double item106;
	private Double item107;
	private Double item108;
	private Double item109;
	private Double item110;
	private Double item111;
	private Double item112;
	private Double item113;
	private Double item114;
	private Double item115;
	private Double item116;
	private Double item117;
	private Double item118;
	private Double item119;
	private Double item120;
	...
	public String getWage_plan() {
		return wage_plan;
	}

	public void setWage_plan(String wage_plan) {
		this.wage_plan = wage_plan;
	}

	public String getWage_plan_name() {
		return wage_plan_name;
	}

	public void setWage_plan_name(String wage_plan_name) {
		this.wage_plan_name = wage_plan_name;
	}
	...
	public Double getWage_count() {
		return wage_count;
	}

	public void setWage_count(Double wage_count) {
		this.wage_count = wage_count;
	}
	...
	public Double getItem106() {
		return item106;
	}

	public void setItem106(Double item106) {
		this.item106 = item106;
	}

	public Double getItem107() {
		return item107;
	}

	public void setItem107(Double item107) {
	...
	public Double getItem110() {
		return item110;
	}

	public void setItem110(Double item110) {
		this.item110 = item110;
	}

	public Double getItem111() {
		return item111;
	}

	public void setItem111(Double item111) {
		this.item111 = item111;
	}

	public Double getItem112() {
		return item112;
	}

	public void setItem112(Double item112) {
		this.item112 = item112;
	}

	public Double getItem113() {
		return item113;
	}

	public void setItem113(Double item113) {
		this.item113 = item113;
	}

	public Double getItem114() {
		return item114;
	}

	public void setItem114(Double item114) {
		this.item114 = item114;
	}

	public Double getItem115() {
		return item115;
	}

	public void setItem115(Double item115) {
		this.item115 = item115;
	}

	public Double getItem116() {
		return item116;
	}

	public void setItem116(Double item116) {
		this.item116 = item116;
	}

	public Double getItem117() {
		return item117;
	}

	public void setItem117(Double item117) {
		this.item117 = item117;
	}

	public Double getItem118() {
		return item118;
	}

	public void setItem118(Double item118) {
		this.item118 = item118;
	}

	public Double getItem119() {
		return item119;
	}

	public void setItem119(Double item119) {
		this.item119 = item119;
	}

	public Double getItem120() {
		return item120;
	}

	public void setItem120(Double item120) {
