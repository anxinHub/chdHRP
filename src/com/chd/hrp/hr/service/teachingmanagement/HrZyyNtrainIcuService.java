...
public interface HrZyyNtrainIcuService {
	/**
	 * 查询专业信息 下拉框
	 * @return
	 ...
	 * @throws DataAccessException
	 */
    String deleteHrZyyNtrainIcu(List<HrZyyNtrainIcu> entityList)throws DataAccessException;
    /**
     * 计算
     * @param entityMap
     * @return
	 ...
	 * @throws DataAccessException
	 */
	String importZyyNtrainIcu(Map<String, Object> mapVo)throws DataAccessException;
	/**
	 * 打印
	 * 
	 * @param page
	 ...
	 * @throws DataAccessException
	 */
	List<Map<String, Object>> queryZyyNtrainIcuByPrint(Map<String, Object> page)throws DataAccessException;
	/**
	 * 保存
	 * @param mapVo
	 * @return
