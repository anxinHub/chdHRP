...
public class Condition extends Wrapper {
    ...
    public String getSqlSegment() {
        if (null == this || Condition.EMPTY.equals(this)) {
            return null;
        }
        /*
         * 无条件
		 ...
		 */
        return isWhere != null ? (isWhere ? sqlWhere.replaceFirst("WHERE", "") : sqlWhere.replaceFirst("WHERE", AND_OR)) : sqlWhere.replaceFirst("WHERE", AND_OR);
