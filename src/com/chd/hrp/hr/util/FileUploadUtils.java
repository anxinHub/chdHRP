...
public class FileUploadUtils
{
            ...
            throws FileSizeLimitExceededException, IOException
    {
        ...
        {
            throw new SysException("upload.filename.exceed.length:" + FileUploadUtils.DEFAULT_FILE_NAME_LENGTH);
        }
            ...
            throws FileSizeLimitExceededException
    {
        ...
        {
            throw new SysException("upload.exceed.maxSize:" + DEFAULT_MAX_SIZE / 1024 / 1024);
        }
        ...
        if (allowedExtension != null && !isAllowedExtension(extension, allowedExtension))
        {
             ...
             throw new SysException("filename : [" + filename + "], extension : [" + extension + "], allowed extension : [" + Arrays.toString(allowedExtension) + "]" );
