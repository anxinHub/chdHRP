...
public interface HrDeptMapper  extends SqlMapper{
	/**
	 * @Description 添加Dept
	 * @param HrDept entityMap
	 * @return int
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<HrDept> queryDept(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<HrDept> queryDept(Map<String,Object> entityMap) throws DataAccessException;
	...
	*/
	 ...
	 * @return
	 */
	public List<HrDept> queryDeptById(Map<String, Object> entityMap) throws DataAccessException;
	/**
	 * 查询当前集团、医院下的 部门 的最大排序号
	 * @param entityMap
	 * @return
	 */
	public HrDept queryMaxDept_sort(Map<String, Object> entityMap) throws DataAccessException;
	/**
	 ...
	 * @throws DataAccessException
	 */
	public HrDept queryDept_sort(Map<String, Object> entityMap) throws DataAccessException;
	/**
    ...
    */
	public List<Map<String, Object>> queryDeptOrg(Map<String, Object> map) throws DataAccessException;
	 /**
	    ...
	    * @throws DataAccessException
	    */
	public List<HrDept> queryBySuperCode(Map<String, Object> entityMap) throws DataAccessException;
	 /**
	    * 更新类别编码
	    * @param map
	    * @return
	    * @throws DataAccessException
	    */
	public void updateBatchSuperCode(@Param(value="map") Map<String, Object> entityMap, @Param(value="list")List<HrDept> listDept) throws DataAccessException;
	 /**
	    * 更新是否末级
	    * @param map
	    * @return
	...
	public void updateIsLast(Map<String, Object> isLast) throws DataAccessException;
      ...
      * @throws DataAccessException
      */
	public void updateBatchStop(@Param(value="map") Map<String, Object> entityMap, @Param(value="list")List<HrDept> listDept)throws DataAccessException;
     /**
      * 查询上级是否存在
      * @param map
      * @return
      * @throws DataAccessException
      */
	public HrDept qureySurpDept(Map<String, Object> map)throws DataAccessException;
    /**
     * 查询是否有下级
     * @param superCodeMap
     * @throws DataAccessException
     */
	public void querySuperCode(List<HrDept> superCodeMap)throws DataAccessException;

	public List<HrDept> queryDeptByIdName(Map<String, Object> entityMap);
}
