...
public interface HrAccRestStatisticsMapper  extends SqlMapper{
   /**
    * 查询积休增加
    * @param entityMap
    * @return
    */
	 ...
	 * @return
	 */
	Map<String, Object> queryHrCycDate(Map<String, Object> entityMap);
	/**
	 * 积休统计表里面是否有数据
	 * @param entityMap
	 * @return
	 */
	List<Map<String, Object>> queryHrAttdentAccstatIsUse(Map<String, Object> entityMap);
	/**
	 * 打印
	 * @param entityMap
	 * @return
	 ...
	 * @return
	 */
	List<Map<String, Object>> queryAccYearMonthExists(Map<String, Object> entityMap);
