...
import com.chd.hrp.hr.entity.sysstruc.HrFunLink;
...
public interface HrFunLinkMapper extends SqlMapper{
	/**
	 * @Description 
	 * 添加9910 绩效函数页面配置表<BR> 
	 * @param  entityMap
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<HrFunLink> queryPrmFunLink(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<HrFunLink> queryPrmFunLink(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	/**
	 * @Description 
	 * 获取9910 绩效函数页面配置表<BR> 
	 * @param  entityMap
	 ...
	 * @throws DataAccessException
	*/
	public HrFunLink queryPrmFunLinkByCode(Map<String,Object> entityMap)throws DataAccessException;
