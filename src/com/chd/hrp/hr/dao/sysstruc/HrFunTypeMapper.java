...
public interface HrFunTypeMapper extends SqlMapper{
	/**
	 * @Description 
	 * 添加9909 绩效函数分类表<BR> 
	 * @param  entityMap
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<HrFunType> queryPrmFunType(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<HrFunType> queryPrmFunType(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	/**
	 * @Description 
	 * 获取9909 绩效函数分类表<BR> 
	 * @param  entityMap
	...
	*/
	...
	public HrFunType queryByCodeOrName(Map<String, Object> entityMap) throws DataAccessException;
