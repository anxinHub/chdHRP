 ...
 * @Version: 1.0
 */
@Service("medCommonOutApplyCheckService")
public class MedCommonOutApplyCheckServiceImpl implements MedCommonOutApplyCheckService {

	private static Logger logger = Logger.getLogger(MedCommonOutApplyCheckServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		try {
			...
			//return "{\"error\":\"添加失败 数据库异常 请联系管理员! 方法 addMedCommonOutApplyCheck\"}";
		}
	}
	/**
	 * @Description 
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			throw new SysException("{\"error\":\"添加失败\"}");
			//return "{\"error\":\"添加失败 数据库异常 请联系管理员! 方法 addBatchMedCommonOutApplyCheck\"}";
		}
	}
...
//			StringBuffer invEnoughMsg = new StringBuffer();
			...
			for(Map<String, Object> entityMap : entityList){ 
				...
				money_sum = 0;
				//主表数据
				Map<String, Object> appMap = medCommonOutApplyCheckMapper.queryMedApplyMainByCode(entityMap);
				...
				mainMap.put("dept_emp", appMap.get("app_emp") == null ? null : Integer.valueOf(appMap.get("app_emp").toString()));
				mainMap.put("brief", "由科室申领单"+appMap.get("apply_no").toString()+"生成----"+appMap.get("brief").toString() == null ? null : appMap.get("brief").toString());
				mainMap.put("state", "1");
				...
				//判断库房是否已启用
				String store_flag = medCommonMapper.queryMedStoreIsStart(mainMap);
				...
				mainMap.put("out_id", String.valueOf(medCommonOutApplyCheckMapper.queryMedOutMainSeqNext()));
				
				//明细信息
				List<Map<String, Object>> detailList = toListMapLower((List<Map<String, Object>>) medCommonOutApplyCheckMapper.queryMedApplyDetailByCode(entityMap));
				...
				for(Map<String, Object> map : detailList){
					...
					for(Map<String, Object> fifoMap : fifoList){
						...
						detailMap.put("out_detail_id", String.valueOf(medCommonOutApplyCheckMapper.queryMedOutDetailSeqNext()));
			...
			if(invEnoughMsg != null && !"".equals(invEnoughMsg.toString())){
				return "{\"error\":\"以下药品库存药品不足：<br/>"+invEnoughMsg.toString()+"\"}";
			}
			*/
			if(outMainList.size() == 0 || outDetailList.size() == 0){
				return "{\"error\":\"所选单据库存药品不足\"}";
			}
			 
			//保存出库单主表
			medCommonOutApplyCheckMapper.addMedOutMainByAppBatch(outMainList);
			//保存出库单明细表
			medCommonOutApplyCheckMapper.addMedOutDetailByApp(outDetailList);
			//保存资金来源表
	...
	*/
	...
	public Map<String, Object> queryOutMainByCollect(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		for(Map<String, Object> entityMap : entityList){
			...
			if(is_frist){
				//查询科室申请主表数据
				mainMap = toMapLower(medCommonOutApplyCheckMapper.queryOutMain(entityMap));
				...
				//判断app_date  取所有数据中的最大的时间  即墨需求  2017/08/07
				if (bt.before(et)){ 
					//表示bt小于et
	...
	*/
	...
	public String queryOutDetailByCollect(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		//用于合并相同批次的药品明细信息(key：invMapKey+batch_sn，value：批次明细Map)
		Map<String, Map<String, Object>> invJsonMap = new HashMap<String, Map<String, Object>>();

		String invKey = "";  //药品Map的key值
		String immeKey = "";	//药品Map的key值
		String invJsonKey = "";  //药品JsonMap的key值
		boolean isInvAlready = false;  //判断药品是否存在Map中
		boolean isInvJsonAlready = false;  //判断药品是否存在Map中
		...
		try {
			...
			for(Map<String, Object> entityMap : entityList){
				//明细信息
				List<Map<String, Object>> detailList = toListMapLower((List<Map<String, Object>>) medCommonOutApplyCheckMapper.queryDetailByCollect(entityMap));
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			//return "{\"error\":\"更新失败 数据库异常 请联系管理员! 方法 updateBatchMedCommonOutApplyCheck\"}";
		}	
	}
	/**
	 * @Description 
	...
	*/
    ...
    public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			//return "{\"error\":\"删除失败 数据库异常 请联系管理员! 方法 deleteMedCommonOutApplyCheck\"}";
		}	
  }
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {	
			...
			throw new SysException("{\"error\":\"删除失败\"}");
			//return "{\"error\":\"删除失败 数据库异常 请联系管理员! 方法 deleteBatchMedCommonOutApplyCheck\"}";
		}	
	}

	@Override
	public String updateBackMedCommonOutApplyCheckBatch(List<Map<String, Object>> entityMap) throws DataAccessException {
		
		try {	
			//批量退回
			medCommonOutApplyCheckMapper.updateMedApplyBackBatch(entityMap);
		}
		catch (Exception e) {
			logger.error(e.getMessage(), e);
	...
	@Override
	public String updateMedCommonOutApplyCheckCloseInv(List<Map<String, Object>> entityList) throws DataAccessException {
		
		try {	
			//批量关闭药品
			medCommonOutApplyCheckMapper.updateMedCommonOutApplyCheckCloseInv(entityList);
		}
		catch (Exception e) {
			logger.error(e.getMessage(), e);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		if (MedApplyMain != null) {
			...
			int state = medCommonOutApplyCheckMapper.update(entityMap);
		...
		try {
			...
			int state = medCommonOutApplyCheckMapper.add(entityMap);
			...
			return "{\"error\":\"添加失败 数据库异常 请联系管理员! 方法 addOrUpdateMedCommonOutApplyCheck\"}";
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			List<?> list = medCommonOutApplyCheckMapper.query(entityMap);
			
			return ChdJson.toJson(list);
		}else{
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<?> list = medCommonOutApplyCheckMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return medCommonOutApplyCheckMapper.queryMedApplyMainByCode(entityMap);
	}
	...
	*/
	...
	public String queryDetailByCode(Map<String,Object> entityMap)throws DataAccessException{
		...
		List<?> list = medCommonOutApplyCheckMapper.queryMedApplyDetailByCode(entityMap);
	...
	*/
	...
	public  <T>T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return medCommonOutApplyCheckMapper.queryByUniqueness(entityMap);
	}
	...
	public Map<String, Object> queryOutMain(Map<String, Object> entityMap) throws DataAccessException {
		...
		return toMapLower(medCommonOutApplyCheckMapper.queryOutMain(entityMap));
	}
	/**
	 * 组装生成出库单明细表数据
	 */
	...
	public String queryOutDetail(Map<String, Object> entityMap) throws DataAccessException {
		try{
			//明细中药品信息
			List<Map<String, Object>> invList = toListMapLower(medCommonOutApplyCheckMapper.querySelectDetailForOut(entityMap));
	...
	public String addOut(Map<String, Object> entityMap) throws DataAccessException {
		try {
			...
			entityMap.put("out_id", medCommonOutApplyCheckMapper.queryMedOutMainSeqNext().toString());
			// 获取出库单号
			...
			if(invEnoughMsg != null && !"".equals(invEnoughMsg.toString())){
				return "{\"error\":\"以下药品库存药品不足："+invEnoughMsg.toString()+"\"}";
			}
			//判断即时库存是否充足(防止多人同时操作同一药品，额外加的判断)
			String invEnough = medCommonMapper.existsMedStockInvIsEnough(out_detail_batch);
			...
			medCommonOutApplyCheckMapper.addMedOutMainByApp(entityMap);// 保存主表

			medCommonOutApplyCheckMapper.addMedOutDetailByApp(out_detail_batch);// 保存明细表
			
			entityMap.put("source_money", money_sum);
			
			medOutResourceMapper.add(entityMap);// 保存资金来源
			
			medApplyOutRelaMapper.addMedApplyOutRelaBatch(appOutRelaList);//保存对应关系 
	...
	public String addAffiOut(Map<String, Object> entityMap) throws DataAccessException {
		try {
			...
			// 查询序列
			entityMap.put("out_id", medCommonOutApplyCheckMapper.queryMedAffiOutSeqNext());
			// 获取出库单号
			entityMap.put("table_code", "MED_AFFI_OUT");
			String out_no = medCommonService.getMedNextNo(entityMap);
			if(out_no.indexOf("error") > 0){
				return out_no;
			}
					...
					if(ChdJson.validateJSON(String.valueOf(jsonObj.get("sum_amount"))) && ChdJson.validateJSON(String.valueOf(jsonObj.get("amount"))) && ChdJson.validateJSON(String.valueOf(jsonObj.get("inv_detail_data"))) && String.valueOf(jsonObj.get("sum_amount")).equals(String.valueOf(jsonObj.get("amount")))){
						...
						for(Map<String, Object> m : JsonListMapUtil.getListMap(jsonObj.get("inv_detail_data").toString())){
							...
							if(m.get("inv_id") != null && !"".equals(String.valueOf(m.get("inv_id")))){
								Map<String, Object> detailMap = new HashMap<String, Object>();
								detailMap.putAll(mapDetailVo);
								detailMap.put("detail_id", String.valueOf(medCommonOutApplyCheckMapper.queryMedAffiOutDetailSeqNext()));
								if (ChdJson.validateJSON(String.valueOf(m.get("batch_sn")))) {
									detailMap.put("batch_sn", m.get("batch_sn").toString());
								}else{
									detailMap.put("batch_sn", null);
			...
			//判断即时库存是否充足(防止多人同时操作同一药品，额外加的判断)
			String invEnough = medCommonMapper.existsMedAffiInvIsEnough(out_detail_batch);
			if(invEnough != null && !"".equals(invEnough)){
				return "{\"error\":\"以下药品库存药品不足!"+invEnough+"\"}";
			}
			
			medCommonOutApplyCheckMapper.addMedAffiOutByApp(entityMap);// 保存主表

			medCommonOutApplyCheckMapper.addMedAffiOutDetailByApp(out_detail_batch);// 保存明细表
	...
	*/
	...
	public String queryStoreByDept(Map<String,Object> entityMap)throws DataAccessException{
		...
		String store = medCommonOutApplyCheckMapper.queryStoreByDept(entityMap);
	...
	public Map<String, Object> queryTranMain(Map<String, Object> entityMap) throws DataAccessException {
		...
		return toMapLower(medCommonOutApplyCheckMapper.queryTranMain(entityMap));
	}
	/**
	 * 组装生成调拨单明细表数据
	 */
	...
	*/
	...
	public String addTran(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			entityMap.put("tran_id", medCommonOutApplyCheckMapper.queryMedTranMainSeqNext());
			...
			tranMap.put("table_code", "MED_TRAN_MAIN");
			tranMap.put("prefixe", "DB");
			tranMap.put("store_alias", "");
			tranMap.put("bus_type", "");

			// 判断是否存在该业务流水码
			flag = medNoManageMapper.queryIsExists(tranMap);
			String max_no = "";
			if (flag == 0) {// 如不存在则流水码为1，并插入流水码表中
				max_no = "1";
				tranMap.put("max_no", 1);
				medNoManageMapper.add(tranMap);
			} else {
				// 更新该业务流水码+1
				medNoManageMapper.updateMaxNo(tranMap);
				// 取出该业务更新后的流水码
				max_no = medNoManageMapper.queryMaxCode(tranMap);
			}
			// 补流水码前缀0
			...
			outMap.put("prefixe", "");
			long out_id = medCommonOutApplyCheckMapper.queryMedOutMainSeqNext();
					...
					if(ChdJson.validateJSON(String.valueOf(jsonObj.get("sum_amount"))) && ChdJson.validateJSON(String.valueOf(jsonObj.get("amount"))) && ChdJson.validateJSON(String.valueOf(jsonObj.get("inv_detail_data"))) && String.valueOf(jsonObj.get("sum_amount")).equals(String.valueOf(jsonObj.get("amount")))){
						...
						for(Map<String, Object> m : JsonListMapUtil.getListMap(jsonObj.get("inv_detail_data").toString())){
							...
							if(m.get("inv_id") != null && !"".equals(String.valueOf(m.get("inv_id")))){
								...
								detailMap.putAll(mapDetailVo);
								detailMap.put("tran_detail_id", String.valueOf(medCommonOutApplyCheckMapper.queryMedTranDetailSeqNext()));
								...
								outDetailMap.put("out_detail_id", medCommonOutApplyCheckMapper.queryMedOutDetailSeqNext());
			...
			//新增调拨单主表
			medCommonOutApplyCheckMapper.addMedTranMainByApp(entityMap);
			//新增调拨单明细表
			medCommonOutApplyCheckMapper.addMedTranDetailByApp(tran_detail_batch);
			
			//新增出库单主表
			medCommonOutApplyCheckMapper.addMedOutMainByApp(outMap);
			//新增出库单明细表
			medCommonOutApplyCheckMapper.addMedOutDetailByApp(outDetailList);
			//新增出库单资金来源
			...
			//添加申请单与对应关系
			medApplyOutRelaMapper.addMedApplyOutRelaBatch(appOutRelaList);
	...
	*/
	...
	public String addAffiTran(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			entityMap.put("tran_id", medCommonOutApplyCheckMapper.queryMedAffiTranMainSeqNext());
			...
			tranMap.put("year", entityMap.get("year"));
			tranMap.put("month", entityMap.get("month"));
			tranMap.put("table_code", "MED_AFFI_TRAN_MAIN");
			tranMap.put("prefixe", "DB");
			tranMap.put("store_alias", "");
			tranMap.put("bus_type", "");
			...
			outMap.put("prefixe", "");
			long out_id = medCommonOutApplyCheckMapper.queryMedAffiOutSeqNext();
			outMap.put("out_id", out_id);
			String out_no = medCommonService.getMedNextNo(outMap);
			if(out_no.indexOf("error")!=-1){
				return out_no;
					...
					if(ChdJson.validateJSON(String.valueOf(jsonObj.get("sum_amount"))) && ChdJson.validateJSON(String.valueOf(jsonObj.get("amount"))) && ChdJson.validateJSON(String.valueOf(jsonObj.get("inv_detail_data"))) && String.valueOf(jsonObj.get("sum_amount")).equals(String.valueOf(jsonObj.get("amount")))){
						...
						for(Map<String, Object> m : JsonListMapUtil.getListMap(jsonObj.get("inv_detail_data").toString())){
							...
							if(m.get("inv_id") != null && !"".equals(String.valueOf(m.get("inv_id")))){
								...
								Map<String, Object> outDetailMap = new HashMap<String, Object>();
								detailMap.putAll(mapDetailVo);
								detailMap.put("tran_detail_id", String.valueOf(medCommonOutApplyCheckMapper.queryMedAffiTranDetailSeqNext()));
								if (ChdJson.validateJSON(String.valueOf(m.get("batch_sn")))) {detailMap.put("batch_sn", m.get("batch_sn").toString());}
								if (ChdJson.validateJSON(String.valueOf(m.get("amount")))) {detailMap.put("amount", m.get("amount").toString());}
								//金额根据系统参数重新对数量和单价的乘积进行四舍五入
								if (ChdJson.validateJSON(String.valueOf(m.get("amount_money")))) {
								...
								outDetailMap.put("out_id", outMap.get("out_id").toString());
								outDetailMap.put("out_no", outMap.get("out_no").toString());
								outDetailMap.put("detail_id", medCommonOutApplyCheckMapper.queryMedAffiOutDetailSeqNext());
								if(ChdJson.validateJSON(String.valueOf(detailMap.get("location_out_id")))){
									outDetailMap.put("location_id", detailMap.get("location_out_id").toString());
								}else{
									outDetailMap.put("location_id", "0");
			...
			if(invEnoughMsg != null && !"".equals(invEnoughMsg.toString())){
				return "{\"error\":\"以下代销药品库存药品不足："+invEnoughMsg.toString()+"\"}";
			}

			//判断即时库存是否充足(防止多人同时操作同一药品，额外加的判断)
			String invEnough = medCommonMapper.existsMedAffiInvIsEnough(tran_detail_batch);
			if(invEnough != null && !"".equals(invEnough)){
				return "{\"error\":\"以下代销药品库存药品不足!"+invEnough+"\"}";
			}
			
			//新增代销调拨单主表
			medCommonOutApplyCheckMapper.addMedAffiTranMainByApp(entityMap);
			//新增代销调拨单明细表
			medCommonOutApplyCheckMapper.addMedAffiTranDetailByApp(tran_detail_batch);
			
			//新增代销出库单主表
			medCommonOutApplyCheckMapper.addMedAffiOutByApp(outMap);
			//新增代销出库单明细表
			medCommonOutApplyCheckMapper.addMedAffiOutDetailByApp(outDetailList);
	...
	public Map<String, Object> queryReqMain(Map<String, Object> entityMap) throws DataAccessException {
		...
		return toMapLower(medCommonOutApplyCheckMapper.queryReqMain(entityMap));
	}
	/**
	 * 组装生成科室需求计划明细表数据
	 */
	...
	public String queryReqDetail(Map<String, Object> entityMap) throws DataAccessException {
		try{
			...
			return ChdJson.toJson(toListMapLower(medCommonOutApplyCheckMapper.queryReqDetail(entityMap)));
		}
		catch (Exception e) {
			logger.error(e.getMessage(), e);
	...
	*/
	...
	public String addReq(Map<String,Object> entityMap)throws DataAccessException{
		...
		try{
			...
			req_code = "XQ" + entityMap.get("year").toString().substring(2, 4) + entityMap.get("month") + entityMap.get("day") + max_no;
			...
			while (it.hasNext()) {
				...
				if(ChdJson.validateJSON(String.valueOf(jsonObj.get("inv_id")))){
					...
					detailMap.put("inv_id", jsonObj.getString("inv_id"));//药品ID
					detailMap.put("inv_no", jsonObj.getString("inv_no"));//药品变更ID
					//数量
					if (ChdJson.validateJSON(String.valueOf(jsonObj.get("amount")))) {
			...
			if(detailList.size() > 0){
				//插入主表
				medCommonOutApplyCheckMapper.addMedRequireMainByApp(entityMap);
				//插入明细表
				medCommonOutApplyCheckMapper.addMedRequireDetailByApp(detailList);
				//添加对应关系
				medApplyOutRelaMapper.addMedApplyOutRelaBatch(applyRelaList);
			}else{
	...
	*/
	@Override
	public String queryMedApplyRela(Map<String,Object> entityMap)throws DataAccessException{
		return ChdJson.toJsonLower(medCommonOutApplyCheckMapper.queryMedApplyRela(entityMap));
	}
	...
	*/
	@Override
	public String deleteMedApplyRela(List<Map<String,Object>> entityList)throws DataAccessException{
		try {
			String flag = medApplyOutRelaMapper.existsMedApplyOutRelaStateBatch(entityList);
			if(flag != null && !"".equals(flag) && !"0".equals(flag)){
				...
				if(outDeleteList.size() > 0){
					//删除出库单资金来源
					medOutResourceMapper.deleteBatch(outDeleteList);
					//删除出库单明细表
					medCommonOutApplyCheckMapper.deleteMedOutDetailByApp(outDeleteList);
					//删除出库单主表
					medCommonOutApplyCheckMapper.deleteMedOutMainByApp(outDeleteList);
				}
				if(tranDeleteList.size() > 0){
					//查询调拨单对应出入库单据
					List<Map<String, Object>> tranRelaList = toListMapLower(medTranRelaMapper.queryListForDelete(tranDeleteList));
					if(tranRelaList.size() > 0){
						//删除入库单资金来源
						medInCommonMapper.deleteMedInResourceBatch(tranRelaList);
						//删除入库单明细表
						medInCommonMapper.deleteMedInDetailBatch(tranRelaList);
						//删除入库单主表
						medInCommonMapper.deleteMedInMainBatch(tranRelaList);
						//删除出库单资金来源
						medOutResourceMapper.deleteBatch(tranRelaList);
						//删除出库单明细表
						medCommonOutApplyCheckMapper.deleteMedOutDetailByApp(tranRelaList);
						//删除出库单主表
						medCommonOutApplyCheckMapper.deleteMedOutMainByApp(tranRelaList);
					}
					//删除调拨单与出入库单对应关系
					medTranRelaMapper.deleteBatch(tranDeleteList);
					//删除调拨单明细表
					medCommonOutApplyCheckMapper.deleteMedTranDetailByApp(tranDeleteList);
					//删除调拨单明细表
					medCommonOutApplyCheckMapper.deleteMedTranMainByApp(tranDeleteList);
				}
				if(affiOutDeleteList.size() > 0){
					//删除代销出库单明细
					medCommonOutApplyCheckMapper.deleteMedAffiOutDetailByApp(affiOutDeleteList);
					//删除代销出库单主表
					medCommonOutApplyCheckMapper.deleteMedAffiOutByApp(affiOutDeleteList);
				}
				if(affiTranDeleteList.size() > 0){
					//查询代销调拨单对应代销出入库单据
					List<Map<String, Object>> tranRelaList = toListMapLower(medAffiTranRelaMapper.queryListForDelete(affiTranDeleteList));
					if(tranRelaList.size() > 0){
						//删除代销入库单明细表
						medAffiInMapper.deleteBatchMedAffiInDetail(tranRelaList);//明细表
						//删除代销入库单主表
						medAffiInMapper.deleteBatchMedAffiInMain(tranRelaList);//主表
						//删除代销出库单明细表
						medCommonOutApplyCheckMapper.deleteMedAffiOutDetailByApp(tranRelaList);
						//删除代销出库单主表
						medCommonOutApplyCheckMapper.deleteMedAffiOutByApp(tranRelaList);
					}
					//删除代销调拨单与代销出入库单对应关系
					medAffiTranRelaMapper.deleteBatch(affiTranDeleteList);
					//删除代销调拨单明细表
					medCommonOutApplyCheckMapper.deleteMedAffiTranDetailByApp(affiTranDeleteList);
					//删除代销调拨单主表
					medCommonOutApplyCheckMapper.deleteMedAffiTranMainByApp(affiTranDeleteList);
				}
				if(reqDeleteList.size() > 0){
					//删除科室需求计划明细表
					medCommonOutApplyCheckMapper.deleteMedRequireDetailByApp(reqDeleteList);
					//删除科室需求计划主表
					medCommonOutApplyCheckMapper.deleteMedRequireMainByApp(reqDeleteList);
				}
				//删除对应关系
	...
	*/
	...
	public Map<String, Object> queryRelaOutMainByCode(Map<String,Object> entityMap)throws DataAccessException{
		return toMapLower(medCommonOutApplyCheckMapper.queryRelaOutMainByCode(entityMap));
	}
	...
	*/
	...
	public String queryRelaOutDetailByCode(Map<String,Object> entityMap)throws DataAccessException{
		return ChdJson.toJsonLower(medCommonOutApplyCheckMapper.queryRelaOutDetailByCode(entityMap));
	}
	...
	*/
	...
	public Map<String, Object> queryRelaAffiOutMainByCode(Map<String,Object> entityMap)throws DataAccessException{
		return toMapLower(medCommonOutApplyCheckMapper.queryRelaAffiOutMainByCode(entityMap));
	}
	...
	*/
	...
	public String queryRelaAffiOutDetailByCode(Map<String,Object> entityMap)throws DataAccessException{
		return ChdJson.toJsonLower(medCommonOutApplyCheckMapper.queryRelaAffiOutDetailByCode(entityMap));
	}
	...
	*/
	...
	public Map<String, Object> queryRelaTranMainByCode(Map<String,Object> entityMap)throws DataAccessException{
		return toMapLower(medCommonOutApplyCheckMapper.queryRelaTranMainByCode(entityMap));
	}
	...
	*/
	...
	public String queryRelaTranDetailByCode(Map<String,Object> entityMap)throws DataAccessException{
		return ChdJson.toJsonLower(medCommonOutApplyCheckMapper.queryRelaTranDetailByCode(entityMap));
	}
	...
	*/
	...
	public Map<String, Object> queryRelaAffiTranMainByCode(Map<String,Object> entityMap)throws DataAccessException{
		return toMapLower(medCommonOutApplyCheckMapper.queryRelaAffiTranMainByCode(entityMap));
	}
	...
	*/
	...
	public Map<String, Object> queryRelaReqMainByCode(Map<String,Object> entityMap)throws DataAccessException{
		return toMapLower(medCommonOutApplyCheckMapper.queryRelaReqMainByCode(entityMap));
	}
	...
	*/
	...
	public String queryRelaReqDetailByCode(Map<String,Object> entityMap)throws DataAccessException{
		return ChdJson.toJsonLower(medCommonOutApplyCheckMapper.queryRelaReqDetailByCode(entityMap));
	}
	...
	public String queryMedOutByPrintTemlate(Map<String, Object> entityMap)throws DataAccessException {
		...
		try{
			...
			if("1".equals(String.valueOf(entityMap.get("p_num")))){ 
				...
				//查询入库主表
				List<Map<String,Object>> map=medCommonOutApplyCheckMapper.queryApplyCheckPrintTemlateByMainInBatch(entityMap);
				
				//查询入库明细表
				List<Map<String,Object>> list=medCommonOutApplyCheckMapper.queryMedOutPrintTemlateByDetail(entityMap);
				 
				return superPrintService.getBatchListByPrintTemplateJson(entityMap,map,list);
			
			}else{
				//查询入库主表
				Map<String,Object> map=medCommonOutApplyCheckMapper.queryMedOutPrintTemlateByMain(entityMap);
    ...
    public List<Map<String, Object>> queryMedOutRequirelExists(Map<String, Object> entityMap) throws DataAccessException {
		//查询入库明细表
		List<Map<String,Object>> list=medCommonOutApplyCheckMapper.queryMedOutRequirelExists(entityMap);
	    return list;
    }
	...
	public Map<String,Object> queryMedOutByPrintPage(Map<String, Object> entityMap)throws DataAccessException {
		try{
			...
			MedCommonOutApplyCheckMapper medCommonOutApplyCheckMapper = (MedCommonOutApplyCheckMapper)context.getBean("medCommonOutApplyCheckMapper");
