 ...
 * @Version: 1.0
 */
@Service("medInitInService")
public class MedInitInServiceImpl implements MedInitInService {

	private static Logger logger = Logger.getLogger(MedInitInServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		try {
			...
			//入库日期需在系统启用日期之前
			int flag = medCommonMapper.existsDateCheckBefore(entityMap);
			if(flag == 0){
			...
			*/ 
			...
			//return "{\"error\":\"添加失败 数据库异常 请联系管理员! 方法 addMedInitIn\"}";
		}
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			throw new SysException("{\"error\":\"添加失败\"}");
			//return "{\"error\":\"添加失败 数据库异常 请联系管理员! 方法 addBatchMedInitIn\"}";
		}
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			//return "{\"error\":\"更新失败 数据库异常 请联系管理员! 方法 updateMedInitIn\"}";
		}		
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			throw new SysException("{\"error\":\"更新失败\"}");
			//return "{\"error\":\"更新失败 数据库异常 请联系管理员! 方法 updateBatchMedInitIn\"}";
		}	
	...
	*/
    ...
    public String delete(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			//return "{\"error\":\"删除失败 数据库异常 请联系管理员! 方法 deleteMedInitIn\"}";
		}	
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {	
			...
			throw new SysException("{\"error\":\"删除失败\"}");
			//return "{\"error\":\"删除失败 数据库异常 请联系管理员! 方法 deleteBatchMedInitIn\"}";
		}	
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		if (medInMain != null) {
			...
			int state = medInitInMapper.update(entityMap);
		...
		try {
			...
			int state = medInitInMapper.add(entityMap);
			...
			return "{\"error\":\"添加失败 数据库异常 请联系管理员! 方法 addOrUpdateMedInitIn\"}";
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			List<?> list = medInitInMapper.query(entityMap);
			
			return ChdJson.toJson(list);
		}else{
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<?> list = medInitInMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public  <T>T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return medInitInMapper.queryByUniqueness(entityMap);
	}
	...
	*/
	...
	public List<Map<String, Object>> queryInvListForImport(Map<String, Object> entityMap)throws DataAccessException{
		...
		return JsonListMapUtil.toListMapLower((List<Map<String, Object>>) medInitInMapper.queryInvListForImport(entityMap));
	}
	...
	*/
	...
	public List<Map<String, Object>> queryLocationListForImport(Map<String, Object> entityMap)throws DataAccessException{
		...
		return JsonListMapUtil.toListMapLower((List<Map<String, Object>>) medInitInMapper.queryLocationListForImport(entityMap));
	}
	//入库模板打印（包含主从表）
	...
	public String queryMedInByPrintTemlate(Map<String, Object> entityMap)
		...
		try {
			if("1".equals(String.valueOf(entityMap.get("p_num")))){
				List<Map<String,Object>>  map= medInitInMapper.queryMedInPrintTemlateByMainBatch(entityMap);
				
				//查询入库明细表
				List<Map<String,Object>> list=medInitInMapper.queryMedInPrintTemlateByDetail(entityMap);
				return superPrintService.getBatchListByPrintTemplateJson(entityMap,map,list);
			}else{

				//查询入库主表
				Map<String,Object> map=medInitInMapper.queryMedInPrintTemlateByMain(entityMap);
	...
	//新版打印
	public Map<String, Object> queryMedInByPrintTemlateNewPrint(Map<String, Object> entityMap)
			throws DataAccessException {
		try {
			
			Map<String,Object> reMap=new HashMap<String,Object>();
			WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
			MedInitInMapper medInitInMapper = (MedInitInMapper)context.getBean("medInitInMapper");
