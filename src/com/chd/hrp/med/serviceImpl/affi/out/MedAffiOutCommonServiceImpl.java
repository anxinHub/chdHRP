package com.chd.hrp.med.serviceImpl.affi.out;
...
@Service("medAffiOutCommonService")
public class MedAffiOutCommonServiceImpl implements MedAffiOutCommonService{
	private static Logger logger = Logger.getLogger(MedAffiOutCommonServiceImpl.class);
	//引入dao
	...
	*/
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal()==-1){
			List<?> list = medAffiOutCommonMapper.query(entityMap);
			
			return ChdJson.toJson(list);
		}else{
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<?> list = medAffiOutCommonMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		try{
			...
			//取出主表ID（自增序列）
			entityMap.put("out_id", medAffiOutMapper.queryMedAffiOutMainSeq());
			//自动生成代销代销出库单据号
			entityMap.put("table_code", "MED_AFFI_OUT");
			entityMap.put("out_no", medCommonService.getMedNextNo(entityMap));
			...
			if(entityMap.get("detailData") != null && !"".equals(entityMap.get("detailData"))){
							...
							if(validateJSON(String.valueOf(jsonObj.get("sum_amount"))) && validateJSON(String.valueOf(jsonObj.get("amount")))&& validateJSON(String.valueOf(jsonObj.get("inv_detail_data"))) && String.valueOf(jsonObj.get("sum_amount")
								...
								for(Map<String, Object> m : JsonListMapUtil.getListMap(jsonObj.get("inv_detail_data").toString())){
									...
									if(m.get("inv_id") != null && !"".equals(String.valueOf(m.get("inv_id")))){
										...
										detailNewMap.put("detail_id", medAffiOutMapper.queryMedAffiOutDetailSeq());
								...
								//按先进先出匹配批次信息
								List<Map<String, Object>> fifoList = toListMapLower((List<Map<String, Object>>) medCommonMapper.queryMedAffiOutDetailInvList(detailMap));
				...
				String invEnough = medCommonMapper.existsMedAffiInvIsEnough(detailList);
				if(invEnough != null && !"".equals(invEnough)){
					return "{\"error\":\"以下药品库存物资不足!"+invEnough+"\"}";
				}
				//新增入库主表数据
				medAffiOutMapper.addMedAffiOutMain(entityMap);
				//新增入库明细数据
				ChdJson.toJson(detailList);
				medAffiOutMapper.addMedAffiOutDetail(detailList);
	...
	*/
	...
	public String addBatch(List<Map<String, Object>> entityMap) throws DataAccessException {
		try {
			...
			logger.error(e.getMessage(), e);
			throw new SysException("{\"error\":\"操作失败\"}");
			//return "{\"error\":\"添加失败 数据库异常 请联系管理员! 方法 addBatchMedAffiOutCommon\"}";
		}
	}
	/**
	 * @Description 
	...
	*/
	...
	public String queryByCodeDetail(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<?> list = medAffiOutMapper.queryByCodeDetail(entityMap);
		return ChdJson.toJson(list);
	...
	*/
	...
	public String update(Map<String, Object> entityMap) throws DataAccessException {
		try {
						...
						for(Map<String, Object> m : JsonListMapUtil.getListMap(jsonObj.get("inv_detail_data").toString())){
							...
							if(m.get("inv_id") != null && !"".equals(String.valueOf(m.get("inv_id")))){
								...
								if (validateJSON(String.valueOf(m.get("detail_id")))) {
									...
									detailMap.put("detail_id", medAffiOutMapper.queryMedAffiOutDetailSeq());
								}
			...
			medAffiOutMapper.updateMedAffiOutMain(entityMap);// 保存主表
			medAffiOutMapper.deleteMedAffiOutDetail(entityMap);//删除明细
			medAffiOutMapper.addMedAffiOutDetail(out_detail_batch);// 保存明细表
	...
	*/
	...
	public String updateBatch(List<Map<String, Object>> entityMap) throws DataAccessException {
		try {
			...
			logger.error(e.getMessage(), e);
			throw new SysException("{\"error\":\"操作失败\"}");
			//return "{\"error\":\"添加失败 数据库异常 请联系管理员! 方法 updateBatchMedAffiOutCommon\"}";
		}
	}
	...
	*/
	...
	public String queryMedAffiOutMatchDetail(Map<String, Object> entityMap) throws DataAccessException {
		...
		return ChdJson.toJson(medAffiOutCommonMapper.queryMedAffiOutMatchDetail(entityMap));
	...
	*/
	...
	public String queryAffiInMain(Map<String, Object> entityMap) throws DataAccessException {
		...
		sysPage = (SysPage) entityMap.get("sysPage");
		if (sysPage.getTotal() == -1) {
			List<Map<String, Object>> list = (List<Map<String, Object>>) medAffiOutCommonMapper.queryAffiInMain(entityMap);
			return ChdJson.toJsonLower(list);
		} else {
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<Map<String, Object>> list = (List<Map<String, Object>>) medAffiOutCommonMapper.queryAffiInMain(entityMap, rowBounds);
			PageInfo page = new PageInfo(list);
	...
	*/
	...
	public String queryAffiInInv(Map<String, Object> entityMap) throws DataAccessException {
		...
		sysPage = (SysPage) entityMap.get("sysPage");
		if (sysPage.getTotal() == -1) {
			List<Map<String, Object>> list = (List<Map<String, Object>>) medAffiOutCommonMapper.queryAffiInInv(entityMap);
			return ChdJson.toJsonLower(list);
		} else {
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<Map<String, Object>> list = (List<Map<String, Object>>) medAffiOutCommonMapper.queryAffiInInv(entityMap, rowBounds);
			PageInfo page = new PageInfo(list);
			return ChdJson.toJsonLower(list, page.getTotal());
	...
	*/
	...
	public String queryAffiInWholeDetail(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<Map<String, Object>> list = (List<Map<String, Object>>)medAffiOutCommonMapper.queryAffiInWholeDetail(entityMap);
		return ChdJson.toJsonLower(list);
	}
	...
	*/
	...
	public String auditMedAffiOutCommon(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {	
			...
			medAffiOutCommonMapper.auditMedAffiOutCommon(entityList);
			...
			logger.error(e.getMessage(), e);
			throw new SysException("{\"error\":\"操作失败\"}");
			//return "{\"error\":\"审核失败 数据库异常 请联系管理员! 方法 auditMedAffiOutCommon\"}";
		}
	...
	*/
	...
	public String unAuditMedAffiOutCommon(List<Map<String, Object>> entityList) throws DataAccessException {
		try {	
			...
			medAffiOutCommonMapper.unAuditMedAffiOutCommon(entityList);
			...
			logger.error(e.getMessage(), e);
			throw new SysException("{\"error\":\"操作失败\"}");
			//return "{\"error\":\"销审失败 数据库异常 请联系管理员! 方法 unAuditMedAffiOutCommon\"}";
		}	
	}
	...
	*/
	...
	public String deleteMedAffiOutCommon(List<Map<String, Object>> entityList) throws DataAccessException {
		try {	
			...
			//2、根据参数08011判断是否倒序删除，如果是，则只能删除单据号最大的出库单。否则，医院人为控制单据连续性。
			...
			int flag = medAffiOutMapper.queryNotByUserId(mapVo);
			if(flag > 0 ){
			...
			//	medAffiOutMapper.deleteBatchMedAffiTranRela(mapVo);
			
			//5、删除明细表
				medAffiOutMapper.deleteBatchMedAffiOutDetail(entityList);
			//6、删除主表
				medAffiOutMapper.deleteBatchMedAffiOutMain(entityList);
	
			return "{\"msg\":\"操作成功.\",\"state\":\"true\"}";
		}catch (Exception e) {
			logger.error(e.getMessage(), e);
			throw new SysException("{\"error\":\"操作失败\"}");
			//return "{\"error\":\"删除失败 数据库异常 请联系管理员! 方法 deleteMedAffiOutCommon\"}";
		}	
	}
	...
	*/
	...
	public String queryMedAffiOutByInvHold(Map<String, Object> entityMap) throws DataAccessException {
		...
		sysPage = (SysPage) entityMap.get("sysPage");
		if (sysPage.getTotal() == -1) {
			List<Map<String, Object>> list = (List<Map<String, Object>>) medAffiOutCommonMapper.queryMedAffiOutByInvHold(entityMap);
			return ChdJson.toJsonLower(list);
		} else {
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<Map<String, Object>> list = (List<Map<String, Object>>) medAffiOutCommonMapper.queryMedAffiOutByInvHold(entityMap, rowBounds);
			PageInfo page = new PageInfo(list);
			return ChdJson.toJsonLower(list, page.getTotal());
		}		
	}
	...
	/**
	 * 代销出库 选择药品--查询 med_affi_fifo 查有批次结存表
	 * @param  entityList
	 * @return String JSON
	 * @throws DataAccessException
	*/
	...
	public String queryMedAffiOutByFifoBalance(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {	
			...
			if (flag!=null && "fifo".equals(flag)) {//没有选择明细数据 走先进先出
				List<Map<String, Object>> list = (List<Map<String, Object>>) medAffiOutCommonMapper.queryMedAffiOutByFifoBalance(entityMap);	
				if (list.size() > 0) {
				...
				try {
					while (detail_it.hasNext()) {					
						...
						List<Map<String, Object>> list = (List<Map<String, Object>>) medAffiOutCommonMapper.queryMedAffiOutByFifoBalance(mapDetailVo);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) medAffiOutCommonMapper.queryMedAffiOutByFifoBalance(entityMap,rowBounds);
	...
	public String copyMedAffiOutCommon(List<Map<String,Object>> entityList)throws DataAccessException{
		try {
			...
			for(Map<String, Object> tmp : entityList){				
				Map<String, Object> mom = (Map<String, Object>) medAffiOutMapper.queryByCode(tmp);
				...
				mainMap.put("table_code", "MED_AFFI_OUT");
				mainMap.put("out_no", medCommonService.getMedNextNo(mainMap));					
				mainMap.put("out_id",medAffiOutMapper.queryMedAffiOutMainSeq());
				mainMap.put("state", "1");
				...
				//查询明细表
				List<Map<String, Object>> list_detail = (List<Map<String, Object>>)medAffiOutMapper.queryByCodeDetail(tmp);
				for(Map<String, Object> mod : list_detail){					
					...
					if(fifoMap.get(fifoKey) != null){
						...
						fifoList = toListMapLower((List<Map<String, Object>>) medCommonMapper.queryMedAffiOutDetailInvList(mapDetailVo));
					}
			...
			medAffiOutMapper.addMedAffiOutMainBatch(mainList);
			medAffiOutMapper.addMedAffiOutDetail(detailList);
			return "{\"msg\":\"复制成功.\",\"state\":\"true\"}";
		}catch (Exception e) {
			logger.error(e.getMessage(), e);
			throw new SysException("{\"error\":\"操作失败\"}");
			//return "{\"error\":\"复制失败 数据库异常 请联系管理员! 方法 copyMedAffiOutCommon\"}";
		}	
	}
	...
	public String offsetMedAffiOutCommon(List<Map<String, Object>> entityList) throws DataAccessException {
		...
		try {
			...
			for(Map<String, Object> tmp : entityList){				
				Map<String, Object> mom = (Map<String, Object>) medAffiOutMapper.queryByCode(tmp);				
				Map<String, Object> mainMap = defaultBeanToMap(mom);				
				Long out_id = medAffiOutMapper.queryMedAffiOutMainSeq();// 查询序列				
			...
			logger.error(e.getMessage(), e);
			throw new SysException("{\"error\":\"操作失败\"}");
			//return "{\"error\":\"冲账失败 数据库异常 请联系管理员! 方法 offsetMedAffiOutCommon\"}";
		}
	...
	public String confirmMedAffiOutCommon(List<Map<String, Object>> entityList) throws DataAccessException {
		try{
			/*
			    ...
			    (4)、30代销退库业务：判断药品出库数量是否能容纳这么多退库数量。
			    (5)、按照先进先出算法，将出库单数量写入物流出出库结存表 MED_FIFO_BALANCE的出库数量中；
			    (6)、同时，将当月出库数量累加到库存结余表：物资批次结余表 MED_BATCH_BALANCE；物资药品结存表 MED_BATCH_HOLD；代销药品结余表：MED_AFFI_BALANCE
		    ...
		    */  
			...
			for(Map<String, Object> mod : detailList){
				...
				medAffiFifo.put(mod.get("store_id").toString()+mod.get("inv_id")+mod.get("price")+mod.get("batch_no")+mod.get("batch_sn")+mod.get("bar_code")+mod.get("location_id"), mapDetail);
			...
			//------------------------------查询账表 取出相应数据 并且组织账表数据 MED_FIFO_BALANCE//med_affi_fifo ----------------------------------
			...
			for (String key : medAffiFifo.keySet()) {//循环当前药品的明细 key查询条件 取相应的值				
				...
				if(mfb_mb.get(key) !=null){
					...
					//帐表中没有该药品信息，提示库存不足！
					invMsg.append(medAffiFifo.get(key).get("inv_code")).append(" ").append(medAffiFifo.get(key).get("inv_name")).append(",");
					if(is_enough){
						is_enough = false;
					}
				}
			...
			if(is_enough){
				//------------------------------查询账表 取出相应数据 并且组织账表数据MED_BATCH_BALANCE// med_affi_batch----------------------------------
				...
				//------------------------------查询账表 取出相应数据 并且组织账表数据MED_INV_HOLD// med_affi_inv_hold----------------------------------
				...
				//------------------------------查询账表 取出相应数据 并且组织账表数据MED_INV_Batch  med_affi_balance----------------------------------
			...
			//修改状态为出库确认
			medAffiOutMapper.updateBatchConfirm(listMainUpdate);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return medAffiOutMapper.queryByCode(entityMap);
	}
	...
	public Map<String, Object> queryAffiOutIds(Map<String, Object> entityMap) throws DataAccessException {
		...
		String out_idUp = medAffiOutCommonMapper.queryAffiUpOutId(entityMap);//上一张ID
		if(out_idUp == null){
		...
		String out_idNext = medAffiOutCommonMapper.queryAffiNextOutId(entityMap); //下一张ID
		if(out_idNext == null){
	...
	@Override
	public String queryAffiOutDetailById(Map<String, Object> entityMap) throws DataAccessException {
		SysPage sysPage = new SysPage();
		sysPage = (SysPage) entityMap.get("sysPage");
		if (sysPage.getTotal() == -1) {
			List<Map<String, Object>> list = (List<Map<String, Object>>) medAffiOutMapper.queryAffiOutDetailById(entityMap);
			return ChdJson.toJsonLower(list);
		} else {
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<Map<String, Object>> list = (List<Map<String, Object>>) medAffiOutMapper.queryAffiOutDetailById(entityMap, rowBounds);
			PageInfo page = new PageInfo(list);
			return ChdJson.toJsonLower(list, page.getTotal());
		}
	}
	...
	//出库模板打印（包含主从表）
		...
		@Override
		public String medAffiOutCommonService(Map<String, Object> entityMap)
				throws DataAccessException {
			try {
				//查询入库主表
				if("1".equals(String.valueOf(entityMap.get("p_num")))){ 
					List<Map<String, Object>> map =medAffiOutCommonMapper.queryMedAffiOutPrintTemlateByMainBatch(entityMap);
					List<Map<String,Object>> list=medAffiOutCommonMapper.queryMedAffiOutPrintTemlateByDetail(entityMap);
					return superPrintService.getBatchListByPrintTemplateJson(entityMap,map,list);
				}else{
					//查询出库主表
					Map<String,Object> map=medAffiOutCommonMapper.queryMedAffiOutPrintTemlateByMain(entityMap);
		 ...
		 */
		@Override
		public String queryMedAffiInvBatchList(Map<String, Object> entityMap) throws DataAccessException {
			SysPage sysPage = new SysPage();
			sysPage = (SysPage) entityMap.get("sysPage");

			if (sysPage.getTotal() == -1) {
				
				List<Map<String, Object>> list = JsonListMapUtil.toListMapLower(medAffiOutCommonMapper.queryMedAffiInvBatchList(entityMap));
				
				return ChdJson.toJson(list);
			} else {
				
				RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
				List<Map<String, Object>> list = JsonListMapUtil.toListMapLower(medAffiOutCommonMapper.queryMedAffiInvBatchList(entityMap, rowBounds));
				PageInfo page = new PageInfo(list);
		...
		public String queryAffiOutInvListByChoiceInv(List<Map<String,Object>> entityList) throws DataAccessException{
			try {
				return medCommonService.getAffiInvJsonByAffiInvList(entityList);
		...
		public String queryDetails(Map<String,Object> entityMap) throws DataAccessException{
			...
			if (sysPage.getTotal()==-1){
				List<Map<String,Object>> list = medAffiOutCommonMapper.queryDetails(entityMap);			
				return ChdJson.toJsonLower(list);
			}else{
				RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
				List<Map<String,Object>> list = medAffiOutCommonMapper.queryDetails(entityMap, rowBounds);
				PageInfo page = new PageInfo(list);			
				return ChdJson.toJsonLower(list, page.getTotal());
			}
		}
		...
		@Override
		public Map<String, Object> medAffiOutCommonTemplate(Map<String, Object> entityMap)
				throws DataAccessException {
			try {
				
				Map<String,Object> reMap=new HashMap<String,Object>();
				WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext();
				MedAffiOutCommonMapper medAffiOutCommonMapper = (MedAffiOutCommonMapper)context.getBean("medAffiOutCommonMapper");
