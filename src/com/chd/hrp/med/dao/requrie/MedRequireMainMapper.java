...
public interface MedRequireMainMapper extends SqlMapper{
	...
	public List<Map<String, Object>> queryMedRequireMainByReqCode(Map<String, Object> map);

	public List<Map<String, Object>> queryMedRequireMainDetailByReqCode(Map<String, Object> map);
