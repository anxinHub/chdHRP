...
package com.chd.hrp.med.dao.affi.back;
import java.util.*;
...
public interface MedAffiBackMapper extends SqlMapper{
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<Map<String,Object>> queryMedAffiBackDetailByCode(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public String existsMedAffiBackInvIsEnough(List<Map<String,Object>> entityList) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<Map<String,Object>> queryMedAffiInDetailForCopy(Map<String,Object> entityMap) throws DataAccessException;
