...
public interface MedFacAttrMapper extends SqlMapper{
	/**
	 * @Description 
	 * 添加050115 生产厂商附属表<BR> 
	 * @param  entityMap
	...
	*/
	public int addMedFacAttr(Map<String,Object> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int addBatchMedFacAttr(List<Map<String, Object>> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int updateMedFacAttr(Map<String,Object> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int updateBatchMedFacAttr(List<Map<String, Object>> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int deleteMedFacAttr(Map<String,Object> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int deleteBatchMedFacAttr(List<Map<String, Object>> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<AssFacAttr> queryMedFacAttr(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<AssFacAttr> queryMedFacAttr(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	/**
	 * @Description 
	 * 获取050115 生产厂商附属表<BR> 
	 * @param  entityMap
	...
	*/
	...
	public int queryFacAttrExist(Map<String, Object> mapVo) throws DataAccessException;
