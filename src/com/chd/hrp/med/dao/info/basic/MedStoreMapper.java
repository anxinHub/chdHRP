...
public interface MedStoreMapper extends SqlMapper{
	/**
	 * 查看变更记录
	 * @param entityMap
	 * @param rowBounds
	 * @return
	 */
	public List<?> queryMedStoreDict(Map<String, Object> entityMap, RowBounds rowBounds) throws DataAccessException;
