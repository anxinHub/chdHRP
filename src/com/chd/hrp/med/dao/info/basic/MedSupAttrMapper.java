 ...
 * @Version: 1.0
 *  com.chd.hrp.med.dao.infomaint.basicset.MedSupAttrMapper
 */
public interface MedSupAttrMapper extends SqlMapper{
	...
	*/
	public int addMedSupAttr(Map<String,Object> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int addBatchMedSupAttr(List<Map<String, Object>> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int updateMedSupAttr(Map<String,Object> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int updateBatchMedSupAttr(List<Map<String, Object>> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int deleteMedSupAttr(Map<String,Object> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int deleteBatchMedSupAttr(List<Map<String, Object>> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<AssSupAttr> queryMedSupAttr(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<AssSupAttr> queryMedSupAttr(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	/**
	 * @Description 
	 * 获取050113 供应商附属表<BR> 
	 * @param  entityMap
