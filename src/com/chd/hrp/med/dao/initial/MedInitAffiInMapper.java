...
package com.chd.hrp.med.dao.initial;
...
public interface MedInitAffiInMapper extends SqlMapper{
	 ...
	 * @throws DataAccessException
	*/
	public int confirmMedInitAffiInBatch(List<Map<String, Object>> entityMap)throws DataAccessException;
