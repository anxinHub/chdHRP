...
public class MedSx implements Serializable {
	...
	private String med_sx_id;
	private String med_sx_name;
	private int is_stop;
	private String note;
	/**
	 * @return the group_id
	 ...
	 */
	public String getMed_sx_id() {
		return med_sx_id;
	}
	/**
	 * @param med_sx_id the med_sx_id to set
	 */
	public void setMed_sx_id(String med_sx_id) {
		this.med_sx_id = med_sx_id;
	}
	/**
	 * @return the med_sx_name
	 */
	public String getMed_sx_name() {
		return med_sx_name;
	}
	/**
	 * @param med_sx_name the med_sx_name to set
	 */
	public void setMed_sx_name(String med_sx_name) {
		this.med_sx_name = med_sx_name;
	}
	/**
	 * @return the is_stop
	 */
