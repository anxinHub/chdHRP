...
public interface MedPayDetailService {
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public String addBatchMedPayDetail(List<Map<String, Object>> entityMap)throws DataAccessException;
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public String updateBatchMedPayDetail(List<Map<String, Object>> entityMap)throws DataAccessException;
	/**
	 * @Description 
	 * 删除保存一个付款单对应的发票<BR> 
	 * @param  entityMap
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public String deleteBatchMedPayDetail(List<Map<String, Object>> entityMap)throws DataAccessException;
	...
	*/
	 ...
	 * @throws DataAccessException
	 */
	public String queryMedPayDetailNew(Map<String, Object> page) throws DataAccessException;
}
