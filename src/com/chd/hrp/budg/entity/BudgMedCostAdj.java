...
public class BudgMedCostAdj implements Serializable {
  ...
  /**
	...
	*/
	...
	public Date getLast_check_code() {
		return last_check_code;
	}

	public void setLast_check_code(Date last_check_code) {
		this.last_check_code = last_check_code;
	}
