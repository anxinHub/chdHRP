...
public class BudgFun implements Serializable {
	...
	private String  budg_fun_sql; //函数sql
  ...
  /**
	...
	*/
	...
	public String getBudg_fun_sql() {
		return budg_fun_sql;
	}

	public void setBudg_fun_sql(String budg_fun_sql) {
		this.budg_fun_sql = budg_fun_sql;
	}
