...
public class BudgMedRiskFund implements Serializable {
  ...
  /**
	...
	* @param value 
	*/
	public void setIncome_budg(Double value) {
		this.income_budg = value;
	}
	...
	* @return Double
	*/
	public Double getIncome_budg() {
		return this.income_budg;
	}
	/**
	* 设置 提取比例
	* @param value 
