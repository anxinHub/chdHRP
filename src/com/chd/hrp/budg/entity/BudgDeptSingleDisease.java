...
public class BudgDeptSingleDisease implements Serializable {
	 ...
	 */
	private Long hos_id;
	private Long dept_code_old;
	private String disease_code_old;
	
	public Long getDept_id_old() {
		return dept_code_old;
	}

	public void setDept_id_old(Long dept_id_old) {
		this.dept_code_old = dept_id_old;
	}
