 ...
 * 
 * @Description:
 * 医保类型性质（INSURANCE_NATURE）取自系统字典表：01医保，02自费
 * @Table:
 * BUDG_YB_TYPE_DICT
 * @Author: bell
...
public class BudgYbTypeDict implements Serializable {
  ...
  /**
	...
	* @param value 
	*/
	public void setInsurance_name(String value) {
	...
	* @param value 
	*/
	public void setInsurance_nature(String value) {
		this.insurance_nature = value;
	}
