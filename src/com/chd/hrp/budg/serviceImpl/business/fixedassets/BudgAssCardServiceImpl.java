...
@Service("budgAssCardService")
public class BudgAssCardServiceImpl implements BudgAssCardService {

	private static Logger logger = Logger.getLogger(BudgAssCardServiceImpl.class);
	//引入DAO操作
	@Resource(name = "budgAssCardMapper")
	private final BudgAssCardMapper budgAssCardMapper = null;
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			String naturs_code =budgAssCardMapper.querynatursCode(entityMap);
			...
			int state = budgAssCardMapper.add(entityMap);
			...
			int i =budgAssCardMapper.addBudgAssCardSource(detailAddList);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgAssCardMapper.addBatch(entityList);
	...
	*/
	...
	public String addBudgAssCardSource(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgAssCardMapper.addBudgAssCardSource(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			Date in_date = new SimpleDateFormat("yyyy-MM-dd").parse( entityMap.get("in_date").toString());
			entityMap.put("in_date", in_date);
		  int state = budgAssCardMapper.update(entityMap);
		  ...
		  List<Map<String,Object>> detailAddList = new ArrayList<Map<String,Object>>();
			...
			while (it.hasNext()) {
				...
				if( jsonObj.get("source_id") != null && !"".equals(jsonObj.get("source_id"))){
					...
					detailMap.put("cur_money", jsonObj.get("cur_money"));
					detailMap.put("fore_money", jsonObj.get("fore_money"));
					Map<String,Object> assCardSourceMap=budgAssCardMapper.queruBudgAssCardSource(detailMap);
					if (assCardSourceMap!=null) {
						detailAddList.add(detailMap);
						budgAssCardMapper.deleteBudgAssCardSource(detailMap);
					}
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  budgAssCardMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = budgAssCardMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgAssCardMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<BudgAssCard> list = (List<BudgAssCard>)budgAssCardMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<Map<String,Object>> list = (List<Map<String, Object>>) budgAssCardMapper.query(entityMap);
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>)budgAssCardMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return budgAssCardMapper.queryByCode(entityMap);
	}
	...
	*/
	...
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return budgAssCardMapper.queryByUniqueness(entityMap);
	}
	...
	*/
	...
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return budgAssCardMapper.queryExists(entityMap);
	}
	@Override
	public String queryBudgAssCardSourceBySourceId(Map<String, Object> mapVo) {
		List<Map<String,Object>> list = (List<Map<String, Object>>) budgAssCardMapper.queryBudgAssCardSourceBySourceId(mapVo);
	...
	public int queryDataExist(Map<String,Object> entityMap)throws DataAccessException{
		return budgAssCardMapper.queryDataExist(entityMap);
	}
	/**
	...
	public List<Map<String, Object>> queryAssDictData(Map<String, Object> map) throws DataAccessException {
		return budgAssCardMapper.queryAssDictData(map);
	}
	...
	public List<Map<String, Object>> queryDeptData(Map<String, Object> map) throws DataAccessException {
		return budgAssCardMapper.queryDeptData(map);
	}
	...
	public List<Map<String, Object>> queryStoreData(Map<String, Object> map) throws DataAccessException {
		return budgAssCardMapper.queryStoreData(map);
	}
	 ...
	 */
	@Override
	public List<String> queryDeprMethod(Map<String, Object> map) throws DataAccessException {
		return budgAssCardMapper.queryDeprMethod(map);
	}
	 ...
	 */
	@Override
	public List<Map<String, Object>> querySourceData(Map<String, Object> map) throws DataAccessException {
		
		return budgAssCardMapper.querySourceData(map);
	}
	...
	public int queryDataExistSource(Map<String,Object> entityMap)throws DataAccessException{
		return budgAssCardMapper.queryDataExistSource(entityMap);
	}
	
	@Override
	public String collectData(Map<String, Object> entityMap) throws DataAccessException {
		try {
			budgAssCardMapper.insertCollectData(entityMap);
