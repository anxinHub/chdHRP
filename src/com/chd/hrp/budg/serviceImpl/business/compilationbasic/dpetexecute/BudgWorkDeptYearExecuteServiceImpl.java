...
@Service("budgWorkDeptYearExecuteService")
public class BudgWorkDeptYearExecuteServiceImpl implements BudgWorkDeptYearExecuteService {

	private static Logger logger = Logger.getLogger(BudgWorkDeptYearExecuteServiceImpl.class);
	//引入DAO操作
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象科室业务执行数据
		BudgWorkDeptYearExecute budgWorkDeptYearExecute = queryByCode(entityMap);

		if (budgWorkDeptYearExecute != null) {
		...
		try {
			...
			int state = budgWorkDeptYearExecuteMapper.add(entityMap);
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try{
			...
			for(Map<String,Object> item : entityList){
				...
				int count =budgWorkDeptYearExecuteMapper.queryDataExists(item);
	
				if (count>0) {
	
					str += item.get("year")+"年 "+item.get("dept_id")+"科室 "+item.get("index_code")+ "指标;";
				}
			}
			if(str != ""){
				...
				budgWorkDeptYearExecuteMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = budgWorkDeptYearExecuteMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgWorkDeptYearExecuteMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = budgWorkDeptYearExecuteMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgWorkDeptYearExecuteMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<BudgWorkDeptExecute> list = (List<BudgWorkDeptExecute>)budgWorkDeptYearExecuteMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgWorkDeptYearExecuteMapper.query(entityMap);
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgWorkDeptYearExecuteMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return budgWorkDeptYearExecuteMapper.queryByCode(entityMap);
	}
	...
	*/
	...
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return budgWorkDeptYearExecuteMapper.queryByUniqueness(entityMap);
	}
	...
	*/
	...
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return budgWorkDeptYearExecuteMapper.queryExists(entityMap);
	}
	@Override
	public String budgWorkDeptYearExecuteImport(Map<String, Object> map) throws DataAccessException {
		 try{
				...
				//查询 指标 基本信息  
				List<Map<String,Object>> listSourceIdDict = budgWorkDeptYearExecuteMapper.queryIndexData(entityMap);		
				...
				//查询  末级科室 基本信息 
				List<Map<String,Object>> listDeptIdDict = budgWorkDeptYearExecuteMapper.queryDeptData(entityMap);		
				// 判断 科室 是否存在用 map key：name ， value : id、code等信息
				...
				for( int i = 0; i < returnList.size(); i++ ){
					...
					for(int j = i + 1 ; j < returnList.size(); j++){
						...
						if(returnList.get(i).get("dept_name").equals(returnList.get(j).get("dept_name")) && returnList.get(i).get("year").equals(returnList.get(j).get("year")) && returnList.get(i).get("index_name").equals(returnList.get(j).get("index_name"))){
							
							err_sb.append(returnList.get(i).get("dept_name")+"部门名称,"+returnList.get(i).get("year")+"年度,"+returnList.get(i).get("index_name")+"指标编码");  
						}
					}
	...
	public List<Map<String, Object>> queryDeptData(Map<String, Object> paraMap) throws DataAccessException {
		...
		return budgWorkDeptYearExecuteMapper.queryDeptData(paraMap);
	}
	@Override
	public List<Map<String, Object>> queryIndexData(Map<String, Object> paraMap) throws DataAccessException {

		return budgWorkDeptYearExecuteMapper.queryIndexData(paraMap);
	}
	
	@Override
	public List<Map<String, Object>> getPrintData(Map<String, Object> mapVo)
			throws DataAccessException {
		List<Map<String,Object>> list = (List<Map<String,Object>>) budgWorkDeptYearExecuteMapper.query(mapVo);
		return list;
	}
}
