...
@Service("budgWorkHosYearExecuteService")
public class BudgWorkHosYearExecuteServiceImpl implements BudgWorkHosYearExecuteService {

	private static Logger logger = Logger.getLogger(BudgWorkHosYearExecuteServiceImpl.class);
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		int count= budgWorkHosYearExecuteMapper.queryDateExist(entityMap);
		...
		try {
			...
			int state = budgWorkHosYearExecuteMapper.add(entityMap);
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {		
			for( Map<String,Object> item : entityList){
				...
				int count= budgWorkHosYearExecuteMapper.queryDateExist(item);
				
				if(count > 0 ){
					
					str += item.get("year")+"年度 " + item.get("index_name") +"指标 ;" ;
				}	
			}
			
			if("".equals(str)){
				
				budgWorkHosYearExecuteMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = budgWorkHosYearExecuteMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgWorkHosYearExecuteMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = budgWorkHosYearExecuteMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgWorkHosYearExecuteMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<BudgWorkHosExecute> list = (List<BudgWorkHosExecute>)budgWorkHosYearExecuteMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgWorkHosYearExecuteMapper.query(entityMap);
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgWorkHosYearExecuteMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return budgWorkHosYearExecuteMapper.queryByCode(entityMap);
	}
	...
	*/
	...
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return budgWorkHosYearExecuteMapper.queryByUniqueness(entityMap);
	}
	...
	*/
	...
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		...
		return budgWorkHosYearExecuteMapper.queryExists(entityMap);
	}
	
	//判断指标编码是否存在
	public int queryIndexCode(Map<String, Object> mapVo) throws DataAccessException {
		return budgWorkHosYearExecuteMapper.queryIndexCode(mapVo);
	}
	@Override
	public String budgWorkHosYearExecuteImport(Map<String, Object> map) throws DataAccessException {
		 try{
				...
				for( int i = 0; i < returnList.size(); i++ ){
					...
					for(int j = i + 1 ; j < returnList.size(); j++){
						...
						if(returnList.get(i).get("year").equals(returnList.get(j).get("year")) && returnList.get(i).get("index_name").equals(returnList.get(j).get("index_name"))){
							
							err_sb.append(returnList.get(i).get("year")+"年度,"+returnList.get(i).get("index_name")+"指标编码");  
						}
					}
	...
	public List<Map<String, Object>> getPrintData(Map<String, Object> mapVo)
			throws DataAccessException {
		List<Map<String,Object>> list = (List<Map<String,Object>>)budgWorkHosYearExecuteMapper.query(mapVo);
		return list;
	}
