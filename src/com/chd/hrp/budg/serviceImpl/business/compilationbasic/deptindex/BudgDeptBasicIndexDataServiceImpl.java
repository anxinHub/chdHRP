...
package com.chd.hrp.budg.serviceImpl.business.compilationbasic.deptindex;
...
import com.chd.hrp.budg.dao.business.compilationbasic.deptindex.BudgDeptBasicIndexDataMapper;
...
@Service("budgDeptBasicIndexDataService")
public class BudgDeptBasicIndexDataServiceImpl implements BudgDeptBasicIndexDataService {

	private static Logger logger = Logger.getLogger(BudgDeptBasicIndexDataServiceImpl.class);
	//引入DAO操作
	@Resource(name = "budgDeptBasicIndexDataMapper")
	private final BudgDeptBasicIndexDataMapper budgDeptBasicIndexDataMapper = null;
	...
	public String save(List<Map<String, Object>> listVo) throws DataAccessException{
		...
		try {
			...
			if(addList.size()>0){
				//批量 查询 添加数据是否已存在
				String  str = budgDeptBasicIndexDataMapper.queryDataExistList(addList) ;
				
				if(str == null){
					
					int count = budgDeptBasicIndexDataMapper.addBatch(addList);
			...
			if(updateList.size()>0){
				...
				int state = budgDeptBasicIndexDataMapper.updateBatch(updateList);
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象科室基本指标数据维护
		BudgDeptBasicIndexData budgDeptBasicIndexData = queryByCode(entityMap);

		if (budgDeptBasicIndexData != null) {
		...
		try {
			...
			int state = budgDeptBasicIndexDataMapper.add(entityMap);
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			for(Map<String,Object> item :entityList){
				...
				int count  = budgDeptBasicIndexDataMapper.queryDataExist(item);
			...
			if(str != ""){
				...
				budgDeptBasicIndexDataMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = budgDeptBasicIndexDataMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  budgDeptBasicIndexDataMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = budgDeptBasicIndexDataMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgDeptBasicIndexDataMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<BudgDeptBasicIndexData> list = (List<BudgDeptBasicIndexData>)budgDeptBasicIndexDataMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<BudgDeptBasicIndexData> list = (List<BudgDeptBasicIndexData>)budgDeptBasicIndexDataMapper.query(entityMap);
			...
			List<BudgDeptBasicIndexData> list = (List<BudgDeptBasicIndexData>)budgDeptBasicIndexDataMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return budgDeptBasicIndexDataMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return BudgDeptBasicIndexData
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return budgDeptBasicIndexDataMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<BudgDeptBasicIndexData>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return budgDeptBasicIndexDataMapper.queryExists(entityMap);
	}
	...
	public String queryBudgDept(Map<String, Object> mapVo)	throws DataAccessException {
		...
		return JSON.toJSONString(budgDeptBasicIndexDataMapper.queryBudgDept(mapVo, rowBounds));
	}
	//	判断数据是否存在
	public int queryDataExist(Map<String, Object> mapVo) throws DataAccessException {
		// TODO Auto-generated method stub
		return budgDeptBasicIndexDataMapper.queryDataExist(mapVo);
	}
	 ...
	 */
	@Override
	public Map<String, Object> queryDeptID(Map<String, Object> mapVo) {
		
		return budgDeptBasicIndexDataMapper.queryDeptID(mapVo);
	}
	...
	public List<Map<String, Object>> queryBudgDeptIndexData(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgDeptBasicIndexDataMapper.queryBudgDeptIndexData(mapVo);
	...
	*/
	@Override
	public String importBudgBasicDeptIndex(Map<String, Object> map) throws DataAccessException {
        try{
			...
			entityMap.put("index_nature", "02");//指标性质（INDEX_NATURE）01医院02科室
			...
			for(Map<String,List<String>> item : liData ){
				...
				List<String> amount = item.get("预算值") ;
				...
				if(amount == null){
					...
					return "{\"warn\":\"" + amount.get(0) + ",预算值为空！\",\"state\":\"false\",\"row_cell\":\"" + amount.get(0) + "\"}";
					 ...
					 try{
						 ...
						 return "{\"warn\":\"" + amount.get(0) + ",预算值输入不合法,只能输入数字！\",\"state\":\"false\",\"row_cell\":\"" + amount.get(0) + "\"}";
					  }
			...
			for( int i = 1; i < returnList.size(); i++ ){
				...
				for(int j = i + 1 ; j < returnList.size(); j++){
					...
					if(returnList.get(i).get("dept_name").equals(returnList.get(j).get("dept_name"))&&returnList.get(i).get("year").equals(returnList.get(j).get("year")) && returnList.get(i).get("index_code").equals(returnList.get(j).get("index_code")) ){
						
						err_sb.append(returnList.get(i).get("dept_name")+"部门名称,"+returnList.get(i).get("year")+"年度,"+returnList.get(i).get("index_name")+"指标");
					}
				}
	...
	public String collectBudgDeptBasicIndexData(Map<String, Object> mapVo) throws DataAccessException {
		...
		try {
			List<Map<String,Object>> list = (List<Map<String, Object>>) budgDeptBasicIndexDataMapper.query(mapVo);
			...
			if(list.size()>0){
				...
				budgDeptBasicIndexDataMapper.updateBatch(list);
