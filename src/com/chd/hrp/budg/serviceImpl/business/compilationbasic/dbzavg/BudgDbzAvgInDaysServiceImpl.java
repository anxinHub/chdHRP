...
package com.chd.hrp.budg.serviceImpl.business.compilationbasic.dbzavg;
...
import com.chd.hrp.budg.dao.business.compilationbasic.dbzavg.BudgDbzAvgInDaysMapper;
...
@Service("budgDbzAvgInDaysService")
public class BudgDbzAvgInDaysServiceImpl implements BudgDbzAvgInDaysService {

	private static Logger logger = Logger.getLogger(BudgDbzAvgInDaysServiceImpl.class);
	//引入DAO操作
	@Resource(name = "budgDbzAvgInDaysMapper")
	private final BudgDbzAvgInDaysMapper budgDbzAvgInDaysMapper = null;
	...
	public String save(List<Map<String, Object>> listVo) throws DataAccessException{
		...
		try {
			...
			if(addList.size()>0){
				//批量 查询 添加数据是否已存在
				String  str = budgDbzAvgInDaysMapper.queryDataExistList(addList) ;
				
				if(str == null){
					
					int count = budgDbzAvgInDaysMapper.addBatch(addList);
			...
			if(updateList.size()>0){
				...
				int state = budgDbzAvgInDaysMapper.updateBatch(updateList);
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			int state = budgDbzAvgInDaysMapper.add(entityMap);
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			for(Map<String,Object> item : entityList){
				...
				int  count  = budgDbzAvgInDaysMapper.queryDataExist(item);
				
				if(count >  0){
					
					str += "医保类型:" + item.get("insurance_code") + " 医保单病种:" + item.get("disease_code") ;
				}
			}
			...
			if(str != ""){
				...
				budgDbzAvgInDaysMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = budgDbzAvgInDaysMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  budgDbzAvgInDaysMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = budgDbzAvgInDaysMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgDbzAvgInDaysMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<BudgDbzAvgInDays> list = (List<BudgDbzAvgInDays>)budgDbzAvgInDaysMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgDbzAvgInDaysMapper.query(entityMap);
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgDbzAvgInDaysMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return budgDbzAvgInDaysMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return BudgDbzAvgInDays
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return budgDbzAvgInDaysMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<BudgDbzAvgInDays>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return budgDbzAvgInDaysMapper.queryExists(entityMap);
	}
	...
	public int queryBudgInsuranceCode(Map<String, Object> entityMap) throws DataAccessException {
		...
		return  budgDbzAvgInDaysMapper.queryBudgInsuranceCode(entityMap); 
	...
	public int queryBudgDiseaseCode(Map<String, Object> entityMap) throws DataAccessException {
		...
		return  budgDbzAvgInDaysMapper.queryBudgDiseaseCode(entityMap); 
	 ...
	 * @throws Exception
	 */
	public String queryBudgYBTP(Map<String, Object> entityMap) throws DataAccessException {
      RowBounds rowBounds = new RowBounds(0, 20);
		...
		return JSON.toJSONString(budgDbzAvgInDaysMapper.queryBudgYBTP(entityMap, rowBounds));
	}
	/**
	 * 根据主键查询数据是否存在
	 */
	...
	public int queryDataExist(Map<String, Object> mapVo)	throws DataAccessException {
		...
		return  budgDbzAvgInDaysMapper.queryDataExist(mapVo);
	...
	public List<Map<String, Object>> queryDate(Map<String, Object> mapVo) throws DataAccessException {
		...
		return  budgDbzAvgInDaysMapper.queryDate(mapVo);
	...
	public String queryBudgSingleDC(Map<String, Object> entityMap) throws DataAccessException {
		...
		return  JSON.toJSONString(budgDbzAvgInDaysMapper.queryBudgSingleDC(entityMap,rowBounds)); 
	}
	@Override
	public String budgDbzAvgInDaysImportNewPage(Map<String, Object> map) throws DataAccessException {
         try{
			...
			for(Map<String,List<String>> item : liData ){
				...
				List<String> avg_in_days = item.get("平均住院日(天)【必填】") ;
               ...
               if(avg_in_days == null){
					...
					return "{\"warn\":\"" + avg_in_days.get(0) + ",平均住院日为空！\",\"state\":\"false\",\"row_cell\":\"" + avg_in_days.get(0) + "\"}";
					
				}else{
					
					 try{
						    Double.parseDouble((avg_in_days.get(1)));
						   
					 }catch(NumberFormatException e){
						 
						 return "{\"warn\":\"" + avg_in_days.get(0) + ",平均住院日输入不合法,只能输入数字！\",\"state\":\"false\",\"row_cell\":\"" + avg_in_days.get(0) + "\"}";
					  }
				...
				returnMap.put("avg_in_days", avg_in_days.get(1));
			...
			for( int i = 0; i < returnList.size(); i++ ){
				...
				for(int j = i + 1 ; j < returnList.size(); j++){
					...
					if(returnList.get(i).get("disease_name").equals(returnList.get(j).get("disease_name")) &&returnList.get(i).get("year").equals(returnList.get(j).get("year")) && returnList.get(i).get("insurance_name").equals(returnList.get(j).get("insurance_name"))){
