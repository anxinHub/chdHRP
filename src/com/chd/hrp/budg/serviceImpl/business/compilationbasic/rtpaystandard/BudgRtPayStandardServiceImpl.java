...
package com.chd.hrp.budg.serviceImpl.business.compilationbasic.rtpaystandard;
...
import com.chd.hrp.budg.dao.business.compilationbasic.rtpaystandard.BudgRtPayStandardMapper;
...
@Service("budgRtPayStandardService")
public class BudgRtPayStandardServiceImpl implements BudgRtPayStandardService {

	private static Logger logger = Logger.getLogger(BudgRtPayStandardServiceImpl.class);
	//引入DAO操作
	@Resource(name = "budgRtPayStandardMapper")
	private final BudgRtPayStandardMapper budgRtPayStandardMapper = null;
	...
	public String save(List<Map<String, Object>> listVo) throws DataAccessException{
		...
		try {
			...
			if(addList.size()>0){
				//批量 查询 添加数据是否已存在
				String  str = budgRtPayStandardMapper.queryDataExistList(addList) ;
				
				if(str == null){
					
					int count = budgRtPayStandardMapper.addBatch(addList);
			...
			if(updateList.size()>0){
				...
				int state = budgRtPayStandardMapper.updateBatch(updateList);
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			int state = budgRtPayStandardMapper.add(entityMap);
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			for(Map<String,Object> item : entityList){
				...
				int count  = budgRtPayStandardMapper.queryDataExist(item);
				
				if( count > 0 ){
					str += item.get("year") + "年度 " + item.get("insurance_name") + "医保类型;";
				}
			...
			if(str != ""){
				...
				budgRtPayStandardMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = budgRtPayStandardMapper.update(entityMap);
	...
	*/
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  budgRtPayStandardMapper.updateBatch(entityList);
	...
	*/
    ...
    try {
			...
			int state = budgRtPayStandardMapper.delete(entityMap);
	...
	*/
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgRtPayStandardMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<BudgRtPayStandard> list = (List<BudgRtPayStandard>)budgRtPayStandardMapper.queryExists(mapVo);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgRtPayStandardMapper.query(entityMap);
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgRtPayStandardMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return budgRtPayStandardMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return BudgRtPayStandard
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return budgRtPayStandardMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<BudgRtPayStandard>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		
		return budgRtPayStandardMapper.queryExists(entityMap);
	...
	public int queryDataExist(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgRtPayStandardMapper.queryDataExist(mapVo);
	...
	public int queryInsuranceCodeExist(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgRtPayStandardMapper.queryInsuranceCodeExist(mapVo);
	...
	public List<Map<String, Object>> queryData(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgRtPayStandardMapper.queryData(mapVo);
	}
	...
	public String queryBudgYBTY(Map<String, Object> entityMap) throws DataAccessException {
		...
		return JSON.toJSONString(budgRtPayStandardMapper.queryBudgYBTY(entityMap, rowBounds));
	}
	@Override
	public String budgRTPaystandardImportNewPage(Map<String, Object> map) throws DataAccessException {
         try{
			...
			for(Map<String,List<String>> item : liData ){
				...
				List<String> outpatient_charge = item.get("门诊均次费用") ;
					
				List<String> day_bed_charge = item.get("床日均次费用") ;
				
				List<String> o_workload_budg = item.get("门诊业务量预算") ;
				
				List<String> i_workload_budg = item.get("床日业务量预算") ;
				...
				returnMap.put("outpatient_charge",outpatient_charge.get(1));
							
				returnMap.put("day_bed_charge",day_bed_charge.get(1));
				
				returnMap.put("o_workload_budg",o_workload_budg.get(1));
				
				returnMap.put("i_workload_budg",i_workload_budg.get(1));
