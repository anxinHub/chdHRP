...
import com.chd.hrp.budg.dao.business.intangible.BudgAssetPurIntangibleMapper;
 ...
 * @Version: 1.0
 */
@Service("budgAssetPurIntangibleService")
public class BudgAssetPurIntangibleServiceImpl implements BudgAssetPurService {

	private static Logger logger = Logger.getLogger(BudgAssetPurIntangibleServiceImpl.class);
	// 引入DAO操作
	@Resource(name = "budgAssetPurIntangibleMapper")
	private final BudgAssetPurIntangibleMapper budgAssetPurIntangibleMapper = null;

	@Override
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		try {
			budgAssetPurIntangibleMapper.add(entityMap);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		try {
			budgAssetPurIntangibleMapper.delete(entityMap);
	...
	public String deleteBatch(List<Map<String, Object>> entityMap) throws DataAccessException {
		try {
			budgAssetPurIntangibleMapper.deleteBatch(entityMap);
			return "{\"msg\":\"删除成功.\",\"state\":\"true\"}";
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
			throw new SysException(e.getMessage());
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			...
			List<BudgAssetNow> list = (List<BudgAssetNow>) budgAssetPurIntangibleMapper.query(entityMap);
			...
			List<BudgAssetNow> list = (List<BudgAssetNow>) budgAssetPurIntangibleMapper.query(entityMap, rowBounds);
	...
	public String collectBudgAssetPur(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			...
			entityList = budgAssetPurIntangibleMapper.queryCollectData(entityMap);
		} catch (Exception e) {
		...
		if (collectList != null && collectList.size() > 0) {
			try {
				budgAssetPurIntangibleMapper.addBatch(collectList);
			} catch (Exception e) {
				throw new SysException(e.getMessage());
			}
		}
