...
import com.chd.hrp.budg.dao.business.intangible.BudgAssetNowIntangibleMapper;
 ...
 * @Version: 1.0
 */
@Service("budgAssetNowIntangibleService")
public class BudgAssetNowIntangibleServiceImpl implements BudgAssetNowService {

	private static Logger logger = Logger.getLogger(BudgAssetNowIntangibleServiceImpl.class);
	// 引入DAO操作
	@Resource(name = "budgAssetNowIntangibleMapper")
	private final BudgAssetNowIntangibleMapper budgAssetNowIntangibleMapper = null;

	@Override
	public String add(Map<String, Object> entityMap) throws DataAccessException {
		try {
			budgAssetNowIntangibleMapper.add(entityMap);
	...
	public String delete(Map<String, Object> entityMap) throws DataAccessException {
		try {
			budgAssetNowIntangibleMapper.delete(entityMap);
	...
	public String deleteBatch(List<Map<String, Object>> entityMap) throws DataAccessException {
		try {
			budgAssetNowIntangibleMapper.deleteBatch(entityMap);
			return "{\"msg\":\"删除成功.\",\"state\":\"true\"}";
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
			throw new SysException(e.getMessage());
	...
	public String query(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			List<BudgAssetNow> list = (List<BudgAssetNow>) budgAssetNowIntangibleMapper.query(entityMap);
			return ChdJson.toJson(list);
		} else {
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<BudgAssetNow> list = (List<BudgAssetNow>) budgAssetNowIntangibleMapper.query(entityMap, rowBounds);
	...
	public List<Map<String, Object>> queryBudgAssCard(Map<String, Object> entityMap) throws DataAccessException {
		return budgAssetNowIntangibleMapper.queryBudgAssCard(entityMap);
	}
	...
	public String collectBudgAssetNow(Map<String, Object> entityMap) throws DataAccessException {
		...
		try {
			entityList = budgAssetNowIntangibleMapper.queryBudgAssCard(entityMap);
		} catch (Exception e) {
			throw new SysException(e.getMessage());
		}
		...
		if (collectList != null && collectList.size() > 0) {
			try {
				budgAssetNowIntangibleMapper.addBatch(collectList);
			} catch (Exception e) {
				throw new SysException(e.getMessage());
			}
		}
