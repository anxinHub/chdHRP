...
import com.chd.hrp.budg.dao.budgcost.elsecost.BudgElseCostAdjMapper;
...
@Service("budgElseCostAdjService")
public class BudgElseCostAdjServiceImpl implements BudgElseCostAdjService {

	private static Logger logger = Logger.getLogger(BudgElseCostAdjServiceImpl.class);
	//引入DAO操作
	@Resource(name = "budgElseCostAdjMapper")
	private final BudgElseCostAdjMapper budgElseCostAdjMapper = null;
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			int state = budgElseCostAdjMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgElseCostAdjMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			String state = budgElseCostAdjMapper.queryAdjState(entityMap);
			if(!"01".equals(state)){
				return "{\"error\":\"数据不是新建状态,无法执行修改操作.\",\"state\":\"false\"}";
			}
			
		    budgElseCostAdjMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			for (Map<String, Object> map : entityList) {
				String state = budgElseCostAdjMapper.queryAdjState(map);
				if(!"01".equals(state)){
		    ...
		    budgElseCostAdjMapper.updateBatch(entityList);
	...
	*/
    ...
    public String delete(Map<String, Object> entityMap) throws DataAccessException {
	    ...
	    try {
			...
			budgElseCostAdjMapper.delete(entityMap);
	...
	*/
	...
	public String deleteData(Map<String,Object> mapVo, Map<String, Object> fileMap)throws DataAccessException{
		...
		try {
			...
			String state = budgElseCostAdjMapper.queryAdjState(mapVo);
			String adj_code = budgElseCostAdjMapper.queryMaxCodeFromAdj(mapVo);
			if(!"01".equals(state)){
				return "{\"error\":\"数据不是新建状态,无法执行删除操作.\",\"state\":\"false\"}";
			}
			...
			budgElseCostAdjMapper.delete(mapVo);
			//删除数据后   还原最大单号
			mapVo.put("table_code", "BUDG_ELSE_COST_ADJ");
			budgElseCostAdjMapper.updateMaxNo(mapVo);
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgElseCostAdjMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<BudgElseCostAdj> list = (List<BudgElseCostAdj>)budgElseCostAdjMapper.queryExists(mapVo);
		
		if (list.size()>0) {

			int state = budgElseCostAdjMapper.update(entityMap);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgElseCostAdjMapper.query(entityMap);
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgElseCostAdjMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return budgElseCostAdjMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return BudgElseCostAdj
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return budgElseCostAdjMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<BudgElseCostAdj>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return budgElseCostAdjMapper.queryExists(entityMap);
	}
	/**
	 * 
	 * 审核
	 */
	@Override
	public String auditBudgElseCostAdj(List<Map<String, Object>> listVo) throws DataAccessException {
		...
		try {
			...
			mapVo.put("else_cost_flag", "1");
			
			budgEditStateMapper.updateElseCostFlag(mapVo);
			
			budgElseCostAdjMapper.auditOrUnAudit(listVo)	;
	 ...
	 */
	@Override
	public String unAuditBudgElseCostAdj(List<Map<String, Object>> listVo) throws DataAccessException {
		try{
			...
			for (Map<String, Object> map : listVo) {
				...
				String checkCode = budgElseCostAdjMapper.queryMaxCodeFromCheck(map);
	...
	public int queryBcState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgElseCostAdjMapper.queryBcState(mapVo);
	}
	...
	public int queryCheckDataExists(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgElseCostAdjMapper.queryCheckDataExists(mapVo);
	}
	...
	public Map<String, Object> queryMaxCheckData(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgElseCostAdjMapper.queryMaxCheckData(mapVo);
	}
	/**
	...
	public Map<String, Object> queryMaxCheckDataForUpdate(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgElseCostAdjMapper.queryMaxCheckDataUpdate(mapVo);
	}
	...
	public List<String> queryBudgElseCostAdjState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgElseCostAdjMapper.queryBudgElseCostAdjState(mapVo);
