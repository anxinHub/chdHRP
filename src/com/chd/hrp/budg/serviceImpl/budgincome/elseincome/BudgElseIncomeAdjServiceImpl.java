...
import com.chd.hrp.budg.dao.budgincome.elseincome.BudgElseIncomeAdjMapper;
...
@Service("budgElseIncomeAdjService")
public class BudgElseIncomeAdjServiceImpl implements BudgElseIncomeAdjService {

	private static Logger logger = Logger.getLogger(BudgElseIncomeAdjServiceImpl.class);
	//引入DAO操作
	@Resource(name = "budgElseIncomeAdjMapper")
	private final BudgElseIncomeAdjMapper budgElseIncomeAdjMapper = null;
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			int state = budgElseIncomeAdjMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgElseIncomeAdjMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			String state = budgElseIncomeAdjMapper.queryAdjState(entityMap);
			if(!"01".equals(state)){
				return "{\"error\":\"数据不是新建状态,无法执行修改操作.\",\"state\":\"false\"}";
			}
			
			budgElseIncomeAdjMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			for (Map<String, Object> map : entityList) {
				String state = budgElseIncomeAdjMapper.queryAdjState(map);
				if(!"01".equals(state)){
			...
			budgElseIncomeAdjMapper.updateBatch(entityList);
	...
	*/
    ...
    public String delete(Map<String, Object> entityMap) throws DataAccessException {
	    ...
	    try {
			...
			budgElseIncomeAdjMapper.delete(entityMap);
	...
	*/
	...
	public String deleteData(Map<String,Object> mapVo, Map<String, Object> fileMap) throws DataAccessException{
		...
		try {
			...
			String state = budgElseIncomeAdjMapper.queryAdjState(mapVo);
			String adj_code = budgElseIncomeAdjMapper.queryMaxCodeFromAdj(mapVo);
			if(!"01".equals(state)){
				return "{\"error\":\"数据不是新建状态,无法执行删除操作.\",\"state\":\"false\"}";
			}
			...
			budgElseIncomeAdjMapper.delete(mapVo);
			//删除数据后   还原最大单号
			mapVo.put("table_code", "BUDG_ELSE_INCOME_ADJ");
			budgElseIncomeAdjMapper.updateMaxNo(mapVo);
			//如果存在文件名  说明存在文件  删除文件
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgElseIncomeAdjMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<BudgElseIncomeAdj> list = (List<BudgElseIncomeAdj>)budgElseIncomeAdjMapper.queryExists(mapVo);
		
		if (list.size()>0) {

			int state = budgElseIncomeAdjMapper.update(entityMap);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgElseIncomeAdjMapper.query(entityMap);
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgElseIncomeAdjMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return budgElseIncomeAdjMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return BudgElseIncomeAdj
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return budgElseIncomeAdjMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<BudgElseIncomeAdj>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return budgElseIncomeAdjMapper.queryExists(entityMap);
	}
	/**
	 * 
	 * 审核
	 */
	@Override
	public String auditBudgElseIncomeAdj(List<Map<String, Object>> listVo) throws DataAccessException {
		...
		try {
			...
			mapVo.put("else_income_flag", "1");
			
			budgEditStateMapper.updateElseIncomeFlag(mapVo);
			
			budgElseIncomeAdjMapper.auditOrUnAudit(listVo)	;
	 ...
	 */
	@Override
	public String unAuditBudgElseIncomeAdj(List<Map<String, Object>> listVo) throws DataAccessException {
		try{
			...
			for (Map<String, Object> map : listVo) {
				...
				String checkCode = budgElseIncomeAdjMapper.queryMaxCodeFromCheck(map);
	 ...
	 */
	@Override
	public String queryBudgElseIncomeAdjBefore(Map<String, Object> entityMap) throws DataAccessException {
		SysPage sysPage = new SysPage();
		...
		if (sysPage.getTotal()==-1){
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgElseIncomeAdjMapper.queryBudgElseIncomeAdjBefore(entityMap);
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgElseIncomeAdjMapper.queryBudgElseIncomeAdjBefore(entityMap, rowBounds);
	...
	public List<String> queryBudgElseIncomeAdjState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgElseIncomeAdjMapper.queryBudgElseIncomeAdjState(mapVo);
	...
	public int queryCheckDataExists(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgElseIncomeAdjMapper.queryCheckDataExists(mapVo);
	}
	...
	public int queryBcState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgElseIncomeAdjMapper.queryBcState(mapVo);
	}
	...
	public Map<String, Object> queryMaxCheckData(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgElseIncomeAdjMapper.queryMaxCheckData(mapVo);
	}
	/**
	...
	public Map<String, Object> queryMaxCheckDataForUpdate(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgElseIncomeAdjMapper.queryMaxCheckDataUpdate(mapVo);
	}
