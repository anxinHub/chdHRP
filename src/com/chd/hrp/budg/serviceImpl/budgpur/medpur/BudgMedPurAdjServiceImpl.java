...
import com.chd.hrp.budg.dao.budgpur.medpur.BudgMedPurAdjMapper;
import com.chd.hrp.budg.dao.common.BudgEditStateMapper;
import com.chd.hrp.budg.entity.BudgMedPurAdj;
...
@Service("budgMedPurAdjService")
public class BudgMedPurAdjServiceImpl implements BudgMedPurAdjService {

	private static Logger logger = Logger.getLogger(BudgMedPurAdjServiceImpl.class);
	//引入DAO操作
	@Resource(name = "budgMedPurAdjMapper")
	private final BudgMedPurAdjMapper budgMedPurAdjMapper = null;
	...
	*/
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			int state = budgMedPurAdjMapper.add(entityMap);
	...
	*/
	...
	public String addBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgMedPurAdjMapper.addBatch(entityList);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			String state = budgMedPurAdjMapper.queryAdjState(entityMap);
			if(!"01".equals(state)){
				return "{\"error\":\"数据不是新建状态,无法执行修改操作.\",\"state\":\"false\"}";
			}
			
		    budgMedPurAdjMapper.update(entityMap);
	...
	public String updateBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			for (Map<String, Object> map : entityList) {
				String state = budgMedPurAdjMapper.queryAdjState(map);
				if(!"01".equals(state)){
		    ...
		    budgMedPurAdjMapper.updateBatch(entityList);
	...
	*/
    ...
    public String delete(Map<String, Object> entityMap) throws DataAccessException {
	    ...
	    try {
			...
			budgMedPurAdjMapper.delete(entityMap);
	...
	*/
	...
	public String deleteData(Map<String,Object> mapVo, Map<String, Object> fileMap)throws DataAccessException{
		...
		try {
			...
			String state = budgMedPurAdjMapper.queryAdjState(mapVo);
			String adj_code = budgMedPurAdjMapper.queryMaxCodeFromAdj(mapVo);
			if(!"01".equals(state)){
				return "{\"error\":\"数据不是新建状态,无法执行删除操作.\",\"state\":\"false\"}";
			}
			...
			budgMedPurAdjMapper.delete(mapVo);
			//删除数据后   还原最大单号
			mapVo.put("table_code", "BUDG_MED_PUR_ADJ");
			budgMedPurAdjMapper.updateMaxNo(mapVo);
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			budgMedPurAdjMapper.deleteBatch(entityList);
	...
	*/
	...
	public String addOrUpdate(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		...
		List<BudgMedPurAdj> list = (List<BudgMedPurAdj>)budgMedPurAdjMapper.queryExists(mapVo);
		
		if (list.size()>0) {

			int state = budgMedPurAdjMapper.update(entityMap);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgMedPurAdjMapper.query(entityMap);
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)budgMedPurAdjMapper.query(entityMap, rowBounds);
	...
	*/
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return budgMedPurAdjMapper.queryByCode(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return BudgMedPurAdj
	 * @throws DataAccessException
	*/
	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return budgMedPurAdjMapper.queryByUniqueness(entityMap);
	}
	 ...
	 * @param  entityMap<BR>
	 *  参数为要检索的字段
	 * @return List<BudgMedPurAdj>
	 * @throws DataAccessException
	*/
	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return budgMedPurAdjMapper.queryExists(entityMap);
	}
	/**
	 * 
	 * 审核
	...
	public String auditBudgMedPurAdj(List<Map<String, Object>> listVo) throws DataAccessException {
		...
		try {
			...
			mapVo.put("med_pur_flag", "1");
			
			budgEditStateMapper.updateMedPurFlag(mapVo);
			
			budgMedPurAdjMapper.auditOrUnAudit(listVo)	;
	...
	public String unAuditBudgMedPurAdj(List<Map<String, Object>> listVo) throws DataAccessException {
		try{
			...
			for (Map<String, Object> map : listVo) {
				...
				String checkCode = budgMedPurAdjMapper.queryMaxCodeFromCheck(map);
	...
	public int queryBcState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgMedPurAdjMapper.queryBcState(mapVo);
	}
	...
	public int queryCheckDataExists(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgMedPurAdjMapper.queryCheckDataExists(mapVo);
	}
	...
	public Map<String, Object> queryMaxCheckData(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgMedPurAdjMapper.queryMaxCheckData(mapVo);
	}
	/**
	...
	public Map<String, Object> queryMaxCheckDataForUpdate(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgMedPurAdjMapper.queryMaxCheckDataUpdate(mapVo);
	}
	...
	public List<String> queryBudgMedPurAdjState(Map<String, Object> mapVo) throws DataAccessException {
		...
		return budgMedPurAdjMapper.queryBudgMedPurAdjState(mapVo);
