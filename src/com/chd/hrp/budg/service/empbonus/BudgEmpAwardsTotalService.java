...
public interface BudgEmpAwardsTotalService extends SqlService {
	 ...
	 */
	public List<Map<String, Object>> queryBudgAwardsItem(Map<String, Object> mapVo) throws DataAccessException ;
