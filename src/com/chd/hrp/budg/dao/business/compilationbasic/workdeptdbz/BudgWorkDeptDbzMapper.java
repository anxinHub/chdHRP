...
package com.chd.hrp.budg.dao.business.compilationbasic.workdeptdbz;
...
public interface BudgWorkDeptDbzMapper extends SqlMapper{
	...
	/**
	 * 根据病种编码 查询 对应医保类型是否存在（查 医保单病种维护表 BUDG_YB_SINGLE_DISEASE）
	 * @param mapVo
	 * @return
	 * @throws DataAccessException
	 */
