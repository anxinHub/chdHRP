...
public interface BudgElseCostCheckMapper extends SqlMapper{
	...
	/**
	 * 调整审批 医院其他支出预算  查询(未下达) 不分页
	 * @param entityMap
	 * @return
	 */
	public List<Map<String, Object>> queryBudgElseCost(Map<String, Object> entityMap);
	
	/**
	 * 初始审批 医院其他支出预算  查询(未下达)  分页
	 * @param entityMap
	 * @param rowBounds
	 * @return
	 */
	public List<Map<String, Object>> queryBudgElseCost(Map<String, Object> entityMap, RowBounds rowBounds);
	
	/**
	 * 调整审批 医院其他支出预算  查询(已下达) 不分页
	 * @param entityMap
	 * @return
	 */
	public List<Map<String, Object>> queryBudgElseCostCopy(Map<String, Object> entityMap);
	
	/**
	 * 初始审批 医院其他支出预算  查询(已下达)  分页
	 * @param entityMap
	 * @param rowBounds
	 * @return
	 */
	public List<Map<String, Object>> queryBudgElseCostCopy(Map<String, Object> entityMap, RowBounds rowBounds);
	
	/**
	 * 初始审批 医院其他支出预算  查询(未下达)   不分页
	 * @param entityMap
	 * @return
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryBudgElseCostAdjust(Map<String, Object> entityMap) throws DataAccessException;
	
	/**
	 * 调整审批 医院其他支出预算  查询(未下达)   分页
	 * @param entityMap
	 * @param rowBounds
	 * @return
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryBudgElseCostAdjust(Map<String, Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	
	/**
	 * 初始审批 医院其他支出预算  查询(已下达)   不分页
	 * @param entityMap
	 * @return
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryBudgElseCostAdjustCopy(Map<String, Object> entityMap) throws DataAccessException;
	
	/**
	 * 调整审批 医院其他支出预算  查询(已下达)   分页
	 * @param entityMap
	 * @param rowBounds
	 * @return
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryBudgElseCostAdjustCopy(Map<String, Object> entityMap, RowBounds rowBounds) throws DataAccessException;
