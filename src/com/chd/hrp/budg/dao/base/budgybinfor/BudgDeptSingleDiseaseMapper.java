...
public interface BudgDeptSingleDiseaseMapper extends SqlMapper{
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String, Object>> queryDiseaseData(Map<String, Object> entityMap) throws DataAccessException;
