...
public interface BudgSubjChargeKindMapper extends SqlMapper{
	/**
	 * @Description 
	 * 添加预算科目与会计科目对应关系表<BR> 
	 * @param  entityMap
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public int addBatchBudgSubjChargeKind(List<Map<String, Object>> entityMap)throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public int updateBatchBudgSubjChargeKind(List<Map<String, Object>> entityMap)throws DataAccessException;
	...
	*/
	 ...
	 * @throws DataAccessException
	 */
	public List<Map<String,Object>> queryBudgSubjChargeKind(Map<String, Object> mapVo, RowBounds rowBounds) throws DataAccessException;
	/**
	 * 查询数据是否已存在
	 * @param mapVo
	 * @return
	 ...
	 * @return
	 */
	public int queryUpdateDataExist(Map<String, Object> entityMap) throws DataAccessException;
