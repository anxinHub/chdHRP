...
public interface BudgCashFlowMapper extends SqlMapper{
	 ...
	 * @return
	 */
	public Map<String, Object> queryMaxMonthFromCashPlan(Map<String, Object> entityMap) throws DataAccessException;
	/**
	 * 初始化添加现金存量预算  计算专用 
	 * @param initList
	 */
