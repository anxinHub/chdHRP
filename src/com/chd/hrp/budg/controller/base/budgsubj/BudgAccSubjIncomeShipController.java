...
@Controller
public class BudgAccSubjIncomeShipController extends BaseController{
	
	private static Logger logger = Logger.getLogger(BudgAccSubjIncomeShipController.class);
	...
	private final BudgIncomeSubjTypeService budgIncomeSubjTypeService = null;
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/budgAccSubjIncomeShipMainPage", method = RequestMethod.GET)
	public String budgAccSubjShipMainPage(Model mode) throws Exception {

		return "hrp/budg/base/budgsubj/budgincomeship/budgAccSubjIncomeShipMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/budgAccSubjIncomeShipAddPage", method = RequestMethod.GET)
	public String budgAccSubjShipAddPage(Model mode) throws Exception {

		return "hrp/budg/base/budgsubj/budgincomeship/budgAccSubjIncomeShipAdd";
	 ...
	 *保存
	 */
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/saveBudgAccSubjIncomeShip", method = RequestMethod.POST)
	@ResponseBody
	...
	public Map<String, Object> saveBudgAccSubjIncomeShip(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
		...
		for ( String id: paramVo.split(",")) {
			...
			//根据编码查询数据使用
			mapVo.put("table1", "BUDG_INCOME_SUBJ");
			mapVo.put("table2", "BUDG_INCOME_SUBJ_TYPE");
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/addBudgAccSubjIncomeShip", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addBudgAccSubjIncomeShip(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
		List<Map<String, Object>> listVo= new ArrayList<Map<String,Object>>();
		for ( String id: paramVo.split(",")) {
			Map<String, Object> mapVo=new HashMap<String, Object>();
			mapVo.put("group_id", SessionManager.getGroupId());
...
/**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/budgAccSubjIncomeShipUpdatePage", method = RequestMethod.GET)
	public String budgAccSubjShipUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	  ...
	  if(mapVo.get("group_id") == null){
		...
		return "hrp/budg/base/budgsubj/budgincomeship/budgAccSubjIncomeShipUpdate";
	}
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/updateBudgAccSubjIncomeShip", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateBudgAccSubjIncomeShip(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		if(mapVo.get("group_id") == null){
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/deleteBudgAccSubjIncomeShip",method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteBudgAccSubjIncomeShip(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/queryBudgAccSubjIncomeShip", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryBudgAccSubjIncomeShip(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/setBudgAccSubjIncomeShip", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> setBudgAccSubjIncomeShip(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/budgAccSubjIncomeShipImportPage", method = RequestMethod.GET)
	public String budgAccSubjIncomeShipImportPage(Model mode) throws Exception {

		return "hrp/budg/base/budgsubj/budgincomeship/budgAccSubjIncomeShipImport";
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="hrp/budg/base/budgsubj/budgincomeship/downTemplate1", method = RequestMethod.GET)  
	 public String downTemplate1(Plupload plupload,HttpServletRequest request,
	    		HttpServletResponse response,Model mode) throws IOException { 
	    			
	    printTemplate(request,response,"budg\\base","收入预算科目与会计科目对应关系模版.xls");
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="/hrp/budg/base/budgsubj/budgincomeship/readBudgAccSubjIncomeShipFiles",method = RequestMethod.POST)  
			...
			for (int i = 1; i < list.size(); i++) {
				...
				for(int j = i + 1 ; j < list.size(); j++){
					...
					if (StringTool.isNotBlank(temp[1])) {
						...
						budgAccSubjShip.setSubj_code(String.valueOf(temp[2]));	
					...
					/*if (StringTool.isNotBlank(temp[3])) {
						...
						mapVo.put("income_subj_type_code", temp[3]);
						
						BudgIncomeSubjType type = budgIncomeSubjTypeService.queryBudgIncomeSubjTypeByCode(mapVo);
						
						if(type == null ){
							err_sb.append("科目类别不存在;");
						}
						
						BudgIncomeTypeSet typeSet = budgIncomeTypeSetService.queryBudgIncomeTypeSetByCode(mapVo);
						if( typeSet == null ){
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/addBatchBudgAccSubjIncomeShip",method = RequestMethod.POST)
	@ResponseBody
    public Map<String, Object> addBatchBudgAccSubjIncomeShip(@RequestParam(value = "ParamVo") String paramVo, Model mode)throws Exception{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/queryAccSubj", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/queryBudgIncomeTypeSet", method = RequestMethod.POST)
	@ResponseBody
	public String queryBudgIncomeTypeSet(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return budgAccSubjShipService.queryBudgIncomeTypeSet(mapVo);
	}
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/generate", method=RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/base/budgsubj/budgincomeship/extend", method=RequestMethod.POST)
	@ResponseBody
