...
package com.chd.hrp.budg.controller.budgincome.downtotop.deptmonthbudg;
...
@Controller
public class deptMonthMedInBudgController extends BaseController{
	
	private static Logger logger = Logger.getLogger(deptMonthMedInBudgController.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/deptMonthMedInPage", method = RequestMethod.GET)
	public String budgMedIncomeDeptMonthMainPage(Model mode) throws Exception {

		return "hrp/budg/budgincome/downtotop/deptmonthbudg/deptMonthMedInBudgMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/deptMonthMedInBudgResolveMainPage", method = RequestMethod.GET)
	public String medInDYBudgResolveMainPage(@RequestParam Map<String, Object> mapVo,Model mode) throws Exception {
		...
		return "hrp/budg/budgincome/downtotop/deptmonthbudg/deptMonthMedInBudgResolveMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/deptMonthMedInBudgAddPage", method = RequestMethod.GET)
	public String budgMedIncomeDeptMonthAddPage(Model mode) throws Exception {

		return "hrp/budg/budgincome/downtotop/deptmonthbudg/deptMonthMedInBudgAdd";

	}

	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/saveDeptMonthMedInBudgUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> saveDeptMonthMedInBudgUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/addDeptMonthMedInBudgUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addDeptMonthMedInBudgUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
...
/**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/deptMonthMedInBudgUpdatePage", method = RequestMethod.GET)
	public String budgMedIncomeDeptMonthUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/budgbudgincome/toptodown/deptmonthinbudg/deptMonthMedInBudgUpdate";
	}
	 ...
	 * @throws Exception
	*/																		
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/updateDeptMonthMedInBudgUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateDeptMonthMedInBudgUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/																		
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/updateDeptMonthMedInBudgResolveUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateDeptMonthMedInBudgResolveUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/addOrUpdateDeptMonthMedInBudgUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateDeptMonthMedInBudgUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/deleteDeptMonthMedInBudgUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteDeptMonthMedInBudgUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/queryDeptMonthMedInBudgUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryDeptMonthMedInBudgUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/queryDeptMonthMedInBudgResolveUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryDeptMonthMedInBudgResolveUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/deptMonthMedInBudgImportPage", method = RequestMethod.GET)
	public String budgMedIncomeDeptMonthImportPage(Model mode) throws Exception {

		return "hrp/budg/budgincome/downtotop/deptmonthbudg/deptMonthMedInBudgImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/budgincome/downtotop/deptmonthbudg/downTemplate", method = RequestMethod.GET)  
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/budgincome/downtotop/deptmonthbudg/readDeptMonthMedInBudgFiles",method = RequestMethod.POST)  
    public String readDeptMonthMedInBudgFiles(Plupload plupload,HttpServletRequest request,
    		HttpServletResponse response,Model mode) throws IOException { 
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/addBatchDeptMonthMedInBudgUp", method = RequestMethod.POST)
	@ResponseBody
    public Map<String, Object> addBatchDeptMonthMedInBudg(@RequestParam(value = "ParamVo") String paramVo, Model mode)throws Exception{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/collectMedInDMBudgUp", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/queryDeptyearValue", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/downtotop/deptmonthbudg/generate", method=RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> generate(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	       List<Map<String, Object>> listVo= new ArrayList<Map<String,Object>>();
			...
			if(listVo.size() > 0 ){
				...
				budgMedIncomeDeptMonth =medInDMBudgService.addBatch(listVo);
