...
@Controller
public class BudgDeptYearMonthIncomePlanController extends BaseController{
	
	private static Logger logger = Logger.getLogger(BudgDeptYearMonthIncomePlanController.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/budgDeptYearMonthIncomePlanMainPage", method = RequestMethod.GET)
	public String budgDeptYearMonthIncomePlanMainPage(Model mode) throws Exception {

		return "hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/budgDeptYearMonthIncomePlanMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/budgDeptYearMonthIncomePlanAddPage", method = RequestMethod.GET)
	public String budgDeptYearMonthIncomePlanAddPage(Model mode) throws Exception {

		return "hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/budgDeptYearMonthIncomePlanAdd";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/budgDeptYearMonthIncomePlanSetPage", method = RequestMethod.GET)
	public String budgDeptYearMonthIncomePlanSetPage(Model mode) throws Exception {

		return "hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/budgDeptYearMonthIncomePlanSet";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/addBudgDeptYearMonthIncomePlan", method = RequestMethod.POST)
	@ResponseBody
...
/**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/budgDeptYearMonthIncomePlanUpdatePage", method = RequestMethod.GET)
	public String budgDeptYearMonthIncomePlanUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/budgDeptYearMonthIncomePlanUpdate";
	}
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/updateBudgDeptYearMonthIncomePlan", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/addOrUpdateBudgDeptYearMonthIncomePlan", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/settingBudgHosDeptYearMonthIncomePlan", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/deleteBudgDeptYearMonthIncomePlan", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/queryBudgDeptYearMonthIncomePlan", method = RequestMethod.POST)
	@ResponseBody
  ...
  /**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/budgDeptYearMonthIncomePlanImportPage", method = RequestMethod.GET)
	public String budgDeptYearMonthIncomePlanImportPage(Model mode) throws Exception {

		return "hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/budgDeptYearMonthIncomePlanImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/downTemplate", method = RequestMethod.GET)  
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/readBudgDeptYearMonthIncomePlanFiles",method = RequestMethod.POST)  
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/addBatchBudgDeptYearMonthIncomePlan", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/budgincome/toptodown/plan/deptyearmonthincome/generate", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> generate(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		String Json = budgDeptYearMonthIncomePlanService.generate(mapVo);
