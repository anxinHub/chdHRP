...
@Controller
public class BudgWorkHosExecuteController extends BaseController{
	
	private static Logger logger = Logger.getLogger(BudgWorkHosExecuteController.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationbasic/hosexecute/budgWorkHosExecuteMainPage", method = RequestMethod.GET)
	public String budgWorkHosExecuteMainPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationbasic/hosexecute/budgWorkHosExecuteMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationbasic/hosexecute/budgWorkHosExecuteAddPage", method = RequestMethod.GET)
	public String budgWorkHosExecuteAddPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationbasic/hosexecute/budgWorkHosExecuteAdd";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationbasic/hosexecute/addBudgWorkHosExecute", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addBudgWorkHosExecute(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationbasic/hosexecute/budgWorkHosExecuteUpdatePage", method = RequestMethod.GET)
	public String budgWorkHosExecuteUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/budg/business/compilationbasic/hosexecute/budgWorkHosExecuteUpdate";
	}
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationbasic/hosexecute/updateBudgWorkHosExecute", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateBudgWorkHosExecute(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationbasic/hosexecute/addOrUpdateBudgWorkHosExecute", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateBudgWorkHosExecute(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationbasic/hosexecute/deleteBudgWorkHosExecute", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteBudgWorkHosExecute(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationbasic/hosexecute/queryBudgWorkHosExecute", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryBudgWorkHosExecute(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationbasic/hosexecute/budgWorkHosExecuteImportPage", method = RequestMethod.GET)
	public String budgWorkHosExecuteImportPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationbasic/hosexecute/budgWorkHosExecuteImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/business/compilationbasic/hosexecute/downTemplate", method = RequestMethod.GET)  
	 public String downTemplate(Plupload plupload,HttpServletRequest request,
	    		HttpServletResponse response,Model mode) throws IOException { 
	    			
	    printTemplate(request,response,"budg\\business","医院月份历史指标数据采集模板.xls");
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/business/compilationbasic/hosexecute/readBudgWorkHosExecuteFiles",method = RequestMethod.POST)  
    public String readBudgWorkHosExecuteFiles(Plupload plupload,HttpServletRequest request,
    		HttpServletResponse response,Model mode) throws IOException { 			 
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationbasic/hosexecute/addBatchBudgWorkHosExecute", method = RequestMethod.POST)
	@ResponseBody
    public Map<String, Object> addBatchBudgWorkHosExecute(@RequestParam(value = "ParamVo") String paramVo, Model mode)throws Exception{
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationbasic/hosexecute/budgWorkHosMonthExecuteImportNewPage", method = RequestMethod.GET)
	public String budgWorkHosYearExecuteImportPage(Model mode) throws Exception {
		return "/hrp/budg/business/compilationbasic/hosexecute/budgWorkHosMonthExecuteImport";
	...
	*/
	...
	@RequestMapping(value = "/hrp/budg/business/compilationbasic/hosexecute/budgWorkHosMonthExecuteImport", method = RequestMethod.POST)
	@ResponseBody
	public String budgWorkHosMonthExecuteImport(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		try {
			
			String reJson=budgWorkHosExecuteService.budgWorkHosMonthExecuteImport(mapVo);
