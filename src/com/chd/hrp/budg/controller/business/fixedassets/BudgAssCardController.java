...
@Controller
public class BudgAssCardController extends BaseController{
	
	private static Logger logger = Logger.getLogger(BudgAssCardController.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/fixedassets/budgasscard/budgAssCardactualityMainPage", method = RequestMethod.GET)
	public String budgAssCardMainPage(Model mode) throws Exception {

		return "hrp/budg/business/fixedassets/budgasscard/budgAssCardMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/fixedassets/budgasscard/budgAssCardAddPage", method = RequestMethod.GET)
	public String budgAssCardAddPage(Model mode) throws Exception {
		
		mode.addAttribute("p04044", MyConfig.getSysPara("04044"));
		
		return "hrp/budg/business/fixedassets/budgasscard/budgAssCardAdd";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/fixedassets/budgasscard/addBudgAssCard", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addBudgAssCard(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		String budgAssCardJson = budgAssCardService.add(mapVo);
...
/**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/fixedassets/budgasscard/budgAssCardUpdatePage", method = RequestMethod.GET)
	public String budgAssCardUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		Map<String,Object> budgAssCard= budgAssCardService.queryByCode(mapVo);
		...
		return "hrp/budg/business/fixedassets/budgasscard/budgAssCardUpdate";
	}
	/**
	 * @Description 
	 * 查询数据 
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/fixedassets/budgasscard/queryBudgAssCardSourceBySourceId", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryBudgAssCardSourceBySourceId(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		String budgAssCard = budgAssCardService.queryBudgAssCardSourceBySourceId(mapVo);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/fixedassets/budgasscard/updateBudgAssCard", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateBudgAssCard(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		String budgAssCardJson = budgAssCardService.update(mapVo);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/fixedassets/budgasscard/addOrUpdateBudgAssCard", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateBudgAssCard(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		budgAssCardJson = budgAssCardService.addOrUpdate(detailVo);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/fixedassets/budgasscard/deleteBudgAssCard", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteBudgAssCard(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
		...
		String budgAssCardJson = budgAssCardService.deleteBatch(listVo);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/fixedassets/budgasscard/queryBudgAssCardactuality", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryBudgAssCardactuality(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		String budgAssCard = budgAssCardService.query(getPage(mapVo));
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/fixedassets/budgasscard/budgAssCardImportPage", method = RequestMethod.GET)
	public String budgAssCardImportPage(Model mode) throws Exception {

		return "hrp/budg/business/fixedassets/budgasscard/budgAssCardImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/business/fixedassets/budgasscard/downTemplate1", method = RequestMethod.GET)  
	 public String downTemplate1(Plupload plupload,HttpServletRequest request,
	    		HttpServletResponse response,Model mode) throws IOException { 
	    			
	    printTemplate(request,response,"budg\\cost\\ass","固定资产现状.xls");
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/fixedassets/budgasscard/budgAssCardSourceImportPage", method = RequestMethod.GET)
	public String budgAssCardSourceImportPage(Model mode) throws Exception {

		return "hrp/budg/business/fixedassets/budgasscard/budgAssCardSourceImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/business/fixedassets/budgasscard/downTemplate2", method = RequestMethod.GET)  
	 public String downTemplate2(Plupload plupload,HttpServletRequest request,
	    		HttpServletResponse response,Model mode) throws IOException { 
	    			
	    printTemplate(request,response,"budg\\cost\\ass","固定资产现状_资金来源.xls");
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/business/fixedassets/budgasscard/readBudgAssCardFiles",method = RequestMethod.POST)  
		...
		try {
			for (int i = 1; i < list.size(); i++) {
				...
				Map<String, Object> mapVo = new HashMap<String, Object>();
					...
					if (ExcelReader.validExceLColunm(temp,3)) {
						...
						if(Arrays.asList(naturData).contains(temp[3])){
							mapVo.put("naturs_code", temp[3]);
							
						}else{
							err_sb.append("资产性质输入错误(01至04);");
						}
						
						map.put("naturs_code",temp[3]);
					...
					if (ExcelReader.validExceLColunm(temp,4)) {
						...
						for(Map<String,Object> item: deptData){
							...
							if(temp[4].equals(item.get("dept_code"))){
						...
						map.put("dept_code",temp[4]);
						map.put("dept_name",temp[5]);
					...
					if (ExcelReader.validExceLColunm(temp,6)) {
						...
						if(Arrays.asList(useState).contains(temp[6])){
							
							mapVo.put("use_state",Long.valueOf(temp[6]));
					...
					if (ExcelReader.validExceLColunm(temp,7)) {
						...
						if(Arrays.asList(isNO).contains(temp[7])){
							
							mapVo.put("is_dept",Integer.valueOf(temp[7]));
						}else{
							err_sb.append("在用状态输入不合法(0-1);");
						}
						
			    		map.put("is_dept", temp[7]);
					...
					if (ExcelReader.validExceLColunm(temp,8)) {
						...
						for(Map<String,Object> item : storeData){
							if(temp[8].equals(item.get("store_code"))){
			    		...
			    		map.put("store_code", temp[8]);
			    		
			    		map.put("store_name", temp[9]);
					...
					if (ExcelReader.validExceLColunm(temp,10)) {
						...
						if(Arrays.asList(isNO).contains(temp[10])){
							
							mapVo.put("is_throw",Integer.valueOf(temp[10]));
					...
					if (ExcelReader.validExceLColunm(temp,11)) {
						...
						try {
							...
							mapVo.put("in_date", df.parse(temp[11]));
							
						} catch (Exception e) {
							err_sb.append("入库日期填写格式错误(yyyyMMdd);");
						}
						
						map.put("in_date",temp[11]);
					...
					if (ExcelReader.validExceLColunm(temp,13)) {
						...
						if(Arrays.asList(isNO).contains(temp[13])){
							
							mapVo.put("is_depr",Integer.valueOf(temp[13]));
					...
					if (ExcelReader.validExceLColunm(temp,14)) {
						...
						if(deprMethod.contains(temp[14])){
							
							mapVo.put("depr_method", temp[14]);
					...
					if (ExcelReader.validExceLColunm(temp,15)) {
						...
						map.put("acc_depre_amount",Integer.valueOf(temp[15]));
			    		mapVo.put("acc_depre_amount", temp[15]);
					...
					if (ExcelReader.validExceLColunm(temp,16)) {
						...
						map.put("price",Double.valueOf(temp[16]));
			    		mapVo.put("price", temp[16]);
					...
					if (ExcelReader.validExceLColunm(temp,17)) {
						...
						map.put("depre_money",Double.valueOf(temp[17]));
			    		mapVo.put("depre_money", temp[17]);
					...
					if (ExcelReader.validExceLColunm(temp,18)) {
						...
						map.put("cur_money",Double.valueOf(temp[18]));
			    		mapVo.put("cur_money", temp[18]);
					...
					if (ExcelReader.validExceLColunm(temp,19)) {
						...
						map.put("fore_money",Double.valueOf(temp[19]));
			    		mapVo.put("fore_money", temp[19]);
					...
					if (ExcelReader.validExceLColunm(temp,20)) {
						...
						map.put("add_depre_month",Integer.valueOf(temp[20]));
			    		mapVo.put("add_depre_month", temp[20]);
					...
					if (ExcelReader.validExceLColunm(temp,21)) {
						...
						map.put("last_depr_year",temp[21]);
			    		mapVo.put("last_depr_year", temp[21]);
					...
					if (ExcelReader.validExceLColunm(temp,22)) {
						
						if(Arrays.asList(monthData).contains(temp[22])){
							
							mapVo.put("last_depr_month", temp[22]);
							
						}else{
							err_sb.append("上次折旧月填写错误(必须两位数字【01至12】);");
						}
						map.put("last_depr_month",temp[22]);
				...
				int count = budgAssCardService.queryDataExist(mapVo);
			...
			if(list_err.size() == 0){
				...
				if(addList.size() > 0){
					...
					String dataJson = budgAssCardService.addBatch(addList);
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/business/fixedassets/budgasscard/readBudgAssCardSourceFiles",method = RequestMethod.POST)  
    public String readBudgAssCardSourceFiles(Plupload plupload,HttpServletRequest request,
		...
		try {
			for (int i = 1; i < list.size(); i++) {
				...
				Map<String, Object> mapVo = new HashMap<String, Object>();
					...
					if (ExcelReader.validExceLColunm(temp,4)) {
						...
						map.put("price",Double.valueOf(temp[4]));
			    		mapVo.put("price", temp[4]);
					...
					if (ExcelReader.validExceLColunm(temp,5)) {
						...
						map.put("depre_money",Double.valueOf(temp[5]));
			    		mapVo.put("depre_money", temp[5]);
					...
					if (ExcelReader.validExceLColunm(temp,6)) {
						...
						map.put("cur_money",Double.valueOf(temp[6]));
			    		mapVo.put("cur_money", temp[6]);
					...
					if (ExcelReader.validExceLColunm(temp,7)) {
						...
						map.put("fore_money",Double.valueOf(temp[7]));
			    		mapVo.put("fore_money", temp[7]);
			...
			if(list_err.size() == 0){
				...
				if(addList.size() > 0){
					//批量添加 固定资产现状——资金来源数据
					String dataJson = budgAssCardService.addBudgAssCardSource(addList);
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/business/fixedassets/budgasscard/addBatchBudgAssCard", method = RequestMethod.POST)
	@ResponseBody
    public Map<String, Object> addBatchBudgAssCard(@RequestParam(value = "ParamVo") String paramVo, Model mode)throws Exception{
		...
		Map<String, Object> mapVo = new HashMap<String, Object>();
			...
			JSONObject jsonObj = JSONObject.parseObject(it.next().toString());
				...
				BudgAssCard data_exc_extis = budgAssCardService.queryByCode(mapVo);
				...
				if (err_sb.toString().length() > 0) {
					...
					String dataJson = budgAssCardService.add(mapVo);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/business/fixedassets/budgasscard/collectData", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> collectData(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		String budgAssCardJson = budgAssCardService.collectData(mapVo);
