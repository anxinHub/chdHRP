...
@Controller
public class BudgDeptMonthPlanController extends BaseController{
	
	private static Logger logger = Logger.getLogger(BudgDeptMonthPlanController.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthplan/queryBudgBuiltIn", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthplan/budgDeptMonthPlanMainPage", method = RequestMethod.GET)
	public String budgDeptMonthPlanMainPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/deptmonthplan/budgDeptMonthPlanMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthplan/budgDeptMonthPlanAddPage", method = RequestMethod.GET)
	public String budgDeptMonthPlanAddPage(@RequestParam Map<String, Object> mapVo,Model mode) throws Exception {
		...
		return "hrp/budg/business/compilationplan/uptodown/deptmonthplan/budgDeptMonthPlanAdd";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthplan/addBudgDeptMonthPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addBudgDeptMonthPlanUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthplan/budgDeptMonthPlanUpdatePage", method = RequestMethod.GET)
	public String budgDeptMonthPlanUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/budg/business/compilationplan/uptodown/deptmonthplan/budgDeptMonthPlanUpdate";
	}
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthplan/updateBudgDeptMonthPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateBudgDeptMonthPlanUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthplan/addOrUpdateBudgDeptMonthPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateBudgDeptMonthPlanUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthplan/deleteBudgDeptMonthPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteBudgDeptMonthPlanUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthplan/queryBudgDeptMonthPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryBudgDeptMonthPlanUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthplan/budgDeptMonthPlanImportPage", method = RequestMethod.GET)
	public String budgDeptMonthPlanImportPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/deptmonthplan/budgDeptMonthPlanImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/business/compilationplan/uptodown/deptmonthplan/downTemplate", method = RequestMethod.GET)  
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/business/compilationplan/uptodown/deptmonthplan/readBudgDeptMonthPlanFiles",method = RequestMethod.POST)  
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthplan/addBatchBudgDeptMonthPlan", method = RequestMethod.POST)
	@ResponseBody
