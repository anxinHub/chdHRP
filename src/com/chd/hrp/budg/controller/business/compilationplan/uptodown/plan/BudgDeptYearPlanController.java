...
@Controller
public class BudgDeptYearPlanController extends BaseController{
	
	private static Logger logger = Logger.getLogger(BudgDeptYearPlanController.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptyearplan/queryBudgBuiltIn", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptyearplan/budgDeptYearPlanMainPage", method = RequestMethod.GET)
	public String budgHosYearPlanMainPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/deptyearplan/budgDeptYearPlanMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptyearplan/budgDeptYearPlanAddPage", method = RequestMethod.GET)
	public String budgHosYearPlanAddPage(@RequestParam Map<String, Object> mapVo,Model mode) throws Exception {
		...
		return "hrp/budg/business/compilationplan/uptodown/deptyearplan/budgDeptYearPlanAdd";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptyearplan/addBudgDeptYearPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addBudgDeptYearPlanUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
...
/**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptyearplan/budgDeptYearPlanUpdatePage", method = RequestMethod.GET)
	public String budgDeptYearPlanUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/budg/business/compilationplan/uptodown/deptyearplan/budgDeptYearPlanUpdate";
	}
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptyearplan/updateBudgDeptYearPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateBudgDeptYearPlanUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptyearplan/addOrUpdateBudgDeptYearPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateBudgDeptYearPlanUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptyearplan/deleteBudgDeptYearPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteBudgDeptYearPlanUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptyearplan/queryBudgDeptYearPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryBudgDeptYearPlanUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptyearplan/budgDeptYearPlanImportPage", method = RequestMethod.GET)
	public String budgDeptYearPlanImportPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/deptyearplan/budgDeptYearPlanImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/business/compilationplan/uptodown/deptyearplan/downTemplate", method = RequestMethod.GET)  
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/business/compilationplan/uptodown/deptyearplan/readBudgDeptYearPlanFiles",method = RequestMethod.POST)  
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptyearplan/addBatchBudgDeptYearPlan", method = RequestMethod.POST)
	@ResponseBody
