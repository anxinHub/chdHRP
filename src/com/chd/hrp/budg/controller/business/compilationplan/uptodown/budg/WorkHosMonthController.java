...
@Controller
public class WorkHosMonthController extends BaseController{
	
	private static Logger logger = Logger.getLogger(WorkHosMonthController.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/budgWorkHosMonthMainPage", method = RequestMethod.GET)
	public String budgWorkHosMonthMainPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/hosmonthbudg/budgWorkHosMonthMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/budgWorkHosMonthAddPage", method = RequestMethod.GET)
	public String budgWorkHosMonthAddPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/hosmonthbudg/budgWorkHosMonthAdd";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/addBudgWorkHosMonthUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addBudgWorkHosMonthUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		//	return JSONObject.parseObject("{\"error\":\"添加失败!上年业务量不存在!\"}");
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/budgWorkHosMonthUpdatePage", method = RequestMethod.GET)
	public String budgWorkHosMonthUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/budg/business/compilationplan/uptodown/hosmonthbudg/budgWorkHosMonthUpdate";
	}
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/updateBudgWorkHosMonthUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateBudgWorkHosMonthUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/updateBudgWorkHosMonthRate", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateBudgWorkHosMonthRate(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/addOrUpdateBudgWorkHosMonth", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/deleteBudgWorkHosMonthUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteBudgWorkHosMonthUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/queryBudgWorkHosMonthUp", method = RequestMethod.POST)
	@ResponseBody
  ...
  /**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/budgWorkHosMonthImportPage", method = RequestMethod.GET)
	public String budgWorkHosMonthImportPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/hosmonthbudg/budgWorkHosMonthImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/business/compilationplan/uptodown/hosmonthbudg/downTemplate", method = RequestMethod.GET)  
	 public String downTemplate(Plupload plupload,HttpServletRequest request,
	    		HttpServletResponse response,Model mode) throws IOException { 
	    			
	    printTemplate(request,response,"budg\\business\\toptodown","医院月份业务预算模板.xls");
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/readBudgWorkHosMonthFiles",method = RequestMethod.POST)  
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/addBatchBudgWorkHosMonth", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/queryHosYearLastYearWork", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/collectBudgWorkHosMonthUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> collectBudgWorkHosMonthUp(@RequestParam Map<String, Object> mapVo,Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/queryResolveData", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryResolveData(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/resolveData", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthbudg/generate", method=RequestMethod.POST)
	@ResponseBody
				...
				for(String month : monthData){
					...
					if(count == 0){
						...
						if(last_year_workload == null || "".equals(last_year_workload)){
							...
							//str += map.get("index_code") +"指标"  + map.get("month") + "月;" ;
