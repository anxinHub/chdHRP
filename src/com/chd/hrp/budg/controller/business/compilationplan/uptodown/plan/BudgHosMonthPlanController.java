...
@Controller
public class BudgHosMonthPlanController extends BaseController{
	
	private static Logger logger = Logger.getLogger(BudgHosMonthPlanController.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthplan/queryBudgBuiltIn", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthplan/budgHosMonthPlanMainPage", method = RequestMethod.GET)
	public String budgHosMonthPlanMainPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/hosmonthplan/budgHosMonthPlanMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthplan/budgHosMonthPlanAddPage", method = RequestMethod.GET)
	public String budgHosMonthPlanAddPage(@RequestParam Map<String, Object> mapVo,Model mode) throws Exception {
		...
		return "hrp/budg/business/compilationplan/uptodown/hosmonthplan/budgHosMonthPlanAdd";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthplan/addBudgHosMonthPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addBudgHosMonthPlanUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthplan/budgHosMonthPlanUpdatePage", method = RequestMethod.GET)
	public String budgHosMonthPlanUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/budg/business/compilationplan/uptodown/hosmonthplan/budgHosMonthPlanUpdate";
	}
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthplan/updateBudgHosMonthPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateBudgHosMonthPlanUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthplan/addOrUpdateBudgHosMonthPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateBudgHosMonthPlanUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthplan/deleteBudgHosMonthPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteBudgHosMonthPlanUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthplan/queryBudgHosMonthPlanUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryBudgHosMonthPlanUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthplan/budgHosMonthPlanImportPage", method = RequestMethod.GET)
	public String budgHosMonthPlanImportPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/hosmonthplan/budgHosMonthPlanImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/business/compilationplan/uptodown/hosmonthplan/downTemplate", method = RequestMethod.GET)  
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/business/compilationplan/uptodown/hosmonthplan/readBudgHosMonthPlanFiles",method = RequestMethod.POST)  
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosmonthplan/addBatchBudgHosMonthPlan", method = RequestMethod.POST)
	@ResponseBody
