...
@Controller
public class BudgHosMonthPlanControllerDown extends BaseController{
	
	private static Logger logger = Logger.getLogger(BudgHosMonthPlanControllerDown.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosmonthplan/queryBudgBuiltIn", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosmonthplan/budgHosMonthPlanMainPage", method = RequestMethod.GET)
	public String budgHosMonthPlanMainPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/downtoup/hosmonthplan/budgHosMonthPlanMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosmonthplan/budgHosMonthPlanAddPage", method = RequestMethod.GET)
	public String budgHosMonthPlanAddPage(@RequestParam Map<String, Object> mapVo,Model mode) throws Exception {
		
		mode.addAttribute("budg_year", mapVo.get("budg_year"));
		
		return "hrp/budg/business/compilationplan/downtoup/hosmonthplan/budgHosMonthPlanAdd";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosmonthplan/addBudgHosMonthPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addBudgHosMonthPlanDown(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		String budgHosMonthPlanJson = null;
		
		try {
			
			budgHosMonthPlanJson = budgWorkEditPlanService.add(mapVo);
			
		} catch (Exception e) {
			
			budgHosMonthPlanJson = e.getMessage() ;
		}
		

		return JSONObject.parseObject(budgHosMonthPlanJson);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosmonthplan/budgHosMonthPlanUpdatePage", method = RequestMethod.GET)
	public String budgHosMonthPlanUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/budg/business/compilationplan/downtoup/hosmonthplan/budgHosMonthPlanUpdate";
	}
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosmonthplan/updateBudgHosMonthPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateBudgHosMonthPlanDown(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		try {
			...
			budgHosMonthPlanJson = budgWorkEditPlanService.update(mapVo);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosmonthplan/addOrUpdateBudgHosMonthPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateBudgHosMonthPlanDown(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		
		String budgHosMonthPlanJson ="";
		...
		budgHosMonthPlanJson = budgWorkEditPlanService.addOrUpdate(detailVo);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosmonthplan/deleteBudgHosMonthPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteBudgHosMonthPlanDown(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
		...
		try {
			...
			budgHosMonthPlanJson = budgWorkEditPlanService.deleteBatch(listVo);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosmonthplan/queryBudgHosMonthPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryBudgHosMonthPlanDown(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosmonthplan/budgHosMonthPlanImportPage", method = RequestMethod.GET)
	public String budgHosMonthPlanImportPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/downtoup/hosmonthplan/budgHosMonthPlanImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/business/compilationplan/downtoup/hosmonthplan/downTemplate", method = RequestMethod.GET)  
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/business/compilationplan/downtoup/hosmonthplan/readBudgHosMonthPlanFiles",method = RequestMethod.POST)  
    public String readBudgHosMonthPlanFiles(Plupload plupload,HttpServletRequest request,
    		HttpServletResponse response,Model mode) throws IOException { 
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosmonthplan/addBatchBudgHosMonthPlan", method = RequestMethod.POST)
	@ResponseBody
    public Map<String, Object> addBatchBudgHosMonthPlan(@RequestParam(value = "ParamVo") String paramVo, Model mode)throws Exception{
