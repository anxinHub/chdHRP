...
@Controller
public class BudgHosYearPlanControllerDown extends BaseController{
	
	private static Logger logger = Logger.getLogger(BudgHosYearPlanControllerDown.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosyearplan/queryBudgBuiltIn", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosyearplan/budgHosYearPlanMainPage", method = RequestMethod.GET)
	public String budgHosYearPlanMainPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/downtoup/hosyearplan/budgHosYearPlanMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosyearplan/budgHosYearPlanAddPage", method = RequestMethod.GET)
	public String budgHosYearPlanAddPage(@RequestParam Map<String, Object> mapVo,Model mode) throws Exception {
		...
		return "hrp/budg/business/compilationplan/downtoup/hosyearplan/budgHosYearPlanAdd";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosyearplan/addBudgHosYearPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addBudgHosYearPlanDown(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosyearplan/budgHosYearPlanUpdatePage", method = RequestMethod.GET)
	public String budgHosYearPlanUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/budg/business/compilationplan/downtoup/hosyearplan/budgHosYearPlanUpdate";
	}
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosyearplan/updateBudgHosYearPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateBudgHosYearPlanDown(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosyearplan/addOrUpdateBudgHosYearPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateBudgHosYearPlanDown(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosyearplan/deleteBudgHosYearPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteBudgHosYearPlanDown(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosyearplan/queryBudgHosYearPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryBudgHosYearPlanDown(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosyearplan/budgHosYearPlanImportPage", method = RequestMethod.GET)
	public String budgHosYearPlanImportPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/downtoup/hosyearplan/budgHosYearPlanImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/business/compilationplan/downtoup/hosyearplan/downTemplate", method = RequestMethod.GET)  
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/business/compilationplan/downtoup/hosyearplan/readBudgHosYearPlanFiles",method = RequestMethod.POST)  
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/hosyearplan/addBatchBudgHosYearPlan", method = RequestMethod.POST)
	@ResponseBody
