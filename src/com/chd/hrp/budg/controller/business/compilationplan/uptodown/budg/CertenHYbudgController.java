...
@Controller
public class CertenHYbudgController extends BaseController{
	
	private static Logger logger = Logger.getLogger(CertenHYbudgController.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/certenHYBudgMainPage", method = RequestMethod.GET)
	public String zeroHYBudgMainPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/certenHYBudgMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/certenHYBudgAddPage", method = RequestMethod.GET)
	public String zeroHYBudgAddPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/certenHYBudgAdd";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/saveCertenHYBudgUp", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/addCertenHYBudgUpNew", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addCertenHYBudgUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		try {
			...
			budgWorkHosYearJson = budgWorkHosYearService.add(mapVo);
	...
	/*
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/addCertenHYBudgUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addCertenHYBudgUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
		...
		for ( String id: paramVo.split(",")) {
			...
			if("-1".equals(ids[4])){
				...
				mapVo.put("dept_suggest_sum", ids[4]);
			}
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/certenHYBudgUpdatePage", method = RequestMethod.GET)
	public String CertenHYBudgUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/updateCertenHYBudgUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateCertenHYBudgUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/addOrUpdateCertenHYBudgUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateCertenHYBudgUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/deleteCertenHYBudgUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteCertenHYBudgUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/queryCertenHYBudgUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryCertenHYBudgUp(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/certenHYBudgImportPage", method = RequestMethod.GET)
	public String zeroHYBudgImportPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/certenHYBudgImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/downTemplate", method = RequestMethod.GET)  
	 public String downTemplate(Plupload plupload,HttpServletRequest request,
	    		HttpServletResponse response,Model mode) throws IOException { 
	    			
	    printTemplate(request,response,"budg\\business\\toptodown","医院年度业务预算确定预算模板.xls");
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/readCertenHYBudgFiles",method = RequestMethod.POST)  
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/addBatchCertenHYBudgUp", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/generate", method=RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/queryBudgIndex", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/hosyearbudg/certen/collectCertenHYBudgData", method = RequestMethod.POST)
	@ResponseBody
	public String collectCertenHYBudgData(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		try {
			...
			String reJson = budgWorkHosYearService.collectCertenHYBudgData(mapVo);
