...
@Controller
public class BudgDeptYearPlanControllerDown extends BaseController{
	
	private static Logger logger = Logger.getLogger(BudgDeptYearPlanControllerDown.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/deptyearplan/queryBudgBuiltIn", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/deptyearplan/budgDeptYearPlanMainPage", method = RequestMethod.GET)
	public String budgHosYearPlanMainPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/downtoup/deptyearplan/budgDeptYearPlanMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/deptyearplan/budgDeptYearPlanAddPage", method = RequestMethod.GET)
	public String budgHosYearPlanAddPage(@RequestParam Map<String, Object> mapVo,Model mode) throws Exception {
		...
		return "hrp/budg/business/compilationplan/downtoup/deptyearplan/budgDeptYearPlanAdd";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/deptyearplan/addBudgDeptYearPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addBudgDeptYearPlanDown(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		String budgDeptYearPlanJson = null;
		
		try {
			
			budgDeptYearPlanJson = budgWorkEditPlanService.add(mapVo);
			
		} catch (Exception e) {

			budgDeptYearPlanJson = e.getMessage() ;
		}
		

		return JSONObject.parseObject(budgDeptYearPlanJson);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/deptyearplan/budgDeptYearPlanUpdatePage", method = RequestMethod.GET)
	public String budgDeptYearPlanUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/budg/business/compilationplan/downtoup/deptyearplan/budgDeptYearPlanUpdate";
	}
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/deptyearplan/updateBudgDeptYearPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateBudgDeptYearPlanDown(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		try {
			...
			budgDeptYearPlanJson = budgWorkEditPlanService.update(mapVo);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/deptyearplan/addOrUpdateBudgDeptYearPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateBudgDeptYearPlanDown(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		
		String budgDeptYearPlanJson ="";
		...
		budgDeptYearPlanJson =  budgWorkEditPlanService.addOrUpdate(detailVo);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/deptyearplan/deleteBudgDeptYearPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteBudgDeptYearPlanDown(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
		...
		try {
			...
			budgDeptYearPlanJson = budgWorkEditPlanService.deleteBatch(listVo);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/deptyearplan/queryBudgDeptYearPlanDown", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryBudgDeptYearPlanDown(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
  ...
  /**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/deptyearplan/budgDeptYearPlanImportPage", method = RequestMethod.GET)
	public String budgDeptYearPlanImportPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/downtoup/deptyearplan/budgDeptYearPlanImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/business/compilationplan/downtoup/deptyearplan/downTemplate", method = RequestMethod.GET)  
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/business/compilationplan/downtoup/deptyearplan/readBudgDeptYearPlanFiles",method = RequestMethod.POST)  
    public String readBudgDeptYearPlanFiles(Plupload plupload,HttpServletRequest request,
    		HttpServletResponse response,Model mode) throws IOException { 
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/downtoup/deptyearplan/addBatchBudgDeptYearPlan", method = RequestMethod.POST)
	@ResponseBody
    public Map<String, Object> addBatchBudgDeptYearPlan(@RequestParam(value = "ParamVo") String paramVo, Model mode)throws Exception{
