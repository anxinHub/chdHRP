...
@Controller
public class WorkDeptMonthController extends BaseController{
	
	private static Logger logger = Logger.getLogger(WorkDeptMonthController.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/budgWorkDeptMonthMainPage", method = RequestMethod.GET)
	public String budgWorkDeptMonthMainPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/deptmonthbudg/budgWorkDeptMonthMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/budgWorkDeptMonthAddPage", method = RequestMethod.GET)
	public String budgWorkDeptMonthAddPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/deptmonthbudg/budgWorkDeptMonthAdd";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/addBudgWorkDeptMonthUp", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/budgWorkDeptMonthUpdatePage", method = RequestMethod.GET)
	public String budgWorkDeptMonthUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/budg/business/compilationplan/uptodown/deptmonthbudg/budgWorkDeptMonthUpdate";
	}
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/updateBudgWorkDeptMonthUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateBudgWorkDeptMonthUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/updateBudgWorkDeptMonthRate", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/addOrUpdateBudgWorkDeptMonth", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/deleteBudgWorkDeptMonthUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteBudgWorkDeptMonthUp(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/queryBudgWorkDeptMonthUp", method = RequestMethod.POST)
	@ResponseBody
  ...
  /**
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/budgWorkDeptMonthImportPage", method = RequestMethod.GET)
	public String budgWorkDeptMonthImportPage(Model mode) throws Exception {

		return "hrp/budg/business/compilationplan/uptodown/deptmonthbudg/budgWorkDeptMonthImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/business/compilationplan/uptodown/deptmonthbudg/downTemplate", method = RequestMethod.GET)  
	 public String downTemplate(Plupload plupload,HttpServletRequest request,
	    		HttpServletResponse response,Model mode) throws IOException { 
	    			
	    printTemplate(request,response,"budg\\business\\toptodown","科室月份业务预算模板.xls");
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/readBudgWorkDeptMonthFiles",method = RequestMethod.POST)  
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/addBatchBudgWorkDeptMonth", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/collectBudgWorkDeptMonthUp", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> collectBudgWorkDeptMonthUp(@RequestParam Map<String, Object> mapVo,Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/queryCollectData", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/compilationplan/uptodown/deptmonthbudg/generate", method=RequestMethod.POST)
	@ResponseBody
				...
				if(item.get("dept_id") !=  null){
					...
					for(String month : monthData){
						...
						if(count == 0){
							...
							map.put("hos_suggest_resolve", "");
							map.put("dept_suggest", "");
