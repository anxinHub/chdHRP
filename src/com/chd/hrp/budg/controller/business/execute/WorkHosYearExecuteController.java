...
@Controller
public class WorkHosYearExecuteController extends BaseController{
	
	private static Logger logger = Logger.getLogger(WorkHosYearExecuteController.class);
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/execute/hosyearexecute/workHosYearExecuteMainPage", method = RequestMethod.GET)
	public String workHosYearExecuteMainPage(Model mode) throws Exception {

		return "hrp/budg/business/execute/hosyearexecute/workHosYearExecuteMain";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/execute/hosyearexecute/workHosYearExecuteAddPage", method = RequestMethod.GET)
	public String workHosYearExecuteAddPage(Model mode) throws Exception {

		return "hrp/budg/business/execute/hosyearexecute/workHosYearExecuteAdd";
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/execute/hosyearexecute/addWorkHosYearExecute", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addWorkHosYearExecute(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/execute/hosyearexecute/workHosYearExecuteUpdatePage", method = RequestMethod.GET)
	public String workHosYearExecuteUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		return "hrp/budg/business/execute/hosyearexecute/workHosYearExecuteUpdate";
	}
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/execute/hosyearexecute/updateWorkHosYearExecute", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateWorkHosYearExecute(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/execute/hosyearexecute/addOrUpdateWorkHosYearExecute", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> addOrUpdateWorkHosYearExecute(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/execute/hosyearexecute/deleteWorkHosYearExecute", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteWorkHosYearExecute(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/execute/hosyearexecute/queryWorkHosYearExecute", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryWorkHosYearExecute(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/budg/business/execute/hosyearexecute/workHosYearExecuteImportPage", method = RequestMethod.GET)
	public String workHosYearExecuteImportPage(Model mode) throws Exception {

		return "hrp/budg/business/execute/hosyearexecute/workHosYearExecuteImport";
	 ...
	 * @throws IOException
	*/
	 @RequestMapping(value="hrp/budg/business/execute/hosyearexecute/downTemplate", method = RequestMethod.GET)  
	 public String downTemplate(Plupload plupload,HttpServletRequest request,
	    		HttpServletResponse response,Model mode) throws IOException { 
	    			
	    printTemplate(request,response,"budg\\business\\execute","医院年度业务预算执行模板.xls");
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value="/hrp/budg/business/execute/hosyearexecute/readWorkHosYearExecuteFiles",method = RequestMethod.POST)  
    public String readWorkHosYearExecuteFiles(Plupload plupload,HttpServletRequest request,
    		HttpServletResponse response,Model mode) throws IOException { 			 
   ...
   /**
	 ...
	 * @throws IOException
	*/
	@RequestMapping(value = "/hrp/budg/business/execute/hosyearexecute/addBatchWorkHosYearExecute", method = RequestMethod.POST)
	@ResponseBody
    public Map<String, Object> addBatchWorkHosYearExecute(@RequestParam(value = "ParamVo") String paramVo, Model mode)throws Exception{
