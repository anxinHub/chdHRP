...
import com.chd.hrp.cost.dao.CostExecDeptEarningsAnalysisMapper;
...
@Service("costExecDeptEarningsAnalysisService")
public class CostExecDeptEarningsAnalysisServiceImpl implements CostExecDeptEarningsAnalysisService {

	private static Logger logger = Logger.getLogger(CostExecDeptEarningsAnalysisServiceImpl.class);
	
	@Resource(name = "costExecDeptEarningsAnalysisMapper")
	private final CostExecDeptEarningsAnalysisMapper costExecDeptEarningsAnalysisMapper = null;
	...
	*/
	...
	public String queryCostExecDeptEarnings(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal()==-1){
			...
			List<CostExecDeptEarnings> list = costExecDeptEarningsAnalysisMapper.queryCostExecDeptEarnings(entityMap);
			...
			List<CostExecDeptEarnings> list = costExecDeptEarningsAnalysisMapper.queryCostExecDeptEarnings(entityMap, rowBounds);
