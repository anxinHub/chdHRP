...
import com.chd.hrp.cost.dao.CostExecIncomeTrendAnalysisMapper;
...
@Service("costExecIncomeTrendAnalysisService")
public class CostExecIncomeTrendAnalysisServiceImpl implements CostExecIncomeTrendAnalysisService {

	private static Logger logger = Logger.getLogger(CostExecIncomeTrendAnalysisServiceImpl.class);
	
	@Resource(name = "costExecIncomeTrendAnalysisMapper")
	private final CostExecIncomeTrendAnalysisMapper costExecIncomeTrendAnalysisMapper = null;
	...
	*/
	...
	public String queryCostExecIncomeTrend(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal()==-1){
			...
			List<CostExecIncomeTrend> list = costExecIncomeTrendAnalysisMapper.queryCostExecIncomeTrend(entityMap);
			...
			List<CostExecIncomeTrend> list = costExecIncomeTrendAnalysisMapper.queryCostExecIncomeTrend(entityMap, rowBounds);
