...
@Service("costSuperReportDataSetService")
public class CostSuperReportDataSetServiceImpl implements CostSuperReportDataSetService {

	private static Logger logger = Logger.getLogger(CostSuperReportDataSetServiceImpl.class);
	
	@Autowired
	private CostSuperReportDataSetMapper dataSetMapper;
