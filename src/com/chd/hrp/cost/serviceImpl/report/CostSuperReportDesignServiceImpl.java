 ...
 *
 */
@Service("costSuperReportDesignService")
public class CostSuperReportDesignServiceImpl implements CostSuperReportDesignService {
	...
	public String querySuperReportByMod(Map<String, Object> map) throws DataAccessException {
		...
		list = costSuperReportDesignMapper.querySuperReportByMod(map);
	...
	public String saveSuperReport(Map<String, Object> map) throws DataAccessException {
		...
		try {
			...
			if (map.get("sort_code").toString().equals("系统生成")) {
				...
				// 添加
				costSuperReportDesignMapper.insertSuperReport(map);
			} else {
				// 修改
				costSuperReportDesignMapper.updateSuperReport(map);
			}
	...
	public String updateSuperReportContent(Map<String, Object> map) throws DataAccessException {
		try {
			costSuperReportDesignMapper.updateSuperReportContent(map);
			return "{\"msg\":\"保存成功.\",\"state\":\"true\"}";
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
			throw new SysException(e.getMessage());
	...
	public String deleteSuperReportByCode(Map<String, Object> map) throws DataAccessException {
		...
		try {
			...
			int count = costSuperReportDesignMapper.querySuperReportInstanceCountByCode(map);
			if (count > 0) {
				return "{\"error\":\"已经有报表数据，不能删除，到【报表管理】页面删除该报表数据！\",\"state\":\"false\"}";
			}

			costSuperReportDesignMapper.deleteSuperReportByCode(map);
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
			throw new SysException(e.getMessage());
	...
	public String querySuperReportParaByEle(Map<String, Object> map) throws DataAccessException {
		// TODO Auto-generated method stub
		return ChdJson.toJson(costSuperReportDesignMapper.querySuperReportParaByEle(map));
	}
	...
	public String querySuperReportParaByDs(Map<String, Object> map) throws DataAccessException {
		// TODO Auto-generated method stub
		return ChdJson.toJson(costSuperReportDesignMapper.querySuperReportParaByDs(map));
	...
	public String querySuperReportParaSelectData(Map<String, Object> map) throws DataAccessException {
		...
		CostRepDefineDict dict = costSuperReportDesignMapper.querySuperReportDictBySql(map);
		...
		if (!dictSql.equals("")) {
			...
			return JSON.toJSONString(costSuperReportDesignMapper.querySuperReportParaSelectData(dictSql));
		}
	...
	public String queryMakeSuperReportDsManager(Map<String, Object> mapVo) throws DataAccessException {
		...
		List<Map<String, Object>> list = costSuperReportDataSetMapper.querySuperReportDsColForMake(mapVo);
	...
	public List<Map<String, Object>> queryDetailParamForMakeReport(Map<String, Object> mapVo) {
		...
		mapVo.put("list", list);
		List<Map<String, Object>> relist = costSuperReportDataSetMapper.queryDetailParamForMakeReport(mapVo);

		List<Map<String, Object>> list2 = costSuperReportDataSetMapper.queryDetailParamForMakeReport2(mapVo);
	...
	public String updateRepRepDSPara(Map<String, Object> mapVo) {
		try {
			costSuperReportDataSetMapper.saveRepRepDSPara(mapVo);
