...
public class CostMateTypeArrt implements Serializable {
	 ...
	 * 设置 材料分类编码
	 */
	public void setMate_type_code(String value) {
		this.mate_type_code = value;
	}
	/**
	 * 获取 材料分类编码
	 */	
	public String getMate_type_code() {
		return this.mate_type_code;
	}
	/**
	 * 设置 材料分类名称
	 */
	public void setMate_type_name(String value) {
		this.mate_type_name = value;
	}
	/**
	 * 获取 材料分类名称
	 */	
	public String getMate_type_name() {
		return this.mate_type_name;
	}
	/**
	 * 设置 上级编码
	 */
