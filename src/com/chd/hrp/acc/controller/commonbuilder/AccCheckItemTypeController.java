...
@Controller
public class AccCheckItemTypeController extends BaseController{
	private static Logger logger = Logger.getLogger(AccCheckItemTypeController.class);
	...
	*/
	// 添加页面
	@RequestMapping(value = "/hrp/acc/acccheckitem/accCheckItemTypeAddPage", method = RequestMethod.GET)
	public String accCheckItemTypeAddPage(Model mode,String check_type_id, String check_type_name) throws Exception {
		...
		return "hrp/acc/acccheckitem/accCheckItemTypeAdd";
	...
	*保存
	*/
	@RequestMapping(value = "/hrp/acc/acccheckitem/addAccCheckItemType", method = RequestMethod.POST)
	@ResponseBody
	...
	public Map<String, Object> addAccCheckItemType(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
        ...
        mapVo.put("hos_id", SessionManager.getHosId());
        mapVo.put("copy_code", SessionManager.getCopyCode());
		String accCheckTypeJson = accCheckItemTypeService.addAccCheckItemType(mapVo);
	...
	*查询
	*/
	@RequestMapping(value = "/hrp/acc/acccheckitem/queryAccCheckItemType", method = RequestMethod.POST)
	@ResponseBody
	...
	public Map<String, Object> queryAccCheckItemType(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		String accCheckItemType = accCheckItemTypeService.queryAccCheckItemType(getPage(mapVo));
	...
	*删除
	*/
	@RequestMapping(value = "/hrp/acc/acccheckitem/deleteAccCheckItemType", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> deleteAccCheckItemType(@RequestParam(value="ParamVo") String paramVo, Model mode) throws Exception {
		...
		String accCheckItemTypeJson = accCheckItemTypeService.deleteAccCheckItemType(listVo);
	...
	*修改页面跳转
	*/
	@RequestMapping(value = "/hrp/acc/acccheckitem/accCheckItemTypeUpdatePage", method = RequestMethod.GET)
	...
	public String accCheckItemTypeUpdatePage(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
        ...
        accCheckItemType = accCheckItemTypeService.queryAccCheckItemTypeById(mapVo);
		...
		return "hrp/acc/acccheckitem/accCheckItemTypeUpdate";
	}
	/**
	*核算分类<BR>
	*修改保存
	*/	
	...
	@RequestMapping(value = "/hrp/acc/acccheckitem/updateAccCheckItemType", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateAccCheckItemType(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		...
		String accCheckItemTypeJson = accCheckItemTypeService.updateAccCheckItemType(mapVo);
	...
	*/
	...
	@RequestMapping(value = "/hrp/acc/acccheckitem/importAccCheckItemType", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> importAccCheckItemType(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
		
		String accCheckItemTypeJson = accCheckItemTypeService.importAccCheckItemType(mapVo);
