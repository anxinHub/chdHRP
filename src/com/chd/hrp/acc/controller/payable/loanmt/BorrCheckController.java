...
@Controller
public class BorrCheckController extends BaseController{
	private static Logger logger = Logger.getLogger(BorrCheckController.class);	
	...
	@RequestMapping(value = "/hrp/acc/payable/loanmt/check/applyMainPage", method = RequestMethod.GET)
	public String ApplyMainPage(Model mode) throws Exception {

		return "hrp/acc/payable/loanmt/check/main";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/acc/payable/loanmt/check/budgBorrApplyUpdatePage", method = RequestMethod.GET)
	public String assInMainUpdatePage(@RequestParam Map<String, Object> mapVo,
		...
		return "hrp/acc/payable/loanmt/check/update";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/acc/payable/loanmt/check/updateToExamineApply", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateToExamineApply( @RequestParam(value = "ParamVo") String paramVo, Model mode) throws Exception {
		...
		try{
			String assInMainJson = budgBorrApplyService.updateToExamine(listVo);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/acc/payable/loanmt/check/updateNotToExamineApply", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> updateNotToExamineApply( @RequestParam(value = "ParamVo") String paramVo, Model mode) throws Exception {
		List<Map<String, Object>> listVo = new ArrayList<Map<String, Object>>();
		boolean flag = true;
		...
		try{
			String assInMainJson = budgBorrApplyService.updateNotToExamine(listVo);
			return JSONObject.parseObject(assInMainJson);
		}catch(Exception e){
			return JSONObject.parseObject("{\"error\":\""+e.getMessage()+" \"}");
		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/hrp/acc/payable/loanmt/check/queryBudgBorrCheck", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryBudgBorrCheck( @RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
	...
	@RequestMapping(value = "/hrp/acc/payable/loanmt/check/queryBudgBorrApplyDet", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/hrp/acc/payable/loanmt/check/getBorrowAmount", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @throws Exception
	*/
	@RequestMapping(value = "/hrp/acc/payable/loanmt/check/queryBorrCheckPrintTemlate", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> queryBorrCheckPrintTemlate(@RequestParam Map<String, Object> mapVo, Model mode) throws Exception {
