...
@Service("accPersonCollectService")
public class AccPersonCollectServiceImpl implements AccPersonCollectService{

	private static Logger logger = Logger.getLogger(AccPersonCollectServiceImpl.class);
	
	@Resource(name = "sysFunUtilMapper")
	private final SysFunUtilMapper sysFunUtilMapper = null;
	
	@Resource(name = "accPersonCollectMapper")
	private final AccPersonCollectMapper accPersonCollectMapper = null;

	@Override
	public String addAccPersonCollect(Map<String, Object> entityMap) throws DataAccessException {
		// TODO Auto-generated method stub
		try {
				Map<String,Object> accFirstMap = accPersonCollectMapper.queryAccPersonByFirst(entityMap);
				if(accFirstMap != null && "2".equals(accFirstMap.get("state").toString())){
					...
					Map<String,Object> accPersonMap = accPersonCollectMapper.queryAccPersonByCode(entityMap);
					...
					accPersonCollectMapper.addAccPerson(entityMap);
					accPersonCollectMapper.updateAccPersonFtBl(entityMap);
	...
	@Override
	public String updateAccPersonCollect(Map<String, Object> entityMap)
		...
		try {
			...
			if(accFirstMap != null && "2".equals(accFirstMap.get("state").toString())){
				...
				accPersonCollectMapper.updateAccPersonCollect(entityMap);
				accPersonCollectMapper.updateAccPersonFtBl(entityMap);
	...
	@Override
	public String updateAccPersonDataFromLastMonth(Map<String, Object> entityMap)
			throws DataAccessException {
		// TODO Auto-generated method stub
		...
		try {
			...
			if(accFirstMap != null){
				...
				List<Map<String, Object>> list = accPersonCollectMapper.queryAccPersonByLastMonth(entityMap);
				if(list.size() == 0){
					return "{\"error\":\"上月数据为空.\"}";
				}
				accPersonCollectMapper.updateAccPersonDataFromLastMonth(entityMap);
				return "{\"msg\":\"数据更新成功.\",\"state\":\"true\"}";
			}
		} catch (Exception e) {
			// TODO: handle exception
			logger.error(e.getMessage(), e);
			return "{\"error\":\"修改失败 数据库异常 请联系管理员! 错误编码  updateAccPersonDataFromLastMonth\"}";
		}

	}
	
	@Override
	public String insertAccSysPerson(Map<String, Object> entityMap)
			throws DataAccessException {
		// TODO Auto-generated method stub
		...
		try {
			...
			if(accFirstMap != null && "2".equals(accFirstMap.get("state").toString())){
				...
				accPersonCollectMapper.insertAccSysPerson(entityMap);
				accPersonCollectMapper.updateAccPersonFtBl(entityMap);
				return "{\"msg\":\"采集数据成功.\",\"state\":\"true\"}";
			}
		} catch (Exception e) {
			// TODO: handle exception
			logger.error(e.getMessage(), e);
	...
	@Override
	public String updateAccPersonState(Map<String, Object> entityMap)
			throws DataAccessException {
		// TODO Auto-generated method stub
		
		try {
			if("1".equals(entityMap.get("state").toString())){
				int count = accPersonCollectMapper.queryQuoteOrNot(entityMap);
				if(count>0){
					return "{\"error\":\"" + entityMap.get("year_month").toString() + "的数据已被使用，无法取消审核.\"}";
				}
			}
			accPersonCollectMapper.updateAccPersonState(entityMap);
			...
			return "{\"error\":\"审核失败 数据库异常 请联系管理员! 错误编码  updateAccPersonState\"}";
		}
	...
	public String queryAccPersonCollect(Map<String, Object> entityMap) throws DataAccessException {
		...
		if (sysPage.getTotal() == -1) {
			List<Map<String, Object>> list = accPersonCollectMapper.queryAccPersonCollect(entityMap);
			
			return ChdJson.toJson(list);
		} else {
			RowBounds rowBounds = new RowBounds(sysPage.getPage(), sysPage.getPagesize());
			List<Map<String, Object>> list = accPersonCollectMapper.queryAccPersonCollect(entityMap, rowBounds);
	...
	public String queryTotalNum(Map<String, Object> entityMap) throws DataAccessException {
		...
		Map<String,Object> accTotalMap = accPersonCollectMapper.queryTotalNum(entityMap);
	...
	@Override
	public String deletePersonCollect(List<Map<String, Object>> list)
			throws DataAccessException {
		// TODO Auto-generated method stub
		try {
			...
			if(accFirstMap != null && "2".equals(accFirstMap.get("state").toString())){
				...
				accPersonCollectMapper.deletePersonCollect(list);
				accPersonCollectMapper.updateAccPersonFtBl(entityMap);
	...
	public Map<String, Object> queryAccPersonById(Map<String, Object> entityMap) throws DataAccessException {
		// TODO Auto-generated method stub
		return accPersonCollectMapper.queryAccPersonById(entityMap);
	}
...
//			}
			...
			List<Map<String, Object>> list = accPersonCollectMapper.queryDeptAllInfoDict(mapVo);
			...
			for (Map<String, List<String>> map : liData) {
				...
				String emp_count = map.get("科室人数").get(1);
				...
				if (emp_count == null || "".equals(emp_count)) {
					return "{\"warn\":\"科室人数为空！\",\"state\":\"false\",\"row_cell\":\"" + map.get("科室人数").get(0) + "\"}";
				}
			...
			if (!deptList.isEmpty()) {
				...
				Map<String, Object> accFirstMap = accPersonCollectMapper.queryAccPersonByFirst(saveMap);
				if(accFirstMap != null && "2".equals(accFirstMap.get("state").toString())){
					return "{\"error\":\"日期：" + accFirstMap.get("year_month").toString() + "的数据已审核,无法修改.\"}";
				}else{
					accPersonCollectMapper.insertAccPersonByImport(deptList);
					accPersonCollectMapper.updateAccPersonFtBl(saveMap);
				}
			}
