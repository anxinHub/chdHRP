...
import com.chd.hrp.acc.dao.accAly.AccAlyFacMapper;
...
@Service("accAlyFacService")
public class AccAlyFacServiceImpl implements AccAlyFacService {

	private static Logger logger = Logger.getLogger(AccAlyFacServiceImpl.class);
	//引入DAO操作
	@Resource(name = "accAlyFacMapper")
	private final AccAlyFacMapper accAlyFacMapper = null;
	...
	public String add(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
			...
			if(!entityMap.get("super_code").toString().equals("0")){
				...
				hm.putAll(entityMap); 
				hm.put("fac_code", hm.get("super_code"));
				map= queryByCode(hm);
	...
	*/
	...
	public String update(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  accAlyFacMapper.update(entityMap);
	...
	*/
    ...
    try {
			...
			int state = accAlyFacMapper.delete(entityMap);
	...
	public List<Map<String, Object>> queryFacPrintDate(Map<String, Object> entityMap) throws DataAccessException {
		...
		List<Map<String,Object>> list = (List<Map<String,Object>>)accAlyFacMapper.query(entityMap);
	...
	public String deleteBatch(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			for(Map<String,Object> map:entityList){
				fac_code=map.get("fac_code").toString();
				code=fac_code.split("@");
				map.put("fac_code", code[0]);
				map.put("super_code", code[1]);
			}
			accAlyFacMapper.deleteBatch(entityList);
			//判断修改其父级级别
			List<Map<String,Object>> tmpList=null;
			Map<String,Object> parentMap=null;
			for(Map<String,Object> map:entityList){
				if(!map.get("super_code").toString().equals("0")){
					tmpList=(List<Map<String, Object>>) accAlyFacMapper.query(map);
					if(tmpList==null||tmpList.size()==0){
						//修改父级为末级
						parentMap=new HashMap<String,Object>();
						parentMap.put("fac_code", map.get("super_code"));
						...
						accAlyFacMapper.update(parentMap);
	...
	*/
	...
	public String query(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<Map<String,Object>> list = (List<Map<String,Object>>)accAlyFacMapper.query(entityMap, rowBounds);
	...
	public <T> T queryByCode(Map<String,Object> entityMap)throws DataAccessException{
		return accAlyFacMapper.queryByCode(entityMap);
	}
	

	@Override
	public <T> T queryByUniqueness(Map<String,Object> entityMap)throws DataAccessException{
		return accAlyFacMapper.queryByUniqueness(entityMap);
	}
	

	@Override
	public List<?> queryExists(Map<String,Object> entityMap)throws DataAccessException{
		return accAlyFacMapper.queryExists(entityMap);
	}
