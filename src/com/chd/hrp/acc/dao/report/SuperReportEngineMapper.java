...
public interface SuperReportEngineMapper extends SqlMapper{

		
	//根据系统编码查询报表
	public List<RepDefine> queryAccSuperReportByPerm(Map<String, Object> map) throws DataAccessException;

	//根据报表编码、年度、月份查询报表实例数据
	public RepInstance querySuperReportInstance(Map<String, Object> map) throws DataAccessException;
