...
public interface SuperReportManagerMapper extends SqlMapper{
		
	 
	//报表管理页面，查询报表的所有实例 
	public List<RepInstance> querySuperReportInstanceList(Map<String, Object> map) throws DataAccessException;
	...
	//报表管理页面，根据字典编码查询报表字典
	public RepDefineDict querySuperReportDictByCode(Map<String, Object> map) throws DataAccessException;
	...
	public List<Map<String, Object>> getReportQuery(Map<String, Object> mapVo) throws DataAccessException;
