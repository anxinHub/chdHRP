...
public interface AccIssAutoVouchMapper extends SqlMapper {
	// 查询表头
	public List<BusiQuery> queryAssAutoVouchHead(Map<String, Object> entityMap) throws DataAccessException;

	public List<Map<String, Object>> queryAssAutoVouch(Map<String, Object> entityMap, RowBounds rowBounds)
			throws DataAccessException;

	public List<Map<String, Object>> queryAssAutoVouch(Map<String, Object> entityMap) throws DataAccessException;

	// 按日期生成凭证，查询业务ID
	public List<String> queryAssAutoVouchBusiIdList(Map<String, Object> map) throws DataAccessException;
