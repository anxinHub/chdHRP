...
public interface AccPubAutoVouchMapper extends SqlMapper{
	
	//查询表头
	public List<BusiQuery> queryPubAutoVouchHead(Map<String,Object> entityMap)throws DataAccessException;
	
	public List<Map<String, Object>> queryPubAutoVouch(Map<String, Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	
	public List<Map<String, Object>> queryPubAutoVouch(Map<String, Object> entityMap) throws DataAccessException;
	
	//按日期生成凭证，查询业务ID 
	public List<String> queryPubAutoVouchBusiIdList(Map<String, Object> map) throws DataAccessException;
