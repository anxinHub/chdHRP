...
public class AccFunType implements Serializable {
	 ...
	 * 设置 支出功能分类ID
	 */
	public void setFun_id(Long value) {
		this.fun_id = value;
	}
	/**
	 * 获取 支出功能分类ID
	 ...
	 * 设置 分类级次
	 */
	public void setFun_level(Integer value) {
		this.fun_level = value;
	}
	/**
	 * 获取 分类级次
	 */	
	public Integer getFun_level() {
		return this.fun_level;
	}
	/**
	 * 设置 是否末级
	 */
