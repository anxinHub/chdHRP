...
import com.chd.hrp.hpm.dao.AphiTargetMethodParaMapper;
...
@Service("aphiTargetMethodParaService")
public class AphiTargetMethodParaServiceImpl implements AphiTargetMethodParaService {

	private static Logger logger = Logger.getLogger(AphiTargetMethodParaServiceImpl.class);
	//引入DAO操作
	@Resource(name = "aphiTargetMethodParaMapper")
	private final AphiTargetMethodParaMapper aphiTargetMethodParaMapper = null;
	...
	*/
	...
	public String addPrmTargetMethodPara(Map<String,Object> entityMap)throws DataAccessException{
		...
		//获取对象9903 指标取值方法参数表
		AphiTargetMethodPara prmTargetMethodPara = queryPrmTargetMethodParaByCode(entityMap);
		...
		try {
			...
			int state = aphiTargetMethodParaMapper.addPrmTargetMethodPara(entityMap);
	...
	public String addPrmTargetMethod(Map<String,Object> entityMap)throws DataAccessException{
		...
		*/
		try {
			...
			int state = aphiTargetMethodParaMapper.addPrmTargetMethod(entityMap);
	...
	*/
	...
	public String addBatchPrmTargetMethodPara(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			aphiTargetMethodParaMapper.addBatchPrmTargetMethodPara(entityList);
	...
	*/
	...
	public String updatePrmTargetMethodPara(Map<String,Object> entityMap)throws DataAccessException{
		...
		try {
		  ...
		  int state = aphiTargetMethodParaMapper.updatePrmTargetMethodPara(entityMap);
	...
	*/
	...
	public String updateBatchPrmTargetMethodPara(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
		  ...
		  aphiTargetMethodParaMapper.updateBatchPrmTargetMethodPara(entityList);
	...
	*/
    ...
    try {
			...
			int state = aphiTargetMethodParaMapper.deletePrmTargetMethodPara(entityMap);
	...
	*/
	...
	public String deleteBatchPrmTargetMethodPara(List<Map<String,Object>> entityList)throws DataAccessException{
		...
		try {
			...
			aphiTargetMethodParaMapper.deleteBatchPrmTargetMethodPara(entityList);
	...
	*/
	...
	public String queryPrmTargetMethodPara(Map<String,Object> entityMap) throws DataAccessException{
		...
		if (sysPage.getTotal()==-1){
			...
			List<AphiTargetMethodPara> list = aphiTargetMethodParaMapper.queryPrmTargetMethodPara(entityMap);
			...
			List<AphiTargetMethodPara> list = aphiTargetMethodParaMapper.queryPrmTargetMethodPara(entityMap, rowBounds);
	...
	*/
	...
	public AphiTargetMethodPara queryPrmTargetMethodParaByCode(Map<String,Object> entityMap)throws DataAccessException{
		return aphiTargetMethodParaMapper.queryPrmTargetMethodParaByCode(entityMap);
	}
