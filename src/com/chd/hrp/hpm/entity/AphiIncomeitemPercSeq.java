...
public class AphiIncomeitemPercSeq implements Serializable {
	...
	public void setIncome_percent(double value) {
		this.income_percent = value;
	}

	public double getIncome_percent() {
