...
public class AphiDeptBalancePercConfSeq implements Serializable {
	...
	public void setDept_percent(double value) {
		this.dept_percent = value;
	}

	public double getDept_percent() {
		return this.dept_percent;
	}
}