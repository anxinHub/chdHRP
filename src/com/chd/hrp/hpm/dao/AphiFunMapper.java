...
public interface AphiFunMapper extends SqlMapper{
	/**
	 * @Description 
	 * 添加9908 绩效函数表<BR> 
	 * @param  entityMap
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public List<AphiFun> queryPrmFun(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<AphiFun> queryPrmFunByFile(Map<String,Object> entityMap) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	*/
	public List<AphiFun> queryPrmFun(Map<String,Object> entityMap, RowBounds rowBounds) throws DataAccessException;
	/**
	 * @Description 
	 * 获取9908 绩效函数表<BR> 
	 * @param  entityMap
	...
	*/
	 ...
	 * @throws DataAccessException
	*/
	public AphiFun queryPrmFunByPrcName(Map<String,Object> entityMap)throws DataAccessException;
