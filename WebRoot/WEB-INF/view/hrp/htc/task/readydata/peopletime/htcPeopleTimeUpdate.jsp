...
<html style="overflow:hidden;">
  <head>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcPeopleTime.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input type="text" name="time_sum" id="time_sum" value='${time_sum}'  validate="{required:true}"/></td>
            <td align="left"></td>
        </tr> 
        </table>
    </form>
