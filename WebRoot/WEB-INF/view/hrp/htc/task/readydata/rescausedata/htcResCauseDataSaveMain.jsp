...
<script type="text/javascript">
    ...
    var userUpdateStr;
    var res_cause_code = '${res_cause_code}';
    var res_cause_name = '${res_cause_name}';
    $(function ()
    {
        loadDict()//加载下拉框
    	//加载数据
    ...
    function  query(){
    	...
    	grid.options.parms.push({name:'res_cause_code',value:res_cause_code}); 
    	//加载查询条件
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryHtcResCauseData.do',
                     ...
                     toolbar: { items: [
                     	...
                     	{ line:true },
                     	{ text: '采集', id:'collect', click: collect,icon:'cut' },
                     	{ line:true },
    				]}
                   });
    ...
    function collect(){
		...
		ajaxJsonObjectByUrl("collectHtcResCauseData.do?isCheck=false", {ParamVo : ParamVo.toString()}, function(responseData) {
