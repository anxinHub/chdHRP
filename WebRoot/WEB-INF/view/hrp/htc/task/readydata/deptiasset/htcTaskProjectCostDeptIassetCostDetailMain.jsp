...
<script type="text/javascript">
		...
		grid = $("#maingrid").ligerGrid(
				{
					...
					dataType : 'server',
					usePager : true,
					url : 'queryHtcTaskProjectCostDeptIassetCostDetail.do',
					width : '100%',
					height : '100%',
					checkbox : true,
					delayLoad :true,
	...
	function dataDispose(){
		...
		var formPara = {
			...
			ajaxJsonObjectByUrl("disposeHtcTaskProjectCostDeptIassetCostDetail.do?isCheck=false",formPara,function(responseData) {
