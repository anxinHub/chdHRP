...
<script type="text/javascript">
	...
	function query() {
		...
		grid.options.parms.push({name : 'mate_code',value:liger.get("mate_code").getValue()});
		...
		grid = $("#maingrid").ligerGrid(
				{
					...
					dataType : 'server',
					usePager : true,
					url : 'queryHtcTaskProjectCostDeptMaterialCostDetail.do',
					height : '100%',
					delayLoad :true,
					checkbox : true,
					rownumbers : true,
	...
	function dataDispose(){
		...
		var formPara = {
			...
			ajaxJsonObjectByUrl("disposeHtcTaskProjectCostDeptMaterialCostDetail.do?isCheck=false",formPara,function(responseData) {
...
<body style="padding: 0px; overflow: hidden;">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit">
		...
		<tr>
			<td align="right" class="l-table-edit-td" style="padding-left: 20px;">材料：</td>
