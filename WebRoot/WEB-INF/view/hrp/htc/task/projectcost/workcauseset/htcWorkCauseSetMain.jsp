...
<script type="text/javascript">
	...
	function init(){
	   var formPara={
		...
		ajaxJsonObjectByUrl("initHtcWorkCauseSet.do?isCheck=false",formPara,function(
				responseData) {
	...
	function openBatchUpdate(){
		...
		if (data.length == 0) {
			...
			$.ligerDialog.open({
				url : 'htcWorkCauseSetBatchUpdatePage.do?isCheck=false&ParamVo='+ ParamVo.toString(),
				data : {},
				height : 300,
				width : 500,
				title : '修改',
	...
	function remove(){
		...
		if (data.length == 0) {
			...
			$.ligerDialog.confirm('确定删除?', function(yes) {
				if (yes) {
					ajaxJsonObjectByUrl("deleteHtcWorkCauseSet.do", {
