...
<script type="text/javascript">
  ...
  function loadHeadCharge(){
	  grid_charge = $("#maingrid_charge").ligerGrid({
			...
			dataType : 'server',
			usePager : true,
			url : 'queryHtcChargeCoopCharge.do?isCheck=false',
			width : '100%',
			height : '100%',
			checkbox : 'checkbox',
			delayLoad : true,
	...
	function loadHeadTitle(){
		grid_title = $("#maingrid_title").ligerGrid({
			...
			dataType : 'server',
			usePager : false,
			url : 'queryHtcChargeCoopTitle.do?isCheck=false',
			width : '100%',
			height : '100%',
			checkbox : 'checkbox',
			//rownumbers : true,
 ...
 function f_onAfterEdit(rowdata, rowid, rowobj){
	...
	ajaxJsonObjectByUrl("saveHtcChargeCoop.do", formPara, function(responseData) {
