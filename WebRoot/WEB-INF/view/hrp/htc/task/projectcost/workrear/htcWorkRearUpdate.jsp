...
<html style="overflow:hidden;">
  <head>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcWorkRear.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="rear" type="text" id="rear" ltype="text" value='${rear}' validate="{required:true}" /></td>
				<td align="left"></td>
			</tr>
        </table>
    </form>
