...
<script type="text/javascript">
	...
	function loadHead() {
      ...
      function add_open(){
    	  $.ligerDialog.open({
				url : 'htcWorkRearAddPage.do?isCheck=false',
				height : 260,
				width : 500,
				title : '添加',
				modal : true,
    	  ...
    	  var data = gridManager.getCheckedRows();
			if (data.length == 0) {
				...
				$.ligerDialog.confirm('确定删除?', function(yes) {
					if (yes) {
						ajaxJsonObjectByUrl("deleteHtcWorkRear.do", {
	...
	function openUpdate(obj) {
		...
		var parm = "&" + "group_id="  + vo[0] 
		         ...
		         + "&" + "work_code=" + vo[7]
		$.ligerDialog.open({
			url : 'htcWorkRearUpdatePage.do?isCheck=false&' + parm,
			data : {},
			height : 260,
			width : 500,
			title : '修改',
