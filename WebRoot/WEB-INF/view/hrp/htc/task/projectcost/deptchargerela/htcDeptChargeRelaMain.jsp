...
<script type="text/javascript">
	...
	function add_open(){
		$.ligerDialog.open({
			url : 'htcDeptChargeRelaAddPage.do?isCheck=false',
			height : 350,
			width : 500,
			title : '添加',
			modal : true,
			...
			$(data).each(
					function() {
						ParamVo.push(this.group_id + "@"
								   ...
								   + this.proj_dept_no + "@"
								   + this.proj_dept_id + "@"
								   + this.charge_item_id);//实际代码中temp替换主键
					});
			$.ligerDialog.confirm('确定删除?', function(yes) {
				if (yes) {
					ajaxJsonObjectByUrl("deleteHtcDeptChargeRela.do", {
	...
	function openUpdate(obj) {
		...
		var parm =       "group_id="  + vo[0] 
		         ...
		         + "&" + "proj_dept_id=" + vo[6]
		         + "&" + "charge_item_id=" + vo[7]
		$.ligerDialog.open({url : 'htcDeptChargeRelaUpdatePage.do?isCheck=false&'+parm,
					data : {},
					height : 350,
					width : 500,
					title : '修改',
