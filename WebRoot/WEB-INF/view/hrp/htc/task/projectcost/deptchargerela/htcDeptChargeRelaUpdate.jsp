...
<script type="text/javascript">
	...
	function save() {
		var formPara = {
        	...
        	charge_item_id : liger.get("charge_item_code").getValue()
		};
		ajaxJsonObjectByUrl("updateHtcDeptChargeRela.do", formPara, function(responseData) {
	...
	function loadDict() {
         ...
         liger.get("charge_item_code").setValue('${charge_item_id}');
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
                ...
                <td align="left" class="l-table-edit-td"><input class="Wdate" type="text" name="acc_year" id="acc_year" validate="{required:true}" value='${acc_year}' onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy'})"/></td>
                <td align="left"></td>
            </tr> 
            <tr>
