...
<script type="text/javascript">
							...
							columns : [
									{
										...
										render: function(rowdata, rowindex, value) {
											return "<a href='#' onclick=\"queryDetailItems('"
									        + rowdata.group_id + "|"
									        + rowdata.hos_id + "|"
									        + rowdata.copy_code + "|"
									        + rowdata.acc_year + "|"
										...
										align: 'left',
										render: function(rowdata, rowindex, value) {
											return formatNumber(rowdata.total_cost - rowdata.charge_cost- rowdata.mate_charge_cost - rowdata.out_cost- rowdata.in_cost, 2, 1);
										}
									}],
							dataAction : 'server',
							dataType : 'server',
							usePager : true,
							url : 'queryHtcWorkTest.do',
							width : '100%',
							height : '100%',
							checkbox : true,
							rownumbers : true,
	...
	function check() {
		...
		ajaxJsonObjectByUrl("checkHtcWorkTest.do?isCheck=false", formPara,
	...
	function queryDetailItems(obj) {
		...
		$.ligerDialog.open({
			url : 'htcWorkTestDetailMainPage.do?isCheck=false' + parm,
			data : {},
			height: 500,
			width: 1000,
			title:"成本项目",
