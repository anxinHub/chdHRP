...
<script type="text/javascript">
	...
	function add_open(){
			$.ligerDialog.open({
				url : 'htcTaskDeptIncomeAddPage.do?isCheck=false',
				height : 380,
				width : 500,
				title : '添加',
				modal : true,
	...
	function remove(){
			...
			if (data.length == 0) {
				...
				$.ligerDialog.confirm('确定删除?', function(yes) {
					if (yes) {
						ajaxJsonObjectByUrl("deleteHtcTaskDeptIncome.do", {
	...
	function imp(){
		...
		var para={
			...
			importSpreadView("hrp/htc/relative/cost/deptincome/impHtcTaskDeptIncome.do?isCheck=false",para); 
		}
	function openUpdate(obj) {
		...
		$.ligerDialog.open({
			url : 'htcTaskDeptIncomeUpdatePage.do?isCheck=false&' + parm,
			data : {},
			height : 350,
			width : 500,
			title : '修改',
