    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryHtcTaskPlanSetAudit.do',
    ...
    function audit(){
	        ...
	        if (data.length == 0){
	            ...
	            $.ligerDialog.confirm('确定审核?', function (yes){
	            	if(yes){
	                	ajaxJsonObjectByUrl("auditHtcTaskPlanSet.do",{ParamVo : ParamVo.toString()},function (responseData){
    ...
    function cancelaudit(){
	        ...
	        if (data.length == 0){
	            ...
	            $.ligerDialog.confirm('确定取消审核?', function (yes){
	            	if(yes){
	                	ajaxJsonObjectByUrl("cancelAuditHtcTaskPlanSet.do",{ParamVo : ParamVo.toString()},function (responseData){
	                		if(responseData.state=="true"){
	                			query();
	                		}
	                	});
