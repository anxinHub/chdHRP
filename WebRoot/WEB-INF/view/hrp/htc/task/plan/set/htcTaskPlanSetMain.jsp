...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryHtcTaskPlanSet.do',
    ...
    function add_open(){
	    	$.ligerDialog.open({
	    	    url: 'htcTaskPlanSetAddPage.do?isCheck=false',
	    	    height: 300,
	    	    width: 500,
	    	    title: '添加',
	    	    modal: true,
    ...
    function remove(){
	        ...
	        if (data.length == 0){
	            ...
	            $.ligerDialog.confirm('确定删除?', function (yes){
	            	if(yes){
	                	ajaxJsonObjectByUrl("deleteHtcTaskPlanSet.do",{ParamVo : ParamVo.toString()},function (responseData){
    ...
    function openUpdate(obj){
    	...
    	//实际代码中&temp替换主键
    	$.ligerDialog.open({
    	    url: 'htcTaskPlanSetUpdatePage.do?isCheck=false' + parm,
    	    data: {},
    	    height: 300,
    	    width: 500,
    	    title: '修改',
    ...
    function setDept(obj){
		...
		var parm = "&" + "group_id="  + vo[0] 
				 ...
				 + "&" + "plan_code=" + vo[4]
    	$.ligerDialog.open({
    	    url: 'htcTaskPlanSetDeptPage.do?isCheck=false'+parm,
    	    data: {},
    	    height: 500,
    	    width: 1010,
    	    title: '设置科室',
