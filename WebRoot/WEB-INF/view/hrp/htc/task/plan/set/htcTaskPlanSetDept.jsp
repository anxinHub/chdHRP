...
<script type="text/javascript">
	...
	function listbox_ok(){
		$("#listbox_ok").ligerListBox({
			parms : para,
			url : 'queryHtcTaskPlanDeptByPlanSetOk.do?isCheck=false',
			valueField : 'id',
			textField : 'text',
			isShowCheckBox : true,
			isMultiSelect : true,
	...
	function listbox_no(){
		$("#listbox_no").ligerListBox({
			parms : para,
			url : 'queryHtcTaskPlanDeptByPlanSetNO.do?isCheck=false',
			valueField : 'id',
			textField : 'text',
			isShowCheckBox : true,
			isMultiSelect : true,
	...
	function saveDeptSet() {
		...
		ajaxJsonObjectByUrl("addHtcTaskPlanDept.do?isCheck=false",
