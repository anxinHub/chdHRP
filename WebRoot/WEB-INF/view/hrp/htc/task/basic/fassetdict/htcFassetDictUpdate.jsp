...
<html style="overflow:hidden;">
  <head>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcFassetDict.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit"  style="margin: 0 0 0 30px" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="asset_model" type="text" id="asset_model" ltype="text"  value="${asset_model}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
            ...
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">启用年月：</td>
                 <td align="left" class="l-table-edit-td"><input  class="Wdate" name="start_date" type="text" id="start_date" ltype="text" value="${start_date}"  onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyyMM'})"/></td>
                 <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">停用年月：</td>
                <td align="left" class="l-table-edit-td"><input  class="Wdate" name="end_date" type="text" id="end_date" ltype="text"  value="${end_date}" onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyyMM'})"/></td>
            <td align="left"></td>
            </tr> 
            <tr>
