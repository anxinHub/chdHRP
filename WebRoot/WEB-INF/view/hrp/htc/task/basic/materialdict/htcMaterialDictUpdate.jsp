...
<script type="text/javascript">
	...
	function save() {
		...
		ajaxJsonObjectByUrl("updateHtcMaterialDict.do", formPara, function(
				responseData) {
	...
	function saveMaterialDict() {
	 ...
	 function loadDict(){
    	 ...
    	 autocomplete("#meas_code","../../../info/base/queryHtcHosUnitDict.do?isCheck=false","id","text",true,true);
 		 liger.get("meas_code").setValue('${meas_code}');
		 liger.get("meas_code").setText('${meas_name}');
     	 autocomplete("#fac_code","../../../info/base/queryHtcHosFacDict.do?isCheck=false","id","text",true,true);
 		 liger.get("fac_code").setValue('${fac_no}.${fac_id}');
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="mate_code" type="text" id="mate_code" ltype="text" value ="${mate_code}" validate="{required:true}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left: 20px;">物资名称：</td>
				<td align="left" class="l-table-edit-td"><input name="mate_name" type="text" id="mate_name" ltype="text" value ="${mate_name}" validate="{required:true}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="mate_mode" type="text" id="mate_mode" ltype="text" value ="${mate_mode}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="price" type="text" id="price" ltype="text" value ="${price}" /></td>
				<td align="left"></td>
			</tr>
            <tr>
