  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp" />
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcFassetCostRela.do",formPara,function(responseData){
    ...
    function loadDict(){
    	...
    	//资产分类字典
		//资产分类字典
		autocomplete("#asset_type_code","../../../info/base/queryHtcAssetTypeDict.do?isCheck=false", "id", "text", true,true);
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit"  style="margin: 40px 0px 0px 0px">
            <tr>
