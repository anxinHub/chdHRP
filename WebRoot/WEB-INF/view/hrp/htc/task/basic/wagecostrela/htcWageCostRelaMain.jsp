...
<script type="text/javascript">
		...
		grid = $("#maingrid").ligerGrid(
						{columns : [{
										...
										render : function(rowdata, rowindex,value) {
											...
											+ rowdata.wage_item_code+"');\" >"+ rowdata.people_type_code+ "</a>";
										}
									}, {
										display : '人员类别名称',
	...
	function add_open(){
		$.ligerDialog.open({
			url: 'htcWageCostRelaAddPage.do?isCheck=false',
			height: 300,
			width: 350,
			title: '添加',
			modal: true,
	...
	function remove(){
		...
		if (data.length == 0) {
			...
			$.ligerDialog.confirm('确定删除?', function(yes) {
				if (yes) {
					ajaxJsonObjectByUrl("deleteHtcWageCostRela.do", {
	...
	function openUpdate(obj) {
		...
		var parm = "group_id=" + vo[0] + "&"
		         ...
		         + "wage_item_code="+ vo[5]
		$.ligerDialog.open({
			url : 'htcWageCostRelaUpdatePage.do?isCheck=false&' + parm,
			data : {},
			height : 300,
			width : 350,
			title : '修改',
...
<body style="padding: 0px; overflow: hidden;">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit">
		<tr>
			...
			<td align="left" class="l-table-edit-td"><input
				name="wage_item_code" type="text" id="wage_item_code" ltype="text" /></td>
			<td align="left"></td>	
		</tr>		
		<tr>		
