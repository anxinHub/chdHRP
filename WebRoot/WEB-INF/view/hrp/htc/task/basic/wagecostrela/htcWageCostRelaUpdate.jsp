...
<html style="overflow:hidden;">
  <head>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcWageCostRela.do",formPara,function(responseData){
    ...
    function loadDict(){
		...
		//工资项
		autocomplete("#wage_item_code","../../../info/base/queryHtcWageItemDict.do?isCheck=false", "id", "text", true,true);
		//成本项目
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit"  >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="people_type_code" type="text" id="people_type_code" ltype="text"  value="${people_type_code}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">工作项：</td>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="cost_item_code" type="text" id="cost_item_code" ltype="text"  value="${cost_item_id}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
        </table>
    </form>
