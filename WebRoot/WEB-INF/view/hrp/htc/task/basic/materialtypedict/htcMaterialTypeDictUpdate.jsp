...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcMaterialTypeDict.do",formPara,function(responseData){
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="mate_type_code" type="text" id="mate_type_code" ltype="text" value="${mate_type_code}" validate="{required:true}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left: 20px;">材料分类名称：</td>
				<td align="left" class="l-table-edit-td"><input name="mate_type_name" type="text" id="mate_type_name" ltype="text"  value="${mate_type_name}"  validate="{required:true}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
