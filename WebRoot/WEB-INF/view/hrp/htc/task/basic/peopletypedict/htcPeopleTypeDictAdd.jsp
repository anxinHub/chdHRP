...
<script type="text/javascript">
	...
	function save() {
		...
		ajaxJsonObjectByUrl("addHtcPeopleTypeDict.do", formPara, function(
				responseData) {

			if (responseData.state == "true") {
				 
				$("input[name='peop_type_code']").val('');
				
				$("input[name='peop_type_name']").val('');
				
				$("input[name='peop_type_desc']").val('');
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-left: 30px">
			...
			<tr>
				<td align="right" class="l-table-edit-td"
					style="padding-left: 20px;">类别编码：</td>
			...
			<tr>
				<td align="right" class="l-table-edit-td"
					style="padding-left: 20px;">类别名称：</td>
				<td align="left" class="l-table-edit-td"><input
			...
			<tr>
                ...
                <textarea cols="100" rows="4" class="l-textarea" id="peop_type_desc" name="peop_type_desc" style="width:300px;resize:none" validate="{maxlength:200}"></textarea>
                </td>
			</tr>
		</table>
	</form>
