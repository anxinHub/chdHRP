...
<script type="text/javascript">
	...
	function save() {
		...
		ajaxJsonObjectByUrl("updateHtcWorkType.do", formPara, function(
				responseData) {
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="work_type_code" type="text" id="work_type_code" ltype="text" value="${work_type_code}" validate="{required:true}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left: 20px;">作业分类名称：</td>
				<td align="left" class="l-table-edit-td"><input name="work_type_name" type="text" id="work_type_name" ltype="text" value="${work_type_name}" validate="{required:true}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td" colspan="2"><textarea cols="100" rows="4" class="l-textarea" id="work_type_remark" name="work_type_remark" style="width: 250px;resize:none">${work_type_remark}</textarea></td>
				<td align="left"></td>
			</tr>
		</table>
	</form>
