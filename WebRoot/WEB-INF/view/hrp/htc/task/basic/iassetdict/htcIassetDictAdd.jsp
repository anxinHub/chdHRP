...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addHtcIassetDict.do",formPara,function(responseData){
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit" >
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="start_date" class="Wdate" type="text" id="start_date" ltype="text" onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyyMM'})" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left: 20px;">结束年月：</td>
				<td align="left" class="l-table-edit-td"><input name="end_date" type="text" class="Wdate" id="end_date" ltype="text"  onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyyMM'})" /></td>
				<td align="left"></td>
			</tr>
			<tr>
