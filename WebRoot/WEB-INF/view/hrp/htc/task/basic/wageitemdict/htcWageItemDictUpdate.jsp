...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcWageItemDict.do",formPara,function(responseData){
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-left: 30px">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input
					...
					validate="{required:true,maxlength:100}" value="${wage_item_code }"/></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td"
				...
				<td align="left" class="l-table-edit-td"><input
					name="wage_item_name" type="text" id="wage_item_name" ltype="text"  value="${wage_item_name }"/></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td"
			...
			<tr>
				<td align="right" class="l-table-edit-td"
					style="padding-left: 20px;">显示顺序：</td>
				<td align="left" class="l-table-edit-td">
				<input type="text" id="sort_code" name="sort_code" ltype='text'  value="${sort_code}"  class="l-table-edit-td"/>
				</td>
				<td align="left"></td>
			</tr>
			<tr>
                ...
                <textarea cols="100" rows="4" class="l-textarea" id="remark" name="remark" style="width:300px;resize:none" validate="{maxlength:200}">${remark }</textarea>
                </td> 
				<td align="left"></td>
			</tr>
		</table>
