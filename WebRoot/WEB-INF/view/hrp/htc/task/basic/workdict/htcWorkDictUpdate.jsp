...
<script type="text/javascript">
	...
	function save() {
		...
		ajaxJsonObjectByUrl("updateHtcWorkDict.do", formPara, function(
				responseData) {
	...
	function loadDict() {
		...
		liger.get("work_type_code").setValue('${work_type_code}');
		liger.get("work_type_code").setText('${work_type_name}');
		autocomplete("#is_people","../../../info/base/queryHtcYearOrNo.do?isCheck=false", "id", "text",true, true,"",false,'${is_people}');
		autocomplete("#is_material","../../../info/base/queryHtcYearOrNo.do?isCheck=false", "id", "text",true, true,"",false,'${is_material}');
		autocomplete("#is_asset","../../../info/base/queryHtcYearOrNo.do?isCheck=false", "id", "text",true, true,"",false,'${is_asset}');
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
             <tr>
				...
				<td align="left" class="l-table-edit-td"><input name="work_code" type="text" id="work_code" ltype="text" validate="{required:true}" value="${work_code}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left: 20px;">作业名称：</td>
				<td align="left" class="l-table-edit-td"><input name="work_name" type="text" id="work_name" ltype="text" validate="{required:true}" value="${work_name}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td" colspan="2"><textarea cols="100" rows="4" class="l-textarea" id="work_remark" name="work_remark" style="width: 300px;height: 140px;resize:none" validate="{maxlength:200}" >${work_name}</textarea></td>
				<td align="left"></td>
			</tr>
		</table>
	</form>
