...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcBonusItemDict.do",formPara,function(responseData){
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-left: 30px ">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input
					...
					ltype="text" validate="{required:true,maxlength:100}" value="${bonus_item_code}"/></td>
				<td align="left"></td>
			</tr>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input
					...
					ltype="text" validate="{required:true,maxlength:100}"  value="${bonus_item_name}"/></td>
				<td align="left"></td>
			</tr>
			...
			<tr>
                ...
                <textarea cols="100" rows="4" class="l-textarea" id="remark" name="remark" style="height:130px;width:300px;resize:none" validate="{maxlength:200}">${remark}</textarea>
                </td> 
				<td align="left"></td>
			</tr>
