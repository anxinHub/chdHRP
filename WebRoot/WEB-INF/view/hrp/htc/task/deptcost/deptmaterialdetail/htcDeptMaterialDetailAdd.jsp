...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addHtcDeptMaterialDetail.do",formPara,function(responseData){
            if(responseData.state=="true"){
				 $("input[name='dept_code']").val('');
				 $("input[name='mate_code']").val('');
				 $("input[name='is_charge']").val('');
				 $("input[name='num']").val('');
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td">
					<input name="num" type="text" id="num" ltype="text" validate="{required:true}" />
				</td>
				<td align="left"></td>
			</tr>
			<tr>
				...
				<td align="left" class="l-table-edit-td">
					<input name="amount" type="text" id="amount" ltype="text" validate="{required:true}" />
				</td>
				<td align="left"></td>
			</tr>
		    <tr>
