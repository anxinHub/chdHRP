...
<script type="text/javascript">
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
			...
			dataType : 'server',
			usePager : true,
			url : 'queryHtcDeptFassetCostDetail.do',
			width : '100%',
			height : '100%',
			checkbox : true,
			rownumbers : true,
	...
	function check(){
		$.ligerDialog.open({
			url : 'htcDeptFassetCostDetailCheckPage.do?isCheck=false',
			height : 450,
			width : 790,
			title : '数据核对',
			modal : true,
	...
	function loadDict() {
		...
		autocomplete("#asset_type_code",
				"../../../info/base/queryHtcFassetTypeDict.do?isCheck=false",
				"id", "text", true, true);

		autocomplete("#asset_code",
				"../../../info/base/queryHtcFassetDict.do?isCheck=false", "id",
				"text", true, true);

		autocomplete("#source_code",
				"../../../info/base/queryHtcSourceDict.do?isCheck=false", "id",
				"text", true, true);
...
<body style="padding: 0px; overflow: hidden;">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit">
		...
		<tr>
			...
			<td align="left" class="l-table-edit-td"><input
				name="source_code" type="text" id="source_code" ltype="text" /></td>
			<td align="left"></td>
		</tr>
	</table>
	<div id="maingrid"></div>
