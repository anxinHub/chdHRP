    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
    		columns: [{ display: '方案编码', name: 'plan_code', align: 'left'},
                      ...
                      { display: '数量', name: 'charge_num', align:'left',
							render: function(rowdata, rowindex, value) {
								return  formatNumber(rowdata.charge_num, 2, 1);
							}
					 },
                      { display: '金额', name: 'charge_money', align:'left',
							render: function(rowdata, rowindex, value) {
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryHtcRelativeChargeCostHosReport.do',
