...
<script type="text/javascript">
           ...
           columns: [
                     { display: '方案编码', name: 'plan_code', align: 'left',
                          render : function(rowdata, rowindex, value) {
							...
							+ rowdata.charge_item_id + "');\" >" + rowdata.plan_code
							+ "</a>";
						}},
                     ...
                     { display: '相对价值比率', name: 'value_ratio', align: 'left'}
                     ],
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryHtcRelativeChargeItemValue.do',
    ...
    function add_open(){
    	$.ligerDialog.open({
    	    url: 'htcRelativeChargeItemValueAddPage.do?isCheck=false',
    	    height: 300,
    	    width: 500,
    	    title: '添加',
    	    modal: true,
    	    ...
    	    buttons: [{
    	        ...
    	        onclick: function(item, dialog) {
    	            dialog.frame.saveChargeItemValue();
    	        },
    ...
    function remove(){
        ...
        if (data.length == 0){
            ...
            $.ligerDialog.confirm('确定删除?', function (yes){
            	if(yes){
                	ajaxJsonObjectByUrl("deleteHtcRelativeChargeItemValue.do",{ParamVo : ParamVo.toString()},function (responseData){
    ...
    function openUpdate(obj){
    	...
    	var parm = "group_id=" + vo[0] + "&" +"hos_id=" + vo[1] + "&" + "copy_code=" + vo[2]
		     +"&"+ "acc_year=" + vo[3] + "&" +"plan_code=" + vo[4] +"&"+ "proj_dept_id=" +  vo[5]  
			 + "&" +"charge_item_id=" + vo[6]
    	$.ligerDialog.open({
    	    url: 'htcRelativeChargeItemValueUpdatePage.do?isCheck=false&' + parm,
    	    data: {},
    	    height: 300,
    	    width: 500,
    	    title: '修改',
...
<body style="padding: 0px; overflow: hidden;">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="plan_code" type="text" id="plan_code" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
    </table>
	<div id="maingrid"></div>
