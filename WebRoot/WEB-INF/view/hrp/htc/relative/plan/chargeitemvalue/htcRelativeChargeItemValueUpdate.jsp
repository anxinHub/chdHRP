...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp" />
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcRelativeChargeItemValue.do",formPara,function(responseData){
    ...
    function loadDict(){
        //字典下拉框
	     ...
	     liger.get("charge_item_id").setText("${charge_item_name}");
 		 ...
 		 $("#proj_dept_id").ligerTextBox({ disabled:true});
 		 $("#charge_item_id").ligerTextBox({disabled:true});
      }   
    </script>
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="value_ratio" type="text" id="value_ratio" ltype="text" value = "${value_ratio}" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
        </table>
    </form>
