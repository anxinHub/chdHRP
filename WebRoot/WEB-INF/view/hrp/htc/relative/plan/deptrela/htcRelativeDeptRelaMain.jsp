...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryHtcRelativeDeptRela.do',
    ...
    function add_open(){
	    	$.ligerDialog.open({
	    	    url: 'htcRelativeDeptRelaAddPage.do?isCheck=false',
	    	    height: 300,
	    	    width: 500,
	    	    title: '添加',
	    	    modal: true,
    ...
    function remove(){
         ...
         if (data.length == 0){
             ...
             $.ligerDialog.confirm('确定删除?', function (yes){
             	if(yes){
                 	ajaxJsonObjectByUrl("deleteHtcRelativeDeptRela.do",{ParamVo : ParamVo.toString()},function (responseData){
    ...
    function openUpdate(obj){
		...
		$.ligerDialog.open({
		    url: 'htcRelativeDeptRelaUpdatePage.do?isCheck=false' + parm,
		    height: 300,
		    width: 500,
		    title: '修改',
		    modal: true,
