...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
    		columns: [{ display: '方案编码', name: 'plan_code', align: 'left'},
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryHtcIncomeChargeCostHos.do',
    ...
    function  collect(){
        ...
        ajaxJsonObjectByUrl("addHtcIncomeChargeCostHos.do?isCheck=false",formPara,function(responseData){
