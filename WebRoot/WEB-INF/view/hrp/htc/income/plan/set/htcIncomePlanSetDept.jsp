...
<script type="text/javascript">
	...
	function listbox_ok(){
		$("#listbox_ok").ligerListBox({
			parms : para,
			url : 'queryHtcIncomePlanDeptByPlanSetOk.do?isCheck=false',
			valueField : 'id',
			textField : 'text',
			isShowCheckBox : true,
			isMultiSelect : true,
	...
	function listbox_no(){
		$("#listbox_no").ligerListBox({
			parms : para,
			url : 'queryHtcIncomePlanDeptByPlanSetNO.do?isCheck=false',
			valueField : 'id',
			textField : 'text',
			isShowCheckBox : true,
			isMultiSelect : true,
	...
	function saveDeptSet() {
		...
		ajaxJsonObjectByUrl("addHtcIncomePlanDept.do?isCheck=false",
