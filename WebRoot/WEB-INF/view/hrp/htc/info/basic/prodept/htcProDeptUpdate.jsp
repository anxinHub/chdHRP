...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcProDept.do",formPara,function(responseData){
    ...
    function loadDict(){
		...
		autocomplete("#is_stop", "../../base/queryHtcYearOrNo.do?isCheck=false", "id", "text", true, true,"",false,"${is_stop}");
		autocomplete("#is_last", "../../base/queryHtcYearOrNo.do?isCheck=false", "id", "text", true, true,"",false,"${is_last}");
...
<body>
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin: 20px 0px 0px 50px">
			<tr>
				<td align="right" class="l-table-edit-td"
					style="padding-left: 20px;">核算科室编码：</td>
				<td align="left" class="l-table-edit-td"><input
					name="proj_dept_code" type="text" id="proj_dept_code" ltype="text"
					value="${proj_dept_code}" validate="{required:true,maxlength:20}"
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input
					...
					value="${proj_dept_name}" validate="{required:true,maxlength:20}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td"
