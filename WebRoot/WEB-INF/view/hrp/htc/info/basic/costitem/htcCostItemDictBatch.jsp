...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("updateHtcCostItemBatch.do?isCheck=false",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
            //字典下拉框
    	 autocomplete("#nature_id","../../dict/queryHtcDeptNature.do?isCheck=false","id","text",true,true);
            
		 autocomplete("#cost_type","../../dict/queryHtcDeptTypeDictNo.do?isCheck=false","id","text",true,true);
		 //成本项目来源
		 autocomplete("#busi_data_source","../../dict/queryHtcDataSource.do?isCheck=false","id","text",true,true);
		 //成本项目分摊类型配置
		 autocomplete("#para_type_code","../../dict/queryHtcParaType.do?isCheck=false","id","text",true,true);
     } 
