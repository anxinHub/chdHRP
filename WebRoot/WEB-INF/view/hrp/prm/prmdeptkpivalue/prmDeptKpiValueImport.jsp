...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(2, "250"); sheet.setText(0, 2, "科室");
    	sheet.setColumnWidth(3, "250"); sheet.setText(0, 3, "目标名称或目标编码");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importDeptKpiValue.do?isCheck=false", para, function(responseData){	
