...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAphiDeptKindFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '科室分类编码', name: 'dept_kind_code', align: 'left',editor:{type:'text'}},
				{ display: '科室分类名称', name: 'dept_kind_name', align: 'left',editor:{type:'text'}},
				{ display: '科室分类说明', name: 'dept_kind_note', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchAphiDeptKind.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
