  ...
  <head>
   ...
   <jsp:include page="${path}/inc.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updatePrmDeptKind.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="dept_kind_note" type="text" id="dept_kind_note" ltype="text"  value="${dept_kind_note}"  /></td>
                <td align="left"></td>
            </tr> 
            <tr>
