...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryPrmFun.do?target_code=${target_code}',
    ...
    function loadComType(obj){
    	ajaxJsonObjectByUrl("../prmfunpara/queryComTypePara.do?isCheck=false&fun_code="+obj+"&target_code=${target_code}", {},
