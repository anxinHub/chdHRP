...
<script type="text/javascript">
    ...
    function loadComType(obj){
    	ajaxJsonObjectByUrl("../prmfunpara/queryComTypeParaByHos.do?isCheck=false&fun_code="+obj+"&acc_year=${acc_year}&acc_month=${acc_month}&goal_code=${goal_code}&kpi_code=${kpi_code}&check_hos_id=${check_hos_id}", {},
	...
	function loadComBoBox(fc,fv) {
    	...
    	$("#"+fc).ligerComboBox({
    		parms : {"para_code":fc},
         	url: '../prmfunparamethod/queryPrmFunParaByDict.do?isCheck=false',
         	valueField: 'ID',
          	textField: 'TEXT', 
          	selectBoxWidth: 160,
         	autocomplete: true,
	...
	function loadTree(){  
		...
		ajaxJsonObjectByUrl("../prmfuntype/queryPrmFunTypeTree.do?isCheck=false", {},
	...
	function saveFunStack(obj){
    	...
    	$.each(fun_para_code,function(i,v){
    			if(this.com_type_nature == "text"){
    				...
    				fun_para_value.push({'fun_para_code':key,'fun_para_value':val});
    		    }else if(this.com_type_nature == "input"){
