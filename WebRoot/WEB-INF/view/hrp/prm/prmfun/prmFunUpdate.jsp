...
<html style="overflow:hidden;">
    ...
    var gridManager = null;
     var dataFormat;
     $(function (){
		var ue = UE.getEditor('fun_sql',{        // 放在这里是以免光标获取不到
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("updatePrmFun.do",formPara,function(responseData){
             ...
             columns: [ 
 					...
 					editor: {
  					...
  					{ display: '参数类型', name: 'com_type_code',textField: 'com_type_name', align: 'left',width:110,
                       ...
                       usePager:false,url:'queryPrmFunParaByFunCode.do?isCheck=false&fun_code=${fun_code}',
      ...
      function remove(){
          ...
          if (data.length == 0){
              ...
              $.ligerDialog.confirm('确定删除?', function (yes){
              	if(yes){
                  	ajaxJsonObjectByUrl("deletePrmFunParaByFunCode.do?isCheck=false",{ParamVo : ParamVo.toString()},function (responseData){
                  		if(responseData.state=="true"){
                  			query();
                  			loadTree();
                  		}
