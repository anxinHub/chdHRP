...
<script type="text/javascript">
		...
		function plupload(){  
			$("#uploader").pluploadQueue({    
				...
				url : "readPrmFunParaMethodFiles.do?isCheck=false",    
				chunk_size : '2mb',           
				filters : {                
	...
	function itemclick(item) {
		if (item.id) {
			...
			case "save":
				...
				ajaxJsonObjectByUrl("addBatchPrmFunParaMethod.do?isCheck=false", {ParamVo : JSON.stringify(data)}, function(responseData) {
