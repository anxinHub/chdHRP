...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updatePrmFunParaMethod.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
			...
			<tr>        
	            ...
	            <td align="left" class="l-table-edit-td" colspan="4">
	                	select	
						dept_code as <font color="red">id</font>,
						dept_name as <font color="red">text</font> 
						from	aphi_dept  <br/>
						where
						is_stop=0
			...
			<tr>        
	            <td align="right" class="l-table-edit-td"  style="padding-left:10px;"><font color="red">说明</font>：</td>
	            <td align="left" class="l-table-edit-td" colspan="4">       
	            1)id	text 必写<br/>
	            2)变量放在{}中间	常用变量{comp_code} {copy_code}
	            </td>
	            <td align="left"></td>
			</tr>
        </table>
