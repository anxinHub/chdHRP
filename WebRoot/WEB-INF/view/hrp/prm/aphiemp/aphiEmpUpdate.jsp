...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateAphiEmp.do",formPara,function(responseData){
    ...
    function loadDict(){
        //字典下拉框
    	autocomplete("#dept_code","../queryPrmDeptDict.do?isCheck=false","id","text",true,true,'',false);
    	...
    	liger.get("duty_code").setValue('${duty_code}');
        liger.get("duty_code").setText("${dept_code} ${duty_name}");
     }   
    </script>
