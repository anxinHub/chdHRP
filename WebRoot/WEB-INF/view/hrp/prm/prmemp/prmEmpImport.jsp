...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(3, "250"); sheet.setText(0, 3, "职务名称");
    	sheet.setColumnWidth(4, "250"); sheet.setText(0, 4, "是否停用(0或1 0:否,1:是)");
    	sheet.setColumnWidth(5, "250"); sheet.setText(0, 5, "是否奖金发放(0或1 0:否,1:是)");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importPrmEmp.do?isCheck=false", para, function(responseData){	
