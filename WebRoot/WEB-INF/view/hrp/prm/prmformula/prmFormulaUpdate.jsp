...
<script type="text/javascript">
	...
	var num = 0;
	$(function() {
		 ue = UE.getEditor('formula_method_chs',{        // 放在这里是以免光标获取不到
...
/* 	var ue = UE.getEditor('formula_method_chs',{
		autoHeightEnabled: false,
	    autoFloatEnabled: false,
	    toolbars: [
	...
	function savePrmFormula() {
		...
		var formula_method_chs = UE.getEditor('formula_method_chs').getContentTxt();
		...
		var formPara = {
			...
			ajaxJsonObjectByUrl("updatePrmFormula.do", formPara, function(
					responseData) {
		...
		<div id="layout1"
			...
			<div position="center" title="计算公式（中文）" >
				 <table cellpadding="0" cellspacing="0" class="l-table-edit" style="width:100%; bottom: 143px;">
					<tr>
						<td align="left" class="l-table-edit-td">
							<textarea class="liger-textarea" id="formula_method_chs" disabled name="formula_method_chs" style="width:100%;height:58%;" validate="{required:true}">${formula_method_chs}</textarea>
						 </td>
					<tr />
				</table>
