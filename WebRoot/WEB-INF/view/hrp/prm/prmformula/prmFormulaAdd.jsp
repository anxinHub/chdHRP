...
<script type="text/javascript">
	...
	function save() {
		...
		ajaxJsonObjectByUrl("addPrmFormula.do", formPara,
		...
		<div id="layout1"
			...
			<div position="center" title="计算公式（中文）" >
				 <table cellpadding="0" cellspacing="0" class="l-table-edit" style="width:100%; bottom: 143px;">
					<tr>
						<td align="left" class="l-table-edit-td">
							<textarea class="liger-textarea" id="formula_method_chs" disabled name="formula_method_chs" style="width:100%;height:58%;" validate="{required:true}"></textarea>
						 </td>
					<tr />
				</table>
