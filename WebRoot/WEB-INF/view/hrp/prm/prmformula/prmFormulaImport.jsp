...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
				...
				url : "readPrmFormulaFiles.do?isCheck=false",    
				chunk_size : '2mb',           
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
			columns : [
			{display : '公式编码',name : 'formula_code',align : 'left',editor : {type : 'text'}},
			{display : '公式名称',name : 'formula_name',align : 'left',editor : {type : 'text'}},
			{display : '计算公式(中文）',name : 'formula_method_chs',align : 'left',editor : {type : 'text'}},
			{display : '计算公式(英文)',name : 'formula_method_eng',align : 'left',editor : {type : 'text'}},
	...
	function itemclick(item) {
		if (item.id) {
			...
			case "save":
				...
				ajaxJsonObjectByUrl("addBatchPrmFormula.do?isCheck=false", {
