...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
       ...
       dialogData = dialog.get('data');//获取data参数
        ...
        ajaxJsonObjectByUrl("addPrmHosKpi.do",formPara,function(responseData){
    ...
    function loadDict(){
            //字典下拉框
        autocomplete("#goal_code","../quertPrmGoalDict.do?isCheck=false","id","text",true,true,"",true);
    	autocomplete("#dim_code","../queryPrmKpiDim.do?isCheck=false","id","text",true,true);
        autocomplete("#super_kpi_code","../queryPrmHosKpiSuperKpiCode.do?isCheck=false","id","text",true,true,"",true);
     } 
    </script>
