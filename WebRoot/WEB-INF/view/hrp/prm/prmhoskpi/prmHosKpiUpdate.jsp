...
<html style="overflow:hidden;">
  <head>
	...
	function  save(){
       ...
       dialogData = dialog.get('data');//获取data参数
        ...
        ajaxJsonObjectByUrl("updatePrmHosKpi.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
            //字典下拉框
        autocomplete("#goal_code","../quertPrmGoalDict.do?isCheck=false","id","text",true,true,'',false,'${goal_code}');
    	autocomplete("#dim_code","../queryPrmKpiDim.do?isCheck=false","id","text",true,true,'',false,'${dim_code}');
    	
	    autocomplete("#super_kpi_code","../queryPrmHosKpiSuperKpiCode.do?isCheck=false","id","text",true,true,'',false,'${super_kpi_code}');
    	
    	$('#nature_code').val("${nature_code}");
    	$('#is_last').val("${is_last}");
