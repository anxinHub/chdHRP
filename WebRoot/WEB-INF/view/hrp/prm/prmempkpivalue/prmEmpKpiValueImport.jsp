...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(2, "250"); sheet.setText(0, 2, "职工编码或职工姓名");
    	sheet.setColumnWidth(3, "250"); sheet.setText(0, 3, "目标编码或目标名称");
    	sheet.setColumnWidth(4, "250"); sheet.setText(0, 4, "指标名称或指标编码");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importPrmEmpKpiValue.do?isCheck=false", para, function(responseData){	
