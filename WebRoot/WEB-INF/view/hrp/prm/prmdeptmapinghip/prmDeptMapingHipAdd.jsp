...
<script type="text/javascript">
        ...
        function saveHpmDeptMaping() {
            ...
            ajaxJsonObjectByUrl("addPrmDeptMapingHip.do", {}, function (responseData) {
        ...
        function loadHead() {
            ...
            gridcharge = $('#maingrid1').ligerGrid({
                ...
                dataType: 'server',
                usePager: true,
                url: 'queryPrmDept.do?isCheck=false',
                width: '100%',
                height: '45%',
                enabledEdit: true,
                title: '绩效科室',
            ...
            gridtitle = $("#maingrid2").ligerGrid({
                ...
                dataType: 'server',
                usePager: true,
                url: 'queryPrmDeptHipByMaping.do?isCheck=false',
                width: '100%',
                height: '45%',
                checkbox: true,
                title: '平台科室',
        ...
        function deleteDeptMaping() {
            ...
            if (data.length == 0) {
                ...
                $.ligerDialog.confirm('确定删除?', function (yes) {
                    if (yes) {
                        ajaxJsonObjectByUrl("deletePrmDeptMappingHip.do", {
        ...
        function addDeptMaping() {
            ...
            ajaxJsonObjectByUrl("addPrmDeptMapingHip.do", {
        ...
        function loadDict() {
          ...
          //  autocomplete("#sys_dept_id", "../queryPrmDeptHip.do?isCheck=false", "id", "text", true, true);
            autocomplete("#sys_dept_id","../../sys/queryDeptDict.do?isCheck=false","id","text",true,true);
        ...
        <div position="center" >
            <div class="top" style="margin:0 auto;overflow:hidden;">
                <div style=" padding: 0; float: left;width:40%">
                   ...
                   <div style='display:inline-block'>
                        <input type="checkbox" id="is_dept" checked="checked" />
                   </div>
                ...
                <div style=" padding: 0; float: left;width:40%">
                    ...
                    <input type="checkbox" id="is_sys_dept" checked="checked" /></td>
                    <span>不包含对应关系科室</span>
