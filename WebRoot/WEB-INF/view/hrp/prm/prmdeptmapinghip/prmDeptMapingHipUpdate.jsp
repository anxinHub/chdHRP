...
<script type="text/javascript">
	...
	var gridTatalManager = null;
     ...
     function deleteDeptMaping(){
	     ...
	     if (data.length == 0){
             ...
             $.ligerDialog.confirm('确定删除?', function (yes){
             	if(yes){
                 	ajaxJsonObjectByUrl("deletePrmDeptMappingHip.do",{ParamVo : ParamVo.toString()},function (responseData){
                 		if(responseData.state=="true"){
                 			query();
                 		}
                 	});
     ...
     function addDeptMaping(){
    	 ...
    	 ajaxJsonObjectByUrl("addPrmDeptMapingHip.do",{maping_data : JSON.stringify(totalData)},function (responseData){
     		if(responseData.state=="true"){
     			query();
     		}
     	});
