...
<script type="text/javascript">
	...
	function saveDeptMethod() {
		...
		ajaxJsonObjectByUrl("saveMethodFormulaFunDeptScheme.do", formPara, function(
				responseData) {
	...
	function openFun() {
		var para = "&fun_code="+$("#fun_code").val()+"&acc_year=${acc_year}&acc_month=${acc_month}&goal_code=${goal_code}&kpi_code=${kpi_code}&dept_id=${dept_id}";
		parent.$.ligerDialog.open({
			url : 'hrp/prm/prmfun/prmDeptFunPage.do?isCheck=false'+para,
			height : 630,
			width : 1200,
			data : {
			},
