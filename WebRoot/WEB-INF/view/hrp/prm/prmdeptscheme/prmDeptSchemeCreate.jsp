...
var dataFormat;
     ...
     function  save(){
    	...
    	// alert(JSON.stringify(dialogData))
    	 ...
    	 var 	dept_no = dialogData.dept_no;
    	 
    	 var 	dept_id = dialogData.dept_id;
        ...
        var formPara={
        	 	...
        	 	acc_year : dialogData.acc_year,
           	  	...
           	  	dept_no : dialogData.dept_no,
           	 
           	 	dept_id : dialogData.dept_id,
           	  	
	        	rbtnl:$('#wrap input[name="rbtnl"]:checked').val()
	        
         };	
        ajaxJsonObjectByUrl("createPrmDeptScheme.do",formPara,function(responseData){
