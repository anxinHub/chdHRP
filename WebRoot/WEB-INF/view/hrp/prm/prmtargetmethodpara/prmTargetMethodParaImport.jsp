...
<script type="text/javascript">
		...
		function loadHead() {
				...
				{ display: '取值方法名称', name: 'method_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchPrmTargetMethodPara.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
