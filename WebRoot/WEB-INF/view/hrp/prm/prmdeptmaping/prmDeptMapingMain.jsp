...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
            ...
            dataAction: 'server',dataType: 'server',usePager:true,url:'queryPrmDeptMaping.do',
    ...
    function addDeptMaping(){
    	...
    	parent.$.ligerDialog.open({
    		url: 'hrp/prm/prmdeptmaping/prmDeptMapingAddPage.do?isCheck=false', height: $(window).height(),
			width: $(window).width(), title:'添加',modal: true, showToggle: false, 
    ...
    function deleteDeptMaping (){
        ...
        $.ligerDialog.confirm('确定删除?', function (yes){
        	if(yes){
            	ajaxJsonObjectByUrl("deletePrmDeptMapping.do",{ParamVo : ParamVo},function (responseData){
    ...
    function importDeptMaping (){
    	$.ligerDialog.open({
    		url: 'prmDeptMapingImportPage.do?isCheck=false', height: 500,width: 800, 
	...
	function print(){
    	...
    	var printPara={
   		...
   		ajaxJsonObjectByUrl("queryPrmDeptMaping.do?isCheck=false", selPara, function (responseData) {
    ...
    function openUpdate(obj){
		...
		var parm = "group_id="+
			...
			vo[3]   +"&sys_dept_id="+ 
			vo[4];
		parent.$.ligerDialog.open({url: 'hrp/prm/prmdeptmaping/prmDeptMapingUpdatePage.do?isCheck=false&'+parm, height: $(window).height(),
