    ...
    function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '指标值', columns:[
								{ display: '起始', name: 'kpi_beg_value', align: 'left',
			                    	 render: function (rowdata) {
								...
								{ display: '终止', name: 'kpi_end_value', align: 'left',
				                    	 render: function (rowdata) {
                     ...
                     usePager:false,enabledEdit : false,url:'queryPrmDeptSectionScoreByEditerGrid.do?group_id=${group_id}&hos_id=${hos_id}&copy_code=${copy_code}&acc_year=${acc_year}&acc_month=${acc_month}&goal_code=${goal_code}&kpi_code=${kpi_code}&dept_id=${dept_id}&dept_no=${dept_no}',
