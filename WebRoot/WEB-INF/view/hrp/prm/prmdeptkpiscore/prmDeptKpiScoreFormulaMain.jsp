    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
		             ...
		             { display: '取值方法', name: 'method_code', align: 'left',
					  ...
					  { display: '指标值', name: 'target_value', align: 'right',width:80,
		                  		render : function(rowdata, rowindex,
										value) {
		                  			return "<a href=javascript:openKpiValue()>"+rowdata.target_value+"</a>";
		   							
		                    	}
							 }	 	
                     ],
                     usePager:false,url:'queryPrmDeptScoreFormula.do?group_id=${group_id}&hos_id=${hos_id}&copy_code=${copy_code}&acc_year=${acc_year}&acc_month=${acc_month}&formula_code=${formula_code}&kpi_code=${kpi_code}&dept_id=${dept_id}&dept_no=${dept_no}',
...
<body style="padding: 0px; overflow: hidden;" >
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
	 	  <tr>
            ...
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:5px;">科室名称：</td>
