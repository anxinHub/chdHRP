...
<script type="text/javascript">
	...
	function save() {
		...
		ajaxJsonObjectByUrl("addPrmTargetMethod.do", formPara, function(
				responseData) {
	...
	function openFun() {
		...
		parent.$.ligerDialog.open({
			url : 'hrp/prm/prmfun/prmFunPage.do?isCheck=false&fun_code='+$("#fun_code").val()+"&target_code="+liger.get("target_code").getValue(),
			height : 630,
			width : 1200,
			data : {
			},
