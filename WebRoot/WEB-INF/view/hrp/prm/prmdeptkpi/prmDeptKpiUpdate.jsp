  ...
  <head>
	...
	function  save(){
       ...
       dialogData = dialog.get('data');//获取data参数
        ...
        ajaxJsonObjectByUrl("updatePrmDeptKpi.do",formPara,function(responseData){
    ...
    function loadDict(){
	    ...
	    autocomplete("#super_kpi_code","../queryPrmDeptKpiSuperKpiCode.do?isCheck=false","id","text",true,true,'',false,'${super_kpi_code}');//上级编码
