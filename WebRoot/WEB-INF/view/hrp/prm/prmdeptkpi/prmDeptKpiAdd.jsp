...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
       ...
       dialogData = dialog.get('data');//获取data参数
        ...
        ajaxJsonObjectByUrl("addPrmDeptKpi.do",formPara,function(responseData){
    ...
    function loadDict(){
        ...
        autocomplete("#super_kpi_code","../queryPrmDeptKpiSuperKpiCode.do?isCheck=false","id","text",true,true,"",true);//上级指标
     } 
    </script>
