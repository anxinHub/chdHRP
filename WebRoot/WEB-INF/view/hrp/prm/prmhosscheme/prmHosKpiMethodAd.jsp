...
<script type="text/javascript">
	...
	function saveHosMethod() {
		...
		ajaxJsonObjectByUrl("saveMethodFormulaFunHosScheme.do", formPara, function(
				responseData) {
	...
	function openFun() {
		var para = "&fun_code="+$("#fun_code").val()+"&acc_year=${acc_year}&acc_month=${acc_month}&goal_code=${goal_code}&kpi_code=${kpi_code}&check_hos_id=${check_hos_id}";
		parent.$.ligerDialog.open({
			url : 'hrp/prm/prmfun/prmHosFunPage.do?isCheck=false'+para,
			height : 630,
			width : 1200,
			data : {
			},
