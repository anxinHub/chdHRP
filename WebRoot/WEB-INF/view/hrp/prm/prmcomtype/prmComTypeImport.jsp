...
<script type="text/javascript">
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '部件代码', name: 'com_type_code', align: 'left',editor:{type:'text'}},
				{ display: '部件名称', name: 'com_type_name', align: 'left',editor:{type:'text'}},
				{ display: 'input:下拉框 text:文本框 date:日期框', name: 'com_type_nature', align: 'left',editor:{type:'text'}},
				{ display: '部件说明', name: 'com_type_note', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchPrmComType.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
