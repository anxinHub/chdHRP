...
var dataFormat;
     ...
     function  save(){
    	...
    	// alert(JSON.stringify(dialogData))
    	 ...
    	 var 	emp_no = dialogData.emp_no;
    	 
    	 var 	emp_id = dialogData.emp_id;
        ...
        var formPara={
        	 	...
        	 	acc_year : dialogData.acc_year,
           	  	...
           	  	emp_no : dialogData.emp_no,
           	 
           	 emp_id : dialogData.emp_id,
           	  	
	        	rbtnl:$('#wrap input[name="rbtnl"]:checked').val()
	        
         };	
        ajaxJsonObjectByUrl("createPrmEmpScheme.do",formPara,function(responseData){
