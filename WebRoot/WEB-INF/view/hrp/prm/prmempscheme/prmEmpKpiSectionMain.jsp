...
<script type="text/javascript">
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
			 ...
			 { display: '指标得分', columns:[
                     ...
                     usePager:false,enabledEdit : true,url:'queryPrmEmpSectionByEditerGrid.do?group_id=${group_id}&hos_id=${hos_id}&copy_code=${copy_code}&acc_year=${acc_year}&acc_month=${acc_month}&goal_code=${goal_code}&kpi_code=${kpi_code}&emp_id=${emp_id}&emp_no=${emp_no}',
  ...
  //键盘事件
	...
	function saveSchemeSection(){
		...
		ajaxJsonObjectByUrl("saveEmpSchemeSection.do", formPara, function(responseData) {
	...
	function DeleteGridRow(){
	     ...
	     if (data.length == 0){
             ...
             $.ligerDialog.confirm('确定删除?', function (yes){
             	if(yes){
                 	ajaxJsonObjectByUrl("deletePrmEmpKpiSection.do",{ParamVo : ParamVo.toString()},function (responseData){
                 		if(responseData.state=="true"){
                 			query();
                 		}
                 	});
