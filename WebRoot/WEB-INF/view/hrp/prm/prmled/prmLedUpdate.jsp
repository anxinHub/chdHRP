  ...
  <head>
   ...
   <jsp:include page="${path}/inc.jsp"/>
    ...
    $(function (){
        loadDict();
        loadForm();
        $("#sec_code").ligerTextBox({width:200,disabled: true});
    ...
    function save(){
        ...
        $.ajaxFileUpload({  
            url : 'updatePrmLed.do?sec_code='+sec_code+'&sec_name='+sec_name+'&kpi_beg_score='+kpi_beg_score+'&kpi_end_score='+kpi_end_score+"&old_led_path=${led_path}", //用于文件上传的服务器端请求地址  
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="sec_code" type="text" id="sec_code" ltype="text" value="${sec_code}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">等级名称：</td>
                <td align="left" class="l-table-edit-td"><input name="sec_name" type="text" id="sec_name" ltype="text"  value="${sec_name}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">KPI起始分：</td>
                <td align="left" class="l-table-edit-td"><input name="kpi_beg_score" type="text" id="kpi_beg_score" ltype="text"  value="${kpi_beg_score}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">KPI结束分：</td>
                <td align="left" class="l-table-edit-td"><input name="kpi_end_score" type="text" id="kpi_end_score" ltype="text"  value="${kpi_end_score}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">指示灯路径：</td>
                <td align="left" class="l-table-edit-td"><input name="led_path" type="file" id="led_path" /></td>
