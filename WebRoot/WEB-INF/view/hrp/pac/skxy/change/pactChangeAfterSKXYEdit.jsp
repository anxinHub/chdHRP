...
var etTab,subGrid,docGrid,dept_no,emp_id,cus_no,pact_type_code,subject_type;
var deptSoues = [];   
var projSoues = [];   
var empSoues = [];    
var typeSoues = [];    
...
var save = function() {
	...
	ajaxPostData({
		url : 'updatePactSKXYC.do?isCheck=false',
		data : {
	 ...
	 var initSelect=  function(){
	    	...
	    	ajaxPostData({
	      	...
	      	ajaxPostData({
	   		 	url: '../../basicset/select/queryPactSKXYSelect.do?isCheck=false&is_init=${entity.is_init}',
				success: function (result) {
					var master = "none";
				  ...
				  master_pact_code = $("#master_pact_code").etSelect({
	                 	...
	                 	onChange:function(value){
	                 		if(!value){return;}
	                 		ajaxPostData({
	                		 	url: 'queryPactMainSKXYForMaster.do?isCheck=false&is_init=${entity.is_init}',
	                		 	data:{
	                		 		pact_code:value
	                		 	},
	                			success: function (result) {
	 ...
	 var initSubGrid = function () {
         ...
         var paramObj = {
             ...
             usePager: false,
             dataModel: {
	             url: 'queryPactDetSKXYC.do?isCheck=false&pact_code='+$("#pact_code").val()+'&change_code='+$("#change_code").val()
             },
             columns: columns,
             editorEnd : editorEnd,
             load : function(){
     ...
     function removeSub(){
         ...
         if (data.length == 0) {
             ...
             $.etDialog.confirm('确定删除?', function () {
                 ajaxPostData({
                     url: 'deletePactDetSKXYC.do?isCheck=false',
