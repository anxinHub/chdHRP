    ...
    <script>
        ...
        var initGrid = function () {
            ...
            var paramObj = {
            	...
            	checkbox: true,
                dataModel: {
                    url: 'queryPactExecSKXY.do?isCheck=false'
                },
        ...
        function toResource(rowData){
                ...
                url: 'hrp/pac/skxy/pactinfo/pactexec/toPactExecSKXYFilePage.do?isCheck=false&pact_code='+rowData.pact_code,
                width: $(window).width(),
        ...
        var unuse = function(data){
             ...
             if (data.length == 0) {
                 ...
                 if(param.length == 0){
                   ...
                   ajaxPostData({
                	   url: '../pactinit/checkPactMainSKXY.do',
                       data: {
        ...
        var edit = function (data) {
        	parent.$.etDialog.open({
                 url: 'hrp/pac/skxy/pactinfo/pactexec/pactExecSKXYEdit.do?isCheck=false&pact_code='+data.pact_code,
                 width: $(window).width(),
                 height: $(window).height(),
                 title: '查看',
                 modal: true,
