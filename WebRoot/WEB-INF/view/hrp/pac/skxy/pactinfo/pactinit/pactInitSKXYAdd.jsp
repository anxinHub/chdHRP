...
var etTab,subGrid,docGrid,palnGrid,dept_no,emp_id,cus_no,pact_type_code,subject_type;
var deptSoues = [];   
var projSoues = [];   
var empSoues = [];    
var typeSoues = [];    
...
var is_bid ;
    ...
    var initSelect=  function(){
    	...
    	ajaxPostData({
      	...
      	ajaxPostData({
   		 	url: '../../../basicset/select/queryPactSKXYSelect.do?isCheck=false&is_init=${is_init}',
			success: function (result) {
	 ...
	 var initSubGrid = function () {
         ...
         var paramObj = {
             ...
             usePager: false,
             dataModel: {
	            // url: 'queryPactDetSKXY.do?isCheck=false&pact_code='+$("#pact_code").val()
             },
             columns: columns,editorEnd:editorEnd,
             toolbar: {
                 items: [
