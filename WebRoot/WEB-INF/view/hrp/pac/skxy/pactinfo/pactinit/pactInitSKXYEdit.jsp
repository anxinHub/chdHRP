...
var etTab,subGrid,docGrid,palnGrid,dept_no,emp_id,cus_no,pact_type_code,change_reason,subject_type,change_reason;
var deptSoues = [];   
var projSoues = [];   
var empSoues = [];    
var typeSoues = [];    
    ...
    var initSelect=  function(){
			...
			success: function (result) {
			  ...
			  master_pact_code = $("#master_pact_code").etSelect({
                 	...
                 	onChange:function(value){
                 		if(!value){return;}
                 		ajaxPostData({
                		 	url: 'queryPactSKXYForMaster.do?isCheck=false',
                		 	data:{
                		 		pact_code:value,
                		 		is_init : ${entity.is_init}
                		 	},
	 ...
	 var initSubGrid = function () {
         ...
         var paramObj = {
             ...
             usePager: false,
             dataModel: {
	             url: 'queryPactDetSKXY.do?isCheck=false&pact_code=${entity.pact_code}'
             },
             columns: columns,
             editorEnd:editorEnd,
             load : function(){
     ...
     function removeSub(){
         ...
         if (data.length == 0) {
             ...
             $.etDialog.confirm('确定删除?', function () {
                 ajaxPostData({
                     url: 'deletePactDetSKXY.do?isCheck=false',
