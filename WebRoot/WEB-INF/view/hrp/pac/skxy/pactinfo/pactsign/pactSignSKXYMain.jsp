...
<script>
        ...
        var initGrid = function () {
            ...
            var paramObj = {
            	...
            	checkbox: true,
                dataModel: {
                   url: '../pactinit/queryPactSKXY.do?isCheck=false&is_init=0'
                },
		...
		var check = function(data){
			...
			if (data.length == 0) {
				...
				ajaxPostData({
					url: '../pactinit/checkPactMainSKXY.do?isCheck=false',
					data: {
        ...
        var save = function (data) {
        	 parent.$.etDialog.open({
                 url: 'hrp/pac/skxy/pactinfo/pactinit/pactInitSKXYAddPage.do?isCheck=false&is_init=0',
                 //width: $(window).width(),
        ...
        var remove = function () {
             ...
             if (data.length == 0) {
                 ...
                 $.etDialog.confirm('确定删除?', function () {
                     ajaxPostData({
                         url: '../pactinit/deletePactSKXY.do?isCheck=false',
                         data: {
                        	 mapVo: JSON.stringify(param)
                         },
                         success: function () {
