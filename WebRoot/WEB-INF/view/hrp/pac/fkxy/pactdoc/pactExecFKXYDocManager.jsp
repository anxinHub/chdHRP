...
var stateSoues = [];    
    ...
    var initSelect=  function(){
		pact_type_code = $("#pact_type_code").etSelect({url: '../../../basicset/select/queryPactTypeFKXYSelect.do?isCheck=false'});
      	ajaxPostData({
	 ...
	 var initPactDocGrid = function () {
         ...
         var paramObj = {
         	...
         	usePager: false,
            dataModel: {
	         	url: '../../pactdoc/queryPactDocFKXY.do?isCheck=false&pact_code='+$("#pact_code").val(),
             },
             columns: docColumns,
             toolbar: {
                 items: [
	...
	function saveDoc(){
		...
		ajaxPostData({
		 	url: '../../pactdoc/addPactDocFKXY.do?isCheck=false',
		 	 data: {
