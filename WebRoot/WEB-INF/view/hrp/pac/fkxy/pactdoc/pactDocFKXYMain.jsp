...
var pact_code;
	 ...
	 var query = function (id) {
         ...
         docGrid.loadData(params,'queryPactDocFKXY.do?isCheck=false');
     };
       	...
       	pact_type_code = $("#pact_type_code").etSelect({
   			...
   			defaultValue: pact,
   			 onChange:function(value, $item){
   				...
   				pact_code.reload({
   					 url: '../../basicset/select/queryPactFKXYSelect.do?isCheck=false&pact_type_code=' + pact_type_code.getValue(),
   	    		})
   			 }, 
   		 });
	...
	function saveDoc(){
		...
		ajaxPostData({
		 	url: 'addPactDocFKXY.do?isCheck=false',
		 	 data: {
