...
<head>
    ...
    <script>
        ...
        var initSelect=  function(){
           $("#pact_type_code").etSelect({url: '../../../basicset/select/queryPactTypeFKXYSelect.do?isCheck=false&FKXY_Attr='+"01",defaultValue: "none"});
        ...
        var initGrid = function () {
            ...
            var paramObj = {
            	...
            	checkbox: true,
                dataModel: {
                   url: 'queryPactFKXY.do?isCheck=false&is_init='+1+'&FKXY_Attr='+"01"
                },
        ...
        var save = function (data) {
        	 parent.$.etDialog.open({
                 url: 'hrp/pac/fkxy/pactinfo/pactinit/pactInitFKXYAddPage.do?isCheck=false&is_init=1',
                 //width: $(window).width(),
        ...
        //跳转修改页面
        var edit = function (pact_code,state) {
     		parent.$.etDialog.open({
                 url: 'hrp/pac/fkxy/pactinfo/pactinit/pactFKXYEditPage.do?isCheck=false&is_init=1&pact_code='+pact_code,
                 //width: $(window).width(),
                 //height: $(window).height(),
                 isMax:true,
                 title: '修改',
        ...
        var remove = function () {
             ...
             if (data.length == 0) {
                 ...
                 $(data).each(function () {
                	 ...
                	 if(rowdata.state != 1){
                		 msg +="第["+rowIndx+"]行状态["+rowdata.state_name+"] 不能删除！"
                	 }
