    ...
    <script>
        ...
        var initGrid = function () {
            ...
            var paramObj = {
            	...
            	checkbox: true,
                dataModel: {
                    url: 'queryPactChangeAftFKXYMain.do?isCheck=false'
                },
                columns: columns,
                toolbar: {
                    items: [
        ...
        var check = function(data){
            ...
            if (data.length == 0) {
                ...
                ajaxPostData({
                     url: 'checkPactMainFKXYC.do?isCheck=false',
                     data: {
      ...
      var save = function (data) {
       	 parent.$.etDialog.open({
                url: 'hrp/pac/fkxy/changeafter/pactChangeAftFKXYAddPage.do?isCheck=false',
                width: $(window).width(),
       ...
       var remove = function () {
            ...
            if (data.length == 0) {
                ...
                $.etDialog.confirm('确定删除?', function () {
                    ajaxPostData({
                        url: 'deletePactFKXYC.do?isCheck=false',
                        data: {
                       	 mapVo: JSON.stringify(param)
                        },
                        success: function () {
        ...
        function toChangeAftEdit(rowData){
        	parent.$.etDialog.open({
                url: 'hrp/pac/fkxy/changeafter/pactChangeAfterFKXYEdit.do?isCheck=false&change_code='+rowData.change_code+'&pact_code='+rowData.pact_code+'&state='+rowData.state,
                width: $(window).width(),
                height: $(window).height(),
                title: '查看',
                modal: true,
