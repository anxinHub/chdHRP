...
var is_price_cont;
    ...
    var initSelect=  function(){
		...
		pact_type_code = $("#pact_type_code").etSelect({url: '../../basicset/select/queryPactTypeFKXYSelect.do?isCheck=false' ,defaultValue: def});
	 ...
	 var initSubGrid = function () {
         ...
         var paramObj = {
             ...
             usePager: false,
             dataModel: {
	             url: '../pactinfo/pactinit/queryPactDetFKXY.do?isCheck=false&change_code=${change_code}&pact_code='+$("#pact_code").val(),
             },
             columns: columns,
         };
