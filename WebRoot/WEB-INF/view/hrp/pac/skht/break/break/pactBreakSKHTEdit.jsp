...
var cus_no;
	var save = function() {
		...
		ajaxPostData({
			url : 'updatePactBreakSKHT.do?isCheck=false',
			data : {
	...
	<div>
		<table class="table-layout">
			...
			<tr>
				...
				<td class="ipt" colspan="5"><textarea id="break_process" style="height: 110px;width: 840px;margin-top: 15px">${entity.break_reason }</textarea></td>
			</tr>
			<tr>
