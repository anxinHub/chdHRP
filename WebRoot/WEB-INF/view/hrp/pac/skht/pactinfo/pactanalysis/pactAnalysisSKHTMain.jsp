    ...
    <script>
        ...
        var initGrid = function () {
            ...
            var paramObj = {
            	...
            	checkbox: true,
            	 dataModel: {
                 	url: '../pactinit/queryPactMainSKHT.do?isCheck=false'
                 },
                columns: columns,
                toolbar: {
                    items: [
        ...
        var edit = function (data) {
        	parent.$.etDialog.open({
                 url: 'hrp/pac/skht/pactinfo/pactAnalysis/pactAnalysisSKHTDetailPage.do?isCheck=false&pact_code='+data.pact_code,
                 width: $(window).width(),
                 height: $(window).height(),
                 title: '查看',
                 modal: true,
