    ...
    var initSelect=  function(){
	 ...
	 var initSubGrid = function () {
         ...
         var paramObj = {
             ...
             usePager: false,
             dataModel: {
	             url: '../pactinit/queryPactDetSKHT.do?isCheck=false&pact_code='+$("#pact_code").val()
             },
             columns: columns
         };
	 ...
	 var initPactPlanGrid = function () {
         var columns = [
             ...
             { display: '摘要', name: 'summary', width: '250px',
              ...
              { display: '收款条件', name: 'rec_cond', width: '150px',editor: {type: 'select',keyField: 'rec_cond',source:paycondSoues}},
         ...
         var paramObj = {
         	...
         	usePager: false,
            dataModel: {
             url: '../pactinit/queryPactPlanSKHT.do?isCheck=false&pact_code='+$("#pact_code").val()
            },
           	columns: columns
         };
