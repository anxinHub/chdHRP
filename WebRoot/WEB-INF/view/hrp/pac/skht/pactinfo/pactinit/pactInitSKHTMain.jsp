    ...
    <script>
        ...
        var initGrid = function () {
            ...
            var paramObj = {
            	...
            	checkbox: true,
                dataModel: {
                    url: 'queryPactMainSKHT.do?isCheck=false&is_init=1'
                },
        ...
        var check = function(data){
             ...
             if (data.length == 0) {
                 ...
                 if(param.length == 0){
                   ...
                   ajaxPostData({
                       url: 'checkPactMainSKHT.do?isCheck=false',
                       data: {
        ...
        var save = function (data) {
        	 parent.$.etDialog.open({
                 url: 'hrp/pac/skht/pactinfo/pactinit/pactInitSKHTAdd.do?isCheck=false&is_init=1',
                 //width: $(window).width(),
        ...
        var remove = function () {
             ...
             if (data.length == 0) {
                 ...
                 $.etDialog.confirm('确定删除?', function () {
                     ajaxPostData({
                         url: 'deletePactMainSKHT.do?isCheck=false',
                         data: {
                        	 mapVo: JSON.stringify(param)
                         },
                         success: function () {
