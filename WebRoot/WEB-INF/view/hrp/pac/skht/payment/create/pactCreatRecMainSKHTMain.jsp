    ...
    <script>
        ...
        var initGrid = function () {
            ...
            var paramObj = {
            	...
            	checkbox: true,
                dataModel: {
                	   url: 'queryCreatPactRecMainSKHT.do?isCheck=false'
                },
                ...
                toolbar: {
                    items: [
                        ...
                        { type: 'button', label: '打印',  listeners: [{ click: print }],  icon: 'back' }
       ...
       var print = function(){
           	...
           	var printPara={
                  	...
                  	columns: JSON.stringify(grid.getPrintColumns()),//表头
               		class_name:"com.chd.hrp.pac.service.skht.payment.PactCreateRecMentSKHTService",
   					method_name:"queryCreatPactRecMainSKHTPrint",
   					bean_name:"pactCreateRecMentSKHTService",
        ...
        var check = function(data){
             ...
             if (data.length == 0) {
                ...
                ajaxPostData({
             	   	url: '../payment/checkPactRecMainSKHTState.do?isCheck=false',
        ...
        var del = function(data){
            ...
            if (data.length == 0) {
                ...
                $.etDialog.confirm('确定删除?', function () {
                    ajaxPostData({
                 	   url: '../payment/deletePactRecMainSKHT.do?isCheck=false',
        ...
        var edit = function (data) {
        	if(data.rec_code == null){
        		return;
        	}
        	parent.$.etDialog.open({
        		 url: 'hrp/pac/skht/payment/payment/pactRecMainSKHTEditPage.do?isCheck=false&is_init=1&rec_code='+data.rec_code + '&pact_code='+data.pact_code + '&state=' + data.state,
        		 width: $(window).width(),
        ...
        var crate = function(){
            ...
            if (data.length == 0) {
               ...
               if(param.length == 0){$.etDialog.error('此收款计划不可生成收款单'); return;}
               ajaxPostData({
            	   	url: 'addCreatPactRecMainSKHT.do?isCheck=false',
                   data: {mapVo: JSON.stringify(param)},
                   success:function(){query();}
               })
            }
