    ...
    <script>
        ...
        var initGrid = function () {
            ...
            var paramObj = {
            	...
            	checkbox: true,
                dataModel: {
                	   url: 'queryPactRecMainSKHT.do?isCheck=false&is_init=1'
                },
        ...
        var printModel = function(){
 			useId='${user_id }';
 			officeFormTemplate({template_code:"11007",user_id:useId});
        };
        ...
        var add = function (data) {
        	parent.$.etDialog.open({
                 url: 'hrp/pac/skht/payment/payment/pactRecMainSKHTAddPage.do?isCheck=false&is_init=1',
                 width: $(window).width(),
                 height: $(window).height(),
                 title: '添加',
                 modal: true,
...
<body>
    <table class="table-layout">
        ...
        <tr>
            ...
            <td class="ipt"><select id="emp_id" type="text" style="width: 180px"/> </td>
