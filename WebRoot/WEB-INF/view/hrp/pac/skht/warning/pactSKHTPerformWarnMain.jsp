            ...
            dept_no = $("#dept_no").etSelect({ 
            	...
            	defaultValue: "none",
          		onItemAdd:function(value, $item){
          			emp_id.reload({url: '../../basicset/select/queryHosEmpDictSelect.do?isCheck=false&dept_no='+value})
        		}
            });
        ...
        var initGrid = function () {
            var columns = [
                 ...
                 { display: '到期提醒(天)', name: 'warning_day',  align: 'center', width: '100px',
                	render :function(date){
                		return parseInt(date.rowData.warning_day);
                	}	 
                 },
            ];
            var paramObj = {
            	...
            	checkbox: true,
                 dataModel: {
                    url: 'queryPactSKHTPerformWarn.do?isCheck=false'
                }, 
        ...
        var print = function(){
           	...
           	var printPara={
                  	...
                  	columns: JSON.stringify(grid.getPrintColumns()),//表头
   					...
   					method_name:"queryPactMainSKHTForWarningPrint",
