...
<head>
    ...
    <script>
        ...
        var initSelect=  function(){
          	pact_type_code = $("#pact_type_code").etSelect({url: '../../basicset/select/queryPactTypeSKHTSelect.do?isCheck=false',async:false,defaultValue: "none"});
            cus_no = $("#cus_no").etSelect({ url: '../../basicset/select/queryHosCusDictSelect.do?isCheck=false',async:false,defaultValue: "none"});
            ...
            warn_state = $("#warn_state").etSelect({options: [{ id: 0, text: '近期' }, { id: 1, text: '到期' },{ id: 2, text: '过期' }],defaultValue: "none"});
          }
        ...
        var initGrid = function () {
            var columns = [
                 ...
                 { display: '付款期号', name: 'rec_id', align: 'center', width: '90px'},
                 /* { display: '资金来源', name: 'source_name', width: '90px'}, */ //2020-04-03 cxd 收款合同收款计划表删除了资金开源字段
            ...
            var paramObj = {
            	...
            	checkbox: true,
                 dataModel: {
                    url: 'queryPactMainSKHTForPayWarning.do?isCheck=false'
                }, 
        ...
        var print = function(){
           	...
           	var printPara={
                  	...
                  	columns: JSON.stringify(grid.getPrintColumns()),//表头
               		class_name:"com.chd.hrp.pac.service.skht.pactinfo.PactMainSKHTService",
   					method_name:"queryPactMainSKHTForPayWarningPrint",
   					bean_name:"pactMainSKHTService",
