    ...
    <script>
        ...
        var initGrid = function () {
            ...
            var paramObj = {
            	...
            	checkbox: true,
                dataModel: {
                	  url: '../init/queryPactDepRecSKHT.do?isCheck=false&is_init=0'
                },
        ...
        var printModel = function(){
 			useId='${user_id }';
 			officeFormTemplate({template_code:"11004",use_id:useId});
        };
        ...
        var check = function(data){
             ...
             if (data.length == 0) {
                 ...
                 $(data).each(function () {
                	 ...
                	 if(rowdata.state == '新建'){
	                     param.push(rowdata.pay_code);
                	 }
                 });
                if(param.length == 0){$.etDialog.error('当前状态不可审核'); return;}
                ajaxPostData({
             	   	url: '../init/checkPactDepRecSKHT.do?isCheck=false',
        ...
        var del = function(data){
            ...
            if (data.length == 0) {
               ...
               $.etDialog.confirm('确定删除?', function () {
                   ajaxPostData({
                	   url: '../init/deletePactDepRecSKHT.do?isCheck=false',
        ...
        var edit = function (data) {
        	parent.$.etDialog.open({
                url: 'hrp/pac/skht/guarantee/performance/init/toPactDepRecSKHTEditPage.do?isCheck=false&pay_code='+data.pay_code + '&pact_code='+data.pact_code,
                width: '680px',
                height: '400px',
                title: '编辑',
                modal: true,
        ...
        var add = function (data) {
        	parent.$.etDialog.open({
        		url: 'hrp/pac/skht/guarantee/performance/init/toPactDepRecSKHTAddPage.do?isCheck=false&is_init=0',
                 width: '680px',
                 height: '400px',
                 title: '添加',
                 modal: true,
...
<body>
    <table class="table-layout">
        ...
        <tr>
            ...
            <td class="label" style="width: 100px;">付款编号：</td>
            <td class="ipt"><input id="pay_code" type="text" /> </td>
        </tr>
        <tr>
         	<td class="label" style="width: 100px;">付款方式：</td>
