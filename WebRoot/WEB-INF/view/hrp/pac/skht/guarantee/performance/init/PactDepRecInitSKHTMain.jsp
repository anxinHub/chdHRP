    ...
    <script>
        ...
        var initGrid = function () {
            ...
            var paramObj = {
            	...
            	checkbox: true,
                dataModel: {
                    url: 'queryPactDepRecSKHT.do?isCheck=false&is_init=1'
                },
        ...
        var check = function(data){
             ...
             if (data.length == 0) {
                ...
                ajaxPostData({
             	   	url: 'checkPactDepRecSKHT.do?isCheck=false',
        ...
        var del = function(data){
            ...
            if (data.length == 0) {
                ...
                $.etDialog.confirm('确定删除?', function () {
                    ajaxPostData({
                 	   url: 'deletePactDepRecSKHT.do?isCheck=false',
        ...
        var add = function (data) {
        	parent.$.etDialog.open({
                 url: 'hrp/pac/skht/guarantee/performance/init/toPactDepRecSKHTAddPage.do?isCheck=false&is_init=1',
                 width: '680px',
                 height: '400px',
                 title: '添加',
                 modal: true,
