...
<script type="text/javascript">
           ...
           columns: [ 
                     ...
                     { display: '是否生成',width:80, name: 'is_auto', align: 'center',
							render : function(rowdata, rowindex,value) {
								if(value == 1){
	  								return "<input type='checkbox' style='margin-top:7px;' id='is_auto' name='is_auto"+rowindex+"' checked='checked'/>";
	                      		 }else{
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryPacRules.do',
    ...
    function save(rowindex,proj_code){
		...
		ajaxJsonObjectByUrl("updatePacRules.do",formPara,function(responseData){
                query();
        });
    }
    </script>
