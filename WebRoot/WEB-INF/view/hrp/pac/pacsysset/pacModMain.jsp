...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryMod.do',
	...
	function save(mod_code,index){
		...
		var formPara = {
		 ...
		 ajaxJsonObjectByUrl("../pacsysset/addPacModStart.do?isCheck=false",formPara,function(responseData){
