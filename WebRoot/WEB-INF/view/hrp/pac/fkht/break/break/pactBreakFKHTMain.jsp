...
<script type="text/javascript">
        ...
        var initGrid = function () {
            ...
            var paramObj = {
            	...
            	checkbox: true,
                dataModel: {
                    url: 'queryPactBreakFKHT.do?isCheck'
                },
        ...
        var print = function(){
           	...
           	var printPara={
                  	...
                  	columns: JSON.stringify(grid.getPrintColumns()),//表头
               		class_name:"com.chd.hrp.pac.service.fkht.breach.PactBreakFKHTService",
   					method_name:"queryPactBreakFKHTPrint",
   					bean_name:"pactBreakFKHTService",
        ...
        var check = function(data){
             ...
             if (data.length == 0) {
                ...
                ajaxPostData({
             	   	url: 'checkPactBreakFKHT.do?isCheck=false',
        ...
        var del = function(data){
            ...
            if (data.length == 0) {
                ...
                $.etDialog.confirm('确定删除?', function () {
                    ajaxPostData({
                 	   url: 'deletePactBreakFKHT.do?isCheck=false',
        ...
        var edit = function (data) {
        	parent.$.etDialog.open({
        		 url: 'hrp/pac/fkht/break/break/toPactBreakFKHTEditPage.do?isCheck=false&break_code='+data.break_code + '&pact_code='+data.pact_code,
        		 width: '1000px',
        ...
        var add = function (data) {
        	parent.$.etDialog.open({
                 url: 'hrp/pac/fkht/break/break/toPactBreakFKHTAddPage.do?isCheck=false',
                 width: '1000px',
                 height: $(window).height(),
                 title: '添加',
                 modal: true,
