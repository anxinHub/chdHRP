    ...
    <script>
        ...
        var initGrid = function () {
            ...
            var paramObj = {
            	...
            	checkbox: true,
                dataModel: {
                    url: 'queryPactSPFKHT.do?isCheck'
                },
        ...
        var print = function(){
           	...
           	var printPara={
                  	...
                  	columns: JSON.stringify(grid.getPrintColumns()),//表头
               		class_name:"com.chd.hrp.pac.service.fkht.breach.PactSPFKHTService",
   					method_name:"queryPactSPFKHTPrint",
   					bean_name:"pactSPFKHTService",
        ...
        var check = function(data){
             ...
             if (data.length == 0) {
                ...
                ajaxPostData({
             	   	url: 'checkPactSPFKHT.do?isCheck=false',
        ...
        var del = function(data){
            ...
            if (data.length == 0) {
                ...
                $.etDialog.confirm('确定删除?', function () {
                    ajaxPostData({
                 	   url: 'deletePactSPFKHT.do?isCheck=false',
        ...
        var edit = function (data) {
        	parent.$.etDialog.open({
        		 url: 'hrp/pac/fkht/break/sp/toPactSPFKHTEditPage.do?isCheck=false&sp_code='+data.sp_code + '&pact_code='+data.pact_code,
        		 width: '1000px',
        ...
        var add = function (data) {
        	parent.$.etDialog.open({
                 url: 'hrp/pac/fkht/break/sp/toPactSPFKHTAddPage.do?isCheck=false',
                 width: '1000px',
                 height: $(window).height(),
                 title: '添加',
                 modal: true,
