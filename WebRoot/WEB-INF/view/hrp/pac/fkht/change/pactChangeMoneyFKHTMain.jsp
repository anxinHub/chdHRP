    ...
    <script>
        ...
        var initGrid = function () {
            var columns = [
                 ...
                 { display: '关联卡片', name: '',  width: '10%'},
                 { display: '原值变动单', name: '',  width: '10%'},
            ];
            var paramObj = {
            	editable: false,
            	height: '97%',
            	width:'100%',
                dataModel: {
                    url: 'queryPactMainChangeMoneyFKHT.do?isCheck=false'
                },
        ...
        var print = function(){
           	...
           	var printPara={
                  	...
                  	columns: JSON.stringify(grid.getPrintColumns()),//表头
   					...
   					method_name:"queryPactMainChangeMoneyFKHTPrint",
        ...
        function toDetail(rowData){
        	parent.$.etDialog.open({
          	 	 url: 'hrp/pac/fkht/change/pactMainChangeFKHTPDetailPage.do?isCheck=false&change_code='+rowData.change_code +'&pact_code='+rowData.pact_code,
                   width: $(window).width(),
                   height: $(window).height(),
                   title: '金额变动明细',
                   modal: true,
