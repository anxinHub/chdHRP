...
<head>
    ...
    <script>
        ...
        var initSelect=  function(){
        	pact_code = $("#pact_code").etSelect({url: '../../basicset/select/queryPactSKHTSelect.do?isCheck=false',defaultValue: "${pact_code}"});
        ...
        var initGrid = function () {
            var columns = [
                       { display: '退货单号', name: 'ass_back_no', align: 'center',width: '10%',
                    	   render:function(ui) {
       	               		var data = ui.rowData;
                       ...
                       { display: '退货数量', name: 'back_amount', align: 'left', width: '8%'},
            ];
            var paramObj = {
            	editable: false,
            	height: '97%',
            	width:'100%',
                dataModel: {
                    url: 'queryPactAssPurchaseFKHTMainBack.do?isCheck=false'
                },
                columns: columns,
                toolbar: {
                    items: [
