    ...
    <script>
        var initChangeMoneyGrid = function () {
            var columns = [
                 ...
                 { display: '供应商', name: 'sup_name',  width: '15%'},
            ...
            var paramObj = {
            	...
            	pageModel : false,
                dataModel: {
                    url: '../../change/queryPactMainChangeMoneyFKHT.do?isCheck=false',
                    postData: {
                    	pact_code : '${pact_code}'
                    }
                },
        ...
        var initGuaranteeGrid = function () {
            ...
            var paramObj = {
            	...
            	pageModel : false,
                dataModel: {
                    url: '../../guarantee/performance/init/queryPactDepRecFKHT.do?isCheck=false',
                    postData: {
                    	pact_code : '${pact_code}'
                    }
                },
        ...
        var initRefundGrid = function () {
            var columns = [
            	{ display: '退款编号', name: 'ret_code',width: '150px'},
           		{ display: '退款日期', name: 'date', align: 'center', width: '90px'},
                { display: '供应商', name: 'sup_name',width: '200px'},
           		{ display: '合同编号', name: 'pact_code',width: '150px'},
                { display: '合同名称', name: 'pact_name',width: '200px'},
                { display: '退款金额', name: 'money', align: 'right', width: '100px'},
                { display: '摘要', name: 'note', width: '150px'},
                { display: '退款方式', name: 'pay_way', width: '90px'},
                { display: '支票号码', name: 'cheq_no', width: '150px'},
                { display: '制单人', name: 'maker_name', align: 'center', width: '80px'},
                { display: '审核人', name: 'checker_name', align: 'center', width: '80px'},
                { display: '确认人', name: 'confirmer_name', align: 'center', width: '80px'},
            ...
            var paramObj = {
            	...
            	pageModel : false,
                dataModel: {
                    url: '../../guarantee/performance/refund/queryPactDepRetFKHT.do?isCheck=false',
                    postData: {
                    	pact_code : '${pact_code}'
                    }
                },
        ...
        var initLetterGrid = function () {
            var columns = [
            	 ...
            	 { display: '开具日期', name: 'sign_date', align: 'center',width: '15%'},
                 { display: '供应商', name: 'sup_name', align: 'center', width: '15%'},
            	 { display: '合同编号', name: 'pact_code', align: 'center',width: '15%'},
                 { display: '合同名称', name: 'pact_name', align: 'center' ,width: '19%'},
                 { display: '担保金额', name: 'money', align: 'center', width: '15%'},
                 { display: '开始日期', name: 'start_date', align: 'center', width: '15%'},
                 { display: '结束日期', name: 'end_date', align: 'center', width: '15%'},
                 { display: '索赔条件', name: 'sp_cond', align: 'center', width: '15%'},
                 { display: '备注', name: 'note', align: 'center', width: '15%'},
                 { display: '制单人', name: 'maker_name', align: 'center', width: '15%'},
                 { display: '审核人', name: 'checker_name', align: 'center', width: '15%'},
                 { display: '确认人', name: 'confirmer_name', align: 'center', width: '15%'},
                 { display: '失效人', name: 'disabler_name', align: 'center', width: '15%'},
                 { display: '状态', name: 'letter_state', align: 'center', width: '15%'},
            ];
            var paramObj = {
            	editable: false,
            	height: '240',
            	...
            	pageModel : false,
                dataModel: {
                    url: '../../guarantee/letter/queryPactLetterFKHT.do?isCheck=false',
                    postData: {
                    	pact_code : '${pact_code}'
                    }
                },
        ...
        var initPayGrid = function () {
            ...
            var paramObj = {
            	...
            	pageModel : false,
                dataModel: {
                	   url: '../../payment/payment/queryPactPayMainFKHT.do?isCheck=false',
                	   postData: {
                       	pact_code : '${pact_code}'
                       }
                },
        ...
        var initBreakGrid = function () {
            ...
            var paramObj = {
            	...
            	pageModel : false,
                dataModel: {
                    url: '../../break/break/queryPactBreakFKHT.do?isCheck',
                    postData: {
                    	pact_code : '${pact_code}'
                    }
                },
        ...
        var initSPGrid = function () {
            var columns = [
                 ...
                 { display: '索赔日期', name: 'sp_date', align: 'center', width: '100px'},
                 { display: '制单人', name: 'maker_name', align: 'center',width: '80px'},
                 { display: '审核人', name: 'checker_name',align: 'center', width: '80px'},
                 { display: '确认人', name: 'confirmer_name',align: 'center', width: '80px'},
                 { display: '状态', name: 'state_name', align: 'center', width: '80px'},
            ...
            var paramObj = {
            	...
            	pageModel : false,
                dataModel: {
                    url: '../../break/sp/queryPactSPFKHT.do?isCheck=false',
                    postData: {
                    	pact_code : '${pact_code}'
                    }
                },
...
<body style="overflow: auto;">
    <hr><h1 style="padding-left: 20px">付款合同变更表</h1> 
