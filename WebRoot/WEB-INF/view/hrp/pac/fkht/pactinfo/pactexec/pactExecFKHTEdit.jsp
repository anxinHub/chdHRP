...
var is_deposit;
    ...
    var initSelect=  function(){
        ...
        curr_code = $("#curr_code").etSelect({url: '../../../basicset/select/queryAccCurDictSelect.do?isCheck=false',defaultValue: '${entity.curr_code}'});
	 ...
	 var initSubGrid = function () {
         ...
         var paramObj = {
             ...
             usePager: false,
             dataModel: {
	             url: '../pactinit/queryPactDetFKHT.do?isCheck=false&pact_code='+$("#pact_code").val(),
             },
             columns: columns,
         };
	 ...
	 var initPactPlanGrid = function () {
         ...
         var paramObj = {
         	...
         	usePager: false,
             dataModel: {
	             url: '../pactinit/queryPactPlanFKHT.do?isCheck=false&pact_code='+$("#pact_code").val(),
             },
             columns: columns,
         };
	 ...
	 var initPactDocGrid = function () {
         ...
         var paramObj = {
         	...
         	usePager: false,
            dataModel: {
	         	url: '../../pactdoc/queryPactDocFKHT.do?isCheck=false&pact_code='+$("#pact_code").val(),
             },
             columns: docColumns,
         };
