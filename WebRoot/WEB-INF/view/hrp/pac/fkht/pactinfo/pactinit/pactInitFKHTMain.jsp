    ...
    <script>
        ...
        var initGrid = function () {
            ...
            var paramObj = {
            	...
            	checkbox: true,
                dataModel: {
                    url: 'queryPactMainFKHT.do?isCheck=false&is_init=1'
                },
        ...
        var check = function(data){
             ...
             if (data.length == 0) {
                 ...
                 if(param.length == 0){
                   ...
                   ajaxPostData({
                       url: 'checkPactMainFKHT.do?isCheck=false',
                       data: {
        ...
        var save = function (data) {
        	 parent.$.etDialog.open({
                 url: 'hrp/pac/fkht/pactinfo/pactinit/pactMainFKHTAdd.do?isCheck=false&is_init=1',
                 //width: $(window).width(),
        ...
        var remove = function () {
             ...
             if (data.length == 0) {
                 ...
                 $.etDialog.confirm('确定删除?', function () {
                     ajaxPostData({
                         url: 'deletePactMainFKHT.do?isCheck=false',
                         data: {
                        	 mapVo: JSON.stringify(param)
                         },
                         success: function () {
