    ...
    var initSelect=  function(){
	 ...
	 var initSubGrid = function () {
         var columns = [
				...
				{ display: '单价', name: 'price', width: '120px',align: "right", editor: { type: 'number'}},
     ...
     var initSourceGrid = function () {
         var columns = [
				{display: '资金来源', name: 'source_name', align: 'center', width: '120px',editable: true,
					 editor: {
	          		 	type: 'select', 
	          		 	keyField: 'source_id',
				...
				{ display: '金额', name: 'money',width: '110px',align: "right", editor: {type: "number"}},              
				{ display: '备注', name: 'note',width: '120px'}
         ];
         var paramObj = {
        	 editable: true,
     ...
     function loadSourceGrid(event,ui){
    	 ...
    	 if(ui.rowData.sourceData){
    		 sourceGridData = ui.rowData.sourceData ;
...
<body style="overflow: scroll; ">
	<table class="table-layout">
		...
		<tr>
			...
			<td class="ipt"><input id="pact_money_w" type="text" disabled="disabled" style="background-color: #EAEAEA"/></td>
		...
		<tr>
			...
			<td class="ipt"><input id="deposit_money" type="text" disabled="disabled" style="background-color: #EAEAEA"/></td>
		</tr>
		<tr>
