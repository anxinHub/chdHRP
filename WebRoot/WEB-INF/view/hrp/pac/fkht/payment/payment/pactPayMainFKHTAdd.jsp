...
var sourceSoues = [];   
	var save = function() {
		...
		if(!formValidate.test()){
		 ...
		 $(data).each(function () {
             var rowdata = this.rowData;
       		 ...
       		 money1+=parseFloat(rowdata.pay_money);
             param.push(obj);
         });
		...
		ajaxPostData({
			url : 'addPactPayMainFKHT.do?isCheck=false',
			data : {
    ...
    var initPactPlanGrid = function () {
        ...
        var paramObj = {
        	...
        	load :function(){
        		 $("#pay_money").val(palnGrid.getTotalSummary("pay_money"));	
        	},
    ...
    var initPayDetailGrid = function () {
        var columns = [
             ...
             { display: '付款金额', name: 'pay_money', align: 'right', width: '150px',editor: {type: 'text'}},
	...
	<div>
		<table class="table-layout">
			<tr>
				...
				<td class="ipt"><input id="pay_code" type="text" disabled="disabled" value="系统生成" style="background-color: #eaeaea"/></td>
			...
			<tr>
				...
				<td class="ipt"><input id="pay_date" style="width: 180px;"/></td>
				...
				<td class="ipt"><input id="pay_money" type="text" disabled="disabled" style="background-color: #eaeaea"/></td>
			</tr>
			<tr>
