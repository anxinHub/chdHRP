...
<head>
    ...
    <script>
        ...
        var print = function(){
           	...
           	var printPara={
                  	...
                  	columns: JSON.stringify(grid.getPrintColumns()),//表头
               		class_name:"com.chd.hrp.pac.service.fkht.guarantee.PactLetterFKHTService",
   					method_name:"queryPactLetterFKHTPrint",
   					bean_name:"pactLetterFKHTService",
        ...
        var printModel = function(){
    			useId='${user_id }';
    			officeFormTemplate({template_code:"11001",use_id:useId});
           };
        ...
        var check = function(data){
             ...
             if (data.length == 0) {
                ...
                ajaxPostData({
             	   	url: 'checkPactLetterFKHT.do?isCheck=false',
        ...
        var del = function(data){
            ...
            if (data.length == 0) {
                ...
                $.etDialog.confirm('确定删除?', function () {
                    ajaxPostData({
                        url: 'deletePactLetterFKHT.do?isCheck=false',
        ...
        var edit = function (data) {
        	parent.$.etDialog.open({
        		 url: 'hrp/pac/fkht/guarantee/letter/toPactLetterFKHTEditPage.do?isCheck=false&letter_code='+data.letter_code + '&pact_code='+data.pact_code,
                 width: '680px',
        ...
        var add = function (data) {
        	parent.$.etDialog.open({
                 url: 'hrp/pac/fkht/guarantee/letter/toPactLetterFKHTAddPage.do?isCheck=false',
                 width: '680px',
                 height: $(window).height(),
                 title: '添加',
                 modal: true,
