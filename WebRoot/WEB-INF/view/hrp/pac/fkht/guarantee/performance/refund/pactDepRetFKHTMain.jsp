...
<head>
    ...
    <jsp:include page="${path}/resource.jsp">
	    <jsp:param value="hr,tree,grid,select,dialog,datepicker,validate,pageOffice,pageOffice" name="plugins" />
	</jsp:include>
    <script>
        var grid;
        var startpicker;
        ...
        var printModel = function(){
 			useId='${user_id }';
 			officeFormTemplate({template_code:"11003",use_id:useId});
        };
        ...
        var print = function(){
           	...
           	var printPara={
                  	...
                  	columns: JSON.stringify(grid.getPrintColumns()),//表头
               		class_name:"com.chd.hrp.pac.service.fkht.guarantee.performance.PactDepRetFKHTService",
   					method_name:"queryPactDepRetFKHTPrint",
   					bean_name:"pactDepRetFKHTService",
        ...
        var check = function(data){
             ...
             if (data.length == 0) {
                ...
                ajaxPostData({
             	   	url: 'checkPactDepRetFKHT.do?isCheck=false',
        ...
        var del = function(data){
            ...
            if (data.length == 0) {
                ...
                $.etDialog.confirm('确定删除?', function () {
                    ajaxPostData({
                        url: 'deletePactDepRetFKHT.do?isCheck=false',
        ...
        var edit = function (data) {
        	parent.$.etDialog.open({
                 url: 'hrp/pac/fkht/guarantee/performance/refund/toPactDepRetFKHTEditPage.do?isCheck=false&ret_code='+data.ret_code + '&pact_code='+data.pact_code,
                 width: '680px',
                 height: '330px',
                 title: '编辑',
                 modal: true,
        ...
        var add = function (data) {
        	parent.$.etDialog.open({
                 url: 'hrp/pac/fkht/guarantee/performance/refund/toPactDepRetFKHTAddPage.do?isCheck=false',
                 width: '680px',
                 height: '330px',
                 title: '添加',
                 modal: true,
...
<body>
    <table class="table-layout">
        <tr>
            <td class="label" style="width: 100px;">退款日期：</td>
        ...
        <tr>
            ...
            <td class="label" style="width: 100px;">退款编号：</td>
            <td class="ipt"><input id="ret_code" type="text" /> </td>
        </tr>
        <tr>
         	<td class="label" style="width: 100px;">退款方式：</td>
