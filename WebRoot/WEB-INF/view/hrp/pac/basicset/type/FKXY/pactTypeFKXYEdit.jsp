...
var subjectType;
	...
	var initSelect = function(){
		...
		//var attrSelect = $("#fkxy_attr").etSelect({url: "../../select/queryDictSelect.do?isCheck=false&f_code=PACT_ATTR_FKXY",defaultValue: "${entity.fkxy_attr }"});
		var change = true;
		var code=""
			attrSelect = $("#fkxy_attr").etSelect({
	   			url: '../../select/queryDictSelect.do?isCheck=false&f_code=PACT_ATTR_FKXY',
	   			defaultValue: "${entity.fkxy_attr}",
...
<body>
	<table class="table-layout">
		...
		<tr>
			...
			<td class="ipt"><select id="subject_type" style="width: 180px" disabled="disabled"></select></td>
		</tr>
		<tr>
