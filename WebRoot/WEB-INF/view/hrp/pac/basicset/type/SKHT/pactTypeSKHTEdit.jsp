...
var datepicker;
	...
	var initSelect = function(){
		...
		var deptSelect = $("#pact_nature").etSelect({url: "../../select/queryTypeSKHTNatureSelect.do?isCheck=false",defaultValue: "${entity.pact_nature }"});
		var attrSelect = $("#auto_vouch_type").etSelect({url: "../../select/queryDictSelect.do?isCheck=false&f_code=VOUCH_TYPE_SKHT",defaultValue: "${entity.auto_vouch_type }"});
