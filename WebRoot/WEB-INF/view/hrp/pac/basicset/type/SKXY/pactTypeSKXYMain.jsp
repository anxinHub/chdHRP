...
<script>
        ...
        var update = function (data) {
        	 $.etDialog.open({
                 url: 'toPactTypeSKXYEditMain.do?isCheck=false&type_code=' + data.type_code,
                 width: 620,
                 height: 340,
                 title: '编辑',
                 btn: ['保存', '取消'],
        ...
        var save = function (data) {
        	 $.etDialog.open({
                 url: 'toPactTypeSKXYAddMain.do?isCheck=false',
                 width: 620,
                 height: 340,
                 title: '添加',
                 btn: ['保存', '取消'],
...
<body>
	<table class="table-layout">
		<tr>
			...
			<td class="ipt"><select id="dept_id" style="width: 180px;"></select>
			</td>
		</tr>
		<tr>
