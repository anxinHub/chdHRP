    ...
    <script>
        ...
        var query = function () {
            params = [
                ...
                { name: 'pact_attr_fkht', value: $("#pact_attr_fkht").val() },
        ...
        var initGrid = function () {
            var columns = [
                 ...
                 { display: '合同属性', name: 'pact_attr_fkht', width: '10%'},
                 ...
                 { display: '是否停用', name: 'is_stop', align: 'center',width: '6%',
                	 render: function (obj) {
        ...
        var initSelect=  function(){
			...
			var attrSelect = $("#pact_attr_fkht").etSelect({url: "../../select/queryDictSelect.do?isCheck=false&f_code=PACT_ATTR_FKHT",defaultValue: "none"});
			 $("#is_stop").etSelect({
     			  options: [
     			    { id: 0, text: '否' },
     			    { id: 1, text: '是' }
        ...
        var update = function (data) {
        	 $.etDialog.open({
                 url: 'toPactTypeFKHTEditMain.do?isCheck=false&type_code=' + data.type_code,
                 width: 620,
                 height: 410,
                 title: '编辑',
                 btn: ['保存', '取消'],
      ...
      //跳转保存页面
        var save = function (data) {
        	 $.etDialog.open({
                 url: 'toPactTypeFKHTAddMain.do?isCheck=false',
                 width: 620,
                 height: 410,
                 title: '添加',
                 btn: ['保存', '取消'],
...
<body>
    <table class="table-layout">
        ...
        <tr>
            ...
            <td class="label" style="width: 100px;">合同属性：</td>
            <td class="ipt">
                <select id="pact_attr_fkht" style="width: 180px"></select>
            </td>
