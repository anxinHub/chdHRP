...
<head>
    ...
    <script>
        ...
        var addFileType = function (data) {
        	 $.etDialog.open({
                 url: 'PactFileTempSKHTInsert.do?isCheck=false&pid='+pids,
                 width: 800,
                 height: 550,
                 //title: '添加',
                 //btn: ['保存', '取消'],
        ...
        var initTree = function () {
            tree = $("#mainTree").etTree({
                async: {
                    ...
                    url: 'queryPactTypeSKHT.do?isCheck=false'
                },
                callback: {
                    onClick: function (event, treeId, treeNode) {
                    	...
                    	grid.loadData(params,'queryPactFileTempSKHTfile.do?isCheck=false');
                    },
