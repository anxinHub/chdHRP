...
<head>
    ...
    <script>
        ...
        var addFileType = function (data) {
        	 $.etDialog.open({
                 url: 'pactFileTempFKXYInsert.do?isCheck=false&pid='+pids,
                 width: 800,
                 height: 550,
        ...
        var initTree = function () {
            tree = $("#mainTree").etTree({
                async: {
                    ...
                    url: 'queryPactTypeFKXY.do?isCheck=false'
                },
                callback: {
                    onClick: function (event, treeId, treeNode) {
                    	...
                    	grid.loadData(params,'queryPactFileTempFKXYfile.do?isCheck=false');
                    },
