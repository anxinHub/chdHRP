	...
	var parentWindow = parent.window[parentFrameName]
     ...
     var query = function () {
       ...
       var addFileType = function (data) {
       	 $.etDialog.open({
                url: 'PactFileTempSKXYAdd.do?isCheck=false',
                width: 300,
                height: 350,
                title: '添加',
                btn: ['保存', '取消'],
       ...
       var save = function(){
           ...
           ajaxPostData({
               url: 'addPactFileTempSKXY.do?isCheck=false',
               data: {
               ...
               success: function(ret){
            	...
            	var params=[{name:'pact_type_code',value:pact_type_code}];
   				parent.window.grid.loadData(params,'queryPactFileTempSKXYfile.do?isCheck=false');
               }
           })
   }
