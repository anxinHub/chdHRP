...
<head>
    ...
    <script>
        ...
        var addFileType = function (data) {
        	 $.etDialog.open({
                 url: 'PactFileTempSKXYInsert.do?isCheck=false&pid='+pids,
                 width: 800,
                 height: 550,
                 //title: '添加',
                 //btn: ['保存', '取消'],
                ...
                var paramObj = {
                    ...
                    toolbar: {
                        items: [
                           ...
                           { type: 'button', label: '归档项目设置', listeners: [{ click: addFileType }], icon: 'add' }
        ...
        var initTree = function () {
            tree = $("#mainTree").etTree({
                async: {
                    ...
                    url: 'queryPactTypeSKXY.do?isCheck=false'
                },
                callback: {
                    onClick: function (event, treeId, treeNode) {
                    	...
                    	grid.loadData(params,'queryPactFileTempSKXYfile.do?isCheck=false');
                    },
