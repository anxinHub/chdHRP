...
<head>
    ...
    <script>
        ...
        var openUpdate = function (rowData) {
        	$.etDialog.open({
            	 url: 'pactNatureSKHTEditPage.do?isCheck=false&nature_code=' + rowData.nature_code,
                 width: 320,
                 height: 280,
                 title: '修改',
                 btn: ['保存', '取消'],
        ...
        var save = function (data) {
        	 $.etDialog.open({
                 url: 'pactNatureSKHTAddPage.do?isCheck=false',
                 width: 320,
                 height: 280,
                 title: '添加',
                 btn: ['保存', '取消'],
