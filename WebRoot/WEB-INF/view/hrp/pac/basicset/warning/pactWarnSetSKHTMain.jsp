...
<head>
    ...
    <script>
        ...
        var save = function (data) {
        	ajaxPostData({
                url: 'updatePactWarnSetSKHT.do',
                data: {
                	pact_type_code:data.pact_type_code,
    				pact_end_w:data.pact_end_w,
    				deposit_get_w:data.deposit_get_w,
    				rec_w:data.rec_w
                },
                delayCallback:true,
        ...
        var initGrid = function () {
            var columns = [
                 ...
                 { display: '保证金收回预警(天)', name: 'deposit_get_w', align: 'center',width: '15%', editable: true},
                 { display: '收款预警(天)', name: 'rec_w', align: 'center',width: '15%', editable: true},
