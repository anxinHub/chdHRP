  ...
  <head>
	...
	function loadHead(){
		grid = $("#maingrid").ligerGrid({
			...
			url: "../../mat/info/basic/inv/queryMatInvSup.do?isCheck=false",
			async:false,
    ...
    function save(){
        ...
        if($("form").valid()){
	        ...
	        var formPara={
				...
				fac_id : liger.get("fac_code").getValue() == null ? "" : liger.get("fac_code").getValue(),
	        ...
	        ajaxJsonObjectByUrl("../../mat/info/basic/inv/updateMatInv.do",formPara,function(responseData){
    ...
    function loadDict(){
    	//字典下拉框
		autocomplete("#mat_type_code", "../../mat/queryMatTypeDict.do?isCheck=false", "id", "text", true, true, {is_last : '1'});
		...
		autocomplete("#price_type", "../../mat/queryMatSysList.do?isCheck=false", "id", "text", true, true, paras, false, "${matInv.price_type}");
		paras = {
			field_code : "amortize_type"
		}
		autocomplete("#amortize_type", "../../mat/queryMatSysList.do?isCheck=false", "id", "text", true, true, paras, false, "${matInv.amortize_type}");
		...
		autocomplete("#fac_code", "../../mat/queryHosFac.do?isCheck=false", "id", "text", true, true, "", false);

		
		liger.get("fac_code").setValue("${matInv.fac_id}");
		...
		autocomplete("#manage_type", "../../mat/queryMatManageType.do?isCheck=false", "id", "text", true, true, "", false, "${matInv.manage_type}");
		...
		$("#plan_price").ligerTextBox({width:160, number:true, precision:'${p04001}'});
		$("#plan_price").focus(function(){this.select();});//加获取焦点选择文本事件
		$("#price_rate").ligerTextBox({width:160, number:true});
		$("#sell_price").ligerTextBox({width:160, number:true, precision:'${p04001}'});
  ...
  //改变启用日期事件
	...
	function openUpdate(){
		parent.$.ligerDialog.open({
			url: 'hrp/mat/info/basic/inv/matInvCertInfoMainPage.do?isCheck=false&inv_id='+'${matInv.inv_id}', 
	...
	<form name="form1" method="post"  id="form1" >
		<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%" style="padding: 10px" border="0">
	        ...
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="plan_price" type="text" id="plan_price" ltype="text" value="${matInv.plan_price}"  validate="{required:false,maxlength:20}" />
	            </td>
	            <td align="right" class="l-table-edit-td" >
	            	加价率：
	            </td>
	            <td align="left" class="l-table-edit-td">
	            	<input name="price_rate" type="text" id="price_rate" ltype="text" value="${matInv.price_rate}" validate="{required:false,maxlength:20}" />
	            </td>
	            <td align="right" class="l-table-edit-td" >
	            	零售价：
	            </td>
	        	...
	        	<td class="l-table-edit-td" colspan="6">
	        		<table cellpadding="0" cellspacing="0" style="margin-top: 20px;" class="l-table-edit" border="1px;" width="100%">
	        			<tr height="30px" style="background: url(../../../../../lib/ligerUI/skins/Aqua/images/grid/header-bg.gif) repeat;);">
	        				...
	        				<td align="center" width="10%">条码管理标识</td>
	        ...
	        <tr>
	        	...
	        	<td align="left" class="l-table-edit-td" colspan="2">
	        		<input name="is_change" type="checkbox" id="is_change" ltype="text"  />是否保存变更记录
	        	</td>
	        </tr>
	        <tr>
	        	<td colspan="6" align="left" class="l-table-edit-td" >
