  ...
  <head>
	...
	function loadHead(){
		grid = $("#maingrid").ligerGrid({
			...
			//isScroll : false,
			url: "queryMatInvSup.do?isCheck=false&sup_id=${sup_id}&sup_code=${sup_code}&sup_name=${sup_name}",
			isAddRow:false,
	...
	function  save(){
        ...
        if($("form").valid()){
			...
			var hrp_inv_id="";
			ajaxJsonObjectByUrl("../../mat/info/basic/inv/addMatInv.do",formPara,function(responseData){
     	            if(responseData.state=="true"){
     	            	var str=responseData.update_para;
     	            	hrp_inv_id=str.split(",")[3];
     	            
     	            	update_sup_state(hrp_inv_id);
     	                parentFrameUse().query();
             			var obj=${group_id}+"|"+${hos_id}+"|"+'${copy_code}'+"|"+${inv_id}+"|"+hrp_inv_id
             			parentFrameUse().openAuditUpdate(obj);
             			this_close();
     	            }
     	        });
        }
    }
    function update_sup_state(inv_id){
    	
		var parm = 
			"inv_id="+${inv_id}   +"&"+ 
			"sup_id="+${sup_id}   +"&"+
			"hrp_inv_id="+inv_id;
		//更新供应商字典表 启用状态 以及 hrp中的材料ID
    	ajaxJsonObjectByUrl("updateSupState.do?isCheck=false&"+parm,{},function (responseData){	});
    }
     //加载表单
	function loadForm(){
	...
	function loadDict(){
		...
		liger.get("mat_type_code").setValue("${mat_type_id},${mat_type_no}");
		liger.get("mat_type_code").setText("${mat_type_name}");
		
		var paras = {
			field_code : "price_type"
		}
		autocomplete("#price_type", "../../mat/queryMatSysList.do?isCheck=false", "id", "text", true, true, paras, true);
		paras = {
			field_code : "amortize_type"
		}
		autocomplete("#amortize_type", "../../mat/queryMatSysList.do?isCheck=false", "id", "text", true, true, paras, true);
		autocomplete("#unit_code", "../../mat/queryHosUnit.do?isCheck=false", "id", "text", true, true);
		autocomplete("#fac_code", "../../mat/queryHosFac.do?isCheck=false", "id", "text", true, true);
		autocomplete("#manage_type", "../../mat/queryMatManageType.do?isCheck=false", "id", "text", true, true);
		...
		liger.get("fac_code").setText("${fac_name}");
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%" style="padding: 10px"  >
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td" width="20%">
	            	<input name="inv_code" type="text" id="inv_code" ltype="text" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')" value="${inv_code}" validate="{required:true,maxlength:20}" />
	            </td>
	            <td align="right" class="l-table-edit-td"  width="10%">
	            	<span style="color:red">*</span>材料名称：
	            </td>
	            <td align="left" class="l-table-edit-td" width="20%">
	            	<input name="inv_name" type="text" id="inv_name" ltype="text"  validate="{required:true,maxlength:50}"  value="${inv_name}"/>
	            </td>
	            <td align="right" class="l-table-edit-td" width="10%">
	            	别名：
	            </td>
	            <td align="left" class="l-table-edit-td" width="20%">
	            	<input name="alias" type="text"  id="alias" ltype="text"  validate="{required:false,maxlength:50}" value="${alias}" />
	            </td>
	        </tr> 
	        <tr>
			...
			<tr>
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="inv_model" type="text" id="inv_model" ltype="text"  validate="{required:true,maxlength:200}" value="${inv_model}" />
	            </td>
	            <td align="right" class="l-table-edit-td"  >
	        ...
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="plan_price" type="text" id="plan_price"   ltype="text" validate="{required:false,maxlength:20}"  value="${plan_price}"/>
	            </td>
	            <td align="right" class="l-table-edit-td"  >
	            	加价率：
	            </td>
	            <td align="left" class="l-table-edit-td">
	            	<input name="price_rate" type="text" id="price_rate" ltype="text" validate="{required:false,maxlength:20}" value="${price_rate}" />
	            </td>
	            <td align="right" class="l-table-edit-td"  >
	            	零售价：
	            </td>
	            <td align="left" class="l-table-edit-td">
	            	<input name="sell_price" type="text" id="sell_price"  value="0" ltype="text" validate="{required:false,maxlength:20}" value="${sell_price}" />
	            </td>
	        </tr> 
	        <tr>
	            <td align="right" class="l-table-edit-td"  >
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="agent_name" type="text" id="agent_name" ltype="text" validate="{required:false,maxlength:60}" value="${agent_name}" />
	            </td>
	        </tr>
	        <tr>
	            <td align="right" class="l-table-edit-td"  >
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="brand_name" type="text" id="brand_name" ltype="text" validate="{required:false,maxlength:60}" value="${brand_name}" />
	            </td>
	            <td align="right" class="l-table-edit-td"  >
					材料用途：
				</td>
