  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateAssEqdevicemap.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="device_code" type="text" id="device_code" ltype="text" value="${device_code}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">设备描述：</td>
            <td align="left" class="l-table-edit-td"><input name="device_desc" type="text" id="device_desc" ltype="text" value="${device_desc}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
