...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssEqdevicemapFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: 'assCode', name: 'ass_code', align: 'left',editor:{type:'text'}},
				{ display: '仪器来源编码（仪器来源类型：3.设备效益分析）COST_BUSI_SOUREC_DICT', name: 'busi_data_source_code', align: 'left',editor:{type:'text'}},
				{ display: '仪器', name: 'device_code', align: 'left',editor:{type:'text'}},
				{ display: '设备描述', name: 'device_desc', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssEqdevicemap.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
