  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAssEqgroupdetail.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='eq_unit_code']").val('');
				 $("input[name='eo_eq_group']").val('');
				 $("input[name='main_flag']").val('');
				 $("input[name='income_rate']").val('');
				 $("input[name='expend_rate']").val('');
				 $("input[name='from_date']").val('');
				 $("input[name='to_date']").val('');
				 $("input[name='update_date']").val('');
				 $("input[name='update_time']").val('');
				 $("input[name='update_userdr']").val('');
