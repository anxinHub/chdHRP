...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAssEqcserviceitem.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function saveAssEqcserviceitem(){
        if($("form").valid()){
            save();
        }
   }
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="max_minutes" type="text" id="max_minutes" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
