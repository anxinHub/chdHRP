...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssEqcserviceitemFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '计量编码（HOS_UNIT）', name: 'unit_code', align: 'left',editor:{type:'text'}},
				{ display: '单价', name: 'price', align: 'left',editor:{type:'text'}},
				{ display: '备注', name: 'remark', align: 'left',editor:{type:'text'}},
				{ display: '导入标志', name: 'import_flag', align: 'left',editor:{type:'text'}},
				{ display: '最小分钟数', name: 'min_minutes', align: 'left',editor:{type:'text'}},
				{ display: '每次分钟数', name: 'minutes_per_times', align: 'left',editor:{type:'text'}},
				{ display: '最大分钟数', name: 'max_minutes', align: 'left',editor:{type:'text'}},
				{ display: '无效标志', name: 'invalid_flag', align: 'left',editor:{type:'text'}},
				{ display: '更新日期', name: 'update_date', align: 'left',editor:{type:'text'}},
				{ display: '曾用描述', name: 'ex_desc', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchAssEqcserviceitem.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
