  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAssEqcconsumableitem.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='consum_code']").val('');
				 $("input[name='consum_desc']").val('');
				 $("input[name='price']").val('');
				 $("input[name='unit_code']").val('');
				 $("input[name='invalid_flag']").val('');
				 $("input[name='is_seperate_fee']").val('');
 ...
 function loadForm(){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="consum_desc" type="text" id="consum_desc" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="is_seperate_fee" type="text" id="is_seperate_fee" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
