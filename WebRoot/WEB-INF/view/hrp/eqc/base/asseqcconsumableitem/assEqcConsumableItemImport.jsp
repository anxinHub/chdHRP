...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssEqcconsumableitemFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '描述', name: 'consum_desc', align: 'left',editor:{type:'text'}},
				{ display: '单价', name: 'price', align: 'left',editor:{type:'text'}},
				{ display: 'unitCode', name: 'unit_code', align: 'left',editor:{type:'text'}},
				{ display: '有效标记', name: 'invalid_flag', align: 'left',editor:{type:'text'}},
				{ display: 'ciIsseperatefee', name: 'is_seperate_fee', align: 'left',editor:{type:'text'}},
				{ display: '收费价格(对于单独收费的消耗项)', name: 'pay_price', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchAssEqcconsumableitem.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
