...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssEqgroupFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '单价', name: 'eq_unit_name', align: 'left',editor:{type:'text'}},
				{ display: '更新日期', name: 'update_date', align: 'left',editor:{type:'text'}},
				{ display: 'grUpdatetime', name: 'update_time', align: 'left',editor:{type:'text'}},
				{ display: 'grFromdate', name: 'from_date', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssEqgroup.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
