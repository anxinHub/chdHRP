  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAssEqgroup.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='eq_unit_code']").val('');
				 $("input[name='eq_unit_name']").val('');
 ...
 function loadForm(){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="eq_unit_name" type="text" id="eq_unit_name" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">grUpdatetime：</td>
            ...
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">grFromdate：</td>
