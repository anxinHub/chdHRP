  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateAssEqgroup.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="eq_unit_name" type="text" id="eq_unit_name" ltype="text" value="${eq_unit_name}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
