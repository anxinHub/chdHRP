...
<script>
	...
	function initGrid() {
            var columns = [
                 {display: '名称', name: 'charge_item_name',width: '15%', editable:false },
            	 {display: '编码', name: 'charge_item_code',width: '10%', editable:setEdit ,
            		 editor: {
		...
		function save () {
			 var data = grid.getChanges();
		        ...
		        if (data.addList.length > 0 || data.updateList.length > 0) {
		            ...
		            ajaxPostData({
		                url: "saveAssEqcServDetItem.do?isCheck=false",
		...
		function remove() {
		     ...
		     if (data.length == 0) {
		         ...
		         $.etDialog.confirm('确定删除?', function () {
		             ajaxPostData({
		                 url: 'deleteAssEqcServDetItem.do',
		                 data: {
...
<body>
    <table class="table-layout">
        <tr>
        	<td class="label" style="width: 100px;">项目明细:</td>
            <td class="ipt">
