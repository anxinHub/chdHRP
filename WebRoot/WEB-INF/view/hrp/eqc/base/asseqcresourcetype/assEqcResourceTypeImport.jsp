...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssEqcresourcetypeFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '描述', name: 'oresource_desc', align: 'left',editor:{type:'text'}},
				...
				{ display: '类型', name: 'invalid_flag', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchAssEqcresourcetype.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
