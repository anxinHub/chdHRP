  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateAssEqcresourcetype.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="oresource_desc" type="text" id="oresource_desc" ltype="text" value="${oresource_desc}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
