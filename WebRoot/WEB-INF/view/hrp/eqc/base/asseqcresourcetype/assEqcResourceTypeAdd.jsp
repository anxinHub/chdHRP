...
<html style="overflow:hidden;">
    ...
    <script type="text/javascript">
     ...
     function  save(){
        var formPara={
           ...
           oresource_desc:$("#oresource_desc").val(),
        ...
        ajaxJsonObjectByUrl("addAssEqcresourcetype.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='oresource_code']").val('');
				 $("input[name='oresource_desc']").val('');
 ...
 function loadForm(){
    ...
    function saveAssEqcresourcetype(){
        if($("form").valid()){
            save();
        }
   }
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="oresource_desc" type="text" id="oresource_desc" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
