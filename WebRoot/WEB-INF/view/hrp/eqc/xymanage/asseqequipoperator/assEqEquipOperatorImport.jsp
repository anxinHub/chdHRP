...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssEqequipoperatorFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '用户ID（SYS_USER）', name: 'user_id', align: 'left',editor:{type:'text'}},
				{ display: '占比', name: 'percent', align: 'left',editor:{type:'text'}},
				{ display: '备注', name: 'remark', align: 'left',editor:{type:'text'}},
				{ display: '起始日期', name: 'from_date', align: 'left',editor:{type:'text'}},
				{ display: '结束日期', name: 'to_date', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchAssEqequipoperator.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
