  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateAssEqequipoperator.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="percent" type="text" id="percent" ltype="text" value="${percent}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
