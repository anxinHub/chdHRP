  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAssEqequipconsumable.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='ec_fromtype']").val('');
				 $("input[name='ec_eq_group']").val('');
 ...
 function loadForm(){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="ec_fromtype" type="text" id="ec_fromtype" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">ecEqGroup：</td>
            <td align="left" class="l-table-edit-td"><input name="ec_eq_group" type="text" id="ec_eq_group" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
