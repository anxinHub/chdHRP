...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssEqequipconsumableFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '01：机组:02：设备', name: 'ec_fromtype', align: 'left',editor:{type:'text'}},
				{ display: 'ecEqGroup', name: 'ec_eq_group', align: 'left',editor:{type:'text'}},
				{ display: '代码（其他资源消耗类型 ASS_EQCResourceType）', name: 'oresource_code', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssEqequipconsumable.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
