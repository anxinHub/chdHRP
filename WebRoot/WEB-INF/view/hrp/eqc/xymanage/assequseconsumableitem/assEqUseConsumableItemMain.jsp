...
<script>
	var grid, analysis_codeSelect,ur_eq_groupSelect,charge_kindSelect,charge_itemSelect,unit_codeSelect,dept_codeSelect,ur_usedateSelect,ur_enddateSelect;
	$(function () {
		loadDict();
	    initGrid();
	...
	function initGrid() {
            ...
            var paramObj = {
                ...
                dataModel: {
                    url: 'queryAssEqUseConsumableItem.do'
                },
		...
		function save () {
			 var data = grid.getChanges();
		        ...
		        if (data.addList.length > 0 || data.updateList.length > 0) {
		            ...
		            ajaxPostData({
		                url: "saveAssEqUseConsumableItem.do?isCheck=false",
		...
		function remove() {
		     ...
		     if (data.length == 0) {
		         ...
		         $.etDialog.confirm('确定删除?', function () {
		             ajaxPostData({
		                 url: 'deleteAssEqUseConsumableItem.do',
		                 data: {
