...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssEquseconsumableitemFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '使用记录（ASS_EQUseRecord）', name: 'uci_userecorddr', align: 'left',editor:{type:'text'}},
				{ display: '分析项', name: 'analysis_code', align: 'left',editor:{type:'text'}},				
				{ display: '用自增ID', name: 'charge_kind_id', align: 'left',editor:{type:'text'}},
				{ display: '代码(服务消耗资源项定义表 ASS_EQCConsumableItem)', name: 'consum_code', align: 'left',editor:{type:'text'}},
				{ display: 'deptCode', name: 'dept_code', align: 'left',editor:{type:'text'}},
				{ display: 'unitCode', name: 'unit_code', align: 'left',editor:{type:'text'}},
				{ display: '数量', name: 'quantity', align: 'left',editor:{type:'text'}},
				{ display: '单价', name: 'price', align: 'left',editor:{type:'text'}},
				{ display: '金额', name: 'amount', align: 'left',editor:{type:'text'}},
				{ display: '数量类型（1:绝对量 2:相对量 3:相对量已计算绝对量）', name: 'quantity_type', align: 'left',editor:{type:'text'}},
				{ display: '相对量', name: 'relative_qty', align: 'left',editor:{type:'text'}},
				{ display: '增加日期', name: 'add_date', align: 'left',editor:{type:'text'}},
				{ display: '使用日期', name: 'use_date', align: 'left',editor:{type:'text'}},
				{ display: '取消日期', name: 'cancel_date', align: 'left',editor:{type:'text'}},
				{ display: '统计月份', name: 'month_str', align: 'left',editor:{type:'text'}},
				{ display: '是否是按月统计', name: 'sum_by_month_flag', align: 'left',editor:{type:'text'}},
				{ display: '单独收费消耗项单价', name: 'pay_price', align: 'left',editor:{type:'text'}},
				{ display: '单独收费消耗项总金额', name: 'pay_amount', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchAssEquseconsumableitem.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
