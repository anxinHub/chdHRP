...
<script>
	...
	function initGrid() {
            var columns = [
            	 ...
            	 {display: '清算日期', name: 'liquid_date', width: '8%',editor: {type: 'date',}},
            ...
            var paramObj = {
                ...
                dataModel: {
                    url: 'queryAssEqPublicConsumLiquidate.do'
                },
		...
		function save () {
			 var data = grid.getChanges();
		        ...
		        if (data.addList.length > 0 || data.updateList.length > 0) {
		            ...
		            ajaxPostData({
		                url: "saveAssEqPublicConsumLiquidate.do?isCheck=false",
		...
		function remove() {
		     ...
		     if (data.length == 0) {
		         ...
		         $.etDialog.confirm('确定删除?', function () {
		             ajaxPostData({
		                 url: 'deleteAssEqPublicConsumLiquidate.do',
		                 data: {
