  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateAssEquserecord.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="rowid" type="text" id="rowid" ltype="text" value="${rowid}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="start_time" type="text" id="start_time" ltype="text" value="${start_time}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="end_time" type="text" id="end_time" ltype="text" value="${end_time}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">工作量：</td>
            <td align="left" class="l-table-edit-td"><input name="work_load_num" type="text" id="work_load_num" ltype="text" value="${work_load_num}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="patient_id" type="text" id="patient_id" ltype="text" value="${patient_id}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">性别：</td>
            <td align="left" class="l-table-edit-td"><input name="patient_sex" type="text" id="patient_sex" ltype="text" value="${patient_sex}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">年龄：</td>
            <td align="left" class="l-table-edit-td"><input name="patient_age" type="text" id="patient_age" ltype="text" value="${patient_age}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">姓名：</td>
            <td align="left" class="l-table-edit-td"><input name="patient_name" type="text" id="patient_name" ltype="text" value="${patient_name}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="total_fee" type="text" id="total_fee" ltype="text" value="${total_fee}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">为空表示按标准配备数量或者没有单独收费， 不为空表示特殊的单独收费项数量：</td>
            <td align="left" class="l-table-edit-td"><input name="alone_pay_num" type="text" id="alone_pay_num" ltype="text" value="${alone_pay_num}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="ex_id" type="text" id="ex_id" ltype="text" value="${ex_id}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="doctor_order_id" type="text" id="doctor_order_id" ltype="text" value="${doctor_order_id}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">记录操作员（编码_名字）：</td>
            <td align="left" class="l-table-edit-td"><input name="operator" type="text" id="operator" ltype="text" value="${operator}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">阳性标志：</td>
            <td align="left" class="l-table-edit-td"><input name="positive_flag" type="text" id="positive_flag" ltype="text" value="${positive_flag}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">用于标本号/医技号：</td>
            <td align="left" class="l-table-edit-td"><input name="sample_no" type="text" id="sample_no" ltype="text" value="${sample_no}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">用于曝光次数：</td>
            <td align="left" class="l-table-edit-td"><input name="exposure_num" type="text" id="exposure_num" ltype="text" value="${exposure_num}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">开始日期：</td>
            <td align="left" class="l-table-edit-td"><input name="start_date" type="text" id="start_date" ltype="text" value="${start_date}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">其他信息：</td>
            <td align="left" class="l-table-edit-td"><input name="other_info" type="text" id="other_info" ltype="text" value="${other_info}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="submit_time" type="text" id="submit_time" ltype="text" value="${submit_time}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
