...
<script>
	var grid, analysis_codeSelect,charge_itemSelect,dept_codeSelect,consum_codeSelect;
	$(function () {
		loadDict();
	    initGrid();
	})
    function query() {
        params = [
                  ...
                  { name: 'consum_code', value: consum_codeSelect.getValue() },
        ];
	...
	function initGrid() {
            ...
            var paramObj = {
            	...
            	editable:false,
                dataModel: {
                    url: 'queryAssEqUseConsItemDetail.do' //queryAssEqUseConsItem.do
                },
                columns: columns,
                toolbar: {
                    items: [
