...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAccBankTell.do",formPara,function(responseData){
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
           ...
           <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="summary" type="text" id="summary" ltype="text" validate="{maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
             <tr>
