...
<script type="text/javascript">
    ...
    function  query(){
		...
		grid.options.parms.push({name : 'charge_type_code',value : liger.get("charge_type_code_search").getValue()});
    ...
    function loadHead(){
		grid = $("#maingrid").ligerGrid({
			columns : [
					{display : '病人类别编码',name : 'charge_type_code',width: 100,align : 'left',
						render: function (item) {
							
	                        return "<a onClick=openUpdate('"+item.charge_type_code+"') >"+item.charge_type_code+"</a>";
	                        
	                    }
					}, 
					{display : '病人类别名称',name : 'charge_type_name',width: 250,align : 'left'},
			...
			dataAction : 'server',dataType : 'server',usePager : true,url : 'queryAccChargeType.do',
    ...
    function openUpdate(obj){
    	...
    	var formPara = {
    			...
    			charge_type_code : obj

		};
		
		ajaxJsonObjectByUrl("updateAccChargeTypePage.do?isCheck=false", formPara, function(responseData) {

			$("#charge_type_code").val(responseData.charge_type_code);$("#charge_type_code").ligerTextBox({disabled: true});
			
			$("#charge_type_name").val(responseData.charge_type_name);
    ...
    function loadDict(){
    	...
    	autocomplete("#charge_type_code_search","../../queryAccChargeType.do?isCheck=false","id","text",true,true,"",false,false,'180');
    	
    	$("#charge_type_code").ligerTextBox({width:180});
    	
    	$("#charge_type_name").ligerTextBox({width:180});
    ...
    function btnAdd(){
    	...
    	$("#charge_type_code").ligerTextBox({disabled: false});
    ...
    function btnDel(){
    	...
    	var charge_type_code = $("#charge_type_code").val();
		...
		ajaxJsonObjectByUrl("deleteAccChargeType.do", formPara, function(responseData) {
    ...
    function btnSave(){
    	...
    	var charge_type_name = $("#charge_type_name").val();
		...
		ajaxJsonObjectByUrl("addAccChargeType.do", formPara, function(responseData) {
...
<body style="padding: 0px; overflow: hidden;" >
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <td align="left" class="l-table-edit-td"><input name="charge_type_code_search" type="text" id="charge_type_code_search" ltype="text" /></td>
            <td align="left"></td>
        </tr> 
    </table>
    ...
    <div id="layout1">
            ...
            <div position="right" title="明细">
            	...
            	<table cellpadding="0" cellspacing="0" class="l-table-edit" >
			   		 <tr>
			            <td align="right" class="l-table-edit-td"  style="padding-left:20px;padding-top:20px;">  收费类别编码：</td>
			            <td align="left" class="l-table-edit-td" style="padding-top:20px;"><input name="charge_type_code" type="text" id="charge_type_code" ltype="text" validate="{required:true,maxlength:20}"/></td>
			            <td align="left"></td>
			        </tr> 
			        <tr>
			            <td align="right" class="l-table-edit-td"  style="padding-left:20px;padding-top:20px;"> 收费类别名称：</td>
			            <td align="left" class="l-table-edit-td" style="padding-top:20px;"><input name="charge_type_name" type="text" id="charge_type_name" ltype="text" validate="{required:true,maxlength:20}"/></td>
			            <td align="left"></td>
			        </tr>
			        <tr>
