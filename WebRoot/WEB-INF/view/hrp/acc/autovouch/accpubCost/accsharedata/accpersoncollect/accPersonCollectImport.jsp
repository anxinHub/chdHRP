...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(2, "250"); sheet.setText(0, 2, "科室人数");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importAccPersonCollect.do?isCheck=false", para, function(responseData){	
