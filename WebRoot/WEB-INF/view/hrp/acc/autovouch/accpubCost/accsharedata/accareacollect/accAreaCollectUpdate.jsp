...
<script type="text/javascript">
     ...
     function loadTotal(){
    	 ...
    	 ajaxJsonObjectByUrl("queryTotalArea.do?isCheck=false", formPara ,function(responseData){
             ...
             if(responseData.state=="true"){
 				 ...
 				 var percent = ((${dept_area}*1)/(totalNum*1)*100).toFixed(2);
 				 $("#total").val(totalNum);
 				 $("#percent").val(percent);
             }else{
     ...
     function num(obj){
   		 ...
   		 if (reg.test(obj.value) == false){//判断输入字符是否为数字
   			 ...
   			 total = (totalNum*1) - (${dept_area}*1) + (obj.value*1);
   		 ...
   		 if($("#dept_count").val()==""){
   			$("#total").val((totalNum*1) - (${dept_area}*1));
   			$("#percent").val('');
   		 }
   	 }
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("updateAccAreaCollect.do?isCheck=false",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1">
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="dept_count" type="text" id="dept_count" ltype="text" value="${dept_area}" onkeyup="num(this)" validate="{required:true}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
