...
var my_box=dialog.get("data").my_box;
    $(function (){
    	loadCenterTool();
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "250"); sheet.setText(0, 0, "科室名称或科室编码");
    	sheet.setColumnWidth(1, "250"); sheet.setText(0, 1, "分摊金额");
    ...
    function mySave(){
    	...
    	if(!(sheet.getText(0,0) == "科室名称或科室编码" || sheet.getText(0,0) == "科室名称" || sheet.getText(0,0) == "科室编码")){
    	...
    	ajaxJsonObjectBylayer("importAccPubCostRegDept.do?isCheck=false", para, function(responseData){	
    		...
    		if(row != null){
    	 	...
    	 	if(responseData.state == "false" ){
    			...
    			grid.reload();
    			my_box.setValue(responseData.ft_my);
    			myClose();
    		} 
