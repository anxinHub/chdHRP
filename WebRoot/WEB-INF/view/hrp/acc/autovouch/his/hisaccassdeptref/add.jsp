...
var dialog = frameElement.dialog; //调用页面的dialog对象(ligerui对象)
	...
	function loadHead() {
		...
		grid = $("#maingrid").ligerGrid({
					columns : [
							{ display: 'HRP科室编码', name: 'dept_code', align: 'left'},
		                    { display: 'HRP科室名称', name: 'dept_name', align: 'left'
							 }
							],
						dataAction : 'server',dataType : 'server',usePager : false,url : '../../../../sys/deptdict/queryDeptDict.do?isCheck=false',parms:parms,
	...
	function saveAccAssDeptRef(obj){
        ...
        if (data.length == 0){
            ...
            ajaxJsonObjectByUrl("addHisAccAssDeptRef.do",{ParamVo : ParamVo.toString()},function (responseData){
	...
	function loadDict(){
		autocomplete("#type_code","../../../queryHosDept.do?isCheck=false","id","text",true,true);
