...
var rightSum = 0;
	$(function() {
		...
		loadHead();
		query();
		$("#proj_code").ligerGetTextBoxManager().setDisabled();
	});
	...
	function save(){
		...
		ajaxJsonObjectByUrl("updateAccCooProj.do?isCheck=false",para,function(responseData){
...
<body style="padding: 0px; overflow: hidden;">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit">
		<tr>
			...
			<td align="left" class="l-table-edit-td"><input id="proj_code" name="proj_code" value="${proj_code}"/></td>	

			<td align="right" class="l-table-edit-td"><strong style="color: red;">*</strong>项目名称：</td>
			<td align="left" class="l-table-edit-td"><input id="proj_name" name="proj_name" value="${proj_name}"/></td>	
		...
		<tr>
			...
			<td align="left" class="l-table-edit-td" colspan="3"><input id="note" name="note" value="${note}"/></td>	
		</tr>
