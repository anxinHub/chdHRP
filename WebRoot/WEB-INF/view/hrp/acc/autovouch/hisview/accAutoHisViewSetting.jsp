...
<script type="text/javascript">
				...
				.ligerGrid(
						{
							columns : [
									...
									{display: 'HIS视图编码', name: 'his_log_code',id:'his_log_name', align: 'left',width: 200},
  									...
  									{ display: '默认天数', name: 'g_day', align: 'left',type: 'text',editor : {type : 'text'},width: 100, 
							...
							dataType : 'server',
							usePager : false,
							url : 'queryAutoHisViewSetting.do?isCheck=false',
							width : '100%',
							height : '95%',
							checkbox : false,
							rownumbers : false,
	...
	function save() {
		...
		$.ligerDialog.confirm('确定保存?', function(yes) {
			if (yes) {
				ajaxJsonObjectByUrl("updateAccAutoHisView.do?isCheck=false",
	...
	function onSave(rowindex,his_log_code){
	  	...
	  	var formPara = "his_log_code="+his_log_code;
	  	 $.ligerDialog.open({ 
			url : 'updateDatePage.do?isCheck=false&' + formPara,data:{}, 
	  		height: 300,width: 400, title:'取数时间', top: 100, 
	  		modal:true,showToggle:false,showMax:false,showMin: false,isResize:true,
			buttons: [
				{ text: '保存', onclick: function (item, dialog) {dialog.frame.saveAccAutoHisDate(); },cls:'l-dialog-btn-highlight' },
...
<body style="padding: 0px; overflow: hidden;">
	...
	<div style="width: 100%; height: 100%;">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2)、是否启用：如果不启用ETL将不会添加取数时间；默认天数：只能>=0，1代表ETL默认取昨天的数据，以此类推。<br/>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3)、设置取数时间：ETL下次执行时，读取数据会包含里面设置的时间，只会包含最近31天。
		</div>
		<br/>
		<div id="maingrid"></div>
