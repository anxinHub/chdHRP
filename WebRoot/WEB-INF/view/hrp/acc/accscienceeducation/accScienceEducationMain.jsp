...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccScienceEducation.do',
    ...
    function loadDict(){
    	...
    	$("#proj_id").ligerTextBox({width:235});
    ...
    function printDate(){
    	...
    	var heads={
     		...
     		var printPara={
     			...
     			class_name: "com.chd.hrp.acc.service.books.memorandumbook.AccScienceEducationService",
	  			method_name: "queryAccScienceEducationPrint",
	  			bean_name: "accScienceEducationService",
    ...
    function openUpdate(obj){
		...
		parent.$.ligerDialog.open({
			url: 'hrp/acc/accscienceeducation/accscienceeducationDataMiningPage.do?isCheck=false&'+parm, data: {parm:parm},
