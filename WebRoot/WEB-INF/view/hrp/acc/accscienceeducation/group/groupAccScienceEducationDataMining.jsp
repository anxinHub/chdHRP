...
<script type="text/javascript">
    ...
    function loadHead(){
        if(identification == "ScienceEducation_bal_sr" || identification == "ScienceEducation_bal_ot"){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccScienceEducationDataMining.do?isCheck=false&'+data,
                     width: '100%', height: '100%', checkbox: false,rownumbers:true,delayLoad:false,
                     selectRowButtonOnly:true,//heightDiff: -10,
                   });

        }else if(identification == "ScienceEducation_match_sr"){
         ...
         }else if(identification == "ScienceEducation_match_ot"){
