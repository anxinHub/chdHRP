...
<script type="text/javascript">
    ...
    if(identification=="ScienceEducation_total_sr"){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccScienceEducationDataMining.do?isCheck=false&'+data.replace("ScienceEducation_total_sr","ScienceEducation_bal_sr"),
    	   ...
    	   gridManager = $("#maingrid").ligerGetGridManager();
        	...
        	grid = $("#maingrid1").ligerGrid({
                columns: [ 
                          ...
                          dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccScienceEducationDataMining.do?isCheck=false&'+data.replace("ScienceEducation_total_sr","ScienceEducation_match_sr"),
                          width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
                          selectRowButtonOnly:true,//heightDiff: -10,
                        });

        	gridManager1 = $("#maingrid1").ligerGetGridManager();
    	 }else if(identification=="ScienceEducation_total_ot"){
    		 grid = $("#maingrid").ligerGrid({
    	           columns: [ 
    	                     { display: '凭证号', name: 'vouch_no', align: 'left',width:'10%',
    	                         render:function(rowdata){
    	                     ...
    	                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccScienceEducationDataMining.do?isCheck=false&'+data.replace("ScienceEducation_total_ot","ScienceEducation_bal_ot"),
    	                     width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
    	                     selectRowButtonOnly:true,//heightDiff: -10,
    	                   });
    	    	   ...
    	    	   grid = $("#maingrid1").ligerGrid({
    	                 columns: [ 
    	                           ...
    	                           dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccScienceEducationDataMining.do?isCheck=false&'+data.replace("ScienceEducation_total_ot","ScienceEducation_match_ot"),
    	                           width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
    	                           selectRowButtonOnly:true,//heightDiff: -10,
    	                         });
