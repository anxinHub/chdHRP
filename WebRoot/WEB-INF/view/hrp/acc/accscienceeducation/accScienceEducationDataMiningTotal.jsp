    ...
    if(identification=="ScienceEducation_total_sr"){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryAccScienceEducationDataMining.do?isCheck=false&'+data.replace("ScienceEducation_total_sr","ScienceEducation_bal_sr"),
    	   ...
    	   gridManager = $("#maingrid").ligerGetGridManager();
        	...
        	grid = $("#maingrid1").ligerGrid({
                columns: [ 
                          ...
                          dataAction: 'server',dataType: 'server',usePager:false,url:'queryAccScienceEducationDataMining.do?isCheck=false&'+data.replace("ScienceEducation_total_sr","ScienceEducation_match_sr"),
                          width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
                          selectRowButtonOnly:true,//heightDiff: -10,
                        });
        	...
        	gridManager1 = $("#maingrid1").ligerGetGridManager();
    		 ...
    		 grid = $("#maingrid").ligerGrid({
    	           columns: [ 
    	                     ...
    	                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryAccScienceEducationDataMining.do?isCheck=false&'+data.replace("ScienceEducation_total_ot","ScienceEducation_bal_ot"),
    	                     width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
    	                     selectRowButtonOnly:true,//heightDiff: -10,
    	                   });
    	    	   ...
    	    	   grid = $("#maingrid1").ligerGrid({
    	                 columns: [ 
    	                           ...
    	                           dataAction: 'server',dataType: 'server',usePager:false,url:'queryAccScienceEducationDataMining.do?isCheck=false&'+data.replace("ScienceEducation_total_ot","ScienceEducation_match_ot"),
    	                           width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
    	                           selectRowButtonOnly:true,//heightDiff: -10,
    	                         });
