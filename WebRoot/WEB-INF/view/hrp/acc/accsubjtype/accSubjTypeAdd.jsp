...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAccSubjType.do?isCheck=false",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='subj_type_code']").val('');
				
				 $("input[name='subj_type_name']").val('');
 ...
 function loadForm(){
    ...
    function loadDict(){
		//字典下拉框
    	autoCompleteByData("#kind_code", [{"id": "01", "text": "财务会计科目"}, {"id": "02", "text": "预算会计科目"}], "id", "text", true, true, "", true);
	} 
    </script>
