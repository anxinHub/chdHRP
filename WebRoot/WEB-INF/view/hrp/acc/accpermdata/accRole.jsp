...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '用户名称', name: 'role_name', align: 'left',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'../../sys/hosrole/queryHosRole.do',
    ...
    function loadDict(){
            //字典下拉框
    	autocomplete("#role_id","../../sys/queryRoleDict.do?isCheck=false","id","text",true,true);    
         }   
    </script>
