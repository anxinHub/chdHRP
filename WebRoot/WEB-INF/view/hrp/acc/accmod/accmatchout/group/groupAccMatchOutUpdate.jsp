...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("updateGroupAccMatchOut.do?isCheck=false",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	autocomplete("#proj_id","../../../sys/queryProjDictDict.do?isCheck=false","id","text",true,true,'',false,'${proj_id}.${proj_no}'); 
    	liger.get("proj_id").setValue("${proj_id}.${proj_no}");
        liger.get("proj_id").setText("${proj_code} ${proj_name}");
    	autocomplete("#subj_id","../../../querySubj.do?isCheck=false","id","text",true,true,'',false,'${subj_id}.${subj_code}');  
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="vouch_no" type="text" id="vouch_no"  ltype="text" value="${vouch_no}"  validate="{required:true,maxlength:20}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="business_no" type="text" id="business_no" ltype="text" value="${business_no}"  validate="{required:true,maxlength:20}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">科目：</td>
                <td align="left" class="l-table-edit-td"><input name="subj_id" type="text" id="subj_id" ltype="text" value="${subj_id}" validate="{required:true,maxlength:50}" /></td>
                <td align="left"></td>
            </tr> 
			<tr>
