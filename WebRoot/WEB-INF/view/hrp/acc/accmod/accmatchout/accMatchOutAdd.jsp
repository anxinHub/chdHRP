...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAccMatchOut.do?isCheck=false",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='proj_id']").val('');
				 $("input[name='con_emp_id']").val('');
 ...
 function loadForm(){
    ...
    function loadDict(){
    	autocomplete("#proj_id","../../../sys/queryProjDictDict.do?isCheck=false&attr_code="+'${attr_code}',"id","text",true,true,'',false,'','300');  
    ...
    function projChange(){
    	if(liger.get("proj_id").getValue() != null && liger.get("proj_id").getValue() != ''){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" style="margin-left:100px;margin-top:30px" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="vouch_no" type="text" id="vouch_no"  ltype="text" validate="{required:false,maxlength:20}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="business_no" type="text" id="business_no" ltype="text" validate="{required:false,maxlength:50}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">科&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;目：</td>
                <td align="left" class="l-table-edit-td"><input name="subj_code" type="text" id="subj_code" ltype="text" validate="{required:true,maxlength:1000}" /></td>
                <td align="left"></td>
            </tr> 
			<tr>
