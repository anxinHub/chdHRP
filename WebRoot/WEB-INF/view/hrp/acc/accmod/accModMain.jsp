           ...
           columns: [ 
                     ...
                     { display: '启用年度', name: 'modStart.start_year', align: 'center',
							render : function(rowdata, rowindex,
								...
								if(rowdata.modStart && rowdata.modStart.create_date){
                     ...
                     { display: '操作', name: 'modStart.create_user', align: 'center',
							render : function(rowdata, rowindex,
									value) {
								if(!rowdata.modStart || rowdata.modStart.create_date == null){
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMod.do',
		 ...
		 $.ligerDialog.confirm("启用模块："+mod_name +　"   启用时间:"+start_year　+ start_month+" 该操作不可逆转"　, '启用', function(flag){
				if(flag){
					var formPara = {
					 ...
					 ajaxJsonObjectByUrl("../accmodstart/addModStart.do",formPara,function(responseData){
