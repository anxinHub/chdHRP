...
var fma_en = dialog.get("data").fma_en;
var fma_cn = dialog.get("data").fma_cn;
var mainform=null;
...
var commJson=null;
    ...
    function loadTree(){
		...
		ajaxJsonObjectByUrl("../../acc/superReport/querySuperReportEleByMod.do?isCheck=false",para,function(responseData){	
    ...
    function myClick(){
    	...
    	ajaxJsonObjectByUrl("../superReport/querySuperReportParaByEle.do?isCheck=false",para,function(responseData){
    		...
    		if(obj.para_type==3 || obj.para_type==4){
    			...
    			fieldJosn.push({display:obj.para_name,name:obj.para_code,comboboxName: obj.para_code+"_name",type: "combobox",width:inputWidth,validate: {required:isRequired},
    				editor: {
    					...
    					url : "../superReport/querySuperReportParaSelectData.do?isCheck=false",
    					valueField : "id",
    					textField : "text",
