...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAccFundaAnalysis.do?isCheck=false",formPara,function(responseData){
        	if(responseData.state=="true"){
				 $("input[name='bas_code']").val('');
				 $("input[name='bas_name']").val('');
				 $("input[name='bas_unit']").val('');
				 $('#fma_cn').val('');
				 $('#fma_en').val('');
				 $('#note').val('');
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="bas_code" type="text" id="bas_code" ltype="text" maxlength="20" validate="{required:true}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="bas_name" type="text" id="bas_name" ltype="text" maxlength="50" validate="{required:true}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="bas_unit" type="text" id="bas_unit" ltype="text" maxlength="20" validate="{required:true}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="std_val" type="text" id="std_val" title="请填写数字" onkeyup="num(this)" size="10"
