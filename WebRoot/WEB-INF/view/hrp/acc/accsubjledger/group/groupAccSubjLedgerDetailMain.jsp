    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     { display: '期间',  align: 'center',columns:[{
                    	 ...
                    	 display: '日', name: 'acc_day', align: 'left',width:50,isSort:false
                     }]
					 },
					 { display: '凭证号', name: 'vouch_no', align: 'left',width:150,isSort:false,
						 render:function(rowdata, rowindex, value){
							 ...
							 if(value != null&&value.length>8){
						         ...
						         tempSet=value.substr(0,6)+"..." +value.substr(value.length-6,value.length);
								 
						         return "<span title="+value+">"+tempSet+"</span>";
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'collectGroupAccSubjLedgerDetail.do',
  ...
  //普通打印 
	function printDate(){//打印
		...
		var heads={
		  		  ...
		  		  "rows": [
			          {"cell":0,"value":"会计期间："+$("#acc_year_month1").val()+"至"+$("#acc_year_month2").val(),"colSpan":"9","align":"center"} ,
			         ...
			         {"cell":7,"value":"币种："+liger.get("cur_code").getText(),"colSpan":"2"} 
	   		...
	   		var printPara={
				...
				method_name: "collectGroupAccSubjLedgerDetailPrintDate",
  ...
  //模板打印
    function print_btn(){
    	...
    	var selPara={};
       	...
       	selPara["method_name"]="collectGroupAccSubjLedgerDetailPrint";
      ...
      /* 	var selPara={};
    	$.each(grid.options.parms,function(i,obj){
   		...
   		ajaxJsonObjectByUrl("collectAccSubjLedgerDetail.do?isCheck=false", selPara, function(responseData) {
	...
	function subjSelector() {
		$.ligerDialog.open({
					url : '../../groupbookselector/groupAccSubjSelectorPage.do?isCheck=false&flag=' + $("#subj_flag").val()+'&rela_code='+liger.get("rela_code").getValue(),
