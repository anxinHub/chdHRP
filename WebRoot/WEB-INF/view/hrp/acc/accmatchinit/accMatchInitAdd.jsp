...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAccMatchInit.do?isCheck=false&attr_code="+'${attr_code}',formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	autocomplete("#proj_id","../../sys/queryProjDictDict.do?isCheck=false&attr_code="+'${attr_code}',"id","text",true,true,'','','','300px');  
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="con_emp_id" type="text" id="con_emp_id" disabled="disabled" ltype="text" validate="{maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">申请科室：</td>
                <td align="left" class="l-table-edit-td">
                	<input name="dept_id" type="text" id="dept_id" ltype="text" validate="{maxlength:50}" disabled="disabled"/>
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
