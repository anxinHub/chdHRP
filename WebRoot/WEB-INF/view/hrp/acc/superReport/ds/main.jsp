...
var setting;
    ...
    function loadHead(){
        ...
        pGrid = $("#pGrid").ligerGrid({
            columns: [ 
				...
				{ display: '参数性质', name: 'para_tm', align: 'left', width: 100,
					 render : function(rowdata, rowindex,value) {
						 	if(value==1)
						 		return "模版参数";
						 	if(value==2)
    ...
    function columnAdd(){
    	...
    	parent.$.ligerDialog.open({url : 'hrp/acc/superReport/ds/paraSetPage.do?isCheck=false',
    		data:{}, height:300,width: 360, title:'数据集显示列设置',modal:true,showToggle:false,initShowMax:false,showMax:true,showMin: false,isResize:false,
