...
<script type="text/javascript">
     ...
     function  save(){
        ...
        var formPara={
        		income_no:liger.get("business_no").getValue(),
        		...
        		reply_no:$("#reply_no").val()==""?"—":$("#reply_no").val(),
                note:$("#note").val()==""?"—":$("#note").val(),
        		reply_money:$("#reply_money").val()
         };
        ajaxJsonObjectByUrl("updateAccMatchIncome.do?isCheck=false",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	autocompleteAsync("#proj_id","../../sys/queryProjDictDict.do?isCheck=false","id","text",true,true,'',false,'${proj_id}.${proj_no}');  
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" align="center" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<%-- <input class="Wdate" name="reply_date" type="text" id="reply_date" ltype="text" onFocus="year()"  value="${reply_date}" validate="{required:true,maxlength:20}" onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd'})"/> --%>
               <input name="reply_date" type="text" id="reply_date" value="${reply_date }" ltype="text" validate="{required:true,maxlength:20}" class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd'})"/>
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="business_no" type="text" id="business_no" disabled="disabled" ltype="text" value="${business_no}"  validate="{required:true,maxlength:20}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="reply_no" type="text" id="reply_no" ltype="text" value="${reply_no}" validate="{required:false,maxlength:20}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="note" type="text" id="note" ltype="text" value="${note}" validate="{required:false,maxlength:20}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">批复金额：</td>
                <td align="left" class="l-table-edit-td"><input name="reply_money" type="text" id="reply_money" value="${reply_money}" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
