...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAccMatchIncome.do?isCheck=false",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0"  style="margin-left:100px;margin-top:30px" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="reply_no" type="text" id="reply_no" ltype="text" validate="{required:false,maxlength:20}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="note" type="text" id="note" ltype="text" validate="{required:false,maxlength:20}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
