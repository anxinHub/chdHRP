...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAccVouchType.do?isCheck=false",formPara,function(responseData){
            ...
            if(responseData.state=="true"){
				 ...
				 $("input[name='vouch_type_name']").val('');
				 $("input[name='vouch_type_short']").val('');
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="vouch_type_short" type="text" id="vouch_type_short" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
