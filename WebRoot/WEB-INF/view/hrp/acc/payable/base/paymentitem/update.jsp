  ...
  <head>
   ...
   <script src="<%=path%>/lib/json2.js"></script>
    ...
    function loadDict(){
    	...
    	/* autocomplete("#acc_subj_manage","../../../querySubjDict.do?isCheck=false","id","text",true,true,'',false,'',444);
    	...
    	autocomplete("#acc_subj_medical","../../../querySubjDict.do?isCheck=false","id","text",true,true,'',false,'',444);
    	...
    	autocomplete("#acc_subj_education","../../../querySubjDict.do?isCheck=false","id","text",true,true,'',false,'',444);
    	...
    	autocomplete("#acc_subj_scientific","../../../querySubjDict.do?isCheck=false","id","text",true,true,'',false,'',444);
    	...
    	autocomplete("#acc_subj_financial","../../../querySubjDict.do?isCheck=false","id","text",true,true,'',false,'',444);
