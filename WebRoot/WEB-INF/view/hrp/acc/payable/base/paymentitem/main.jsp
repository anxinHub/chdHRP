...
<script type="text/javascript">
    ...
    function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryBudgPaymentItem.do',
                     width: '100%', height: '100%', checkbox: true,rownumbers:true,
                     selectRowButtonOnly:true,heightDiff: 28,
                     toolbar: { items: [
    	...
    	var data = gridManager.getCheckedRows();
                    if (data.length == 0){
                        ...
                        $(data).each(function (){					
							...
							this.payment_item_code + "@"+
							this.payment_item_name
							) });
    ...
    function imp(){
     	$.ligerDialog.open({
     		url: 'payMentItemImportPage.do?isCheck=false', 
