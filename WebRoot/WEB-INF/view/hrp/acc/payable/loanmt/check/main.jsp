...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '借款金额', name: 'borrow_amount', align: 'right', align: 'right',formatter:'###,##0.00',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryBudgBorrCheck.do',
    ...
    function openUpdate(obj){
    	...
    	parent.$.ligerDialog.open({
			...
			width: $(window).width(),
			url: 'hrp/acc/payable/loanmt/check/budgBorrApplyUpdatePage.do?isCheck=false&'+parm,
    ...
    function loadDict(){
    	...
    	autocomplete("#state","../../../queryBudgSysDict.do?isCheck=false&f_code=BORROW_STATE", "id","text", true, true,null,false,'02',"160");
    } 
    //键盘事件
