...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryBudgBorrProj.do',
	...
	function print(){
    	...
    	var printPara={
       			...
       			class_name: "com.chd.hrp.acc.service.payable.base.BudgBorrProjService",
    			method_name: "queryBudgBorrProjPrint",
    			bean_name: "budgBorrProjService"/* ,
