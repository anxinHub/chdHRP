...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
	        	     { display: '报销申请单号', name: 'apply_code', align: 'left',
                     ...
                     { display: '冲抵借款金额', name: '1', align: 'left',width:80
					 		},
                     { display: '实际支付金额', name: '2', align: 'left',width:80
					 		},
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryBudgPaymentApplyPay.do',
