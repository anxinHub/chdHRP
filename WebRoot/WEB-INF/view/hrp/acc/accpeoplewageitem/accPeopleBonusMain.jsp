...
<script type="text/javascript">
	...
	var note_columns = "<tr style='color:red;font-size:24px;'><td align='right' class='l-table-edit-td'  style='padding-left:25px;padding-top:10px;'>备注：</td><td colspan='16'><input class='inp' name='NOTE' type='text' id='NOTE' ltype='text' disabled='disabled' style='width: 1000px' /></td></tr>";
	...
	ajaxJsonObjectByUrl("../accwagepay/queryAccWagePayGrid.do?isCheck=false",{wage_code:liger.get("wage_code").getValue(),acc_year:liger.get("acc_time").getValue().split(".")[0]},function(responseData){
			...
			$.each(responseData.Rows,function(index,value){
				...
				if(value.ITEM_NATURE=='06'){
					...
					if(value.ITEM_TYPE=='01'){
						...
						jbgz_columns = jbgz_columns +"<td align='right' class='l-table-edit-td'  style='padding-left:25px;padding-top:10px;'>"+value.ITEM_NAME+"：</td>"
	...
	function btn_query(){
    	...
    	var formPara={
        		...
        		acc_year:liger.get("acc_time").getValue(),
    ...
    function loadDict(){
       ...
       var fromData={
		...
		autocompleteObj({
    		id:"#acc_time",
    		urlStr:"../queryYearMonth.do?isCheck=false",
    		valueField:"id",
    		textField:"text",
    		autocomplete:true,
    		highLight:true,
		...
		autocompleteObj({
    		id:"#wage_code",
    		urlStr:"../queryAccWage.do?isCheck=false&is_read=1",
    		valueField:"id",
    		textField:"text",
    		autocomplete:true,
    		highLight:true,
...
<body style="padding: 0px; overflow: hidden;">
	...
	<div id="layout1">
            ...
            <div position="center"  title="  " style="height: 495px;overflow:auto">
