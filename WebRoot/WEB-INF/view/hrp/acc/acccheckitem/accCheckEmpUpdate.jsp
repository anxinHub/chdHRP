...
//         		is_buyer:$("#is_buyer").val(),  
 ...
 function loadForm(){
    ...
    function set(){
    	$.ligerDialog.open({ url : 'accCheckEmpSetPage.do?isCheck=false',data:{}, height: 400,width: 650, 
    ...
    function loadDict(){
    	...
    	autocomplete("#countries_code","../../sys/queryCountriesDict.do?isCheck=false","id","text",true,true,'',false,'${countries_code }',200);
    	liger.get("countries_code").setValue("${countries_code}");
    	liger.get("countries_code").setText("${countries_name}");
    	autocomplete("#attr_code","../queryEmpSet.do?isCheck=false","id","text",true,true,'',true,'${attr_code}');
    	
    	
    	$("#countries_code").ligerTextBox({width:200});
    	...
    	$("#is_disable").ligerTextBox({width:180,disabled: true });
    	...
    	$("#attr_code").ligerTextBox({width:180});
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="is_disable" type="text"  id="is_disable" ltype="text" disabled="disabled" validate="{required:true,maxlength:20}" /></td>
                <td align="left" width="150"></td>
            ...
            <tr>
                ...
                <td align="left" width="150"></td>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">自定义属性：</td>
                <td align="left" class="l-table-edit-td"><input name="attr_code" type="text" onclick="attr();" id="attr_code" ltype="text"  validate="{required:false,maxlength:20}" /></td>
