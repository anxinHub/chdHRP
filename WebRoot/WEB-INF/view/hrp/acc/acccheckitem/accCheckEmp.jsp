...
<script type="text/javascript">
    ...
    function  query(){
    		...
    		grid.options.newPage=1;
    		 if(liger.get("is_disable").getValue()){
    	...
    	grid.options.parms.push({name:'is_disable',value:is_disable}); 
    	grid.options.parms.push({name:'is_pay',value:$("#is_pay").val()}); 
    	grid.options.parms.push({name:'id_number',value:$("#id_number").val()}); 
		grid.options.parms.push({name:'attr_code',value:liger.get("attr_code").getValue()});
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '自定义属性', name: 'attr_name', align: 'left'
					 },
    ...
    function openUpdate(obj){
		...
		parent.$.ligerDialog.open({ url : 'accCheckEmpUpdatePage.do?isCheck=false&' + parm,data:{}, height: 500,width: 930, 
	...
	var data = gridManager.getCheckedRows();
        ...
        parent.$.ligerDialog.open({ url : '../accempattr/initAccEmpAttrMainPage.do?isCheck=false&param='+ParamVo,
    		data:{}, height: 550,width: 700, title:'批量修改',modal:true,showToggle:false,showMax:false,
...
/* 
    ...
    function loadDict(){
    	...
    	autocomplete("#pay_type_code","../queryEmpPay.do?isCheck=false","id","text",true,true,'',false,'',120);
    	autocomplete("#dept_id","../../acc/queryHosDept.do?isCheck=false","id","text",true,true,'',false,'',120);
    	autocomplete("#attr_code","../queryEmpSet.do?isCheck=false","id","text",true,true,'',false,'',120);
    	$("#emp_code").ligerTextBox({width:120});
   		...
   		$("#dept_id").ligerTextBox({width:120});
   	 	$("#is_disable").ligerComboBox({width:120}); 
...
<body style="padding: 0px; overflow: hidden;">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        ...
        <tr>
            ...
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">职工属性：</td>
            <td align="left" class="l-table-edit-td"><input name="attr_code" type="text" id="attr_code" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td>
