...
//         		is_buyer:$("#is_buyer").val()
        ...
        ajaxJsonObjectByUrl("../accempattr/addAccEmpAttr.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
            	/**
				 $("input[name='sex']").val('');
				 $("input[name='is_pay']").val('');
 ...
 function loadForm(){
    ...
    function loadDict(){
		...
		autocomplete("#countries_code","../../sys/queryCountriesDict.do?isCheck=false","id","text",true,true,'',false,'',300);
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
               	 	<input name="pay_type_code" type="text"  id="pay_type_code" ltype="text"  validate="{required:false,maxlength:20}" />
                </td>
            	<td align="left"></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">岗位：</td>
                <td align="left" class="l-table-edit-td"><input name="station_code" type="text"  id="station_code" ltype="text"  validate="{required:false,maxlength:20}" /></td>
                <td align="left" width="150" width="150"></td>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">职务：</td>
                <td align="left" class="l-table-edit-td"><input name="duty_code" type="text"  id="duty_code" ltype="text" validate="{required:false,maxlength:20}" /> </td>
            	<td align="left"></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">身份证号：</td>
                <td align="left" class="l-table-edit-td"><input name="id_number" type="text"  id="id_number" ltype="text"  validate="{required:false,maxlength:20}" /></td>
                <td align="left" width="150"></td>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="countries_code" type="text" value="${countries_code }"   id="countries_code" ltype="text"  validate="{required:false,maxlength:20}" /></td>
                <td align="left" width="150"></td>
                <td align="left"></td>
                <td align="left"></td>
                <td align="left"></td>
