...
<script type="text/javascript">
     ...
     $(function (){
        ...
        liger.get("type_name").setValue('${type_code}');
		 liger.get("type_name").setText('${type_name}');
		 liger.get("dept_code").setValue('${dept_id}');
		 liger.get("dept_code").setText('${dept_name}');
		 liger.get("head_emp_code").setValue('${head_emp_id}');
		 liger.get("head_emp_code").setText('${head_emp_name}');
		 liger.get("acc_emp_code").setValue('${acc_emp_id}');
		 liger.get("acc_emp_code").setText('${acc_emp_name}');
		 liger.get("safe_emp_code").setValue('${safe_emp_id}');
		 liger.get("safe_emp_code").setText('${safe_emp_name}');
		 liger.get("proc_emp_code").setValue('${proc_emp_id}');
		 liger.get("proc_emp_code").setText('${proc_emp_name}');
     });  
     ...
     function  save(){
        ...
        var formPara={
           ...
           type_code:liger.get("type_name").getValue(),
        ...
        ajaxJsonObjectByUrl("../accstoreattr/updateAccStoreAttr.do",formPara,function(responseData){
 ...
 function loadForm(){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="type_name" type="text"  id="type_name" ltype="text" validate="{required:false,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                ...
                <select id="is_disable" name="is_disable" style="width: 135px;" disabled="disabled">
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="head_emp_code" type="text"  id="head_emp_code"   ltype="text" validate="{required:false,maxlength:20}" /></td>
                <td align="left" width="150"></td>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td" colspan="4"><input cols="60"  name="address" type="text" id="address" ltype="text"  value= "${address }"  validate="{required:false,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
