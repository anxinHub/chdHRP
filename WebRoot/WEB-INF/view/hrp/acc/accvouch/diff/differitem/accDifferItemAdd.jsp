...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAccDifferItem.do?isCheck=false",formPara,function(responseData){
            if(responseData.state=="true"){
				 $("input[name='diff_item_code']").val('');
				 $("input[name='diff_item_name']").val('');
				 $("input[name='diff_dire']").val('');
				 $("input[name='diff_obj']").val('');
