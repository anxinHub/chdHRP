...
<script type="text/javascript">	
    ...
    function loadHead(){
    	...
    	+"{ display: '凭证号', name: 'vouch_no', align: 'left',width:'10%',render:function(rowdata){if(rowdata.vouch_id != 0 && rowdata.vouch_id != null){return'<a href=javascript:openSuperVouch('+rowdata.vouch_id+')>'+rowdata.vouch_no+'</a>'}}},"
    	...
    	grid = $("#maingrid").ligerGrid({
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccCashJournal.do',
    ...
    function loadDict(){
            //字典下拉框
    	autocomplete("#subj_code","../querySubj.do?isCheck=false&subj_nature_code=02&is_last=1","id","text",true,true,'',true);
    	autocomplete("#other_subj_code","../querySubj.do?isCheck=false&is_last=1&extras=02","id","text",true,true);
...
<body style="padding: 0px; overflow: hidden;">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        ...
        <tr>
            <td align="right" class="l-table-edit-td"><font color="red" size="2">*</font>会计科目：</td>
            ...
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><font color="red" size="2">*</font>日期：</td>
            <td align="left" class="l-table-edit-td"><input class="Wdate" name="begin_date" type="text" id="begin_date" ltype="text" validate="{required:true,maxlength:20}" value="${begin_date}" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd',minDate:'${modStartTime}'})"/></td>
