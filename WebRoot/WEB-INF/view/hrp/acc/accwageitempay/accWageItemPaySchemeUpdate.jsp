...
<script type="text/javascript">
    ...
    $(function ()
    {
       ...
       function zTreeBeforeRename(treeId, treeNode, newName, isCancel) {
    	   ...
    	   $.post("../accwagepay/updateAccWageScheme.do",{scheme_id: treeNode.id,scheme_name:newName,group_id:treeNode.group_id,hos_id:treeNode.hos_id,copy_code:treeNode.copy_code},function (responseData){
       ...
       function zTreeOnCheck(event, treeId, treeNode){
    	   ...
    	   $("#listbox2").ligerListBox({
   			...
   			url : '../accwagepay/queryAccSchemeEmpKindList.do?isCheck=false',
    ...
    function save(){
    	...
    	var empData = liger.get("listbox2").getValue();
    	
    	var wageData = liger.get("listbox4").getValue();
    	
		if(empData.length<1){
    		
    		$.ligerDialog.error('请先选择职工分类');
    	...
    	$.post("../accwagepay/setAccWageSchemeRela.do?isCheck=false",{para: empData,paraValue:wageData,scheme_id:scheme_id},function (responseData){
   ...
   <div class="l-layout" id="layout1" style="height: 100%;" >
          ...
          <div position="center"  id="rightCheckTypeName">
	           <div title="" class="l-layout-content" style="width:100%; height: 100%;" position="center">
		           ...
		           <div class="l-layout-header">职工分类</div>
				         <div id="listbox1"></div>  
				   </div>
