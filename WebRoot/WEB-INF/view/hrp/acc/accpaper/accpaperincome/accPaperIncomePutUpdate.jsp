...
<script type="text/javascript">
	...
	function updatePut(str){
		str += "&"+$("#acc_paper_sf").serialize()
		ajaxJsonObjectByUrl("updatePutAccPaperIncome.do",str,function(responseData){
...
<table cellpadding="0" align="center" cellspacing="0" class="l-table-edit" >
        <tr>
         ...
         <tr>
        	<td align="right" class="l-table-edit-td"  style="padding-left:20px;">利息：</td>
            <td align="left" class="l-table-edit-td"><input class="l-table-edit-td" name="lx" placeholder="0.000.00" ltype="text"   /></td>
        </tr>
         <tr>
        	<td align="right" class="l-table-edit-td"  style="padding-left:20px;">费用：</td>
            <td align="left" class="l-table-edit-td"><input class="l-table-edit-td" name="fy" placeholder="0.000.00" ltype="text"   /></td>
        </tr>
         <tr>
        	<td align="right" class="l-table-edit-td"  style="padding-left:20px;">说明：</td>
            <td align="left" class="l-table-edit-td"><input class="l-table-edit-td" name="note" ltype="text"   /></td>
        </tr>
    </table>
</form>
</body>
