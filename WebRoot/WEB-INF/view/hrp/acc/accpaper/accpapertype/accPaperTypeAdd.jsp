...
var state =  [{ text: '否', id: '0' },{ text: '是', id: '1' }]
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAccPaperType.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='type_code']").val('');
				 $("input[name='type_name']").val('');
				 $("input[name='paper_prefix']").val('');
				 $("input[name='paper_clen']").val('');
				 $("input[name='paper_zlen']").val('');
                parent.query();
            }
        });
    }
 ...
 function loadForm(){
    ...
    function saveAccPayType(){
     ...
     function loadDict(){
         ...
         liger.get("paper_way_type").setValue("1");
 		 liger.get("paper_way_type").setText("单张管理");
         $("#paper_use_type").ligerComboBox({  
             data: paper_use_type
         }); 
         liger.get("paper_use_type").setValue("1");
 		 liger.get("paper_use_type").setText("一次领用");
         $("#is_sd").ligerComboBox({  
             data: state
         });
         liger.get("is_sd").setValue("0");
 		 liger.get("is_sd").setText("否");
         $("#is_auto").ligerComboBox({  
             data: state
         });
         liger.get("is_auto").setValue("0");
 		 liger.get("is_auto").setText("否");
         ...
         liger.get("is_wb").setValue("0");
 		 liger.get("is_wb").setText("否");
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><font color="red">*</font>类型名称：</td>
                <td align="left" class="l-table-edit-td"><input name="type_name" type="text" id="type_name" ltype="text" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">前缀：</td>
                <td align="left" class="l-table-edit-td"><input name="paper_prefix" type="text" id="paper_prefix" ltype="text" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><font color="red">*</font>票据号长度：</td>
                <td align="left" class="l-table-edit-td"><input name="paper_clen" type="text" id="paper_clen" ltype="text" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><font color="red">*</font>每本张数：</td>
                <td align="left" class="l-table-edit-td"><input name="paper_zlen" type="text" id="paper_zlen" ltype="text" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
