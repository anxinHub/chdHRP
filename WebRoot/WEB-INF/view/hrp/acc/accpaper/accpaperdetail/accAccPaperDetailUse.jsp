...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     { display: '核算日期', name: 'type_code', align: 'left',minWidth:90},
   	  				 { display: '业务类型', name: 'type_name', align: 'left',minWidth:130},
                     { display: '票据类型编码', name: 'paper_way_type', align: 'left'},
                     { display: '票据类型名称', name: 'paper_use_type', align: 'left'},
                     { display: '票据状态', name: 'begin_num', align: 'left'},
                     { display: '开始号码', name: 'begin_num', align: 'left'},
                     { display: '终止号码', name: 'end_num', align: 'left'},
                     { display: '作废号码', name: 'paper_num', align: 'left',minWidth:130}
                     ],
