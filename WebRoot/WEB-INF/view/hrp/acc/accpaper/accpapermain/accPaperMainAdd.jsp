...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAccPaperMain.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='begin_num']").val('');
				 $("input[name='end_num']").val('');
				 $("input[name='amount']").val('');
				 $("input[name='amoney']").val('');
				 $("input[name='note']").val('');
                parent.query();
            }
        });
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="opt_date" class="Wdate" id="opt_date" ltype="text" onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd'})" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">起始号码：</td>
                <td align="left" class="l-table-edit-td"><input name="begin_num" type="text" id="begin_num" ltype="text" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">终止号码：</td>
                <td align="left" class="l-table-edit-td"><input name="end_num" type="text" id="end_num" ltype="text" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
             <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">购置费用：</td>
                <td align="left" class="l-table-edit-td"><input name="amoney" type="text" id="amoney" ltype="text" validate="{required:true}"/></td>
                <td align="left"></td>
            </tr> 
              <tr>
