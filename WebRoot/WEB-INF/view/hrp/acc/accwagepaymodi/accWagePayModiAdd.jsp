...
<script type="text/javascript">
     ...
     function  save(){
        ...
        var formPara={
            ...
            item_code:liger.get("wage_item_code").getValue().split(".")[0],
        ...
        $.ligerDialog.confirm('确认对你查出的所有人进行工资变动吗？', function (yes){
        	...
        	if(yes){
        		ajaxJsonObjectByUrl("addAccWagePayModi.do?isCheck=false",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
            //字典下拉框
    	 autocomplete("#wage_item_code","../queryAccWageColumn.do?isCheck=false&is_stop=0","id","text",true,true);
    	...
    	var year_Month = '${wage_year_month}';
 	    ...
 	    liger.get("acc_year").setValue(year_Month.substring(0,4)+"."+year_Month.substring(4,6).toString());
 		 
     	liger.get("acc_year").setText(year_Month.substring(0,4)+"."+year_Month.substring(4,6).toString());
