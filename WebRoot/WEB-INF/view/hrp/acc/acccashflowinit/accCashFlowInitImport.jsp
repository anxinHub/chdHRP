...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAccCashFlowInitFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '年度', name: 'acc_year', align: 'left'},
				{ display: '科目ID', name: 'subj_id', align: 'left'},
				{ display: '现金流量项目ID', name: 'cash_item_id', align: 'left'},
				{ display: '金额', name: 'cash_money', align: 'right',
					render:function(rowdata, rowindex, value){
						return formatNumber(rowdata.cash_money, 2, 1);
					}
				},
				{ display: '备注', name: 'summary', align: 'left'},
