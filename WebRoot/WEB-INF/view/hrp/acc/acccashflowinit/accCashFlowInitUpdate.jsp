...
<script type="text/javascript">
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
			...
			url:"queryAccCashFlow.do?isCheck=false&vouch_detail_id=${vouch_detail_id}"
		});
	...
	function mySave(){
		...
		var formData="vouch_detail_id="+'${vouch_detail_id}'+"&para004="+$("#para004",parent.document).val()+"&cash_item_id="+ParamVo;
...
<body onload="is_addRow()">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit">
		<tr>
			...
			<td align="left">
				<input type="hidden" id="debit" value="${debit}"/>
