...
<script type="text/javascript">
    ...
    function loadTree(){
    	...
    	ajaxJsonObjectByUrl("querySubjBySelector.do?isCheck=false&sign="+sign,{'select_code':select_code,'queryTree':queryTree,'is_stop':'0','subj_level':subj_level},function (responseData){
