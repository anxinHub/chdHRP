...
<script type="text/javascript">
         			...
         			if(!value.isParent){
         				if(value.pId != 0){
                			...
                			if((index+1) == data.length){
                				...
                				param.id = value.subj_id+"."+value.name.toString().split(" ")[0];
                				param.text = value.name;
                				//param ="{id:" +value.subj_id+ "." +value.name.toString().split(" ")[0]+ ",text:" +value.name+ "},";
    ...
    function loadTree(){
    	...
    	ajaxJsonObjectByUrl("querySubjBySelector.do?isCheck=false",{'select_code':select_code,'queryTree':queryTree,'is_stop':'0','subj_level':subj_level},function (responseData){
