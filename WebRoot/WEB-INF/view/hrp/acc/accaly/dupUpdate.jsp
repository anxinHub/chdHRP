...
<script type="text/javascript">
     ...
     $(function (){
    	 ...
    	 //设置指标编码只读
    	 $("#dup_code").ligerGetTextBoxManager().setDisabled();
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("updateAccAlyDup.do?isCheck=false",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    $.metadata.setType("attr", "validate");
 	...
 	function loadDict() {
		...
		liger.get("is_stop").setValue("${dupMap.IS_STOP}");
  ...
  //自定义函数
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">杜邦分析指标编码:</td>
                <td align="left" class="l-table-edit-td">
                	<input name="dup_code" type="text" id="dup_code" ltype="text" value="${dupMap.DUP_CODE}" disabled="disabled" validate="{required:true}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">杜邦分析指标名称:</td>
                <td align="left" class="l-table-edit-td">
                	<input name="dup_name" type="text" id="dup_name" ltype="text" value="${dupMap.DUP_NAME}" maxlength="50" validate="{required:true}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="zb_unit" type="text" id="zb_unit" ltype="text" value="${dupMap.ZB_UNIT}" maxlength="20" validate="{required:true}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<textarea id="fma_en" name="fma_en" cols="100" rows="3" hidden=true>${dupMap.FMA_EN}</textarea>
                	<textarea name="fma_cn" id="fma_cn" validate="{required:true}" readonly disabled
                			style=" border: 1px solid #aecaf0;height: 100px;line-height: 15px;width: 400px;">${dupMap.FMA_CN}</textarea>
                </td>
                <td align="left">
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<textarea name="note" id="note" ltype="textarea" maxlength="100"
                			style=" border: 1px solid #aecaf0;height: 50px;line-height: 20px;width: 400px;background: #fff;">${dupMap.NOTE}</textarea>
                </td>
                <td align="left"></td>
            </tr>
            <tr>
