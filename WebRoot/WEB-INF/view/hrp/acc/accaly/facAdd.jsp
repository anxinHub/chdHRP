...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAccAlyFac.do?isCheck=false",formPara,function(responseData){
  ...
  //自定义函数
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">因素指标编码:</td>
                <td align="left" class="l-table-edit-td">
                	<input name="fac_code" type="text" id="fac_code" ltype="text" maxlength="20" validate="{required:true}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">因素指标名称:</td>
                <td align="left" class="l-table-edit-td">
                	<input name="fac_name" type="text" id="fac_name" ltype="text" maxlength="50" validate="{required:true}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
