...
<script type="text/javascript" src="<%=path %>/lib/Z-tree/js/jquery.ztree.exhide-3.5.js"></script>
<style type="text/css">
.ztree * {
font-size:16px;
line-height:20px
...
$(function ()
        { 
          ...
          if(check_nodes!="" && check_nodes != null){
            	...
            	for (var i=0, l=check_nodes.length; i < l; i++) {
            		...
            		//由于不知道check_nodes是干嘛用的，如果加上页面有错误
    ...
    function loadTree(){
    	...
    	ajaxJsonObjectByUrl("queryGroupSubjBySelector.do?isCheck=false&sign="+sign,{'select_code':select_code,'queryTree':queryTree,'is_stop':'0','subj_level':subj_level,'rela_code':'${rela_code}'},function (responseData){
