...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "100"); sheet.setText(0, 0, "职工编码");
    	sheet.setColumnWidth(1, "100"); sheet.setText(0, 1, "职工名称");
    	sheet.setColumnWidth(2, "250"); sheet.setText(0, 2, "账号名");
    	sheet.setColumnWidth(3, "250"); sheet.setText(0, 3, "身份证号");
    	sheet.setColumnWidth(4, "250"); sheet.setText(0, 4, "工资账号");
    	sheet.setColumnWidth(5, "250"); sheet.setText(0, 5, "账户类别名称");
    	sheet.setColumnWidth(6, "250"); sheet.setText(0, 6, "开户银行");
    	sheet.setColumnWidth(7, "250"); sheet.setText(0, 7, "银行地区");
    	sheet.setColumnWidth(8, "250"); sheet.setText(0, 8, "备注");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importAccEmpAccount.do?isCheck=false", para, function(responseData){	
