...
<script type="text/javascript">
    ...
    $(function (){
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("saveBatchAccTellVeri.do",formPara,function(responseData){
         	...
         	<table cellpadding="0" cellspacing="0" class="l-table-edit" >
	            ...
	            <tr>
	                ...
	                <td align="left" class="l-table-edit-td"  style="padding-top:10px;">
	                	<input  name="dire_money"  readonly="readonly" checked="checked" type="checkbox" id="dire_money"  />&nbsp;&nbsp;金额
	                </td>
	                <td align="left"></td>
	                <td align="left"></td>
	            </tr> 
