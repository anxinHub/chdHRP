...
<script type="text/javascript">
 ...
 function  formPara(subj_id){
	   var formPara={
	        ...
	        ajaxJsonObjectByUrl("addAccBankByAccount.do",formPara,function(responseData){
   ...
   <form name="form" method="post"  id="form" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
           ...
           <tr>
                ...
                <td align="left" class="l-table-edit-td"><input class="Wdate"   name="occur_date" type="text" id="occur_date" ltype="text" validate="{required:true,maxlength:20}" disabled="disabled" onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd',minDate:'${modStartTime}'})" />              
                </td>
                <td align="left"></td>
            </tr>
             <tr>
