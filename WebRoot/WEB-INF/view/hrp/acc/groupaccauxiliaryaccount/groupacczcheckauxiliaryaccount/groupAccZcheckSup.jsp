...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'../../sys/sup/querySup.do?isCheck=false',
    ...
    function loadDict(){
    	...
    	autocomplete("#sup_code","../../sys/querySupDict.do?isCheck=false","id","text",true,true);
