    ...
    function loadHead(){
    	 ...
    	 grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '余额', isSort:false, name: 'end_os', align: 'right',width: '10%',formatter:'###,##0.00',reg:'0=Q,0.00=Q',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'collectGroupAccZcheckGeneralLedger.do',
	...
	function printDate(){ 
		...
		var heads={
	   		...
	   		var printPara={
				...
				method_name: "collectGroupAccZcheckGeneralLedgerPrint",
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        ...
        <tr>
            ...
            <td align="right" class="l-table-edit-td" ><input id="acc_year_month2" name="acc_year_month2" /></td>
         	<td align="right" class="l-table-edit-td"  style="padding-left:70px;"><font size="2" color="red">*</font>核 算 类：</td>
            <td align="left" class="l-table-edit-td" ><input id="check_item_type" name="check_item_type" /></td> 
            <td align="right" class="l-table-edit-td"  style="padding-left:70px;">核 算 项：</td>
        ...
        <tr>
        	<td align="right" class="l-table-edit-td" style="padding-left:25px;">币&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;种：</td>
            ...
            <td align="left" class="l-table-edit-td" ><input class="l-button l-button-test"  type="button" value="选择" onclick="subjSelector()"/></td> 
            <td align="left" class="l-table-edit-td" ><input name="is_state" type="checkbox" id="is_state" checked="checked" />包含未记账</td>
            <td><input id="subj_text" name="subj_text" type="hidden" value=""/></td>
        </tr>
