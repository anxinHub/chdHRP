...
<script type="text/javascript">
    ...
    function  query(){
        ...
        //根据表字段进行添加查询条件
        grid.options.parms.push({name:'proj_id',value:liger.get("proj_code").getValue()}); 
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'../../sys/proj/queryProj.do?isCheck=false',
    ...
    function loadDict(){
    	...
    	autocomplete("#proj_code","../../sys/queryProjDict.do?isCheck=false","id","text",true,true);
