...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    function  query(){
    	...
    	if($("#is_end_os").attr("checked") == true){
    		is_end_os = 1;
    	}
    	...
    	if($("#cus_code").val() == ""){
	 		...
	 		grid.options.parms.push({name:'obj_code',value:$("#cus_code").val()}); 
    ...
    function loadHead(){
        ...
        grid = $("#maingrid").ligerGrid({
            columns: [ 
                      { display: '客户编码', isSort:false, name:'obj_code', align: 'left'},
                      
 					 { display: '客户名称', isSort:false, name: 'obj_name', align: 'left'},
 				...
 				dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccCusEndOs.do',
 ...
 function queryBtn(){//查询
	...
	function print(){//打印
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectGroupAccCusEndOsPrint",
	...
	function printDate(){//打印
		...
		selPara["template_code"]="01032";
	   	...
	   	selPara["method_name"]="collectGroupAccCusEndOsPrint";
    ...
    function loadDict(){
    	...
    	autocomplete("#acc_year_month2","../../queryYearMonth.do?isCheck=false","id","text",true,true,'',false,false,90);
		 ...
		 $("#cus_code").ligerTextBox({ width : 200 });
...
<input type="hidden" id="subj_query_code" name="subj_query_code"/>
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit"  border="0">
        ...
        <tr>
            ...
            <td align="right" class="l-table-edit-td"  ><input id="acc_year_month1" name="acc_year_month1" /></td>
            <td align="center" >-</td>
        ...
        <tr>
            ...
            <td align="right" class="l-table-edit-td" colspan="3" >
					...
					<input name="is_end_os" type="checkbox" id="is_end_os"  /> 显示有余额的客户
            </td>
        </tr>
	 <tr>
	 	 <td align="right" class="l-table-edit-td"   >客户：</td>
            <td align="left" class="l-table-edit-td" colspan="3"><input id="cus_code" name="cus_code" /></td>
	 </tr>
    </table>
	</form>
