    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccSubjCusDetailLedger.do',
...
function cusSelector(){
    	...
    	$.ligerDialog.open({ url : '../../groupbookselector/groupAccBookCusSelectorPage.do?isCheck=falseflag='+$("#flag").val()+'&rela_code='+liger.get("rela_code").getValue(),
...
function subjSelector(){
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectGroupAccSubjCusDetailLedgerPrint",
	...
	//打印维护
	function myPrintSet(){
		 officeFormTemplate({template_code:"01031"});
	}
    </script>
</head>
