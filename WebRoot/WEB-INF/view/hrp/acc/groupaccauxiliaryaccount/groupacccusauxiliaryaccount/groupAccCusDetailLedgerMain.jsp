    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'local',usePager:false,url:'queryGroupAccCusSubjDetailLedger.do',
...
function subjSelector(){
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectGroupAccCusSubjDetailLedgerPrint",
	...
	function printDate(){
		...
		selPara["template_code"]="01029";
	   	...
	   	selPara["method_name"]="collectGroupAccCusSubjDetailLedgerPrintDate";
