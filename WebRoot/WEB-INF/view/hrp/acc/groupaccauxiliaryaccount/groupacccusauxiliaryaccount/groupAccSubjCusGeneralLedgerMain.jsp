    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '凭证号', isSort:false, name: 'vouch_no', align: 'left', width: '10%'
					 },
					 { display: '客户', isSort:false, name: 'obj_name', align: 'left',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccSubjCusGeneralLedger.do',
...
function cusSelector(){
    	
    	$.ligerDialog.open({ url : '../../groupbookselector/groupAccBookCusSelectorPage.do?isCheck=false&flag='+$("#flag").val()+'&rela_code='+liger.get("rela_code").getValue(),
    			data:{listBoxData : obj_box_data}, height: 470,width: 480, title:'账簿客户选择器',modal:true,showToggle:false,showMax:false,showMin: false,isResize:true,
				buttons: [ 
 				           { text: '确定', onclick: 
 				        	   function (item, dialog) { 
	 				        	  ...
	 				        	  liger.get("cus_code").setValue(obj_param);
	 				        	       				              
	 				        	  liger.get("cus_code").setText(param);
	 				        	   dialog.close(); 
...
function subjSelector(){
	...
	$.ligerDialog.open({ url : '../../bookselector/accBookSubjSelectorPage.do?isCheck=false&flag='+$("#subj_flag").val()+'&sign=5'+'&rela_code='+liger.get("rela_code").getValue(),
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectGroupAccSubjCusGeneralLedgerPrint",
	...
	//打印维护
	 function myPrintSet(){
		 officeFormTemplate({template_code:"01030"});
	 }
    </script>
</head>
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit"  border="0">
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td" style="padding-left:20px;" colspan="3"><input id="cur_code" name="cur_code"  /></td>
             <td align="right" class="l-table-edit-td"  >客户：</td>
            <td align="left" class="l-table-edit-td" ><input id="cus_code" name="cus_code" /></td>
            <td>
            	<input class="l-button l-button-test"  type="button" value="选择" onclick="cusSelector();"/>
            </td>
