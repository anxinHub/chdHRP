    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccDeptSubjDetailLedger.do',
	...
	$.ligerDialog.open({ url : '../../groupbookselector/groupAccBookSubjSelectorPage.do?isCheck=false&flag='+$("#subj_flag").val()+'&sign=1'+'&rela_code='+liger.get("rela_code").getValue(),
		...
		function print(){
			...
			var heads={
			 		...
			 		var printPara={
						...
						method_name: "collectGroupAccDeptSubjDetailLedgerPrint",
		...
		function printDate(){
	    	...
	    	$.each(grid.options.parms,function(i,obj){
	       	...
	       	selPara["method_name"]="collectGroupAccDeptSubjDetailLedgerPrintDate";
