    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '部门', isSort:false, name: 'obj_name', align: 'left',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccSubjDeptGeneralLedger.do',
...
function deptSelector(){
    	...
    	$.ligerDialog.open({ url : '../../groupbookselector/groupAccBookDeptSelectorPage.do?isCheck=false&flag='+$("#flag").val()+'&rela_code='+liger.get("rela_code").getValue(),
    			data:{listBoxData : obj_box_data  
    			}, height: 470,width: 480, title:'账簿部门选择器',modal:true,showToggle:false,showMax:false,showMin: false,isResize:true,
				buttons: [ 
 				           { text: '确定', onclick: 
		...
		function print(){
			...
			var heads={
			 		...
			 		var printPara={
						...
						method_name: "collectGroupAccSubjDeptGeneralLedgerPrint",
		...
		function printDate(){
	    	...
	    	selPara["template_code"]="01010";
	       	...
	       	selPara["method_name"]="collectGroupAccSubjDeptGeneralLedgerPrintDate";
	   		...
	   		ajaxJsonObjectByUrl("queryAccSubjDeptGeneralLedger.do?isCheck=false", selPara, function(responseData) {
...
<input type="hidden" id="subj_query_code" name="subj_query_code"/>
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit"  border="0">
        ...
        <tr>
            ...
            <td>
            	<input class="l-button l-button-test" style="float: right;" type="button" value="选择" onclick="deptSelector();"/>
            </td>
