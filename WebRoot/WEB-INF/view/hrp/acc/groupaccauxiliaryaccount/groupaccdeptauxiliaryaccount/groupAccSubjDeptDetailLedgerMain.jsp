    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccSubjDeptDetailLedger.do',
...
function deptSelector(){
    	...
    	$.ligerDialog.open({ url : '../../groupbookselector/groupAccBookDeptSelectorPage.do?isCheck=false&flag='+$("#flag").val()+'&sign=1'+'&rela_code='+liger.get("rela_code").getValue(),
...
function subjSelector(){
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectGroupAccSubjDeptDetailLedgerPrint",
	...
	function printDate(){
		...
		selPara["template_code"]="01011";
	   	...
	   	officeTablePrint(selPara);
			...
			ajaxJsonObjectByUrl("queryAccSubjDeptDetailLedger.do?isCheck=false", selPara, function(responseData) {
	...
	//打印维护
	function myPrintSet(){
		 officeFormTemplate({template_code:"01011"});
	}
    </script>
</head>
