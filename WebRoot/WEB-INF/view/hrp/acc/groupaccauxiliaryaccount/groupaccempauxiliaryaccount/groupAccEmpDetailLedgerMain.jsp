    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccEmpSubjDetailLedger.do',
  ...
  //普通打印数据
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectGroupAccEmpSubjDetailLedgerPrint",
	...
	function printDate(){
		...
		$.each(grid.options.parms,function(i,obj){
	   	...
	   	selPara["method_name"]="collectGroupAccEmpSubjDetailLedgerPrintDate";
