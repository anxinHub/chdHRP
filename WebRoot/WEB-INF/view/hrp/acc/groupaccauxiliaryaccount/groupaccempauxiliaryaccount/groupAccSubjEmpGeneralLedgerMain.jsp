    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '职工', isSort:false, name: 'obj_name', align: 'left',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccSubjEmpGeneralLedger.do',
...
//普通打印数据
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectGroupAccSubjEmpGeneralLedgerPrint",
	...
	function myPrintSet(){
		 officeFormTemplate({template_code:"01015"});
	 }
    </script>
</head>
...
<input type="hidden" id="subj_query_code" name="subj_query_code"/>
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit"  border="0">
        ...
        <tr>
            ...
            <td align="right" class="l-table-edit-td"   >职工：</td>
            <td align="left" class="l-table-edit-td" ><input id="emp_code" name="emp_code" /></td>
            <td>
            ...
            <td align="right" class="l-table-edit-td"  ><input  style="display:none" name="is_happend" type="checkbox" id="is_happend"  /></td>
            <td align="left" class="l-table-edit-td" style="display:none">无发生不显示期初余额</td>
        </tr>
