...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    function  query(){
   	 ...
   	 if($("#emp_code").val() == ""){
		 ...
		 grid.options.parms.push({name:'obj_code',value : $("#emp_code").val()}); 
    ...
    function loadHead(){
        grid = $("#maingrid").ligerGrid({
            columns: [ 
                     { display: '职工编码', isSort:false, name:'obj_code', align: 'left'},
 					 { display: '职工名称', isSort:false, name: 'obj_name', align: 'left'
 					 },
 				...
 				dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccEmpEndOs.do',
  ...
  function queryBtn(){//查询
	...
	function print(){//打印
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectGroupAccEmpEndOsPrint",
	...
	//打印维护
	 function myPrintSet(){
		 officeFormTemplate({template_code:"01017"});
	 }

    function loadDict(){
    	 
		autocomplete("#acc_year_month1","../../queryYearMonth.do?isCheck=false","id","text",true,true,'',false,false,95);
    	
    	autocomplete("#acc_year_month2","../../queryYearMonth.do?isCheck=false","id","text",true,true,'',false,false,95);
    	 ...
    	 $("#emp_code").ligerTextBox({ width : 200 });
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit"  border="0">
        ...
        <tr>
            ...
            <td align="right" class="l-table-edit-td" colspan="2" >
	            ...
	            <input name="is_end_os" type="checkbox" id="is_end_os"  /> 显示有余额的职工
	        </td>
        </tr>
	 <tr>
	 	 <td align="right" class="l-table-edit-td"   >职工：</td>
            <td align="left" class="l-table-edit-td"  colspan="3"><input id="emp_code" name="emp_code" /></td>
	 </tr>
    </table>
	</form>
	<center><h2>职工余额表</h2></center>
	<div id="maingrid"></div>
</body>
</html>
