...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    function  query(){
    	...
    	if($("#store_code").val() == ""){
	 		...
	 		grid.options.parms.push({name:'obj_code',value:$("#store_code").val()}); 
    ...
    function loadHead(){
    	   ...
    	   grid = $("#maingrid").ligerGrid({
               columns: [ 
                         { display: '库房编码', isSort:false, name:'obj_code', align: 'left'},
                         
    					 { display: '库房名称', isSort:false, name: 'obj_name', align: 'left'
    				...
    				dataAction: 'server',dataType: 'server',usePager:false,url:'queryStoreEndOs.do',
 ...
 function queryBtn(){//查询
	...
	function print(){//打印
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectStoreEndOsPrint",
	...
	//打印维护
	 function myPrintSet(){
		 officeFormTemplate({template_code:"01037"});
	 }
    ...
    function loadDict(){
    	...
    	autocomplete("#acc_year_month2","../../queryYearMonth.do?isCheck=false","id","text",true,true,'',false,false,90);
    	 ...
    	 $("#subj_code").ligerComboBox({
 	      	url: '../../querySubjByAccount.do?isCheck=false&sign=4',
 	      	valueField: 'id',
 	       	textField: 'text', 
 	       	selectBoxWidth: 320,
 	      	autocomplete: true,
...
<input type="hidden" id="subj_query_code" name="subj_query_code"/>
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit"  border="0">
        ...
        <tr>
            ...
            <td align="right" class="l-table-edit-td"   >库房：</td>
            <td align="left" class="l-table-edit-td" ><input id="store_code" name="store_code" /></td> 
        ...
        <tr>
            ...
            <td align="right" class="l-table-edit-td" colspan="3" >
		            ...
		            <input name="is_end_os" type="checkbox" id="is_end_os"  /> 显示有余额的库房
            </td>
        </tr>
	 
    </table>
	</form>
	<center><h2>库房余额表</h2></center>
	<div id="maingrid"></div>
</body>
</html>
