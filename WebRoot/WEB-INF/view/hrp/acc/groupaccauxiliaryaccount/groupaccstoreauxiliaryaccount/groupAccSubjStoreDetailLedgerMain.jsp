    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryAccSubjStoreDetailLedger.do',
...
function subjSelector(){
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectAccSubjStoreDetailLedgerPrint",
	...
	//打印维护
	function myPrintSet(){
		 officeFormTemplate({template_code:"01036"});
	}
