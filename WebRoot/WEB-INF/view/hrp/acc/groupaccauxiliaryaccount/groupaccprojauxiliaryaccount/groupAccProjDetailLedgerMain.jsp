    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccProjSubjDetailLedger.do',
 ...
 function subjSelector(){
	...
	var heads={
	 		...
	 		var printPara={
				...
				method_name: "collectGroupAccProjSubjDetailLedgerPrint",
	...
	//打印维护
	 function myPrintSet(){
		 officeFormTemplate({template_code:"01019"});
	 }
    </script>
</head>
