    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '项目', isSort:false, name: 'obj_name', align: 'left',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccSubjProjGeneralLedger.do',
    	...
    	autocomplete("#acc_year_month2","../../queryYearMonth.do?isCheck=false","id","text",true,true,'',false,false,'90');
    	 ...
    	 autocompleteObj({
   			...
   			var	para = {
   		 		...
   		 		autocomplete("#proj_code","../../../sys/queryProjDictDictByRela.do?isCheck=false","id","text",true,true,para,true,false,'250');
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectGroupAccSubjProjGeneralLedgerPrint",
...
//模板打印数据
	...
	//打印维护
	 function myPrintSet(){
		 officeFormTemplate({template_code:"01020"});
	 }
    </script>
</head>
