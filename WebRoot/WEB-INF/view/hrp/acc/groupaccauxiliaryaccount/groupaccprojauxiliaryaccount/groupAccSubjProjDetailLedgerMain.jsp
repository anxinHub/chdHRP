    ...
    function  query(){
		...
		function loadHead() {
			grid = $("#maingrid").ligerGrid({
										...
										{display : '凭证号', isSort : false, name : 'vouch_no', align : 'left', width : '8%',
											render : function(rowdata, rowindex, value) {
												if (rowdata.vouch_no != null) {
													return "<a href=javascript:openSuperVouch('" + rowdata.vouch_id + "')><div>"
								...
								dataAction : 'server',dataType : 'server',usePager : false,url : 'queryGroupAccSubjProjDetailLedger.do',
		...
		function loadDict() {
			...
			$("#proj_code").ligerTextBox({ width : 250 }); 
		...
		function subjSelector() {
			...
			$.ligerDialog.open({
						url : '../../groupbookselector/groupAccBookSubjSelectorPage.do?isCheck=false&flag=' + $("#subj_flag").val() + '&sign=3'+'&rela_code='+liger.get("rela_code").getValue(),
						data : {
		...
		function print() {
			...
			var heads={
			 		...
			 		var printPara={
						...
						method_name: "collectGroupAccSubjProjDetailLedgerPrint",
		...
		//打印维护
		 function myPrintSet(){
			 officeFormTemplate({template_code:"01021"});
		 }
	</script>
</head>
