...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function  query(){
        ...
        if(liger.get("sup_code").getValue() == '' || liger.get("sup_code").getValue() == undefined){
		...
		if(sup_code.split(",").length>1){
			 if($("#flag").val() == "true"){
			 	grid.options.parms.push({name:'obj_code',value:sup_code}); 
        	...
        	if(sup_code==""){
        	 	...
        	 	grid.options.parms.push({name:'obj_code',value:sup_code.split(".")[2]}); 
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     { display: '期间', align: 'left',columns:[
            					        ...
            					        { display: '日', isSort:false, name: 'day', align: 'left', width: '4%'}
            						]
					 },
					 ...
					 { display: '供应商', isSort:false, name: 'obj_name', align: 'left',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccSupSubjDetailLedger.do',
    ...
    function loadDict(){
		...
		autocomplete("#acc_year_month1","../../queryYearMonth.do?isCheck=false","id","text",true,true,'',false,false,100);
    	
    	autocomplete("#acc_year_month2","../../queryYearMonth.do?isCheck=false","id","text",true,true,'',false,false,100);
    	 ...
    	 autocompleteObj({
   			...
   			var	para = {
   		 		...
   		 		autocomplete("#sup_code","../../../sys/querySupDictDictByRela.do?isCheck=false","id","text",true,true,para,true,false,'250');
   		    }
   		}); 
...
//普通打印数据
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectGroupAccSupSubjDetailLedgerPrint",
	...
	//打印维护
	 function myPrintSet(){
		 officeFormTemplate({template_code:"01024"});
	 }
    </script>
</head>
...
<input type="hidden" id="subj_query_code" name="subj_query_code"/>
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit"  border="0">
        ...
        <tr>
            <td align="left" style="padding-left:20px;"><font size="2" color="red">*</font>会计期间：</td>
            ...
            <td align="left" class="l-table-edit-td" ><font size="2" color="red">*</font>供应商：</td>
            <td align="left" class="l-table-edit-td" ><input id="sup_code" name="sup_code" /></td>
        </tr> 
        <tr>
        	<td align="right" class="l-table-edit-td"  style="padding-left:20px;">凭 证 号 ：</td> 
            <td align="left" class="l-table-edit-td" style="padding-left:20px;" ><input name="vouch_no_b" type="text" id="vouch_no_b" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="center"  >至</td>
            <td align="right" ><input name="vouch_no_e" type="text" id="vouch_no_e" ltype="text" validate="{required:true,maxlength:20}" /></td>
	 ...
	 <tr>
        ...
        <td align="left" class="l-table-edit-td" colspan="5" style="padding-left:200px;" >
