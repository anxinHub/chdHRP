    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     { display: '期间', align: 'left',columns:[
             							{ display: '年', name: 'acc_year', align: 'left', width: '4%'},
            					        { display: '月', name: 'acc_month', align: 'left', width: '4%'}
            						]
					 },
					 
					 { display: '凭证号', name: 'vouch_no', align: 'left',width: '8%',
					 ...
					 { display: '摘要', name: 'summary', align: 'left',width: '20%'
					 },
					 { display: '借方', name: 'debit', align: 'right',width: '10%',formatter:'###,##0.00',
                    	 render : function(rowdata, rowindex, value) {
           					return formatNumber(rowdata.debit, 2, 1);
           				}
					 },
					 { display: '贷方', name: 'credit', align: 'right',width: '10%',formatter:'###,##0.00',
                    	 render : function(rowdata, rowindex, value) {
                     ...
                     { display: '余额', name: 'end_os', align: 'right',width: '10%',formatter:'###,##0.00',reg:'0.00=Q,0=Q',
                    	 render : function(rowdata, rowindex, value) {
                    		 if(rowdata.end_os==0)
                    			 return 'Q';
                    		 else
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccSupSubjGeneralLedger.do',
...
function subjSelector(){
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectGroupAccSupSubjGeneralLedgerPrint",
	...
	//打印维护
	 function myPrintSet(){
		 officeFormTemplate({template_code:"01023"});
	 }
    </script>
</head>
...
<input type="hidden" id="subj_query_code" name="subj_query_code"/>
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit"  border="0">
        ...
        <tr>
            ...
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;" ><font size="2" color="red">*</font>供应商：</td>
            <td align="left" class="l-table-edit-td" style="padding-left:20px;"><input id="sup_code" name="sup_code" /></td>
<!--             <td> -->
<!--             	<input class="l-button l-button-test" style="float: right;" type="button" value="选择" onclick="supSelector()"/> -->
<!--             </td> -->
