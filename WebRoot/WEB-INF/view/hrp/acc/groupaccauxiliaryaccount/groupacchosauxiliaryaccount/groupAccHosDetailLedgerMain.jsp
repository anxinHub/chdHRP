    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccHosSubjDetailLedger.do',
...
function print(){
	...
	var heads={
	 		...
	 		var printPara={
				...
				method_name: "collectGroupAccHosSubjDetailLedgerPrint",
...
function printDate(){
	...
	var selPara={};
   	...
   	selPara["method_name"]="collectGroupAccHosSubjDetailLedgerPrintDate";
