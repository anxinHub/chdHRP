		...
		if(hos_code.split(",").length>1){
        	...
        	if(hos_code==""){
    			grid.options.parms.push({name:'obj_code',value:""}); 
    	 		...
    	 		grid.options.parms.push({name:'obj_code',value:hos_code }); 
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccSubjHosDetailLedger.do',
...
function print(){
	...
	var heads={
	 		...
	 		var printPara={
				...
				method_name: "collectGroupAccSubjHosDetailLedgerPrint",
...
function printDate(){
	...
	var selPara={};
   	...
   	selPara["method_name"]="collectGroupAccSubjHosDetailLedgerPrintDate";
