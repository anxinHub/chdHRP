...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    function  query(){
    	...
    	grid.options.parms.push({name:'hos_code',value:liger.get("hos_code").getValue()}); 
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccHosSubjGeneralLedger.do',
...
function hosSelector(){
    	
    	$.ligerDialog.open({ url : '../../bookselector/accBookHosSelectorPage.do?isCheck=false&listBoxData='+obj_box_data+'&flag='+$("#flag").val() ,data:{}, height: 470,width: 480, title:'账簿项目选择器',modal:true,showToggle:false,showMax:false,showMin: false,isResize:true,
				buttons: [ 
 				           { text: '确定', onclick: 
...
function print(){
	...
	var heads={
 		...
 		var printPara={
			...
			method_name: "collectGroupAccHosSubjGeneralLedgerPrint",
...
function printDate(){
	...
	var selPara={};
   	...
   	selPara["method_name"]="collectGroupHosSubjGeneralLedgerPrintDate";
...
<input type="hidden" id="subj_query_code" name="subj_query_code"/>
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit"  border="0">
        ...
        <tr>
            ...
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;" ><font size="2" color="red">*</font>单位：</td>
