...
<script type="text/javascript">
    ...
    $(function (){
        ...
        liger.get("bank_number").setValue('${bank_number}');
	    liger.get("bank_number").setText('${simple_name}');
	    if(${is_stop}==true){
    ...
    function save(){
    	var formPara={
    	           ...
    	           bank_number:liger.get("bank_number").getValue(),
    ...
    function loadDict(){
    	...
    	autocomplete("#bank_number","../queryBankSelect.do?isCheck=false","id","text",true,true,'',true,'','180');
   ...
   <form name="form1" method="post"  id="form1" >
         <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="type_code" type="text" id="type_code" value="${type_code }" ltype="text" disabled="disabled"/></td>
                <td align="left"></td>
            </tr> 
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="note" type="text" id="note" value="${note }" ltype="text" validate="{required:false,maxlength:50}" /></td>
                <td align="left"></td>
            </tr>
