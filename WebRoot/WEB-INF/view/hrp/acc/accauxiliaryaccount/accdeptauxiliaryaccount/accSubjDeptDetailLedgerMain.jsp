    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccSubjDeptDetailLedger.do',
    ...
    function loadDict(){
		...
		function print(){
			...
			var heads={
		 	...
		 	var printPara={
				...
				method_name: "collectAccSubjDeptDetailLedgerPrint",
		...
		function printDate(){
			...
			selPara["template_code"]="01011";
		   	...
		   	selPara["method_name"]="collectAccSubjDeptDetailLedgerPrintDate";
