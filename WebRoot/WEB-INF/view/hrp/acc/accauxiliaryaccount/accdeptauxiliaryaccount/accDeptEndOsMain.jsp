...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function loadHead(){
        grid = $("#maingrid").ligerGrid({
            columns: [ 
 				...
 				dataAction: 'server',dataType: 'server',usePager:true,url:'queryDeptEndOs.do',
 				pageSize: 100, pageSizeOptions:[100, 200, 500],
 				width: '100%', height: '98%', checkbox: false,rownumbers:true,delayLoad:true,selectRowButtonOnly:true,heightDiff: 25,
 				toolbar: { items: [
	...
	function print(){//打印
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectAccDeptBalancePrint",
	...
	function printDate(){//打印
    	...
    	$.each(grid.options.parms,function(i,obj){
       	...
       	selPara["method_name"]="collectAccDeptBalancePrintDate";
    ...
    function loadDict(){
    	autocomplete("#sch_id", "../queryAccBookSch.do?isCheck=false", "id", "text", true, true, ''); 
            ...
            <td align="left" class="l-table-edit-td"  colspan="3">
            	<table>
            		<tr>
            			...
            			<td>
	           				&nbsp;&nbsp;<input name="is_show" type="checkbox" id="is_show"  /> 显示有余额的部门
            			</td>
            		</tr>
            	</table>
            </td>
