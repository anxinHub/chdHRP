...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					...
					/*  { display: '凭证号', isSort:false, name: 'vouch_no', align: 'left', width: '8%'
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryDeptSubjGeneralLedger.do',
	...
	function print(){
		...
		var printPara={
			...
			method_name: "collectDeptSubjGeneralLedgerPrint",
	...
	function printDate(){
		...
		var selPara={};
       	...
       	selPara["method_name"]="collectDeptSubjGeneralLedgerPrintDate";
