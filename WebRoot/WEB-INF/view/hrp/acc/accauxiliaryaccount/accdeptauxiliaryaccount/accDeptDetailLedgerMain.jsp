    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccDeptSubjDetailLedger.do',
                     width: '100%', height: '98%', checkbox: false,rownumbers:true,
                     delayLoad:true,delayLoad:true, pageSize: 100, pageSizeOptions:[100, 200, 500],
    ...
    function openSuperVouch(vouch_id){
		...
		function print(){
			...
			var heads={
			 	...
			 	var printPara={
					...
					method_name: "collectAccDeptSubjDetailLedgerPrint",
		...
		function printDate(){
	    	...
	    	$.each(grid.options.parms,function(i,obj){
	   		...
	   		ajaxJsonObjectByUrl("queryAccDeptSubjDetailLedger.do?isCheck=false", selPara, function(responseData) {
		...
		//打印维护
		 function myPrintSet(){
			 officeFormTemplate({template_code:"01009"});
		 }
