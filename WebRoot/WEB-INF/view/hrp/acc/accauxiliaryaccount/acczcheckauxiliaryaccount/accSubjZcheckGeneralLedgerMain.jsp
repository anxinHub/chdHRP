...
<script type="text/javascript" src="<%=path%>/lib/hrp/acc/accBookZcheck.js"></script>
    ...
    function loadHead(){
		grid = $("#maingrid").ligerGrid({
			...
			dataAction:  'server',dataType:  'server',usePager: true,url: 'collectAccSubjZcheckGeneralLedger.do',
		 		...
		 		autocompleteObj({
					...
					selectEvent: function(value){
						...
						var param = {
				 		...
				 		autocomplete("#check_item_code1_b","../queryCheckItemByTypeFy.do?isCheck=false","id","text",true,true,param,false);
				 		autocomplete("#check_item_code1_e","../queryCheckItemByTypeFy.do?isCheck=false","id","text",true,true,param,false);
				    }
				});
		 		return paraDatil;
		    } */
 	...
 	function printDate(){
		...
		var heads={
   		...
   		var printPara={
			...
			method_name:  "collectAccSubjZcheckGeneralLedgerPrint",
