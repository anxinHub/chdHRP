...
<script type="text/javascript">
    ...
    $(function ()
    {
    	...
    	$("#cus_name").ligerTextBox({width:160});
    ...
    function  query(){
        ...
        //根据表字段进行添加查询条件
    	grid.options.parms.push({name:'cus_code',value:liger.get("cus_code").getValue()}); 
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'../../sys/cus/queryCus.do?isCheck=false',
