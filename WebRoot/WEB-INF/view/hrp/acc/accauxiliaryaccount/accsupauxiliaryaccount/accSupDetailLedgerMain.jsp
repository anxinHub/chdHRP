...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '供应商', isSort:false, name: 'check1_name', align: 'left', width: '20%',
							render : function(rowdata, rowindex,value) {
								return rowdata.check1_name;
							}
					 },
					 { display: '科目', isSort:false, name: 'subj_name', align: 'left',width: '10%',
							render : function(rowdata, rowindex,
									value) {
								return rowdata.subj_name;
							}
					 },
					 { display: '摘要', isSort:false, name: 'summary', align: 'left',width: '10%',
					 },
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccSupSubjDetailLedger.do',
    ...
    function loadDict(){
		...
		acc_year_month1 = $("#acc_year_month1").etDatepicker({
    	 ...
    	 autocomplete("#check_item_code1_b","../queryCheckItemByTypeFy.do?isCheck=false","id","text",true,true,{check_type_id:'${check_type_id}'},false,false,200);
       	autocomplete("#check_item_code1_e","../queryCheckItemByTypeFy.do?isCheck=false","id","text",true,true,{check_type_id:'${check_type_id}'},false,false,200);
     	
    	autocomplete("#sch_id", "../queryAccBookSch.do?isCheck=false", "id", "text", true, true, '', true,false) 
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectAccSupSubjDetailLedgerPrint",
	...
	function printDate(){
		...
		selPara["template_code"]="01024";
	   	...
	   	selPara["method_name"]="collectAccSupSubjDetailLedgerPrintDate";
...
<body style="padding: 0px; overflow: hidden;">
	...
	<form name="form1" method="post"  id="form1" >
    	<table cellpadding="0" cellspacing="0" class="l-table-edit"  border="0" >
	        <tr>
	            <td align="right" class="l-table-edit-td"><font size="2" color="red">*</font>会计期间：</td>
	            <td align="left" class="l-table-edit-td">
	            	<input id="acc_year_month1" name="acc_year_month1" style="width:200px" />
	            </td>
	            
	            <td align="left" class="l-table-edit-td">方&nbsp;&nbsp;案：</td> 
				<td align="left" class="l-table-edit-td">
					<table>
						<tr>
							<td>
		 	...
		 	<tr>
	           ...
	           <td align="left" class="l-table-edit-td"  style="padding-left:20px;">凭&nbsp;证&nbsp;号 ：</td> 
            	<td align="left" class="l-table-edit-td" colspan="2">
	            	<table>
						<tr>
							<td><input id="vouch_no_b" name="vouch_no_b"  /></td>
							<td align="left" class="l-table-edit-td">&nbsp;至：</td>
							<td><input id="vouch_no_e" name="vouch_no_e" /></td>
