...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccSubjSupGeneralLedger.do',
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectAccSubjSupGeneralLedgerPrint",
	...
	function printDate(){
		...
		selPara["template_code"]="01025";
	   	...
	   	selPara["method_name"]="collectAccSubjSupGeneralLedgerPrintDate";
