...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccSubjHosGeneralLedger.do',
		...
		if(grid.getData().length==0){
			...
			var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectAccSubjHosGeneralLedgerPrint",
	...
	function printDate(){
		...
		var selPara={};
	   	...
	   	selPara["method_name"]="collectAccSubjHosGeneralLedgerPrintDate";
