...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    function  query(){
        ...
        /* if(liger.get("hos_code").getValue() == '' || liger.get("hos_code").getValue() == undefined){
            	$.ligerDialog.error('单位为必填项');
            return ;
        } */ 
        //根据表字段进行添加查询条件
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '单位', isSort:false, name: 'check1_name', align: 'left' ,
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccHosSubjDetailLedger.do',
	...
	function print(){
		...
		var heads={
	 		...
	 		var printPara={
	 			...
	 			class_name: "com.chd.hrp.acc.service.books.auxiliaryaccount.AccHosAuxiliaryAccountService",
				method_name: "collectAccHosSubjDetailLedgerPrint",
				bean_name: "accHosAuxiliaryAccountService",
	...
	function printDate(){
		...
		var selPara={};
	   	...
	   	selPara["template_code"]="01039";
	   	selPara["class_name"]="com.chd.hrp.acc.service.books.auxiliaryaccount.AccHosAuxiliaryAccountService";
	   	selPara["method_name"]="collectAccHosSubjDetailLedgerPrintDate";
	   	selPara["bean_name"]="accHosAuxiliaryAccountService";
	   	if(year_month1!=""){
	...
	//打印维护
	function myPrintSet(){
	 	officeFormTemplate({template_code:"01039"});
	}
	//方案设置
	...
	<form name="form1" method="post"  id="form1" >
	    <table cellpadding="0" cellspacing="0" class="l-table-edit"  border="0" width="100%">
	        <tr>
		 	...
		 	<tr>
	            <td align="right" class="l-table-edit-td"  style="padding-left:20px;" >单&nbsp;&nbsp;位：</td>
	            <td align="left" class="l-table-edit-td" colspan="2" >
	            	<table>
						<tr>
