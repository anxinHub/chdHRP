...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryHosSubjGeneralLedger.do',
	...
	function print(){
		...
		var heads={
 		...
 		var printPara={
			...
			method_name: "collectHosSubjGeneralLedgerPrint",
	...
	function printDate(){
		...
		var selPara={};
	   	...
	   	selPara["method_name"]="collectHosSubjGeneralLedgerPrintDate";
