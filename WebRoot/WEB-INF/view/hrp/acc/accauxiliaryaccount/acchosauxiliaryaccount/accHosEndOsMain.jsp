    ...
    function loadHead(){
		...
		function print() {
			...
			var heads = {
				...
				"rows" : [ {"cell":0,"value":"会计期间："+year_month1[0]+"至"+year_month1[1],"colSpan":"5"}  ]
			};
			...
			var printPara = {
				...
				method_name : "collectHosEndOsPrint",
		...
		function printDate() {
			...
			var selPara={};
		   	...
		   	selPara["method_name"]="collectHosEndOsPrintDate";
            ...
            <td align="left" class="l-table-edit-td"  colspan="3">
            	<table>
            		<tr>
            			...
            			<td>
	           				&nbsp;&nbsp;<input name="is_show" type="checkbox" id="is_show"  /> 显示有余额的单位
            			</td>
            		</tr>
            	</table>
            </td>
