...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    function loadHead(){
    	   ...
    	   grid = $("#maingrid").ligerGrid({
               columns: [ 
    					 { display: '库房', isSort:false, name: 'check1_name', align: 'left'
    				...
    				dataAction: 'server',dataType: 'server',usePager:true,url:'queryStoreEndOs.do',
            ...
            <td align="left" class="l-table-edit-td"  colspan="3">
            	<table>
            		<tr>
            			...
            			<td>
	           				&nbsp;&nbsp;<input name="is_show" type="checkbox" id="is_show"  /> 显示有余额的库房
            			</td>
            		</tr>
            	</table>
            </td>
