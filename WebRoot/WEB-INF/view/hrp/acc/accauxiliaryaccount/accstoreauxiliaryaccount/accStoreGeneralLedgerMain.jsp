...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryStoreSubjGeneralLedger.do',
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectStoreSubjGeneralLedgerPrint",
	...
	//打印维护
	 function myPrintSet(){
		 officeFormTemplate({template_code:"01033"});
	 }
