...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '客户', isSort:false, name: 'check1_name', align: 'left',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccSubjCusGeneralLedger.do',
    ...
    function loadDict(){
    	...
    	//会计期间
    	 ...
    	 $("#subj_code").ligerComboBox({
    	      	url: '../querySubj.do?isCheck=false&sign=5',
    	      	valueField: 'id',
    	       	textField: 'text', 
    	       	selectBoxWidth: 200,
    	      	autocomplete: true,
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
		 			...
		 			class_name: "com.chd.hrp.acc.service.books.auxiliaryaccount.AccCusAuxiliaryAccountService",
					method_name: "collectAccSubjCusGeneralLedgerPrint",
					bean_name: "accCusAuxiliaryAccountService",
	...
	function printDate(){
		...
		selPara["template_code"]="01030";
	   	selPara["class_name"]="com.chd.hrp.acc.service.books.auxiliaryaccount.AccCusAuxiliaryAccountService";
	   	selPara["method_name"]="collectAccSubjCusGeneralLedgerPrintDate";
	   	selPara["bean_name"]="accCusAuxiliaryAccountService";
	   	if(year_month1!=""){
	...
	<form name="form1" method="post"  id="form1" >
	    <table cellpadding="0" cellspacing="0" class="l-table-edit"  border="0" width="100%">
	        <tr>
		 	...
		 	<tr>
	            <td align="right" class="l-table-edit-td"  style="padding-left:20px;" >客&nbsp;&nbsp;户：</td>
	            <td align="left" class="l-table-edit-td" colspan="2" >
	            	<table>
						<tr>
