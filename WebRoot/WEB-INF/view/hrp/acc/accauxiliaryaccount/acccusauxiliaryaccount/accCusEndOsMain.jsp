    ...
    function loadHead(){
        ...
        grid = $("#maingrid").ligerGrid({
            columns: [ 
 				...
 				dataAction: 'server',dataType: 'server',usePager:true,url:'queryCusEndOs.do',
...
{"cell":0,"value":"会计期间："+year_month1[0]+"至"+year_month1[1],"colSpan":"5"}  
		 		...
		 		var printPara={
					...
					method_name: "collectCusEndOsPrint",
	...
	//打印维护
	function myPrintSet(){
		 officeFormTemplate({template_code:"01032"});
	}
    ...
    function loadDict(){
    	...
    	autocomplete("#check_item_code1_b","../queryCheckItemByTypeFy.do?isCheck=false","id","text",true,true,{check_type_id:'${check_type_id}'});
    	 ...
    	 $("#subj_code").ligerComboBox({
 	      	url: '../querySubjByAccount.do?isCheck=false&sign=5',
 	      	valueField: 'id',
 	       	textField: 'text', 
 	       	selectBoxWidth: 320,
 	      	autocomplete: true,
...
function subjSelector(){
	...
	$.ligerDialog.open({ url : '../bookselector/accBookSubjSelectorPage.do?isCheck=false&flag='+$("#subj_flag").val()+'&sign=5' ,
            ...
            <td align="left" class="l-table-edit-td"  colspan="3">
            	<table>
            		<tr>
            			...
            			<td>
	           				&nbsp;&nbsp;<input name="is_show" type="checkbox" id="is_show"  /> 显示有余额的客户
            			</td>
            		</tr>
            	</table>
            </td>
