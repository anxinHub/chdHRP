...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccSubjCusDetailLedger.do',
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectAccSubjCusDetailLedgerPrint",
	...
	function printDate(){
		...
		selPara["template_code"]="01031";
	   	...
	   	selPara["method_name"]="collectAccSubjCusDetailLedgerPrint";
