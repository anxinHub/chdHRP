...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryProjSubjGeneralLedger.do',
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectProjSubjGeneralLedgerPrint",
	...
	function printDate(){
    	...
    	selPara["template_code"]="01018";
       	...
       	selPara["method_name"]="collectProjSubjGeneralLedgerPrintDate";
