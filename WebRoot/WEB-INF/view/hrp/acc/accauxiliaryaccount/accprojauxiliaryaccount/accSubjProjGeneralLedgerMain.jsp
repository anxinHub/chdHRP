...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '项目', isSort:false, name: 'check1_name', align: 'left',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccSubjProjGeneralLedger.do',
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectAccSubjProjGeneralLedgerPrint",
	...
	function printDate(){
    	...
    	selPara["template_code"]="01020";
       	...
       	selPara["method_name"]="collectAccSubjProjGeneralLedgerPrintDate";
