...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    function loadHead(){
        grid = $("#maingrid").ligerGrid({
            columns: [ 
 				...
 				dataAction: 'server',dataType: 'server',usePager:true,url:'queryEmpEndOs.do',
	...
	function print(){//打印
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectEmpEndOsPrint",
	...
	function printDate(){//打印
		...
		selPara["template_code"]="01017";
	   	...
	   	selPara["method_name"]="collectEmpEndOsPrintDate";
...
/* function empSelector(){
    	...
    	$.ligerDialog.open({ url : '../bookselector/accBookEmpSelectorPage.do?isCheck=false&listBoxData='+obj_box_data+'&flag='+$("#flag").val() ,data:{}, height: 470,width: 720, title:'账簿职工选择器',modal:true,showToggle:false,showMax:false,showMin: false,isResize:true,
				buttons: [ 
 				           { text: '确定', onclick: 
...
function subjSelector(){
	...
	$.ligerDialog.open({ url : '../bookselector/accBookSubjSelectorPage.do?isCheck=false&flag='+$("#subj_flag").val()+'&sign=2' ,
            ...
            <td align="left" class="l-table-edit-td"  colspan="3">
            	<table>
            		<tr>
            			...
            			<td>
	           				&nbsp;&nbsp;<input name="is_show" type="checkbox" id="is_show"  /> 显示有余额的职工
            			</td>
            		</tr>
            	</table>
            </td>
