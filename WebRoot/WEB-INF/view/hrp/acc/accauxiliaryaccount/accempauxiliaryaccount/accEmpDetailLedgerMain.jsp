...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '凭证号', isSort:false, name: 'vouch_no', align: 'left', width: '8%',
						 render : function(rowdata, rowindex, value) {
							 if(rowdata.vouch_no !=null){
								 return "<a href=javascript:openSuperVouch('"+rowdata.vouch_no.split('-')[1]+"')><div>"+rowdata.vouch_no.split('-')[0]+"-"+rowdata.vouch_no.split('-')[1]+"</div></a>"; 
							 }
						 }

					 },
					 { display: '职工', isSort:false, name: 'check1_name', align: 'left',
							render : function(rowdata, rowindex,value) {
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccEmpSubjDetailLedger.do',
    ...
    function loadDict(){
    	...
    	$("#subj_code").ligerComboBox({
    	      	url: '../querySubjByAccount.do?isCheck=false&sign=2',
    	      	valueField: 'id',
    	       	textField: 'text', 
    	       	selectBoxWidth: 200,
    	      	autocomplete: true,
    	...
    	autocomplete("#check_item_code1_b","../queryCheckItemByTypeByCode.do?isCheck=false","id","text",true,true,{check_type_id:'${check_type_id}'},false,false,180);
     	autocomplete("#check_item_code1_e","../queryCheckItemByTypeByCode.do?isCheck=false","id","text",true,true,{check_type_id:'${check_type_id}'},false,false,180);
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
		 			...
		 			class_name: "com.chd.hrp.acc.service.books.auxiliaryaccount.AccEmpAuxiliaryAccountService",
					method_name: "collectAccEmpSubjDetailLedgerPrint",
					bean_name: "accEmpAuxiliaryAccountService",
	...
	function printDate(){
		...
		$.each(grid.options.parms,function(i,obj){
	   	...
	   	selPara["template_code"]="01014";
	   	selPara["class_name"]="com.chd.hrp.acc.service.books.auxiliaryaccount.AccEmpAuxiliaryAccountService";
	   	selPara["method_name"]="collectAccEmpSubjDetailLedgerPrintDate";
	   	selPara["bean_name"]="accEmpAuxiliaryAccountService";
	   	if(year_month1!=""){
	...
	//打印维护
	 function myPrintSet(){
		 officeFormTemplate({template_code:"01014"});
	 }
