...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccSubjEmpGeneralLedger.do',
	...
	function print(){
		...
		var heads={
		 		...
		 		var printPara={
					...
					method_name: "collectAccSubjEmpGeneralLedgerPrint",
	...
	function printDate(){
		...
		selPara["template_code"]="01015";
	   	...
	   	selPara["method_name"]="collectAccSubjEmpGeneralLedgerPrintDate";
