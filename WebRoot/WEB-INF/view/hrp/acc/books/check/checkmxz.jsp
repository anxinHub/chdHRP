...
<style>
    ...
    var method_name = "collectAccBooksCheckPrintMXZ";
    var method_name_grid = "collectAccBooksCheckPrintGridMXZ";
    var checkType = "${type}";
		...
		<div id="floatQuery" >
    		<table cellpadding="0" cellspacing="0" class="l-table-edit"  >
				<tr>
					...
					<td id="sub_inp" align="left" class="l-table-edit-td"><input id="subj_kind" name="subj_kind" /></td>
		        ...
		        <tr>
		        	...
		        	<td align="right" class="l-table-edit-td" width="70px;"><span id="check_name1" >核算项1：</span></td>
		        	<td align="left" class="l-table-edit-td">
		            	<table>
							<tr>
