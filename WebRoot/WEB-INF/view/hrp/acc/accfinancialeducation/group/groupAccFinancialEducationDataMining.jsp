...
<script type="text/javascript">
    ...
    function loadHead(){
        if(identification == "financialeducation_bal_sr" || identification == "financialeducation_bal_ot"){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccFinancialEducationDataMining.do?isCheck=false&'+data,
                     width: '100%', height: '100%', checkbox: false,rownumbers:true,delayLoad:false,
                     selectRowButtonOnly:true,//heightDiff: -10,
                   });

        }else if(identification == "financialeducation_match_sr"){
         ...
         }else if(identification == "financialeducation_match_ot"){
