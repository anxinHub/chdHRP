    ...
    if(identification=="financialeducation_total_sr"){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccFinancialEducationDataMining.do?isCheck=false&'+data.replace("financialeducation_total_sr","financialeducation_bal_sr"),
    	   ...
    	   gridManager = $("#maingrid").ligerGetGridManager();
        	...
        	grid = $("#maingrid1").ligerGrid({
                columns: [ 
                          ...
                          dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccFinancialEducationDataMining.do?isCheck=false&'+data.replace("financialeducation_total_sr","financialeducation_match_sr"),
                          width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
                          selectRowButtonOnly:true,//heightDiff: -10,
                        });
        	...
        	gridManager1 = $("#maingrid1").ligerGetGridManager();
    		 ...
    		 grid = $("#maingrid").ligerGrid({
    	           columns: [ 
    	                     ...
    	                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccFinancialEducationDataMining.do?isCheck=false&'+data.replace("financialeducation_total_ot","financialeducation_bal_ot"),
    	                     width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
    	                     selectRowButtonOnly:true,//heightDiff: -10,
    	                   });
    	    	   ...
    	    	   grid = $("#maingrid1").ligerGrid({
    	                 columns: [ 
    	                           ...
    	                           dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccFinancialEducationDataMining.do?isCheck=false&'+data.replace("financialeducation_total_ot","financialeducation_match_ot"),
    	                           width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
    	                           selectRowButtonOnly:true,//heightDiff: -10,
    	                         });
