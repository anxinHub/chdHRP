...
<script type="text/javascript">
	...
	function  save(){
		...
		ajaxJsonObjectByUrl("queryAccBankNetPaymentPayNum.do?isCheck=false",formPara,function(responseData){
			...
			if (responseData.result_msg != "") {
				...
				ajaxJsonObjectByUrl("collectAccBankNetPayment.do",formPara,function(responseData){
