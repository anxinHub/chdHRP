...
<script type="text/javascript">
	...
	function pay(){
		...
		var para = "&payFlag=2"+"&group_id="+data[0].group_id+"&hos_id="+data[0].hos_id+"&copy_code="+data[0].copy_code+"&fseqno="+'${fseqno}'+"&acc_year="+'${acc_year}'+"&acc_month="+'${acc_month}'+"&paramVo="+ParamVo.toString();
