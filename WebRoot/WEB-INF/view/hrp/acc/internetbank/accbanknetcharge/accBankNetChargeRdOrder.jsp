...
<script type="text/javascript">
    ...
    function  query(){//根据表字段进行添加查询条件
		...
		grid.options.parms.push({name:'recaccnamecn',value:'${recaccnamecn}'});
    ...
    function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
			columns : [
					{display : '费用单号',name : 'ref',width: 140,align : 'left'},
					
					{ display: '收款单位/个人', name: 'recaccnamecn',width: 130, align: 'left'},
					...
					{display : '交易返回描述',name : 'iretmsg',width: 360,align : 'left'},
					],
					dataAction : 'server',dataType : 'server',usePager : true,url : 'queryAccBankNetChargeRd.do?isCheck=false',parms:para,pageSize:500,
	...
	function myPrint(){
    	...
    	var printPara={
        		...
        		method_name: "queryAccBankNetChargeRdPrint",
