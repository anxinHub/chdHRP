...
<script type="text/javascript">
	...
	function  save(){
		...
		//ajaxJsonObjectByUrl("queryAccBankNetChargeNum.do?isCheck=false",formPara,function(responseData){
		...
		//	}else{
				...
				ajaxJsonObjectByUrl("collectAccBankNetCharge.do",formPara,function(responseData){
