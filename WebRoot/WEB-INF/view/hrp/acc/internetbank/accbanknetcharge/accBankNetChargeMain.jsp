...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
	        	     { display: '申请单号', name: 'apply_code', align: 'left',width:130,
			 		 ...
			 		 { display: '申请日期', name: 'apply_date', align: 'left',width:180},	
                     ...
                     { display: '费用金额', name: 'payment_amount', align: 'right',width:80,
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccChargeApply.do',
	...
	function myPrint(){
    	...
    	if(grid.getData().length==0){
       	...
       	var printPara={
       		...
       		class_name: "com.chd.hrp.acc.service.InternetBank.AccBankNetChargeService",
    		method_name: "queryAccChargeApplyPrint",
    		bean_name: "accBankNetChargeService"
        ...
        if (data.length == 0){
        	...
        	$.ligerDialog.error('请选择行');
        	 ...
        	 $(data).each(function (){
				...
				ParamVo.push(this.apply_code+"@"+this.payment_amount+"@"+"null");
				
        	 })
        	 
        	 var paramVo = ParamVo.toString();	
        	 $.ligerDialog.open({url: 'collectAccBankNetChargePage.do?isCheck=false&payFlag=0&paramVo='+ParamVo,height: 450,width: 870,title:'补录网上银行信息',modal:true,showToggle:false,showMax:false,showMin: false,isResize:true,
 				/* buttons: [ 
