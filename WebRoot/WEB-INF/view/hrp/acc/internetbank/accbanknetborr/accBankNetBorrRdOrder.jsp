...
<script type="text/javascript">
    ...
    function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
			columns : [
					{display : '借款单号',name : 'ref',width: 140,align : 'left'},
					...
					dataAction : 'server',dataType : 'server',usePager : true,url : 'queryAccBankNetBorrRd.do?isCheck=false',parms:para,pageSize:500,
	...
	function myPrint(){
    	...
    	var printPara={
        		...
        		method_name: "queryAccBankNetBorrRdPrint",
