...
<script type="text/javascript">
    ...
    function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
			columns : [
					...
					dataAction : 'server',dataType : 'server',usePager : true,url : 'queryAccBankNetAssPay.do',pageSize:500,delayLoad:true,
		...
		if (data.length == 0){
			...
			var busi_no="";//生成凭证使用
        	 ...
        	 $.ligerDialog.confirm('确定更新指令状态?', function (yes){if(yes){
     			...
     			ajaxJsonObjectByUrl("updateAccBankNetAssPay.do?isCheck=false&ParamVo="+ParamVo.toString(),{}, function(responseData) {
	...
	function openUpdate(obj){
		...
		var parm = "erpsqn="+vo[0]   
			...
			+"&copy_code="+ vo[3]
			+"&acc_year="+ vo[4];
    	$.ligerDialog.open({ url : 'queryAccBankNetAssPayRdPage.do?isCheck=false&' + parm,data:{}, height: 520,width: 1180, title:'支付单明细',modal:true,showToggle:false,showMax:false,showMin: false,isResize:true});
