...
<script type="text/javascript">
	...
	function  save(){
		...
		ajaxJsonObjectByUrl("queryAccBankNetAssPayNum.do?isCheck=false",formPara,function(responseData){
			...
			if (responseData.result_msg != "") {
				...
				ajaxJsonObjectByUrl("collectAccBankNetAssPay.do",formPara,function(responseData){
