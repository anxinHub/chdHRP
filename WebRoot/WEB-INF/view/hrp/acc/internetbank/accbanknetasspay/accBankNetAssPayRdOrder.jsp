...
<script type="text/javascript">
    ...
    function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
			columns : [
					{display : '付款单号',name : 'erpsqn',width: 100,align : 'left'},
					...
					dataAction : 'server',dataType : 'server',usePager : true,url : 'queryAccBankNetAssPayRd.do?isCheck=false',parms:para,pageSize:500,
