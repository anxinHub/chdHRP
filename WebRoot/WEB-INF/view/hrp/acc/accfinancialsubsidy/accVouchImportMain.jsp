...
<script type="text/javascript">	
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccVouchImport.do',
    ...
    function save(){
    	...
    	if (data.length == 0){
            ...
            ajaxJsonObjectByUrl("addBatchAccItialExpend.do",{ParamVo : ParamVo},function (responseData){
