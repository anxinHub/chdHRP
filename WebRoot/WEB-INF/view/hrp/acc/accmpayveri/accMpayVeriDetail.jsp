    	...
    	if(direct=="0"){
    		grid = $("#maingrid").ligerGrid({
                columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccVerificationDetail.do?isCheck=false&veri_check_id='+veri_check_id+'&check_id='+check_id+'&check_type='+check_type+'&subj_dire=0'+'&subj_id='+subj_id+'&check_type_id='+check_type_id,
    		...
    		grid = $("#maingrid").ligerGrid({
                columns: [ 
                 ...
                 dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccVerificationDetail.do?isCheck=false&veri_check_id='+veri_check_id+'&check_id='+check_id+'&check_type='+check_type+'&subj_dire=1'+'&subj_id='+subj_id+'&check_type_id='+check_type_id,
                 width: '100%', height: '100%', checkbox: false,rownumbers:true,isSingleCheck :false,
                 selectRowButtonOnly:true
        	});
    	}
