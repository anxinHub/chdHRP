...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryGroupAccEducationBySplit.do',
    	...
    	var heads={
     		...
     		var printPara={
     			...
     			class_name: "com.chd.hrp.acc.service.books.memorandumbook.GroupAccEducationService",
	  			method_name: "queryGroupAccEducationBySplitPrint",
    ...
    function openUpdate(obj){
		...
		parent.$.ligerDialog.open({
			url: 'hrp/acc/acceducation/group/groupAcceducationDataMiningByDyPage.do?isCheck=false&'+parm, data: {parm:parm},
