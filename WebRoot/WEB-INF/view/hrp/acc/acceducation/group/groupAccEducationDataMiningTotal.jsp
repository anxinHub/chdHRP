...
<script type="text/javascript">
    ...
    if(identification=="Education_total_sr"){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccEducationDataMining.do?isCheck=false&'+data.replace("Education_total_sr","Education_bal_sr"),
    	   ...
    	   gridManager = $("#maingrid").ligerGetGridManager();
        	...
        	grid = $("#maingrid1").ligerGrid({
                columns: [ 
                          ...
                          dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccEducationDataMining.do?isCheck=false&'+data.replace("Education_total_sr","Education_match_sr"),
                          width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
                          selectRowButtonOnly:true,//heightDiff: -10,
                        });

        	gridManager1 = $("#maingrid1").ligerGetGridManager();
    	 }else if(identification=="Education_total_ot"){
    		 grid = $("#maingrid").ligerGrid({
    	           columns: [ 
    	                     { display: '凭证号', name: 'vouch_no', align: 'left',width:'10%',
    	                         render:function(rowdata){
    	                     ...
    	                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccEducationDataMining.do?isCheck=false&'+data.replace("Education_total_ot","Education_bal_ot"),
    	                     width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
    	                     selectRowButtonOnly:true,//heightDiff: -10,
    	                   });
    	    	   ...
    	    	   grid = $("#maingrid1").ligerGrid({
    	                 columns: [ 
    	                           ...
    	                           dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccEducationDataMining.do?isCheck=false&'+data.replace("Education_total_ot","Education_match_ot"),
    	                           width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
    	                           selectRowButtonOnly:true,//heightDiff: -10,
    	                         });

    	        	gridManager1 = $("#maingrid1").ligerGetGridManager();
        	 }else if(identification=="Education_total_sr_dy"){
        	    	grid = $("#maingrid").ligerGrid({
        	            columns: [ 
        	                      { display: '凭证号', name: 'vouch_no', align: 'left',width:'10%',
        	                          render:function(rowdata){
        	                      ...
        	                      dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccEducationDataMining.do?isCheck=false&'+data.replace("Education_total_sr_dy","Education_bal_sr"),
        	     	 ...
        	     	 }else if(identification=="Education_total_ot_dy"){
        	    		 grid = $("#maingrid").ligerGrid({
        	    	           columns: [ 
        	    	                     { display: '凭证号', name: 'vouch_no', align: 'left',width:'10%',
        	    	                         render:function(rowdata){
        	    	                     ...
        	    	                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryGroupAccEducationDataMining.do?isCheck=false&'+data.replace("Education_total_ot_dy","Education_bal_ot"),
        	    	                     width: '100%', height: '100%', checkbox: false,rownumbers:true,delayLoad:false,
        	    	                     selectRowButtonOnly:true,//heightDiff: -10,
        	    	                   });
