    ...
    if(identification=="Education_total_sr"){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryAccEducationDataMining.do?isCheck=false&'+data.replace("Education_total_sr","Education_bal_sr"),
    	   ...
    	   gridManager = $("#maingrid").ligerGetGridManager();
        	...
        	grid = $("#maingrid1").ligerGrid({
                columns: [ 
                          ...
                          dataAction: 'server',dataType: 'server',usePager:false,url:'queryAccEducationDataMining.do?isCheck=false&'+data.replace("Education_total_sr","Education_match_sr"),
                          width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
                          selectRowButtonOnly:true,//heightDiff: -10,
                        });
        	...
        	gridManager1 = $("#maingrid1").ligerGetGridManager();
    		 ...
    		 grid = $("#maingrid").ligerGrid({
    	           columns: [ 
    	                     ...
    	                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryAccEducationDataMining.do?isCheck=false&'+data.replace("Education_total_ot","Education_bal_ot"),
    	                     width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
    	                     selectRowButtonOnly:true,//heightDiff: -10,
    	                   });
    	    	   ...
    	    	   grid = $("#maingrid1").ligerGrid({
    	                 columns: [ 
    	                           ...
    	                           dataAction: 'server',dataType: 'server',usePager:false,url:'queryAccEducationDataMining.do?isCheck=false&'+data.replace("Education_total_ot","Education_match_ot"),
    	                           width: '100%', height: '50%', checkbox: false,rownumbers:true,delayLoad:false,
    	                           selectRowButtonOnly:true,//heightDiff: -10,
    	                         });
        	    	...
        	    	grid = $("#maingrid").ligerGrid({
        	            columns: [ 
        	                      ...
        	                      dataAction: 'server',dataType: 'server',usePager:false,url:'queryAccEducationDataMining.do?isCheck=false&'+data.replace("Education_total_sr_dy","Education_bal_sr"),
        	     	   ...
        	     	   gridManager = $("#maingrid").ligerGetGridManager();
        	    		 ...
        	    		 grid = $("#maingrid").ligerGrid({
        	    	           columns: [ 
        	    	                     ...
        	    	                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryAccEducationDataMining.do?isCheck=false&'+data.replace("Education_total_ot_dy","Education_bal_ot"),
        	    	                     width: '100%', height: '100%', checkbox: false,rownumbers:true,delayLoad:false,
        	    	                     selectRowButtonOnly:true,//heightDiff: -10,
        	    	                   });
