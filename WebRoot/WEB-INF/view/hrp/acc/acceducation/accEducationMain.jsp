...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAccEducation.do',
    	...
    	var heads={
     		...
     		var printPara={
     			...
     			class_name: "com.chd.hrp.acc.service.books.memorandumbook.AccEducationService",
	  			method_name: "queryAccEducationPrint",
    ...
    function openUpdate(obj){
		...
		parent.$.ligerDialog.open({
			url: 'hrp/acc/acceducation/acceducationDataMiningPage.do?isCheck=false&'+parm, data: {parm:parm},
