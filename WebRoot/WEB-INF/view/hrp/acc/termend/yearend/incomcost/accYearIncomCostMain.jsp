...
<script type="text/javascript">
	...
	$(function() {
		$("#layout1").ligerLayout({ leftWidth: 265, centerBottomHeight: $(window).height()-270});
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
			...
			usePager : false, url : 'queryAccYearIncomCost.do', checkbox : true, isSingleCheck: true,  
			...
			case "delete":
				...
				if (data.length == 0) {
					...
					$.ligerDialog.confirm('确定删除?', function(yes) {
						if (yes) {
							ajaxJsonObjectByUrl("deleteAccYearIncomCost.do", {
	...
	function setSubj(){
		...
		parent.$.ligerDialog.open({ 
			...
			url: 'hrp/acc/termend/accTermendTemplateSubjPage.do?isCheck=false&subj_type_code=03&subj_type_code1=08', 
	...
	function saveTemplate(){
		if($("form").valid()){
			...
			ajaxJsonObjectByUrl("saveAccYearIncomCost.do",formPara,function (responseData){
        		if(responseData.state=="true"){
	...
	function createVouch(){
		...
		$.ligerDialog.confirm('确定生成凭证?', function (yes){
	        if(yes){
	        		...
	        		ajaxJsonObjectBylayer("addAccYearIncomCostVouch.do",para,function(responseData){	
	        			...
	        			var paraVouch={
	        				...
	        				isShowMin:true,
	        				isModal:true,
	        				data:{auto_id:responseData.vouch_id, busi_log_table:'ACC_BUSI_LOG_ZZ', busi_type_code:'Z012',busi_no:para.template_id}
	        			};
	...
	function showVhouchList(){
		parent.$.ligerDialog.open({ 
			...
			url: 'hrp/acc/termend/accTermendTemplateVouchPage.do?isCheck=false&template_type_code=Z012&acc_year='+liger.get("acc_year_month").getValue().split(".")[0]+'&acc_month='+liger.get("acc_year_month").getValue().split(".")[1],
	...
	<div id="layout1" style="width:100%;margin:0; padding:0;">
		...
		<div position="center" title="模板信息">
			<table cellpadding="0" cellspacing="0" class="l-table-edit">
				<tr>
					...
					<td align="right" class="l-table-edit-td" style="padding-left: 20px;">
						<input type="button" id="but_add" accessKey="T"  value="收支结余(T)"/>
						&nbsp;&nbsp;
			...
			<form name="form1" method="post"  id="form1" >
				<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-left: 5px;">
					<tr>
						...
						<td align="left" class="l-table-edit-td" >
							<input name="template_id" type="hidden" id="template_id" ltype="text" value="${template_id }" validate="{required:false}" />
							<input name="template_name" type="text" id="template_name" ltype="text" required="true" validate="{required:true}" />
						</td>
				...
				<fieldset style="border: 1px solid #7d7474; width: 450px; margin-left: 5px; margin-top: 5px; padding: 5px 0;"> 
					<legend style="margin-left: 70px; padding: 0 5px;">财务会计</legend>
					<table cellpadding="0" cellspacing="0" class="l-table-edit" >
						<tr>
							<td align="right" class="l-table-edit-td" >
								<span style="color:red">*</span>结余科目：
							</td>
							<td align="left" colspan="3" class="l-table-edit-td" >
				...
				<fieldset style="border: 1px solid #7d7474; width: 450px; margin-left: 5px; margin-top: 10px; padding: 5px 0;">
