...
<script type="text/javascript">
	...
	function loadBody(){//加载body
		...
		autocompleteAsync("#set_code", "../../queryMedVirStoreByWrite.do?isCheck=false", "id", "text", true, true, "", true);
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
			columns : [ 
				{display : '仓库编码',name : 'store_code',align : 'left',width : '80'},
				...
				{display : '期初',
					columns : [
						{display : '数量',
							columns:[
								{display : '账表',name : 'begin_amount_rpt',align : 'right',width : '80'}, 
								{display : '计算',name : 'begin_amount_calc',align : 'right',width : '80'}
							]
						},
						{display : '金额',
							columns:[
								{display : '账表',name : 'begin_money_rpt',align : 'right',width : '100',
									render : function(rowdata, rowindex, value) {
										return formatNumber(rowdata.begin_money_rpt ==null ? 0 : rowdata.begin_money_rpt, '${p08005}', 1);
									}
								}, 
								{display : '计算',name : 'begin_money_calc',align : 'right',width : '100',
									render : function(rowdata, rowindex, value) {
				...
				{display : '本期增加',
					columns : [
						{display : '数量',
							columns:[
								{display : '账表',name : 'in_amount_rpt',align : 'right',width : '80'}, 
								{display : '计算',name : 'in_amount_calc',align : 'right',width : '80'}
							]
						},
						
						{display : '金额',
							columns:[
								{display : '账表',name : 'in_money_rpt',align : 'right',width : '100',
									render : function(rowdata, rowindex, value) {
										return formatNumber(rowdata.in_money_rpt ==null ? 0 : rowdata.in_money_rpt, '${p08005}', 1);
									}
								}, 
								{display : '计算',name : 'in_money_calc',align : 'right',width : '100',
									render : function(rowdata, rowindex, value) {
				...
				{display : '本期减少',
					columns : [
						{display : '数量',
							columns:[
								{display : '账表',name : 'out_amount_rpt',align : 'right',width : '80'}, 
								{display : '计算',name : 'out_amount_calc',align : 'right',width : '80'}
							]
						},
						{display : '金额',
							columns:[
								{display : '账表',name : 'out_money_rpt',align : 'right',width : '100',
									render : function(rowdata, rowindex, value) {
										return formatNumber(rowdata.out_money_rpt ==null ? 0 : rowdata.out_money_rpt, '${p08005}', 1);
									}
								}, 
								
								{display : '计算',name : 'out_money_calc',align : 'right',width : '100',
									render : function(rowdata, rowindex, value) {
				...
				{display : '期末',
					columns : [
						{display : '数量',
							columns:[
								{display : '账表',name : 'end_amount_rpt',align : 'right',width : '80'}, 
								{display : '计算',name : 'end_amount_calc',align : 'right',width : '80'}
							]
						},
						{display : '金额',
							columns:[
								{display : '账表',name : 'end_money_rpt',align : 'right',width : '100',
									render : function(rowdata, rowindex, value) {
										return formatNumber(rowdata.out_money_rpt ==null ? 0 : rowdata.out_money_rpt, '${p08005}', 1);
									}
								}, 
								{display : '计算',name : 'end_money_calc',align : 'right',width : '100',
									render : function(rowdata, rowindex, value) {
										return formatNumber(rowdata.out_money_calc ==null ? 0 : rowdata.out_money_calc, '${p08005}', 1);
									}
								}
			...
			],dataAction : 'server',dataType : 'server',usePager : true,url : 'queryMedFinalCheck.do',width : '100%',
			height : '90%',checkbox : false,rownumbers : false,delayLoad: true,selectRowButtonOnly : true,//heightDiff: -10,
		});
