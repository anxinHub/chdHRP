...
<script type="text/javascript">
	...
	function query() {
		...
		//grid.options.parms.push({name : 'med_type_id',value : liger.get("med_type_id").getValue() == null ? "" : liger.get("med_type_id").getValue().split(",")[0] });
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
		       columns: [ 
		                 ...
		                 url:'queryMedPurMainSafe.do?isCheck=false',
	...
	function loadDict() {
        ...
        autocomplete("#med_type_id","../../queryMedTypeDict.do?isCheck=false","id","text",true,true,"",true);//物资分类
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%" >
		<tr>
	        ...
	        <td align="left"></td>
           	...
           	<td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b><font color="red">*</font>物资分类:</b></td>
            <td align="left" class="l-table-edit-td">
