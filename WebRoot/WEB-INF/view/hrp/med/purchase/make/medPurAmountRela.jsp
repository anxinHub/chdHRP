...
<script type="text/javascript">
	...
	function loadHead(){
		grid = $("#maingrid").ligerGrid({
			...
			width: '100%', height: '97%', url: 'queryMedPurAmountRela.do?isCheck=false', 
		});
	...
	function save() {
		...
		$(relaData).each(function(d_index, d_content) {
			...
			if(this.pur_detail_id != undefined && this.pur_detail_id != '' && this.pur_detail_id != null){
				rows += 1;
				if (!this.pur_amount || parseFloat(this.pur_amount) < 0) {	
		...
		ajaxJsonObjectByUrl("updateMedPurAmountRela.do?isCheck=false", formPara, function(responseData) {
