    ...
    <script type="text/javascript">
     ...
     function  save(){
    	 ...
    	 if(validateGrid()){
             ...
             var pageTitle="订单修改";
             var saveUrl = "addMedOrderInitByPur.do?isCheck=false";;
             var pageUrl = "hrp/med/order/init/medOrderInitUpdatePage.do?isCheck=false";
    ...
    function loadHead() {
		...
		grid = $("#maingrid").ligerGrid({
			columns : [
				...
				},{display : '药品名称',name : 'inv_name',width : 150,align : 'left',
