    	 ...
    	 grid = $("#maingrid").ligerGrid({
             columns: [
					   ...
					   { display: '采购数量', name: 'pur_amount', align: 'right',minWidth : 120,
                         ...
                         url:'queryMedReqStoreMain.do?isCheck=false',
   ...
   //编辑之前
	...
	function addNew(){
		...
		if (data.length == 0){
			...
			ajaxJsonObjectByUrl("queryStoreCollectData.do?isCheck=false", formPara, function(responseData) {
				...
				var paras ="store_id="+liger.get("stock_id").getValue().split(",")[0] + 
					"&store_no="+liger.get("stock_id").getValue().split(",")[1] + 
					"&store_text="+liger.get("stock_id").getText()+"&is_dir="+is_dir+"&is_dept=0";	
		...
		function openUpdate(obj){
			$.ligerDialog.open({
				url : 'medStoreRequireDetail.do?isCheck=false&req_id='+obj,data:{}, height: 420,width: 950,top:1,
