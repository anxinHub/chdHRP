...
<script type="text/javascript">
	...
	function save() {
		var formPara = {
			...
			med_type_code : liger.get("med_type_id").getText().split(" ")[0],
			brif : $("#brif").val()//摘要
		};
		//console.log(formPara)
		ajaxJsonObjectByUrl("medPurPlanGenBySecuLimit.do?isCheck=false", formPara,
	...
	function loadDict() {
		...
		//autocomplete("#pur_hos_id","../../queryMedHosInfoDict.do?isCheck=false","id","text",true,true,"",false);//采购单位下拉框 
		//autocomplete("#req_hos_id","../../queryMedHosInfoDict.do?isCheck=false","id","text",true,true,"",false);//请购单位下拉框 
		//autocomplete("#pay_hos_id","../../queryMedHosInfoDict.do?isCheck=false","id","text",true,true,"",false);//付款单位下拉框 
		
		//autoCompleteByData("#is_dir", yes_or_no.Rows, "id", "text", true, true,'',false,false,'160');//是否定向
		//autocomplete("#dir_dept_id","../../queryMedDeptDictDate.do?isCheck=false","id","text",true,true,{is_last:'1',is_write:'1'},false,false,'160');//定向科室	
		
		autocomplete("#store_id","../../queryMedStore.do?isCheck=false","id","text",true,true,"",true);//仓库
        autocomplete("#med_type_id","../../queryMedTypeDict.do?isCheck=false","id","text",true,true,"",false);//物资分类
