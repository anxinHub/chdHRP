     ...
     function loadHead(){
    	 ...
    	 grid = $("#maingrid").ligerGrid({
             columns: [ 
                       ...
                       url:'queryMedPurMainDetail.do?isCheck=false&pur_id='+'${pur_id}',
                       isScroll : true,
		...
		var formPara = {
			...
			ajaxJsonObjectByUrl("updateMedPurMain.do", formPara, function(
					responseData) {
	 ...
	 function itemclick(item){ 
	                ...
	                case "check":
	                   var Param =[];
	                       ...
	                       $.ligerDialog.confirm('确定审核?', function (yes){
	                        	if(yes){
	                            	ajaxJsonObjectByUrl("checkMedPurMain.do?isCheck=false&paramVo="+Param,{},function (responseData){
	                            		if(responseData.state=="true"){
	                            			parent.query();
	                            		}
	                            	});
 	 ...
 	 function f_onSelectRow(data, rowindex, rowobj) {
		...
		function loadDict() {					
			...
			autocomplete("#req_hos_id","../../queryMedHosInfoDict.do?isCheck=false","id","text",true,true,"",true,false);//请购单位下拉框 
		...
		function printSet(){
			...
			parent.parent.$.ligerDialog.open({url : 'hrp/med/purchase/check/purMainCheckPrintSetPage.do?template_code=08027&use_id='+useId,
