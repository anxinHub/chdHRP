	...
	function f_onSelectRow_detail(data, rowindex, rowobj) {
 	 ...
 	 function f_onSelectRow(data, rowindex, rowobj) {
		...
		function save() {
			...
			ajaxJsonObjectByUrl("addOrUpdateMedPurMain.do", formPara,function(responseData) {
		...
		function openUpdate(obj){
			...
			$.ligerDialog.open({ url : 'medInvCurAmountDetailPage.do?isCheck=false&inv_id='+obj,data:{}, height: 480,width: 1100,top:1,title:'药品当前库存明细',modal:true,showToggle:false,showMax:true,showMin: false,isResize:true});
		...
		function openDetail(obj,rowindex){
			...
			$.ligerDialog.open({ url : 'medPurMainAmountDetailPage.do?isCheck=false&paraObj='+paraObj+'&rowindex='+rowindex,data:{}, height: 400,width: 1100,top:1,title:'采购计划数量明细',modal:true,showToggle:false,showMax:true,showMin: false,isResize:true,buttons: [ { text: '确认', onclick: function (item, dialog) { dialog.frame.saveMedPurMain(); },cls:'l-dialog-btn-highlight' }, { text: '取消', onclick: function (item, dialog) { dialog.close(); } } ]});
