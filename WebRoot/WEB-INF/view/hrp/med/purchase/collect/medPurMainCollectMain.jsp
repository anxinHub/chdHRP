...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     url:'queryMedPurMainCollect.do?isCheck=true',
    ...
    function collect(){
    	...
    	//alert(parm);
    	$.ligerDialog.open({
    		url: 'prodMedPurMainCollectPage.do?isCheck=false&'+parm,height: 500,top:1,width: 1100, 
    ...
    function openUpdate(obj){
		$.ligerDialog.open({ 
			url : 'medPurMainCollectDetailPage.do?isCheck=false&pur_id='+obj,data:{}, height: 480,width: 1100, top:1,
    ...
    //键盘事件
	 ...
	 function loadDict(){
        //字典下拉框
		autocomplete("#planState", "../../queryMedPlanState.do?isCheck=false", "id", "text", true, true,"",false,null,'160');//状态 下拉框		 
