...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedAccountBalanceVirStockInvBalance.do',
    ...
    function lodopPrint(){
    	var head="<table class='head' width='100%'><tr><td>单位：${sessionScope.hos_name}</td></tr>";
 		...
 		grid.options.lodop.title="库存药品收发账表(虚仓)";
    }
   ...
   /*  //键盘事件
	...
	function print(){
    	...
    	var colspan_num = grid.getColumns(1).length-1;
   		...
   		ajaxJsonObjectByUrl("queryMedAccountBalanceVirStockInvBalance.do?isCheck=false", selPara, function (responseData) {
