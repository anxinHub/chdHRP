    	...
    	grid = $("#maingrid").ligerGrid({
			columns: [{ 
				...
				display: '单价', name: 'price', align: 'left', width: 90,
		 		...
		 		render : function(rowdata, rowindex, value) {
		 			if(rowdata.sup_name == "合计" || rowdata.store_name == "供应商合计" || rowdata.inv_name == "药品小计" ){
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedAccountBalanceChargeInvCollectByHospital.do',
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%" style="padding: 10px" border="0">
		...
		<tr>
            ...
            <td id="inv_sup" align="left" class="l-table-edit-td">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    			<input type="radio" name="inv_sup" value="1" checked="checked" />药品供应商
			</td>
		</tr> 
	</table>
