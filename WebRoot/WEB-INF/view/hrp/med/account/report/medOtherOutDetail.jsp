...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedOtherOutDetail.do',
    ...
    function loadDict(){
		//字典下拉框
		autocompleteAsyncMulti("#bus_type_code", "../../queryMedBusType.do?isCheck=false", "id", "text", true, true,{codes : '9'},true, false, 180);
		autocomplete("#store_code", "../../queryMedStoreByRead.do?isCheck=false", "id", "text", true, true,"", false, false, 180);
		autocomplete("#dept_code", "../../queryMedDeptDict.do?isCheck=false", "id", "text", true, true,"", false, false, 180);
	...
	function print(){
    	...
    	var colspan_num = grid.getColumns(1).length-1;
    	 ...
    	 var printPara={
   		...
   		ajaxJsonObjectByUrl("queryMedOtherOutDetail.do?isCheck=false", selPara, function (responseData) {
