  ...
  <head>
	...
	function  save(){
		if($("form").valid()){
			...
			ajaxJsonObjectByUrl("updateMedShowSet.do", formPara, function(responseData){
	...
	function loadDict(){
		...
		//字典下拉框
		autoCompleteByData("#show_flag", yes_or_no.Rows, "id", "text", true, true, "", false, '${medShowSet.show_flag}');
		autoCompleteByData("#direction_flag", medShowSet_directionFlag.Rows, "id", "text", true, true, "", false, '${medShowSet.direction_flag}');
		//格式化按钮
				...
				<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
					<tr>
			            <td style="display: none;">
			            	<input name="group_id" type="text" id="group_id" value="${medShowSet.group_id}" ltype="text" />
			            	<input name="hos_id" type="text" id="hos_id" value="${medShowSet.hos_id}" ltype="text" />
			            	<input name="copy_code" type="text" id="copy_code" value="${medShowSet.copy_code}" ltype="text" />
			            	<input name="old_show_id" type="text" id="old_show_id" value="${medShowSet.show_id}" ltype="text" />
			            </td>
					</tr>
					<tr>
			            ...
			            <td align="left" class="l-table-edit-td" width="50%">
			            	<input name="show_id" type="text" id="show_id" value="${medShowSet.show_id}" ltype="text" required="true" validate="{required:true}" />
			            </td>
					</tr>
					<tr>
			            <td align="right" class="l-table-edit-td" width="30%">
			        ...
			        <tr>
			            ...
			            <td align="left" class="l-table-edit-td" width="50%">
			            	<input name="show_name" type="text" id="show_name" value="${medShowSet.show_name}" ltype="text" required="true" validate="{required:true}" />
			            </td>
					</tr>
					<tr>
