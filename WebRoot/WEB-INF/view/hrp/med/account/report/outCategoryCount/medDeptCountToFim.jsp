...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			columns: [],
			dataAction: 'server',dataType: 'server',usePager:false,url:'queryMedDeptCountToFim.do',width: '100%', height: '100%',rownumbers:true,
   ...
   /*  //键盘事件
    ...
    function loadDict(){
		...
		autocompleteAsyncMulti("#bus_type_code", "../../../queryMedBusType.do?isCheck=false", "id", "text", true, true,{codes :'3,21,49,50'},true,true,160);
