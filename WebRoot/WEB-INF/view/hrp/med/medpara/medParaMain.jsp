...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedPara.do',
    ...
    function add_open(){
    	...
    	if(ParamVo.toString().length >0 ){
    		ajaxJsonObjectByUrl("saveBatchMedPara.do?isCheck=false",{ParamVo : ParamVo.toString()},function (responseData){
