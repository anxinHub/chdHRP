    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedSafeStoreWarning.do?isCheck=false',
	...
	//打印
		function print(){
	    	...
	    	var colspan_num = grid.getColumns(1).length-1;
	   		...
	   		ajaxJsonObjectByUrl("queryMedSafeStoreWarning.do?isCheck=false", selPara, function (responseData) {
