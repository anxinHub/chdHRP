  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        if(validateGrid()){
        	ajaxJsonObjectByUrl("addMedRefCharge.do",formPara,function(responseData){
				...
				.ligerGrid(
						{
							columns : [
									...
									{
										display : '药品名称', name : 'inv_id', textField : 'inv_name', minWidth : 180, align : 'left',
										editor : {
											type : 'select',
											valueField : 'inv_id',
											textField : 'inv_name',
											...
											grid : {
												...
												url : '../../queryMedInvListDept.do?isCheck=false&med_ref_chrage_exists=0',
												pageSize : 10,
	...
	function remove() {
		...
		if (data.length == 0) {
			...
			$.ligerDialog.confirm('确定删除?', function(yes) {
				if (yes) {
					ajaxJsonObjectByUrl("deleteMedRefCharge.do", {
