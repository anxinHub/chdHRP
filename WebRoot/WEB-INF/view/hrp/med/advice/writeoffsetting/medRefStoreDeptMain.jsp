...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid1 = $("#maingrid1").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryMedStoreDict.do',
		...
		if (data.length == 0) {
			...
			$(data).each(
			 ...
			 $.ligerDialog.confirm('确定删除?', function (yes){
			        if (yes) {
			        	ajaxJsonObjectByUrl("deleteMedRefStoreDept.do?isCheck=false", {
    ...
    function settingDept(){
    	...
    	$.ligerDialog.open({
			...
			height: 600,
			width: 1000,
			url: 'medRefStoreDeptSetPage.do?isCheck=false&store_id='+$("#store").val(),
