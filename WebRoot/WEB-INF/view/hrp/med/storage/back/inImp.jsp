 ...
 function loadForm(){
    ...
    function imp(){
    	...
    	var para={
         ...
         ajaxJsonObjectByUrl("queryMedStorageBackDetailByImp.do?isCheck=false",para,function (responseData){
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedStorageBackIn.do?isCheck=false',
         ...
         gridDetail = $(ele).css({'margin-top':10, 'margin-left':60}).ligerGrid({
             columns:
						...
						dataAction : 'server',dataType : 'server',usePager : false,
			 			parms :para,
			 			url : 'queryMedStorageBackInDetail.do?isCheck=false',fixedCellHeight:true,
			 			width: '95%',height : '100%',
			 			frozen:false
         });  
     }
