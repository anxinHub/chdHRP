...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedCommonOutApply.do',
    ...
    function loadDetailHead(){
    	detailGrid = $("#detailgrid").ligerGrid({
			columns : [{
				...
				display : '药品变更号', name : 'inv_no', align : 'left', width : 240, hide: true
			}, {
				display : '药品名称', name : 'inv_id', textField : 'inv_name', width : 240, align : 'left',
			}, {
				...
				display : '请领数量', name : 'app_amount', width : 80, type : 'number', align : 'left',
				render : function(rowdata, rowindex, value) {
			...
			url : 'queryMedCommonOutApplyDetail.do?isCheck=false', 
