...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			columns: [{ 
     				...
     				display : '库存数量', name : 'imme_amount', width : 100, align : 'left'
     			} ,{ 
    ...
    function loadDict(){
		...
		autocompleteAsync("#dept_match", "../../../queryMedDeptMatch.do?isCheck=false", "id", "text", true, true, {dept_id:dept_id.split(",")[0],store_id:store_id.split(",")[0]}, true,"",230);
        //配套表联动查询，点击配套表直接查询当前配套表的药品信息
