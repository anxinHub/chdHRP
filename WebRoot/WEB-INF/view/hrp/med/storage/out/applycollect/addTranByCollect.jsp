...
<script type="text/javascript">
     ...
     function  save(){
		...
		if(validateGrid()){
	        ...
	        if(is_com == "0"){
	        	pageTitle = "调拨单修改";
	        	saveUrl = "../applycheck/addMedTranMainByApp.do?isCheck=false";
	        	pageUrl = "hrp/med/storage/tran/medTranMainUpdatePage.do?isCheck=false";
	        }else{
	        	pageTitle = "代销调拨单修改";
	        	saveUrl = "../applycheck/addMedAffiTranMainByApp.do?isCheck=false";
	        	pageUrl = "hrp/med/affi/tran/medAffiTranMainUpdatePage.do?isCheck=false";
	        }
 ...
 function loadForm(){
           ...
           columns: [ 
				...
				toolbar: { 
					items: [
						...
						{ line:true },
						/* { text: '整单调拨（<u>I</u>）', id:'import', click: medTranBySingleImport, icon:'up' },
						{ line:true } */
					]
				}
		});
	...
	function loadHotkeys() {
		hotkeys('D', deleteRow);
		hotkeys('I', medTranBySingleImport);
	}
