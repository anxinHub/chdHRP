...
<html style="overflow:hidden;">
  <head>
	...
	var dept_id;
	var dept_no;
	var store_id = '${medReqMain.store_id}';
	var store_no = '${medReqMain.store_no}';
	var store_name = '${medReqMain.store_name}';
	$(function() {
		$("#layout1").ligerLayout({
			topHeight:125,
	...
	function save(){
		...
		if(validateGrid()){
			...
			ajaxJsonObjectByUrl("../applycheck/addMedRequriedMainByApp.do?isCheck=false", formPara, function(responseData) {
				if(responseData.state=="true"){
		            ...
		            parent.$.ligerDialog.open({
						...
						width: $(window).width(),
						url : 'hrp/med/require/dept/plan/medDeptRequriedPlanUpdatePage.do?isCheck=false&' + paras.toString(),
	...
	function query() {
		...
		grid.options.parms.push({name : 'store_id',value : '${medReqMain.store_id}'}); 
	...
	function pimport(){
		...
		if(liger.get("store_code").getValue()==""){
			...
			store_id = '${medReqMain.store_id}';
			store_no = '${medReqMain.store_no}';
			store_name = '${medReqMain.store_name}';
		}
	...
	//安全库存导入
	function simport(){
		var parm = 'store_no='+'${medReqMain.store_no}'
		+'&store_id='+'${medReqMain.store_id}'
		+'&store_name='+'${medReqMain.store_name}'
		+'&dept_id='+liger.get("dept_code").getValue().split(',')[0]
		+'&dept_no='+liger.get("dept_code").getValue().split(',')[1];
		...
		<div position="top">
			<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
			   ...
			   <tr>     
			        ...
			        <td align="left" class="l-table-edit-td" >
			            <input name="brif" type="text" requried="false"  id="brif" value="${medReqMain.brif}" ltype="text"/>
			        </td>
			        <td align="left"></td>
