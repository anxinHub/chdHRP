    ...
    <script type="text/javascript">
     ...
     function  save(){
    	 if(validateGrid()){
 	        ...
 	        ajaxJsonObjectByUrl("updateMedCommonOutApplyN.do",formPara,function(responseData){
...
function loadForm(){
    ...
    function loadHead() {
		grid = $("#maingrid").ligerGrid({
			...
			url : 'queryMedCommonOutApplyDetailN.do?isCheck=false',
			...
			toolbar : {
				items : [ {
					text : '添加（<u>A</u>）', id : 'add', click : batch_imp, icon : 'add', disabled: state == 1 ? false : true
				}, {
					line : true
				}, {
