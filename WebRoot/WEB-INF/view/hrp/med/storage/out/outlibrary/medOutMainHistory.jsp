...
<script type="text/javascript">
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	autocomplete("#inv_id", "../../../queryMedInvDict.do?isCheck=false", "id", "text", true, true,"",false,false,'238', "", '238');
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [
                ...
                { display: '上期耗用量', name: 'old_amount', minWidth: 70},
    		    ...
    		    { display: '灭菌日期', name: 'disinfect_date', minWidth: 50},
				],

	 			dataAction : 'server', dataType : 'server', url : 'queryMedOutDetailHistory.do?isCheck=false',
