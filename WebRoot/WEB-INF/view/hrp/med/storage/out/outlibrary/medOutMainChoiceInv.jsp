...
<script type="text/javascript">
    ...
    function  query(){
    		...
    		grid.options.parms.push({
    			name : 'med_type_code',
    			value : liger.get("med_type_id").getText().split(" ")[0]
    		}); 
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
			...
			dataAction: 'local', dataType: 'server', usePager:true, url:'queryMedInvBatchList.do?isCheck=false',
  ...
  //确定添加
	function addNew(){
		...
		if (data.length == 0){
			...
			if(inv_codes != ""){
				$.ligerDialog.error("药品 "+inv_codes+" 的出库数量为空，请填写！");
				return;
			}
    ...
    function loadDict(){
		...
		autocomplete("#med_type_id", "../../../queryMedType.do?isCheck=false", "id", "text", true, true,null,false,null,"180");
...
<body style="padding: 0px; overflow: hidden;">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
        ...
        <tr>
			...
			<td align="right" class="l-table-edit-td" >药品材分类：</td>
