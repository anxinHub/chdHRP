  ...
  <head>
	...
	$(function (){
		...
		$("#store_code").bind("change",function(){
			charge_store();
			grid.columns[5].editor.grid.url = "../../queryMedInvList.do?isCheck=false&store_id="
	...
	function loadDict(){
		...
		autocompleteAsync("#store_code", "../../queryMedStoreStocker.do?isCheck=false", "id", "text", true, true, isUseAffiStore ? "" : {is_com : 0});
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
			columns : [{
				display : '明细ID', name : 'in_detail_id', minWidth : 100, align : 'left', hide: true
			}, {
				...
				display : '金额(E)', name : 'amount_money', minWidth : 80, align : 'right',
				editor : {
					type : 'numberbox',
					precision : '${p08006 }'
				},
				...
				display: '灭菌批号(E)', name: 'disinfect_no', minWidth: 80, align: 'left',
				editor: {
					type: 'text',
				}
			}, {
    ...
    function openUpdate(obj) {
		...
		parent.$.ligerDialog
				.open({
					title : '入库单引入送货单明细修改' + '送货单号：'+'${medInMain.in_no}' + '  药品名称'
							+ inv_name,
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
			...
			<td align="right" class="l-table-edit-td">发票日期：</td>
				<td align="left" class="l-table-edit-td"><input class="Wdate"
					name="bill_date" id="bill_date" type="text" value="${medInMain.bill_date}"
			...
			<td align="right" class="l-table-edit-td">发票号：</td>
				<td align="left" class="l-table-edit-td"><input name="bill_no"
					type="text" id="bill_no"  ltype="text" value="${medInMain.bill_no}"
					 required="true"  />
				</td>
