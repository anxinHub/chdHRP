...
// 		liger.get("sup_code").setText("${sup_text}");
		...
		autocompleteAsync("#store_code", "../../queryMedStoreStocker.do?isCheck=false", "id", "text", true, true, {is_com : 0}, true);
...
<form name="form1" method="post"  id="form1" >
	<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
		<tr>
			...
			<td align="right" class="l-table-edit-td"><span id="sup_code_span" style="color:red">*</span>送货单类型：</td>
