...
<script type="text/javascript">
    ...
    function  query(){
		...
		grid.options.parms.push({
			name : 'protocol_id',
			value : liger.get("protocol_code").getValue().split(",")[0] == null ? "" : liger.get("protocol_code").getValue().split(",")[0]
		}); 
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			columns: [{ 
		 			...
		 			render : function(rowdata, rowindex, value) {
						return rowdata.amount == null ? "" : formatNumber(rowdata.amount, '${p08006}', 1);
					}
		 		} ],
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedCommonInProtocol.do?isCheck=false',
