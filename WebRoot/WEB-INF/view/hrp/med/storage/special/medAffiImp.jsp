...
<script type="text/javascript">
			...
			columns: [
			    { 
					...
					/* render : function(rowdata, rowindex, value) {
		 			...
		 			display : '科室ID', name : 'dept_id', minWidth : 80, hide:true
		 		},{
		 			display : '科室NO', name : 'dept_no', minWidth : 80, hide:true
		 		},{
		 			display : '主表ID', name : 'out_id', minWidth : 80, hide:true
		 		},{
		 			display : '明细ID', name : 'detail_id', minWidth : 80, hide:true
		 		},{
		 			display : '注册证ID', name : 'cert_id', minWidth : 80, hide:true
		 		}],
    ...
    function loadDict(){
		//字典下拉框
		autocompleteAsync("#store_id", "../../queryMedStore.do?isCheck=false", "id", "text", true, true, {"is_com" : 1}, true);
		//入库库房
		autocomplete("#in_store_id", "../../queryMedStore.do?isCheck=false", "id", "text", true, true);
		//采购部门
    	autocomplete("#dept_id", "../../queryMedDeptDict.do?isCheck=false", "id", "text", true, true, {"is_last" : 1}, false);
    	//供应商
