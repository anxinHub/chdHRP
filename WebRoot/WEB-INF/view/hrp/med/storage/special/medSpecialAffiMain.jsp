...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			columns: [
				...
				{display: '单据来源', name: 'come_from', align: 'left',width: 160,
		 			},
				{display: '仓库', name: 'store_name', align: 'left',width: 160,
		 		...
		 		{display: '金额', name: 'amount_money', align: 'right',width: 100,
			 			render : function(rowdata, rowindex, value) {
							return formatNumber(rowdata.amount_money ==null ? 0 : rowdata.amount_money, '${paras.para_08005}', 1);
						}
		 			}, 
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedAffiSpecial.do?isCheck=false',
    ...
    function print(){
   		...
   		ajaxJsonObjectByUrl("queryMedSpecial.do?isCheck=false",printPara,function (responseData){
   			 var trHtml='';
