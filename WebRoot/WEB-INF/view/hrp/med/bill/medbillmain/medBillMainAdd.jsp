  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     $(function (){
         ...
         $("#set_code").bind("change",function(){
 	    	if(liger.get("set_code").getValue()){
 	    		...
 	    		$("#store_id").ligerComboBox({disabled:false});
     ...
     function  query(){
    	 if(!liger.get("sup_id").getValue()){
  			...
  			inMainGrid.options.parms=[];
  	 		...
  	 		inMainGrid.options.parms.push({
  	 			name : 'begin_in_date',	value : $("#begin_in_date").val()
  	 		});
  	 		inMainGrid.options.parms.push({
  	 			name : 'end_in_date',	value : $("#end_in_date").val()
  	 		});
  	 		inMainGrid.options.parms.push({
  	 			name : 'begin_confirm_date',	value : $("#begin_confirm_date").val()
  	 		});
  	 		inMainGrid.options.parms.push({
  	 			name : 'end_confirm_date',	value : $("#end_confirm_date").val()
  	 		});
  	 		inMainGrid.options.parms.push({
  	 			name : 'in_no',	value : $("#in_no").val()
  	 		});
  	 		inMainGrid.options.parms.push({
  	 			name : 'bill_type',	value : $("#bill_type").val()
  	 		});
  	 		inMainGrid.options.parms.push({
  	 			name : 'store_id',
     ...
     function loadHead(){
     	 inMainGrid = $("#maingrid").ligerGrid({
            columns: [ 
                      { display: '入库单号', name: 'in_no', align: 'left',width:180
 					 		},
                      ...
                      url:'queryMedCommonInBill.do?isCheck=false', 
                      ...
                      toolbar: { items: [
     					{ text: '查询（<u>A</u>）', id:'query', click: query, icon:'add' },
     	                { line:true },
						...
						{ line:true },
						{ text: '查询条件（<u>H</u>）', id:'showCondition', click: showCondition,icon:'search' }
     				]},
                  });
         ...
         $(detailPanel).append(detailGrid);
       	 grid =$(detailGrid).css('margin',10).ligerGrid({
             columns:
                    ...
                    { display: '药品名称', name: 'inv_name',width:190},
                    ...
                    { display: '数量', name: 'amount',width:80 },
                    { display: '单据金额', name: 'payable_money', align: 'right',width:100 ,
                    	render:function(rowdata,rowindex,value){
                    		return formatNumber(rowdata.payable_money, '${p08005 }', 1);
                    	}
                    },
	  	 			{ display: '发票金额<E>', name: 'bill_money', align: 'right',type:'float',editor: { type: 'float'},width:100 ,
                   	 		render: function(rowdata,rowindex,value){
                    ...
                    width:'98%',height:'auto',isScoll:true ,allowAdjustColWidth : false , frozen : false ,isAddRow:false,
			 		...
			 		data:row.detail,enabledEdit : true,fixedCellHeight:true, onAfterEdit : f_onAfterEdit, 
     ...
     function detailData(rowdata,rowid,rowobj){
    	 ...
    	 if(detailDate.length > 0){
    		 $.each(detailDate,function(index,content){
    			 bill_money += Number(content.bill_money);
    		 })
    	 }
   ...
   //勾选入库单后  自动填写 要生成的发票的  发票金额
     function updateBill_money(){
    	 ...
    	 bill_money = bill_money.toFixed(4);
    ...
    function setBillCode(){
    	...
    	var parm={
    	 ...
    	 ajaxJsonObjectByUrl("setBillCode.do?isCheck=false",parm,function (responseData){
				$("#bill_code").val(responseData.prefixe+responseData.year.substring(2)+responseData.month+responseData.day+responseData.max_no);
    	 })
    }
  ...
  /*    //删除
          	...
          	if(JSON.stringify(targetMap.map) != '{}'){
            	...
            	if(str != ''){
            		...
            		$.ligerDialog.confirm('<span style="color : red">您有入库单选择了明细记录,该入库单的发票明细将只保存您选择的明细.</span>确定要保存吗?', function (yes){
                    	if(yes){
                    		 ajaxJsonObjectByUrl("addMedBillMain.do?isCheck=false",formPara,function(responseData){
                   	            if(responseData.state=="true"){
                   	                parent.query();
                   	                ajaxJsonObjectByUrl("addMedBillDetail.do?isCheck=false",{ParamVo : ParamVo.toString()},function (responseData){
                                   		if(responseData.state=="true"){
                                   		}
                                   	});
    ...
    function loadDict(){
		...
		//	autocomplete("#store_code", "../../queryMedStoreByRead.do?isCheck=false", "id", "text", true, true, '',false,'',240);
			autocomplete("#store_id", "../../queryMedStoreByRead.do?isCheck=false", "id", "text", true, true,'',true,'',240);
			autodate("#bill_date","yyyy-MM-dd");
   ...
   <div class="l-layout" id="layout1" style="height: 100%;" ligeruiid="layout1">
	      	...
	      	<form name="form" method="post"  id="form" >
			     <table cellpadding="0" cellspacing="0" class="l-table-edit" >
					<tr>
			            ...
			            <td align="left" class="l-table-edit-td"><input name="bill_no" type="text" id="bill_no" ltype="text" onChange="setBillCode()"  validate="{required:true,maxlength:100}" /></td>
			            <td align="left"></td>
					...
					<tr>
			            ...
			            <td align="left" class="l-table-edit-td">
				            <select name="bill_type" id="bill_type" style="width: 135px;" onChange="query()">
            ...
            <td align="left" class="l-table-edit-td">
             ...
             <td align="right" class="l-table-edit-td"  style="padding-left:20px;">仓&nbsp;&nbsp;库：</td>
				<td align="left" class="l-table-edit-td"><input name="store_id" type="text" id="store_id" ltype="text" validate="{required:false,maxlength:100}" /></td>
       			 <td align="left"></td>
           ...
           <input name="set_code" type="text" id="set_code" ltype="text" validate="{required:false,maxlength:100}" />
             ...
             <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>摘&nbsp;&nbsp;要:</b></td>
        	...
        	<div id="condition">
	        	...
	        	<table cellpadding="0" cellspacing="0" class="l-table-edit" >
						<tr>
				            ...
				            <td align="left" class="l-table-edit-td"><input class="Wdate" name="begin_in_date" id="begin_in_date" type="text" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"/></td>
				            <td align="left">至</td>
				            <td align="right" class="l-table-edit-td" ><input class="Wdate" name="end_in_date" id="end_in_date" type="text" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"/></td>
	        				<td align="right" class="l-table-edit-td"  style="padding-left:20px;">入库日期：</td>
				            <td align="left" class="l-table-edit-td"><input class="Wdate" name="begin_confirm_date" id="begin_confirm_date" type="text" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"/></td>
				            <td align="left">至</td>
				            <td align="right" class="l-table-edit-td" ><input class="Wdate" name="end_confirm_date" id="end_confirm_date" type="text" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"/></td>
	        				<td align="right" class="l-table-edit-td"  style="padding-left:20px;">单据号：</td>
				            <td align="left" class="l-table-edit-td"><input name="in_no" type="text" id="in_no" ltype="text" validate="{required:false,maxlength:100}" /></td>
