...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedBillDetailFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '发票明细ID', name: 'bill_detail_id', align: 'left',editor:{type:'text'}},
				{ display: '入库单ID', name: 'in_id', align: 'left',editor:{type:'text'}},
				{ display: '入库明细ID', name: 'in_detail_id', align: 'left',editor:{type:'text'}},
				{ display: '发票金额', name: 'bill_money', align: 'left',editor:{type:'text'}},
				{ display: '优惠金额', name: 'fav_money', align: 'left',editor:{type:'text'}},
				{ display: '累计付款', name: 'pay_money', align: 'left',editor:{type:'text'}},
				{ display: '全部开票标志', name: 'is_pay_all', align: 'left',editor:{type:'text'}},
				{ display: '优惠金额临时', name: 'fav_money_temp', align: 'left',editor:{type:'text'}},
				{ display: '付款金额临时', name: 'pay_money_temp', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchMedBillDetail.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
