  ...
  <head>
   ...
   <jsp:include page="${path}/inc.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateMedBillDetail.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="in_id" type="text" id="in_id" ltype="text" value="${in_id}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">入库明细ID：</td>
            <td align="left" class="l-table-edit-td"><input name="in_detail_id" type="text" id="in_detail_id" ltype="text" value="${in_detail_id}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="fav_money_temp" type="text" id="fav_money_temp" ltype="text" value="${fav_money_temp}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">付款金额临时：</td>
            <td align="left" class="l-table-edit-td"><input name="pay_money_temp" type="text" id="pay_money_temp" ltype="text" value="${pay_money_temp}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
