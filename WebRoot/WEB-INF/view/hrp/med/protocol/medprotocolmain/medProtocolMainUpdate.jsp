    ...
    <script type="text/javascript">
     ...
     function typeId(){
		 ...
		 if(parm.type_id != null && parm.type_id !='' && parm.type_id !='${type_id}' ){
			 ajaxJsonObjectByUrl("queryMedProtocolTypePre.do?isCheck=false",parm,function (responseData){
	...
	function startDate(){
	 ...
	 function addInv(){
		 if(!$("#detailgrid").is(":hidden")){
			 $.ligerDialog.open({url: 'medInvDetailPage.do?isCheck=false',height: 500,width: 900, 
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("updateMedProtocolMain.do?isCheck=false",formPara,function(responseData){
     ...
     function loadHead(obj){
     	           ...
     	           columns: [ 
					 ...
					 { display: '备注', name: 'note', align: 'left',editor: { type: 'text'},width:250,
						 	render:function(rowdata,rowindex,value){
						 		if(rowdata.note == null || rowdata.note == '' || rowdata.note == 'null'){
						 			return '';
						 		}else{
						 			return rowdata.note;
						 		}
                     ...
                     width: '100%', height: '240',url:'queryMedProtocolDetail.do?isCheck=false&protocol_id=${protocol_id}',
                   });
		...
		if("file"==obj){
			fileGrid = $("#filegrid").ligerGrid({
				 ...
				 width: '100%', height: '240',url:'queryMedProtocolFile.do?isCheck=false&protocol_id=${protocol_id}',
     ...
     function openUpdateFlie(data){
		...
		var parm = 
			...
			"file_id="+vo[3]   +"&"+
			"protocol_id="+vo[4] 
		$.ligerDialog.open({ url : 'medProtocolFilePage.do?isCheck=false&'+parm,data:{}, 
