     ...
     function loadHead(obj){
     	if("detail"==obj){
     		detailGrid = $("#detailgrid").ligerGrid({
     	           columns: [ 
                     ...
                     width: '100%', height: '200',url:'../medprotocolmain/queryMedProtocolDetail.do?isCheck=false&protocol_id=${protocol_id}',
                    /*  dataAction: 'server',dataType: 'server',usePager:true,url:'../queryMedProtocolDetail.do?dept_id='+dept_id,
		...
		if("file"==obj){
			fileGrid = $("#filegrid").ligerGrid({
				 ...
				 width: '100%', height: '200',url:'../medprotocolmain/queryMedProtocolFile.do?isCheck=false&protocol_id=${protocol_id}',
