  ...
  <head>
    ...
    <script type="text/javascript">
    		 ...
    		 if(!flag){
                 ...
                 if (data.length == 0){
                     ...
                     $(data).each(function (){					
                       	...
                       	ajaxJsonObjectByUrl("../medprotocolmain/addMedProtocolDetail.do",{ParamVo : ParamVo.toString()},function (responseData){
   			 ...
   			 $.ligerDialog.error('请先添加采购协议，再点击');
	             ...
	             if (data.length == 0){
	                 ...
	                 $(data).each(function (){					
	                   	...
	                   	ajaxJsonObjectByUrl("../medprotocolmain/addMedProtocolFile.do",{ParamVo : ParamVo.toString()},function (responseData){
	                   		if(responseData.state=="true"){
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addMedProtocolInt.do",formPara,function(responseData){
   ...
   <body>
   		<div class="l-layout" id="layout1" style="height: 100%;" ligeruiid="layout1">
			     ...
			     <table cellpadding="0" cellspacing="0" class="l-table-edit" >
					...
					<tr>
			            ...
			            <td align="left" class="l-table-edit-td">
			            	<input class="Wdate" name="sign_date" type="text" id="sign_date" ltype="text" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" validate="{required:true,maxlength:20}" />
			            </td>
			            <td align="left"></td>
			        ...
			        <tr>
			            ...
			            <td align="left" class="l-table-edit-td">
			            	<input class="Wdate" name="start_date" type="text" id="start_date" ltype="text" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" validate="{required:true,maxlength:20}" />
			            </td>
			            <td align="left"></td>
						<td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>结束日期<font color="red">*</font>:</b></td>
			            <td align="left" class="l-table-edit-td">
			            	<input class="Wdate" name="end_date" type="text" id="end_date" ltype="text" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" validate="{required:true,maxlength:20}" />
			            </td>
			            <td align="left"></td>
			        </tr> 
			        <tr>
			        ...
			        <tr>
	                	<td align="center" colspan="9"><input class="liger-button" name="save"  id="save"  type="button" width="200" value="保存" /></td>
			        </tr>
			     </table>
		    </form>
        	</div>
	        <div title="" class="l-layout-content" style="" position="centerbottom">
	        	...
	        	<input class="liger-button" name="inv"  id="inv"  type="button" width="200" value="选择药品" />
