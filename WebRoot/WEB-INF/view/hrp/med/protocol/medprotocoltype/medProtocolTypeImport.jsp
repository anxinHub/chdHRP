...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedProtocolTypeFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '类别代码', name: 'type_code', align: 'left',editor:{type:'text'}},
				{ display: '类别名称', name: 'type_name', align: 'left',width: 100,editor:{type:'text'}},
				{ display: '协议前缀', name: 'pre', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchMedProtocolType.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
