  ...
  <head>
   ...
   <jsp:include page="${path}/inc.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateMedProtocolType.do",formPara,function(responseData){
    ...
    function loadDict(){
    	...
    	/* $("#dept_id").ligerComboBox({
           	url: '../queryMedDeptIsManager.do?isCheck=false',
           	valueField: 'id',
            textField: 'text', 
            selectBoxWidth: 160,
           	autocomplete: true,
   ...
   <form name="form1" method="post"  id="form1" >
       ...
       <%--  <tr>
            ...
            <td align="left" class="l-table-edit-td"><input class='Wdate' name="start_year" type="text" id="start_year" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy'})" ltype="text" value="${start_year}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>开始月份<font color="red">*</font>:</b></td>
            <td align="left" class="l-table-edit-td"><input class='Wdate' name="start_month" type="text" id="start_month" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'MM'})" ltype="text" value="${start_month}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr>  --%>
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="pre" type="text" id="pre" ltype="text" value="${pre}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>预警天数<font color="red">*</font>:</b></td>
            <td align="left" class="l-table-edit-td"><input name="war_days" type="text" id="war_days" ltype="text" value="${war_days}" validate="{digits:true,maxlength:18}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
