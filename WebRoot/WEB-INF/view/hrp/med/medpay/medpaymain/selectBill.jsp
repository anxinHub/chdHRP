...
<script type="text/javascript">
    ...
    function loadHead(){
    	mainGrid = $("#maingrid").ligerGrid({
			...
			width: '100%', height:'100%', url:'queryMedBillMain_Pay.do?isCheck=false',
        ...
        grid = $(detailGrid).css('margin',10).ligerGrid({
            columns:
                     [
                        ...
                        { display: '药品名称', name: 'inv_name',width:100},
                    ...
                    //url:'queryMedBillDetail_Pay.do?isCheck=false&bill_id='+row.bill_id+'&is_init='+row.is_init,
