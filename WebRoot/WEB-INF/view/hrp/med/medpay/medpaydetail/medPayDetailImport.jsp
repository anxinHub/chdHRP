...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedPayDetailFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '付款单明细ID', name: 'pay_detail_id', align: 'left',editor:{type:'text'}},
				...
				{ display: '是否付完', name: 'is_pay_all', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchMedPayDetail.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
