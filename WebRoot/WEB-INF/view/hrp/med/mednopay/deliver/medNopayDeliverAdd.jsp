    ...
    <script type="text/javascript">
     ...
     function  save(){
    	if(validateGrid()){
	        ...
	        ajaxJsonObjectByUrl("addMedNopayDeliver.do?isCheck=false",formPara,function(responseData){
...
function loadForm(){
    ...
    function loadHead() {
		grid = $("#maingrid").ligerGrid({
			columns : [
					...
					{display : '金额', name : 'amount_money', minWidth : 100, type : 'number', align : 'right',
	...
	function loadDict(){
    	...
    	//仓库下拉框
		autocomplete("#store_id", "../../queryMedStore.do?isCheck=false", "id", "text", true, true, "", true);
		//供应商
		...
		autodate("#confirm_date","yyyy-MM-dd",200);
		//格式化文本框
	...
	<form name="form" method="post"  id="form" >
		<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
	        ...
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input class="Wdate" name="confirm_date" id="confirm_date" type="text"  onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" validate="{required:true}" />
	            </td>
