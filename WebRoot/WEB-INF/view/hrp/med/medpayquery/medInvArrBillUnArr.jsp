    	...
    	grid = $("#maingrid").ligerGrid({
			columns: [{
					display: '仓库', name: 'store_name', align: 'left', width: '120'
		 			...
		 			display: '制单日期', name: 'in_date', align: 'left', minWidth: '150'
		 		}, { 
		 			display: '药品类别', name: 'med_type_name', align: 'left', width: '80'
		 		}, { 
		 			...
		 			render : function(rowdata, rowindex, value) {
						return formatNumber(rowdata.notpaymoney ==null ? 0 : rowdata.notpaymoney, '${p08005 }', 1);
					}
		 		}, { 
		 			display: '开户银行', name: '', align: 'left', width: '90'
		 		}, { 
		 			display: '银行账号', name: '', align: 'left', width: '80'
		 		}
		 		],
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedInvArrBillUnArr.do',
     ...
     */
  	...
  	function print(){
      	...
      	var colspan_num = grid.getColumns(1).length-1;
     		...
     		ajaxJsonObjectByUrl("queryMedInvArrBillUnArr.do?isCheck=false", selPara, function (responseData) {
