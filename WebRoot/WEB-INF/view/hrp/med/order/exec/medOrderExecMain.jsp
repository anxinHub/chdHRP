...
<script type="text/javascript">
	...
	function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedOrderExec.do?isCheck=true',
	...
	function print(){
    	...
    	var colspan_num = grid.getColumns(1).length-1;
   		...
   		ajaxJsonObjectByUrl("queryMedOrderExec.do?isCheck=false", selPara, function (responseData) {
	...
	function loadDict() {
		...
		//物资类别
		autocomplete("#med_type","../../queryMedTypeDict.do?isCheck=false","id","text",true,true,'',false,'',240);
		//采购部门
		...
		$("#med_type").ligerTextBox({width:240});
