...
<script type="text/javascript">
	...
	function query() {
    	...
    	grid.options.parms.push({name : 'med_type_id',value : liger.get("med_type").getValue().split(',')[0]});
    	grid.options.parms.push({name : 'med_type_no',value : liger.get("med_type").getValue().split(',')[1]});
	...
	function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedOrderReceive.do?isCheck=true',
	...
	function print(){
    	...
    	var colspan_num = grid.getColumns(1).length-1;
   		...
   		ajaxJsonObjectByUrl("queryMedOrderReceive.do?isCheck=false", selPara, function (responseData) {
	...
	function loadDict() {
		...
		//付款单位
		autocomplete("#pay_hos_id","../../../sys/queryHosInfoDictPerm.do?isCheck=false","id","text",true,true);//付款单位下拉框 
		//物资类别
		autocomplete("#med_type","../../queryMedTypeDict.do?isCheck=false","id","text",true,true);
        ...
        $("#med_type").ligerTextBox({width:160});
...
<body style="padding: 0px; overflow: hidden;">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit" border="0" width="100%">
		...
		<tr> 
			...
			<td align="left" class="l-table-edit-td">
				<input name="med_type" type="text" requried="false" id="med_type" />
			</td>
