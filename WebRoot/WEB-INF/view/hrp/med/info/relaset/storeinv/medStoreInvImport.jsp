...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedStoreInvFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '药品ID', name: 'inv_id', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchMedStoreInv.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
