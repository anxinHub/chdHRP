...
<script type="text/javascript">
   ...
   /*  $(function(){
    ...
    function  query(){
        	...
        	//传递父页面inv_ids，不再执行两边
        	/*grid.set('url','../../queryMedInvList.do?isCheck=false');*/
    		//加载查询条件
           ...
           columns: [ 
                     ...
                     { display: '单价', name: 'price', align: 'left',width: '130',
                    	 render : function(rowdata, rowindex, value) {
           					return value == null ? "" : formedNumber(value, '${p08006 }', 1);
           				}
                     },
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'../../queryMedInvList.do?isCheck=false',
