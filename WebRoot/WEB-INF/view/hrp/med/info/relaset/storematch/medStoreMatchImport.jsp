...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedStoreMatchFiles.do?isCheck=false",    
		...
		ajaxJsonObjectByUrl("addBatchMedStoreMatch.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
