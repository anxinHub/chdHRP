...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "150"); sheet.setText(0, 0, "采购类型编码");
    	sheet.setColumnWidth(1, "150"); sheet.setText(0, 1, "采购类型名称");
    	sheet.setColumnWidth(2, "150"); sheet.setText(0, 2, "是否停用");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importMedStockType.do?isCheck=false", para, function(responseData){	
