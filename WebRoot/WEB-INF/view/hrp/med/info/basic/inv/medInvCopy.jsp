...
<html style="overflow:auto;">
  <head>
	...
	function  save(){
        ...
        if($("form").valid()){
			...
			if(JSON.stringify(d) != '[{}]'){
				...
				if(count != 1){
					$.ligerDialog.warn('默认供应商必选且只能选一个');
					return ; 
				}
				
			} 
			 
        	var para = {inv_name:$("#inv_name").val() ,inv_model:$("#inv_model").val()};
        	ajaxJsonObjectByUrl("queryMedInvExist.do?isCheck=false",para,function(responseData){
    	            if(responseData.state=="false"){
    	    	        ...
    	    	        ajaxJsonObjectByUrl("addMedInv.do",formPara,function(responseData){
	...
	function loadDict(){
		...
		autocomplete("#price_type", "../../../queryMedSysList.do?isCheck=false", "id", "text", true, true, {field_code : "price_type"}, false, "${medInv.price_type}");
		autocomplete("#amortize_type", "../../../queryMedSysList.do?isCheck=false", "id", "text", true, true, {field_code : "amortize_type"}, false, "${medInv.amortize_type}");
   ...
   function exsitValidate(){
	...
	function openUpdate(){
		parent.$.ligerDialog.open({
			url: 'hrp/med/info/basic/inv/medInvCertInfoAddPage.do?isCheck=false', 
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%" style="padding: 10px"  >
	        <tr>
	          ...
	          <td align="right" class="l-table-edit-td"  width="10%">
	            ...
	            <td align="left" class="l-table-edit-td" width="20%">
	            	<input name="alias" type="text" id="alias" ltype="text"  value="${medInv.alias}"  validate="{required:false,maxlength:100}"  onmouseover="showTip(event, this)" onmouseout="hideTip(event)"/>
	            </td>
	        </tr> 
	        <tr>
			...
			<tr>
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="inv_model" type="text" id="inv_model" ltype="text" value="${medInv.inv_model}" validate="{required:false,maxlength:200}"  onmouseover="showTip(event, this)" onmouseout="hideTip(event)"/>
	            </td>
	            <td align="right" class="l-table-edit-td" >
	        ...
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input class="Wdate" name="bid_date" id="bid_date" type="text" value="${medInv.bid_date}" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"/>
	            </td> 
	            <td align="right" class="l-table-edit-td"  >
	            	项目中标编码：
	            </td>
	            <td align="left" class="l-table-edit-td">
	            	<input name="bid_code" type="text" id="bid_code" ltype="text" value="${medInv.bid_code}" validate="{required:false,maxlength:50}" />
	            </td>
	        </tr>
	        <tr>
	            <td align="right" class="l-table-edit-td"  >
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="memory_encoding" type="text" id="memory_encoding" ltype="text" value="${medInv.memory_encoding}" validate="{required:false,maxlength:50}" />
	            </td>
                <td align="right" class="l-table-edit-td"  >
	            	计划来源：
	            </td>
