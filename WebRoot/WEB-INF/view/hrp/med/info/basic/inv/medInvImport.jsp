...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedInvFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '药品编码', name: 'inv_code', align: 'left',width:100,editor:{type:'text'}},
				{ display: '药品名称', name: 'inv_name', align: 'left',width:100,editor:{type:'text'}},
				{ display: '别名', name: 'alias', align: 'left',width:100,editor:{type:'text'}},
				{ display: '药品类别编码', name: 'med_type_code', align: 'left',width:100,editor:{type:'text'}},
				{ display: '药品类别名称', name: 'med_type_name', align: 'left',width:100,editor:{type:'text'}},
				...
				{ display: '是否灭菌药品', name: 'is_disinfect', align: 'left',width:100,editor:{type:'text'}},
				...
				{ display: '结构', name: 'inv_structure', align: 'left',width:100,editor:{type:'text'}},
				{ display: '药品用途', name: 'inv_usage', align: 'left',width:100,editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchMedInv.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
