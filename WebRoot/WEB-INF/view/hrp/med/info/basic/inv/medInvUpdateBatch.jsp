  ...
  <head>
	...
	function  save(){
        ...
        if($("form").valid()){
			...
			ajaxJsonObjectByUrl("updateMedInvBatch.do?isCheck=false",formPara,function(responseData){
	...
	function loadDict(){
		//字典下拉框
		//暂不支持类别批量修改
		//autocomplete("#med_type_code", "../../../queryMedTypeDict.do?isCheck=false", "id", "text", true, true, {is_last : '1'});
		
		var paras = {
			field_code : "price_type"
		}
		autocomplete("#price_type", "../../../queryMedSysList.do?isCheck=false", "id", "text", true, true, paras);
		paras = {
		...
		autocomplete("#manage_type", "../../../queryMedManageType.do?isCheck=false", "id", "text", true, true);
		...
		/*
		autocomplete("#use_state", "../../../queryMedYearOrNo.do?isCheck=false", "id", "text", true, true, "", false, "1");
		*/
		autoCompleteByData("#abc_type", medInv_ABCType.Rows, "id", "text", true, true);
		autoCompleteByData("#source_plan", medInv_sourcePlan.Rows, "id", "text", true, true);
		autocomplete("#is_single_ven", "../../../queryMedYearOrNo.do?isCheck=false", "id", "text", true, true);
		autocomplete("#is_bid", "../../../queryMedYearOrNo.do?isCheck=false", "id", "text", true, true);
		autocomplete("#is_zero_store", "../../../queryMedYearOrNo.do?isCheck=false", "id", "text", true, true);
		...
		autocomplete("#is_dura", "../../../queryMedYearOrNo.do?isCheck=false", "id", "text", true, true);
		autocomplete("#is_com", "../../../queryMedYearOrNo.do?isCheck=false", "id", "text", true, true);
		autocomplete("#is_bar", "../../../queryMedYearOrNo.do?isCheck=false", "id", "text", true, true);
		autocomplete("#is_per_bar", "../../../queryMedYearOrNo.do?isCheck=false", "id", "text", true, true);
		autocomplete("#is_inv_bar", "../../../queryMedYearOrNo.do?isCheck=false", "id", "text", true, true);
		autocomplete("#is_quality", "../../../queryMedYearOrNo.do?isCheck=false", "id", "text", true, true);
		autocomplete("#is_disinfect", "../../../queryMedYearOrNo.do?isCheck=false", "id", "text", true, true);
		autocomplete("#is_cert", "../../../queryMedYearOrNo.do?isCheck=false", "id", "text", true, true);
		autocomplete("#is_sec_whg", "../../../queryMedYearOrNo.do?isCheck=false", "id", "text", true, true);
		autocomplete("#is_shel_make", "../../../queryMedYearOrNo.do?isCheck=false", "id", "text", true, true);
		
		//药品属性
		autocomplete("#med_sx_id", "../../../queryMedSx.do?isCheck=false", "id", "text", true, true, "", true);
		//药品剂型
		autocomplete("#med_jx_id", "../../../queryMedJx.do?isCheck=false", "id", "text", true, true, "", true);
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%" style="padding: 10px"  >
        	...
        	<tr style="display:none">
	            ...
	            <td align="right" class="l-table-edit-td"  >
	            	<input name="is_involved" type="checkbox" id="is_involved" ltype="text" validate="{required:false}" />是否介入
	            </td>
	             <td align="right" class="l-table-edit-td"  >
	            	是否耐用品
	            </td>
