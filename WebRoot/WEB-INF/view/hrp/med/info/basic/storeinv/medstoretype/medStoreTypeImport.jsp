...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedStoreTypeFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '药品类别ID', name: 'med_type_id', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchMedStoreType.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
