...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "150"); sheet.setText(0, 0, "货位编码");
    	sheet.setColumnWidth(1, "150"); sheet.setText(0, 1, "货位名称");
    	sheet.setColumnWidth(2, "150"); sheet.setText(0, 2, "货位分类");
    	sheet.setColumnWidth(3, "100"); sheet.setText(0, 3, "排序号");
    	sheet.setColumnWidth(4, "150"); sheet.setText(0, 4, "所属库房");
    	sheet.setColumnWidth(5, "100"); sheet.setText(0, 5, "货位性质");
    	sheet.setColumnWidth(6, "100"); sheet.setText(0, 6, "控制方式");
    	sheet.setColumnWidth(7, "100"); sheet.setText(0, 7, "拣货员");
    	sheet.setColumnWidth(8, "100"); sheet.setText(0, 8, "是否停用");
    	sheet.setColumnWidth(9, "150"); sheet.setText(0, 9, "备注");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importMedLocationDict.do?isCheck=false", para, function(responseData){	
