  ...
  <head>
   ...
   <jsp:include page="${path}/inc.jsp"/>
    ...
    function save(){
		...
		ajaxJsonObjectByUrl("updateMedLocationDict.do",formPara,function(responseData){
    ...
    function loadDict(){
    	...
    	//字典下拉框
    	autocomplete("#picker","../../../../queryMedEmp.do?isCheck=false","id","text",true,true);  
        liger.get("picker").setValue("${picker}");
        liger.get("picker").setText("${picker_name}");
        
        //alert(liger.get("picker").getText());
        
    	autocomplete("#location_type_id","../../../../queryMedLocationType.do?isCheck=false","id","text",true,true);
    	liger.get("location_type_id").setValue("${location_type_id}");
        liger.get("location_type_id").setText("${location_type_code}");
        
        autocomplete("#store_id","../../../../queryMedStore.do?isCheck=false","id","text",true,true,'','','','','',200);
