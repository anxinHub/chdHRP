...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedLocationTypeFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '货位分类名称', name: 'location_type_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchMedLocationType.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
