...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryMedLocationType.do',
    ...
    function itemclick(item){ 
        if(item.id)
        {
            ...
            {
                case "add":
              		$.ligerDialog.open({url: 'medLocationTypeAddPage.do?isCheck=false', height: 300,width: 500, 
                ...
                case "delete":
                    ...
                    if (data.length == 0){
                        ...
                        $.ligerDialog.confirm('确定删除?', function (yes){
                        	if(yes){
                            	ajaxJsonObjectByUrl("deleteMedLocationType.do",{ParamVo : ParamVo.toString()},function (responseData){
                ...
                case "downTemplate":
                    ...
                    return;
                case "import":
                   	$.ligerDialog.open({url: 'medLocationTypeImportPage.do?isCheck=false', height: 430,width: 760, isResize:true, title:'导入'});
                   	return;
                case "Excel":
                case "Word":
                case "PDF":
    ...
    function openUpdate(obj){
    	...
    	$.ligerDialog.open({ url : 'medLocationTypeUpdatePage.do?isCheck=false&' + parm,data:{}, height: 300,width: 500, 
