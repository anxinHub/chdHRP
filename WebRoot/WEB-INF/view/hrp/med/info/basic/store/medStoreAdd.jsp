...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("addMedStore.do",formPara,function(responseData){
    ...
    function loadDict(){
    	...
    	autocomplete("#type_code","../../../queryMedStoreType.do?isCheck=false","id","text",true,true);//库房分类
    	...
    	autocomplete("#dept_id","../../../queryMedDeptIsManager.do?isCheck=false","id","text",true,true);//主管部门
    	autocomplete("#acc_emp","../../../queryMedEmp.do?isCheck=false","id","text",true,true); //会计
    	autocomplete("#manager","../../../queryMedManagerEmp.do?isCheck=false","id","text",true,true);//库房管理员
    	autocomplete("#stock_emp","../../../queryMedStockEmp.do?isCheck=false","id","text",true,true);//采购员   	
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" border="0">
			...
			<tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="acc_emp" type="text" id="acc_emp"  ltype="text" />
                </td>
                
                <td align="left"></td>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>库房管理员：</b></td>
                <td align="left" class="l-table-edit-td">
                	<input name="manager" type="text" id="manager"  ltype="text" />
                </td>
                <td align="left"></td>
			</tr>
			<tr>
