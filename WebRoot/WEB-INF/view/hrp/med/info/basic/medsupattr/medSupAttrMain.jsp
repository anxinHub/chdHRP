...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedSupAttr.do?isCheck=false',
            	...
            	case "delete":
                    ...
                    if (data.length == 0){
                        ...
                        $.ligerDialog.confirm('确定删除?', function (yes){
                        	if(yes){
                            	ajaxJsonObjectByUrl("deleteMedSupAttr.do",{ParamVo : ParamVo.toString()},function (responseData){
                    ...
                    return;
                case "import":
                	$.ligerDialog.open({url: 'medSupAttrImportPage.do?isCheck=false', height: 500,width: 800, title:'导入',modal:true,showToggle:false,showMax:false,showMin: true,isResize:true });
                case "export":
                	return;
                case "downTemplate":
    ...
    function add_open(){
  		parent.$.ligerDialog.open({url: 'hrp/med/info/basic/medsupattr/medSupAttrAddPage.do?isCheck=false&type_code='+type_code, 
    ...
    function openUpdate(obj){
		...
		parent.$.ligerDialog.open({ 
    		...
    		url : 'hrp/med/info/basic/medsupattr/medSupAttrUpdatePage.do?isCheck=false&' + parm,
  ...
  //打印数据
	 function printDate(){
		...
		ajaxJsonObjectByUrl("queryMedSupAttr.do",printPara,function (responseData){
	 ...
	 function exportExcel(){
		...
		ajaxJsonObjectByUrl("queryMedSupAttr.do",exportPara,function (responseData){
			$.each(responseData.Rows,function(idx,item){ 
				 var trHtml="<tr>";
					 trHtml+="<td>"+item.sup_id+"</td>"; 
					 trHtml+="<td>"+item.sup_name+"</td>"; 
