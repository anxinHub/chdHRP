...
<html style="overflow:auto;">
  <head>
    ...
    <script type="text/javascript">
     var dataFormat;
     var mod_code ='08' ;//（ 模块编码  该页面为物流系统使用 默认 物流系统模块'08' , 其他系统模块用该页面时 改为 相应的系统模块编码 ）
     var is_auto = "${is_auto}";
     $(function (){
        loadDict()//加载下拉框
        loadForm();
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addMedSupAttr.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	autocomplete("#ven_pay_con","../../../queryMedPayTerm.do?isCheck=false","id","text",true,true);
