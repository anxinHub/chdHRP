...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedFacAttrFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '生产厂商类别', name: 'type_code', align: 'left',editor:{type:'text'}},
				{ display: '是否停用', name: 'is_stop', align: 'left',editor:{type:'text'}},
				{ display: '所属系统模块', name: 'mod_code', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchMedFacAttr.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
