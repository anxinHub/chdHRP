  ...
  <head>
   ...
   <jsp:include page="${path}/inc.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateMedStockType.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="stock_type_code" type="text" id="stock_type_code" ltype="text" value="${stock_type_code}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">采购类型名称：</td>
            <td align="left" class="l-table-edit-td"><input name="stock_type_name" type="text" id="stock_type_name" ltype="text" value="${stock_type_name}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
