...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){ 
        ...
        ajaxJsonObjectByUrl("addMedStoreEmp.do?isCheck=true",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){ 
    	...
    	autocomplete("#emp_id","../../../../queryMedStockEmp.do?isCheck=false","id","text",true,true,'',true,'','160');   
