...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedStoreDetailFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '设置ID', name: 'set_id', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchMedStoreDetail.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
