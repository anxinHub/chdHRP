...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           ...
           usePager: false, url:'queryMedStoreData.do?isCheck=false&set_id=${set_id}',
    ...
    function add_open(){
        ...
        ajaxJsonObjectByUrl("addMedStoreDetail.do?isCheck=true", {ParamVo : ParamVo.toString()},function(responseData){
