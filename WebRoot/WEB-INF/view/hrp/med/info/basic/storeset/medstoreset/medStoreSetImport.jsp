...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedStoreSetFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '编码', name: 'set_code', align: 'left',editor:{type:'text'}},
				{ display: '名称', name: 'set_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchMedStoreSet.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
