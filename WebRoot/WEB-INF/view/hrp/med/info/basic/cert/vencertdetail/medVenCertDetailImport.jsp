...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedVenCertDetailFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '证件编号', name: 'cert_code', align: 'left',width:220,editor:{type:'text'}},
				{ display: '供应商ID', name: 'sup_id', align: 'left',editor:{type:'text'}},
				{ display: '证件类型ID', name: 'type_id', align: 'left',editor:{type:'text'}},
				{ display: '发证机关', name: 'issuing_authority', align: 'left',editor:{type:'text'}},
				{ display: '起始日期', name: 'start_date', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchMedVenCertDetail.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
