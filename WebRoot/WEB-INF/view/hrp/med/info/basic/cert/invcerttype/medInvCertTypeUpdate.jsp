  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateMedInvCertType.do",formPara,function(responseData){
    ...
    function loadDict(){
		...
		autoCompleteByData("#validity_type", medInvCertType_validityType.Rows, "id", "text", true, true, "", false, "${validity_type}");
     }   
    </script>
