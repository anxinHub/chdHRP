...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedInvCertTypeFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '证件类型编码', name: 'type_code', align: 'left',editor:{type:'text'}},
				{ display: '证件类型名称', name: 'type_name', align: 'left',editor:{type:'text'}},
				{ display: '效期类型', name: 'validity_type', align: 'left',editor:{type:'text'}},
				{ display: '是否预警', name: 'is_alarm', align: 'left',editor:{type:'text'}},
				{ display: '预警天数', name: 'war_days', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchMedInvCertType.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
