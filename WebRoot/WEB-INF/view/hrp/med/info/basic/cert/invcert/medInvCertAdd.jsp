     ...
     function  save(){
    	 if(validateGrid()){
    		var allData = gridManager.getData();
   	        ...
   	        ajaxJsonObjectByUrl("addMedInvCert.do",formPara,function(responseData){
                          ...
                          { display: '药品名称',
     					     ...
     					     editor :{
    								...
    								grid : {
    									...
    									url : 'queryMedCertInvList.do?isCheck=false',
    									usePager:true,
		...
		//选择药品页面跳转
    	 function choice_inv(){
    		...
    		$.ligerDialog.open({url: "medInvCertChoiceInvPage.do?isCheck=false",
    				...
    				data: {"sup_id": liger.get("sup_id").getValue(), "sup_text": liger.get("sup_id").getText()},
