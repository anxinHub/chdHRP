...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedVenCertDetail.do',
    ...
    function openDetail(obj){
		...
		$.ligerDialog.open({url: 'medVenCertDetailPage.do?isCheck=false&'+ parm, height: 600,width: 1000, title:'供应商证件明细',
