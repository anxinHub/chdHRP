...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addMedInvCertType.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='type_code']").val('');
				 $("input[name='type_name']").val('');
				 $("select[name='is_alarm']").val('');
 ...
 function loadForm(){
    ...
    function loadDict(){
		//字典下拉框
		autoCompleteByData("#validity_type", medInvCertType_validityType.Rows, "id", "text", true, true, "", true);
     } 
    </script>
