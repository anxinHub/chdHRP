...
<html style="overflow:hidden;">
  <head>
    ...
    function validate(){
		...
		ajaxJsonObjectByUrl("existsMedInvInCert.do?isCheck=false", para, function (responseData) {
			if (responseData.state == "false") {
				msg += "药品" + responseData.inv_ids + "与证件的对应关系已经存在！<br>";
			}
		}, false);
    ...
    function save(){
    	if(validate()){
        	...
        	ajaxJsonObjectByUrl("addMedInvCertRelaAdd.do?isCheck=false",formPara,function(responseData){
    ...
    function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '药品编码', name: 'inv_code', align: 'left',width:'15%'},
                     { display: '药品名称',
 					     name: 'inv_name',
 					     width: '25%',
 					     align: 'left',
 					     ...
 					     editor :{
								...
								grid : {
									...
									url : 'queryMedInvCertList.do?isCheck=false&cert_id='+'${cert_id}'+'&med_type_code='+liger.get("med_type_code").getText().split(" ")[0]+'&store_code='+liger.get("store_code").getText().split(" ")[0],
									usePager:true,
	...
	function f_onSelectRow_detail(data, rowindex, rowobj) {
     ...
     function loadDict(){
        ...
        autocomplete("#cert_id","../../../../queryMedStore.do?isCheck=false","id","text",true,true,'',false,'','160');
		...
		$("#cert_id").ligerTextBox({width:300});
		   autocompleteAsync("#med_type_code", "../../../../queryPermMedTypeDict.do?isCheck=false", "id", "text", true, true); 
			...
			liger.get("med_type_code").setText("${med_type_code} ${med_type_name} ");
...
<body style="padding: 0px; overflow: hidden;">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        ...
        <td align="right" class="l-table-edit-td"  >药品分类：</td>
