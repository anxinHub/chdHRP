...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedInvCertRelaFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '证件ID', name: 'cert_id', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchMedInvCertRela.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
