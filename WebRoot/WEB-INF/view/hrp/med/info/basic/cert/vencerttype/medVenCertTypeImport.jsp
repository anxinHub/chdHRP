...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedVenCertTypeFiles.do?isCheck=false",    
		...
		ajaxJsonObjectByUrl("addBatchMedVenCertType.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
