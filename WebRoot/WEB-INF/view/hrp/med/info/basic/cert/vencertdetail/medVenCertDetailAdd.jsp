...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addMedVenCertDetail.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
            ...
            //证件编码
    		//autocomplete("#cert_code", "../../../../queryMedInvCert.do?isCheck=false", "id", "text", true, true,'',false,'',240);
    		//证件类型
            autocomplete("#type_id", "../../../../queryMedVenCertType.do?isCheck=false", "id","text", true, true,'',false,'',240);
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td" colspan="4">
            	<textarea rows="4" class="liger-textarea" id="file_path" name="file_path" style="width:580px" validate="{maxlength:200}" ></textarea>
            	</td>
            <td align="left"></td>
        </tr>
        <tr>
            ...
            <td align="left" class="l-table-edit-td" >
            	<div class='l-button' style='width: 60px; margin-top:1px; margin-left: 40px;' ligeruiid='Button1008' onclick=upLodePage('${sup_id}')><span>上传</span></div>
            	</td>
            <td align="left"></td>
        </tr>
    </table>
