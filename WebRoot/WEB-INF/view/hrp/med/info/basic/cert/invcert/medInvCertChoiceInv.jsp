    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					{ display: '交易编码', name: 'bid_code', align: 'left',width:'100'},
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedCertInvListObject.do?isCheck=false',
  ...
  //确定添加
	function addNew(){
		...
		if (data.length == 0){
			...
			ajaxJsonObjectByUrl("queryMedCertInvChoiceInvList.do?isCheck=false", formPara, function(responseData) {
