...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "150"); sheet.setText(0, 0, "付款条件编码");
    	sheet.setColumnWidth(1, "150"); sheet.setText(0, 1, "付款条件名称");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importMedPayTerm.do?isCheck=false", para, function(responseData){	
