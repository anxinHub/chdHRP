...
<script type="text/javascript">
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="pay_term_id" type="text" id="pay_term_id" ltype="text" value="${pay_term_id}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">付款条件编码：</td>
            <td align="left" class="l-table-edit-td"><input name="pay_term_code" type="text" id="pay_term_code" ltype="text" value="${pay_term_code}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
