...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedPayTermFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '付款条件ID', name: 'pay_term_id', align: 'left',editor:{type:'text'}},
				{ display: '付款条件编码', name: 'pay_term_code', align: 'left',editor:{type:'text'}},
				{ display: '付款条件名称', name: 'pay_term_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchMedPayTerm.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
