    	 ...
    	 grid = $("#maingrid").ligerGrid({
             columns: [
					   ...
					   /* { display: '原零售单价', name: 'old_sell_price', align: 'right',minWidth : 80,render:
						   	function(rowdata){
						   		return formatNumber(rowdata.old_sell_price,'${para_value}',1);
					   		}
					   },
                       ...
                       url:'queryMedAdjustDetailByCode.do?isCheck=false&adjust_id='+'${adjust_id}',
	...
	function f_onSelectRow_detail(data, rowindex, rowobj) {
 	 ...
 	 function f_onSelectRow(data, rowindex, rowobj) {
		...
		function save() {
			...
			ajaxJsonObjectByUrl("updateMedAdjust.do", formPara,function(responseData) {
