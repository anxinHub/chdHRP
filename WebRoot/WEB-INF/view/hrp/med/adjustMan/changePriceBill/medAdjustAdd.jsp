             ...
             columns: [ 
                       ...
                       { display: '药品名称(E)',
  					     ...
  					     editor :{
								...
								grid : {
									...
									url : 'queryMedInvList.do?isCheck=false',
									//delayLoad:true,
									usePager:true,
									pageSize : 30,
					   ...
					   { display: '新计划价(E)', name: 'new_price', align: 'right',minWidth : 80,
							...
							render : function(rowdata, rowindex, value) {
								rowdata.new_price = value == null ? "" : formatNumber(value, '${p08006 }', 0);
								return value == null ? "" : formatNumber(value, '${p08006 }', 1);
							}
						},
					   /* { display: '原零售单价', name: 'old_sell_price', align: 'right',minWidth : 80,render:
						   	function(rowdata){
						   		return formedNumber(rowdata.old_sell_price,'${para_value}',1);
					   		}
							},
					   { display: '新零售单价(E)', name: 'new_sell_price', align: 'right',minWidth : 80,
								editor : {
									type : 'numberbox',
									precision : '${sessionScope.med_para_map["04006"] }'
								},
								render : function(rowdata, rowindex, value) {
									rowdata.new_sell_price = value == null ? "" : formatNumber(value, '${sessionScope.med_para_map["04006"] }', 0);
									return value == null ? "" : formatNumber(value, '${sessionScope.med_para_map["04006"] }', 1);
								}
							}, */
	...
	function f_onSelectRow_detail(data, rowindex, rowobj) {
 	 ...
 	 function f_onSelectRow(data, rowindex, rowobj) {
		...
		function save() {
		    		...
		    		if(typeof(v.inv_id) != "undefined" && v.inv_id != null && v.inv_id != ''){
						...
						var value="第"+(i+1)+"行";
			 			...
			 			if(targetMap.get(key)== null || targetMap.get(key) == 'undefined' || targetMap.get(key) == ""){
			 				...
			 				msg += value + targetMap.get(key) +'药品重复.<br> '
			 			}
			...
			ajaxJsonObjectByUrl("addMedAdjust.do", formPara,function(responseData) {
		...
		function itemclick(item){ 
	        if(item.id)
	        {
	            ...
	            {
					case "import":
	                	$.ligerDialog.open({url: 'medAdjustImportPage.do?isCheck=false', height: 500,width: 800, title:'导入',modal:true,showToggle:false,showMax:false,showMin: true,isResize:true });
	                	return ; 
	                case "downTemplate":
