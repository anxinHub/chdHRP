...
<script type="text/javascript">
     ...
     function  save(){
		...
		//if($("form").valid()){
	        ...
	        ajaxJsonObjectByUrl("addMedAffiBack.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	//字典下拉框
    	autocomplete("#bus_type_code", "../../queryMedBusType.do?isCheck=false", "id", "text", true, true, {codes : '29'}, true);
    	autocomplete("#store_code", "../../queryMedStore.do?isCheck=false", "id", "text", true, true, {is_com : '1'}, true,"","","",200);
		autocomplete("#stocker", "../../queryMedStockEmp.do?isCheck=false", "id", "text", true, true, "", true);
		...
		autocomplete("#app_dept", "../../queryMedDept.do?isCheck=false", "id", "text", true, true, {is_last : '1'},true,"","","",300);
		autocomplete("#protocol_code", "../../queryMedProtocolMain.do?isCheck=false", "id", "text", true, true);
		autocomplete("#proj_code", "../../queryMedProj.do?isCheck=false", "id", "text", true, true,"","","","","",490);
		//格式化文本框
				...
				editor : {
					type : 'select',
	         		...
	         		grid : {
	         			...
	         			url : '${p08021}' == 0 ? '../../queryMedAffiInvList.do?isCheck=false&is_com=1&store_id='+liger.get("store_code").getValue().split(",")[0]
							: '../../queryMedAffiInvList.do?isCheck=false&is_com=1&store_id='+liger.get("store_code").getValue().split(",")[0]+'&sup_id='+liger.get("sup_code").getValue().split(",")[0],
	         			pageSize : 500,
	...
	function queryallMederials(){
		...
		ajaxJsonObjectByUrl("queryAllMedbySupId.do?isCheck=false&store_id="+store_id+"&sup_id="+sup_id,null,function(responseData){
