...
<script type="text/javascript">
    	...
    	grid = $("#maingrid").ligerGrid({
			columns: [{
					...
					render : function(rowdata, rowindex, value) {
		 			...
		 			display: '出库日期', name: 'out_date', align: 'left', width: '80'
		 		}, { 
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedAffiOutImplant.do',
	...
	function print(){
    	...
    	var colspan_num = grid.getColumns(1).length-1;
   		...
   		ajaxJsonObjectByUrl("queryMedAffiOutImplant.do?isCheck=false", selPara, function (responseData) {
