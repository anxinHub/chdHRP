...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMedAffiOutDept.do',
	...
	function print(){
    	...
    	var colspan_num = grid.getColumns(1).length-1;
   		...
   		ajaxJsonObjectByUrl("queryMedAffiOutDept.do?isCheck=false", selPara, function (responseData) {
    ...
    function loadDict(){
		...
		//autocomplete("#inv_code", "../../queryMedInv.do?isCheck=false", "id", "text", true, true,'',false,'',270);
		autocomplete("#dept_code", "../../queryMedDept.do?isCheck=false", "id", "text", true, true, {is_last : '1'},false,'',220);
