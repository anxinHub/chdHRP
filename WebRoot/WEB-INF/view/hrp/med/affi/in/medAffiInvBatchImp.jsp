...
<script type="text/javascript">
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
		       columns: [ 
						 {    display: '药品ID', name: 'inv_id', align: 'left',width : '120',hide:true
						 }, { display: '药品NO', name: 'inv_no', align: 'left',width : '120',hide:true
		             ...
		             url:'queryMedAffiInInvBatch.do?isCheck=false',
	...
	function imp(){
		...
		if (data.length == 0){
			...
			$.ligerDialog.confirm('确定生成入库单吗?', function (yes){
				if(yes){
					ajaxJsonObjectByUrl("queryMedAffiInInvBatchDetail.do?isCheck=false", formPara, function(responseData) {
