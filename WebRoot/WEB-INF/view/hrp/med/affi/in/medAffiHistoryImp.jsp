...
<script type="text/javascript">
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
		       columns: [ 
		             ...
		             url:'queryMedAffiInHistoryDetail.do?isCheck=false',
	...
	function imp(){
		...
		if (data.length == 0){
			...
			$.ligerDialog.confirm('确定生成入库单吗?', function (yes){
				if(yes){
					ajaxJsonObjectByUrl("queryMedAffiInHisDetail.do?isCheck=false", formPara, function(responseData) {
	...
	function loadDict() {
		...
		autocomplete("#bus_type_code", "../../queryMedBusType.do?isCheck=false", "id", "text", true, true,{codes:'27,29'},false,"29");//业务类型
