  ...
  <head>
	...
	function save(){
		...
		if(validateGrid()){
			...
			ajaxJsonObjectByUrl("addMedStoreRequriedPlan.do?isCheck=true", formPara, function(responseData) {
	...
	//字典加载
	function loadDict() {
		autocomplete("#dept_code", "../../../queryMedDept.do?isCheck=false", "id", "text", true, true, {is_last : '1'}, false);//主管部门
		/* liger.get("dept_code").setValue('${dept_id},${dept_no}');
		liger.get("dept_code").setText('${dept_text}'); */
		
		autocomplete("#store_code","../../../queryMedStore.do?isCheck=false","id","text",true,true,'',false);
