...
<html style="overflow:hidden;">
  <head>
   ...
   //验证
     ...
     function  save(){
    	if(validateGrid){
    		...
    		var formPara={
    	        ...
    	        ajaxJsonObjectByUrl("updateMedInitAffiIn.do?isCheck=true",formPara,function(responseData){
    ...
    function loadDict(){
    	//字典下拉框
    	autocomplete("#bus_type_code", "../../queryMedBusType.do?isCheck=false", "id", "text", true, true, {sel_flag : 'init'}, false, '${medInMain.bus_type_code}');//业务类型
		autocomplete("#store_code", "../../queryMedStore.do?isCheck=false", "id", "text", true, true, {is_com : 1}, false, '${medInMain.store_id},${medInMain.store_no}');//仓库
    ...
    function loadHead() {
    	grid = $("#maingrid").ligerGrid({
			...
			dataType : 'server',
			usePager : false,
			url : 'queryMedInitAffiInDetail.do?isCheck=false',
			width : '100%',
			height : '93%',
			checkbox : true,
    ...
    function printDate(){
		...
		printTemplate("queryMedInByPrintTemlateQm.do",para);
	}
  ...
  //打印设置
	function printSet(){
		...
		parent.parent.$.ligerDialog.open({url : 'hrp/med/initial/affiin/storageInPrintSetPageQm.do?template_code=08007&use_id='+useId,
	...
	function confirm_in(){
		...
		$.ligerDialog.confirm('确定入库确认?', function (yes){
			if(yes){
				ajaxJsonObjectByUrl("confirmMedInitAffiIn.do?isCheck=true",formPara,function (responseData){
					if(responseData.state=="true"){
						query();
					}
				});
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
	        ...
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="in_no" type="text" id="in_no" value="${medInMain.in_no}" ltype="text" />
	            </td>
	        ...
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td" colspan="5">
	            	<input name="brief" type="text" id="brief" ltype="text" value="${medInMain.brief}" validate="{required:true,maxlength:50}" />
	            </td>
	        </tr>
	    </table>
    </form>
