...
<head>
    ...
    <script>
        ...
        var add = function () {
            $.etDialog.open({
                url: 'addSignModePage.do?isCheck=false',
                width: 450,
                height: 300,
                title: '添加',
                btn: ['确定', '取消'],
        ...
        var openUpdate = function (openParam) {
            $.etDialog.open({
                url: 'updateSignModePage.do?isCheck=false&way_code=' + openParam.way_code,
                title: '修改',
                width: 450,
                height: 300,
                btn: [ '保存', '取消' ],
        ...
        var initGrid = function () {
            var columns = [
                { display: '签到方式编码', name: 'way_code', width: 120,
                    render: function (ui) {
                        var updateHtml =
                ...
                { display: '签到方式名称', name: 'way_name', width: 120 },
            ...
            var paramObj = {
                ...
                dataModel: {
                    url: 'querySignMode.do?isCheck=false'
                },
        ...
        function importDate(){
    		...
    		importSpreadView("/hrp/hr/training/setting/signmode/importDateHTL.do?isCheck=false", para);
    	}
    </script>
</head>
...
<body>
    <table class="table-layout">
        <tr>
            <td class="label" style="width: 100px;">签到方式编码：</td>
            <td class="ipt">
                <input id="way_code" type="text" />
            </td>

            <td class="label" style="width: 100px;">签到方式名称：</td>
            <td class="ipt">
