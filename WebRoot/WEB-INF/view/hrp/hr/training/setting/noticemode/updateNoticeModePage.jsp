...
<body>
    <div class="mian">
        <table class="table-layout" style="width: 100%;">
            <tr>
                <td class="label no-empty">通知方式编码：</td>
                <td class="ipt">
                    <input id="way_code" type="text" value="${way_code}" disabled="disabled"/>
                </td>
            </tr>
            <tr>
                <td class="label no-empty">通知方式名称：</td>
                <td class="ipt">
                    <input id="way_name" type="text" value="${way_name}" />
                </td>
            </tr>
            <tr>
