...
<head>
    ...
    <script>
        ...
        var initForm = function () {
          ...
          if(${is_exam}==0){
          	  $(":radio[name='is_exam'][value='0']").prop("checked", "checked");
          }else{
          	  $(":radio[name='is_exam'][value='1']").prop("checked", "checked");
          }
          if(${is_cert}==0){
          	 $(":radio[name='is_cert'][value='0']").prop("checked", "checked");
        }else{
      	  $(":radio[name='is_cert'][value='1']").prop("checked", "checked");
        }
        
          if(${is_exama}==0){
        	 $(":radio[name='is_cert']").prop("disabled", "true"); 
        	/* 	document.getElementById("is_exam").disabled=true; */
         } 
        /*   if(${is_certa}!=0){
         	 $(":radio[name='is_cert']").prop("disabled", "true"); 
          }  */
          $("#is_exam").click(function () {
           ...
           $("#is_exama").click(function () {
             ...
             var option = dept_code.getItem(0);
			dept_code.clearItem();
			dept_code.removeOption("${dept_code}");
			
			dept_code.addOptions({id: "${dept_code}", text:"${dept_name}"})
			dept_code.setValue("${dept_code}");
        };
           ...
           if (!checked()) {
            ...
            ajaxPostData({
                ...
                data: {
                	...
                	year :${year},
                	month :month.getValue()=="" ? "${month}" :month.getValue() ,
    ...
    <div class="mian">
        <table class="table-layout" style="width: 100%;">
            ...
            <tr>
                ...
                <td class="ipt">
                    <input id="train_title" type="text" value="${train_title}"/>
                </td>
                ...
                <td class="ipt">
                    <input id="train_object" type="text" value="${train_object}"/>
                </td>
                <td class="label no-empty">培训方式：</td>
                <td class="ipt">
                    <input id="train_way" type="text" style="width:180px"/>
                </td>
            </tr>
                   <tr>
                ...
                <td class="ipt">
                  <input type="radio" name="is_exam"  id="is_exama"   value='1' onclick="makeDis('1')"/><label>是&nbsp;&nbsp;</label>  
                	<input name="is_exam"  type="radio" id="is_exam"  value="0" onclick="makeDis('0')" /><label>否&nbsp;&nbsp;</label>  

                </td>
                <td class="label ">学分：</td>
                <td class="ipt">
                    <input id="credit_hour" type="number" value="${credit_hour}"/>
                </td>
            </tr>
                   <tr>
                <td class="label no-empty">是否发证：</td>
                <td class="ipt">
                  <input type="radio" name="is_cert"   value='1' onclick="makeDis('1')"/><label>是&nbsp;&nbsp;</label>  
                	<input name="is_cert"  type="radio"  value="0" onclick="makeDis('0')" /><label>否&nbsp;&nbsp;</label>  
            ...
            <tr>-->
                ...
                <td class="ipt">
                 <textarea id="note" rows="20" cols="25" class="wishContent" placeholder="请输入不超过50个字" maxlength="50">${note}</textarea>
                </td>
            </tr>
