    ...
    <head>
        ...
        <script>
            ...
            var query = function () {
                ...
                grid.loadData(params,"queryHrEmpMonthHnurse.do");
            };
            ...
            function print() { 
            	...
            	var printPara={
                  		...
                  		class_name: "com.chd.hrp.hr.service.nursingtraining.HrEmpMonthHnurseService",
               			method_name: "queryHNurseByPrint",
               			bean_name: "hrEmpMonthHnurseService",
            ...
            function importData() {
            	...
            	var para = {
            		...
            		importSpreadView("/hrp/hr/nursingtraining/hrempmonthhnurse/importMonthHNurse.do?isCheck=false", para, query);
            }
