    ...
    <head>
        ...
        <script>
            ...
            function print() {
            	...
            	var printPara={
                  		title: "护理长绩效年考核记录打印",//标题
                  		columns: JSON.stringify(grid.getPrintColumns()),//表头
                  		class_name: "com.chd.hrp.hr.service.nursingtraining.HrEmpYearHnurseService",
               			method_name: "queryYearHNurseByPrint",
               			bean_name: "hrEmpYearHnurseService",
            ...
            function importData() {
            	...
            	var para = {
            		...
            		importSpreadView("/hrp/hr/nursingtraining/hrempyearhnurse/importYearHNurse.do?isCheck=false", para, query);
            }
