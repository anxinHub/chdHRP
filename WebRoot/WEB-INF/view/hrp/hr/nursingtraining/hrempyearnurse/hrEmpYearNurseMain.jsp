<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <head>
        ...
        <script>
            var year_date, dept_select, duty_select, title_select, level_select, grid
            $(function () {
                init();
            });
            ...
            function initGrid() {
                ...
                var main_columns = [
                	{ display: '年度', name: 'year', width: 120, editor: yearEditor,editable : function(col){
                    	if(col.rowData){
                    ...
                    { display: '职工姓名', name: 'emp_name', width: 120,editable : function(col){
                    	if(col.rowData){
                    		if(col.rowData.state!=null){
                    			return false;
                    		}
            ...
            var query = function () {
                ...
                grid.loadData(params,"queryHrEmpYearNurse.do");
            };
            ...
            function print() {
            	...
            	var printPara={
                  		title: "护理绩效年考核记录打印",//标题
                  		columns: JSON.stringify(grid.getPrintColumns()),//表头
                  		class_name: "com.chd.hrp.hr.service.nursingtraining.HrEmpYearNurseService",
               			method_name: "queryYeartNurseByPrint",
               			bean_name: "hrEmpYearNurseService",
            ...
            function importData() {
            	...
            	var para = {
            		...
            		importSpreadView("/hrp/hr/nursingtraining/hrempyearnurse/importYearNurse.do?isCheck=false", para, query);
            }
