...
<script type="text/javascript">
	...
	var initBtn = function(){
		...
		$("#calSet").click(function(){
			...
			parent.$.etDialog.open({
	            url: 'hrp/hr/salarymanagement/socialsecuritymanagement/insurBaseCal/insurBaseCalEditPage.do?isCheck=false',
	            width: 800,
	            height: 500,
	...
	/* 	if(!rowData.kind_code){
			...
			kind_code.setValue(rowData.kind_code)
		} */
		if(!rowData.kind_code){
			emp_kind_code.setValue("全部");
		}else{
		emp_kind_code.setValue(rowData.kind_code)
		}
	}
	...
	var query = function() {
		...
		grid.loadData(param, "queryHrInsurBaseCal.do?isCheck=false");
	}
...
<body style="padding: 0px; overflow: hidden;">
	<div class="container">
		...
		<div class="center">
			<input type="hidden" id="cal_id" name="cal_id" class="edit_item"/>
			<input type="hidden" id="group_id" name="group_id" class="edit_item"/>
			<input type="hidden" id="hos_id" name="hos_id" class="edit_item"/>
			<table class="table-layout">
				<tr>
					<td class="label leftText"><span style="color:red;">*</span>职工分类：</td>
					<td class="ipt">
						<select id="emp_kind_code" style="width:180px;">
					</td>
				</tr>
				<tr>
