...
<script type="text/javascript">
	...
	var initGrid = function(){
		var columns = [
   			...
   			{ display : '单位应缴公积金', name : 'unit_amount', width : 120 },
   			{ display : '个人应缴公积金', name : 'individual_amount', width : 120 },
   			{ display : '合计', name : 'amount_count', width : 120 }
   		];
   		var paramObj = {
   			height : '100%',
   			inWindowHeight : true,
	...
	var query = function(){
		...
		grid.loadData(param, "queryHrFund.do");
	}
</script>
</head>
<body>
