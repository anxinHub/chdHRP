...
<head>
	...
	var formValidate;
	    ...
	    var cellClick = function(event,ui){
	    	if(ui.dataIndx=="col_codes"){
		    	grid.getColumns()[2].editor.url ='<%=path%>/hrp/hr/salarymanagement/standard/queryStandardColCodeOption.do?isCheck=false&code='+ui.rowData.tab_code+'&is_pk=0';
	    	}
	    	return true;
	    }
		...
		<form id="changeform">
		 <table class="table-layout" style="width: 100%;">
	        <tr>
	            ...
	            <td class="ipt">
	                <input id="type_code" name="type_code" type="text" style="width:150px;" />
	            </td>
	            <td class="label"><font size="2" color="red">*</font>薪资变动类型名称：</td>
	            <td class="ipt">
	                <input id="type_name" placeholder="如 ：入职定薪" name="type_name" type="text" style="width:150px;" />
	            </td>
	        ...
	        <tr>
	            ...
	            <td class="ipt" colspan="5">
	                <input  id="note" type="text" name="note" style="width:888px;" />
	            </td>
	        </tr>
    	</table>
    	</form>
