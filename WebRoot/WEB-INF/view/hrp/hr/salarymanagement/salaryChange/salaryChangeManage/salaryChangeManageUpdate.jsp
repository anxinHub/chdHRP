	...
	var formValidate;
        ...
        var initValidate = function () {
    		...
    		change_type = $("#change_type").etSelect({
    			...
    			defaultValue: 'none',
    			defaultOption: {id: '${vo.CHANGE_TYPE}', text: '${vo.CHANGE_TYPE}'},
    			onChange:function(id){
    				type_code = id;
    		    	grid.loadData([],'queryUpdateSalaryChangeTypeSalaryProject.do?isCheck=false&change_code='+'${vo.CHANGE_CODE}');
    		    	grids.loadData([],'queryUpdateSalaryChangeTypeSalaryManageProject.do?isCheck=false&change_code='+'${vo.CHANGE_CODE}');
    			}
    		});
        	...
        	$("#save").click(function(){
        		...
        		var forms = $("#manageform").serialize();
              	...
              	forms += "&emp_id="+emp_id.getValue()+"&change_type="+change_type.getValue();
	    ...
	    var endload = function(){
            change_type.setValue('${vo.CHANGE_TYPE}')
            emp_id.setValue('${vo.EMP_ID}'.toString().split(","));
	    }
		...
		<form id="manageform">
		 <table class="table-layout" style="width: 100%;">
	        <tr>
	            ...
	            <td class="ipt">
	            	<input type="hidden" id="change_code" value="${vo.CHANGE_CODE}" name="change_code">
	                <input value="${vo.CHANGE_CODE}" disabled type="text" style="width:150px;" />
	            </td>
	            <td class="label">变动类型<font size="2" color="red">*</font>：</td>
	            <td class="ipt">
	                <input id="change_type" style="width:150px;" />
	            </td>
	            <td class="label">制单日期<font size="2" color="red">*</font>：</td>
	            <td class="ipt">
	                <input  id="make_date" value="${vo.MAKE_DATE}" name="make_date" style="width:150px;" />
	            </td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	            ...
	            <td class="ipt" colspan="5">
	                <input  id="remark" value="${vo.REMARK}" type="text" name="remark" style="width:872px;" />
	            </td>
	        </tr>
	        <tr>
		        <td class="label">生效日期<font size="2" color="red">*</font>：</td>
				<td class="ipt">
	                	<input type="text" value="${vo.EFFECTIVE_DATE}" id="effective_date" name="effective_date" style="width:180px;"/>
	            </td>
            </tr>
    	</table>
    	</form>
