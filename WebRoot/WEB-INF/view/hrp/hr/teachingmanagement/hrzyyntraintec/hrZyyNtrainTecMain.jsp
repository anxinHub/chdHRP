<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <head>
        ...
        <script>
            var grid, record_select, profession_select, dept_select,year,year,month;
            var initColumns = function () {
            	 ajaxPostData({
                     url: 'queryHrZyyNtrainSetTec.do?isCheck=false',
                     data: { year: $("#year").val() },
	 							...
	 							editor: {
        							type: 'grid',
         							columns: [
         								...
         								height: '205px',
         								dataModel: {
             								url: 'queryComboBoxTec.do?isCheck=false',
         											},
     											},editable : function (col){
     					            			    if(col.rowData){
     					            				    if(col.rowData.hos_id != null && col.rowData.group_id != null){
            ...
            var initSelect = function () {
                record_select = $("#record_select").etSelect({
                    url: 'queryEducationComboBoxTec.do?isCheck=false',
                    defaultValue: 'none',
                    onChange: query
                });

                profession_select = $("#profession_select").etSelect({
                    url: 'queryProfessionalComboBoxTec.do?isCheck=false',
                    defaultValue: 'none',
                    onChange: query
                });
                ...
                dept_select = $("#dept_select").etSelect({
                    url: 'queryDeptComboBoxTec.do?isCheck=false',
                    defaultValue: 'none',
                    onChange: query
                });
            }
            ...
            var query = function () {
                ...
                grid.loadData(params,'queryHrZyyNtrainTec.do');
            };
            var print = function () { if(grid.getAllData()==null){
        	...
        	var printPara={
                title: "住院医师规培轮转成绩表（医技）打印",//标题
                columns: JSON.stringify(grid.getPrintColumns()),//表头
                class_name: "com.chd.hrp.hr.service.teachingmanagement.HrZyyNtrainTecService",
                method_name: "queryZyyNtrainTecByPrint",
                bean_name: "hrZyyNtrainTecService",
	  ...
	  var putin = function () { 
		  var para = {
	    		...
	    		importSpreadView("/hrp/hr/teachingmanagement/importZyyNtrainTec.do?isCheck=false", para, query);
      ...
      var save = function () {
          ...
          ajaxPostData({
              url: 'addOrUpdateHrZyyNtrainTec.do',
              data: {
