...
<head>
    ...
    <script>
        ...
        var query = function () {
            ...
            grid.loadData(params,"queryCardiopulmonary.do");
        };
        ...
        var cancel = function () {
            ...
            if (data.length == 0) {
                ...
                $.etDialog.confirm('确定撤回?', function () {
                    ajaxPostData({
                        url: 'reConfirmCardiopulmonary.do',
                        data: {
                            paramVo: JSON.stringify(ParamVo)
                        },
                        success: function () {
...
$.etDialog.confirm('确定删除?', function () {
        ...
        var putin = function () {
        	var para = {
        		...
        		importSpreadView("/hrp/hr/nursing/importCPR.do?isCheck=false", para, query);
      ...
      /*   var putout = function () { 
        ...
        var initGrid = function () {
          ...
          /*       {
                ...
                { display: '', name: 'level_code', hidden: true, },
                { display: 'CPR考核成绩', name: 'cpr_score', width: 120,
                	editor: {
                		type: 'number'
                    } },
