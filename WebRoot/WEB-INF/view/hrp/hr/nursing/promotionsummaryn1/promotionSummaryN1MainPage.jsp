...
<head>
    ...
    <script>
        ...
        var query = function () {
            ...
            grid.loadData(params,"queryPromotionSummaryN1.do");
        };
        ...
        var print = function () {
        	...
        	var printPara={
                title: " 护理晋级汇总申请表N1打印",//标题
                columns: JSON.stringify(grid.getPrintColumns()),//表头
                class_name: "com.chd.hrp.hr.service.nursing.HrPromotionSummaryN1Service",
                method_name: "queryPromotionN1ByPrint",
                bean_name: "hrPromotionSummaryN1Service",
      ...
      /*       var isPass = grid.validateTest({
        ...
        // 科护长审核
        var section_chief_auditN1 = function () {
         	var errorMsg = '';//错误提示信息
            var ParamVo = [];
            var data = grid.selectGet();
            if (data.length == 0) {
        ...
        // 科护长销审
        var section_chief_unauditN1 = function () {
        	var ParamVo = [];
            var data = grid.selectGet();
            if (data.length == 0) {
                $.etDialog.error('请选择行');
        ...
        // 晋级小组意见
        var advocacy_team_commentsN1 = function () {
         	var errorMsg = '';//错误提示信息
        ...
        var initFrom = function () {
            ...
            $("#nurse_auditN1").on('click', nurse_auditN1);
            $("#nurse_unauditN1").on('click', nurse_unauditN1);
            $("#section_chief_auditN1").on('click', section_chief_auditN1);
            $("#section_chief_unauditN1").on('click', section_chief_unauditN1);
            $("#advocacy_team_commentsN1").on('click', advocacy_team_commentsN1);
        ...
        var initGrid = function () {
            ...
            var paramObj = {
                ...
                editable: true,
                /* dataModel: {
                    url: 'queryPromotionSummaryN1.do?isCheck=false'
                }, */
                columns: columns
            };
...
<body>
    ...
    <div class="button-group" style="text-align: left;">
        ...
        <button id="nurse_auditN1">护士长审核</button>
        <button id="nurse_unauditN1">护士长销审</button>
        <button id="section_chief_auditN1">科护长审核</button>
        <button id="section_chief_unauditN1">科护长销审</button>
        <button id="advocacy_team_commentsN1">晋级小组意见</button>
