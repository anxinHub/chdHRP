...
<head>
    ...
    <script>
        var year, dept_code, duty_code, title_code, level_code, emp_id;
        var grid;
        ...
        var query = function () {
            ...
            grid.loadData(params,"queryAcademicAbilityStatistics.do");
        };
        ...
        var print = function () {
        	...
        	var printPara={
              		...
              		class_name: "com.chd.hrp.hr.service.nursing.HrAcademicStatisticsService",
           			method_name: "queryAcademicStatisticsPrint",
           			bean_name: "hrAcademicStatisticsService",
        ...
        var initGrid = function () {
            ...
            /*     { display: '统计年度', name: 'year', width: 120 }, */
                ...
                { display: '个案分析报告', name: 'special_case_analy', width: 120 },
            ...
            var paramObj = {
                ...
                checkbox: true,
                /* dataModel: {
                    url: 'queryAcademicAbilityStatistics.do'
                }, */
                columns: columns,
                toolbar: {
                    items: [
