...
<head>
    ...
    <script>
        ...
        var query = function () {
            ...
            grid.loadData(params,"queryWritten.do");
        };
        ...
        var putin = function () {
        	var para = {
        		...
        		importSpreadView("/hrp/hr/nursing/importWrite.do?isCheck=false", para, query);
        ...
        var initGrid = function () {
            ...
            var paramObj = {
                ...
                editable: true,
                /* dataModel: {
                     url: 'queryWritten.do?isCheck=false'
                }, */
                columns: columns,
                toolbar: {
                    items: [
