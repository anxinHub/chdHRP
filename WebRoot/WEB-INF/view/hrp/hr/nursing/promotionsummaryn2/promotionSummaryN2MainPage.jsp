...
<head>
    ...
    <script>
        ...
        var query = function () {
            ...
            grid.loadData(params,"queryPromotionSummaryN2.do");
        };
        ...
        var print = function () {
        	...
        	var printPara={
                title: " 护理晋级汇总申请表N2打印",//标题
                columns: JSON.stringify(grid.getPrintColumns()),//表头
                class_name: "com.chd.hrp.hr.service.nursing.HrPromotionSummaryN2Service",
                method_name: "queryPromotionN2ByPrint",
                bean_name: "hrPromotionSummaryN2Service",
      ...
      /*       var isPass = grid.validateTest({
        ...
        // 科护长审核
        var section_chief_auditN2 = function () {
         	var errorMsg = '';//错误提示信息
            var ParamVo = [];
            var data = grid.selectGet();
            if (data.length == 0) {
                ...
                $(data).each(function (index) {
                    ...
                    if(rowdata.dhnurse_name == '' || rowdata.dhnurse_name == undefined){
        ...
        // 科护长销审
        var section_chief_unauditN2 = function () {
        	var ParamVo = [];
            var data = grid.selectGet();
            if (data.length == 0) {
                $.etDialog.error('请选择行');
        ...
        // 晋级小组意见
        var advocacy_team_commentsN2 = function () {
         	var errorMsg = '';//错误提示信息
        ...
        var initFrom = function () {
            ...
            $("#nurse_auditN2").on('click', nurse_auditN2);
            $("#nurse_unauditN2").on('click', nurse_unauditN2);
            $("#section_chief_auditN2").on('click', section_chief_auditN2);
            $("#section_chief_unauditN2").on('click', section_chief_unauditN2);
            $("#advocacy_team_commentsN2").on('click', advocacy_team_commentsN2);
        ...
        var initGrid = function () {
            ...
            var paramObj = {
                ...
                editable: true,
                dataModel: {
                    url: 'queryPromotionSummaryN2.do'
                },
                columns: columns
            };
...
<body>
    ...
    <div class="button-group" style="text-align: left;">
        ...
        <button id="nurse_auditN2">护士长审核</button>
        <button id="nurse_unauditN2">护士长销审</button>
        <button id="section_chief_auditN2">科护长审核</button>
        <button id="section_chief_unauditN2">科护长销审</button>
        <button id="advocacy_team_commentsN2">晋级小组意见</button>
