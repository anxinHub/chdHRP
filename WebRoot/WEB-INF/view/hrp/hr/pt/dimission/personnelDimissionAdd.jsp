...
<script type="text/javascript">
	...
	function save() {
		...
		var formPara = {
			...
			emp_id :  liger.get("dim_emp_select").getValue(),
			dim_emp_state : '0',
		};
		
		console.log(formPara),
		
		$.post("addPersonnelDimission.do?tab_code=HR_PERSONNEL_DIMISSION", formPara, function(responseData) {
...
//            	}           
		...
		$("#dept_name").ligerComboBox({
		 ...
		 $("#attend_time").ligerTextBox({width : 180});
	...
	<form name="form1" method="post" id="form1" style="display:blok">
		<table cellpadding="0" cellspacing="0" class="l-table-edit"
		   ...
		   <tr>
				...
				<td align="left" class="l-table-edit-td" ><input id="entity_time" name="entity_time" class="Wdate"  type="text"  onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" /></td>
				<td align="left"></td>
		   </tr>
		   <tr>
				<td align="right" class="l-table-edit-td"
				...
				<td align="left" class="l-table-edit-td" ><input id="dim_app_date" name="dim_app_date" class="Wdate"  type="text"  onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td"  style="padding-left:2px!important;" width="60">确定离职日期：</td>
            	<td align="left" class="l-table-edit-td" ><input name="dim_cert_date" class="Wdate"  type="text" id="dim_cert_date" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" /></td>
				<td align="left"></td>
		   </tr>
		   <tr>
				<td align="right" class="l-table-edit-td"  style="padding-left:20px;">离职申请及其原由：</td>
                <td align="left" class="l-table-edit-td">
                	<textarea rows="3" cols="50" id="dim_reason" name="dim_reason" placeholder="请输入不超过100个字" maxlength="100"></textarea>
                </td>
                <td align="left"></td>
              </tr> 
		</table>
