...
<script type="text/javascript">
	...
	$(function() {
	  ...
	  var initValidate = function () {
          formValidate = $.etValidate({
          	config: {},
          	items: [
  				{ el: $("#chang_emp_code"), required: true },
	...
	function save() {
		if (!formValidate.test()) {
    	   ...
    	   ajaxJsonObjectByUrl("updatePersonnelChange.do", formPara, function(
					responseData) {
	...
	function loadDict() {
		   ...
		   chang_emp_name = $("#chang_emp_name").etSelect({
		      	...
		      	onChange: function (value) {
		      		$("#chang_emp_code").val(value);
// 		      		$.post("queryEmpInfo.do?isCheck=false", {
// 						'tab_code' : 'HOS_EMP',
// 						'chang_emp_code':value,
// 						 'rjt':'json'
					
// 					},function(responseData){
// 		       		 $.each(responseData.Rows,function(i,v){
						
// 							$("#chang_emp_code").val(v.EMP_CODE);
// 				   			$("#chang_emp_unit").val(v.CHANG_EMP_UNIT);
// 				   			$("#chang_entry_time").val(v.CHANG_ENTITY_TIME);
// 				   			$("#bef_station_code").val(v.BEF_STATION_CODE);
// 				   			$("#bef_dept_id").val(v.BEF_DEPT_ID);
		...
		<table class="table-layout flex-item-1">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input
					name="chang_emp_name" type="text" id="chang_emp_name" type="text" style="width:180px;" disabled
					/></td>
				<td align="left"></td>
			<td align="right" class="l-table-edit-td"
					style="padding-left: 20px;">工号：</td>
				<td align="left" class="l-table-edit-td"><input
					name="chang_emp_code" type="text" id="chang_emp_code" type="text"  value="${emp_id}" disabled/></td>
				<td align="left"></td>
			 ...
			 <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="chang_effect_time" type="text"  id="chang_effect_time"  value="${chang_effect_time}" type="text" /></td>
                <td align="left"></td>
                </tr>
             <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">更动原因：</td>
                 <td align="left" class="l-table-edit-td" colspan="4">
                            <textarea rows="2" cols="81" id="chang_reason" name="chang_reason">${chang_reason}</textarea>
                        </td>
                <td align="left"></td>
            </tr> 
                    ...
                    <div class="single-block">
                        <table class="table-layout ">
                            ...
                            <tr>
                                <td class="label">    薪资：</td>
                                <td class="ipt">
                                    <input type="text" id="aft_salary" value="${aft_salary}">
                                </td>
                            </tr>
                            <tr>
                                <td class="label">    薪资幅度：</td>
                                <td class="ipt">
                                    <input type="text" id="aft_salary_float" value="${aft_salary_float}">
                                </td>
                            </tr>
                            <tr>
                                <td class="label">    年薪：</td>
                                <td class="ipt">
                                    <input type="text" id="aft_year_salary" value="${aft_year_salary}">
                                </td>
                            </tr>
                        </table>
                    </div>
