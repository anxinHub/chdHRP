...
<script type="text/javascript">
	...
	function save() {
 	   ...
 	   ajaxJsonObjectByUrl("updateResignation.do", formPara, function(
					responseData) {
	...
	function loadDict() {
		 ...
		 $("#handover_user").ligerComboBox({
		      	...
		      	onSuccess: function (data) {
						this.setValue("${handover_user}");
		      	}
			 });
		 $("#resignation_reason").ligerComboBox({
		      	url: '../../baseSelect.do?isCheck=false&&field_tab_code=DIC_RES_REASON',
		      	valueField: 'id',
		       	textField: 'text', 
		       	selectBoxWidth: 160,
		      	autocomplete: true,
		      	width: 160,
		      	onSuccess: function (data) {
						this.setValue("${resignation_reason}");
		      	}
			 });
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
			 ...
			 <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="resignation_date" type="text" class="Wdate"  value="${ resignation_date}" id="resignation_date" ltype="text" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"  /></td>
                <td align="left"></td>
                </tr>
		  ...
		  <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	 <textarea rows="3" cols="30" id="handover_note" name="handover_note">${handover_note}</textarea> 
                </td>
                <td align="left"></td>
            </tr> 
