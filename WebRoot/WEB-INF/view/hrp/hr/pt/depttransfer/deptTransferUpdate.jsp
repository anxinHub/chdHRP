...
<script type="text/javascript">
	...
	function save() {
    	   ...
    	   ajaxJsonObjectByUrl("updateDeptTransfer.do", formPara, function(
					responseData) {
		...
		transfer_date = $("#transfer_date").etDatepicker();
		 ...
		 emp_id = $("#emp_id").etSelect({
		      	...
		      	onChange: function (value) {
		             ...
		             defaultOption: {id: ${emp_id}, text: "${emp_name}"}
		             

			 });
		 aft_dept_id = $("#aft_dept_id").etSelect({
             url: "../../baseSelect.do?isCheck=false&&field_tab_code=SYS_DEPT",
             defaultOption: {id: ${aft_dept_id}+'@'+${aft_dept_no}, text: "${dept_name}"}
		...
		<table class="table-layout flex-item-1">
			...
			<td align="right" class="l-table-edit-td"
			 ...
			 <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="transfer_date" type="text" value="${transfer_date}"  id="transfer_date" type="text" /></td>
                <td align="left"></td>
                </tr>
             <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">更动原因：</td>
                 <td class="ipt" class="l-table-edit-td" colspan="4">
                            <textarea rows="2" cols="81" id="transfer_reason" name="transfer_reason">${transfer_reason}</textarea>
                        </td>
                <td align="left"></td>
            </tr> 
                    ...
                    <div class="single-block">
                        <table class="table-layout ">
                            <tr>
                                ...
                                <td class="ipt">
                                    <input type="text" id="bef_dept_id" disabled value="${bef_dept_name}">
                                </td>
                            </tr>
                        </table>
                    </div>
