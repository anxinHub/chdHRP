...
<head>
    ...
    <script>
        ...
        var query = function () {
            ...
            grid.loadData(params, 'queryPaperStatistics.do');
        };
        /* var putOut = function () {
        	exportGrid(grid);
        }; */
        var print = function () { 
        	...
        	var printPara={
                ...
                method_name: "queryPaperDynamicTabHeadByPrint",
        ...
        var initColumns = function () {
            ajaxPostData({
                url: 'queryPaperDynamicTabHead.do?isCheck=false&field_tab_code=DIC_PAPER_TYPE',
                ...
                success: function (res) {
                    var gridColumns = [
                        ...
                        { display: '学术论文发表', columns: res.columns},
                        { display: '学术论文积分', name: 'SCORE', width: 130 },
                    ];
                    grid.option('columns', gridColumns);
                    grid.option('title','学术论文发表（满分：'+res.fullScore.paper+'分）')
                    grid.refreshView();
