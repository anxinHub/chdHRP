...
<head>
    ...
    <script>
        ...
        var query = function () {
            ...
            grid.loadData(params, 'queryHonorStatistics.do');
        };
        /* var putOut = function () { 
        	exportGrid(grid);
        }; */
        ...
        var print = function () { 
        	...
        	var printPara={
                ...
                method_name: "queryHonorStatisticsByPrint",
        ...
        var initColumns = function () {
            ajaxPostData({
                url: 'queryDynamicTabHead.do?isCheck=false&field_tab_code=DIC_ACADE_HONOR',
                ...
                success: function (res) {
                    var gridColumns = [
                        ...
                        { display: '个人学术荣誉', columns: res.columns },
                        { display: '个人学术荣誉积分', name: 'SCORE', width: 120, align: 'center' },
                    ];
                    grid.option('columns', gridColumns);
                    grid.option('title','荣誉统计（满分：'+res.fullScore.acade_honor+'分）')
                    grid.refreshView();
        ...
        var initGrid = function () {
            var paramObj = {
                ...
                columns: [
                    ...
                    { display: '职工工号', name: 'EMP_CODE', width: 80 },
                    { display: '职工名称', name: 'EMP_NAME', width: 80 },
                    { display: '个人学术荣誉', columns: [], width: 120 },
                    { display: '个人学术荣誉积分', name: 'SCORE', width: 120, align: 'center' },
                ],
                toolbar: {
                    items: [
