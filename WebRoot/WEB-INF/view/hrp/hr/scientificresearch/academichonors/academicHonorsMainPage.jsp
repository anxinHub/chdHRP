...
<head>
    ...
    <script>
        var apply_date, honor_code, state;
        var grid;
        ...
        var add = function () {
            parent.$.etDialog.open({
                url: 'hrp/hr/scientificresearch/addAcademicHonorsPage.do?isCheck=false',
         	   width: $(window).width(),
...
$.etDialog.confirm('确定删除?', function () {
        ...
        var openUpdate = function (rowData) {
        	 parent.$.etDialog.open({
                url: 'hrp/hr/scientificresearch/updateAcademicHonorsPage.do?isCheck=false&emp_id=' + rowData.emp_id+'&apply_no='+ rowData.apply_no+'&honor_code='+ rowData.honor_code,
                title: '修改',
         	   width: $(window).width(),
               height: $(window).height(),
            })
        ...
        var initGrid = function () {
            var columns = [
                ...
                { display: '荣誉名称', name: 'honor_name', width: 120 },
                { display: '获得日期', name: 'get_date', width: 120 },
