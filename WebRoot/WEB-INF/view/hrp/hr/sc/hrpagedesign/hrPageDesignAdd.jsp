...
<script type="text/javascript">
	...
	function save() {
		...
		ajaxJsonObjectByUrl("addHrPageDesign.do?isCheck=false", formPara, function(responseData) {
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td">
					<input name="page_code" type="text" id="page_code" ltype="text" required="true" validate="{required:true}" />
				</td>
				<td align="left"></td>
			</tr>
			<tr>
				...
				<td align="left" class="l-table-edit-td">
					<input name="page_name" type="text" id="page_name" ltype="text" required="true" validate="{required:true}" />
				</td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td"
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td" colspan="5">
					<textarea name="note" id="note" rows="4" cols="5" style="width:100%"></textarea>
				</td>
