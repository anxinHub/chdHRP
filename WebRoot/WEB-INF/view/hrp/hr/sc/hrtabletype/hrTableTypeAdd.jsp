        	...
        	<form>
	            <table class="table-layout">
	                ...
	                <tr>
	                    ...
	                    <td class="ipt">
	                        <input type="text" name="table_sort" id="table_sort" style="width:180px;"/>
	                    </td>
	                </tr>
	                <tr>
	                    <td class="label">备注：</td>
	                    <td class="ipt" colspan="3">
	                        <textarea name="table_note" id="table_note" style='width:488px' class="wishContent" placeholder="请输入不超过100个字" maxlength="100"></textarea>
	                    </td>
	                </tr>
	            </table>
            </form>
