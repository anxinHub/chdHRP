...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
					{
				columns : [
					{display : '设计器编码',name : 'design_code',align : 'left',editor : {type : 'text'},width : 80},
					{display : '设计器名称',name : 'design_name',align : 'left',editor : {type : 'text'},width : 80},
					{display : '上级编码',name : 'super_code',align : 'left',editor : {type : 'text'},width : 80},
					{display : '级别',name : 'design_level',align : 'left',editor : {type : 'text'},width : 50},
					{display : '是否末级',name : 'is_last',align : 'left',editor : {type : 'text'},width : 50},
					{display : 'JSON查询设计器',	name : 'design_query_col',align : 'left',editor : {type : 'text'},width : 150},
					{display : 'JSON动态页面构建',name : 'design_query_page',align : 'left',	editor : {type : 'text'},width : 150},
					{display : '排序',name : 'design_sort',align : 'left',editor : {	type : 'text'},width : 50},
					{display : '是否停用',name : 'is_stop',align : 'left',editor : {	type : 'text'},width : 50},
					{display : '备注',name : 'design_note',align : 'left',editor : {type : 'text'},	width : 100},
