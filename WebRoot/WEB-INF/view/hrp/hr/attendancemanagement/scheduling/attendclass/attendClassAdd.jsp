...
<head>
    ...
    <script>
        var year, begin_date, end_date,attend_begtime1,attend_endtime1,attend_begtime2,attend_endtime2,attend_begtime3,attend_endtime3;
        var formValidate;
	...
	<div class="button-group">
		 <table class="table-layout" style="width: 100%;">
	        <tr>
	            ...
	            <td class="ipt">
	                <input id="attend_classcode"  type="text" />
	            </td>
	        </tr>
	        <tr>
	            <td class="label "><font size="2" color="red">*</font>班次名称：</td>
	            <td class="ipt">
	                <input id="attend_classname" type="text" />
	            </td>
	        </tr>
	        ...
	        <tr>
	            ...
	            <td class="ipt">
	                <input id="attend_classsname" type="text" />
	            </td>
	        </tr>
	         <tr>
	        ...
	        <tr>
	            ...
	            <td class="ipt">
	                <input id="attend_begtime1"  type="text" placeholder="HH:mm" style="width: 120px;"/>
	                <input id="attend_endtime1" type="text" placeholder="HH:mm" style="width: 120px;"/>
	                <a href="javascript:void(0)" id="a1" placeholder="HH:mm" onclick="doSomething1()">增加</a>
	            </td>
	        </tr>
            <tr id="attend2" style="display:none">
	            <td class="label ">上下班时间2：</td>
	            <td class="ipt">
	                <input id="attend_begtime2"  type="text" placeholder="HH:mm" style="width: 120px;"/>
	                <input id="attend_endtime2" type="text" placeholder="HH:mm" style="width: 120px;"/>
            ...
            <tr id="attend3" style="display:none">
	            ...
	            <td class="ipt">
	                <input id="attend_begtime3"  type="text" placeholder="HH:mm" style="width: 120px;"/>
	                <input id="attend_endtime3" type="text" placeholder="HH:mm" style="width: 120px;"/>
	        ...
	        <tr>
	            ...
	            <td class="ipt">
	                <input id="attend_days" type="number" step="0.5" min="0.5"/>
	            </td>
	        </tr>
    	</table>
