    ...
    <%String path = request.getContextPath();%>
        ...
        <head>
           <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
            ...
            <script>
				var leftTree, rightTree,attend_areacode,attend_pbrule;
                var attend_class_typecode;
				...
				/* function checkTree() {
             	...
             	function initTree() {
                    ...
                    $("#save").click( function () {
						...
						if($('#attend_areacode').val().length>4){
							$.etDialog.error('区域编码不能超过4位');
                            return;
						}
	    ...
	    <div class="main" style="float:left;">
	        <table class="table-layout">
	            <tr>
	                ...
	                <td class="ipt">
	                    <input id="attend_areacode"  type="text" />
	                </td>
                </tr>
                <tr>
	                  <td class="label"><font size="2" color="red">*</font>区域名称：</td>
	                <td class="ipt">
	                    <input id="attend_area_name"     type="text" />
	                </td>
                </tr>
                <tr>
