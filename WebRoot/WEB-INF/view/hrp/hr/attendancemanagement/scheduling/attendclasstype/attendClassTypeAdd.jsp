                  ...
                  ajaxPostData({
                     url: 'addAttendClassType.do',
                      ...
                      success: function (responseData) {
                    	  $('#attend_class_typecode').val(""),
                    	  $('#attend_class_typename').val("")
        ...
        function checked(){
        	var dataValidate = $.etValidate({
        		...
        		items:[
        			...
        			{ el : $('#attend_class_typename'), required : true }
        		]
        	});
...
<body>
	<div class="button-group" style="overflow-y: auto">
		 <table class="table-layout" style="width: 100%;">
	        <tr>
	            <td class="label "><font color="red">*</font>班次分类编码：</td>
	            <td class="ipt">
	                <input id="attend_class_typecode" type="text" />
	            </td>
	        </tr>
	        <tr>
	            <td class="label "><font color="red">*</font>班次分类名称：</td>
	            <td class="ipt">
	                <input id="attend_class_typename" type="text" />
	            </td>
	        </tr>
    	</table>
