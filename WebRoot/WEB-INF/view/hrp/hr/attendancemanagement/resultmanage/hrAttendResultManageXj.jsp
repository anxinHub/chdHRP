...
<script type="text/javascript">
	...
	var query = function (queryFor) {
		...
		grid.loadData(params, "queryAttendResultManageXj.do?isCheck=false");
	};
	
	var initGrid = function () {
		var columns = [ {
			display: '休假申请编号', name: 'attend_overtime_code', width: 120, 
		}, {
			display: '休假类型', name: 'attend_name', width: 120,
		}, {
			display: '休假开始时间', name: 'begin_date', width: 120,
		}, {
			display: '休假结束时间', name: 'end_date', width: 120,
		}, {
			display: '休假天数', name: 'attend_accchadays', width: 120, align: "right", 
		} ];
