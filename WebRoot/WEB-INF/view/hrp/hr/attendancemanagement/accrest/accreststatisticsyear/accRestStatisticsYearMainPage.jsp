...
<script type="text/javascript">
        ...
        var query = function () {
            ...
            grid.loadData(params,'queryAccRestStatisticsYear.do?isCheck=false');
        };
        ...
        var initGrid = function () {
            var columns = [
                ...
                { display: '增加天数', name: 'add_days', width: 120,
                    render: function (ui) {
                        var updateHtml =
                ...
                { display: '减少天数', name: 'attend_xjdays', width: 120,
                        render: function (ui) {
                            var updateHtml =
                                '<a class="openUpdate1" row-index="' + ui.rowIndx + '">' +
                                ui.cellData +
                                '</a>'
                            return updateHtml;
                }}, 
            /*     { display: '期末天数(实际)', name: 'attend_xjdays', width: 120 }, */
            ...
            $("#mainGrid").on('click', '.openUpdate', function () {
                ...
                if(currentRowData.add_days!=0){
                	 parent.$.etDialog.open({
                 		...
                 		url:"hrp/hr/attendancemanagement/attend/hrOvertimeYearPage.do?isCheck=false&emp_id=" + currentRowData.emp_id,
                 		title: '增加详情',
                 	})	
                }
            ...
            $("#mainGrid").on('click', '.openUpdate1', function () {
                ...
                if(currentRowData.attend_xjdays!=0){
                	 parent.$.etDialog.open({
                		width:$(window).width()-40,
                        height: $(window).height()-40,
                		url:"hrp/hr/attendancemanagement/attend/applyLeaveYearPage.do?isCheck=false&emp_id=" + currentRowData.emp_id,
                		title: '减少详情',
                	})
                }
            }) 
        ...
        function printData(){
        	...
        	var printPara={
          		...
          		class_name: "com.chd.hrp.hr.service.attendancemanagement.accrest.HrAccRestStatisticsYearService",
       			bean_name: "hrAccRestStatisticsYearService",
       			method_name: "queryAccRestStatisticsYearPrint",
