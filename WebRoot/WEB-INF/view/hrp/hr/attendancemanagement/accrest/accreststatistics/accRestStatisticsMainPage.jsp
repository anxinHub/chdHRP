...
<script type="text/javascript">
        ...
        var query = function () {
            ...
            grid.loadData(params,'queryAccRestStatistics.do?isCheck=false');
        };
        ...
        function submitData(){
            ...
            if (data.length == 0) {
                ...
                $.etDialog.confirm('确定要计算吗?', function () {
                    ajaxPostData({
                        url: 'updateAccRestStatistics.do',
                        data: {
        ...
        function printData(){
        	...
        	var printPara={
          		...
          		class_name: "com.chd.hrp.hr.service.attendancemanagement.accrest.HrAccRestStatisticsService",
       			bean_name: "hrAccRestStatisticsService",
       			method_name: "queryAccRestStatisticsPrint",
