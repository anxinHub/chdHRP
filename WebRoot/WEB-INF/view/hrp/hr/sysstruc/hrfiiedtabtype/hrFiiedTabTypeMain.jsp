<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <head>
        ...
        <title>hrFiiedtabTypeMain</title>
        ...
        <script>
            ...
            function update(data, index, value) {
                ...
                $.etDialog.open({
                    url: 'hrFiiedTabTypeUpdatePage.do?isCheck=false&' + parm,
                    height: 320,
                    width: 650,
                    title: '代码表数据修改页',
                    btn: ["确定", "取消"],
            ...
            function add() {
                $.etDialog.open({
                    url: 'hrFiiedTabTypeAddPage.do?isCheck=false',
                    height: 300,
                    width: 700,
                    title: '代码表数据添加页',
                    btn: ['确定', '取消'],
            ...
            function search() {
                ...
                grid.loadData(param,'queryHrFiiedTabType.do');
            }
            //导入数据
            function importDate(){
    		var para = {
    		  ...
    		  importSpreadView("/hrp/hr/sysstruc/hrfiiedtabtype/importDateHDTT.do?isCheck=false", para, search);  
    	}
        </script>
    </head>
