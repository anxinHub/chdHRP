...
<html style="overflow:hidden;">
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("hrFunSetupdate.do",formPara,function(responseData){
             ...
             columns: [ 
 					...
 					editor: {
  					...
  					{ display: '参数类型', name: 'com_type_code',textField: 'com_type_name', align: 'left',width:110,
                       ...
                       usePager:false,url:'queryhrFunParaByFunCode.do?isCheck=false&fun_code=${fun_code}',
      ...
      function remove(){
          ...
          if (data.length == 0){
              ...
              $.ligerDialog.confirm('确定删除?', function (yes){
              	if(yes){
                  	ajaxJsonObjectByUrl("deleteHrFunParaByFunCode.do?isCheck=false",{ParamVo : ParamVo.toString()},function (responseData){
                  		if(responseData.state=="true"){
                  			query();
                  			loadTree();
                  		}
 ...
 function validateGrid() {
    ...
    function intiProcBody(){
    	...
    	str = str + "&nbsp;&nbsp;HR_APPCODE OUT NUMBER,&nbsp;&nbsp;<br/>"
   ...
   <div id="layout1" style="height: 100%;">
            <div  position="left" title="函数" style="left: 0px; top: 0px;  height: 99%;">
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="prc_name" disabled="disabled" type="text" id="prc_name" ltype="text" value="${prc_name}" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%"  style="margin-top: 5px;">
			<tr style="padding-top: 100px;">	
        	 ...
        	 <tr>
                ...
                <td align="left" class="l-table-edit-td" colspan="4">
                	<div>
    				<textarea id="fun_sql" style="width:100%;height:330px;overflow:scroll;"></textarea>
					</div>
                </td>
                <td align="left"></td>
            </tr> 
