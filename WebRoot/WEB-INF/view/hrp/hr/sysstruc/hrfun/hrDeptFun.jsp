...
<script type="text/javascript">
    ...
    function loadComType(obj){
    	ajaxJsonObjectByUrl("../hpmfunpara/queryComTypeParaByDept.do?isCheck=false&fun_code="+obj+"&acc_year=${acc_year}&acc_month=${acc_month}&goal_code=${goal_code}&kpi_code=${kpi_code}&dept_id=${dept_id}", {},
