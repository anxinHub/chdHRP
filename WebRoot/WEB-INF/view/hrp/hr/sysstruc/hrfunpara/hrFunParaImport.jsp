...
<script type="text/javascript">
		...
		function loadHead() {
				...
				{ display: '参数栈序列', name: 'stack_seq_no', align: 'left',editor:{type:'text'}},
				{ display: '部件类型', name: 'com_type_code', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchHpmFunPara.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
