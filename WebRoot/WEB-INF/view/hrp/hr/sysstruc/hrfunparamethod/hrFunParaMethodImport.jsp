...
<script type="text/javascript">
		...
		function plupload(){  
			$("#uploader").pluploadQueue({    
				...
				url : "readHpmFunParaMethodFiles.do?isCheck=false",    
				chunk_size : '2mb',           
				filters : {                
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
			columns : [
				{display : '参数代码',name : 'para_code',align : 'left',editor : {type : 'text'}},
				{display : '参数名称',name : 'para_name',align : 'left',editor : {type : 'text'}},
				{display : '取值方法',name : 'para_sql',align : 'left',editor : {type : 'text'}},
	...
	function itemclick(item) {
		if (item.id) {
			...
			case "save":
				...
				ajaxJsonObjectByUrl("addBatchHpmFunParaMethod.do?isCheck=false", {ParamVo : JSON.stringify(data)}, function(responseData) {
