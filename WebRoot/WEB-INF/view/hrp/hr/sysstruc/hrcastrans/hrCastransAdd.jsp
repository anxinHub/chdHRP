        ...
        <div class="main">
            <table class="table-layout" border='0'>
                <tr>
                    ...
                    <td class="ipt">
                        <select name="main_col_code" id="main_col_code" style="width:180px;"></select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="ipt">
                        <input type="text" name="cas_level" id="cas_level" style="width:180px;" />
                    </td>
                ...
                <tr>
                    ...
                    <td class="ipt" colspan="3">
                        <textarea name="cas_sql" id="cas_sql" style='width:510px;height:80px'></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="label">备注：</td>
                    <td class="ipt" colspan="3">
                        <textarea name="note" id="note" style='width:510px;height:80px' class="wishContent" placeholder="请输入不超过100个字" maxlength="100"></textarea>
                    </td>
                </tr>
            </table>
        </div>
