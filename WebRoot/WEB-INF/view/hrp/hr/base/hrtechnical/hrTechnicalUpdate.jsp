    ...
    <script>
        ...
        var initValidate = function () {
            formValidate = $.etValidate({
                items: [
                    { el: $("#technical_code"), required: true },
                    { el: $("#technical_name"), required: true },
        ...
        var save = function () {
            ...
            ajaxPostData({
                url: 'updateTechnicalLevel.do',
                data: {
                    technical_code: $("#technical_code").val(),
...
<body>
    <table class="table-layout" style="width: 100%;">
        <tr>
            <td class="label no-empty">技术等级编码：</td>
            <td class="ipt">
                <input id="technical_code" type="text" value="${technical_code}" disabled="disabled"/>
            </td>
        </tr>
        <tr>
            <td class="label no-empty">技术等级名称：</td>
            <td class="ipt">
                <input id="technical_name" type="text" value="${technical_name}"/>
            </td>
        </tr>
        <tr>
