    ...
    <script>
        ...
        var initValidate = function () {
            formValidate = $.etValidate({
                items: [
                    { el: $("#title_level_code"), required: true },
                    { el: $("#title_level_name"), required: true },
        ...
        var save = function () {
            ...
            ajaxPostData({
                url: 'updateTitleLevel.do',
                data: {
                    title_level_code: $("#title_level_code").val(),
                    title_level_name: $("#title_level_name").val(),
...
<body>
    <div class="mian">
        <table class="table-layout" style="width: 100%;">
            <tr>
                <td class="label no-empty">职称等级编码：</td>
                <td class="ipt">
                    <input id="title_level_code" type="text" value="${title_level_code}" disabled="disabled"/>
                </td>
            </tr>
            <tr>
                <td class="label no-empty">职称等级名称：</td>
                <td class="ipt">
                    <input id="title_level_name" type="text" value="${title_level_name}" />
                </td>
            </tr>
            <tr>
