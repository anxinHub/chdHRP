...
<head>
    ...
    <script>
        ...
        var save = function () {
            ...
            ajaxPostData({
                url: 'updateTitleInfo.do?isCheck=false',
                data: {
...
<body>
    <table class="table-layout" style="width: 100%;">
        <tr>
            ...
            <td class="ipt">
                <input id="title_code" type="text" value="${title_code}" disabled="disabled"/>
            </td>
        </tr>
        <tr>
            <td class="label no-empty">职称名称：</td>
            <td class="ipt">
                <input id="title_name" type="text" value="${title_name}"/>
            </td>
        </tr>
        <tr>
