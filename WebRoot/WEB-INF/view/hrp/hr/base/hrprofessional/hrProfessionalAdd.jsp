	...
	<div class="mian">
		<table class="table-layout" style="width: 100%;">
			<tr>
				...
				<td class="ipt"><input id="professional_code" type="text" /></td>
			</tr>
			<tr>
				<td class="label no-empty">专业名称：</td>
				<td class="ipt"><input id="professional_name" type="text" /></td>
			</tr>
			<tr>
				<td class="label no-empty">是否停用：</td>
				<td class="ipt"><input id="is_stop" type="text"
					style="width: 180px;" /></td>
			</tr>
			<tr>
				<td class="label">备注：</td>
				<td class="ipt"><textarea id="note" rows="20" cols="25"></textarea></td>
			</tr>
		</table>
	</div>
</body>
