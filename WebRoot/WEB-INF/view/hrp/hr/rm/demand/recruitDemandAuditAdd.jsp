...
<script type="text/javascript">
	...
	function save() {
		...
		$.post("addRecruitDemand02.do?isCheck=false&tab_code=HR_RECRUIT_DEMAND", formPara, function(responseData) {
	...
	<form name="form1" method="post" id="form1" style="display:blok">
		<table cellpadding="0" cellspacing="0" class="l-table-edit"
		   ...
		   <tr>
				...
				<td align="left" class="l-table-edit-td"><input value="${attend_time}"
					name="complie_count" type="text" id="complie_count" ltype="text" value="${attend_time}" 
					validate="{required:true,maxlength:100}" disabled="disabled"/></td>
				<td align="left"></td>
		   </tr>
		   <tr>
