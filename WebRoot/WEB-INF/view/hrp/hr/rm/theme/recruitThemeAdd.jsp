...
<script type="text/javascript">
	...
	function save() {
		...
		if(!isnull($("#theme_phone").val())){
			var reg =/^((13|15|18|14|17)+\d{9})$/;
			if(!reg.test($("#theme_phone").val())){					
		...
		$.post("addRecruitTheme.do?isCheck=false&tab_code=HR_RECRUIT_THEME", formPara, function(responseData) {
	...
	function loadDict() {
		...
		$("#start_time").ligerTextBox({width : 175});
		$("#end_time").ligerTextBox({width : 175});
	}
	function this_close() {
		frameElement.dialog.close();
	}
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit"
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="theme_name"
					type="text" id="theme_name" ltype="text"
            	...
            	<td align="left" class="l-table-edit-td" ><input name="start_time" class="Wdate" type="text" id="start_time" validate="{required:true}" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" /></td>
		   </tr>
		   <tr>
				<td align="right" class="l-table-edit-td"  style="padding-left:20px;" width="60">结束日期<span style="color: red">*</span>：</td>
            	<td align="left" class="l-table-edit-td" ><input name="end_time" class="Wdate" type="text" id="end_time" validate="{required:true}" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td"
					style="padding-left: 20px;">联系人<span style="color: red">*</span>：</td>
				<td align="left" class="l-table-edit-td"><input name="user_name"
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input
					name="theme_phone" type="text" id="theme_phone" ltype="text"
				...
				<td align="left" class="l-table-edit-td"><input
					name="theme_email" type="text" id="theme_email" ltype="text"
					validate="{maxlength:100}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input
					name="describe" type="text" id="describe" ltype="text"
					validate="{maxlength:100}" /></td>
				<td align="left"></td>
			</tr>
		   <tr>	
				<td align="right" class="l-table-edit-td"
				 ...
				 <td align="left" class="l-table-edit-td">
                	<select id="theme_state" name="theme_state" >
