...
<script type="text/javascript">
	...
	function save() {
		...
		$.post("addRecruitRecord.do?isCheck=false&tab_code=HR_RECRUIT_RECORD", formPara, function(responseData1) {
			...
			if (responseData1.state == "true") {
				...
				parent.queryCard(data.demand_id); 
				frameElement.dialog.close();
			}else{
				parent.$.ligerDialog.warn("添加招聘纪录表失败！");
			}
		},"json");
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit"
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input
					name="app_name" type="text" id="app_name" ltype="text" 
		   ...
		   <tr>
				...
				<td align="left" class="l-table-edit-td" ><input name="app_birth" class="Wdate"  type="text" id="app_birth" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td"
		   ...
		   <tr>
				...
				<td align="left" class="l-table-edit-td"><input 
					...
					validate="{required:true,maxlength:100}" disabled="disabled"/></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td"
