...
<head>
    ...
    <script>
    var is_stop,duty_code,station_level_code,dept_code,dept_name,duty_name,dept_id,is_flag;
	    var formValidate;
	    ...
	    var initForm = function () {
	    	...
	    	station_level_code = $("#station_level_code").etSelect({
                ...
                defaultValue: '${station_level_code}'
            });
	    ...
	    var save = function () {
	        ...
	        if('${station_name}' != $("#station_name").val()){
            	is_flag = 1;
            }else{
            	is_flag = 0;
            }
    ...
    <div >
        <table class="table-layout" style="width: 100%;">
            <tr>
                ...
                <td class="ipt">
                    <input id="station_code" type="text" style="width: 180px;" value="${station_code}"  disabled="disabled"/>
                </td>
			</tr>
			<tr>
            ...
            <tr>
                ...
                <td class="ipt">
                    <input id="station_name" type="text" style="width: 180px;"  value="${station_name}" />
                </td>
			</tr>
            <tr>
