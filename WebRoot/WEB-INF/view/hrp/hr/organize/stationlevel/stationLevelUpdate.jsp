...
<head>
    ...
    <script>
        var sup_code, is_stop, is_last,is_flag;
        var formValidate;
        ...
        var initValidate = function () {
            formValidate = $.etValidate({
                items: [
                    ...
                    { el: $("#station_level_name"), required: true },
        ...
        var save = function () {
            ...
            if('${station_level_name}' != $("#station_level_name").val()){
            	is_flag = 1;
            }else{
            	is_flag = 0;
            }
            ...
            ajaxPostData({
                url: 'updateStationLevel.do',
                data: {
                    station_level_code: $("#station_level_code").val(),
                    station_level_name: $("#station_level_name").val(),
...
<body>
    <table class="table-layout" style="width: 100%;">
        <tr>
            <td class="label no-empty">岗位等级编码：</td>
            <td class="ipt">
                <input id="station_level_code" type="text" value="${station_level_code}" disabled="disabled"/>
            </td>
        </tr>
        <tr>
            <td class="label no-empty">岗位等级名称：</td>
            <td class="ipt">
                <input id="station_level_name" type="text" value="${station_level_name}"/>
            </td>
        </tr>
        <tr>
