...
<head>
    ...
    <script>
        ...
        var query = function () {
            ...
            grid.loadData(params,'queryFurtherTracking.do');
        };
        ...
        var print = function () {
        	...
        	var printPara={
                ...
                class_name: "com.chd.hrp.hr.service.medicalmanagement.HrFurtherTrackingService",
                method_name: "queryFurtherTrackingByPrint",
                bean_name: "hrFurtherTrackingService",
        ...
        var initGrid = function () {
            var columns = [
              ...
              /*   { display: '工龄', name: 'workage', width: 120 },
                ...
                { display: '费用', name: 'duration', width: 120 },
