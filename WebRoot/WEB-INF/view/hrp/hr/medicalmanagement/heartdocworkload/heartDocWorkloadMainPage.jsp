...
$.etDialog.confirm('确定删除?', function () {
    ...
    function putin(){
		...
		importSpreadView("/hrp/hr/privilegemanagement/workload/importHeartDocWork.do?isCheck=false", para);
	}
