	...
	var initForm = function() {
	   ...
	   var initGrid = function () {
           ...
           var paramObj = {
               ...
               columns: columns, 
               dataModel: {
                   url: 'queryResearchDetail.do?isCheck=false&in_hos_no='+"${in_hos_no}",
               },
           };
	...
	<div class="flex-item-1 single-block" style="margin:0; padding: 0;">
		<table class="table-layout" style="width: 100%;">
			<tr>
				...
				<td class="ipt">
				 <select id="in_hos_no" style="width:180px;" disabled></select>
			     </td>
	...
	<div class="flex-item-1 single-block" style="margin:0; padding: 0;">
		<table class="table-layout" style="width: 100%;">
			...
			<tr>
				...
				<td class="ipt">
				 <input id="case_no" type="text" value="${case_no}"/>
			     </td>
				<td class="label">参与人员：</td>
				<td class="ipt">
				 <input id="join_doc" type="text" value="${join_doc}"style="width:180px;"/>
				</td>
			</tr>
			<tr>
				<td class="label">讨论意见：</td>
				<td class="ipt">
				<textarea name="opinion" id="opinion" style='width:180px' >${opinion}</textarea>
				<td class="label">具体存在问题分析：</td>
				<td class="ipt">
				<textarea name="prob_reason" id="prob_reason" style='width:180px' >${prob_reason}</textarea>
			</tr>
		</table>
