...
<script>
	...
	var initForm = function() {
		in_hos_no = $("#in_hos_no").etSelect({
              url: "queryResearchInHosNo.do?isCheck=false",
              defaultValue: "none",
	...
	<div class="flex-item-1 single-block">
		<table class="table-layout" style="width: 100%;">
			<tr>
				...
				<td class="ipt">
				 <select id="in_hos_no" style="width:120px;"></select>
			     </td>
				<td class="label">患者名称：</td>
				<td class="ipt"><input id="patient" style="width:120px;" type="text" disabled/></td>
				<td class="label">投诉人：</td>
				<td class="ipt"><input id="plainter" style="width:120px;"type="text" disabled/></td>
			</tr>
			<tr>
				<td class="label">投诉人电话：</td>
				<td class="ipt"><input id="plaint_tel" style="width:120px;" type="text" disabled/></td>
				<td class="label">与患者关系：</td>
				<td class="ipt"><input id="patient_ref" style="width:120px;" type="text" disabled/></td>
				<td class="label">投诉日期：</td>
				<td class="ipt"><input id="plaint_date" style="width:120px;" type="text" disabled/></td>
			</tr>
			<tr>
				<td class="label">发生时间：</td>
				<td class="ipt"><input id="occ_date" style="width:120px;" type="text" disabled/></td>
				<td class="label">投诉内容：</td>
				<td class="ipt"> <textarea name="content"style="width:120px;"  id="content" style='width:168px' disabled></textarea></td>
			</tr>
		</table>
		</div>
	</div>
	...
	<div class="flex-item-1 single-block">
		<table class="table-layout" style="width: 100%;">
			<tr>
				...
				<td class="ipt">
				  <input id="nature_name"  style="width:120px;" type="text" disabled />
			     </td>
				<td class="label">问题归类：</td>
				<td class="ipt">
				 <input id="prob_name" style="width:120px;" type="text" disabled />
				</td>
				<td class="label">病例讨论：</td>
				<td class="ipt">
				 <input id="case_name" style="width:120px;" type="text" disabled/>
				</td>
			</tr>
			<tr>
				<td class="label">病案号：</td>
				<td class="ipt">
				 <input id="case_no" style="width:120px;" type="text" disabled/>
			     </td>
				<td class="label">参与人员：</td>
				<td class="ipt">
				 <input id="join_doc"  style="width:120px;" type="text"  disabled/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="ipt">
					 <input id="deal_type" type="text" style="width:120px;"/>
				</td>
				<td class="label">赔款金额：</td>
				<td class="ipt">
					 <input id="damage" type="text" style="width:120px;"/>
				</td>
				<td class="label">其他款项：</td>
				<td class="ipt">
					 <input id="other" type="text" style="width:120px;"/>
				</td>
			</tr>
		</table>
