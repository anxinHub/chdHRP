...
<script>
	...
	var initLeftGrid = function() {
		...
		var paramObj = {
			...
			showBottom : false,
			dataModel : {
			url: 'queryHrEmpTechExec.do?isCheck=false&emp_id='+"${emp_id}"+'&app_no='+"${app_no}",
			},
			editable : true,
			columns : columns,
		};
	...
	var initRightGrid = function() {
		...
		var paramObj = {
			...
			showBottom : false,
			dataModel : {
			url: 'queryHrEmpTechRef.do?isCheck=false&emp_id='+"${emp_id}"+'&app_no='+"${app_no}",
			},
			editable : true,
			columns : columns,
		};
	...
	<div class="main">
		<table class="table-layout" style="width: 100%;">
			...
			<input id="emp_id" value="${emp_id}"  type="hidden"/>
				...
				<td class="ipt"><input id="app_date" value="${app_date}" type="text" /></td>
				<td class="label">职工名称：</td>
				<td class="ipt"><input id="emp_name" value="${emp_name}"  type="text" disabled/></td>
			</tr>
			<tr>
				<td class="label">手术名称：</td>
				<td class="ipt"><input id="oper_name" value="${oper_name}" type="text" /></td>
				<td class="label">申请类别：</td>
				<td class="ipt"><select id="app_type" value="${app_type}" style="width: 180px;"></select>
				</td>
				<td class="label">备注：</td>
				<td class="ipt"><input id="note" type="text" value="${note}"/></td>
			</tr>
		</table>
	</div>
