		...
		$("#save").click(function() {
            ...
            if(gridAllData!=null){
  		      gridAllData.forEach(function (item) {
  		          	if(item.dept_code!=null || item.dept_code!=undefined ||item.emp_id!=null || item.emp_id!=undefined){
		...
		<table class="table-layout" style="width: 100%;">
			<tr>
				...
				<td class="ipt"><input id="rc_no" type="text" disabled
					value="系统自动生成" /></td>
				<td class="label"><font size="2" color="red">*</font>团队名称：</td>
				<td class="ipt"><input id="team_name" type="text" /></td>
				<td class="label"><font size="2" color="red">*</font>记录人：</td>
				<td class="ipt"><input id="recorder" type="text"></td>
			</tr>
			<tr>
				<td class="label"><font size="2" color="red">*</font>主&nbsp持&nbsp&nbsp人：</td>
				<td class="ipt"><select id="compere" style="width: 180px;"></select></td>
				<td class="label"><font size="2" color="red">*</font>时&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp间：</td>
				<td class="ipt"><input id="rc_date" type="text"></td>
				<td class="label"><font size="2" color="red">*</font>地&nbsp&nbsp&nbsp点：</td>
				<td class="ipt"><input id="site" type="text" /></td>
			</tr>
			<tr>
				<td class="label"><font size="2" color="red">*</font>讨论主题：</td>
				<td class="ipt"><textarea id="title" rows="" cols="25"></textarea></td>
			</tr>
		</table>
	</div>
		...
		<div class="flex-item-1 single-block">
			<div class="flex-wrap">
				<div>
					...
					<textarea id="content" cols="135" rows="30" style="resize:none;"></textarea>
				</div>
			</div>
		</div>
	</div>
