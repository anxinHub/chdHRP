  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgTitleDict.do?isCheck=false",formPara,function(responseData){
 ...
 function loadForm(){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="title_name" type="text" id="title_name" ltype="text" validate="{required:true,maxlength:40}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
