...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "150"); sheet.setText(0, 0, "类别编码");
    	sheet.setColumnWidth(1, "150"); sheet.setText(0, 1, "类别名称");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importBudgEmpTypeDict.do?isCheck=false", para, function(responseData){	
