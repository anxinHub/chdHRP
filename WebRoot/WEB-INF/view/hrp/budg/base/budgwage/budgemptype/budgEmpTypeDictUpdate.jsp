  ...
  <head>
   ...
   <script src="<%=path%>/lib/hrp/budg/budg.js"	type="text/javascript"></script>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgEmpTypeDict.do?isCheck=false",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td"><input name="type_code" type="text" id="type_code" ltype="text" disabled="disabled" value="${type_code}" validate="{required:true,maxlength:20}" /></td>
	            <td align="left"></td>
	        </tr> 
	        <tr>
	            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>类别名称<font color="red">*</font>:</b></td>
	            <td align="left" class="l-table-edit-td"><input name="type_name" type="text" id="type_name" ltype="text" value="${type_name}" validate="{required:true,maxlength:40}" /></td>
	            <td align="left"></td>
	        </tr> 
	        <tr>
