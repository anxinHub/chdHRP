...
<script type="text/javascript">
     ...
     function  save(){
    	 if($("form").valid()){
    		 var formPara={
   		        ...
   		        ajaxJsonObjectByUrl("addBudgSingleDisDict.do?isCheck=true",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>病种编码<font color="red">*</font>:</b></td>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="disease_name" type="text" id="disease_name" ltype="text"   validate="{required:true,maxlength:50}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
