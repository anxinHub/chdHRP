...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgDeptSingleDiseaseFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '科室编码', name: 'dept_id', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchBudgDeptSingleDisease.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
