...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgYbSingleDiseaseFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '病种编码', name: 'disease_code', align: 'left',editor:{type:'text'}},
				{ display: '医保类型编码', name: 'insurance_code', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchBudgYbSingleDisease.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
