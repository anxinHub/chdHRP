...
<script type="text/javascript">
		...
		function plupload(){  	
			$("#uploader").pluploadQueue({    	       
					...
					url : "readBudgYBTypeFiles.do?isCheck=false",    	
					chunk_size : '2mb',           		
					filters : {                		
						mime_types: [  
		...
		grid = $("#maingrid").ligerGrid(
				{
					columns : [
							...
							{display : '医保类型名称',name : 'insurance_name',align : 'left',editor : {type : 'text'}},
							{display : '医保类型性质',name : 'insurance_nature',align : 'left',editor : {type : 'text'}},
