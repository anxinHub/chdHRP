...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgYBType.do?isCheck=true",formPara,function(responseData){
            if(responseData.state=="true"){
				 $("#insurance_code").val('');
				 $("#insurance_name").val('');
				 $("#insurance_nature").val('');
    ...
    function loadDict(){
      	...
      	//医保类型性质
      	autocomplete("#insurance_nature","../../../queryBudgYBTypeNature.do?isCheck=false","id","text",true,true,'',true);
        ...
        $("#save").ligerButton({click: addBudgYBType, width:90});
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="insurance_name" type="text" id="insurance_name" ltype="text" validate="{required:true,maxlength:20}" />
                </td>
                <td align="left"></td>
            </tr>
            <tr>
