...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgChargeStandGetWayFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '费用标准编码', name: 'charge_stand_code', align: 'left',editor:{type:'text'}},
				{ display: '取值方法', name: 'get_value_way', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchBudgChargeStandGetWay.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
