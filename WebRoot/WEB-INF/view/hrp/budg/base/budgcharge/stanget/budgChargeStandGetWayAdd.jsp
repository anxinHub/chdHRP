...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgChargeStandGetWay.do?isCheck=false",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='charge_stand_code']").val('');
				 $("input[name='charge_stand_nature']").val('');
				 $("input[name='charge_stan_describe']").val('');
 ...
 function loadForm(){
   ...
   function loadDict(){
    	...
    	$("#charge_stand_code").ligerTextBox({width:200});
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="charge_stand_nature" type="text" id="charge_stand_nature" ltype="text" disabled="disabled" validate="{maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><font>描述:</font></td>
            <td align="left" class="l-table-edit-td" colspan="4"><input name="charge_stan_describe" type="text" id="charge_stan_describe" disabled="disabled" ltype="text" validate="{maxlength:40}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td" colspan="4"><input name="formula_ca" type="text" id="formula_ca" ltype="text" disabled="disabled" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td" colspan="4"><input name="fun_method_chs" type="text" id="fun_method_chs" disabled="disabled" ltype="text" /></td>
            <td align="left"></td>
        </tr> 
    </table>
    </form>
