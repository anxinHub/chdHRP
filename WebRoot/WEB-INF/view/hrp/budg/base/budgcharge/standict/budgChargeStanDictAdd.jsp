...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgChargeStanDict.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='charge_stan_code']").val('');
				 $("input[name='charge_stan_name']").val('');
				 $("input[name='charge_stan_nature']").val('');
 ...
 function loadForm(){
   ...
   function loadDict(){
    	...
    	//费用标准性质下拉框
        autocomplete("#charge_stan_nature","../../../queryBudgCharStanNature.do?isCheck=false","id","text",true,true,'',false,'',180);
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%" >
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td"><input name="charge_stan_name" type="text" id="charge_stan_name" ltype="text" validate="{required:true,maxlength:40}" /></td>
	            <td align="left"></td>
	        </tr> 
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td"><input name="data_precision" type="text" id="data_precision" ltype="text" validate="{required:true,digits:true,maxlength:4}" /></td>
	            <td align="left"></td>
	        ...
	        <tr>
	            ...
	            <td align="left" colspan="5" class="l-table-edit-td">
	            	<input name="charge_stan_describe" type="text" id="charge_stan_describe" ltype="text" validate="{maxlength:40}" /></td>
	            </td>
	        </tr> 
