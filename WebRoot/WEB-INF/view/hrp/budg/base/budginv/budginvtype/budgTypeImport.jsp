...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readBudgTypeFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
					{
				columns : [
							 { display: '物资类别编码', name: 'mat_type_code', align: 'left',editor:{type:'text'}},
							 { display: '物资类别名称', name: 'mat_type_name', align: 'left',editor:{type:'text'}},
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addBatchBudgType.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
