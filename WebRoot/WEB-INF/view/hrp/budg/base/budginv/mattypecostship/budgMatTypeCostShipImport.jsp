...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgMatTypeCostShipFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '物资类别', name: 'mat_type_code', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchBudgMatTypeCostShip.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
