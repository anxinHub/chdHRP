...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgMatTypeIncomeShipFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '物资分类编码', name: 'mat_type_code', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchBudgMatTypeIncomeShip.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
