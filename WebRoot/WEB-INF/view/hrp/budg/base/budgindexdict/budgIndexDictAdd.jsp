...
<script src="<%=path%>/lib/hrp/budg/budg.js"	type="text/javascript"></script>
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgIndexDict.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='index_code_1']").val('');
				 $("input[name='index_name']").val('');
				 $("input[name='unit']").val('');
				 $("input[name='data_precision']").val('');
				 $("input[name='data_nature']").val('');
				 $("input[name='is_carried']").val('');
   ...
   function loadDict(){
		...
		autocomplete("#data_nature","../../queryBudgDataNature.do?isCheck=false","id","text",true,true);
  ...
  <form name="form1" method="post"  id="form1" >
     <table cellpadding="0" cellspacing="0" class="l-table-edit" >
	    ...
	    <tr>
	        ...
	        <input name="index_code_1" type="text" id="index_code_1" ltype="text" validate="{required:true,maxlength:20}" /></td>
	        <td align="left"></td>
	    ...
	    <tr>
	        ...
	        <td align="left" class="l-table-edit-td"><input name="data_nature" type="text" id="data_nature" ltype="text" validate="{required:true,maxlength:20}" /></td>
	        <td align="left"></td>
	        <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>数据精度<font color="red">*</font>:</b></td>
	        <td align="left" class="l-table-edit-td"><input name="data_precision" type="text" id="data_precision" ltype="text" validate="{required:true,maxlength:20}" /></td>
	        <td align="left"></td>
	    ...
	    <tr>
	  	    <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>计量单位</b></td>
