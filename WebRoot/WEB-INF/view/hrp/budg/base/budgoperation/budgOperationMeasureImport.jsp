...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgOperationMeasureFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '运营尺度编码', name: 'measure_code', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchBudgOperationMeasure.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
