  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgPaymentItemCostShip.do?isCheck=false",formPara,function(responseData){
	...
	autocomplete("#budg_year","../../../queryBudgYear.do?isCheck=false","id","text",true,true,'',false,'',200);
        ...
        //预算科目下拉框（subj_type 04 收入预算科目 ，05 支出预算科目 ）
        autocomplete("#subj_code","../../../queryBudgSubj.do?isCheck=false&subj_type=05&is_last=1&budg_year="+budg_year,"id","text",true,true,'',false,'${subj_code}',200);
       	
        autocomplete("#fund_nature","../../../../sys/querySysSourceNature.do?isCheck=false","id","text",true,true,'',false,'${fund_nature}',200); 
        
        autocomplete("#payment_item_id","../../../queryBudgPaymentItem.do?isCheck=false&is_last=1","id","text",true,true,'',false,'${payment_item_id}',200); 
        //字典下拉框
        $("#budg_year").ligerTextBox({width:200,disabled:true,cancelable:false});
        $("#payment_item_id").ligerTextBox({width:200,disabled:true,cancelable:false});
        $("#fund_nature").ligerTextBox({width:200,disabled:true,cancelable:false});
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="payment_item_id" type="text" id="payment_item_id" ltype="text" disabled="disabled" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
