  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    $(function (){
        ...
        query();//表格 delayLoad ： true ， 这里手动加载 
    });  
    ...
    function loadDict(){
		...
		autocompleteAsync("#budg_year","../../../queryBudgYear.do?isCheck=false","id","text",true,true,'',false,'${budg_year}',200);
        
        //初始化 预算科目下拉框（subj_type 04 收入预算科目 ，05 支出预算科目 ）
        autocompleteAsync("#subj_code","../../../queryBudgSubj.do?isCheck=false&subj_type=04&is_last=1&budg_year="+"${budg_year}","id","text",true,true,'',false,'${subj_code}',200);
       	
        autocompleteAsync("#fund_nature","../../../../sys/querySysSourceNature.do?isCheck=false","id","text",true,true,'',false,'${fund_nature}',200); 
        ...
        //字典下拉框
        $("#budg_year").ligerTextBox({width:200,disabled:true,cancelable:true});
        $("#fund_nature").ligerTextBox({width:200,disabled:true,cancelable:true});
        $("#subj_code").ligerTextBox({width:200,disabled:true,cancelable:true});
