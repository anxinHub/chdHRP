    ...
    <script type="text/javascript">
			     ...
			     columns : [ 
							...
							{display : '预算科目名称', name : 'subj_code', textField : 'subj_name', minWidth : 80, align : 'center',
									editor : {
										...
										textField : 'subj_name',
										url : 'queryBudgCostTypeSet.do?isCheck=false&budg_year='+budg_year+'&subj_type='+subj_type,
										keySupport : true,
										autocomplete : true,
									}
								}
     ...
     function  save(){
    	 ...
    	 if (data.length == 0){
	        ...
	        ajaxJsonObjectByUrl("addBudgAccSubjCostShip.do?isCheck=false",{ParamVo : ParamVo.toString()},function(responseData){
   ...
   function saveBudgAccRelationship(){
    ...
    function loadDict(){
    	 ...
    	 //预算年度下拉框
	   	 ...
	   	 //收入预算科目类型下拉框
	   	 autocomplete("#subj_type","../../../queryBudgCostSubjType.do?isCheck=false","id","text",true,true,"",true);
