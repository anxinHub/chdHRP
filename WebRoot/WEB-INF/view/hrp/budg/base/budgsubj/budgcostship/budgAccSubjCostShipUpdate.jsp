  ...
  <head>
    ...
    $(function (){
        ...
        $("#subj_type").change(function(){
        	...
        	autocomplete("#subj_code","../../../queryBudgCostTypeSet.do?isCheck=false&subj_type="+subj_type+"&budg_year="+"${budg_year}","id","text",true,true,'',false,'',260);
        })
    });  
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgAccSubjCostShip.do?isCheck=false",formPara,function(responseData){
    ...
    function loadDict(){
        //字典下拉框
    	//支出预算科目类型下拉框
   	 	autocomplete("#subj_type","../../../queryBudgCostSubjType.do?isCheck=false","id","text",true,true,"",false,'',260);
       ...
       //根据支出科目类别设置查询预算科目 
    	...
    	//会计科目下拉框
        autocomplete("#acc_subj_code2","../../../queryAccSubj.do?isCheck=false&subj_type="+"05"+"&acc_year="+"${budg_year}","id","text",true,true,'',false,'',260);
