...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgSubjChargeKindFiles.do?isCheck=false&budg_year=${budg_year}",    
		...
		function loadHead() {
				...
				{ display: '科目编码', name: 'subj_name', align: 'left'},
				{ display: '会计科目编码', name: 'acc_subj_code2', align: 'left'},
				{ display: '会计科目名称', name: 'acc_subj_name', align: 'left'},
