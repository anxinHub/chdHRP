...
<script type="text/javascript">
    ...
    function  query(){
    	...
    	//加载查询条件
    	grid.loadData(search,"queryBudgIncomeTypeSet.do?isCheck=false");
     }
    ...
    function save() {
		...
		if(data.addList.length > 0 || data.updateList.length > 0){
			...
			ajaxPostData({
				url: "saveBudgIncomeTypeSet.do?isCheck=false",
        ...
        if (data.length == 0){
            ...
            if(ParamVo.length > 0){
            	$.etDialog.confirm('确定删除?', function () {
					ajaxPostData({
						url: "deleteBudgIncomeTypeSet.do?isCheck=false",
						data: { ParamVo: ParamVo.toString() },
						success: function () {
							query();
						}
	...
	<div class="main">
		<table class="table-layout">
			<tr>
				...
				<td class="label" style="width:100px">收入科目类别：</td>
				<td class="ipt">
