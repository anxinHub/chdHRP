...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgIncomeTypeSet.do?isCheck=false",formPara,function(responseData){
    ...
    function loadDict(){
        ...
        autocomplete("#type_code","../../../queryBudgIncomeSubjType.do?isCheck=false","id","text",true,true);
