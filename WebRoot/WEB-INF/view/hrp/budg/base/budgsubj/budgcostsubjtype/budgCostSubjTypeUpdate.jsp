...
<script type="text/javascript">
    ...
    function save(){
    	 if("${is_fixed}" == 1){
    		 ...
    		 var formPara={
    	        		cost_subj_type_codeOld :'${cost_subj_type_code}',
   	        ...
   	        ajaxJsonObjectByUrl("updateBudgCostSubjType.do?isCheck=false",formPara,function(responseData){
    ...
    function loadDict(){
        ...
        if("${is_fixed}" == 1){
        	$("#cost_subj_type_code").ligerTextBox({disabled:true});
            $("#cost_subj_type_name").ligerTextBox({disabled:true});
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
           <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="cost_subj_type_code" type="text" id="cost_subj_type_code" value="${cost_subj_type_code}" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
           </tr> 
		   <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>科目类别名称<font color ="red">*</font>:</b></td>
                <td align="left" class="l-table-edit-td"><input name="cost_subj_type_name" type="text" id="cost_subj_type_name" value="${cost_subj_type_name}" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
			<tr>
