  ...
  <head>
    ...
    <script type="text/javascript">
         ...
         $.post("getRules.do?isCheck=false",null,function(responseData){
          ...
          $("#subj_code").blur(function(){
         	...
         	ajaxJsonObjectByUrl("getSuperCode.do?isCheck=false",map,function(responseData){
         		if(responseData.super_code == 'TOP'){
         			$("#super_code").val('TOP');
         		}else{
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgIncomeSubj.do?isCheck=false",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="subj_name_all" type="text" id="subj_name_all" disabled="disabled" ltype="text" validate="{required:true,maxlength:100}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>上级编码:</b></td>
            ...
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>科目级次:</b></td>
                <td align="left" class="l-table-edit-td"><input name="subj_level" type="text" disabled="disabled" id="subj_level" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
        </table>
    </form>
