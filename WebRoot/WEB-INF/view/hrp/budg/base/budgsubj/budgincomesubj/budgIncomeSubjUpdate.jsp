...
<html style="overflow:hidden;">
  <head>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgIncomeSubj.do?isCheck=false",formPara,function(responseData){
    ...
    function loadDict(){
        ...
        autocomplete("#type_code","../../../queryBudgTypeCode.do?isCheck=false","id","text",true,true);
        $("#is_last").val('${is_last}');
        $("#type_code").val('${type_name}');
        $("#is_carried").val('${is_carried}');
    	...
    	$("#budg_year").ligerTextBox({width:160,disabled:true});
    	$("#subj_code").ligerTextBox({width:160,disabled:true});
    	...
    	$("#subj_level").ligerTextBox({width:160,disabled:true});
    	 ...
    	 $("#type_code").ligerComboBox({disabled: true });
      	 $("#is_caarried").ligerComboBox({disabled: true });
     }  
    </script>
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input class="Wdate" name="budg_year" disabled="disabled" ltype="text" id="budg_year" value="${budg_year}"  /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>科目编码<font color="red" >*</font>:</b></td>
                <td align="left" class="l-table-edit-td"><input name="subj_code" type="text" id="subj_code"  disabled="disabled" ltype="text"   value="${subj_code}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
           ...
           <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>科目类别:</b></td>
            ...
            <td align="left"></td>
             ...
             <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="subj_name_all" type="text" id="subj_name_all" disabled="disabled" ltype="text"  value="${subj_name_all}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>上级编码<font color="red" >*</font>:</b></td>
                <td align="left" class="l-table-edit-td"><input name="super_code" type="text" disabled="disabled" id="super_code" ltype="text"  value="${super_code} ${super_name}" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>科目级别<font color="red" >*</font>:</b></td>
                <td align="left" class="l-table-edit-td"><input name="subj_level" type="text" disabled="disabled" id="subj_level" ltype="text"  value="${subj_level}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
        </table>
    </form>
