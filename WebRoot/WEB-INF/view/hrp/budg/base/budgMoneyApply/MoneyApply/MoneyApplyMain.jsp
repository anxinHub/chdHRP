    ...
    <script>
        ...
        var add = function () {
		  ...
		  parent.$.etDialog.open({
		    url: 'hrp/budg/base/budgMoneyApply/Apply/MoneyApplyAddPage.do?isCheck=false',
		    isMax : true,
		    width: 600,
		    height: 600,
		    title: '用款申请登记添加'
        ...
        var openUpdate = function(apply_code){
  		  ...
  		  // 普通打开的弹窗
  		  parent.$.etDialog.open({
  		    url: 'hrp/budg/base/budgMoneyApply/Apply/MoneyApplyUpdatePage.do?apply_code='+apply_code+'&isCheck=false',
  		    isMax : true,
  		    width: 600,
  		    height: 600,
  		    title: '用款申请登记修改'
            ...
            var paramObj = {
                ...
                toolbar: {
                    items: [
                        ...
                        { type: 'button', label: '提交', listeners: [{ click: save }], icon: 'save' },
                        { type: 'button', label: '撤回', listeners: [{ click: back }], icon: '' }
                    ]
                }
            };
