...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgBasicIndexDeptSet.do?isCheck=false",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function saveBudgBasicIndexDeptSetAdd(){
        if($("form").valid()){
            save();
        }
   }
    function loadDict(){
            //字典下拉框
            /*指标编码  */
        autocomplete("#index_code","../../../queryBudgDeptindex_code_name.do?isCheck=false","id","text",true,true,'',false,'',180);
    　　　　　　 /* 部门ID */
        autocomplete("#dept_id","../../../queryBudgDeptDict.do?isCheck=false","id","text",true,true,'',false,'',180);
