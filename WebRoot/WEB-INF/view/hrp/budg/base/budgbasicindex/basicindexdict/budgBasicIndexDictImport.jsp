...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgBasicIndexDictFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '指标性质', name: 'index_nature', align: 'left',editor:{type:'text'}},
				...
				{ display: '指标描述', name: 'index_describe', align: 'left',editor:{type:'text'}},
