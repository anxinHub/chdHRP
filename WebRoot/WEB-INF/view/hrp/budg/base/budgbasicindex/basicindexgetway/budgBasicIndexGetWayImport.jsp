...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgBasicIndexGetWayFiles.do?isCheck=false",    
		...
		ajaxJsonObjectByUrl("addBatchBudgBasicIndexGetWay.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
