  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgBasicIndexGetWay.do?isCheck=false",formPara,function(responseData){
    ...
    function loadDict(){
        ...
        autocomplete("#index_code","../../../queryBudgIndexCodeGetWay.do?isCheck=false","id","text",true,true,'',false,'',200);
        	...
        	liger.get("index_code").setValue("${index_code},${index_nature} ${index_nature_name},${index_describe}");
        	
        	liger.get("index_code").setText("${index_code} ${index_name}");
    	//取值方法下拉框
    	...
    	$("#index_code").ligerTextBox({width:200,disabled:true});
   ...
   <div id="pageloading" class="l-loading" style="display: none"></div>
   	<form name="form1" method="post"  id="form1" >
	        ...
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td"><input name="index_code" type="text" id="index_code" ltype="text" disabled="disabled" validate="{required:true,maxlength:20}" /></td>
	            <td align="left"></td>
	             <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><font>指标性质:</font></td>
	            <td align="left" class="l-table-edit-td"><input name="index_nature" type="text" id="index_nature" value="${index_nature} ${index_nature_name}" ltype="text" disabled="disabled" validate="{maxlength:20}" /></td>
	            <td align="left"></td>
	        </tr> 
	        <tr>
	            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><font>指标描述:</font></td>
	            <td align="left" class="l-table-edit-td" colspan="4"><input name="index_describe" type="text" id="index_describe" value="${index_describe}" disabled="disabled" ltype="text" validate="{maxlength:40}" /></td>
	            <td align="left"></td>
	        </tr> 
	        <tr>
	        ...
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td" colspan="4"><input name="formula_ca" type="text" id="formula_ca" value="${formula_ca}" ltype="text" disabled="disabled" validate="{maxlength:40}" /></td>
	            <td align="left"></td>
	        </tr> 
	        <tr>
	        ...
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td" colspan="4"><input name="fun_method_chs" type="text" id="fun_method_chs" value="${fun_method_chs}" disabled="disabled" ltype="text" validate="{maxlength:40}" /></td>
	            <td align="left"></td>
	        </tr> 
	    </table>
    </form>
