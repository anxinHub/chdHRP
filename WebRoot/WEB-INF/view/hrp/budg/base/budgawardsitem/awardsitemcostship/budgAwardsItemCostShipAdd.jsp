...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
         var formPara={
           ...
           wage_item_name:liger.get("awards_item_code").selectedText.split(" ")[1],
            
           subj_code:liger.get("subj_code").getValue(),
     	   
         };
         
        ajaxJsonObjectByUrl("addBudgAwardsItemCostShip.do",formPara,function(responseData){
    ...
    function loadDict(){
     	//字典下拉框
    	//预算年度下拉框
		//autocomplete("#budg_year","../../../queryBudgYear.do?isCheck=false","id","text",true,true,'',true,budg_year,180);
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">奖金项目<font color="red" >*</font>：</td>
            <td align="left" class="l-table-edit-td"><input name="awards_item_code" type="text" id="awards_item_code" ltype="text" validate="{required:true}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
