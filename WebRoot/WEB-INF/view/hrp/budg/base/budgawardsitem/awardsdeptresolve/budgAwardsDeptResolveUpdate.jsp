  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgAwardsDeptResolve.do?isCheck=false",formPara,function(responseData){
    ...
    function loadDict(){
		...
		autocomplete("#resolve_way","../../../queryBudgResolveWay.do?isCheck=false","id","text",true,true,'',false,'${resolve_way}');
    }   
    </script>
