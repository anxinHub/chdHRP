  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgAwardsEditMethod.do?isCheck=false",formPara,function(responseData){
    ...
    function loadDict(){
 	   ...
 	   //编制方法下拉框
 	   	autocomplete("#edit_method","../../../queryBudgEditMethod.do?isCheck=false","id","text",true,true,'',false,'${edit_method}');
        
 	   //取值方法下拉框
 	   	autocomplete("#get_way","../../../queryBudgGetWay.do?isCheck=false","id","text",true,true,'',false,'${get_way}');
 	       
 	   	//计算公式下拉框
 	   	autocomplete("#formula_id","../../../queryBudgFormula.do?isCheck=false","id","text",true,true,'',false,'${formula_id}');
 	   	  
 	   	//取值函数下拉框
 	   	autocomplete("#fun_id","../../../queryBudgFun.do?isCheck=false","id","text",true,true,'',false,'${fun_id}');
		...
		$("#awards_item_code").ligerTextBox({width:180,disabled:true,cancelable: false});
    	$("#edit_method").ligerTextBox({width:180});
    	$("#get_way").ligerTextBox({width:180});
	   	$("#formula_id").ligerTextBox({width:180});
    	$("#fun_id").ligerTextBox({width:180});
     }   
    </script>
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="awards_item_code" type="text" id="awards_item_code" disabled="disabled" ltype="text" value="${awards_item_code}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">编制方法：</td>
            <td align="left" class="l-table-edit-td"><input name="edit_method" type="text" id="edit_method" ltype="text" value="${edit_method}" validate="{maxlength:20}" /></td>
            <td align="left"></td>
       </tr> 
       <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">取值方法：</td>
            <td align="left" class="l-table-edit-td"><input name="get_way" type="text" id="get_way" ltype="text" value="${get_way}" validate="{maxlength:20}" /></td>
            <td align="left"></td>
