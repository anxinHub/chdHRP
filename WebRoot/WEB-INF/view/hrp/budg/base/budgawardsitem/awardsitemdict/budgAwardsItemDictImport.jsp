...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgAwardsItemDictFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '奖金项目名称', name: 'awards_item_name', align: 'left',editor:{type:'text'}},
				{ display: '期间属性', name: 'period_nature', align: 'left',editor:{type:'text'}},
