  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgAwardsItemDict.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='awards_item_code']").val('');
				 $("input[name='awards_item_name']").val('');
				 $("input[name='period_nature']").val('');
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="awards_item_name" type="text" id="awards_item_name" ltype="text" validate="{required:true,maxlength:40}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
