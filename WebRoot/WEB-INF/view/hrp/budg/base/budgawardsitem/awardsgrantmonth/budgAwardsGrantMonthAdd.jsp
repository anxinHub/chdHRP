...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgAwardsGrantMonth.do?isCheck=false",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='awards_item_code']").val('');
				 $("input[name='id']").val('');
				 $("input[name='grant_month']").val('');
 ...
 function loadForm(){
   ...
   function loadDict(){
        ...
        //发放月份下拉框
    	autoCompleteByData("#grant_month", monthData.Rows, "id", "text", true, true);
    	 //开始年度下拉框
    	autoCompleteByData("#start_year", yearData.Rows, "id", "text", true, true);
    	 //开始月份下拉框
    	autoCompleteByData("#start_month", monthData.Rows, "id", "text", true, true);
    	 //结束年度下拉框
    	autoCompleteByData("#end_year", yearData.Rows, "id", "text", true, true);
    	 //结束月份下拉框
    	autoCompleteByData("#end_month", monthData.Rows, "id", "text", true, true);
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="grant_month" type="text" id="grant_month" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>开始年度<font color="red">*</font>:</b></td>
            <td align="left" class="l-table-edit-td"><input name="start_year" type="text" id="start_year" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>开始月份<font color="red">*</font>:</b></td>
            <td align="left" class="l-table-edit-td"><input name="start_month" type="text" id="start_month" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>结束年度<font color="red">*</font>:</b></td>
            <td align="left" class="l-table-edit-td"><input name="end_year" type="text" id="end_year" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>结束月份<font color="red">*</font>:</b></td>
            <td align="left" class="l-table-edit-td"><input name="end_month" type="text" id="end_month" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
    </table>
    </form>
