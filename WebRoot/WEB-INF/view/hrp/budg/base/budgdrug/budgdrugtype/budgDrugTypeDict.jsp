...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp" />
    ...
    function save(){
        if($("form").valid()){
	        ...
	        ajaxJsonObjectByUrl("saveBudgDrugTypeDict.do?isCheck=false",formPara,function(responseData){
    ...
    function loadDict(){
    	...
    	autoCompleteByData("#is_stop", yes_or_no.Rows, "id", "text", true, true, "", false, "${medType.is_stop}");
    	autoCompleteByData("#is_auto_exp", yes_or_no.Rows, "id", "text", true, true, "", false, "${medType.is_auto_exp}");
