...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryMedInHMBudgResolveDown.do?isCheck=false&is_last=1&resolve_or_sum=01',
    ...
    function count(){
		...
		ajaxJsonObjectByUrl("countMedInHMBudgDown.do?isCheck=false&year="+year+"&subj_code="+subj_code,{},function (responseData){
		...
		if( data.length == 0 ){
    		...
    		$.ligerDialog.error('没有需要保存的数据');
   			...
   			var ParamVo =[]; 
   			 ...
   			 ajaxJsonObjectByUrl("updateMedInHMBudgDown.do?isCheck=false",{ParamVo : ParamVo.toString()},function (responseData){
            		if(responseData.state=="true"){
            			query();
            		}
            	});
    ...
    function loadDict(){
        ...
        autocomplete("#subj_code","../../../queryBudgSubj.do?isCheck=false&subj_type="+'04'+"&budg_year="+'${year}',"id","text",true,true,'',false,'${subj_code}',200);
    	//科目级次下拉框
