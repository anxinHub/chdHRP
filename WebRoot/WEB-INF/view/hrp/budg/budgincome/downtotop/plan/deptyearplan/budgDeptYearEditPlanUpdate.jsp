  ...
  <head>
   ...
   <script src="<%=path%>/lib/hrp/budg/budg.js"	type="text/javascript"></script>
   		...
   		$("#edit_method").change(function(){
         	 ...
         	 if(liger.get("is_single_count").getValue() == 1){
          		...
          		if(edit_method){
	         		...
	         		$.ligerDialog.error('编制方法必填！');
	         	 }
         	}
         	//falg = 0  第一次打开页面加载数据
  			if( flag == 0 && '${edit_method}'){
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgDeptYearEditPlan.do?isCheck=false",formPara,function(responseData){
    ...
    function saveBudgDeptYearIncomePlan(){
        if($("form").valid()){
            save();
        }
    }
    ...
    function loadDict(){
    	...
    	autocomplete("#subj_code","../../../../queryBudgSubj.do?isCheck=false&subj_type=04&type_code=01&budg_year=${budg_year}","id","text",true,true,'',false,'${subj_code}',180);
       ...
       autocomplete("#formula_id","../../../../queryBudgFormula.do?isCheck=false","id","text",true,true,'',false,'${formula_id}',180);
        ...
        autoCompleteByData("#is_single_count", yes_or_no.Rows, "id", "text", true, true,'',false,'${is_single_count}');
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="is_single_count" type="text" id="is_single_count" ltype="text"  validate="{required:true,maxlength:4}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">编制方法：</td>
            <td align="left" class="l-table-edit-td"><input name="edit_method" type="text" id="edit_method" ltype="text"  validate="{required:true}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">取值方法：</td>
            <td align="left" class="l-table-edit-td"><input name="get_way" type="text" id="get_way" ltype="text" validate="{required:true}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">计算公式：</td>
            <td align="left" class="l-table-edit-td"><input name="formula_id" type="text" id="formula_id" ltype="text"  validate="{required:true}" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="fun_id" type="text" id="fun_id" ltype="text"  validate="{required:true}" /></td>
            <td align="left"></td>
             <td align="center" class="l-table-edit-td" colspan="3">
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="resolve_or_sum" type="text" id="resolve_or_sum" ltype="text"  validate="{required:true}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">分解方法：</td>
            <td align="left" class="l-table-edit-td"><input name="resolve_way" type="text" id="resolve_way" ltype="text"  validate="{required:true}" /></td>
            <td align="left"></td>
        </tr> 
