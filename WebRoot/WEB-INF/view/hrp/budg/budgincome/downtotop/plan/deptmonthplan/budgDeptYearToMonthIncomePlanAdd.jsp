...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     /*     $("#budg_year").change(function(){
         	...
         	autocomplete("#subj_code","../../../../queryBudgSubj.do?isCheck=false&budg_year="+budg_year+"&subj_type=04&type_code=01&is_last=1","id","text",true,true,'',false,'',180);
          }) */
   ...
   //选择自定义分解系数页面 
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgDeptYearToMonthIncomePlan.do?isCheck=fasle",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function saveBudgDeptYearToMonthIncomePlanAdd(){
    	if($("form").valid()){
            save();
    	}
   }
