...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgMedInHmPlan.do?isCheck=fasle",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function saveBudgMedInHmPlanAdd(){
    	if($("form").valid()){
            save();
    	}
   }
    function yearChange(){
 		budg_year = $("#budg_year").val();
       	...
       	autocomplete("#subj_code","../../../../queryBudgIncomeSubj.do?isCheck=false&budg_year="+budg_year+"&is_last=1","id","text",true,true,'',false,'',180);
    }
    function loadDict(){
    	//字典下拉框
    	...
    	budg_year = $("#budg_year").val();
    	autocomplete("#subj_code","../../../../queryBudgIncomeSubj.do?isCheck=false&budg_year="+budg_year+"&is_last=1","id","text",true,true);
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="budg_year" type="text" id="budg_year" ltype="text" class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy',ychanged:yearChange})" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
