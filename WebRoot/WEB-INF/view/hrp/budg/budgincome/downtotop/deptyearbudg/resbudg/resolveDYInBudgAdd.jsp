    ...
    <script type="text/javascript">
					...
					{ display: '科室编码', name: 'dept_id', align: 'left' ,
                      ...
                      { display: '科目编码', name: 'subj_code', align: 'left' ,
 					 			...
 					 			editor : {
 									...
 									valueField : 'id',
 									textField : 'text',
 									url : '../../../../qureyResolveSubjIndexFromPlan.do?isCheck=false&is_single_count=0&budg_year='+budg_year,
 									keySupport : true,
 									autocomplete : true,
 					 ...
 					 { display: '医院意见分解(元/E)', name: 'hos_suggest_resolve', align: 'left',editor : {type : 'float'},
 					 			render:function(rowdata,rowindex,value){
					 				if(value){
					 					return formatNumber(value,2,1);
					 				}
     ...
     function queryLastYearIncomeload(rowdata){
    	...
    	if(rowdata.record.subj_code){
    		$.post("queryLastYearIncome.do?isCheck=false&budg_year="+budg_year+"&subj_code="+rowdata.record.subj_code+"&dept_id="+rowdata.record.dept_id,null,function(responseData){
     ...
     function  save(){
    	 if($("form").valid()){
        	 ...
        	 if (data.length == 0){
    	        ...
    	        ajaxJsonObjectByUrl("addResolveDYInBudgUp.do?isCheck=false",{ParamVo : ParamVo.toString()},function(responseData){
