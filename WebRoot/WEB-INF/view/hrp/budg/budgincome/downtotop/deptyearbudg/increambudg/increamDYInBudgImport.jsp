...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readIncreamDYInBudgFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '收入预算科目编码', name: 'subj_code', align: 'left',editor:{type:'text'}},
				{ display: '预算科室ID', name: 'dept_ID', align: 'left',editor:{type:'text'}},
				{ display: '上年收入', name: 'last_year_income', align: 'left',editor:{type:'text'}},
				{ display: '预算值', name: 'budg_value', align: 'left',editor:{type:'text'}},
				{ display: '增长比例', name: 'grow_rate', align: 'left',editor:{type:'text'}},
				{ display: '增长额', name: 'grow_value', align: 'left',editor:{type:'text'}},
				{ display: '说明', name: 'remark', align: 'left',editor:{type:'text'}},
				{ display: '医院意见分解', name: 'hos_suggest', align: 'left',editor:{type:'text'}}
