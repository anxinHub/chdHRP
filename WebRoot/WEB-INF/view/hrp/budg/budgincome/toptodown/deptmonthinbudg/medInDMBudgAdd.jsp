  ...
  <head>
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
				    /*  { display: '月份', name: 'month', align: 'left', width:50,
				    	 valueField:"month",textField : 'm',
				    	 editor : {
								type : 'select',
								valueField : 'month',
								textField : 'm',
								data:[{month:'01',m:'01'},{month:'02',m:'02'},{month:'03',m:'03'},{month:'04',m:'04'},{month:'05',m:'05'},{month:'06',m:'06'},{month:'07',m:'07'},{month:'08',m:'08'},{month:'09',m:'09'},{month:'10',m:'10'},{month:'11',m:'11'},{month:'12',m:'12'}],
								keySupport : true,
								autocomplete : true,
							} 
				     }, */
                     { display: '科室编码', name: 'dept_id', align: 'left' ,width:150,
					 			valueField:"dept_id",textField : 'dept_name',
					 			editor : {
									type : 'select',
									valueField : 'dept_id',
									textField : 'dept_name',
									url : '../deptyearinbudg/queryBudgDept.do?isCheck=false',
									keySupport : true,
									autocomplete : true,
								} 
					 		},
   ...
   function  save(){
   	 if($("form").valid()){
       	 ...
       	 if (data.length == 0){
   	    	 ...
   	    	 var ParamVo =[];
   	         $(data).each(function (){	
   	        	ParamVo.push( budg_year +"@"+ "01" +"@"+ this.dept_id +"@"+ this.dept_name +"@"+ this.subj_code +"@"+ this.text +"@"+ (this.m01? this.m01:"-1"));
   	        	ParamVo.push( budg_year +"@"+ "02" +"@"+ this.dept_id +"@"+ this.dept_name +"@"+ this.subj_code +"@"+ this.text +"@"+ (this.m02? this.m02:"-1"));
   	        	ParamVo.push( budg_year +"@"+ "03" +"@"+ this.dept_id +"@"+ this.dept_name +"@"+ this.subj_code +"@"+ this.text +"@"+ (this.m03? this.m03:"-1"));
   	        	ParamVo.push( budg_year +"@"+ "04" +"@"+ this.dept_id +"@"+ this.dept_name +"@"+ this.subj_code +"@"+ this.text +"@"+ (this.m04? this.m04:"-1"));
   	        	ParamVo.push( budg_year +"@"+ "05" +"@"+ this.dept_id +"@"+ this.dept_name +"@"+ this.subj_code +"@"+ this.text +"@"+ (this.m05? this.m05:"-1"));
   	        	ParamVo.push( budg_year +"@"+ "06" +"@"+ this.dept_id +"@"+ this.dept_name +"@"+ this.subj_code +"@"+ this.text +"@"+ (this.m06? this.m06:"-1"));
   	        	ParamVo.push( budg_year +"@"+ "07" +"@"+ this.dept_id +"@"+ this.dept_name +"@"+ this.subj_code +"@"+ this.text +"@"+ (this.m07? this.m07:"-1"));
   	        	ParamVo.push( budg_year +"@"+ "08" +"@"+ this.dept_id +"@"+ this.dept_name +"@"+ this.subj_code +"@"+ this.text +"@"+ (this.m08? this.m08:"-1"));
   	        	ParamVo.push( budg_year +"@"+ "09" +"@"+ this.dept_id +"@"+ this.dept_name +"@"+ this.subj_code +"@"+ this.text +"@"+ (this.m09? this.m09:"-1"));
   	        	ParamVo.push( budg_year +"@"+ "10" +"@"+ this.dept_id +"@"+ this.dept_name +"@"+ this.subj_code +"@"+ this.text +"@"+ (this.m10? this.m10:"-1"));
   	        	ParamVo.push( budg_year +"@"+ "11" +"@"+ this.dept_id +"@"+ this.dept_name +"@"+ this.subj_code +"@"+ this.text +"@"+ (this.m11? this.m11:"-1"));
   	        	ParamVo.push( budg_year +"@"+ "12" +"@"+ this.dept_id +"@"+ this.dept_name +"@"+ this.subj_code +"@"+ this.text +"@"+ (this.m12? this.m12:"-1"));
   	         });
   	        ajaxJsonObjectByUrl("addMedInDMBudgUp.do?isCheck=false",{ParamVo : ParamVo.toString()},function(responseData){
