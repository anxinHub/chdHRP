...
<html style="overflow:hidden;">
     ...
     $(function (){
        ...
        /*  $("#budg_year").change(
        	function(){
          	...
          	autocomplete("#subj_code","../../../../queryBudgSubj.do?isCheck=false&budg_year="+budg_year+"&subj_type=04&is_last=1&type_code=01","id","text",true,true,'',false,'',180,100);
          })
           */
   ...
   //选择自定义分解系数页面 
    function selectResolve(){
    		...
    		parent.$.ligerDialog.open({
   			url : '../../../../common/budgresolvedatadict/budgResolveDataPage.do?isCheck=false&budg_level=03',
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgHosDeptYearIncomePlan.do?isCheck=fasle",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function saveBudgHosDeptYearIncomePlanAdd(){
    	if($("form").valid()){
            save();
    	}
   }
    ...
    function loadDict(){
    	...
    	$("#reference_years").ligerTextBox({width:160,disabled:true});
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="budg_year" type="text" id="budg_year" ltype="text"  class="Wdate" validate="{required:true,maxlength:20}" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy'})" onchange="chage()"/></td>
            <td align="left"></td>
        </tr> 
        <tr>
