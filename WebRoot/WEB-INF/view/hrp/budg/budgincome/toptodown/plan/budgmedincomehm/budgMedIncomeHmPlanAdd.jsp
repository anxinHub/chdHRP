...
<html style="overflow:hidden;">
  <head>
   ...
   //选择自定义分解系数页面 
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgMedIncomeHmPlan.do?isCheck=fasle",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function saveBudgMedIncomeHmPlanAdd(){
    	if($("form").valid()){
            save();
    	}
   }
   function yearChange(){
 		budg_year = $("#budg_year").val();
       	...
       	autocomplete("#subj_code","../../../../queryBudgSubj.do?isCheck=false&budg_year="+budg_year+"&is_last=1&type_code=01&subj_type=04","id","text",true,true,'',false,'',180,100);
   }
   function loadDict(){
    	//字典下拉框
    	...
    	budg_year = $("#budg_year").val();
    	autocomplete("#subj_code","../../../../queryBudgSubj.do?isCheck=false&budg_year="+budg_year+"&subj_type=04&type_code=01&is_last=1","id","text",true,true,'',false,'',180,100);
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="budg_year" type="text" id="budg_year" ltype="text" class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy',onpicked:yearChange})" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
