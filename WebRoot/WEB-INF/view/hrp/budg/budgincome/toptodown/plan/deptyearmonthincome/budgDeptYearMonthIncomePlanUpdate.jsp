  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgDeptYearMonthIncomePlan.do?isCheck=false",formPara,function(responseData){
    ...
    function saveBudgDeptYearMonthIncomePlan(){
        if($("form").valid()){
            save();
        }
    }
	   ...
	   <form name="form1" method="post"  id="form1" >
	        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
		        ...
		        <tr>
		            ...
		            <td align="left" class="l-table-edit-td"><input name="budg_year" type="text" id="budg_year" disabled="disabled" ltype="text"  validate="{required:true,maxlength:20}" /></td>
		            <td align="left"></td>
		        </tr> 
