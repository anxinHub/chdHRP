  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgHosDeptYearIncomePlan.do",formPara,function(responseData){
    ...
    function saveBudgHosDeptYearIncomePlan(){
        if($("form").valid()){
            save();
        }
    }
    function loadDict(){
    	...
    	autocomplete("#subj_code","../../../../queryBudgIncomeSubj.do?isCheck=false&budg_year="+"${budg_year}","id","text",true,true,{key:'${subj_code}'},false,'${subj_code}',180,100);
    	//分解方法 下拉框
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" > 
	        ...
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td"><input name="subj_code" type="text" id="subj_code" ltype="text" disabled="disabled" validate="{required:true,maxlength:200}" /></td>
	            <td align="left"></td>
	        </tr> 
	        <tr>
