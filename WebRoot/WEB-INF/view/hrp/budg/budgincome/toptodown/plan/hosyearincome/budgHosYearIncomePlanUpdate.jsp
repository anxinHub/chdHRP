  ...
  <head>
   ...
   <script src="<%=path%>/lib/hrp/budg/budg.js"	type="text/javascript"></script>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgHosYearIncomePlan.do?isCheck=false",formPara,function(responseData){
    ...
    function saveBudgHosYearIncomePlan(){
        if($("form").valid()){
            save();
        }
    }
    function loadDict(){
    	...
    	//字典下拉框
    	//autocomplete("#budg_year","../../../../queryBudgYear.do?isCheck=false","id","text",true,true,{key:'${budg_year}'},false,'${budg_year}',180);
    	
    	// 初始加载数据并赋值
    	autocomplete("#subj_code","../../../../queryBudgIncomeSubj.do?isCheck=false&budg_year="+"${budg_year}","id","text",true,true,{key:'${subj_code}'},false,'${subj_code}',180);
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="is_single_count" type="text" id="is_single_count" ltype="text"  validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
