...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMedInDYBudgFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '预算年度', name: 'year', align: 'left',editor:{type:'text'}},
				{ display: '预算科目编码', name: 'subj_code', align: 'left',editor:{type:'text'}},
				{ display: '预算科室编码', name: 'dept_code', align: 'left',editor:{type:'text'}},
				...
				{ display: '科室意见', name: 'dept_suggest', align: 'left',editor:{type:'text'}},
