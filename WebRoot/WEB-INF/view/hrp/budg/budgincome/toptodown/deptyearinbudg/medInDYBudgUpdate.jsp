  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        hos_suggest_resolve:$("#hos_suggest_resolve").val(),
        dept_suggest:$("#dept_suggest").val()
        };
        ajaxJsonObjectByUrl("updateMedInDYBudgUp.do?isCheck=false",formPara,function(responseData){
    ...
    function saveBudgMedIncomeDeptYear(){
        if($("form").valid()){
            save();
        }
    }
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">医院意见分解：</td>
            <td align="left" class="l-table-edit-td"><input name="hos_suggest_resolve" type="text" id="hos_suggest_resolve" ltype="text" value="${hos_suggest_resolve}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">科室意见：</td>
            <td align="left" class="l-table-edit-td"><input name="dept_suggest" type="text" id="dept_suggest" ltype="text" value="${dept_suggest}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
