...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
				 	...
				 	{ display: '增减比例(E)', name: 'grow_rate', align: 'center',width:150,editor : {type : 'float'/*, onChanged : setCountValueAfterRate */},
				 		 render:function(rowdata,rowindex,value){
				 			if(value){
			 					return formatNumber(value, 2, 1)+"%";
			 				};
				 	...
				 	{ display: '分解比例(E)', name: 'resolve_rate', align: 'center',width:150,editor : {type : 'float'/*, onChanged : setCountValueAfterRate */},
				 		 render:function(rowdata,rowindex,value){
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryMedInDYBudgUp.do?isCheck=false&is_last=1',
  ...
  //翻页之前判断当前页是否有变更数据（若有变更数据，提示其保存）
    ...
    function countAll(){
		...
		ajaxJsonObjectByUrl("collectMedInDYBudgUp.do?isCheck=false&year="+year+"&subj_code=",{},function (responseData){
    		if(responseData.state=="true"){
    			parent.query();
    			query();
    		}
