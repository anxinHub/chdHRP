...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readResolveRateHYInBudgFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '增长比例', name: 'count_value', align: 'left',editor:{type:'text'}},
				{ display: '分解比例', name: 'budg_value', align: 'left',editor:{type:'text'}},
