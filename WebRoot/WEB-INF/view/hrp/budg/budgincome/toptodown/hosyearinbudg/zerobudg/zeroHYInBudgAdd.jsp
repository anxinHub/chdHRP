            ...
            columns: [ 
                      { display: '科目编码', name: 'subj_code', align: 'left' ,
 					 			...
 					 			editor : {
 									...
 									valueField : 'id',
 									textField : 'text',
 									url : '../../../../qureySubjIndexFromPlan.do?isCheck=false&edit_method=01&budg_year='+budg_year,
 									keySupport : true,
 									autocomplete : true,
 								} 
 					 		},
        	 ...
        	 if (data.length == 0){
    	         ...
    	         $(data).each(function (){					
    	        	 ParamVo.push(
    					...
    					(this.hos_suggest? this.hos_suggest:"0") +"@"+
    					(this.dept_suggest_sum? this.dept_suggest_sum:"0")
    					)
    	         });
    	        ajaxJsonObjectByUrl("addZeroHYInBudgUp.do?isCheck=false",{ParamVo : ParamVo.toString()},function(responseData){
