...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadHead() {
            grid = $("#maingrid").etGrid({
                columns: [
                    ...
                    { display: '资金来源', name: 'source_name', align: 'left', width: 250 },
                    { display: '预算科目', name: 'subj_name', align: 'left', width: 180 },
                    {
                      display: '收入预算', name: 'budg_amount', align: 'right', minWidth: 130, editor: { type: 'float' },
                        render:function(ui){
        ...
        function lodopPrint() {
            ...
            grid.options.lodop.title = "科研项目收入预算";
        }
