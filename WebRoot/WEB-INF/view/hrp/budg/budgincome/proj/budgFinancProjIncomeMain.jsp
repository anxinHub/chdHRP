...
<head>
    ...
    <script type="text/javascript">
        ...
        function query(){
            ...
            //加载查询条件
            grid.loadData(search,'queryBudgFinancProjIncome.do');
        }
        
        function loadHead() {
            grid = $("#maingrid").etGrid({
                columns: [
                    { display: '年度', name: 'budg_year', align: 'center', width: 80 },
                    { display: '项目编码', name: 'proj_code', align: 'left', width: 150 },
                    { display: '项目名称', name: 'proj_name', align: 'left',width: 450 },
                    { display: '资金来源', name: 'source_name', align: 'left', width: 200 },
                    { display: '预算科目', name: 'subj_name', align: 'left', width: 180 },
                    { display: '收入预算', name: 'budg_amount', align: 'right', minWidth: 120,
                        render:function(ui){
        ...
        function lodopPrint() {
            ...
            grid.options.lodop.title = "财政项目收入预算";
        }
