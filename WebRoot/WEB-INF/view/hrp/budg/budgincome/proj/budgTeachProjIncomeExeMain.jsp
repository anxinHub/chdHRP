...
<head>
	...
	<script type="text/javascript">
        ...
        function query(){
            ...
            //加载查询条件
            grid.loadData(search,"queryBudgTeachProjIncome.do");
        }
		function loadHead() {
			grid = $("#maingrid").etGrid({
				columns: [
					...
					{ display: '项目名称', name: 'proj_name', align: 'left',width: 410 },
					{ display: '资金来源', name: 'source_name', align: 'left', width: 180 },
					{ display: '预算科目', name: 'subj_name', align: 'left', width: 150 },
					...
					{ display: '到账金额', name: 'in_amount', align: 'right', minWidth: 120,
						render:function(ui) {
							var value = ui.cellData;
							if(value){
								return formatNumber(value, 2, 1);
		...
		function lodopPrint() {
			...
			grid.options.lodop.title = "教学项目收入预算执行";
		}
