...
<script type="text/javascript">
    ...
    function query() {
		...
		parms.push({name: 'subj_code', value: subj_code.getValue() }),
		parms.push({ name: 'subj_level', value: subj_level.getValue() }),
        parms.push({ name: 'check_code', value: "${check_code}" });
        //加载查询条件
        grid.loadData(parms, "../check/queryBudgMedIncomeHosMonthCopy.do?isCheck=false");
    }
    //查询
    function queryDept() {
        if (!budg_year) {
        ...
        //加载查询条件
        gridDept.loadData(parms, "../check/queryBudgMedIncomeDeptMonthCopy.do?isCheck=false");
    }
