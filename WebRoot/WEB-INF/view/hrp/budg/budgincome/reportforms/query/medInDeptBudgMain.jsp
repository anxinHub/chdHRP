...
function loadSelect(){
		...
		function query(){
			...
			//加载查询条件
			grid.loadData(search,'queryMedInDeptBudg.do?isCheck=false');
		}
		...
		function loadHead() {
			grid = $("#maingrid").etGrid({
				columns: [
					...
					{ display: '科室年度收入预算(元)', name: 'year_sum', align: 'right', width: 120,
						render:function(ui) {
							return formatNumber(ui.rowData.year_sum, 2, 1);
						}
					},
					{ display: '01月(元/E)', name: 'month_1', align: 'right', width: 120,
						render:function(ui) {
							return formatNumber(ui.rowData.month_1, 2, 1);
						}
					},
					{ display: '02月(元/E)', name: 'month_2', align: 'right', width: 120,
						render:function(ui) {
							return formatNumber(ui.rowData.month_2, 2, 1);
						}
					},
					{ display: '03月(元/E)', name: 'month_3', align: 'right', width: 120,
						render:function(ui) {
							return formatNumber(ui.rowData.month_3, 2, 1);
						}
					},
					{ display: '04月(元/E)', name: 'month_4', align: 'right', width: 120,
						render:function(ui) {
							return formatNumber(ui.rowData.month_4, 2, 1);
						}
					},
					{ display: '05月(元/E)', name: 'month_5', align: 'right', width: 120,
						render:function(ui) {
							return formatNumber(ui.rowData.month_5, 2, 1);
						}
					},
					{ display: '06月(元/E)', name: 'month_6', align: 'right', width: 120,
						render:function(ui) {
							return formatNumber(ui.rowData.month_6, 2, 1);
						}
					},
					{ display: '07月(元/E)', name: 'month_7', align: 'right', width: 120,
						render:function(ui) {
							return formatNumber(ui.rowData.month_7, 2, 1);
						}
					},
					{ display: '08月(元/E)', name: 'month_8', align: 'right', width: 120,
						render:function(ui) {
							return formatNumber(ui.rowData.month_8, 2, 1);
						}
					},
					{ display: '09月(元/E)', name: 'month_9', align: 'right', width: 120,
						render:function(ui) {
							return formatNumber(ui.rowData.month_9, 2, 1);
						}
					},
					{ display: '10月(元/E)', name: 'month_10', align: 'right', width: 120,
						render:function(ui) {
							return formatNumber(ui.rowData.month_10, 2, 1);
						}
					},
					{ display: '11月(元/E)', name: 'month_11', align: 'right', width: 120,
						render:function(ui) {
							return formatNumber(ui.rowData.month_11, 2, 1);
						}
					},
					{ display: '12月(元/E)', name: 'month_12', align: 'right', width: 120,
						render:function(ui) {
	...
	/* 	//打印
		function printDate() {
			...
			ajaxJsonObjectByUrl("queryMedInDeptBudg.do?isCheck=false", selPara, function (responseData) {
		...
		var printDate = function () {
        	...
        	var printPara={
                ...
                method_name: "queryMedInQueryPrintDate",
