...
<head>
	...
	<jsp:include page="${path}/static_resource.jsp">
		<jsp:param value="select,datepicker,grid,ligerUI,pageOffice" name="plugins" />
	</jsp:include>
...
function loadSelect(){
		...
		function query(){
			...
			//加载查询条件
			grid.loadData(search,'queryBudgMedInHosYearMonEx.do?isCheck=false');
		}
		...
		var printDate = function () {
        	...
        	var heads={}; 
        	var printPara={
                title: "医院医疗收入预算执行监控统计数据表",//标题
                columns: JSON.stringify(grid.getPrintColumns()),//表头
                class_name: "com.chd.hrp.budg.service.budgincome.reportforms.monitoring.BudgMedInHosYearMonExService",
                method_name: "queryMedInHosYearMonExPrintDate",
                bean_name: "budgMedInHosYearMonExService",
