...
<head>
	...
	<script type="text/javascript">
		...
		function query(){
			...
			//加载查询条件
			grid.loadData(search,'queryBudgMedInDeptYearMon.do?isCheck=false');
		}
		...
		function printDate() {
			...
			parms.push({ name: 'dept_id', value: dept_name_select.getValue().split(",")[0] });
			var selPara = {};
			...
			var printPara = {
				headCount: 2,
				title: "科室医疗收入预算执行监控数据表",
				type: 3,
				columns: grid.getColumns(1)
			};
			ajaxJsonObjectByUrl("queryBudgMedInDeptYearMon.do?isCheck=false", selPara, function (responseData) {
