...
<script type="text/javascript">
    ...
    function query(type) {
        ...
        if (type === 'hos') {
            ...
            if (check_type == '02') {
                if (bc_state == '04') {
                    url = "queryBudgMedIncomeHosMonthAdjustCopy.do?isCheck=false";
                } else {
                    url = "queryBudgMedIncomeHosMonthAdjust.do?isCheck=false";
                }
            } else {
                if (bc_state == '04') {
                    url = "queryBudgMedIncomeHosMonthCopy.do?isCheck=false";
                } else {
                    url = "queryBudgMedIncomeHosMonth.do?isCheck=false";
                }
            }
            ...
            if (check_type == '02') {
                if (bc_state == '04') {
                    url = "queryBudgMedIncomeCheckDeptMonthAdjustCopy.do?isCheck=false";
                } else {
                    url = "queryBudgMedIncomeCheckDeptMonthAdjust.do?isCheck=false";
                }
            } else {
                if (bc_state == '04') {
                    url = "queryBudgMedIncomeDeptMonthCopy.do?isCheck=false";
                } else {
                    url = "queryBudgMedIncomeDeptMonth.do?isCheck=false";
                }
            }
