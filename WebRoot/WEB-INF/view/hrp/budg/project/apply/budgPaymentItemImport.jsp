...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "200"); sheet.setText(0, 0, "支出项目名称");
    	sheet.setColumnWidth(1, "100"); sheet.setText(0, 1, "预算比例(%)");
    	sheet.setColumnWidth(2, "150"); sheet.setText(0, 2, "预算金额(元)");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importPaymentItem.do?isCheck=false", para, function(responseData){	
