...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgSysDictFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '字段编码', name: 'f_code', align: 'left',editor:{type:'text'}},
				{ display: '字段名称', name: 'f_name', align: 'left',editor:{type:'text'}},
				{ display: '字段取值编码', name: 'value_code', align: 'left',editor:{type:'text'}},
				{ display: '字段取值', name: 'value_name', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchBudgSysDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
