...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readHosProjFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '项目简称', name: 'proj_simple', align: 'left',editor:{type:'text'}},
				{ display: '排序号', name: 'sort_code', align: 'left',editor:{type:'text'}},
				{ display: '拼音码', name: 'spell_code', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchHosProj.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
