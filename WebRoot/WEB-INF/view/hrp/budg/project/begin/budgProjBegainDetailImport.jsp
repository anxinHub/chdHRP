...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "100"); sheet.setText(0, 0, "预算年度");
    	sheet.setColumnWidth(1, "100"); sheet.setText(0, 1, "项目名称");
    	sheet.setColumnWidth(2, "150"); sheet.setText(0, 2, "资金来源");
    	sheet.setColumnWidth(3, "250"); sheet.setText(0, 3, "支出项目");
    	sheet.setColumnWidth(4, "250"); sheet.setText(0, 4, "期初预算余额");
    	sheet.setColumnWidth(5, "250"); sheet.setText(0, 5, "预算金额");
    	sheet.setColumnWidth(6, "250"); sheet.setText(0, 6, "支出金额");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importBudgProjBegainDetail.do?isCheck=false", para, function(responseData){	
