...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(2, "150"); sheet.setText(0, 2, "资金来源名称");
    	sheet.setColumnWidth(3, "250"); sheet.setText(0, 3, "预算金额");
    	sheet.setColumnWidth(4, "250"); sheet.setText(0, 4, "到账金额");
    	sheet.setColumnWidth(5, "250"); sheet.setText(0, 5, "支出金额");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importBudgProjBegain.do?isCheck=false", para, function(responseData){	
