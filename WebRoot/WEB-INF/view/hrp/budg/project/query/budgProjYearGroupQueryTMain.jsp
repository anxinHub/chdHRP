...
<head>
	...
	<script type="text/javascript">
		...
		var his_name_select, proj_name_select, proj_type_select, proj_level_select, proj_state_select, con_emp_select;
		...
		function query() {
			...
			//加载查询条件
			grid.loadData(parms,'queryBudgProjYearGroupQueryT.do?budg_year=' + budg_year);
		}
		...
		function loadHead() {
			grid = $("#maingrid").etGrid({
				columns: [
					...
					{
						display: '医院名称', name: 'hos_simple', align: 'left', width: 200
					},
					{
		...
		function lodopPrint() {
			...
			grid.options.lodop.title = "项目预算查询(二)(集团 )";
		}
	...
	<div class="main">
		<table class="table-layout">
			<tr>
				...
				<td class="ipt">
					<select name="" id="his_name_select" style="width:180px"></select>
				</td>
