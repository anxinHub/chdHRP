...
<script type="text/javascript">
	...
	var year_input,proj_name_select,payment_item_select,type_code_select,level_code_select,proj_state_select;
	...
	function query() {
		...
		//加载查询条件
		grid.loadData(parms,"queryBudgProjDetailYearQuery.do");
	}
	...
	function lodopPrint() {
		...
		grid.options.lodop.title = "项目预算明细查询(一)";
	}
