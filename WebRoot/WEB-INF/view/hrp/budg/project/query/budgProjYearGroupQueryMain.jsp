...
<head>
	...
	<script type="text/javascript">
		...
		var year_input, his_name_select, proj_name_select, proj_type_select, proj_level_select, proj_state_select, con_emp_select;
		...
		function query() {
			...
			//加载查询条件
			grid.loadData(parms,'queryBudgProjYearGroupQuery.do');
		}
		...
		function loadHead() {
			grid = $("#maingrid").etGrid({
				columns: [
					...
					{
						display: '医院', name: 'hos_simple', align: 'left', width: 200,
					},
					{
		...
		function lodopPrint() {
			...
			grid.options.lodop.title = "项目预算查询(一)(集团)";
		}
