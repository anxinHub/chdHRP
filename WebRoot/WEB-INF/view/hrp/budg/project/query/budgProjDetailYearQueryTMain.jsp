...
<head>
	...
	<script type="text/javascript">
		...
		var proj_name_select, type_code_select, level_code_select, proj_state_select, con_emp_select,payment_item_select;
		...
		function query() {
			...
			//加载查询条件
			grid.loadData(parms,'queryBudgProjDetailYearQueryT.do?budg_year=' + budg_year);
		}
		...
		function lodopPrint() {
			...
			grid.options.lodop.title = "项目预算明细查询(二)";
		}
