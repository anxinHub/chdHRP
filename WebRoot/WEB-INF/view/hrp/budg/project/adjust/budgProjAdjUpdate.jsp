...
<script>
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
		           ...
		           { display: '支出项目', name: 'payment_item_id', align: 'left',
                     ...
                     { display: '调整前预算余额', name: 'bef_remain_amount', align: 'right',
					 			render : function(rowdata,rowindex,value) {
					 				if(value){
					 					return formatNumber(value,2,1);
					 				}else{
					 					return formatNumber(0.00,2,1);
					 				}
					 			},
					 			totalSummary: {
	 								align: 'right',
                     ...
                     { display: '预算调整(E)', name: 'adj_amount', align: 'right',editor : {type : 'float',onChanged : updateCell},
					 			render : function(rowdata,rowindex,value) {
					 				if(value){
					 					return formatNumber(value,2,1);
					 				}
                     ...
                     { display: '调整后预算余额', name: 'aft_remain_amount', align: 'right',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryBudgProjAdjDetail.do?isCheck=false&proj_id='+'${proj_id}'+'&budg_year='+'${budg_year}'+'&adj_code='+'${adj_code}',
	...
	function validateGrid(data) {  
     	var msg="";
  		...
  		$.each(data,function(i, v){
  			rowm = "";
 			if (v.text == "" || v.text == null || v.text == 'undefined') {
 				rowm+="[支出项目]、";
 			}
    ...
    function  save () {
    	...
    	if(data.length>0){
            ...
            ajaxJsonObjectByUrl("updateBudgProjAdj.do?isCheck=false",formPara,function(responseData){		            
    ...
    function loadDict(){
      //字典下拉框
      	 //预算年度下拉框
    	 autocomplete("#budg_year","../../../budg/queryBudgYear.do?isCheck=false","id","text",true,true,"",false,'${budg_year}');
       
         //项目名称下拉框
         autocomplete("#proj_id","../../../budg/queryProjName.do?isCheck=false","id","text",true,true,'',false,'${proj_id},${proj_no}',450);   
         
       	 
       	 //初始化项目负责人下拉框（预算指标下拉框 与 科室下拉框下拉框 联动）
       	 
   		autocomplete("#emp_id","../../../budg/queryConEmpId.do?isCheck=false?&proj_id="+${proj_id},"id","text",true,true,'',false,'${con_emp_id}',200);
       	 
         $("#adj_code").ligerTextBox({width:200,disabled:true});  
         $("#budg_year").ligerTextBox({width:200,disabled:true});  
         $("#proj_id").ligerTextBox({width:300,disabled:true});   
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        <tr>
            ...
            <td align="left" class="l-table-edit-td" >
            	<input name="adj_code" type="text" id="adj_code" ltype="text" disabled="disabled" value='${adj_code}' validate="{required:true,maxlength:20}" />
            </td>
            <td align="left" class="l-table-edit-td"></td>
            <td align="right" class="l-table-edit-td">预算年度<span style="color:red">*</span>:</td>
            <td align="left" class="l-table-edit-td" >
            	<input name="budg_year" type="text" id="budg_year" value='${budg_year}' disabled="disabled" ltype="text" validate="{required:true,maxlength:20}" />
            </td>
            <td align="left" class="l-table-edit-td"></td>
            <td align="right" class="l-table-edit-td"  >项目名称：</td>
            <td align="left" class="l-table-edit-td" >
            	<input name="proj_id" type="text" id="proj_id" ltype="text" disabled="disabled" validate="{required:true,maxlength:20}" />
            </td>
            <td align="left" class="l-table-edit-td"></td>
        </tr>
	    <tr> 
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td" colspan="7">
            	<input name="file_url" type="text" id="file_url" ltype="text" value = '${file_url}' validate="{maxlength:20}" /></td>
            <td align="left" >
	...
	<div>
    	<table>
	    	<tr>	
				...
				<td align="center" class="l-table-edit-td"  width="20%" >
					制单日期：<span class="make_date"></span>
				</td>
				<td align="center" class="l-table-edit-td" width="20%">
					审核人：${che_emp_name}
				</td>
				<td align="center" class="l-table-edit-td" width="20%" >
					审核日期：<span class="check_date"></span>
				</td>
				<td align="center" class="l-table-edit-td" width="20%" >
					状态：${state_name}
				</td>
