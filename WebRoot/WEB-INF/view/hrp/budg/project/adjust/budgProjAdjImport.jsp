...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgProjAdjFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '调整说明', name: 'remark', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchBudgProjAdj.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
