...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     $(function (){
         ...
         loadDict()//加载下拉框
        loadForm();
         $("#email").ligerComboBox({width:300})
         $("#note").ligerComboBox({width:490})
     ...
     function  save(){
        var formPara={
           ...
           dept_no: liger.get("dept_id").getValue().split(".")[1],//填报部门
           ...
           state:liger.get("proj_state").getValue(),//项目状态
           
           is_carry:liger.get("is_carry").getValue()//是否停用
            
         };
        ajaxJsonObjectByUrl("addBudgProjSetUp.do",formPara,function(responseData){
            ...
            if(responseData.state=="true"){
				 ...
				 $("input[name='note']").val('');
				 $("input[name='con_phone']").val('');
				 $("input[name='acc_phone']").val('');
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	autocomplete("#use_code","../../../sys/queryProjUseDict.do?isCheck=false","id", "text", true, true  );//项目用途
    	autocomplete("#con_emp_id","../../../sys/queryEmpDict.do?isCheck=false","id", "text", true, true  );//项目负责人
    	autocomplete("#acc_emp_id","../../../sys/queryEmpDict.do?isCheck=false","id", "text", true, true  );//财务负责人
    	autocomplete("#dept_id","../../../sys/queryDeptDictLast.do?isCheck=false","id", "text", true, true  );//填报部门
    	autocomplete("#app_emp_id","../../../sys/queryEmpDict.do?isCheck=false","id", "text", true, true );//填报人
    	autocomplete("#proj_state","../../qureyProjSetUpStateSelect.do?isCheck=false","id", "text", true, true,null,true );//立项状态
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="proj_simple" type="text" id="proj_simple" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td" colspan=3><input name="email" type="text" id="email" ltype="text"   /></td>
            <td align="left"></td>
        </tr>
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">备注：</td>
            <td align="left" class="l-table-edit-td" colspan=4><input  name="note" type="text" id="note" ltype="text"    /></td>
        </tr>
        <tr>
        ...
        <tr>
       		 <td align="right" class="l-table-edit-td table-star"  style="padding-left:20px;">状态：</td>
