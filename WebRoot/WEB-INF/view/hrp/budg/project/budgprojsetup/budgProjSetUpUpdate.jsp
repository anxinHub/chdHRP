...
<html style="overflow:hidden;">
    ...
    <script type="text/javascript">
     ...
     function  save(){
    	 ...
    	 var formPara={
           ...
           state:liger.get("state").getValue(),//项目状态
           
            
         };
       console.log(formPara)
        ajaxJsonObjectByUrl("updateBudgProjSetUp.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
         ...
         autocomplete("#state", "../../qureyProjSetUpStateSelect.do?isCheck=false", "id", "text", true, true, null);
         liger.get("state").setValue("${value_code}")
         liger.get("state").setText("${value_name}")
   ...
   <form name="form1" method="post"  id="form1" >
		...
		<tr>
			<td align="right" class="l-table-edit-td table-star"   style="padding-left:20px;">立项申请单号</td>
			<td align="left" class="l-table-edit-td">${apply_code}</td>
		</tr>
      <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="proj_name" type="text" id="proj_name" value="${proj_name}"ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="proj_simple" type="text" id="proj_simple" value="${proj_simple}" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="set_up_date" type="text" id="set_up_date" value="${set_up_date}" class="Wdate" ltype="text" /></td>
            <td align="left"></td>
        </tr>
        <tr>
       		 <td align="right" class="l-table-edit-td table-star"  style="padding-left:20px;">状态：</td>
            <td align="left" class="l-table-edit-td"><input name="proj_state" type="text" id="state" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
