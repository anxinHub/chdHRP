...
<script type="text/javascript">
    ...
    function query() {
        var parms = [
            ...
            { name: 'med_type_id', value: med_type_id.getValue() },
            { name: 'check_code', value: "${check_code}" }
        ];

        grid.loadData(parms, "../medpurcheck/queryBudgMedPurAdjustCopy.do?isCheck=false");
    }

    function loadHead() {
        grid = $("#maingrid").etGrid({
            columns: [
                { display: '药品编码', name: 'med_type_id', align: 'left', width: 100 },
                { display: '药品名称', name: 'med_type_name', align: 'left', width: 120 },
                {
                    display: '本年合计',
                    name: 'year_sum',
                    align: 'right',
            ...
            dataModel: {
                ...
                location: 'remote',
                url: '',
                recIndx: 'med_type_name' //必填 且该列不能为空  
            },
            usePager: true,
            width: '100%',
            inWindowHeight: true,
