...
<head>
	...
	function  query(){
        ...
        if (check_type_preval == '01') {
            if (bc_state_preval == '04') {
                grid.loadData(parms, 'queryBudgMatPurCopy.do?isCheck=false');
            } else {
            ...
            if (bc_state_preval == '04') {
                grid.loadData(parms, 'queryBudgMatPurAdjustCopy.do?isCheck=false');
            } else {
                grid.loadData(parms, 'queryBudgMatPurAdjust.do?isCheck=false');
            }
        }
	}
	...
	function loadHead(){
		var columns = [
			{ display: '物资分类编码', name: 'mat_type_code', align: 'left',width:100 },
			{ display: '物资分类名称', name: 'mat_type_name', align: 'left',width:100 },
    ...
    function  save(){
        ...
        ajaxPostData({
        	url: "updateBudgMatPurCheck.do?isCheck=false",
        	data: formPara,
