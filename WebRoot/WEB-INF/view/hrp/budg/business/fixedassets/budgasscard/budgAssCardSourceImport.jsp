...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgAssCardSourceFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '资金来源编码', name: 'source_code', align: 'left',width:100},
				{ display: '资金来源名称', name: 'source_name', align: 'left',width:120},
				{ display: '卡片原值', name: 'price', align: 'left',width:100,
				...
				{ display: '卡片净值', name: 'cur_money', align: 'left',width:100,
					render:function(rowdata,rowindex,value){
						return formatNumber(value,2,1)
					}
				},
				{ display: '卡片残值', name: 'fore_money', align: 'left',width:100,
					render:function(rowdata,rowindex,value){
						return formatNumber(value,2,1)
					}
				},
