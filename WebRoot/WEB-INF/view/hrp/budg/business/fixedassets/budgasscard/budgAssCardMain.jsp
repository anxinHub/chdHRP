...
<script type="text/javascript">
    ...
    var naturs_code_select, ass_card_input, ass_name_select, dept_name_select, use_state_select, is_throw_select, is_depr_select;

    function init() {
        naturs_code_select = $("#naturs_code_select").etSelect({
            url: '../../../../ass/card/queryAssNaturs.do?isCheck=false',
            defaultValue: 'none',
            onChange: query
        });
    ...
    function query() {
        ...
        var search = [
            { name: 'ass_card_no', value: $("#ass_card_input").val() },
        ...
        grid.loadData(search,"queryBudgAssCardactuality.do?isCheck=false");
    }
    ...
    function loadHead() {
        ...
        var paramObj = {
            ...
            toolbar: toolbar,
            dataModel: {
                url: 'queryBudgAssCardactuality.do'
            },
            pageModel:{
            	type:'remote'
            },
    ...
    function add_open() {
        parent.$.etDialog.open({
            url: 'hrp/budg/business/fixedassets/budgasscard/budgAssCardAddPage.do?isCheck=false&',
            title: '添加',
            isMax: true,
    ...
    function imp1 () {
        $.etDialog.open({
            url: 'budgAssCardImportPage.do?isCheck=false',
            title: '导入',
            width: '893px',
            height: '500px',
            maxmin: true,
    ...
    function imp2 () {
        $.etDialog.open({
            url: 'budgAssCardSourceImportPage.do?isCheck=false',
            title: '导入',
            width: '893px',
            height: '500px',
            maxmin: true,
    ...
    function openUpdate (ass_card_no,naturs_code) {
        ...
        parent.$.etDialog.open({
            url: 'hrp/budg/business/fixedassets/budgasscard/budgAssCardUpdatePage.do?isCheck=false&' + parm.toString(),
            height: 300,
            width: 450,
            title: '更新',
            isMax: true,
    ...
    <div class="main">
        <table class="table-layout">
            <tr>
                ...
                <td class="ipt">
                    <input type="text" id="ass_card_input" style="width:150px;" />
                </td>
