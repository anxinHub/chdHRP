...
<script type="text/javascript">
    ...
    var year_input, month_input, ass_natures_select, ass_type_select, ass_name_select, dept_name_select, source_select;
    ...
    function query() {
        ...
        grid.loadData(search, 'queryBudgAssetPur.do');
    }
    ...
    function loadHead() {
    	var columns = [
    		...
    		{ display: '购置计划号', name: 'plan_no', width: 120 },
