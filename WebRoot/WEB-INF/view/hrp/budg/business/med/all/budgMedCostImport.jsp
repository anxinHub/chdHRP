...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgMedCostFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '支出预算', name: 'cost_budg', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchBudgMedCost.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
