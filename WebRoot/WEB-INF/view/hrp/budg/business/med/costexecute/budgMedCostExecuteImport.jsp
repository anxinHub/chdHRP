...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgMedCostExecuteFiles.do?isCheck=false",    
		...
		ajaxJsonObjectByUrl("addBatchBudgMedCostExecute.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
