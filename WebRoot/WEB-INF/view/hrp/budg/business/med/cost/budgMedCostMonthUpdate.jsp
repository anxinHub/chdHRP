...
<script type="text/javascript">
 ...
 function checkNum(obj) {
    ...
    function save() {
        ...
        ajaxPostData({
            url: "updateBudgMedCostMonth.do?isCheck=false",
            data: formPara,
    ...
    <div class="mian">
        <table class="table-layout">
            ...
            <tr>
                ...
                <td class="ipt">
                    <select id="subj_code" style="width: 180px;" disabled></select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="ipt">
                    <select id="dept_id" value="${dept_id}" style="width: 180px;" disabled></select>
                </td>
            </tr>
            <tr> 
                <td class="label">基础值：</td>
                <td class="ipt">
                    <input id="base_value" type="text" value="${base_value}"/>
                </td>
            </tr> 
             <tr>
                <td class="label">增长率：</td>
                <td class="ipt">
                    <input id="grow_rate" type="text" value="${grow_rate}" />
                </td>
            </tr>
             <tr>
                <td class="label">预算金额：</td>
                <td class="ipt">
                    <input id="budg_value" type="text" value="${budg_value}" />
                </td>
            </tr>
            <tr>
                <td class="label">说明：</td>
                <td class="ipt">
                    <textarea id="remark" type="text" rows="5" cols="50%" >${remark}</textarea>
                </td>
