...
<script type="text/javascript">
		...
		function loadHead() {
				...
				{ display: '月', name: 'month', align: 'left',width:100},
				{ display: '部门编码', name: 'dept_code', align: 'left',width:100},
				{ display: '部门编码', name: 'dept_name', align: 'left',width:100},
				{ display: '科目编码', name: 'subj_code', align: 'left',width:100},
				{ display: '科目编码', name: 'subj_name', align: 'left',width:100},
				{ display: '支出预算', name: 'cost_budg', align: 'right',width:100,
					render : function(rowdata,rowindex,value){
						return formatNumber(value,2,1)
					}
				},
				{ display: '上月结转', name: 'last_month_carried', align: 'right',width:100,
					render : function(rowdata,rowindex,value){
						return formatNumber(value,2,1)
					}
				},
				{ display: '结转下月', name: 'carried_next_month', align: 'right',width:100,
					render : function(rowdata,rowindex,value){
						return formatNumber(value,2,1)
					}
				},
