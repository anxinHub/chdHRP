...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgFreeMedMatCostFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '属性', name: 'mat_type_code', align: 'left',width:120},
				{ display: '物资类别编码', name: 'mat_type_code', align: 'left',width:120},
				{ display: '物资类别名称', name: 'mat_type_name', align: 'left',width:100},
