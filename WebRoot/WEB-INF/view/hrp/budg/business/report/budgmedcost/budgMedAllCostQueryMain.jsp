...
<script type="text/javascript">
	...
	function query() {
		...
		//加载查询条件
		grid.loadData(parms,"queryMedAllCostReport.do");
	}
	...
	function loadHead() {
		grid = $("#maingrid").etGrid({
			...
			height: '100%', checkbox: true,freezeCols: 5, numberCell:{show:true} ,
			dataModel: {
                method: 'POST',
                location: 'remote',
                url: '',
	...
	<div class="main">
		<table class="table-layout">
			<tr>
				...
				<td class="ipt">
					<select name="" id="subj_level_select" style="width:80px;"></select>
				</td>
			</tr>
		</table>
	</div>
