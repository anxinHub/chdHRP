...
<script type="text/javascript">
	...
	function query() {
		...
		//加载查询条件
		grid.loadData(parms,"queryReportMedDeptCost.do");
	}
	...
	function loadHead() {
		grid = $("#maingrid").etGrid({
			columns: [
				...
				{
					display: '12月', name: 'month_data12', align: 'right', minWidth: 110,
					render: function (ui) {
						var rowdata = ui.rowData;
						var value = ui.cellData;
						return formatNumber(value, 2, 1);
			...
			height: '100%', checkbox: true,freezeCols: 7, numberCell:{show:true} ,
			dataModel: {
                method: 'POST',
                location: 'remote',
                url: '',
	...
	<div class="main">
		<table class="table-layout">
			<tr>
				...
				<td class="ipt">
					<select name="" id="dept_name_select" style="width:200px;"></select>
				</td>
				<td class="label">科目名称：</td>
				<td class="ipt">
					<select name="" id="subj_code_select" style="width:260px;"></select>
				</td>
			</tr>
			<tr>
