...
<script type="text/javascript">
	...
	function query() {
    	...
    	//加载查询条件
    	grid.loadData(parms,'queryReportMedElseCostMonitor.do?isCheck=false');
	}
	...
	function printDate() {
		...
		ajaxJsonObjectByUrl("queryReportMedElseCostMonitor.do?isCheck=false", selPara, function (responseData) {
