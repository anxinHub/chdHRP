...
<script type="text/javascript">
  ...
  //设置单元格打印格式
    ...
    function  query(){
		...
		//加载查询条件
		grid.loadData(parms, 'queryBudgGroupExecData.do?isCheck=false');
    }
    ...
    function loadHead(){
    	grid = $("#maingrid").etGrid({
    		 columns: [ 
				 ...
				 { display: '指标名称', name: 'index_name', width:120,
						 },	 
	...
	function openUpdateSum(obj){
		...
		var parm = 	
			...
			"sum_year="+vo[2] 
		$.etDialog.open({
            url: 'budgWorkGroupExecuteLinkPageSum.do?isCheck=false&'+parm,
            title: '预算值调整记录',
            isMax: true
        });
	}
	...
	function  openUpdate(obj){
		...
		var parm = 	
			...
			"month="+vo[2]
		$.etDialog.open({
            url: 'budgWorkGroupExecuteLinkPage.do?isCheck=false&'+parm,
            title: '预算值调整记录',
            isMax: true
        });
	}
