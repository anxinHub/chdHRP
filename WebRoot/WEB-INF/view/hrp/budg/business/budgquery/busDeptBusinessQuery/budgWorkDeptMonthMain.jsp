...
<script type="text/javascript">
    ...
    function  query(){
		...
		//加载查询条件
		grid.loadData(parms, 'queryBudgWorkDeptMonth.do?isCheck=false');
    }
    ...
    function loadHead(){
       grid = $("#maingrid").etGrid({
         columns: [ 
           ...
           { display: '科室编码', name: 'dept_code',frozen :true,width:90},
	 	   { display: '科室名称', name: 'dept_name',frozen :true,width:100},
      	   { display: '指标编码', name: 'index_code',frozen :true,width:90},
 		   { display: '指标名称', name: 'index_name',frozen :true,width:100},
           //{ display: '项目', name: 'item',frozen :true,width:90},
	 	   { display: '本年合计', name: 'sum_year', align: 'right',frozen :true,width:120,
			   render:function(ui){
				 ...
				 render:function(ui){
  	 			 var value = ui.cellData;
					 if(ui.rowData.b_no == 2){
						 ...
						 ui.rowData.year+"!"+ui.rowData.index_code+"!"+ui.rowData.dept_id+"!"+
    ...
    function lodopPrint(){
    	var head="";
 		...
 		grid.options.lodop.title="科室业务预算查询";
    }
    ...
    function openUpdate(obj){
    	...
    	var parm = 
			...
			"month="+vo[3] 
    	$.etDialog.open({
            url: 'budgWorkDeptMonthUpdPage.do?isCheck=false&'+parm,
            title: '预算值链接',
            isMax: true
        });
    }
    function openUpdateSumYear(obj){
    	...
    	var parm = 
			...
			"sum_year="+vo[3] 
    	$.etDialog.open({
            url: 'budgWorkDeptYearUpdPage.do?isCheck=false&'+parm,
            title: '预算值链接',
            isMax: true
        });
    }
