...
<script type="text/javascript">
    ...
    function save () {
        ...
        ajaxPostData({
            url: "updateBudgAssCard.do?isCheck=false",
            data: formPara,
        ...
        var paramObj = {
            ...
            toolbar: {
                items: [
                    ...
                    { type: 'button', label: '保存', listeners: [{ click: saveAssCardUpdate }], icon: 'save' },
                    { type: 'button', label: '添加行', listeners: [{ click: addRow }], icon: 'add' },
                ]
            },
            dataModel: {
                url: 'queryBudgAssCardSourceBySourceId.do?isCheck=false&naturs_code='+"${naturs_code}"+'&ass_card_no='+"${ass_card_no}"
            }
        };
    ...
    function loadDict() {
        ...
        // 仓库
        var store_id_url = "../../../queryHosStoreDict.do?isCheck=false";
        if (!isUseAffiStore) {
            store_id_url += "&is_com=0"
        } 
        ...
        depr_method = $("#depr_method").etSelect({
            ...
            defaultValue: "${depr_method}"
        });

        // 是否投放
        is_throw = $("#is_throw").etSelect({
            url: '../../../../mat/queryMatYearOrNo.do?isCheck=false',
            defaultValue: "${is_throw}"
        });
    ...
    <div class="main">
        <table class="table-layout">
            <tr>
                ...
                <td class="ipt">
                    <input id="ass_card_no" type="text" disabled value="${ass_card_no}" />
                </td>

                <td class="label no-empty">资产名称：</td>
                <td class="ipt">
                    <input id="ass_id" type="text" disabled value="${ass_name}" />
                </td>
            ...
            <tr>
                ...
                <td class="ipt">
                    <input id="acc_depre_amount" type="text" value="${acc_depre_amount}" />
                </td>

                <td class="label last_depr_year_label">上次折旧：</td>
                <td class="ipt">
            ...
            <tr>
                ...
                <td class="ipt">
                    <input id="price" type="text" disabled value="${price}" />
                </td>

                <td class="label">累计折旧：</td>
                <td class="ipt">
                    <input id="depre_money" type="text" disabled value="${depre_money}" />
                </td>

                <td class="label">资产净值：</td>
                <td class="ipt">
                    <input id="cur_money" type="text" disabled value="${cur_money}" />
                </td>

                <td class="label">预留残值：</td>
                <td class="ipt">
                    <input id="fore_money" type="text" disabled value="${fore_money}" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="ipt">
                    <input id="add_depre_month" type="text" value="${add_depre_month}" />
                </td>

                <td class="label no-empty">是否投放：</td>
                <td class="ipt">
