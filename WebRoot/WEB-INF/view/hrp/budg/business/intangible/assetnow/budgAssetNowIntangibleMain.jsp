...
<script type="text/javascript">
    ...
    function query() {
        ...
        grid.loadData(search, 'queryBudgAssetIntangibleNow.do');
    }
    ...
    function loadHead () {
    	var columns = [
    		...
    		{ display: '科室名称', name: 'dept_name', width: 140 },
    		{ display: '资产卡片号', name: 'ass_card_no', width: 140 },
    		{ display: '资产名称', name: 'ass_name', width: 140 },
    		{ display: '资金来源', name: 'source_name', width: 140 },
    ...
    function collect() {
        ...
        ajaxPostData({
        	url: "collectBudgAssetIntangibleNow.do?isCheck=false",
    ...
    function remove() {
        ...
        if (data.length == 0) {
            ...
            $.etDialog.confirm('确定删除?', function() {
                ajaxPostData({
                	url: "deleteBudgAssetIntangibleNow.do?isCheck=false",
