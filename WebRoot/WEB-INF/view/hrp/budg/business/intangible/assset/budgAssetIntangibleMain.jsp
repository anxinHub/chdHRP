...
<script type="text/javascript">
    ...
    var year_input, month_input, ass_natures_select, ass_type_select, ass_name_select, plan_no_input, dept_name_select, source_select;
    ...
    function query () {
        ...
        grid.loadData(search, 'queryBudgAssetIntangible.do');
    }
    ...
    function loadHead() {
    	var columns = [
    		...
    		{ display: '现有资产折旧预算', name: 'now_budg', align: 'right', width: '15%',
                render: function(ui) {
                	var now_budg = formatNumber(ui.cellData, 2, 1)

                    return "<a href='../assetnow/budgAssetNowIntangibleMainPage.do?isCheck=false' style='color:#0000ff'>" + now_budg + "</a>";
                }
            },
            { display: '预购资产折旧预算', name: 'pur_budg', align: 'right', width: '15%',
                render: function(ui) {
                	var pur_budg = formatNumber(ui.cellData, 2, 1)

                    return "<a href='../assetpur/budgAssetPurIntangibleMainPage.do?isCheck=false' style='color:#0000ff'>" + pur_budg + "</a>";
                }
            },
    ...
    function collect () {
        ...
        ajaxPostData({
        	url: "collectBudgAssetIntangible.do",
    ...
    function remove () {
        ...
        if (data.length == 0) {
            ...
            $.etDialog.confirm('确定删除?', function() {
                ajaxPostData({
                	url: "deleteBudgAssetIntangible.do",
