...
<script type="text/javascript">
    ...
    function query() {
        var search = [
            ...
            { name: 'naturs_code', value: ass_natures_select.getValue() },
        ...
        grid.loadData(search, 'queryBudgAssetIntangiblePur.do');
    }
    ...
    function loadHead() {
    	var columns = [
    		...
    		{ display: '购置计划号', name: 'plan_no', width: 140 },
    		{ display: '申请科室', name: 'dept_name', width: 140 },
    ...
    function collect() {
        ...
        ajaxPostData({
        	url: "collectBudgAssetIntangiblePur.do",
    ...
    function remove() {
        ...
        if (data.length == 0) {
            ...
            $(data).each(function() {
                ParamVo.push(
                	this.rowData.naturs_code + "@" +
                	this.rowData.group_id + "@" +
                    this.rowData.hos_id + "@" +
                    this.rowData.copy_code + "@" +
                    this.rowData.budg_year + "@" +
                    this.rowData.month + "@" +
                    this.rowData.plan_id + "@" +
            ...
            $.etDialog.confirm('确定删除?', function() {
                ajaxPostData({
                	url: "deleteBudgAssetIntangiblePur.do",
    ...
    <div class="mian">
        <table class="table-layout">
            ...
            <tr>
                ...
                <td class="ipt">
                    <input type="text" id="plan_no_input" style="width:150px;">
                </td>
