...
<script type="text/javascript">
		...
		function plupload(){  			
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgAssPurExecute.do?isCheck=false",    
		...
		function loadHead() {
				grid = $("#maingrid").ligerGrid({
					columns: [ 
						...
						{ display: '资产类别编码', name: 'ass_type_code', align: 'left'},
						{ display: '资产类别名称', name: 'ass_type_name', align: 'left'},
						{ display: '执行数据', name: 'pur_amount', align: 'left',
