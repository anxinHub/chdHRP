...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readWorkHosYearExecuteFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '执行数据', name: 'execute_value', align: 'right',
		...
		ajaxJsonObjectByUrl("addBatchBudgWorkHosExecute.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
