...
<script type="text/javascript">
    ...
    function  query(){
		...
		//加载查询条件
		grid.loadData(parms, 'queryBudgGroupBus.do?isCheck=false');
    }
    ...
    function loadHead(){
    	grid = $("#maingrid").etGrid({
    		 columns: [ 
				 ...
				 { display: '指标名称', name: 'index_name', width:120,frozen :true
				 		},
			     ...
			     { display: '本年合计', name: 'sum_year', align: 'right',width:120,frozen :true,
					 		render:function(ui){
					 			 if(ui.rowData.b_no == 2){
	                    		 	return "<a href=javascript:openUpdateSum('"+ui.rowData.year+"!"
	                    		 			+ui.rowData.index_code+"!"+ui.rowData.sum_year+ "')>"+formatNumber(ui.rowData.sum_year,2,1)+"</a>";		
					 			 }else{
                 ...
                 { display: '1月', name: 'month1', align: 'right',minWidth:100,
							 render:function(ui){
								 if(ui.rowData.b_no == 2){
				 ...
				 { display: '2月', name: 'month2', align: 'right',minWidth:100,
				 			 render:function(ui){
				 				if(ui.rowData.b_no == 2){
				 					return "<a href=javascript:openUpdate('"+ui.rowData.year+"!"+ui.rowData.index_code+"!"+
				 ...
				 { display: '3月', name: 'month3', align: 'right',minWidth:100,
				 			 render:function(ui){
				 				if(ui.rowData.b_no == 2){
				 					return "<a href=javascript:openUpdate('"+ui.rowData.year+"!"+ui.rowData.index_code+"!"+
				 ...
				 { display: '4月', name: 'month4', align: 'right',minWidth:100,
					    	 render:function(ui){
								if(ui.rowData.b_no == 2){
									return "<a href=javascript:openUpdate('"+ui.rowData.year+"!"+ui.rowData.index_code+"!"+
				 ...
				 { display: '5月', name: 'month5', align: 'right',minWidth:100,
					 		 render:function(ui){
					 			if(ui.rowData.b_no == 2){
					 				return "<a href=javascript:openUpdate('"+ui.rowData.year+"!"+ui.rowData.index_code+"!"+
				 ...
				 { display: '6月', name: 'month6', align: 'right',minWidth:100,
							 render:function(ui){
								if(ui.rowData.b_no == 2){
									return "<a href=javascript:openUpdate('"+ui.rowData.year+"!"+ui.rowData.index_code+"!"+
				 ...
				 { display: '7月', name: 'month7', align: 'right',minWidth:100,
							 render:function(ui){
								 if(ui.rowData.b_no == 2){
				 ...
				 { display: '8月', name: 'month8', align: 'right',minWidth:100,
							 render:function(ui){
								 if(ui.rowData.b_no == 2){
									 return "<a href=javascript:openUpdate('"+
	                    				ui.rowData.year+"!"+ui.rowData.index_code+"!"+
				 ...
				 { display: '9月', name: 'month9', align: 'right',minWidth:100,
							 render:function(ui){
								if(ui.rowData.b_no == 2){
									return "<a href=javascript:openUpdate('"+
                    				ui.rowData.year+"!"+ui.rowData.index_code+"!"+
				 ...
				 { display: '10月', name: 'month10', align: 'right',minWidth:100,
							 render:function(ui){
								 if(ui.rowData.b_no == 2){
									 return "<a href=javascript:openUpdate('"+
	                    				ui.rowData.year+"!"+ui.rowData.index_code+"!"+
				 ...
				 { display: '11月', name: 'month11', align: 'right',minWidth:100,
							 render:function(ui){
								 if(ui.rowData.b_no == 2){
									 return "<a href=javascript:openUpdate('"+
	                    				ui.rowData.year+"!"+ui.rowData.index_code+"!"+
	...
	function loadHotkeys() {
 	...
 	function openUpdate(obj){
  		...
  		var parm = 	
  			...
  			"month="+vo[2] 
  		$.etDialog.open({
            url: 'budgWorkGroupLinkPage.do?isCheck=false&'+parm,
            title: '医院业务预算查询',
            isMax: true
        });
    }
    function  openUpdateSum(obj){
  		...
  		var parm = 	
  			...
  			"sum_year="+vo[2]  
  		$.etDialog.open({
            url: 'budgWorkGroupLinkPageSum.do?isCheck=false&'+parm,
            title: '医院业务预算查询',
            isMax: true
        });
    }
