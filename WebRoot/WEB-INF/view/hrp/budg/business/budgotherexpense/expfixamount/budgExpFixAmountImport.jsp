...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgExpFixAmountFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '部门名称', name: 'dept_name', align: 'left',width:150},
				{ display: '支出项目编码', name: 'payment_item_code', align: 'left',width:100},
				{ display: '支出项目名称', name: 'payment_item_name', align: 'left',width:150},
				{ display: '定额', name: 'fix_amount', align: 'right',width:100,
