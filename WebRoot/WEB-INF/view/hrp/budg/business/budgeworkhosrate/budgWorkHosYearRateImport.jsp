...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgWorkHosYearRateFiles.do?isCheck=false",    
		...
		ajaxJsonObjectByUrl("addBatchBudgWorkHosYearRate.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
