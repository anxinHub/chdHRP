  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        measure_value:$("#measure_value").val(),
        rate:$("#rate").val(),
        count_value:$("#count_value").val()
        };
        ajaxJsonObjectByUrl("updateBudgWorkHosYearRate.do",formPara,function(responseData){
    ...
    function saveBudgWorkHosYearRate(){
        if($("form").valid()){
            save();
        }
    }
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="measure_value" type="text" id="measure_value" ltype="text" value="${measure_value}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
