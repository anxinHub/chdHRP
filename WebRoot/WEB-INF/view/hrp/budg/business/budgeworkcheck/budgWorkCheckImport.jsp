...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgWorkCheckFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '审批单号', name: 'check_code', align: 'left',editor:{type:'text'}},
				{ display: '审批类型', name: 'check_type', align: 'left',editor:{type:'text'}},
				{ display: '调整单号', name: 'adjust_code', align: 'left',editor:{type:'text'}},
				{ display: '备注', name: 'remark', align: 'left',editor:{type:'text'}},
				{ display: '制单人', name: 'maker', align: 'left',editor:{type:'text'}},
				{ display: '制单日期', name: 'make_data', align: 'left',editor:{type:'text'}},
				{ display: '审核人', name: 'checker', align: 'left',editor:{type:'text'}},
				{ display: '审核日期', name: 'check_data', align: 'left',editor:{type:'text'}},
				{ display: '预算下达日期', name: 'issue_data', align: 'left',editor:{type:'text'}},
				{ display: '状态', name: 'bc_state', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchBudgWorkCheck.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
