...
<script type="text/javascript">
    ...
    function query(type) {
        ...
        if (type === 'hos') {
            ...
            if (check_type == '02') {
                if (bc_state == '04') {
                    url = "queryBudgWorkHosMonthAdjustCopy.do?isCheck=false";
                } else {
                    url = "queryBudgWorkHosMonthAdjust.do?isCheck=false";
                }
            } else {
                if (bc_state == '04') {
                    url = "queryBudgWorkHosMonthCopy.do?isCheck=false";
                } else {
                    url = "queryBudgWorkHosMonth.do?isCheck=false";
                }
            }
            ...
            if (check_type == '02') {
                if (bc_state == '04') {
                    url = "queryBudgWorkCheckDeptMonthAdjustCopy.do?isCheck=false";
                } else {
                    url = "queryBudgWorkCheckDeptMonthAdjust.do?isCheck=false";
                }
            } else {
                if (bc_state == '04') {
                    url = "queryBudgWorkDeptMonthCopy.do?isCheck=false";
                } else {
                    url = "queryBudgWorkDeptMonth.do?isCheck=false";
                }
            }
    ...
    function loadHeadHos() {
        var columns = [
            { display: '科目编码', name: 'index_code', width: 100 },
            { display: '科目名称', name: 'index_name', width: 100 },
            {
                display: '本年合计',
                name: 'year_sum',
                align: 'right',
    ...
    function loadHeadDept() {
        var columns = [
            { display: '指标编码', name: 'index_code', width: 100 },
