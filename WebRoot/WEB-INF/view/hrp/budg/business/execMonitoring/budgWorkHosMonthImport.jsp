...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgWorkHosMonthFiles.do?isCheck=false",    
		...
		ajaxJsonObjectByUrl("addBatchBudgWorkHosMonth.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
