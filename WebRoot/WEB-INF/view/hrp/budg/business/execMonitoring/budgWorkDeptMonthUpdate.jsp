  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgWorkDeptMonth.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="last_year_workload" type="text" id="last_year_workload" ltype="text" value="${last_year_workload}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
