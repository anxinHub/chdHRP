...
<script type="text/javascript">
  ...
  //设置单元格打印格式
    ...
    function  query(){
		...
		//加载查询条件
		grid.loadData(parms, 'queryHosExecData.do?isCheck=false');
    }
    ...
    function loadHead(){
    	grid = $("#maingrid").etGrid({
    		columns: [ 
				...
				{ display: '项目', name: 'item', align: 'left',width:100,frozen :true,
						},
		    	{ display: '本年合计', name: 'sum_year', align: 'right',width:120,frozen :true,
			 		render:function(ui){
					...
					render:function(ui){
				    	  ...
				    	  if(ui.rowData.b_no == 2){
				    		 return "<a href=javascript:openUpdate('"+
	     				              ui.rowData.year+"!"+ui.rowData.index_code+"!"+"01"+ "')>"+formatNumber(value, 2, 1)+"</a>";					 
				    	  }else if(ui.rowData.b_no == 4){
				    		 return formatNumber(value,2,1) +"%";
				    	  }else{
				    		 return formatNumber(value,2,1) ;
			    ...
			    { display: '2月', name: 'month2', align: 'right',width:100,
			 		render:function(ui){
				    	 ...
				    	 if(ui.rowData.b_no == 2){
				    		 return "<a href=javascript:openUpdate('"+
	       				              ui.rowData.year+"!"+ui.rowData.index_code+"!"+"02"+ "')>"+formatNumber(value, 2, 1)+"</a>";					 
				    	 }else if(ui.rowData.b_no == 4){
				    		 return formatNumber(value,2,1) +"%";
				    	 }else{
				    		 return formatNumber(value,2,1) ;
				...
				{ display: '3月', name: 'month3', align: 'right',width:100,
			 		render:function(ui){
				    	 ...
				    	 if(ui.rowData.b_no == 2){
				    		 return "<a href=javascript:openUpdate('"+
	       				              ui.rowData.year+"!"+ui.rowData.index_code+"!"+"03"+ "')>"+formatNumber(value, 2, 1)+"</a>";					 
				    	 }else if(ui.rowData.b_no == 4){
				    		 return formatNumber(value,2,1) +"%";
				    	 }else{
				    		 return formatNumber(value,2,1) ;
				...
				{ display: '4月', name: 'month4', align: 'right',width:100,
			 		render:function(ui){
				    	 ...
				    	 if(ui.rowData.b_no == 2){
				    		 return "<a href=javascript:openUpdate('"+
	       				              ui.rowData.year+"!"+ui.rowData.index_code+"!"+"04"+ "')>"+formatNumber(value, 2, 1)+"</a>";					 
				    	 }else if(ui.rowData.b_no == 4){
				    		 return formatNumber(value,2,1) +"%";
				    	 }else{
				    		 return formatNumber(value,2,1) ;
			    ...
			    { display: '5月', name: 'month5', align: 'right',width:100,
			 	    render:function(ui){
				    	 ...
				    	 if(ui.rowData.b_no == 2){
				    		 return "<a href=javascript:openUpdate('"+
	       				              ui.rowData.year+"!"+ui.rowData.index_code+"!"+"05"+ "')>"+formatNumber(value, 2, 1)+"</a>";					 
				    	 }else if(ui.rowData.b_no == 4){
				    		 return formatNumber(value,2,1) +"%";
				    	 }else{
				    		 return formatNumber(value,2,1) ;
				...
				{ display: '6月', name: 'month6', align: 'right',width:100,
			 		render:function(ui){
				    	 ...
				    	 if(ui.rowData.b_no == 2){
				    		 return "<a href=javascript:openUpdate('"+
	       				              ui.rowData.year+"!"+ui.rowData.index_code+"!"+"06"+ "')>"+formatNumber(value, 2, 1)+"</a>";					 
				    	 }else if(ui.rowData.b_no == 4){
				    		 return formatNumber(value,2,1) +"%";
				    	 }else{
				    		 return formatNumber(value,2,1) ;
				...
				{ display: '7月', name: 'month7', align: 'right',width:100,
			 		render:function(ui){
				    	 ...
				    	 if(ui.rowData.b_no == 2){
				    		 return "<a href=javascript:openUpdate('"+
	       				              ui.rowData.year+"!"+ui.rowData.index_code+"!"+"07"+ "')>"+formatNumber(value, 2, 1)+"</a>";					 
				    	 }else if(ui.rowData.b_no == 4){
				    		 return formatNumber(value,2,1) +"%";
				    	 }else{
				    		 return formatNumber(value,2,1) ;
				...
				{ display: '8月', name: 'month8', align: 'right',width:100,
			 		render:function(ui){
				    	 ...
				    	 if(ui.rowData.b_no == 2){
				    		 return "<a href=javascript:openUpdate('"+
	       				              ui.rowData.year+"!"+ui.rowData.index_code+"!"+"08"+ "')>"+formatNumber(value, 2, 1)+"</a>";					 
				    	 }else if(ui.rowData.b_no == 4){
				    		 return formatNumber(value,2,1) +"%";
				    	 }else{
				    		 return formatNumber(value,2,1) ;
				...
				{ display: '9月', name: 'month9', align: 'right',width:100,
			 		render:function(ui){
				    	 ...
				    	 if(ui.rowData.b_no == 2){
				    		 return "<a href=javascript:openUpdate('"+
	       				              ui.rowData.year+"!"+ui.rowData.index_code+"!"+"09"+ "')>"+formatNumber(value, 2, 1)+"</a>";					 
				    	 }else if(ui.rowData.b_no == 4){
				    		 return formatNumber(value,2,1) +"%";
				    	 }else{
				    		 return formatNumber(value,2,1) ;
				...
				{ display: '10月', name: 'month10', align: 'right',width:100,
				 	render:function(ui){
				    	...
				    	if(ui.rowData.b_no == 2){
				    		return "<a href=javascript:openUpdate('"+
	       				             ui.rowData.year+"!"+ui.rowData.index_code+"!"+"10"+ "')>"+formatNumber(value, 2, 1)+"</a>";					 
				    	}else if(ui.rowData.b_no == 4){
				    		return formatNumber(value,2,1) +"%";
				    	}else{
				    		return formatNumber(value,2,1) ;
				...
				{ display: '11月', name: 'month11', align: 'right',width:100,
			 		render:function(ui){
				    	 ...
				    	 if(ui.rowData.b_no == 2){
				    		 return "<a href=javascript:openUpdate('"+
	       				              ui.rowData.year+"!"+ui.rowData.index_code+"!"+"11"+ "')>"+formatNumber(value, 2, 1)+"</a>";					 
				    	 }else if(ui.rowData.b_no == 4){
				    		 return formatNumber(value,2,1) +"%";
				    	 }else{
				    		 return formatNumber(value,2,1) ;
				...
				{ display: '12月', name: 'month12', align: 'right',width:100,
		 			render:function(ui){
				    	...
				    	if(ui.rowData.b_no == 2){
				    		return "<a href=javascript:openUpdate('"+
	       				            ui.rowData.year+"!"+ui.rowData.index_code+"!"+"12"+ "')>"+formatNumber(value, 2, 1)+"</a>";					 
				    	}else if(ui.rowData.b_no == 4){
				    		return formatNumber(value,2,1) +"%";
				    	}else{
				    		return formatNumber(value,2,1) ;
