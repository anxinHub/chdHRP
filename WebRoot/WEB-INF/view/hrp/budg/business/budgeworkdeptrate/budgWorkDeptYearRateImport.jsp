...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgWorkDeptYearRateFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '运营尺度名称', name: 'measure_name', align: 'left',editor:{type:'text'}},
				{ display: '运营预期', name: 'measure_value', align: 'left',editor:{type:'text'}},
				{ display: '概率', name: 'rate', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchBudgWorkDeptYearRate.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
