...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgWorkDeptYearRate.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='year']").val('');
				 $("input[name='dept_id']").val('');
				 $("input[name='index_code']").val('');
				 $("input[name='measure_name']").val('');
				 $("input[name='measure_value']").val('');
				 $("input[name='rate']").val('');
 ...
 function loadForm(){
    ...
    function saveBudgWorkDeptYearRate(){
        if($("form").valid()){
            save();
        }
   }
