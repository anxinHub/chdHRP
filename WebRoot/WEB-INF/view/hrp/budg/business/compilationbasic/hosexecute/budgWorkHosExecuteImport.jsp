...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgWorkHosExecuteFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '月份', name: 'month', align: 'left',editor:{type:'float'}},
				{ display: '执行数据', name: 'execute_value', align: 'left',editor:{type:'float'}},
				{ display: '说明', name: 'remark', align: 'left',editor:{type:'float'}},
