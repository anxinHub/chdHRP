...
var grid=parentWindow.grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(1, "100"); sheet.setText(0, 1, "指标名称");//修改
    	sheet.setColumnWidth(2, "150"); sheet.setText(0, 2, "执行数据");//修改
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("budgWorkHosYearExecuteImport.do?isCheck=false", para, function(responseData){	
