...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgHosYbLimitFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '医保类型编码', name: 'insurance_code', align: 'left',width:100},
				{ display: '本年支付额度(元)', name: 'pay_limit', align: 'left',width:120,
				...
				{ display: '控线增量比率(元)', name: 'rate', align: 'left',width:80,
					render:function(rowdata,rowindex,value){
		 				if(value){
		 					return formatNumber(value,2,1) + '%';
		 				}
				...
				{ display: '本年控制额度(元)', name: 'control_limit', align: 'left',width:120,
					render:function(rowdata,rowindex,value){
		 				if(value){
		 					return formatNumber(value,2,1);
		 				}
				...
				{ display: '备注', name: 'remark', align: 'left',width:150}
