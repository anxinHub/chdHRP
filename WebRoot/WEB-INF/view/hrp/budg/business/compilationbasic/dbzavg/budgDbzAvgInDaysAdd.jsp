	...
	function loadHead(){
     	grid = $("#maingrid").ligerGrid({
     		columns: [ 
                ...
                { display: '平均住院日(E)', name: 'avg_in_days', align: 'right',editor :{type : 'float'},
                    ...
                    toolbar: { 
                    	items: [
           						{ text: '保存', id:'add', click: saveBudgDbzAvgInDays , icon:'add' },
           	                	{ line:true },
       	 ...
       	 if(!validateGrid(data)){
	         ...
	         $(data).each(function (){					
	        	 ParamVo.push(					
	        		...
	        		disease_code  +"@"+ 
					this.insurance_code +"@"+
					(this.avg_in_days?this.avg_in_days:"-1")

					)
	         });
	        ajaxJsonObjectByUrl("addBudgDbzAvgInDays.do?isCheck=false",{ParamVo : ParamVo.toString()},function(responseData){
