...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgDbzAvgInDaysFiles.do?isCheck=false",    
		...
		function loadHead() {
             ...
             { display: '单病种编码', name: 'disease_code', align: 'left'},
		     { display: '单病种名称', name: 'disease_code', align: 'left' },
             { display: '医保类型', name: 'insurance_code', align: 'left'},
             { display: '平均住院日(E)', name: 'avg_in_days', align: 'left'},
