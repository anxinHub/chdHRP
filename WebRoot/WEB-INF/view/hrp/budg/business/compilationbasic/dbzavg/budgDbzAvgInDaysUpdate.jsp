...
<html style="overflow:hidden;">
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
       ...
       insurance_code:liger.get("insurance_code").getValue(),
        avg_in_days:$("#avg_in_days").val()
        };
        ajaxJsonObjectByUrl("updateBudgDbzAvgInDays.do?isCheck=false",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">平均住院日：</td>
            <td align="left" class="l-table-edit-td"><input name="avg_in_days" type="text" id="avg_in_days" ltype="text" value="${avg_in_days}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
