  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgDeptChargeStan.do",formPara,function(responseData){
    ...
    function loadDict(){
        ...
        autocomplete("#year","../../../queryBudgYear.do?isCheck=false","id","text",true,true);
          //加载费用编码   
        autocomplete("#charge_stan_code","../../../queryBudgChargeStan.do?isCheck=false","id","text",true,true);
            //加载科室     
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">费用标准编码：</td>
            <td align="left" class="l-table-edit-td"><input name="charge_stan_code" type="text" id="charge_stan_code" ltype="text" value="${charge_stan_code}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
