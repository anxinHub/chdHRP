...
var grid=parentWindow.grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(2, "250"); sheet.setText(0, 2, "科室名称");
    	sheet.setColumnWidth(3, "150"); sheet.setText(0, 3, "预算值");//修改
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("budgDeptChargeStanImport.do?isCheck=false", para, function(responseData){	
