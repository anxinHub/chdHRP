...
var grid=parentWindow.grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(2, "200"); sheet.setText(0, 2, "医保类型名称");//修改
    	sheet.setColumnWidth(3, "150"); sheet.setText(0, 3, "医保收入值");//修改
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("budgZeyfIncomeHisImport.do?isCheck=false", para, function(responseData){	
