  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        yb_income:$("#yb_income").val()
        };
        ajaxJsonObjectByUrl("updateBudgZeyfIncomeHis.do?isCheck=false",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">医保收入：</td>
            <td align="left" class="l-table-edit-td"><input name="yb_income" type="text" id="yb_income" ltype="text" value="${yb_income}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
