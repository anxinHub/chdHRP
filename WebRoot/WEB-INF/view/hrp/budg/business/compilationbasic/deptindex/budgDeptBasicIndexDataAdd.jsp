...
<html style="overflow:hidden;">
    ...
    <script type="text/javascript">
     ...
     function loadHead(){
     	grid = $("#maingrid").ligerGrid({
            columns: [ 
 					  ...
 					  { display: '预算科室(E)', name: 'dept_id', align: 'left',valueField:'id',textField:'text',
 					 			 editor : {
										type : 'select',
										valueField : 'id',
										textField : 'text',
										url : '../../../queryBudgBasicIndexDept.do?isCheck=false&index_code='+index_code,
										keySupport : true,
										autocomplete : true,
									} 
  					 		},
     ...
     function  save(){   	 
    	 ...
    	 if (data.length == 0){
	        ...
	        ajaxJsonObjectByUrl(" addBudgDeptBasicIndexData.do?isCheck=false",{ParamVo : ParamVo.toString()},function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
        ...
        autocomplete("#index_code","../../../queryBudgDeptindex_code_name.do?isCheck=false&index_nature=02","id","text",true,true,'',true );
