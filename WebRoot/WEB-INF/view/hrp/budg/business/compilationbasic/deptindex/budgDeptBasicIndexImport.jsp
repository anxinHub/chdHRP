...
var grid=parentWindow.grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(1, "100"); sheet.setText(0, 1, "指标名称");
    	sheet.setColumnWidth(2, "100"); sheet.setText(0, 2, "科室名称");
    	sheet.setColumnWidth(3, "150"); sheet.setText(0, 3, "预算值");
    	sheet.setColumnWidth(4, "250"); sheet.setText(0, 4, "说明(可空)");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importBudgBasicDeptIndex.do?isCheck=false", para, function(responseData){	
