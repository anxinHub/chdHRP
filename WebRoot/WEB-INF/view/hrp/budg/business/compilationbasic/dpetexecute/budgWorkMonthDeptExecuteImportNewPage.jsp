...
var grid=parentWindow.grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(2, "100"); sheet.setText(0, 2, "指标名称");
    	sheet.setColumnWidth(3, "100"); sheet.setText(0, 3, "科室名称");
    	sheet.setColumnWidth(4, "150"); sheet.setText(0, 4, "执行数据");
    	sheet.setColumnWidth(5, "250"); sheet.setText(0, 5, "说明");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("budgWorkDeptMonthExecuteImport.do?isCheck=false", para, function(responseData){	
