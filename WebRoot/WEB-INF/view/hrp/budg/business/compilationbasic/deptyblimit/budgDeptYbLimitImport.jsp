...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgDeptYbLimitFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '医保类型', name: 'insurance_code', align: 'left',width:100},
				{ display: '科室医保额度', name: 'control_limit', align: 'left',width:120},
