...
<html style="overflow:hidden;">
  ...
  //查询
    ...
    function save(){
        ...
        rate:$("#rate").val(),
        dept_control_limit:$("#dept_control_limit").val(),
        remark:$("#remark").val()
        };
        ajaxJsonObjectByUrl("updateBudgDeptYbLimit.do?isCheck=false",formPara,function(responseData){
    ...
    function savebudgZeyfIncomeDept(){
        if($("form").valid()){
            save();
        }
    }
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">科室医保额度：</td>
            <td align="left" class="l-table-edit-td"><input name="dept_control_limit" type="text" id="dept_control_limit" ltype="text" value="${dept_control_limit}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
