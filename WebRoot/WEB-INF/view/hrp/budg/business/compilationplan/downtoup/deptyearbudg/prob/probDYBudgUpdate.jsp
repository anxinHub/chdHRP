  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateProbHYBudgUp.do?isCheck=false",formPara,function(responseData){
    ...
    function loadDict(){
        ...
        autocomplete("#index_code","../../../../../qureyBudgIndexFromPlan.do?isCheck=false&budg_level=01&edit_method=04&budg_year="+budg_year,"id","text",true,true,'',false,'${index_code}',200);
    }   
    </script>
