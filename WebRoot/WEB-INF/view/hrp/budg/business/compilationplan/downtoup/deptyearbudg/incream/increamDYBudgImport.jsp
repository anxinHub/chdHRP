...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readIncreamDYBudgFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '增长额', name: 'grow_value', align: 'right',width:120,
					render:function(rowdata,rowindex,value){
						if(value){
							return formatNumber(value,2,1);
						}
				...
				{ display: '说明', name: 'remark', align: 'left',width:120},
				/*{ display: '医院意见分解', name: 'hos_suggest_resolve', align: 'right',width:120,
					render:function(rowdata,rowindex,value){
						if(value){
							return formatNumber(value,2,1);
						}
