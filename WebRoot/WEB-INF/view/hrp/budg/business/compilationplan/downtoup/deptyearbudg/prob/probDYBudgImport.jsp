...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readProbDYBudgFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '年度', name: 'year', align: 'left',width:100},
				{ display: '指标编码', name: 'index_code', align: 'left',width:100},
				{ display: '科室编码', name: 'dept_code', align: 'left',width:100},
				{ display: '上年业务量', name: 'last_year_workload', align: 'left',width:100,
				...
				{ display: '增长比例', name: 'grow_rate', align: 'left',width:100},
				{ display: '增长额', name: 'grow_value', align: 'left',width:100,
					render:function(rowdata,rowindex,value){
						if(value){
							return formatNumber(value,2,1);
						}
				...
				{ display: '说明', name: 'remark', align: 'left',width:100},
				{ display: '科室意见汇总', name: 'dept_suggest_sum', align: 'left',width:100}
