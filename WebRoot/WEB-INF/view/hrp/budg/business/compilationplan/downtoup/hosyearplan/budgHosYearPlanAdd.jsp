  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     $(function (){
		...
		$.post("queryBudgBuiltIn.do?isCheck=false&budg_level=01&work_budg_edit_mode=02",null,function(responseData){
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgHosYearPlanDown.do?isCheck=fasle",formPara,function(responseData){
