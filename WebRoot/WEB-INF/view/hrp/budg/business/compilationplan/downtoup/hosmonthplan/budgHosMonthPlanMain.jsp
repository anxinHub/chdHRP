			...
			<script type="text/javascript">
				...
				function loadHead() {
					grid = $("#maingrid").ligerGrid({
						...
						dataAction: 'server', dataType: 'server', usePager: true, url: 'queryBudgHosMonthPlanDown.do?isCheck=false&budg_level=02',
				...
				function lodopPrint() {
					...
					grid.options.lodop.title = "医院月份业务预算编制方案";
				}
				...
				function add_open() {
					...
					if (budg_year) {
						parent.$.ligerDialog.open({
							url: 'hrp/budg/business/compilationplan/downtoup/hosmonthplan/budgHosMonthPlanAddPage.do?isCheck=false&budg_year=' + budg_year, data: {}, height: 400, width: 700,
				...
				function remove() {
					...
					if (data.length == 0) {
						...
						$.ligerDialog.confirm('确定删除?', function (yes) {
							if (yes) {
								ajaxJsonObjectByUrl("deleteBudgHosMonthPlanDown.do?isCheck=false", { ParamVo: ParamVo.toString() }, function (responseData) {
				...
				function openUpdate(obj) {
					...
					parent.$.ligerDialog.open({
						url: 'hrp/budg/business/compilationplan/downtoup/hosmonthplan/budgHosMonthPlanUpdatePage.do?isCheck=false&' + parm, data: {}, height: 400, width: 700,
