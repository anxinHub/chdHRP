...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     $(function (){
    	 ...
    	 $("#year").change(function(){
    		 ...
    		 autocomplete("#index_code","../../../../../qureyBudgIndexFromPlan.do?isCheck=false&budg_level=03&edit_method=01&budg_year="+budg_year,"id","text",true,true,'',true,'',200);
        })
     ...
     function  save(){
    	 if($("form").valid()){
        	 ...
        	 if (data.length == 0){
    	        ...
    	        ajaxJsonObjectByUrl("addZeroDYBudgDown.do?isCheck=false",{ParamVo : ParamVo.toString()},function(responseData){
	...
	$("#index_code").ligerComboBox({width:200});
