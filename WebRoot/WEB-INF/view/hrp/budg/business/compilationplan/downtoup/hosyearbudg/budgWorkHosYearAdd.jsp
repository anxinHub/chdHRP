...
<html style="overflow:hidden;">
    ...
    <script type="text/javascript">
     ...
     function loadHead(){
     	grid = $("#maingrid").ligerGrid({
            columns: [ 
                      { display: '预算指标', name: 'index_code', align: 'left' ,
 					 			valueField:"id",textField : 'text',
 					 			editor : {
 									type : 'select',
 									valueField : 'id',
 									textField : 'text',
 									url : '../../../../qureyBudgIndexFromPlan.do?isCheck=false&budg_level=01&budg_year='+budg_year,
 									keySupport : true,
 									autocomplete : true,
 									/* onChanged : queryLastYearWork */
 								} 
 					 		},
 					 ...
 					 { display: '医院意见(E)', name: 'hos_suggest', align: 'right',editor : {type : 'float'},
 					 			render:function(rowdata,rowindex,value){
 					 				if(value){
 					 					return formatNumber(value,2,1);
 					 				}
  ...
  /*  //选择 指标后 查询其上年业务量 并更新上年业务量单元格
     function queryLastYearWork(rowdata){
        	 ...
        	 if (data.length == 0){
    	         ...
    	         $(data).each(function (){					
    	        	 ParamVo.push(
    					...
    					(this.hos_suggest? this.hos_suggest:"-1")
    				)
    	         });
    	        ajaxJsonObjectByUrl("addBudgWorkHosYearDown.do?isCheck=false",{ParamVo : ParamVo.toString()},function(responseData){
