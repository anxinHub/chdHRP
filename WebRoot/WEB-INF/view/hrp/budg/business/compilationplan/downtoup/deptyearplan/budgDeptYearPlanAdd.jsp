  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     $(function (){
        ...
        $.post("queryBudgBuiltIn.do?isCheck=false&budg_level=03&work_budg_edit_mode=02",null,function(responseData){
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgDeptYearPlanDown.do?isCheck=fasle",formPara,function(responseData){
