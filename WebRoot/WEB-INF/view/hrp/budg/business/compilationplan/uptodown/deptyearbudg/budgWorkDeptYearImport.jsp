...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgWorkDeptYearFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '上年业务量', name: 'last_year_workload', align: 'left'},
				{ display: '增长比例', name: 'grow_rate', align: 'left'},
				{ display: '预算值', name: 'budg_value', align: 'left'},
				{ display: '说明', name: 'remark', align: 'left'},
				{ display: '科室意见', name: 'dept_suggest', align: 'left'}
