            ...
            columns: [ 
                      { display: '指标编码', name: 'index_code', align: 'left' ,
 					 			...
 					 			editor : {
 									...
 									valueField : 'id',
 									textField : 'text',
 									url : '../../../../../qureyBudgIndexFromPlan.do?isCheck=false&subj_level=01&edit_method=03&budg_year='+budg_year,
 									keySupport : true,
 									autocomplete : true,
 								} 
 					 		},
 					 ...
 					 { display: '科室意见汇总(元/E)', name: 'dept_suggest_sum', align: 'right',editor : {type : 'float'},
 					 			render:function(rowdata,rowindex,value){
 					 				if(value){
 					 					return formatNumber(value,2,1);
 					 				}
     ...
     function  save(){
    	 if($("form").valid()){
        	 ...
        	 if (data.length == 0){
    	        ...
    	        ajaxJsonObjectByUrl("addCertenHYBudgUp.do?isCheck=false",{ParamVo : ParamVo.toString()},function(responseData){
