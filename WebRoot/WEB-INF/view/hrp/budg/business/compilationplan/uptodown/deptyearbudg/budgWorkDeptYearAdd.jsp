     ...
     $(function (){
         ...
         $("#year").change(function(){
         	budg_year = liger.get("year").getValue();
         	 ...
         	 autocomplete("#index_code","../../../../qureyBudgIndexFromPlan.do?isCheck=false&budg_level=03&budg_year="+budg_year,"id","text",true,true,"",true);
     ...
     function loadHead(){
     	grid = $("#maingrid").ligerGrid({
            columns: [ 
 					  ...
 					  { display: '增长比例(E)', name: 'grow_rate', align: 'right',editor : {type : 'float'},
 					 			render:function(rowdata,rowindex,value){
					 				if(value){
					 					return formatNumber(value,2,1)+"%";
					 				}
 					 ...
 					 { display: '科室意见(元/E)', name: 'dept_suggest', align: 'right',editor : {type : 'float'},
 					 			render:function(rowdata,rowindex,value){
					 				if(value){
					 					return formatNumber(value,2,1);
					 				}
     ...
     function  save(){
    	 if($("form").valid()){
        	 ...
        	 if (data.length == 0){
    	        ...
    	        ajaxJsonObjectByUrl("addBudgWorkDeptYearUp.do?isCheck=false",{ParamVo : ParamVo.toString()},function(responseData){
