...
<script type="text/javascript">
    ...
    function  query(){
		...
		//加载查询条件
		grid.loadData(parms, 'queryResolveData.do?isCheck=false');
     }
    function loadHead(){
    				...
    				usePager: true, width: '100%', height: '100%', checkbox: true, editable: true,
	   				...
	   				toolbar: {
	   					items: [
	   						...
	   						{ type: "button", label: '计算', icon: 'calculator', listeners: [{ click: resolveData }] },
	...
	function save(){
	    ...
	    ajaxPostData({
		    url: 'updateBudgWorkHosMonthRate.do?isCheck=false',
