  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     $(function (){
		...
		$.post("queryBudgBuiltIn.do?isCheck=false&budg_level=04&work_budg_edit_mode=01",null,function(responseData){
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgDeptMonthPlanUp.do?isCheck=fasle",formPara,function(responseData){
