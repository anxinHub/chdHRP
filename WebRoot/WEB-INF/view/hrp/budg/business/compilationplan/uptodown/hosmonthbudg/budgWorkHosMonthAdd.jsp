  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgWorkHosMonthUp.do",formPara,function(responseData){
    ...
    function loadDict(){
        ...
        $("#last_year_workload").ligerTextBox({width:160});
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="last_year_workload" type="text" id="last_year_workload" ltype="text" validate="{required:false,number:true,maxlength:18}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
