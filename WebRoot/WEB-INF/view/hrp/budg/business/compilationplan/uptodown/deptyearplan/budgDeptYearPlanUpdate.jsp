...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("updateBudgDeptYearPlanUp.do?isCheck=fasle",formPara,function(responseData){
  ...
  //选择自定义分解系数页面 
    ...
    function loadDict(){
      ...
      //自定义分解系数 下拉框
        autocomplete("#resolve_data","../../../../queryBudgResolveDataDict.do?isCheck=false&budg_level=03","id","text",true,true,'',false,'${resolve_data}',180);
	 	//分解层次 下拉框
