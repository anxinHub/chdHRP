            ...
            columns: [ 
                      { display: '指标编码', name: 'index_code', align: 'left' ,
 					 			...
 					 			editor : {
 									...
 									valueField : 'id',
 									textField : 'text',
 									url : '../../../../../qureyBudgIndexFromPlan.do?isCheck=false&subj_level=01&edit_method=04&budg_year='+budg_year,
 									keySupport : true,
 									autocomplete : true,
 								} 
 					 		},
    	 ...
    	 if($("form").valid()){
        	 ...
        	 if (data.length == 0){
    	         ...
    	         $(data).each(function (){	
   	        	 ...
   	        	 ajaxJsonObjectByUrl("addProbHYBudgUp.do?isCheck=false",{ParamVo : ParamVo.toString()},function(responseData){
