  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     $(function (){
		...
		$.post("queryBudgBuiltIn.do?isCheck=false&budg_level=01&work_budg_edit_mode=01",null,function(responseData){
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgHosYearPlanUp.do?isCheck=fasle",formPara,function(responseData){
    ...
    function loadDict(){
		...
		//自定义分解系数 下拉框
        autocomplete("#resolve_data","../../../../queryBudgResolveDataDict.do?isCheck=false&budg_level=01","id","text",true,true,'',false,'',180);
   ...
   <form name="form" method="post"  id="form" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="formula_id" type="text" id="formula_id" disabled="disabled" ltype="text" validate="{required:true,maxlength:200}" /></td> 
            <td align="left"></td> 
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="fun_id" type="text" id="fun_id"  disabled="disabled" ltype="text" validate="{required:true,maxlength:200}" /></td>
            <td align="left"></td> 
            <td align="center" class="l-table-edit-td" colspan="3">
