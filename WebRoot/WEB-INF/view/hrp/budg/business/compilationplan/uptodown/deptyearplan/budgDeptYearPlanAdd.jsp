...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     $(function (){
        ...
        $.post("queryBudgBuiltIn.do?isCheck=false&budg_level=03&work_budg_edit_mode=01",null,function(responseData){
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addBudgDeptYearPlanUp.do?isCheck=fasle",formPara,function(responseData){
    ...
    //选择计算公式页面
  	...
  	function selectFun(){
		...
		if(!budg_year){
  		...
  		parent.$.ligerDialog.open({
  			url : 'hrp/budg/common/budgfun/budgFunBusinessPage.do?isCheck=false&budg_year='+budg_year+'&budg_level='+'03'+'&index_code='+index_code+'&index_type_code='+index_type_code,height : 500,width : 750,title : '取值函数选择',
  			modal : true,showToggle : false,showMax : true,showMin :false ,	isResize : true,
  			parentframename:window.name,  //用于parent弹出层调用本页面的方法或变量
  ...
  //选择自定义分解系数页面 
   	function selectResolve(){
   		...
   		parent.$.ligerDialog.open({
  			url : 'hrp/budg/common/budgresolvedatadict/budgResolveDataPage.do?isCheck=false&budg_level=03',
