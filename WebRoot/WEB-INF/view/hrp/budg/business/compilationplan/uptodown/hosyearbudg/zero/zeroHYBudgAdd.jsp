            ...
            columns: [ 
                      { display: '指标编码', name: 'index_code', align: 'left' ,
 					 			...
 					 			editor : {
 									...
 									valueField : 'id',
 									textField : 'text',
 									url : '../../../../../qureyBudgIndexFromPlan.do?isCheck=false&budg_level=01&edit_method=01&budg_year='+budg_year,
 									keySupport : true,
 									autocomplete : true,
 								} 
 					 		},
     ...
     function  save(){
    	 if($("form").valid()){
        	 ...
        	 if (data.length == 0){
    	        ...
    	        ajaxJsonObjectByUrl("addZeroHYBudgUp.do?isCheck=false",{ParamVo : ParamVo.toString()},function(responseData){
