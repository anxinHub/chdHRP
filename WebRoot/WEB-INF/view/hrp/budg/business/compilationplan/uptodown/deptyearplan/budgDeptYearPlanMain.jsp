			...
			<script type="text/javascript">
				...
				function loadHead() {
					grid = $("#maingrid").ligerGrid({
						...
						dataAction: 'server', dataType: 'server', usePager: true, url: 'queryBudgDeptYearPlanUp.do?isCheck=false&budg_level=03',
				...
				function add_open() {
					...
					if (budg_year) {
						...
						parent.$.ligerDialog.open({
							url: 'hrp/budg/business/compilationplan/uptodown/deptyearplan/budgDeptYearPlanAddPage.do?isCheck=false&budg_year=' + budg_year, data: {}, height: 400, width: 700,
				...
				function remove() {
					...
					if (data.length == 0) {
						...
						$.ligerDialog.confirm('确定删除?', function (yes) {
							if (yes) {
								ajaxJsonObjectByUrl("deleteBudgDeptYearPlanUp.do?isCheck=false", { ParamVo: ParamVo.toString() }, function (responseData) {
				...
				function openUpdate(obj) {
					...
					parent.$.ligerDialog.open({
						url: 'hrp/budg/business/compilationplan/uptodown/deptyearplan/budgDeptYearPlanUpdatePage.do?isCheck=false&' + parm, data: {}, height: 400, width: 700,
