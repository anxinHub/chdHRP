  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        $.ajaxFileUpload({  
            url : 'addBudgWorkAdj.do?budg_year='+budg_year+'&adj_code='+adj_code+'&adj_file='+adj_file+"&adj_remark="+adj_remark+"&last_check_code="+last_check_code, //用于文件上传的服务器端请求地址  
   ...
   //关闭当前页面
    ...
    function loadDict(){
		...
		$("#close").ligerButton({click: close_iframe, width:80});
	} 
    </script>
    <script>
    jQuery.extend({  
