...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgDrugCostFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '月', name: 'month', align: 'left'},
				{ display: '科室编码', name: 'dept_code', align: 'left'},
				{ display: '科室名称', name: 'dept_code', align: 'left'},
				{ display: '药品分类编码', name: 'med_type_code', align: 'left'},
				{ display: '药品分类名称', name: 'med_type_name', align: 'left'},
