...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgEmpWageTotalFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '职工ID', name: 'emp_id', align: 'left',editor:{type:'text'}},
				{ display: '职称编码', name: 'title_code', align: 'left',editor:{type:'text'}},
				{ display: '工资项目编码', name: 'wage_item_code', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchBudgEmpWageTotal.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
