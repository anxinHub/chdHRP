...
<script type="text/javascript">
		...
		function loadHead() {
				...
				{ display: '月', name: 'month', align: 'left',width:60},
				...
				{ display: '职工名称', name: 'emp_name', align: 'left',width:100},
				{ display: '职工类别名称', name: 'emp_type_name', align: 'left',width:100},
				{ display: '工资项目名称', name: 'wage_item_name', align: 'left',width:120},
				{ display: '金额', name: 'amount', align: 'right',width:120,
