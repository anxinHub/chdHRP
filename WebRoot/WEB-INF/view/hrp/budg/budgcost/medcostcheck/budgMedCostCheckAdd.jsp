...
<script type="text/javascript">
    ...
    function query (type) {
        ...
        if (type === 'hos') {
            grid.loadData(parms, "queryBudgMedCostHosMonth.do?isCheck=false");
        } else if (type === 'dept') {
            gridDept.loadData(parms, "queryBudgMedCostDeptMonth.do?isCheck=false");
        }
    }
