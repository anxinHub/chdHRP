...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgAddEmpPlanFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '计划单号', name: 'plan_code', align: 'left',editor:{type:'text'}},
				{ display: '计划年度', name: 'plan_year', align: 'left',editor:{type:'text'}},
				{ display: '计划类型', name: 'plan_type', align: 'left',editor:{type:'text'}},
				{ display: '增员人数', name: 'num', align: 'left',editor:{type:'text'}},
				{ display: '申报说明', name: 'explain', align: 'left',editor:{type:'text'}},
				{ display: '申报人', name: 'maker', align: 'left',editor:{type:'text'}},
				{ display: '申报日期', name: 'make_date', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchBudgAddEmpPlan.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
