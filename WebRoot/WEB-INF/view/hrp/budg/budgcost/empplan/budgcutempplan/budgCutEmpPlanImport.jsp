...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgCutEmpPlanFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '减员人数', name: 'num', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchBudgCutEmpPlan.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
