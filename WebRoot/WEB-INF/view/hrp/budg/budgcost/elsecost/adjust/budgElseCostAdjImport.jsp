...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readBudgWorkAdjFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '调整单号', name: 'adj_code', align: 'left',editor:{type:'text'}},
				{ display: '操作员所在科室', name: 'adj_file', align: 'left',editor:{type:'text'}},
				{ display: '调整说明', name: 'adj_remark', align: 'left',editor:{type:'text'}},
				...
				{ display: '上次下达日期', name: 'last_issue_data', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchBudgWorkAdj.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
