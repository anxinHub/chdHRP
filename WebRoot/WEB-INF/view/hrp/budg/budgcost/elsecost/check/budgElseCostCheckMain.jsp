...
<script type="text/javascript">
    ...
    function query() {
        ...
        grid.loadData(parms, 'queryBudgElseCostCheck.do?isCheck=false');
    }
    ...
    function lodopPrint() {
        ...
        grid.options.lodop.title = "其他支出预算审批";
    }
    ...
    function add_open() {
        ...
        ajaxPostData({
            url: "../../../common/budgeditstate/queryElseCostFlag.do?isCheck=false&year=" + budg_year,
            success: function(responseData) {
                if (responseData.flag == "1") {
                    parent.$.etDialog.open({
                        url: 'hrp/budg/budgcost/elsecost/check/budgElseCostCheckAddPage.do?isCheck=false',
                        title: '其他支出预算审批申请添加',
                        isMax: true,
    ...
    function remove() {
        ...
        if (data.length == 0) {
            ...
            //校验 选中数据状态
            ajaxPostData({
                url: "queryBudgElseCostCheckState.do?isCheck=false",
                data: {
                    budg_year: budg_year,
                ...
                success: function(responseData) {
                    if (responseData.state == "false") {
                        ...
                        $.etDialog.confirm('确定删除?', function() {
                            ajaxPostData({
                                url: "deleteBudgElseCostCheck.do",
                                data: formPara,
                                success: function(responseData) {
                                    query();
                                }
    ...
    function imp() {
        var index = layer.open({
            ...
            area: ['893px', '500px'],
            content: 'budgElseCostCheckImportPage.do?isCheck=false'
        });
        layer.full(index);
    }
    //下载临时模板
    ...
    function openUpdate(obj) {
        ...
        parent.$.etDialog.open({
            url: 'hrp/budg/budgcost/elsecost/check/budgElseCostCheckUpdatePage.do?isCheck=false&' + parm,
            title: '其他支出预算审核申请修改',
            isMax: true,
