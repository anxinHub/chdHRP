...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "100"); sheet.setText(0, 0, "现金流量项目编码");
    	sheet.setColumnWidth(1, "100"); sheet.setText(0, 1, "金额(元)");
    	sheet.setColumnWidth(2, "250"); sheet.setText(0, 2, "说明(可空)");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importBudgCashFlowBegin.do?isCheck=false", para, function(responseData){	
