...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(2, "100"); sheet.setText(0, 2, "金额(元)");
    	sheet.setColumnWidth(3, "250"); sheet.setText(0, 3, "说明(可空)");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importBudgCashPlanPage.do?isCheck=false", para, function(responseData){	
