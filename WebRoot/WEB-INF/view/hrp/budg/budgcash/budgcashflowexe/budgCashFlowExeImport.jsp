...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(2, "250"); sheet.setText(0, 2, "现金流量项目编码");
    	sheet.setColumnWidth(3, "100"); sheet.setText(0, 3, "金额(元)");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importBudgCashFlowExe.do?isCheck=false", para, function(responseData){	
