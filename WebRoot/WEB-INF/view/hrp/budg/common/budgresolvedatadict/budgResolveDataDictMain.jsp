  ...
  //打印回调方法
    function lodopPrint(){
    	var head="";
 		...
 		grid.options.lodop.title="自定义分解系数";
    }
    ...
    function imp(){
    	...
    	var index = layer.open({
					...
					area : [ '893px', '500px' ],
					content : 'budgResolveDataDictImportPage.do?isCheck=false'
				});
				layer.full(index);
    	}	
    //下载临时模板
   ...
   //修改页面跳转
    ...
    function loadDict(){
            //字典下拉框
            //预算层次(默认 医院月份)
           autocomplete("#budg_level","../../queryBudgLevel.do?isCheck=false&it=医院年度","id","text",true,true,'',false,'02');
            
            $("#budg_level").ligerTextBox({width:160});
