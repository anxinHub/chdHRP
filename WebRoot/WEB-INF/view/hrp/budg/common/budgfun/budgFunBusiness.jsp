...
<script type="text/javascript">
	...
	function addFun(){
	 ...
	 function loadComType(obj){
		ajaxJsonObjectByUrl("queryComTypePara.do?isCheck=false&fun_code="+obj+"&budg_year="+budg_year+"&budg_level="+budg_level+"&index_code=${index_code}"+"&index_type_code=${index_type_code}", {},
    ...
    function saveSelectFun(){
    	...
    	$.each(fun_para_code,function(i,v){
    			if(this.com_type_nature == "text"){
    				...
    				ParamVo.push({'budg_year':budg_year,'budg_level':budg_level,'index_code':index_code,'fun_para_code':key,'fun_para_value':val,"index_type_code":index_type_code});
    		    }else if(this.com_type_nature == "input"){
    	...
    	parentFrameUse().liger.get("fun_id").setText(row.fun_code + ' ' + row.fun_name);
