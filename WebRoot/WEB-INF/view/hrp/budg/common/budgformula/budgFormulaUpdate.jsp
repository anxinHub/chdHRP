...
<script type="text/javascript">
	...
	function save() {
		...
		ajaxJsonObjectByUrl("updateBudgFormula.do?isCheck=false", formPara,
	...
	function loadDict() {
		...
		//autoCompleteByData("#is_stop", yes_or_no.Rows, "id", "text", true, true,"",false,"${is_stop}",80);
		
		$("#formula_id").ligerTextBox({width : 130,disabled:true});
		...
		<div id="layout1"
			...
			<div position="top">
				<table cellpadding="0" cellspacing="0" class="l-table-edit">
					<tr>
						...
						<td align="left" class="l-table-edit-td"><input name="formula_id" type="text" value="${formula_id}" id="formula_id" ltype="text" validate="{required:true,maxlength:20}" /></td>
						<td align="left"></td>
						...
						<td align="left" class="l-table-edit-td">
							...
							<input name="formula_en" type="hidden" id="formula_en" ltype="text" validate="{required:true,maxlength:2000}" value="${formula_en}" />
							<input name="formula_stack" type="hidden" id="formula_stack" ltype="text" validate="{required:true,maxlength:2000}" value="${formula_stack}" />
						</td>
			...
			<div position="center" title="计算公式（中文）">
				<table cellpadding="0" cellspacing="0" class="l-table-edit">
					<tr>
						<td align="left" class="l-table-edit-td">
						<textarea rows="9" class="liger-textarea" id="formula_ca" disabled name="formula_ca" style="width: 915px; font-size: 16px;"
								validate="{required:true}">${formula_ca}</textarea></td>
					<tr />
				</table>
			</div>
			<div position="centerbottom">
				...
				<table align="center">
					...
					<tr>
						...
						<td align="left" style="padding: 0px 0px 10px 40px;" class="l-table-edit-td"><input class="liger-button" type="button" value=")" onClick="buttonYKH();"></td>
					</tr>
					<tr>
