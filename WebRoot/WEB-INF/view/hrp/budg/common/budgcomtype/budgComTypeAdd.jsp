...
<html style="overflow:hidden;">
  <head>
    ...
    function loadDict(fc) {
    	 ...
    	 autocomplete("#para_code"+fc,"../queryBudgFunParaMethod.do?isCheck=false","id", "text", true, true, para);
...
<body>
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				 <td align="left" class="l-table-edit-td">
					<input type="button" class="liger-button" id="addText"  value="添加文本框"/>
				</td>
				<td align="left" class="l-table-edit-td">
					<input type="button" class="liger-button" id="addSelect"  value="添加下拉框"/>
				</td>
				<td align="left" class="l-table-edit-td">
					<input type="button" class="liger-button" id="addDate" value="添加日期框"/>
				</td>
			</tr>
		</table>	
