...
<html style="overflow:hidden;">
  ...
  <jsp:include page="${path}/inc_jquery_1.9.0.jsp" />
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateBudgFunParaMethod.do?isCheck=false",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b><font color="red">*</font></b>参数代码：</td>
            <td align="left" class="l-table-edit-td"><input name="para_code" type="text" id="para_code" ltype="text" disabled="disabled" value="${para_code}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>参数名称:</b></td>
            <td align="left" class="l-table-edit-td"><input name="para_name" type="text" id="para_name" ltype="text" value="${para_name}" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
       </tr> 
        <tr>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td" colspan="4">
            	<textarea rows="15" class="liger-textarea" id="para_sql" name="para_sql"  style="width:440px" validate="{required:true}" >${para_sql}</textarea>
            </td>
            <td align="left"></td>
        </tr>
		<tr>
