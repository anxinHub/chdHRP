...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("updateHpmCostitemIncreaseData.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function saveCostitemIncreaseData(){
        if($("form").valid()){
            save();
        }
   }
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="acct_year" type="text" class="Wdate" id="acct_year" disabled="disabled" value="${acct_year }"
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="acct_month" type="text" class="Wdate" id="acct_month" disabled="disabled" value="${acct_month }"
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="prim_cost" type="text" id="prim_cost" value="${prim_cost }" ltype="text"
					validate="{required:true,maxlength:20}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left: 20px;">计提支出：</td>
				<td align="left" class="l-table-edit-td"><input name="prim_cost_ret" type="text" id="prim_cost_ret" value="${prim_cost_ret }" ltype="text"
					validate="{required:true,maxlength:20}" /></td>
				<td align="left"></td>
			</tr>
