...
<script type="text/javascript">
     ...
     function  save(){
        var formPara={
           ...
           is_prim_cost:$("#is_prim_cost").val(),
            
           is_calc_cost:$("#is_calc_cost").val()
            
         };
        
        ajaxJsonObjectByUrl("addHpmCostitemConf"+app_mod_code+".do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='dept_id']").val('');
				 $("input[name='cost_item_code']").val('');
				 $("input[name='is_acc']").val('');
				 $("input[name='is_prim_cost']").val('');
				 $("input[name='is_calc_cost']").val('');
                parent.query();
            }
        });
    }
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><select name="is_prim_cost" id="is_prim_cost">
						<option value="0">否</option>
						<option value="1">是</option>
				</select></td>
				<td align="left"></td>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><select name="is_calc_cost" id="is_calc_cost">
						<option value="0">否</option>
						<option value="1">是</option>
				</select></td>
				<td align="left"></td>
