...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "150"); sheet.setText(0, 0, "科室名称");
    	sheet.setColumnWidth(1, "150"); sheet.setText(0, 1, "支出项目名称");
    	sheet.setColumnWidth(2, "100"); sheet.setText(0, 2, "是否参与核算");
    	sheet.setColumnWidth(3, "100"); sheet.setText(0, 3, "是否直接成本");
    	sheet.setColumnWidth(4, "100"); sheet.setText(0, 4, "是否间接成本");
    	
    	
    	sheet.getRange(0, 0, 1, 5).hAlign(spreadNS.HorizontalAlign.center);
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("hpmCostitemConfImport"+app_mod_code+".do?isCheck=false", para, function(responseData){	
