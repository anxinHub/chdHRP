...
<script type="text/javascript">
     ...
     function  save(){
    	 if($("#acct_year").val() == ''){
     		$.ligerDialog.warn('核算年度不能为空');
     		return ; 
     	}
     	
     	if($("#acct_month").val() == ''){
     		$.ligerDialog.warn('核算月份不能为空');
     		return ; 
     	}
     	
     	if($("#target_value").val() == ''){
     		$.ligerDialog.warn('指标值不能为空');
     		return ; 
     	}
        ...
        ajaxJsonObjectByUrl("updateHpmEmpTargetData.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
        ...
        autocomplete("#emp_code","../queryEmpDict.do?isCheck=false","id","text",true,true,'',false,'${emp_id},${emp_no}');
    	autocomplete("#target_code","../queryTargetMethod.do?isCheck=false","id","text",true,true,param,false,'${target_code}');
     } 
    </script>
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td" style="padding-top: 20px"><input name="acct_year" class="Wdate" type="text" id="acct_year" ltype="text"
					disabled="disabled" value="${acct_year}" validate="{required:true,maxlength:20}" onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy'})" /></td>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td" style="padding-top: 20px"><input name="acct_month" class="Wdate" type="text" id="acct_month" ltype="text"
					disabled="disabled" value="${acct_month}" validate="{required:true,maxlength:20}" onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'MM'})" /></td>
				<td align="left" style="padding-top: 20px"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left: 30px; padding-top: 20px">职工：</td>
				<td align="left" class="l-table-edit-td" style="padding-top: 20px"><input name="emp_code" type="text" id="emp_code" ltype="text" disabled="disabled"
					validate="{required:true,maxlength:20}" /></td>
				<td align="left" style="padding-top: 20px"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left: 30px; padding-top: 20px">指标：</td>
				<td align="left" class="l-table-edit-td" style="padding-top: 20px"><input name="target_code" type="text" id="target_code" ltype="text"
