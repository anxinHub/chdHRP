...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(2, "150"); sheet.setText(0, 2, "职工编码");
    	sheet.setColumnWidth(3, "250"); sheet.setText(0, 3, "指标编码");
    	sheet.setColumnWidth(4, "250"); sheet.setText(0, 4, "指标值");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importHpmEmpTargetData.do?isCheck=false", para, function(responseData){	
