...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(3, "250"); sheet.setText(0, 3, "职工名称");
    	sheet.setColumnWidth(4, "250"); sheet.setText(0, 4, "奖金额");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importHpmEmpBonusDataForReport.do?isCheck=false", para, function(responseData){	
