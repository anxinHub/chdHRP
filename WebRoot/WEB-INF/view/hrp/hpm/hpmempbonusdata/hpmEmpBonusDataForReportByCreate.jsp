...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("createHpmEmpBonusDataForReport.do?isCheck=false",formPara,function(responseData){
...
<body>
	...
	<form name="form1" method="post" id="form1">
		...
		<input type="hidden" name="dept_id_no" id="dept_id_no" value="${dept_id_no}" />
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td">
					<div id="wrap">
						<!-- <input id="rbtnl_0" type="radio" name="rbtnl" value="all"  /> 
