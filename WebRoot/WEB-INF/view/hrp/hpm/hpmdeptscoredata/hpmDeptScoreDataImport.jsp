...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "100"); sheet.setText(0, 0, "核算年度");
    	sheet.setColumnWidth(1, "100"); sheet.setText(0, 1, "核算月份");
    	sheet.setColumnWidth(2, "150"); sheet.setText(0, 2, "科室名称");
    	sheet.setColumnWidth(3, "150"); sheet.setText(0, 3, "财务收益");
    	sheet.setColumnWidth(4, "150"); sheet.setText(0, 4, "客户关系");
    	sheet.setColumnWidth(5, "150"); sheet.setText(0, 5, "内部流程");
    	sheet.setColumnWidth(6, "150"); sheet.setText(0, 6, "学习成长");
    	sheet.setColumnWidth(7, "150"); sheet.setText(0, 7, "综合得分");
    	
    	
    	sheet.getRange(0, 0, 1, 8).hAlign(spreadNS.HorizontalAlign.center);
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("hpmDeptScoreDataImpotr.do?isCheck=false", para, function(responseData){	
