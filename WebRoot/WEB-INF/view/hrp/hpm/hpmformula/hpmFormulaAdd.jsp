...
<script type="text/javascript">
	...
	function save() {
		...
		var formPara = {
			...
			formula_method_chs : UE.getEditor('formula_method_chs').getPlainTxt(),
		...
		ajaxJsonObjectByUrl("addHpmFormula.do", formPara,
	...
	function loadDict() {
		...
		autocomplete("#target_code","../queryTarget.do?isCheck=false","id","text",false,false,false, "","", 140);
	...
	<form name="form1" method="post" id="form1">
		<div id="layout1"
			...
			<div position="left" title="指标" style="width: 200px; height: 100%; overflow: auto;">
				...
				<input name="target_code" type="text" id="target_code" ltype="text" />
				</div>
				<ul id="tree1">
			...
			<div position="center" title="计算公式（中文）" >
				 <table cellpadding="0" cellspacing="0" class="l-table-edit" style="width:100%; bottom: 143px;">
					<tr>
						<td align="left" class="l-table-edit-td">
							<textarea class="liger-textarea" id="formula_method_chs" disabled name="formula_method_chs" style="width:100%;height:300px;" validate="{required:true}"></textarea>
						 </td>
					<tr />
				</table>
