...
$(function(){
    ...
    function plupload(){  
     $("#uploader").pluploadQueue({           
            ...
            url : "readDeptKindTargetDataFiles.do?isCheck=false",    
            chunk_size : '1mb',           
            filters : {               
	        ...
	        switch (item.id)
	        {
	            case "save":
	            	var data = gridManager.getData();
	            	 ajaxJsonObjectByUrl("addBatchDeptKindTargetDataDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
