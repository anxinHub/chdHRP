...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("updateHpmDeptKindTargetData.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function saveDeptKindTargetData(){
        if($("form").valid()){
            save();
        }
   }
...
<body>
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left: 30px; padding-top: 20px">科室分类：</td>
				<td align="left" class="l-table-edit-td" style="padding-top: 20px"><input name="dept_kind_code" type="text" id="dept_kind_code" ltype="text"
