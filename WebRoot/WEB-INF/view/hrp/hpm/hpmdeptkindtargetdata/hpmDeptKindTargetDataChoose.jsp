...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("initHpmDeptKindTargetData.do",formPara,function(responseData){
...
<body>
	...
	<form name="form1" method="post" id="form1">
		<input type="hidden" name="acct_yearm" id="acct_yearm" value="${acct_yearm}"> <input type="hidden" name="dept_kind_code" id="dept_kind_code"
			value="${dept_kind_code}"> <input type="hidden" name="target_code" id="target_code" value="${target_code}">
