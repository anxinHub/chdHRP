...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(1, "150"); sheet.setText(0, 1, "是否参与核算");
    	sheet.setColumnWidth(3, "150"); sheet.setText(0, 3, "工作量指标编码或名称");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importHpmWorkitemConf.do?isCheck=false", para, function(responseData){	
