...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("copyHpmWorkitemConf.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	autocomplete("#dept_id_s","../queryDeptDictByPerm.do?isCheck=false","id","text",true,true);
            
     	autocomplete("#dept_id_t","../queryDeptDictByPerm.do?isCheck=false","id","text",true,true);
