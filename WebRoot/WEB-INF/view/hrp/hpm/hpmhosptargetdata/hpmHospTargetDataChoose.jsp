...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("initHpmHospTargetData.do",formPara,function(responseData){
...
<body>
	...
	<form name="form1" method="post" id="form1">
		<input type="hidden" name="acct_yearm" id="acct_yearm" value="${acct_yearm}"> <input type="hidden" name="target_code" id="target_code"
			value="${target_code}">
