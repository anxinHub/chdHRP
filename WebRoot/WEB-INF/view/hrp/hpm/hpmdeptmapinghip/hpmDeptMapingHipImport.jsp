...
<script type="text/javascript">
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '变更ID', name: 'dept_no', align: 'left',editor:{type:'text'}},
				{ display: '部门ID', name: 'dept_id', align: 'left',editor:{type:'text'}},
				{ display: '平台科室变更ID', name: 'sys_dept_no', align: 'left',editor:{type:'text'}},
				{ display: '平台科室ID', name: 'sys_dept_id', align: 'left',editor:{type:'text'}},
				{ display: '01:平行 02:拆分 C03:合并', name: 'ref_code', align: 'left',editor:{type:'text'}},
				{ display: '拆分比例', name: 'spilt_perc', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchAphiDeptMapingHip.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
