...
<script type="text/javascript">
        ...
        function saveHpmDeptMaping() {
            ...
            ajaxJsonObjectByUrl("addAphiDeptMapingHip.do", {}, function (responseData) {
        ...
        function loadHead() {
            ...
            gridcharge = $('#maingrid1').ligerGrid({
                ...
                dataType: 'server',
                usePager: true,
                url: 'queryHpmDept.do?isCheck=false',
                width: '100%',
                height: '45%',
                enabledEdit: true,
                title: '绩效科室',
            ...
            gridtitle = $("#maingrid2").ligerGrid({
                ...
                dataType: 'server',
                usePager: true,
                url: 'queryAphiDeptHipByMaping.do?isCheck=false',
                width: '100%',
                height: '45%',
                checkbox: true,
                title: '平台科室',
        ...
        function deleteDeptMaping() {
            ...
            if (data.length == 0) {
                ...
                $.ligerDialog.confirm('确定删除?', function (yes) {
                    if (yes) {
                        ajaxJsonObjectByUrl("deleteAphiDeptMappingHip.do", {
        ...
        function addDeptMaping() {
            ...
            ajaxJsonObjectByUrl("addAphiDeptMapingHip.do", {
                maping_data: JSON.stringify(totalData)
            }, function (responseData) {
                if (responseData.state == "true") {
                    query();
                }
        ...
        function f_gridtitle_loadData() {
            ...
            gridtitle.options.parms.push({
                name: 'dept_id',
                value: liger.get("sys_dept_id").getValue()
            });
        ...
        function loadDict() {
            ...
            $("#ref_code").ligerComboBox({
                url: "../queryDeptRefDict.do?isCheck=false",
                valueField: 'id',
                textField: 'text',
                selectBoxWidth: 160,
                autocomplete: true,
            ...
            autocomplete("#dept_id", "../queryAphiDeptDict.do?isCheck=false", "id", "text", true, true);
            autocomplete("#sys_dept_id", "../queryAphiDeptHip.do?isCheck=false", "id", "text", true, true);
        ...
        function addData() {
            ...
            var totalData = gridTotalManager.getData();
            var ref_code = liger.get("ref_code").getValue();
            var ref_name = liger.get("ref_code").getText();
            
            if (ref_code == "") {
                $.ligerDialog.warn('对应关系不能为空');
                return;
            }
...
<body>
    <div id="layout1">
        <div position="center" >
            <div class="top" style="margin:0 auto;overflow:hidden;">
                <div style=" padding: 0; float: left;width:40%">
                    <span>　　绩效科室：</span>
                    <div style='display:inline-block'>
                         <input name="dept_id" type="text" id="dept_id" ltype="text" validate="{required:true,maxlength:20}" />
                    </div>
                   <div style='display:inline-block'>
                        <input type="checkbox" id="is_dept" />
                   </div>
                    
                    <span>不包含对应关系科室</span>
                    <div style='display:inline-block'>
                        <input class="l-button l-button-test" type="button" value="查询" onclick="f_gridcharge_loadData()" />
                   </div>
                    
                    <!--<table cellpadding="0" cellspacing="0" class="l-table-edit">
                    <tr>
                        <td align="right" class="l-table-edit-td" style="padding-left:20px;">绩效科室：</td>
                        <td align="left" class="l-table-edit-td"><input name="dept_id" type="text" id="dept_id" ltype="text" validate="{required:true,maxlength:20}"
                                o /></td>
                        <td align="left"></td>
                        ...
                        <td align="left"><input class="l-button l-button-test" style="float: right;" type="button" value="查询" onclick="f_gridcharge_loadData()"
                            /></td>
                    </tr>
                </table>-->
                    <div id="maingrid1" ></div>
                </div>
                <div style="margin-top:150px; padding: 0;width:18%;float: left;">
                    <table cellpadding="0" cellspacing="0" style='margin:0 auto' class="l-table-edit">
                        <tr>
                            <td align="center">
                                <h2>映射规则</h2>
                            </td>
                        ...
                        <tr>
                            <td align="center" class="l-table-edit-td"><input name="ref_code" type="text" id="ref_code" ltype="text" validate="{required:true,maxlength:20}"
                                    onchange="changerefcode()" /></td>
                        </tr>
                    </table>
                    <div style='text-align: center;'>
                        <button id="addData" style='margin-top: 80px;'><b>添加</b></button>
                    </div>
                </div>
                <div style=" padding: 0; float: left;width:40%">
                    <span>平台科室科室：</span>
                    <div style="display:inline-block">
                        <input name="sys_dept_id" type="text" id="sys_dept_id" ltype="text" validate="{required:true,maxlength:20}"/>
                    </div>
                    <input type="checkbox" id="is_sys_dept" /></td>
                    <span>不包含对应关系科室</span>
                        <input class="l-button l-button-test" type="button" value="查询" onclick="f_gridtitle_loadData();"/>
                    <!--<table cellpadding="0" cellspacing="0" class="l-table-edit">
                    <tr>
