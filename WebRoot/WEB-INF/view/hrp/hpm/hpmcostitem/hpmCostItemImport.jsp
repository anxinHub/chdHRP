...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "150"); sheet.setText(0, 0, "支出项目编码");
    	sheet.setColumnWidth(1, "150"); sheet.setText(0, 1, "支出项目名称");
    	sheet.setColumnWidth(2, "150"); sheet.setText(0, 2, "支出项目分类编码");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("hpmCostitemImport"+app_mod_code+".do?isCheck=false", para, function(responseData){	
