...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addHpmCostitem"+app_mod_code+".do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='cost_item_code']").val('');
				 $("input[name='cost_iitem_name']").val('');
 ...
 function loadForm(){
    ...
    function loadDict(){
            //字典下拉框
    	autocomplete("#cost_type_code","../../hpm/queryCostTypeDict.do?isCheck=false","id","text",true,true);
     } 
    </script>
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="cost_type_code" type="text" id="cost_type_code" ltype="text"
					validate="{required:true,maxlength:20}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
