...
$(function(){
    ...
    function plupload(){  
     $("#uploader").pluploadQueue({           
            ...
            url : "empSchemeFiles.do?isCheck=false",    
            chunk_size : '1mb',           
            filters : {               
...
{ display: '选择公式编码', name: 'formula_code', align: 'left',editor: { type: 'text' } },
    ...
    if(item.id)
    {
        switch (item.id)
        {
           case "save":
            ...
            ajaxJsonObjectByUrl("addBatchEmpScheme.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
