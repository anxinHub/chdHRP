...
<script type="text/javascript">
     ...
     function  save(){
        var formPara={
           ...
           work_point:$("#work_point").val()
            
         };
        
        ajaxJsonObjectByUrl("updateHpmIncomeitemPointData.do",formPara,function(responseData){
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="dept_code" type="text" id="dept_code" disabled="disabled" ltype="text"
			...
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left: 20px;">工作量计点：</td>
				<td align="left" class="l-table-edit-td"><input name="work_point" type="text" id="work_point" ltype="text" value="${work_point }"
					validate="{required:true,maxlength:20}" /></td>
				<td align="left"></td>
			</tr>
