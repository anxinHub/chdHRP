...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("initHpmIncomeitemPointData.do?isCheck=false",formPara,function(responseData){
...
<body>
	...
	<form name="form1" method="post" id="form1">
		<input type="hidden" name="acct_yearm" id="acct_yearm" value="${acct_yearm}"> <input type="hidden" name="dept_code" id="dept_code"
			value="${dept_code}"> <input type="hidden" name="income_item_code" id="income_item_code" value="${income_item_code}"> <input type="hidden"
			name="dept_kind_code" id="dept_kind_code" value="${dept_kind_code}">
