...
<script type="text/javascript">
		...
		function plupload(){  
			$("#uploader").pluploadQueue({    
				...
				url : "readHpmFunTypeFiles.do?isCheck=false",    
				chunk_size : '2mb',           
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
			columns : [
				{display : '分类编码',name : 'type_code',align : 'left',editor : {type : 'text'}},
				{display : '分类名称',name : 'type_name',align : 'left',editor : {type : 'text'}},
	...
	function itemclick(item) {
		if (item.id) {
			...
			case "save":
				...
				ajaxJsonObjectByUrl("addBatchHpmFunType.do?isCheck=false", {
