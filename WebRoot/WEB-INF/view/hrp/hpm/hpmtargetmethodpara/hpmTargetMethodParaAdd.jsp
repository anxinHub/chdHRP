...
<html style="overflow:hidden;">
    ...
    <script type="text/javascript">
     ...
     $(function (){
    	...
    	$("#target_code").ligerComboBox({
         	url: '../quertHpmTargetDict.do?isCheck=false',
         	valueField: 'id',
          	textField: 'text', 
          	selectBoxWidth: 160,
         	autocomplete: true,
    	...
    	$("#method_code").ligerComboBox({
			...
			url: '../queryHpmTargetMethodPara.do?isCheck=false',
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addHpmTargetMethod.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function saveHpmTargetMethodPara(){
        if($("form").valid()){
            save();
        }
   	}
    ...
    function openFun(){
	    $.ligerDialog.open({
			url: '../hpmfun/hpmFunPage.do?isCheck=false', 
			height: 500,
			width: 930, 
			data: {
