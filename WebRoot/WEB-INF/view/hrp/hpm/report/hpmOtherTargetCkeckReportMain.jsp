...
<script type="text/javascript">
    ...
    function  query(){
		...
		grid.options.parms.push({name:'select_para',value:'QT'});
	...
	function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			...
			url : 'queryHpmOtherTargetCkeckReport.do',width : '100%',height : '100%',checkbox : false,
    ...
    function print() {
		...
		var printPara={
			...
			method_name: "queryHpmOtherTargetCkeckReportPrint",
