...
<script type="text/javascript">
    ...
    function loadTree(){
    	...
    	ajaxJsonObjectByUrl("queryTargetTree.do?isCheck=false",para,function (responseData){
		...
		<tr>
	   		<td align="center">
	   			<select id="select_code" name="select_code">
	   				...
	   				<option value="target_code">指标编码</option>
	   				<option value="target_name">指标名称</option>
	   			</select>
	   		</td>
