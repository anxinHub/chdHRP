...
<script type="text/javascript">
    ...
    function loadTree(){
    	...
    	ajaxJsonObjectByUrl("queryHosPerfWageRatioTargetTree.do?isCheck=false",para,function (responseData){
		...
		<tr>
	   		<td align="center">
	   			<select id="select_code" name="select_code">
	   				...
	   				<option value="subj_code">指标编码</option>
	   				<option value="subj_name">指标名称</option>
	   			</select>
	   		</td>
