...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "150"); sheet.setText(0, 0, "工作量指标编码");
    	sheet.setColumnWidth(1, "150"); sheet.setText(0, 1, "工作量指标名称");
    
    	
    	sheet.getRange(0, 0, 1, 2).hAlign(spreadNS.HorizontalAlign.center);
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("hpmWorkitemImport.do?isCheck=false", para, function(responseData){	
    		layer.close(loadIndex);
    		console.log(1234,responseData);
    		if(row != null){
