...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addHpmIncomeitemConf"+app_mod_code+".do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='dept_id']").val('');
				 $("input[name='income_item_code']").val('');
				 $("input[name='is_acc']").val('');
				 $("input[name='order_perc']").val('');
				 $("input[name='perform_perc']").val('');
                parent.query();
            }
        });
    }
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="income_item_code" type="text" id="income_item_code" ltype="text" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left: 20px;">是否参与：</td>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="order_perc" type="text" id="order_perc" ltype="text" validate="{required:true,maxlength:20}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left: 20px;">执行权重：</td>
				<td align="left" class="l-table-edit-td"><input name="perform_perc" type="text" id="perform_perc" ltype="text" validate="{required:true,maxlength:20}" /></td>
				<td align="left"></td>
			</tr>
