...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "150"); sheet.setText(0, 0, "收入项目编码");
    	sheet.setColumnWidth(1, "150"); sheet.setText(0, 1, "科室名称");
    	sheet.setColumnWidth(2, "100"); sheet.setText(0, 2, "是否参与核算");
    	sheet.setColumnWidth(3, "100"); sheet.setText(0, 3, "开单权重");
    	sheet.setColumnWidth(4, "100"); sheet.setText(0, 4, "执行权重");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("hpmIncomeitemConfImport"+app_mod_code+".do?isCheck=false", para, function(responseData){	
