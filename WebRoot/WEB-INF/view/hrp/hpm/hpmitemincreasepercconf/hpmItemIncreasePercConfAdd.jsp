...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addHpmItemIncreasePercConf.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
            	
				$("input[name='item_code']").val('');
				 
				$("input[name='increase_percent']").val('');
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-left: 30px">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="increase_percent" type="text" id="increase_percent" ltype='spinner' ligerui="{type:'float'}"
					class="required" validate="{number:true,min:0.000,max:100.000}" /></td>
				<td align="left"></td>
			</tr>
		</table>
	</form>
