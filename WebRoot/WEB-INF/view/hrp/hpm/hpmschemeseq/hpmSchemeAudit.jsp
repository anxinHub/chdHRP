...
<script type="text/javascript">
	...
	function save(){
		...
		ajaxJsonObjectByUrl("auditHpmSchemeSeq.do",param,function(responseData){
			
	 		if(responseData.state=="true"){parent.query();}
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><textarea rows="7" cols="40" id="scheme_note" name="scheme_note"></textarea></td>
				<td align="left"></td>
			</tr>
