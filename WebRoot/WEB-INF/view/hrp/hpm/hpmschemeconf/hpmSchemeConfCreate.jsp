...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("createHpmSchemeConf.do",formPara,function(responseData){
...
<body>
	...
	<form name="form1" method="post" id="form1">
		<input type="hidden" name="year_month" id="year_month" value="${year_month}"> <input type="hidden" name="scheme_seq_no" id="scheme_seq_no"
			value="${scheme_seq_no}">
