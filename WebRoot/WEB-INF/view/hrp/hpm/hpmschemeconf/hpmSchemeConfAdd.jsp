...
<script type="text/javascript">
	...
	function save() {
		var param = {
			...
			scheme_seq_no : liger.get("scheme_seq_no").getValue()

		};

		ajaxJsonObjectByUrl("addHpmSchemeConf.do", param, function(responseData) {
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="scheme_seq_no" type="text" id="scheme_seq_no" ltype="text"
