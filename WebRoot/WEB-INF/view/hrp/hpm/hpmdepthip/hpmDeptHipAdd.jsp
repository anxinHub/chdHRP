...
<script type="text/javascript">
	...
	function save() {
		...
		ajaxJsonObjectByUrl("addAphiDeptHip.do", formPara, function(responseData) {
	...
	function loadDict() {
		...
		//字典下拉框
		/* autocomplete("#dept_kind_code", "../queryDeptKindDict.do?isCheck=false","id", "text", true, true,'',true,'','',120);

		autocomplete("#nature_code", "../queryDeptNatureDict.do?isCheck=false","id", "text", true, true,'',true,'','',120); */
