...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "100"); sheet.setText(0, 0, "收入项目编码");
    	sheet.setColumnWidth(1, "100"); sheet.setText(0, 1, "是否参与核算");
    	sheet.setColumnWidth(2, "150"); sheet.setText(0, 2, "计提点数");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("hpmIncomeitemPointImport.do?isCheck=false", para, function(responseData){	
