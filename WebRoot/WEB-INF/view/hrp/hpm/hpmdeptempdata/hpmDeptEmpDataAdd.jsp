...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addHpmDeptEmpData.do?isCheck=false",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='acct_year']").val('');
				 $("input[name='acct_month']").val('');
				 $("input[name='dept_id']").val('');
				 $("input[name='emp_amount']").val('');
                parent.query();
            }
        });
    }
...
<body>
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left: 20px; padding-top: 20px;">职工人数：</td>
				<td align="left" class="l-table-edit-td" style="padding-top: 20px;"><input name="emp_amount" type="text" id="emp_amount" ltype="text"
					validate="{required:true,maxlength:20}" /></td>
				<td align="left" style="padding-top: 20px;"></td>
			</tr>
