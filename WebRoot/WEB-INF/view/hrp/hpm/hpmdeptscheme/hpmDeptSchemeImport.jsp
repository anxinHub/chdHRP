...
var grid;
var fileName;
var is_limit = [{ is_limit: 1, text: '是' }, { is_limit: 0, text: '否'},];
$(function(){
	 loadHead(null);
    function plupload(){  
     $("#uploader").pluploadQueue({           
            runtimes : 'flash,html5,gears,browserplus,silverlight,html4',           
            url : "readDeptSchemeFiles1_1.do?isCheck=false",    
            chunk_size : '1mb',           
            filters : {               
...
{ display: '取值公式编码', name: 'formula_code', align: 'left',editor: { type: 'text' } },
    ...
    if(item.id)
    {
        switch (item.id)
        {
           case "save":
            ...
            ajaxJsonObjectByUrl("addBatchDeptScheme1_1.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
