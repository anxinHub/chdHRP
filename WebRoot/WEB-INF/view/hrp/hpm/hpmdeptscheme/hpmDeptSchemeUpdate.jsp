...
<script type="text/javascript">
    ...
    $(function (){
    	...
    	liger.get("item_code").setValue('${item_code}');liger.get("item_code").setText('${item_name}');
    	
		liger.get("dept_id").setValue('${dept_id}');liger.get("dept_id").setText('${dept_name}');

		liger.get("method_code").setValue('${method_code}');liger.get("method_code").setText('${method_name}');
    	
    	$("#dept_id").ligerTextBox({ disabled: true });$("#item_code").ligerTextBox({ disabled: true });
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHpmDeptScheme"+'${app_mod_code}'+'${nature_code}'+".do",formPara,function(responseData){
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td" colspan="4" style="padding-top: 20px;"><input name="formula_method_chs" type="text" ltype="text"
					id="formula_method_chs" value="${formula_method_chs }" /></td>
				<td align="left"></td>
			</tr>
		</table>
	</form>
