...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(2, "250"); sheet.setText(0, 2, "科室名称或科室编码");
    	sheet.setColumnWidth(3, "250"); sheet.setText(0, 3, "指标名称或指标编码");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importAphiDeptTargerData.do?isCheck=false", para, function(responseData){	
