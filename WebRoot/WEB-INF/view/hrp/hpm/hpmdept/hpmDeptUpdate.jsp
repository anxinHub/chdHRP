...
<script type="text/javascript">
	...
	function save() { 
		...
		ajaxJsonObjectByUrl("updateHpmDept.do", formPara, function(
				responseData) {

			if (responseData.state == "true") {
				
				old_dept_code = $("#dept_code").val();
				parent.query();
			}
		});
	}
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td">
					<input name="dept_kind_code" type="text" id="dept_kind_code" ltype="text" value="${dept_kind_name }" validate="{required:true,maxlength:20}" />
				</td>
				<td align="left"></td>
			</tr>
			<tr>
