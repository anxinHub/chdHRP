...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "150"); sheet.setText(0, 0, "科室编码");
    	sheet.setColumnWidth(1, "150"); sheet.setText(0, 1, "科室名称");
    	sheet.setColumnWidth(2, "150"); sheet.setText(0, 2, "科室描述");
    	sheet.setColumnWidth(3, "150"); sheet.setText(0, 3, "科室分类");
    	sheet.setColumnWidth(4, "150"); sheet.setText(0, 4, "科室性质");
    	sheet.setColumnWidth(5, "150"); sheet.setText(0, 5, "是否参与人均奖金");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importAphiDept.do?isCheck=false", para, function(responseData){	
