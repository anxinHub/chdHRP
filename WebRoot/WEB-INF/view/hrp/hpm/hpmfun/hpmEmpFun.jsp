...
<script type="text/javascript">
    ...
    function loadComType(obj){
    	ajaxJsonObjectByUrl("../hpmfunpara/queryComTypeParaByEmp.do?isCheck=false&fun_code="+obj+"&acc_year=${acc_year}&acc_month=${acc_month}&goal_code=${goal_code}&kpi_code=${kpi_code}&emp_id=${emp_id}", {},
