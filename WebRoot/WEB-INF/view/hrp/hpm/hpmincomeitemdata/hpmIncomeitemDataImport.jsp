...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(3, "250"); sheet.setText(0, 3, "收入项目编码");
    	sheet.setColumnWidth(4, "100"); sheet.setText(0, 4, "开单金额");
    	sheet.setColumnWidth(5, "100"); sheet.setText(0, 5, "执行金额");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("hpmIncomeitemDataImport.do?isCheck=false", para, function(responseData){	
