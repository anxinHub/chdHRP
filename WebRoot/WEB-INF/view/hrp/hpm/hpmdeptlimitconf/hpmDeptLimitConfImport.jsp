...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(1, "150"); sheet.setText(0, 1, "是否控制");
    	sheet.setColumnWidth(2, "120"); sheet.setText(0, 2, "保底线");
    	sheet.setColumnWidth(3, "120"); sheet.setText(0, 3, "封顶线");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("hpmDeptLimitConfImport"+app_mod_code+".do?isCheck=false", para, function(responseData){	
