...
<script type="text/javascript">
    ...
    $(function (){
		...
		autocomplete("#group_id","../querySysGroupDict.do?isCheck=false","id","text",true,true,'',false,'${group_id}');
     	
     	autocomplete("#hos_id","../../sys/queryHosInfoDict.do?isCheck=false","id","text",true,true,'',false,'${hos_id}');
     	
        loadForm();
        
    	$("#group_id").ligerTextBox({ disabled: true });
    	
    	$("#hos_id").ligerTextBox({ disabled: true });
    ...
    function save(){
        var formPara={
    			...
    			comp_percent:$("#comp_percent").val()
        };
        ajaxJsonObjectByUrl("updateHpmCompanyPerc.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
                //$("input[name='comp_percent']").val('');
                parent.query();
            }
        });
    }
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="comp_percent" type="text" id="comp_percent" ltype="text" value="${comp_percent}"
