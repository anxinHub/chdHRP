...
$(function(){
    ...
    function plupload(){  
     $("#uploader").pluploadQueue({           
            ...
            url : "readCompanyPercFiles.do?isCheck=false",    
            chunk_size : '1mb',           
            filters : {               
	        ...
	        switch (item.id)
	        {
	            case "save":
	            	var data = gridManager.getData();
	            	 ajaxJsonObjectByUrl("addBatchCompanyPerctDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
