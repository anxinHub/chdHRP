...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(3, "250"); sheet.setText(0, 3, "支出项目编码");
    	sheet.setColumnWidth(4, "100"); sheet.setText(0, 4, "直接支出");
    	sheet.setColumnWidth(5, "100"); sheet.setText(0, 5, "间接支出");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("hpmCostitemDataImport"+app_mod_code+".do?isCheck=false", para, function(responseData){	
