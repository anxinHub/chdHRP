...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("initHpmCostitemData"+'${app_mod_code}'+".do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function saveCostItemTargetConf(){
        if($("form").valid()){
            save();
        }
   }
				...
				<td align="left" class="l-table-edit-td">
					<div id="wrap">
						<input id="rbtnl_0" type="radio" name="rbtnl" value="all" checked="checked" /> <label for="rbtnl_0">覆盖生成</label> <input id="rbtnl_0" type="radio"
							name="rbtnl" value="check" /> <label for="rbtnl_1">增量生成</label>
					</div>
				</td>
				<td align="left"></td>
			</tr>
