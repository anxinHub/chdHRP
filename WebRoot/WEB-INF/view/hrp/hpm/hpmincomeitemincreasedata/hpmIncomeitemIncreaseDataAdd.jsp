...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addHpmIncomeitemIncreaseData.do",formPara,function(responseData){
            ...
            if(responseData.state=="true"){
				 ...
				 $("input[name='income_ret_money']").val('');
                parent.query();
            }
        });
    }
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="income_ret_money" type="text" id="income_ret_money" ltype="text"
					validate="{required:true,maxlength:20}" /></td>
				<td align="left"></td>
			</tr>
