...
$(function(){
    ...
    function plupload(){  
     $("#uploader").pluploadQueue({           
            ...
            url : "readDeptKindSchemeFiles.do?isCheck=false",    
            chunk_size : '1mb',           
            filters : {               
	        ...
	        switch (item.id)
	        {
	            case "save":
	            	var data = gridManager.getData();
	            	 ajaxJsonObjectByUrl("addBatchDeptKindSchemeDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
