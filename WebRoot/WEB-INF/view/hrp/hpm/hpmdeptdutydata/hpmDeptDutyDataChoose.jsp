...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
 <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("initHpmDeptDutyData.do?isCheck=false",formPara,function(responseData){
            ...
            <tr>
                ...
                <div id="wrap">
                	...
                	<input id="rbtnl_0" type="radio" name="rbtnl" value="check" />
                		...
                		<input id="rbtnl_0" type="radio" name="rbtnl" value="inherit" />
                		<label for="rbtnl_1">继承上月数据</label>
				</div>
                </td>
                <td align="left"></td>
            </tr> 
