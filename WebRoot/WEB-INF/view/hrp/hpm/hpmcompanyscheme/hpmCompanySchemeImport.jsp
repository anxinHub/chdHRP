...
$(function(){
    ...
    function plupload(){  
     $("#uploader").pluploadQueue({           
            ...
            url : "readCompanySchemeFiles.do?isCheck=false",    
            chunk_size : '1mb',           
            filters : {               
	        ...
	        switch (item.id)
	        {
	            case "save":
	            	var data = gridManager.getData();
	            	 ajaxJsonObjectByUrl("addBatchcompanySchemeDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
