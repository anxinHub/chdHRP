...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#target_code").ligerComboBox(
				{
					url : '../queryTargetCode.do?isCheck=false',
					valueField : 'id',
					textField : 'text',
					selectBoxWidth : 300,
					autocomplete : true,
					...
					onSelected : function(selectValue) {
						...
						ajaxJsonObjectByUrl("../hpmtarget/queryHpmTarget.do?isCheck=false",{"target_code" : selectValue}, function(responseData) {
		...
		$("#method_code").ligerComboBox({
			url : '../queryTargetMethodPara.do?isCheck=false',
			valueField : 'id',
			textField : 'text',
			selectBoxWidth : 160,
			width : 160,
	...
	function save() {
		...
		ajaxJsonObjectByUrl("addHpmTargetMethod.do", formPara, function(
				responseData) {
	...
	function openFun() {
		...
		var target_code = liger.get("target_code").getValue();
		...
		parent.$.ligerDialog.open({
			url : 'hrp/hpm/hpmfun/hpmFunPage.do?isCheck=false'+ '&target_code=' + target_code,
			height : 630,
			width : 1200,
			data : {
			},
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td" style="padding-top: 20px;">
					<input name="target_code" type="text" id="target_code" ltype="text" validate="{required:true}" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td" style="padding-left: 100px; padding-top: 20px;">指标性质：</td>
				<td align="left" class="l-table-edit-td" style="padding-top: 20px;">
					<input name="target_nature" type="text" id="target_nature" ltype="text" /></td>
				<td align="left"></td>
			</tr>
			<tr>
