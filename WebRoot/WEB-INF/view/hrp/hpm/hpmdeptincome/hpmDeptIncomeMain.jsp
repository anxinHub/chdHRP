...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           	columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryHpmDeptIncomeMaping.do',
    ...
    function addDeptMaping(){
    	...
    	parent.$.ligerDialog.open({url: 'hrp/hpm/hpmdeptincome/hpmDeptIncomeAddPage.do?isCheck=false', height: $(window).height(),
    ...
    function deleteDeptMaping (){
        ...
        if (data.length == 0){
            ...
            $.ligerDialog.confirm('确定删除?', function (yes){
            	if(yes){
                	ajaxJsonObjectByUrl("deleteHpmDeptIncome.do?isCheck=false",{ParamVo : ParamVo},function (responseData){
