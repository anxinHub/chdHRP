    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [  
                     ...
                     { display: '计量计划编号', name: 'plan_no', align: 'left',
                    	    },
                     ...
                     { display: '计量计划年份', name: 'plan_year', align: 'left'
					 		},
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAssMeasureRemind.do',
