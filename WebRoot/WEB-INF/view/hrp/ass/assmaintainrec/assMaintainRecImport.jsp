...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssMaintainRecFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '保养ID', name: 'rec_id', align: 'left',editor:{type:'text'}},
				{ display: '保养序号', name: 'rec_no', align: 'left',editor:{type:'text'}},
				...
				{ display: '执行人', name: 'fact_exec_emp', align: 'left',editor:{type:'text'}},
				{ display: '计划执行日期', name: 'plan_exec_date', align: 'left',editor:{type:'text'}},
				{ display: '实际执行日期', name: 'fact_exec_date', align: 'left',editor:{type:'text'}},
				{ display: '保养工时', name: 'maintain_hours', align: 'left',editor:{type:'text'}},
				{ display: '保养费用', name: 'maintain_money', align: 'left',editor:{type:'text'}},
				{ display: '保养说明', name: 'maintain_desc', align: 'left',editor:{type:'text'}},
				{ display: '状态', name: 'state', align: 'left',editor:{type:'text'}},
				{ display: '保养部门ID', name: 'maintain_dept_id', align: 'left',editor:{type:'text'}},
				{ display: '保养部门NO', name: 'maintain_dept_no', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssMaintainRec.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
