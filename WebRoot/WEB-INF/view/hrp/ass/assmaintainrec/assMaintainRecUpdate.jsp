              ...
              columns: [  
                      ...
                      toolbar : {
 	 							items : [ {text : '保存',id : 'save',click : save,icon : 'save'}, {line : true}, 
 	 							          ...
 	 							          {text : '引入保养计划',id : 'refMaintainPlan',click : refMaintainPlan,icon : 'save'} */
  							        ]
  						},
     ...
     function loadDict(){
        ...
        $("#maintain_money").ligerTextBox({disabled:true,cancelable: false,width:160});
     	...
     	/*  $("#ass_nature").ligerComboBox({
    		...
    		autocomplete("#ass_nature", "../queryAssNaturs.do?isCheck=false","id", "text",true,true,null,false,"","160");
     	  liger.get("ass_nature").setValue("${ass_nature}");
     	
     	liger.get("ass_nature").setText("${ass_nature} ${naturs_name}");
