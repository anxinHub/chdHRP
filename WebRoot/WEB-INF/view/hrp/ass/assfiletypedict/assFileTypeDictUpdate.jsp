  ...
  <head>
   ...
   <jsp:include page="${path}/inc.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateAssFileTypeDict.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="equi_usage_code" type="text" id="equi_usage_code" ltype="text"  value="${equi_usage_code}" validate="{required:true,maxlength:20}" disabled="disabled"/></td>
                <td align="left"></td>
            </tr> 
            <tr>
