...
<script type="text/javascript">
		...
		function loadHead() {
				...
				{ display: '文档类别编码', name: 'equi_usage_code', align: 'left',editor:{type:'text'}},
				{ display: '文档类别名称', name: 'equi_usage_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssFileTypeDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
