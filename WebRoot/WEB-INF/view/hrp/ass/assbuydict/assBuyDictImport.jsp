...
<script type="text/javascript">
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '申购类别编码', name: 'buy_code', align: 'left',editor:{type:'text'}},
				{ display: '申购类别名称', name: 'buy_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssBuyDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
