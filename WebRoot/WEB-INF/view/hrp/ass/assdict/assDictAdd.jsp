...
<script type="text/javascript">
	...
	$(function() {
        ...
        $('#is_depre').change(function(){
        	if(liger.get("is_depre").getValue() == 1){
    			...
    			liger.get("ass_depre_code").setValue("0");
        		liger.get("ass_depre_code").setText("");
        ...
        $('#ass_type_id').change(function(){
        	//console.log(liger.get("ass_type_id").data);
	...
	function autoGen(){
		var ParamVo = [];
		//alert('${ass_type_code}')
		ParamVo.push(liger.get("ass_type_id").getValue());
		$.post("queryasstypeid.do?isCheck=false", {
			'ass_type_id' : ParamVo.toString(),
		},  function(responseData)  {
			if(responseData.state == "true" ){
				$("input[name='ass_code']").val(responseData.asscode);
			}else{
				var ass_code = liger.get("ass_type_id").getText();
				if($.trim(ass_code)){
					$("input[name='ass_code']").val(ass_code.split(" ")[0]+"001");
				}
	...
	function save() {
		...
		$.post("addAssDict.do", formPara, function(responseData) {
			...
			if (responseData.state == "true") {
				...
				$("input[name='common_name']").val('');
				//$("input[name='is_ins']").val('');
				//$("input[name='is_accept']").val('');
				//$("input[name='is_check']").val('');
				if($("#is_accept").val() == 1){
					document.getElementById("acceptFrame").contentWindow.clearData();
				}
				if($("#is_check").val() == 1){
					document.getElementById("checkFrame").contentWindow.clearData();
				}
	...
	function loadDict() {
		...
		autocomplete("#ass_type_id",
				"../queryAssTypeDictIsLast.do?isCheck=false&ass_naturs=${ass_naturs}&ass_type_code=${ass_type_code}", "id", "text",
		...
		autocomplete("#ass_depre_code",
				...
				true, true, null, null, "01", "280");
		autocomplete("#usage_code", "../queryAssUsageDict.do?isCheck=false",
				"id", "text", true, true, null, true, null, "200");
...
<body>
	...
	<form name="form1" method="post" id="form1" style="display:blok">
		<table cellpadding="0" cellspacing="0" class="l-table-edit"
			...
			<td align="right" class="l-table-edit-td"
				...
				<td align="left" class="l-table-edit-td"><input name="ass_code"
					type="text" id="ass_code" ltype="text"
					validate="{required:true,maxlength:100}" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td"
				...
				<td align="left" class="l-table-edit-td"><input name="ass_name"
					type="text" id="ass_name" ltype="text"
					validate="{required:true,maxlength:100}" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td"
					style="padding-left: 20px;">规格：</td>
				<td align="left" class="l-table-edit-td"><input name="ass_spec"
					type="text" id="ass_spec" ltype="text" validate="{maxlength:100}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td"
				...
				<td align="left" class="l-table-edit-td"><input
					name="ass_model" type="text" id="ass_model" ltype="text"
				...
				<td align="left" class="l-table-edit-td"><input name="ass_unit"
					type="text" id="ass_unit" ltype="text"
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="gb_code"
					type="text" id="gb_code" ltype="text"  /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td"
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td">
				<!-- <select id="is_depre"
					name="is_depre" validate="{required:true}" >
						<option value="0">否</option>
						<option value="1">是</option>
				</select> -->
				...
				<td align="left" class="l-table-edit-td"><input
					name="depre_years" value="${manage_depre_amount}" type="text" id="depre_years" ltype="text"  onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td"
			...
			<tr>
				...
				<!-- <select id="is_manage_depre"
					name="is_manage_depre" validate="{required:true}" >
						<option value="0">否</option>
						<option value="1">是</option>
				</select> -->
				...
				<td align="left" class="l-table-edit-td"><input
					name="manage_depre_amount" type="text" id="manage_depre_amount" ltype="text"  onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td"
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input
					name="price" type="text" id="price" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td"
     ...
     <div id="acceptItemGrid" style="height: 100%;">
               <iframe frameborder="0" id="acceptFrame"  src="assDictAcceptItemAffiPage.do?isCheck=false&ass_id=0" width="100%" height="64%"></iframe> 
     </div>
     <div id="checkItemGrid" style="height: 100%;">
               <iframe frameborder="0" id="checkFrame"  src="assDictCheckItemAffiPage.do?isCheck=false&ass_id=0" width="100%" height="64%"></iframe> 
     </div>
</body>
</html>
