...
<html style="overflow:auto;">
  <head>
    ...
    <script type="text/javascript">
     var dataFormat;
     var mod_code ='05' ;//（ 模块编码  该页面为物流系统使用 默认 物流系统模块'04' , 其他系统模块用该页面时 改为 相应的系统模块编码 ）
     var is_auto = "${is_auto}";
     $(function (){
        loadDict()//加载下拉框
        loadForm();
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("assAddMatSupAttr.do?isCheck=false",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	autocomplete("#dept_code","../queryDeptDict.do?isCheck=false","id","text",true,true, {is_last : 1},false);
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit"  width="100%">
            ...
            <tr>
				...
				<td align="left" class="l-table-edit-td"><input name="sup_code" type="text"   id="sup_code" ltype="text"  validate="{required:true,maxlength:50}"/></td>
				<td align="left"></td>
