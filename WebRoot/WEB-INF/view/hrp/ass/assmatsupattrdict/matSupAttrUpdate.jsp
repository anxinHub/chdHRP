  ...
  <head>
    ...
    function loadDict(){
       ...
       /*  $("#sup_code").ligerComboBox({width:160, disabled:true, cancelable: false});
    	...
    	autocomplete("#type_code","../queryFacTypeDict.do?isCheck=false","id","text",true,true,'',false,'',160);
    	...
    	if('${dept_id}' != null && '${dept_id}' != '' && '${dept_id}' != 'undefined'){
        	autocomplete("#dept_code","../queryDeptDict.do?isCheck=false","id","text",true,true, {is_last : 1}, false, "${dept_id}");
        }else{
