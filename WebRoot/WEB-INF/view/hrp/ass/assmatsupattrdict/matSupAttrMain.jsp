...
<script type="text/javascript">
            	...
            	case "delete":
                    ...
                    if (data.length == 0){
                        ...
                        $.ligerDialog.confirm('确定删除?', function (yes){
                        	if(yes){
                            	ajaxJsonObjectByUrl("deleteMatSupAttr.do?isCheck=false",{ParamVo : ParamVo.toString()},function (responseData){
    ...
    function add_open(){
  		parent.$.ligerDialog.open({url: 'hrp/ass/sup/assMatSupAttrAddPage.do?isCheck=false&type_code='+type_code, 
    ...
    function openUpdate(obj){
		...
		parent.$.ligerDialog.open({ 
    		...
    		url : 'hrp/ass/sup/assMatSupAttrUpdatePage.do?isCheck=false&' + parm,
    ...
    function loadDict(){
		 ...
		 //字典下拉框
    	autocomplete("#sup_id","../queryHosSupDict.do?isCheck=false","id","text",true,true,"",false,false,260);
