		...
		<script type="text/javascript">
			...
			/* function copy() {
				...
				if (data.length == 0 || data.length > 1) {
					...
					ajaxJsonObjectByUrl("buildAssMaintainItem.do", formPara, function(
							responseData) {
			...
			function loadDict() {
				...
				//计划执行人
				autocomplete("#plan_exec_emp", "../../../hrp/sys/queryUserDict.do?isCheck=false", "id", "text", true, true);
	...
	<body onload="is_addRow()">
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="plan_no" disabled="disabled" type="text" id="plan_no" /></td>
				<td align="left"></td>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="plan_cycle" type="text" id="plan_cycle" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left:20px;">计划执行人：</td>
				<td align="left" class="l-table-edit-td"><input name="plan_exec_emp" type="text" id="plan_exec_emp" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td" style="padding-left:20px;">保养说明：</td>
				<td align="left" class="l-table-edit-td"><input name="maintain_desc" type="text" id="maintain_desc" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td" style="padding-left:20px;">上次保养日期：</td>
				<td align="left" class="l-table-edit-td"><input name="last_exec_date" type="text" id="last_exec_date" class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td" style="padding-left:20px;">下次保养日期：</td>
				<td align="left" class="l-table-edit-td"><input name="next_exec_date" type="text" id="next_exec_date" class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td" style="padding-left:20px;">计划开始日期：</td>
				<td align="left" class="l-table-edit-td"><input name="plan_start_date" type="text" id="plan_start_date" class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td" style="padding-left:20px;">计划结束日期：</td>
				<td align="left" class="l-table-edit-td"><input name="plan_end_date" type="text" id="plan_end_date" class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" /></td>
				<td align="left"></td>
				...
				<td align="left" class="l-table-edit-td"><input name="ass_name" disabled="disabled" type="text" id="ass_name" onchange="queryDict()"/></td>
				<td align="left"></td>
			</tr>
			<tr>
