...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssMaintainPlanFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '计划编号', name: 'plan_no', align: 'left',editor:{type:'text'}},
				{ display: '计划名称', name: 'plan_name', align: 'left',editor:{type:'text'}},
				...
				{ display: '保养等级', name: 'maintain_degree', align: 'left',editor:{type:'text'}},
				{ display: '周期单位', name: 'cycle_unit', align: 'left',editor:{type:'text'}},
				{ display: '保养周期', name: 'plan_cycle', align: 'left',editor:{type:'text'}},
				{ display: '计划执行人', name: 'plan_exec_emp', align: 'left',editor:{type:'text'}},
				{ display: '保养说明', name: 'maintain_desc', align: 'left',editor:{type:'text'}},
				...
				{ display: '上次保养日期', name: 'last_exec_date', align: 'left',editor:{type:'text'}},
				{ display: '下次保养日期', name: 'next_exec_date', align: 'left',editor:{type:'text'}},
				{ display: '计划开始日期', name: 'plan_start_date', align: 'left',editor:{type:'text'}},
				{ display: '计划结束日期', name: 'plan_end_date', align: 'left',editor:{type:'text'}},
				{ display: '终止人', name: 'stop_emp', align: 'left',editor:{type:'text'}},
				{ display: '终止日期', name: 'stop_date', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchAssMaintainPlan.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
