...
//     	  grid.options.parms.push({name:'is_group',value:$("#is_group").val()}); 
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAssContractGroupMain.do',
    ...
    function add_open(){
    	...
    	parent.$.ligerDialog.open({
    		...
    		width: $(window).width(),
    		url: 'hrp/ass/asscontractgroupmain/assContractGroupMainAddPage.do?isCheck=false&',
    	...
    	var data = gridManager.getCheckedRows();
                    if (data.length == 0){
                        ...
                        $.ligerDialog.confirm('确定删除?', function (yes){
                        	if(yes){
                            	ajaxJsonObjectByUrl("../asscontractgroupmain/deleteAssContractGroupMain.do",{ParamVo : ParamVo.toString()},function (responseData){
    ...
    function imp(){
    	...
    	var index = layer.open({
					...
					area : [ '893px', '500px' ],
					content : 'assContractGroupMainImportPage.do?isCheck=false'
				});
				layer.full(index);
    	}	
    ...
    //键盘事件
	  ...
	  function printDate(){
	    	...
	    	var printPara={
	   		...
	   		ajaxJsonObjectByUrl("queryAssContractGroupMain.do?isCheck=false", selPara, function (responseData) {
	 ...
	 function exportExcel(){
		...
		ajaxJsonObjectByUrl("queryAssContractGroupMain.do",exportPara,function (responseData){
