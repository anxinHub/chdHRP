...
<script type="text/javascript">
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '设备来源编码', name: 'equi_usage_code', align: 'left',editor:{type:'text'}},
				{ display: '设备来源名称', name: 'equi_usage_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssDeviceDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
