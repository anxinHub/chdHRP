     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAssContractBreach.do",formPara,function(responseData){
            ...
            if(responseData.state=="true"){
            	$("#breach_no").val(responseData.breach_no);
 ...
 function loadForm(){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="breach_no" type="text" id="breach_no" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <textarea rows="5" cols="70" id="breach_reason" name="breach_reason"></textarea>
            </td>
            <td align="left"></td>
        </tr> 
        <tr>
            ...
            <td align="left" class="l-table-edit-td" colspan="3">
             	<textarea rows="5" cols="70" id="result" name="result"></textarea>
            </td>
            <td align="left"></td>
        </tr>
    </table>
