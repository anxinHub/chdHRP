...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     $(function (){
         loadDict();//加载下拉框
        loadForm();
         $("#breach_no").ligerComboBox({disabled:true,cancelable: false});
     ...
     function  save(){
    	...
    	if($("#breach_money").val() == ""){
   			$.ligerDialog.error('违约金额不能为空');
   			return;	
   		}
    	if($("#breach_flag").val() == ""){
    		$.ligerDialog.error('违约方不能为空');
    		return;	
    	}
    	...
    	if($("#breach_reason").val() == ""){
    		$.ligerDialog.error('违约原因不能为空');
    		return;	
    	}  
        var formPara={
            
           breach_no:$("#breach_no").val(),
           ...
           breach_reason:$("#breach_reason").val(),
            
           result:$("#result").val()
            
         };
        
        ajaxJsonObjectByUrl("addAssContractBreach.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function saveAssContractBreach(){
        if($("form").valid()){
            save();
        }
   }
    function loadDict(){
            //字典下拉框
    	autocomplete("#ven_id", "../queryHosSupDict.do?isCheck=false","id",  "text",true,true,null,false,'${ven_id}@${ven_no}');
            
    	autocomplete("#contract_id", "../queryContractMainDict.do?isCheck=false","id",  "text",true,true,null,false,'${contract_id}');
    	
		autocomplete("#first_emp", "../../../hrp/sys/queryUserDict.do?isCheck=false", "id", "text", true, true,null,false,'${first_emp}');
		
		autocomplete("#second_emp", "../../../hrp/sys/queryUserDict.do?isCheck=false", "id", "text", true, true,null,false,'${second_emp}');
		
		$("#breach_flag").val('${breach_flag}');
     } 
    function this_close(){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">违约单号：</td>
            <td align="left" class="l-table-edit-td"><input name="breach_no" type="text" id="breach_no" value="${breach_no }" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b><font color="red">*</font></b>违约金额：</td>
            <td align="left" class="l-table-edit-td"><input name="breach_money" type="text" id="breach_money" value="${breach_money }" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b><font color="red">*</font></b>违约方：</td>
            <td align="left" class="l-table-edit-td">
            	<select id="breach_flag" name="breach_flag">
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="begin_date" type="text" id="begin_date" ltype="text" validate="{required:true,maxlength:20}" class="Wdate"
				onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" value="${begin_date }"/></td>
            <td align="left"></td>
            ...
            <td align="left" class="l-table-edit-td"><input name="end_date" type="text" id="end_date" ltype="text" validate="{required:true,maxlength:20}" class="Wdate"
				onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" value="${end_date }"/></td>
            <td align="left"></td>
        </tr> 
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b><font color="red">*</font></b>违约原因：</td>
            <td align="left" class="l-table-edit-td" colspan="3">
            <textarea rows="5" cols="70" id="breach_reason" name="breach_reason">${breach_reason }</textarea>
            </td>
            <td align="left"></td>
        </tr> 
        <tr>
        	<td align="right" class="l-table-edit-td"  style="padding-left:20px;">处理结果：</td>
            <td align="left" class="l-table-edit-td" colspan="3">
             <textarea rows="5" cols="70" id="result" name="result">${result }</textarea>
            </td>
            <td align="left"></td>
        </tr>
    </table>
