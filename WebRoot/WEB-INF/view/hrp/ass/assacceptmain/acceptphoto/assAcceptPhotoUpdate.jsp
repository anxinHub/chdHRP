  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        $.ajaxFileUpload({  
            url : 'updateAssCardPhoto.do?photo_code='+photo_code+'&photo_name='+photo_name+'&accept_no=${accept_no}&ord_file_url='+ord_file_url+'&is_stop='+is_stop, //用于文件上传的服务器端请求地址  
