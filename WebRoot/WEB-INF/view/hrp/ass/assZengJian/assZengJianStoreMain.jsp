...
<script type="text/javascript">
    ...
    function loadDict(){
        ...
        autocomplete("#store_id", "../queryHosStoreDict.do?isCheck=false","id", "text",true,true,null,false);
 	...
 	function printDate(){
    	...
    	var foots = {
 		...
 		var printPara={
 				...
 				class_name: "com.chd.hrp.ass.service.zengjian.AssZengJianStoreMainService",
 				method_name: "queryAssZengJianStoreMainPrint",
 				bean_name: "assZengJianStoreMainService" ,
