  ...
  <head>
   ...
   <jsp:include page="${path}/inc.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateAssCheckItemDict.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
            <tr>
                ...
                <td align="left" class="l-table-edit-td" style="padding-top: 45px;"><input name="check_item_code" type="text" disabled="disabled"  id="check_item_code" ltype="text"  value="${check_item_code}" validate="{required:true,maxlength:30}" /></td>
                ...
                <td align="left" class="l-table-edit-td" style="padding-top: 45px;"><input name="check_item_name" type="text" id="check_item_name" ltype="text"  value="${check_item_name}" validate="{required:true,maxlength:200}" /></td>
                <td align="left" style="padding-top: 45px;"></td>
            </tr> 
            <tr>
