...
<html style="overflow:hidden;">
  ...
  //打印回调方法
    ...
    function loadDict(){
    	...
    	//维修部门
    	autocomplete("#repair_dept_id", "../queryDeptDict.do?isCheck=false", "id","text", true, true,"",false);
    	liger.get("repair_dept_id").setValue("${repair_dept_id}@${repair_dept_no}");
    	liger.get("repair_dept_id").setText("${repair_dept_name}");
    	...
    	autocomplete("#apply_emp","../../../hrp/sys/queryUserDict.do?isCheck=false", "id","text", true, true, null, null);
    	
    	
    	liger.get("apply_emp").setValue("${apply_emp}");
    	liger.get("apply_emp").setText("${apply_emp_name}");
   ...
   <form name="form1" method="post"  id="form1" >
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        <tr>
            ...
            <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td align="left"><input type="button" value="派工确认" class="l-button repair_confirm"></td>
