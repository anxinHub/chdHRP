 ...
 function loadForm(){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="claim_no" type="text" id="claim_no" value="${claim_no}" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="breach_money" type="text" value="${breach_money}" id="breach_money" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="begin_date" type="text" id="begin_date" value="${begin_date}" ltype="text" validate="{required:true,maxlength:20}" class="Wdate"
				onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"/></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b><font color="red">*</font></b>结束日期：</td>
            <td align="left" class="l-table-edit-td"><input name="end_date" type="text" id="end_date" value="${end_date}" ltype="text" validate="{required:true,maxlength:20}" class="Wdate"
				onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"/></td>
            <td align="left"></td>
        </tr> 
         <tr>
            ...
            <textarea rows="5" cols="70" id="claim_basis" name="claim_basis">${claim_basis}</textarea>
            </td>
            <td align="left"></td>
        </tr> 
        <tr>
            ...
            <td align="left" class="l-table-edit-td" colspan="3">
             <textarea rows="5" cols="70" id="claim_reason" name="claim_reason">${claim_reason}</textarea>
            </td>
            <td align="left"></td>
        </tr>
    </table>
