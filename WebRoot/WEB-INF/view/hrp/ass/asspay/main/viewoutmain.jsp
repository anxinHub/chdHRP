...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAssBillBillMain.do?isCheck=false&pay_no=${pay_no}',delayLoad :true,
    ...
    function openUpdate(obj){
		...
		parent.$.ligerDialog.open({
			...
			width: $(window).width(),
			url: 'hrp/ass/asspay/main/assBillMainUpdatePage.do?isCheck=false&'+parm,
