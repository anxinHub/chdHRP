...
<script type="text/javascript">
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     toolbar: { items: [
                     	...
                     	{ line:true },
				    	{ text: '生成退款单（<u>A</u>）', id:'save', click: save, icon:'add' },
				    	, {
							line : true
						}, {
							text : '关闭',
    ...
    function save(){
		...
		if (data.length == 0) {
			...
			$.post("initAssBackBill.do?isCheck=false",
					{
    ...
    function openUpdate(obj){
		...
		parent.$.ligerDialog.open({
			...
			width: $(window).width(),
			url: 'assBackBillMainUpdatePage.do?isCheck=false&'+parm,
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
        ...
        <tr>
			...
			<td align="left" class="l-table-edit-td" colspan="3"><input
				name="store_name" type="text" id="store_name" value="${store_name }"/></td>
			<td align="left"></td>
        </tr>
    </table>
