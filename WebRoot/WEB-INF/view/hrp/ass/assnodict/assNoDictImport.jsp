...
<script type="text/javascript">
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '资产ID', name: 'ass_id', align: 'left',editor:{type:'text'}},
				{ display: '资产NO', name: 'ass_no', align: 'left',editor:{type:'text'}},
				{ display: '资产编码', name: 'ass_code', align: 'left',editor:{type:'text'}},
				{ display: '资产名称', name: 'ass_name', align: 'left',editor:{type:'text'}},
				{ display: '类别编码', name: 'ass_type_code', align: 'left',editor:{type:'text'}},
				...
				{ display: '生产厂商ID', name: 'fac_id', align: 'left',editor:{type:'text'}},
				{ display: '生产厂商NO', name: 'fac_no', align: 'left',editor:{type:'text'}},
				{ display: '主要供应商ID', name: 'ven_id', align: 'left',editor:{type:'text'}},
				{ display: '主要供应商NO', name: 'ven_no', align: 'left',editor:{type:'text'}},
				{ display: '资产用途', name: 'usage_code', align: 'left',editor:{type:'text'}},
				{ display: '国标码', name: 'gb_code', align: 'left',editor:{type:'text'}},
				{ display: '五笔码', name: 'wbx_code', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchAssNoDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
