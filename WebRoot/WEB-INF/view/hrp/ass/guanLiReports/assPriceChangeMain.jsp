...
<script type="text/javascript">
  ...
  //打印 单元格格式化 用
 	...
 	function printDate(){
    	...
    	var foots = {
 		...
 		var printPara={
 				...
 				class_name: "com.chd.hrp.ass.service.guanLiReports.AssPriceChangeService",
 				method_name: "queryAssPriceChangMainPrint",
 				bean_name: "assPriceChangeService" ,
    ...
    function changeYearMonth() {
    	...
    	ajaxJsonObjectByUrl("queryBusTypes.do?isCheck=false"+parm, {},
