...
<script type="text/javascript">
    ...
    function query(){
    	...
    	grid.options.parms.push({name:'dept_level',value:$("#dept_level").val()});
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAssPropertyHosManageMain.do?ass_nature='+liger.get("ass_nature").getValue()+'&depre_month='+$("#plan_year").val(),
    ...
    function loadDict(){
		...
		$("#plan_year").ligerTextBox({width:100}); 
       	$("#dept_level").ligerTextBox({width:120});
     ...
     <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        <tr >
            ...
            <td align="left" class="l-table-edit-td">
            	<select name="dept_level" id="dept_level">
            		<option value=""></option>
