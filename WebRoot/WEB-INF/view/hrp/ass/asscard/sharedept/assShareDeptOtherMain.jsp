...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryAssShareDept.do',
                     ...
                     toolbar: { items: [
						                ...
						                { line:true },
						                { text: '历史纪录', id:'history', click: history,icon:'blabel' },
				    	]}
                   });
    ...
    function history(){
    	parent.$.ligerDialog.open({
			...
			url: 'assShareDeptRMainPage.do?isCheck=false&ass_nature=${ass_nature}&ass_card_no='+ass_card_no,
    ...
    function imp(){
    	...
    	var para={
    		...
    		parent.importSpreadView("hrp/ass/asscard/importAssShareDept.do?isCheck=false&ass_naturs=${ass_nature}&ass_card_no="+ass_card_no,para);
    ...
    function save(){
		...
		if (validateGrid()) {
			ajaxJsonObjectByUrl("saveAssCardShareDept.do", formPara, function(
					responseData) {
    	...
    	var data = gridManager.getCheckedRows();
                    if (data.length == 0){
                        ...
                        parent.$.ligerDialog.confirm('确定删除?', function (yes){
                        	if(yes){
                            	ajaxJsonObjectByUrl("deleteAssShareDept.do",{ParamVo : ParamVo.toString(),ass_nature:'${ass_nature}'},function (responseData){
                            		if(responseData.state=="true"){
                            			query();
                            		}
                            	});
