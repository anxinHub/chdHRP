  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        $.ajaxFileUpload({  
            url : 'saveAssCardFile.do?file_code='+file_code+'&file_name='+file_name+'&equi_usage_code='+equi_usage_code+'&ass_nature=${ass_nature}&ass_card_no=${ass_card_no}&location='+location+"&is_stop="+is_stop, //用于文件上传的服务器端请求地址  
