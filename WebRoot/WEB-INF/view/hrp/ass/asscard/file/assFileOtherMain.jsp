...
<script type="text/javascript">
	...
	function openUpdate(obj) {
		...
		parent.$.ligerDialog.open({
			url : 'assFileUpdatePage.do?isCheck=false&'+parm,
			data : {},
			height : 350,
			width : 600,
			title : '资产文档修改',
	...
	function open_add() {
		...
		parent.$.ligerDialog
				.open({
					...
					height : 350,
					width : 600,
					url : 'assFileAddPage.do?isCheck=false&ass_nature=${ass_nature}&ass_card_no=${ass_card_no}',
					modal : false,
					showToggle : false,
					showMax : false,
					showMin : true,
	...
	function remove() {
		...
		if (data.length == 0) {
			...
			parent.$.ligerDialog.confirm('确定删除?', function(yes) {
				if (yes) {
					ajaxJsonObjectByUrl("deleteAssFile.do", {
	...
	function down(file_url) {
		...
		location.href = "downAssFile.do?isCheck=false&file_url="+file_url;
	}
