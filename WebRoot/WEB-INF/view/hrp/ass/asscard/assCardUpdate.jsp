...
<script type="text/javascript">
	...
	function printCode(){
		...
		*/
		...
		var fac_name = liger.get("FAC_ID").getText().split(" ")[1] == null || liger.get("FAC_ID").getText().split(" ")[1] == "undefined"  ? "" :liger.get("FAC_ID").getText().split(" ")[1];
		...
		$.post("generalCardCode.do?isCheck=false",{ass_nature:ass_nature,ass_card_no:$("#ASS_CARD_NO").val()},function(data){
		...
		<table align="center" cellpadding="0" cellspacing="0"
			...
			<tr align="center">
				<td align="center" class="l-table-edit-td">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<!-- <input class="l-button l-button-test"  type="button" value="条码模板设置" onclick="printCodeSet();" />
					&nbsp;&nbsp;&nbsp;&nbsp; -->
