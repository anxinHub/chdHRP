    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '本期摊销', name: 'now_depre_amount', align: 'right',width:100,
								render : function(item) {
									return formatNumber(
											item.now_depre_amount, '${ass_05005}', 1);
								}
					 		},
                     { display: '累计摊销', name: 'add_depre_amount', align: 'right',width:100,
								render : function(item) {
									return formatNumber(
											item.add_depre_amount, '${ass_05005}', 1);
								}
					 		},
                     { display: '累计摊销月份', name: 'add_depre_month', align: 'left',width:100
					 		},
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryAssDepreAcc.do',
