									...
									if (data.Rows[k].field_area == j) {
										if (data.Rows[k].is_insert_view == 1) {
											...
											if (data.Rows[k].type_code == 2) {
												...
												html += "<td align='left' width='"+width+"' class='l-table-edit-td' colspan='"+colspan +"'><input name='"+data.Rows[k].col_code+"' type='text' id='"+data.Rows[k].col_code+"' validate='{maxlength:500}' /></td>";
											}
	...
	function save() {
		...
		ajaxJsonObjectByUrl("addAssCard.do?isCheck=false", formPara, function(
			...
			if (responseData.state == "true") {
				...
				if(responseData.ass_in_no != null && responseData.ass_in_no !=""){
