     	...
     	grid = $("#maingrid").ligerGrid({
            ...
            columns: [  
                        ...
                        { display: '品牌', name: 'ass_brand', width: 100,align: 'left'
					 	...
					 	{ display: '管理科室', name: 'dept_name', width: 120,align: 'left'
					 		},	
                    ...
                    toolbar : {
 	 							items : [ {text : '保存',id : 'save',click : save,icon : 'save'}, {line : true}, 
 	 							          ...
 	 							          {text : '关闭',id : 'close',click : this_close,icon : 'candle'},{line : true}, 
 	 							       	  {text : '引入计量计划',id : 'refMaintainPlan',click : itemclick,icon : 'save'} 
 	 							        ]
 						}
                    });
...
//		            fn();
   	                ...
   	                grid: {
   	                    columns: [{
								...
								,{ 
   	                           ...
   	                           dataAction: 'server',dataType: 'server',usePager:true,url:'queryMeasurePlanRec.do?isCheck=false&plan_id='+liger.get("plan_id").getValue()+'&state=1',
   	                           width: '100%', height: '100%', checkbox: true,rownumbers:true,
   	                } 
   	            });
        ...
        if(validateGrid()){ 
	        ajaxJsonObjectByUrl("addAssMeasureRec.do",formPara,function(responseData){
	            ...
	            if(responseData.state=="true"){
	            	...
	            	$("#seq_no").val(responseData.seq_no);
	                query();
     ...
     function validateGrid() {
      ...
      //计量计划ID
      	...
      	$("#plan_id").change(function(){
    		...
    		ajaxJsonObjectByUrl("queryMeasurePlanRec.do?isCheck=false",formPara,function(responseData){
   ...
   <input type="hidden" id="rec_id" name="rec_id"/>
        ...
        <tr> 
            ...
            <td align="left" class="l-table-edit-td" width="5%"><input name="seq_no" type="text" id="seq_no"  /></td>
            <td align="left"></td>
            ...
            <td align="left" class="l-table-edit-td"><input name="outer_measure_engr" type="text" id="outer_measure_engr"  /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="plan_measure_date" type="text" id="plan_measure_date"  class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">实际计量日期：</td>
            <td align="left" class="l-table-edit-td"><input name="fact_measure_date" type="text" id="fact_measure_date"  class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">有效期至：</td>
            <td align="left" class="l-table-edit-td"><input name="pre_next_date" type="text" id="pre_next_date"  class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
       ...
       <tr>
            ...
            <td align="left" class="l-table-edit-td">
            	 <input name="entrust_no" type="text" id="entrust_no" /> 	 	
            </td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">鉴定依据：</td>
            <td align="left" class="l-table-edit-td">
            	 <input name="firm_basis" type="text" id="firm_basis" /> 	 	
            </td>
            <td align="left"></td>
       </tr>
       <tr>
            ...
            <td align="left" class="l-table-edit-td" colspan="4">
            		<textarea rows="3" cols="70"  name="measure_idea" id="measure_idea"  ></textarea>
            </td>
            <td align="left"></td>
        </tr> 
    </table>
