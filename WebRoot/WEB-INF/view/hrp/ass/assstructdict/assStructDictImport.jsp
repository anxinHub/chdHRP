...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssStructDictFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '建筑结构代码', name: 'struct_code', align: 'left',editor:{type:'text'}},
				{ display: '建筑结构名称', name: 'struct_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssStructDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
