  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAssStructDict.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='struct_code']").val('');
				 $("input[name='struct_name']").val('');
   ...
   <form name="form1" method="post"  id="form1" >
       <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
            <tr>
                ...
                <td align="left" class="l-table-edit-td" style="padding-top: 45px;"><input name="struct_code" type="text" id="struct_code" ltype="text" validate="{required:true,maxlength:30}" /></td>
                ...
                <td align="left" class="l-table-edit-td" style="padding-top: 45px;"><input name="struct_name" type="text" id="struct_name" ltype="text" validate="{required:true,maxlength:200}" /></td>
                <td align="left" style="padding-top: 45px;"></td>
            </tr>  
            <tr >
