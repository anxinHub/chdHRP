...
<script type="text/javascript">
		...
		function loadHead() {
				...
				{ display: '折旧方法名称', name: 'ass_depre_name', align: 'left',editor:{type:'text'}},
				{ display: '折旧方法描述', name: 'ass_depre_define', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssDepreMethodDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
