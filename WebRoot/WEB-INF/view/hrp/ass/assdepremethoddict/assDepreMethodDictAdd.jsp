  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAssDepreMethodDict.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='ass_depre_code']").val('');
				 $("input[name='ass_depre_name']").val('');
				 $("input[name='ass_depre_define']").val('');
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="ass_depre_define" type="text" id="ass_depre_define" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
