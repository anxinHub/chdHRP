    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					...
					/*  { display: '取值', name: 'replace_va', align: 'left',width: '120',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,url:'queryAssReportItem.do?isCheck=false&rhead_id='+${rhead_id},
	...
	function saveAssDefinedQuery(){
		...
		if($("form").valid()){
			...
			if (validateGrid(data)) {
				ajaxJsonObjectByUrl("updateAssDefinedQuery.do?isCheck=false", formPara, function(
						responseData) {
	    	...
	    	<tbody>
	    		<tr>
	                ...
	                <td align="left" class="l-table-edit-td">
	                	<div class="l-text" style="width: 178px;"><input name="rhead_name" value="${rhead_name}" type="text" id="rhead_name" ltype="text" validate="{required:true}" class="l-text-field" ligeruiid="rhead_name" style="width: 174px;"><div class="l-text-l"></div><div class="l-text-r"></div></div>
	                </td>
	                <td align="right" class="l-table-edit-td">报表编码:</td>
	                <td align="left" class="l-table-edit-td">
	                	<div class="l-text" style="width: 178px;"><input name="rhead_code" value="${rhead_code}" type="text" id="rhead_code" ltype="text" validate="{required:true}" class="l-text-field" ligeruiid="rhead_code" style="width: 174px;"><div class="l-text-l"></div><div class="l-text-r"></div></div>
	                </td>
	            </tr>
	            <tr>
	            ...
	            <tr>
	            	<table cellpadding="0" cellspacing="0" class="l-table-edit">
		            	<tr>
			                ...
			                <td align="left" class="l-table-edit-td"> 
			                	<textarea cols="100" rows="4" class="l-textarea" id="r_sql" style="width:600px" validate="{required:true}">${r_sql}</textarea>
			                </td>
