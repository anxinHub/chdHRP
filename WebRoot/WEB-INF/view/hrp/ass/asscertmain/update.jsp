...
<script type="text/javascript">
				...
				.ligerGrid(
						{
							...
							rownumbers : true,
							delayLoad : true,
							url:'queryAssCertDetail.do?isCheck=false',
	...
	function save() {
		...
		if (validateGrid()) {
			ajaxJsonObjectByUrl("updateAssCert.do", formPara, function(responseData) {
					...
					$.ligerDialog
							.confirm(
									...
									function(yes) {
										if (yes) {
											ajaxJsonObjectByUrl(
													"deleteAssCertDetail.do?isCheck=false",
													{
														ParamVo : ParamVo
																.toString()
													},
	...
	function loadDict() {
		...
		liger.get("cert_state").setValue("${fcert_state}");
		liger.get("cert_state").setText("${cert_state_name}");
...
<body style="padding: 0px; overflow: hidden;" onload="is_addRow()">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
		<tr>
			...
			<td align="left" class="l-table-edit-td"><input name="cert_code" disabled="disabled" value="${cert_code }"
				type="text" id="cert_code"  /></td>
			<td align="left"></td>
			<td align="right" class="l-table-edit-td" style="padding-left: 20px;"><b><font
					color="red">*</font></b>证件名称：</td>
			<td align="left" class="l-table-edit-td"><input name="cert_inv_name" value="${cert_inv_name }"
			...
			<td align="left" class="l-table-edit-td"><input name="cert_date"
				type="text" id="cert_date" class="Wdate" value="${cert_date }"
		...
		<tr>
			...
			<td align="left" class="l-table-edit-td" colspan="6"><input name="cert_memo" value="${cert_memo }"
