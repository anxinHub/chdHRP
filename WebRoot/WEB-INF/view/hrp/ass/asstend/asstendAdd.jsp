...
/* 	amount_money : function(value) {//金额
 ...
 function save(){
	...
	$.ligerDialog.confirm('确定新增 ?', function(yes) {
		
		if (yes) {
			ajaxJsonObjectByUrl("addAssTendMain.do?isCheck=false", prama, function(responseData) {
				if (responseData.state == "true") {
					 $("input[name='bid_id']").val(responseData.bid_id);
		...
		if (item.id) {
			...
			case "add":
				...
				parent.$.ligerDialog.open({
					...
					height: 500,
					width: $(window).width(),
					url: 'hrp/ass/asstend/assTendDetailAddPage.do?isCheck=false&bid_id='+$("#bid_id").val(),
			...
			case "delete":
				...
				if (data.length == 0) {
					...
					$.ligerDialog.confirm('确定删除?', function(yes) {
						...
						if (yes) {
							ajaxJsonObjectByUrl("deleteTendDetail.do?isCheck=false", {
	...
	function openUpdate(obj) {
		...
		parent.$.ligerDialog.open({
			...
			height: 500,
			width: $(window).width(),
			url: 'hrp/ass/asstend/assTendDetailUpdatePage.do?isCheck=false&' + parm,
			modal: true, showToggle: false, showMax: false, showMin: false, isResize: true,
			parentframename: window.name,  //用于parent弹出层调用本页面的方法或变量
			buttons: [ { text: '确定', onclick: function (item, dialog) { dialog.frame.save(); },cls:'l-dialog-btn-highlight' }, { text: '取消', onclick: function (item, dialog) { dialog.close(); } } ] 
	 ...
	 function submitTend(){
		 ...
		 prama={
			...
			$.ligerDialog.confirm('确定提交?', function(yes) {
				...
				if (yes) {
					ajaxJsonObjectByUrl("submitAssTend.do?isCheck=false", prama, function(responseData) {
						if (responseData.state == "true") {
							 parentFrameUse().query();
						}
					});
 ...
 <form name="form1" method="post"  id="form1" >
	<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
		...
		<tr>
			...
			<td align="left" class="l-table-edit-td" ><input name="bid_code" type="text" id="bid_code"   validate="{required:true}"/></td>
	        
	        <td align="right" class="l-table-edit-td" >招标方式</td>
			<td align="left" class="l-table-edit-td"><input name="bid_method" type="text" id="bid_method"    validate="{required:true}" /></td>
			<td align="left" ></td>
			
			<td align="right" class="l-table-edit-td">招标人</td>			
			<td align="left" class="l-table-edit-td"><input name="bid_tenderee" type="text" id="bid_tenderee"   validate="{required:true}"/></td>
			<td align="left"></td>
			
			<td align="right" class="l-table-edit-td" >招标地址</td>
			<td align="left" class="l-table-edit-td"><input name="bid_tenderaddress" type="text" id="bid_tenderaddress"   validate="{required:true}"/></td>
		 ...
		 <tr>
			...
			<td align="left" class="l-table-edit-td"><input name="bid_purchasemode" type="text" id="bid_purchasemode" /></td>
			
			<td align="right" class="l-table-edit-td">采购文件售价</td>
			<td align="left" class="l-table-edit-td"><input name="filed_price" type="number" id="filed_price"  /></td>
			<td align="left"></td>
			
			<td align="right" class="l-table-edit-td" >保证金</td>
			<td align="left" class="l-table-edit-td"><input name="bid_bond" type="number" id="bid_bond" /></td>
			<td align="left"></td>
			
			<td align="right" class="l-table-edit-td" >招标条件</td>
			<td align="left" class="l-table-edit-td"><input name="bid_condition" type="text" id="bid_condition"  /></td>
		...
		<tr>
			...
			<td align="left" class="l-table-edit-td"><input name="bid_purstart" type="text" id="bid_purstart" class="Wdate"  onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"  /></td>
			
			<td align="right" class="l-table-edit-td"> 购买标书结束时间</td>
			<td align="left" class="l-table-edit-td"><input name="bid_purend" type="text" id="bid_purend"   class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"  /></td>
			<td align="left"></td>
			
			<td align="right" class="l-table-edit-td">买标书地点</td>
			<td align="left" class="l-table-edit-td"><input name="bid_puraddr" type="text" id="bid_puraddr"  /></td>
			<td align="left"></td>
			
			<td align="right" class="l-table-edit-td">公告媒介</td>
			<td align="left" class="l-table-edit-td"><input name="bid_notice" type="text" id="bid_notice"  /></td>
			
		</tr>
		<tr>
		
		   <td align="right" class="l-table-edit-td" style="padding-left: 10px;">招标代理</td>
		   <td align="left" class="l-table-edit-td"><input name="bid_agent" type="text" id="bid_agent" /></td>
		   
		   <td align="right" class="l-table-edit-td">招标代理联系人</td>
		   <td align="left" class="l-table-edit-td"><input name="bid_agenter" type="text" id="bid_agenter"  /></td>
		   <td align="left"></td>
		   
		   <td align="right" class="l-table-edit-td">招标代理电话</td>
		   <td align="left" class="l-table-edit-td"><input name="bid_agentphone" type="text" id="bid_agentphone" /></td>
		   <td align="left"></td>
		   
		   <td align="right" class="l-table-edit-td">开标地点</td>
		   <td align="left" class="l-table-edit-td"><input name="bid_openplace" type="text" id="bid_openplace"  /></td>
		   <td align="left"></td>
		</tr>
		
		<tr>
		   <td align="right" class="l-table-edit-td" style="padding-left: 10px;">答疑日期</td>
		   <td align="left" class="l-table-edit-td"><input name="bid_answerdate" type="text" id="bid_answerdate" class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"  /></td>
			
		   <td align="right" class="l-table-edit-td">定标日期</td>
		   <td align="left" class="l-table-edit-td"><input name="bid_calibratedate" type="text" id="bid_calibratedate"   class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"  /></td>
		   <td align="left"></td>

		   <td align="right" class="l-table-edit-td">公告日期</td>
		   <td align="left" class="l-table-edit-td"><input name="bid_noticedate" type="text" id="bid_noticedate"   class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"  /></td>
		   <td align="left"></td>

		   <td align="right" class="l-table-edit-td">开标日期</td>
		   <td align="left" class="l-table-edit-td"><input name="bid_start" type="text" id="bid_start"  class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"/></td>
		   <td align="left"></td>		   		
		</tr>
		
		<tr>
		   <td align="right" class="l-table-edit-td" style="padding-left: 10px;">投标截止日期</td>
		   <td align="left" class="l-table-edit-td"><input name="bid_end" type="text" id="bid_end" class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" /></td>
		  
		   <td align="right" class="l-table-edit-td">评委委员会人员</td>
		   <td align="left" class="l-table-edit-td"><input name="bid_committee" type="text" id="bid_committee"  /></td>
		   <td align="left"></td>
		   
		   <td align="right" class="l-table-edit-td">备注</td>
		   <td align="left" class="l-table-edit-td"><input name="bid_remark" type="text" id="bid_remark"  /></td>
		   <td align="left"></td>
		   <td align="right" class="l-table-edit-td" style="display: none">bid_id</td>
		   <td align="left" class="l-table-edit-td"><input name="bid_id" type="text" id="bid_id"  style="display: none" /></td>
