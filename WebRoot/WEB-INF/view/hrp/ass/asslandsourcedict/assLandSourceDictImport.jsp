...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssLandSourceDictFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '土地来源代码', name: 'land_source_code', align: 'left',editor:{type:'text'}},
				{ display: '土地来源名称', name: 'land_source_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssLandSourceDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
