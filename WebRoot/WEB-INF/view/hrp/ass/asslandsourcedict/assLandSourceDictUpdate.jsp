...
<html style="overflow:hidden;">
  <head>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateAssLandSourceDict.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
            <tr>
                ...
                <td align="left" class="l-table-edit-td" style="padding-top: 45px;"><input name="land_source_code" type="text" id="land_source_code" ltype="text" disabled="disabled"  value="${land_source_code}" validate="{required:true,maxlength:30}" /></td>
                ...
                <td align="left" class="l-table-edit-td" style="padding-top: 45px;"><input name="land_source_name" type="text" id="land_source_name" ltype="text"  value="${land_source_name}" validate="{required:true,maxlength:200}" /></td>
                <td align="left" style="padding-top: 45px;"></td>
            </tr> 
            <tr>
