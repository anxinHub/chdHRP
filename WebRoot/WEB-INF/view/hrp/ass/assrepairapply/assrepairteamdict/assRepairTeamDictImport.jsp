...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssRepairTeamDictFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '班组编码', name: 'rep_team_code', align: 'left',editor:{type:'text'}},
				{ display: '班组名称', name: 'rep_team_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssRepairTeamDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
