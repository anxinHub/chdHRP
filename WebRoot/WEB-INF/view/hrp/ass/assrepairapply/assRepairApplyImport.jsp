...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssRepairApplyFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '维修部门ID', name: 'repair_dept_id', align: 'left',editor:{type:'text'}},
				{ display: '维修部门NO', name: 'repair_dept_no', align: 'left',editor:{type:'text'}},
				{ display: '资产名称', name: 'ass_name', align: 'left',editor:{type:'text'}},
				{ display: '申请人', name: 'apply_emp', align: 'left',editor:{type:'text'}},
				{ display: '申请日期', name: 'apply_date', align: 'left',editor:{type:'text'}},
				...
				{ display: '紧急程度', name: 'sharp_degree', align: 'left',editor:{type:'text'}},
				{ display: '报修人电话', name: 'rep_phone', align: 'left',editor:{type:'text'}},
				{ display: '维修班组', name: 'rep_team_code', align: 'left',editor:{type:'text'}},
				{ display: '故障内容', name: 'note', align: 'left',editor:{type:'text'}},
				{ display: '资产卡片', name: 'ass_card_no', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchAssRepairApply.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
