...
<script type="text/javascript">
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					...
					align : 'left',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'../../../queryAssCardTable.do?isCheck=false&ass_nature=03&use_state=1,2,3,4,5,6'+'&sql='+str,
    ...
    function loadDict(){
		...
		autocomplete("#ass_id","../../../queryAssNoDict.do?isCheck=false","id","text",true,true, null, null, null, "180");
