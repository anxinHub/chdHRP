...
<script type="text/javascript">
	...
	function importSave(){
		...
		var param = 
				...
				+"in_store_id="+liger.get("in_store_id").getValue().split("@")[0] + "&"
				+"in_store_no="+liger.get("in_store_id").getValue().split("@")[1] + "&"
				+"in_store_code="+liger.get("in_store_id").getText().split(" ")[0] +"&"
				+"in_store_name="+liger.get("in_store_id").getText().split(" ")[1] +"&"
				+"create_date="+$("#create_date").val();
		$.ligerDialog.open({
			title: '引入资产卡片',
				...
				.ligerComboBox(
						{
							...
							width : 160,
							onSelected : function(id, text) {
								var store_id = liger.get("out_store_id")
										.getValue().split("@")[0];
								var store_no = liger.get("out_store_id")
										.getValue().split("@")[1];
