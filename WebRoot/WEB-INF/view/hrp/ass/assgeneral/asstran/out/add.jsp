...
<script type="text/javascript">
	...
	function save() {
		...
		if (validateGrid()) {
			ajaxJsonObjectByUrl("saveAssOutGeneral.do", formPara, function(responseData) {
	...
	function cardSelect(){
		...
		var str = "select * from ASS_OUT_DETAIL_GENERAL p "+
				 " left join ass_out_general pp "+
				  ...
				  " and a.hos_id = p.hos_id "+
				  " and a.ass_card_no = p.ass_card_no "+
				  " and pp.bill_type = '01' "+
				  " and pp.state = 0 "
