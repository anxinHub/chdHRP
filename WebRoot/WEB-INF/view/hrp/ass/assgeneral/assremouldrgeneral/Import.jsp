...
<script type="text/javascript">
		...
		grid = $("#maingrid").ligerGrid(
				{
					...
					dataType : 'server',
					usePager : true,
					url : 'queryAssRemouldAspecial.do?isCheck=false&state=2&bus_type_code=${bus_type_code}',
					width : '100%',
					height : '100%',
					checkbox : true,
					rownumbers : true,
	...
	function openUpdate(obj) {
		...
		parent.$.ligerDialog
				.open({
					url : 'hrp/ass/assremould/assremouldrgeneral/assRemouldAspecialUpdatePage.do?isCheck=false&'
							+ param,
