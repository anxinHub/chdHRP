...
<script type="text/javascript">
    ...
    function loadDict(){
    	...
    	//是否代销库房
    	autocomplete("#is_com","/hrp/ass/queryMatYearOrNo.do?isCheck=false","id","text",true,true);
    	...
    	//是否代销库房
    	autocomplete("#is_control","/hrp/ass/queryMatYearOrNo.do?isCheck=false","id","text",true,true);
    	...
    	//是否是货位管理
    	autocomplete("#is_location","/hrp/ass/queryMatYearOrNo.do?isCheck=false","id","text",true,true);
    ...
    function deptChange(){
		...
		if(!dept_id){
			...
			$("#stock_emp").ligerComboBox({
			 	parms : param,
			 	url: '/hrp/ass/queryMatEmp.do?isCheck=false',
		      	valueField: 'id',
		       	textField: 'text', 
		      	autocomplete: true,
		      	selectBoxWidth: 160,
			...
			$("#stock_emp").ligerComboBox({
			 	parms : param,
			 	url: '/hrp/ass/queryMatStockEmp.do?isCheck=false',
		      	valueField: 'id',
		       	textField: 'text', 
		      	autocomplete: true,
		      	selectBoxWidth: 160,
