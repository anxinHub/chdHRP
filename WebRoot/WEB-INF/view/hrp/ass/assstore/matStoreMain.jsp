...
<script type="text/javascript">
    ...
    function openUpdate(obj){
    	...
    	$.ligerDialog.open({ url : 'matStoreUpdatePage.do?isCheck=false&' + parm,data:{}, height: 500,width: 800, title:'修改',modal:true,showToggle:false,showMax:false,showMin: false,isResize:true,
    			buttons: [ 
