...
<script type="text/javascript">
	...
	function openUpdate(obj) {
		...
		parent.$.ligerDialog.open({
			...
			width : $(window).width(),
			url : 'hrp/ass/assbidmain/assBidMainViewPage.do?isCheck=false&'
					+ parm,
			modal : true,
			showToggle : false,
			showMax : true,
	...
	function printDate() {
		...
		ajaxJsonObjectByUrl("queryAssBidQueryMain.do?isCheck=false", selPara,
	...
	function exportExcel() {
		...
		ajaxJsonObjectByUrl("queryAssBidMain.do", exportPara, function(
				responseData) {
