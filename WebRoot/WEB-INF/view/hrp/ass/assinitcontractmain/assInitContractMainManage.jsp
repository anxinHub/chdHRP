...
<script type="text/javascript">
				...
				.ligerGrid(
						{
							...
							dataType : 'server',
							usePager : true,
							url : 'queryAssInitContractManage.do?isCheck=false&contract_id=${contract_id}',
							width : '100%',
							height : '100%',
							checkbox : true,
							rownumbers : true,
	...
	function add_open() {
		...
		$.ligerDialog.open({
			url : 'assInitContractManageAddPage.do?isCheck=false&' + parm,
			data : {},
			height : 500,
			width : 500,
			title : '添加付款分期',
	...
	function openUpdate(obj) {
		...
		$.ligerDialog.open({
			url : 'assInitContractManageUpdatePage.do?isCheck=false&' + parm,
			data : {},
			height : 500,
			width : 500,
			title : '修改',
			...
			$.ligerDialog
					.confirm(
							...
							function(yes) {
								if (yes) {
									ajaxJsonObjectByUrl(
											"../assinitcontractmain/deleteAssInitContractManage.do",
											{
