...
<script type="text/javascript">
	...
	function save() {
		...
		if (validateGrid()) {
			ajaxJsonObjectByUrl("addAssInitContractMain.do", formPara,
				...
				.ligerGrid(
						{
							...
							dataType : 'server',
							usePager : false,
							url : '../assinitcontractdetail/queryAssInitContractDetail.do?isCheck=false',
							width : '100%',
							height : '100%',
							checkbox : true,
					...
					$.ligerDialog
							.confirm(
									...
									function(yes) {
										if (yes) {
											ajaxJsonObjectByUrl(
													"../assinitcontractdetail/deleteAssInitContractDetail.do?isCheck=false",
													{
														ParamVo : ParamVo
																.toString()
													},
