...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssRelicGradeDictFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '文物等级代码', name: 'relic_grade_code', align: 'left',editor:{type:'text'}},
				{ display: '文物等级名称', name: 'relic_grade_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssRelicGradeDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
