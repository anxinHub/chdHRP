...
<script type="text/javascript">
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '用途编码', name: 'equi_usage_code', align: 'left',editor:{type:'text'}},
				{ display: '用途名称', name: 'equi_usage_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssUsageDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
