    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAssUsageDict.do',
            ...
            switch (item.id)
            {
                ...
                case "delete":
                    ...
                    if (data.length == 0){
                        ...
                        $.ligerDialog.confirm('确定删除?', function (yes){
                        	if(yes){
                            	ajaxJsonObjectByUrl("deleteAssUsageDict.do",{ParamVo : ParamVo.toString()},function (responseData){
                ...
                case "import":
                	 ...
                	 var para = {
        				...
        				importSpreadView("hrp/ass/assusagedict/assUsageDictImport.do?isCheck=false",
        						para);
...
// 	 }
	    function printDate(){
	    	...
	    	var printPara={
	   		...
	   		ajaxJsonObjectByUrl("queryAssUsageDict.do?isCheck=false", selPara, function (responseData) {
	 ...
	 function exportExcel(){
		...
		ajaxJsonObjectByUrl("queryAssUsageDict.do",exportPara,function (responseData){
			$.each(responseData.Rows,function(idx,item){ 
				 var trHtml="<tr>";
					 trHtml+="<td>"+item.equi_usage_code+"</td>"; 
					 trHtml+="<td>"+item.equi_usage_name+"</td>"; 
