...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssMeasurePlanFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '计量计划ID', name: 'plan_id', align: 'left',editor:{type:'text'}},
				{ display: '计量计划编号', name: 'plan_no', align: 'left',editor:{type:'text'}},
				{ display: '计量计划名称', name: 'plan_name', align: 'left',editor:{type:'text'}},
				{ display: '计量计划年份', name: 'plan_year', align: 'left',editor:{type:'text'}},
				...
				{ display: '检查方式', name: 'check_way', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssMeasurePlan.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
