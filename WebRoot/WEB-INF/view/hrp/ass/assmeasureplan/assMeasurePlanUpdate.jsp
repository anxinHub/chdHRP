  ...
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function  query(){
		...
		grid.options.parms.push({name : 'plan_id',value : $("#plan_id").val()});
    ...
    function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
           ...
           columns: [  
                     ...
                     { display: '资产名称', name: 'ass_name',width: 140, align: 'left', },
                     ...
                     { display: '计量周期(月)', name: 'measure_cycle', width: 100,align: 'left', editor : { type : 'int' }
					 		},
		             ...
		             { display: '计量说明', name: 'measure_desc',width: 100, align: 'left', editor : { type : 'text'  }
		 				    },
			 	     /* { display: '是否内部检测', name: 'is_inner', width: 100,align: 'left', 
		 				    	editor : {
									type : 'select',
									valueField : 'id',
									textField : 'text',
			         ...
			         { display: '外部计量单位', name: 'outer_measure_org',width: 100, align: 'left', editor : { type : 'text'  }
			 			    }, */
                     ],
                     dataAction: 'server',dataType: 'server',usePager:true,
                     url:'../assmeasureplanass/queryAssMeasurePlanAss.do?isCheck=false&ass_nature='+liger.get("ass_nature").getValue(),
                     width : '100%',
						height : '100%',
						checkbox : true,
    ...
    function loadDict(){
    	...
    	autoCompleteByData("#is_inner", ForR , "id","text", true, true,"",false,"${is_inner}");
    	
    	
        $("#plan_no").ligerTextBox({width:160 ,disabled:true});
        ...
        $("#ass_card_no,#measure_cycle,#ass_nature").ligerTextBox({cancelable: false,width:160}); 
   ...
   <div id="pageloading" class="l-loading" style="display: none"></div>
     <input type="hidden" id="plan_id" name="plan_id" value="${plan_id }"/>
        ...
        <tr> 
            ...
            <td align="left" class="l-table-edit-td"><input name="plan_no" type="text" id="plan_no" disabled="disabled" value="${plan_no}"  /></td>
            <td align="left"></td>
            ...
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b><font color="red">*</font></b>计量计划年份：</td>
            <td align="left" class="l-table-edit-td"><input name="plan_year" type="text" id="plan_year"  value="${plan_year}"  class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy'})" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="measure_cycle"  type="text" id="measure_cycle"  value="${measure_cycle}"  onkeyup='this.value=this.value.replace(/\D/gi,"")'/></td>
            <td align="left"></td>
            ...
            <td align="left" class="l-table-edit-td"><input name="check_way" type="text" id="check_way"  value="${check_way}"  /></td>
      		<td align="left"></td>
        </tr>
        <tr>
