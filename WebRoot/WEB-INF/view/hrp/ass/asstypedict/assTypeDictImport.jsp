...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){/* 
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnWidth(0, "100"); sheet.setText(0, 0, "分类编码"); 
    	sheet.setColumnWidth(1, "100"); sheet.setText(0, 1, "分类名称");//修改
    	sheet.setColumnWidth(2, "150"); sheet.setText(0, 2, "是否末级分类");//修改
    	sheet.setColumnWidth(3, "150"); sheet.setText(0, 3, "性质编码");
    	sheet.setColumnWidth(4, "150"); sheet.setText(0, 4, "是否停用");
   ...
   /*  	grid.endEdit(); */
    	...
    	ajaxJsonObjectBylayer("readAssTypeDictFiles.do?isCheck=false", para,function (responseData){
