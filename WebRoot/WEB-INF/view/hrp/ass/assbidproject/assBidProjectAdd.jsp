...
<script type="text/javascript">
	...
	function save() {
		...
		var formPara = {
			...
			project_id : $("#project_id").val() == "" ? 0 : $("#project_id")
					.val(),
		...
		if (validateGrid()) {
			$.post("addAssBidProject.do", formPara, function(responseData) {
	...
	function query() {
		...
		grid.options.parms.push({
			name : 'project_id',
			value : $("#project_id").val() == "" ? "0" : $("#project_id").val()
		});
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit">
		<tr>
			...
			<td align="left" class="l-table-edit-td"><input
				name="project_no" type="text" id="project_no" disabled="disabled" /></td>
			<td align="left"></td>
			<td align="right" class="l-table-edit-td" style="padding-left: 20px;"><b><font
