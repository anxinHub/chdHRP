...
<script type="text/javascript">
	...
	function save() {
		...
		if (validateGrid()) {
			/* console.log(plan_id),  */ajaxJsonObjectByUrl("addAssPlanDeptGroup.do",
				...
				.ligerGrid(
						{
							...
							onCheckRow : function(checked, data, rowid, rowdata) {
								...
								loadHeadItem();checked&& ajaxJsonObjectByUrl(
	...
	function loadDict() {
		...
		autocomplete("#dept_id",
							"../queryDeptDict.do?isCheck=false", "id", "text",
							true, true, null, null);
		//获取当前用户科室默认值
...
<form >
	<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
		...
		<tr>
			<td align="right" class="l-table-edit-td">摘&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;要：

</td>
			<td align="left" class="l-table-edit-td" colspan="6"><textarea
					rows="3" cols="100" name="note" id="note"></textarea></td>
			<td align="left"></td>
		</tr>
