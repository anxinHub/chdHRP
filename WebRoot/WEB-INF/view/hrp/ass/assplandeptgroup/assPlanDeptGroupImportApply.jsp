...
<script type="text/javascript">
	...
	function openUpdate(obj) {
		...
		parent.$.ligerDialog.open({
			...
			width: $(window).width(),
			url: 'hrp/ass/assplandeptgroup/assPlanDeptGroupViewApplyPage.do?isCheck=false&' + parm,
	...
	function save() {
		...
		if (data.length == 0) {
			...
			$.post("addAssPlanDeptGroupImport.do?isCheck=false", {
...
<body style="padding: 0px; overflow: hidden;">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%" border="0">
		<tr>
			...
			<td align="left"></td>
			<td align="right" class="l-table-edit-td" style="padding-left: 20px;" width="60">申请单号：</td>
			<td align="left" class="l-table-edit-td" width="15%"><input name="apply_no"
		...
		<tr>
			...
			<td align="left"></td>
			<td align="right" class="l-table-edit-td" style="padding-left: 20px;">申&nbsp;&nbsp;请&nbsp;&nbsp;人：</td>
			<td align="left" class="l-table-edit-td"><input name="apply_emp"
				type="text" id="apply_emp" 
				 /></td>
			<td align="left"></td>
			<td align="right" class="l-table-edit-td" >审&nbsp;&nbsp;核&nbsp;&nbsp;人：</td>
		...
		<tr>
			...
			<td align="left"></td>
			<td align="right" class="l-table-edit-td" >追加申请：</td>
			<td align="left" class="l-table-edit-td">
