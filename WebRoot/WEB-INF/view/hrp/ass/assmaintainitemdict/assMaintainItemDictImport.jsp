...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssMaintainItemDictFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '保养项目编码', name: 'maintain_item_code', align: 'left',editor:{type:'text'}},
				{ display: '保养项目名称', name: 'maintain_item_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssMaintainItemDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
