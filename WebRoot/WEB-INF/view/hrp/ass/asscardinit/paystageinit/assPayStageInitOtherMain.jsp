...
<script type="text/javascript">
	...
	function save() {
		...
		if (validateGrid()) {
			ajaxJsonObjectByUrl("saveAssPayStageInit.do", formPara, function(
					responseData) {
	...
	function remove() {
		...
		if (data.length == 0) {
			...
			parent.$.ligerDialog.confirm('确定删除?', function(yes) {
				if (yes) {
					ajaxJsonObjectByUrl("deleteAssPayStageInit.do", {
