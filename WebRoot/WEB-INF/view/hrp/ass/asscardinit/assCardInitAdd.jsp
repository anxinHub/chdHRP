...
<script type="text/javascript">
	...
	function selectTab(tabid){
		...
		$.each(tabData.Rows,function(i,v){
			if(v.tab_id == tabid){
				navtab.setTabItemSrc(tabid,v.init_tab_url+"&ass_card_no="+ass_card_no_old);
			}
		});
		tab_ids.push(tabid);
	}
	...
	function getAssCardNo() {
		$.post("getAssCardInitNo.do?isCheck=false", {
			"ass_nature" : "${ass_nature}"
		}, function(resData) {
			ass_card_no = resData;
		});
	...
	function save() {
		...
		ajaxJsonObjectByUrl("addAssCardInit.do?isCheck=false", formPara, function(
				responseData) {
