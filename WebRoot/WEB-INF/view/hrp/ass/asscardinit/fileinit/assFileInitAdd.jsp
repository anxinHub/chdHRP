  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        $.ajaxFileUpload({  
            url : 'saveAssCardInitFile.do?file_code='+file_code+'&file_name='+file_name+'&equi_usage_code='+equi_usage_code+'&ass_nature=${ass_nature}&ass_card_no=${ass_card_no}&location='+location+"&is_stop="+is_stop, //用于文件上传的服务器端请求地址  
   ...
   <form name="form1" method="post"  id="form1" action="upload" method="post" enctype="multipart/form-data">
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="file_code" type="text" id="file_code" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">文档名称：</td>
                <td align="left" class="l-table-edit-td"><input name="file_name" type="text" id="file_name" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="location" type="text" id="location" ltype="text" validate="{required:false,maxlength:200}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
