  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        $.ajaxFileUpload({  
            url : 'updateAssCardPhotoInit.do?photo_code='+photo_code+'&photo_name='+photo_name+'&ass_nature=${ass_nature}&ass_card_no=${ass_card_no}&ord_file_url='+ord_file_url+'&is_stop='+is_stop, //用于文件上传的服务器端请求地址  
   ...
   <form name="form1" method="post"  id="form1" action="upload" method="post" enctype="multipart/form-data">
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="photo_code" value="${photo_code }" disabled="disabled" type="text" id="photo_code" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">照片名称：</td>
                <td align="left" class="l-table-edit-td"><input name="photo_name" value="${photo_name }" type="text" id="photo_name" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
