...
<html style="overflow:hidden;">
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	$("#bond_flag").val('${bond_flag}');
    	
    	$("#pay_flag").val('${pay_flag}');
     } 
    function this_close(){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="create_date" type="text" value="${create_date }" id="create_date" ltype="text" validate="{required:true,maxlength:20}" class="Wdate"
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="pay_money" type="text" value="${pay_money }" id="pay_money" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">发票号：</td>
            <td align="left" class="l-table-edit-td"><input name="bill_no" type="text" value="${bill_no }" id="bill_no"  ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b><font color="red">*</font></b>支票号：</td>
            <td align="left" class="l-table-edit-td"><input name="check_no" type="text" value="${check_no }" id="check_no" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
