...
<script type="text/javascript">
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '性质编码', name: 'naturs_code', align: 'left',editor:{type:'text'}},
				{ display: '性质名称', name: 'naturs_name', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchAssNaturs.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
