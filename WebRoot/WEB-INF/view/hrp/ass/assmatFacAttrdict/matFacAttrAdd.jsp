  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     $(function (){
 	   ...
 	   if(is_auto != 1){
 		 $("#fac_code").val(""); 
 		   /*  $("#fac_code").ligerTextBox({disabled:true});   */
 	   }
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("assAddMatFacAttr.do?isCheck=false",formPara,function(responseData){
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
             <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>生产厂商编码<font color="red">*</font>:</b></td>
                <td align="left" class="l-table-edit-td" ><input name="fac_code" type="text" id="fac_code" ltype="text" validate="{required:true,maxlength:100}"/></td>
                <td align="left"></td>
