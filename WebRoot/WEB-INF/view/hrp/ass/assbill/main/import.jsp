...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAssInAndAssChange.do?isCheck=false',delayLoad :true,
                     width: '100%', height: '95%', checkbox: true,/* rownumbers:true, */checkBoxDisplay : isCheckDisplay,
                     selectRowButtonOnly:true, onSelectRow  : updateBill_money ,onUnSelectRow : updateBill_money ,pageSizeOptions: [10, 15, 20,50,100,500,1000],
                     //heightDiff: -10,
                     toolbar: { items: [
    ...
    function save(){
		...
		if (data.length == 0) {
			...
			var invoice_nos = [];
			$.each(data,function(){
				params.push(this.ass_card_no+"@"+this.stage_no+"@"+this.stage_name+"@"+this.unpay_money+"@"+this.naturs_code+"@"+this.ass_in_no);
			...
			$.post("importInAndChange.do?isCheck=false",
					{
...
<body style="padding: 0px; overflow: hidden;">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
        ...
        <tr>
			...
			<td align="left"  class="l-table-edit-td" colspan="3"><input name="store_name" disabled="disabled" value="${store_name }"
