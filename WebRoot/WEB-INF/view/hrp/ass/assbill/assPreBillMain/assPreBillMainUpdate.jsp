  ...
  <head>
    ...
    function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [  
                     ...
                     url : 'queryAssPreBilldetail.do?isCheck=false&bill_no=${bill_no}',
                     checkbox: true,
                     enabledEdit : true,
                     rownumbers:true,
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="bill_no" type="text" id="bill_no" ltype="text" value="${bill_no}" /></td>
            <td align="left"></td>
            ...
            <input name="bill_date" type="text" id="bill_date" ltype="text" value="${bill_date}"  
            class="Wdate"
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="bill_money" type="text" id="bill_money" ltype="text" value="${bill_money}"/></td>
            <td align="left"></td>
        </tr> 
        </table>
        <div id="maingrid"></div>
