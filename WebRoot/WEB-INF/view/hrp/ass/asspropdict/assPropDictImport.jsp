...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssPropDictFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '产权形式编码', name: 'prop_code', align: 'left',editor:{type:'text'}},
				{ display: '产权形式名称', name: 'prop_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssPropDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
