...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssInspectionFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '巡检ID', name: 'ins_id', align: 'left',editor:{type:'text'}},
				{ display: '巡检编号', name: 'ins_no', align: 'left',editor:{type:'text'}},
				{ display: '巡检名称', name: 'ins_name', align: 'left',editor:{type:'text'}},
				...
				{ display: '科室ID', name: 'dept_id', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssInspection.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
