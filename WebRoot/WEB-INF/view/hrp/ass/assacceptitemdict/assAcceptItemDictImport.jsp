...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAssAcceptItemDictFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '验收项目编码', name: 'accept_item_code', align: 'left',editor:{type:'text'}},
				{ display: '验收项目名称', name: 'accept_item_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssAcceptItemDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
