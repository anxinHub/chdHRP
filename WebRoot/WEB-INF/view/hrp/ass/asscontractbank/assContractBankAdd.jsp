...
<html style="overflow:hidden;">
 ...
 function loadForm(){
    ...
    function loadDict(){
		...
		autocomplete("#bank_emp", "../../../hrp/sys/queryUserDict.do?isCheck=false", "id", "text", true, true);
		
		autocomplete("#delegate_emp", "../../../hrp/sys/queryUserDict.do?isCheck=false", "id", "text", true, true);
     } 
    function this_close(){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="bank_info" type="text" id="bank_info" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="bank_tel" type="text" id="bank_tel" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b><font color="red">*</font></b>银行帐号：</td>
            <td align="left" class="l-table-edit-td"><input name="bank_account" type="text" id="bank_account" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b><font color="red">*</font></b>委托方：</td>
            <td align="left" class="l-table-edit-td"><input name="delegate" type="text" id="delegate" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="delegate_tel" type="text" id="delegate_tel" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b><font color="red">*</font></b>医院信息：</td>
            <td align="left" class="l-table-edit-td"><input name="hos_info" type="text" id="hos_info" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
    ...
    <table align="center" cellpadding="0" cellspacing="0" class="l-table-edit">
        	<tr align="center"> 
        		<td align="center" class="l-table-edit-td"  style="padding-left:20px;"><input class="l-button l-button-test" style="float: right;" type="button" value="保存" onclick="save();"/>
        		</td>
