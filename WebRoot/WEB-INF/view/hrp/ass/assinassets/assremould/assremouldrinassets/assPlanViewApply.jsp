...
<script type="text/javascript">
		...
		grid = $("#maingrid").ligerGrid(
				{
					...
					dataType : 'server',
					usePager : true,
					url : 'queryCheckApSpecialByImport.do?isCheck=false&state=2&record_no=${record_no}',
					width : '100%',
					height : '100%',
					checkbox : true,
					rownumbers : true,
	...
	function openUpdate(obj) {
		...
		parent.$.ligerDialog
				.open({
					url : 'hrp/ass/assremould/assremouldrinassets/assRemouldAspecialUpdatePage.do?isCheck=false&'
							+ param,
