...
<script type="text/javascript">
	...
	function save() {
		...
		if (validateGrid()) {
			ajaxJsonObjectByUrl("saveAssBackRestMainInassets.do", formPara, function(
					responseData) {
			...
			$.ligerDialog
					.confirm(
							...
							function(yes) {
								if (yes) {
									ajaxJsonObjectByUrl(
											"deleteAssBackRestDetailInassets.do",
											{
	...
	function printSet(){
			...
			officeFormTemplate({template_code:"05047",use_id : useId})
	  }
	 ...
	 function printDate(){
		 ...
		 var para={
				...
				template_code:'05047',
				class_name:"com.chd.hrp.ass.serviceImpl.back.rest.AssBackRestInassetsServiceImpl", 
				method_name:"queryAssBackRestInassetsByPrintTemlatePrint",
		...
		ajaxJsonObjectByUrl("queryAssBackRestInassetsState.do?isCheck=false",{ass_back_no:$("#ass_back_no").val(),state:2},function(responseData){
			if (responseData.state == "true") {
