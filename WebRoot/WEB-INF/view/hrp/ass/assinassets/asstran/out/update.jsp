...
<script type="text/javascript">
	...
	function cardSelect(){
		...
		var str = "select * from ASS_OUT_DETAIL_INASSETS p "+
				" left join ass_out_inassets pp "+
		...
		var strr = "select * from ASS_OUT_DETAIL_INASSETS p "+
				  " left join ass_out_inassets pp "+
				  "  on pp.group_id = p.group_id "+
				  " and pp.hos_id = p.hos_id "+
				  " and pp.copy_code = p.copy_code "+
	...
	function save() {
		...
		if (validateGrid()) {
			ajaxJsonObjectByUrl("saveAssOutInassets.do", formPara, function(responseData) {
				...
				.ligerGrid(
						{
							...
							usePager : false,
							width : '100%',
							url : 'queryAssOutDetailInassets.do',
							height : '100%',
							checkbox : true,
							enabledEdit : true,
							alternatingRow : true,
    ...
    function print(){
	    ...
	    var para={
       	...
       	ajaxJsonObjectByUrl("queryState.do?isCheck=false",{out_no:$("#out_no").val()},function (responseData){
       		if(responseData.state=="true"){
...
<body onload="is_addRow()">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
		<tr>
			...
			<td align="left" class="l-table-edit-td"><input name="out_no" value="${out_no }"
