...
<script type="text/javascript">
    ...
    function loadHead(){
		...
		var str = "select * from ass_back_detail_inassets p "+
				  " left join ass_back_inassets pp "+
		...
		url='../../queryAssCardTable.do?isCheck=false&ass_nature=05&use_state=1,2,3,4,5'
    ...
    function loadDict(){
		...
		autocomplete("#ass_id","../../queryAssNoDict.do?isCheck=false&ass_naturs=05","id","text",true,true);
