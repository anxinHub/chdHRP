  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAssBusTypeDict.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='bus_type_code']").val('');
				 $("input[name='bus_type_name']").val('');
				 $("input[name='in_out_type']").val('');
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="bus_type_name" type="text" id="bus_type_name" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
