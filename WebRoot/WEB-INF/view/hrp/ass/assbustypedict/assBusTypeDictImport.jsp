...
<script type="text/javascript">
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '业务类别编码', name: 'bus_type_code', align: 'left',editor:{type:'text'}},
				{ display: '业务类别名称', name: 'bus_type_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchAssBusTypeDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
