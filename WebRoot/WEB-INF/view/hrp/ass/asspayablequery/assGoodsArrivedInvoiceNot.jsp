...
<script type="text/javascript">
    ...
    $(function ()
    {
		...
		autodate("#run_date_beg","YYYY-mm-dd","month_first");

		autodate("#run_date_end","YYYY-mm-dd","month_last");
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '供应商', name: 'ven_name', align: 'left',width : 190
					 		},
                     { display: '序列号', name: 'ass_seq_no', align: 'left',width : 120
					 		},
                     { display: '入库单号', name: 'ass_in_no', align: 'left',width : 120
					 		},
					 { display: '资产用途', name: 'equi_usage_name', align: 'left',width : 120
						 	},
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryGoodsArrivedInvoiceNot.do',delayLoad :true,
