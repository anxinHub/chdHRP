...
<script type="text/javascript">
	...
	function cardSelect(){
		...
		var str = "select * from ASS_TRAN_STORE_DETAIL_OTHER p "+
		" left join ASS_TRAN_STORE_OTHER b on"+
	...
	function save() {
		...
		if (validateGrid()) {
			ajaxJsonObjectByUrl("saveAssTranStoreOther.do", formPara, function(responseData) {
				...
				.ligerGrid(
						{
							...
							usePager : false,
							width : '100%',
							url : 'queryAssTranStoreDetailOther.do',
							height : '97%',
							checkbox : true,
							enabledEdit : true,
							alternatingRow : true,
			...
			$.ligerDialog
					.confirm(
							...
							function(yes) {
								if (yes) {
									ajaxJsonObjectByUrl(
											"deleteAssTranStoreDetailOther.do",
											{
												ParamVo : ParamVo.toString()
											},
											function(responseData) {
