...
<script type="text/javascript">
    ...
    function loadHead(){
		...
		var str = 	"select * from   ASS_TRAN_STORE_DETAIL_other p "+
		  " left join ASS_TRAN_STORE_other pp "+
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					...
					align : 'left',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'../../../queryAssCardTable.do?isCheck=false&ass_nature=04&use_state=1,2,3,4,5'+'&sql='+str
