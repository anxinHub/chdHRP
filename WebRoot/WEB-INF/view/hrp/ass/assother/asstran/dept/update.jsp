...
<script type="text/javascript">
	...
	function cardSelect(){
		...
		var str = "select * from ASS_TRAN_DEPT_DETAIL_OTHER p "+
		  "left join ASS_TRAN_DEPT_OTHER b on"+
	...
	function save() {
		...
		if (validateGrid()) {
			ajaxJsonObjectByUrl("saveAssTranDeptOther.do", formPara, function(responseData) {
				...
				.ligerGrid(
						{
							...
							usePager : false,
							width : '100%',
							url : 'queryAssTranDeptDetailOther.do',
							height : '97%',
							checkbox : true,
							enabledEdit : true,
							alternatingRow : true,
			...
			$.ligerDialog
					.confirm(
							...
							function(yes) {
								if (yes) {
									ajaxJsonObjectByUrl(
											"deleteAssTranDeptDetailOther.do",
											{
