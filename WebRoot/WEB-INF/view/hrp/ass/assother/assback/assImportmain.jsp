...
<script type="text/javascript">
	...
	function save() {
		...
		if (data.length == 0) {
			...
			ajaxJsonObjectByUrl("addAssBackOtherImport.do?isCheck=false", {
			...
			grid = $("#maingrid").ligerGrid(
					{
						...
						dataType : 'server',
						usePager : true,
						url : 'queryAssInMainOther.do?isCheck=false&state=2',
						width : '100%',
						height : '100%',
						checkbox : true,
						rownumbers : true,
	...
	function openUpdate(obj) {
		...
		parent.$.ligerDialog.open({
			...
			width: $(window).width(),
			url: 'hrp/ass/assother/assback/assInMainOtherUpdatePage.do?isCheck=false&'+parm,
