...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
							...
							dataType : 'server',
							usePager : true,
							url : '../tongJiReports/queryAssDepreExpire.do?ass_nature='
									+ liger.get("ass_nature").getValue(),
							width : '100%',
							height : '100%',
							checkbox : true,
							rownumbers : true,
	...
	function exportExcel() {
		...
		if ($("#resultPrint > table > tbody").html() != "") {
			lodopExportExcel("resultPrint", "导出Excel", "资产折旧到期查询.xls", true);
			return;
		}
		...
		ajaxJsonObjectByUrl("queryAssDepreExpire.do?ass_nature="
				+ liger.get("ass_nature").getValue(), exportPara, function(
				responseData) {
	...
	function loadDict() {
		...
		$("#depre_year").ligerTextBox({
			width : 160
		});

		$("#depre_month").ligerTextBox({
			width : 160
		});
