    ...
    <jsp:include page="${path}/resource.jsp">
        ...
        <script>
            ...
            function save() {
            	...
            	ajaxPostData({
                    url: 'updateAssFaultType.do?isCheck=false',
                    data: formData,
                    delayCallback: true,
        ...
        <div class="main">
            <table class="table-layout">
                <tr>
                    ...
                    <td class="ipt">
                        <input name="fau_code" id="fau_code" type="text" style="width:180px;" value="${fau_code}" disabled="disabled" readonly="readonly">
                    </td>
               	</tr>
                <tr>
                    ...
                    <td class="ipt">
                        <input name="fau_name" id="fau_name" type="text" style="width:180px;" value="${fau_name}" >
                    </td>
                </tr>
                 <tr>
