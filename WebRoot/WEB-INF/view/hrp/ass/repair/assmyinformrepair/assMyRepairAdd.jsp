        ...
        $(function () {
        	...
        	eme_status = $("#eme_status").etSelect({
                ...
                loc_code = $("#loc_code").etSelect({
                 ...
                 rep_user = $("#rep_user").etSelect({
                	 url: '../../queryUserDict.do?isCheck=false&user_id='+'${user_id}', 
            ...
            function save() {
            	...
            	//formData.append("files", file.getValues());
                  ajaxPostFormData({
                      url: 'addAssMyRepaor.do?isCheck=false',
                      data: formData,
                      dataType: 'json',
                      success: function (data) { 
        ...
        <div class="center">
            <table class="table-layout">
					...
					<tr>
						...
						<td class="ipt">
							<input id="ass_name" style="width:180px" type="text" disabled="disabled"/>
						</td>
					</tr>
					<tr>
