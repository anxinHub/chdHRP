...
<title>Insert title here</title>
   <jsp:include page="${path}/resource.jsp">
	...
	function update(data, index, value) {
		...
		parmVo.push({ name:'rep_dept' ,value : data.rep_dept})
		console.log(data)
        $.etDialog.open({
            url: 'assRepStaisByRepDeptPaga.do?isCheck=false',
            isMax:true,
            title: '位置',
            btn: ['关闭'],
    ...
    function search() {
        ...
        //加载查询条件
        grid.loadData(parms, 'queryRepCountByRepDeptId.do?isCheck=false');
    }
</script>
</head>
<body>
