        ...
        <script>
            ...
            function loadDict() {
                 rep_user = $("#rep_user").etSelect({
                     url: '../../../ass/queryUserDict.do?isCheck=false',
            ...
            function save() {
            	...
            	formData.push({name:'phone1' , value : $('#phone1').val()})
            	formData.push({name:'phone2' , value : $('#phone2').val()})
        ...
        <div class="main">
            <table class="table-layout">
                ...
                <tr>
                    ...
                    <td class="ipt">
                        <select name="rep_user" id="rep_user" type="text" style="width:180px;" disabled="disabled"></select>
                    </td>
               	</tr>
               <!--  <tr>
                ...
                <tr>
                    ...
                    <td class="ipt">
                        <input name="phone1" id="phone1" style="width:180px;" value="${phone1} " type="text"/>
                    </td>
                </tr> 
                <tr>
                    <td class="label">联系电话：</td>
                    <td class="ipt" >
                        <input name="phone2" id="phone2" style="width:180px;" value="${phone2} " type="text"/>
                    </td>
                </tr>
            </table>
        </div>
