        ...
        <script>
            ...
            function initGrid() {
                ...
                gridObj.dataModel = { // 数据加载的有关属性
                    location: 'remote',
                    url: 'queryMatInvDict.do?isCheck=false',
                    recIndx: 'a'
                };
            ...
            function saveData(value) {
                ...
                formData.push({name:'money',value: $('#money').val()})
        ...
        <div class="main">
            <table class="table-layout">
                ...
                <tr>
                    ...
                    <td class="ipt">
                        <textarea style="width: 350px;height:50px" name="rep_note" id="rep_note" cols="30" rows="10">故障原因及解决方法</textarea>
                    </td>
