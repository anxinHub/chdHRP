  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAssCheckDspecial.do?isCheck=false",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='check_plan_no']").val('');
 ...
 function loadForm(){
    ...
    function loadDict(){
    	 ...
    	 autocomplete("#dept_id", "../../../queryDeptDict.do?isCheck=false", "id",
					"text", true, true, null, false,null);
     } 
    </script>
