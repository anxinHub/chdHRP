...
<script type="text/javascript">
	...
	function save() {
		...
		if (validateGrid()) {
			ajaxJsonObjectByUrl("saveAssOutSpecial.do", formPara, function(responseData) {
	...
	function cardSelect(){
		...
		var str = "select * from ASS_OUT_DETAIL_SPECIAL p "+
				" left join ass_out_special pp "+
		...
		var strr = "select * from ASS_OUT_DETAIL_SPECIAL p "+
				  " left join ass_out_special pp "+
				  "  on pp.group_id = p.group_id "+
				  " and pp.hos_id = p.hos_id "+
				  " and pp.copy_code = p.copy_code "+
				...
				.ligerGrid(
						{
							...
							usePager : false,
							width : '100%',
							url : 'queryAssOutDetailSpecial.do',
							height : '97%',
							checkbox : true,
							enabledEdit : true,
							alternatingRow : true,
