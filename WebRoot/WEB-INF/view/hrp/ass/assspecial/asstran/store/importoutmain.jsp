...
<script type="text/javascript">
    ...
    function query(item){
    	...
    	grid.options.parms.push({name : 'out_store_id',value : '${out_store_id}'});
		grid.options.parms.push({name : 'out_store_no',value : '${out_store_no}'});
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					...
					align : 'left',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'../../../queryAssCardTable.do?isCheck=false&ass_nature=02&use_state=1,2,3,4,5'+'&sql='+str
     					+'&is_dept=0&store_id='+store_id+'&store_no='+store_no,
