...
<script type="text/javascript">
	...
	function save() {
		...
		if (validateGrid()) {
			ajaxJsonObjectByUrl("saveAssTranStoreSpecial.do", formPara, function(responseData) {
	...
	function cardSelect(){
		...
		var str = "select * from ASS_TRAN_STORE_DETAIL_SPECIAL p "+
		" left join ASS_TRAN_STORE_SPECIAL b on"+
				...
				.ligerGrid(
						{
							...
							usePager : false,
							width : '100%',
							url : 'queryAssTranStoreDetailSpecial.do',
							height : '97%',
							checkbox : true,
							enabledEdit : true,
							alternatingRow : true,
			...
			$.ligerDialog
					.confirm(
							...
							function(yes) {
								if (yes) {
									ajaxJsonObjectByUrl(
											"deleteAssTranStoreDetailSpecial.do",
											{
												ParamVo : ParamVo.toString()
											},
											function(responseData) {
