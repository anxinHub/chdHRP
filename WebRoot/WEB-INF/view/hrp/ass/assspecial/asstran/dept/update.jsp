...
<script type="text/javascript">
	...
	function save() {
		...
		if (validateGrid()) {
			ajaxJsonObjectByUrl("saveAssTranDeptSpecial.do", formPara, function(responseData) {
	...
	function cardSelect(){
		...
		var str = "select * from ASS_TRAN_DEPT_DETAIL_SPECIAL p "+
		  "left join ASS_TRAN_DEPT_SPECIAL b on"+
				...
				.ligerGrid(
						{
							...
							usePager : false,
							width : '100%',
							url : 'queryAssTranDeptDetailSpecial.do',
							height : '97%',
							checkbox : true,
							enabledEdit : true,
							alternatingRow : true,
			...
			$.ligerDialog
					.confirm(
							...
							function(yes) {
								if (yes) {
									ajaxJsonObjectByUrl(
											"deleteAssTranDeptDetailSpecial.do",
											{
