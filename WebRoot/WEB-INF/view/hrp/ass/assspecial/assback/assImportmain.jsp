...
<script type="text/javascript">
	...
	function save() {
		...
		if (data.length == 0) {
			...
			ajaxJsonObjectByUrl("addAssBackSpecialImport.do?isCheck=false", {
			...
			grid = $("#maingrid").ligerGrid(
					{
						...
						dataType : 'server',
						usePager : true,
						url : 'queryAssInMainSpecial.do?isCheck=false&state=2',
						width : '100%',
						height : '100%',
						checkbox : true,
						rownumbers : true,
	...
	function openUpdate(obj) {
		...
		parent.parent.$.ligerDialog.open({
			...
			width: $(window).width(),
			url: 'hrp/ass/assspecial/assback/assInMainSpecialUpdatePage.do?isCheck=false&'+parm,
