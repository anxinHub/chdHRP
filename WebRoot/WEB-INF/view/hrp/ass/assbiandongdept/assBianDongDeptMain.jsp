    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '部门名称', name: 'dept_name', align: 'left',width:'20%'
					 		},
					 ...
					 { display: '期末金额', name: 'end_money', align: 'left',width:'20%',
							render : function(rowdata, rowindex,value) {
								 return formatNumber(
	...
	//打印数据
 	function printDate(){
    	...
    	var foots = {
    			rows: [
    				{"cell":4,"value":"制表人:"},
    				{"cell":5,"value":"${user_name}"},
    			]
    		}; 
 		var printPara={
 				title: "变动表(部门)",//标题
 				columns: JSON.stringify(grid.getPrintColumns()),//表头
 				class_name: "com.chd.hrp.ass.service.biandongdept.AssBianDongDeptMainService",
 				method_name: "queryAssBianDongDeptPrint",
 				bean_name: "assBianDongDeptMainService" ,
