...
<script type="text/javascript">
	...
	function loadHead() {
		...
		ajaxJsonObjectByUrl("queryHtcgRecipeType.do?isCheck=false", "", function(
				responseData) {
	...
	function init() {
		...
		ajaxJsonObjectByUrl("initHtcgDrgsDmodel.do?isCheck=false", formPara,
	...
	function save() {
		...
		ajaxJsonObjectByUrl("saveHtcgDrgsDmodel.do?isCheck=false", formPara,
		 ...
		 var data = gridManager.getCheckedRows();
			if (data.length == 0) {
				...
				$.ligerDialog.confirm('确定删除?', function(yes) {
					if (yes) {               
						ajaxJsonObjectByUrl("deleteHtcgDrgsDmodel.do", {
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit">
     <tr>   
		...
		<tr>
			...
			<td align="left" class="l-table-edit-td"><input name="drgs_code" type="text" id="drgs_code" ltype="text"/></td>
			<td align="left"></td>
		</tr>
	</table>
	<div id="maingrid"></div>
