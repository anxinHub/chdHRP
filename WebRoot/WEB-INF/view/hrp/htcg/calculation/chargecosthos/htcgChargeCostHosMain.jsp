...
<script type="text/javascript">
	...
	function configure() {
		$.ligerDialog.open({
			url : '../chargecostdept/htcgChargeCostSchemeRelaPage.do?isCheck=false',
			height : 500,
			width : 900,
			title : '方案对应关系',
			modal : true,
	...
	function init() {
		...
		ajaxJsonObjectByUrl("initHtcgChargeCostHos.do?isCheck=false", formPara,
	...
	function remove(){
		...
		if (data.length == 0) {
			...
			$.ligerDialog.confirm('确定删除?', function(yes) {
				if (yes) {
					ajaxJsonObjectByUrl("deleteHtcgChargeCostHos.do", {
...
<body style="padding: 0px; overflow: hidden;">
	...
	<tr>
			...
			<td align="left" class="l-table-edit-td"><input class="Wdate" name="acc_year" style="width: 160px;" type="text" id="acc_year" ltype="text" 
			...
			<td align="left" class="l-table-edit-td"><input
				name="period_type_code" type="text" id="period_type_code" ltype="text" onchange="chargePeriodType()" /></td>
			<td align="left"></td>
		</tr>
		<tr>
			...
			<td align="left" class="l-table-edit-td"><input name="charge_item_code" type="text" style="width: 160px;" id="charge_item_code" ltype="text"/></td>
			<td align="left"></td>
		</tr>
	</table>
	<div id="maingrid"></div>
