...
<script type="text/javascript">
	...
	function query() {
		...
		grid.options.parms.push({
			name : 'proj_dept_code',
			value : liger.get("proj_dept_code").getValue()
		});
		grid.options.parms.push({
		...
		grid = $("#maingrid").ligerGrid({
			columns : [ {
				...
				render : function(rowdata, rowindex, value) {
					return formatNumber(rowdata.charge_num, 2, 1);
				}
			}, {
				display : '收费单价',
				name : 'charge_price',
				...
				minWidth : 80,
				render : function(rowdata, rowindex, value) {
					return formatNumber(rowdata.charge_price, 2, 1);
				}
			}, {
				display : '收入',
				name : 'charge_money',
			...
			dataType : 'server',
			usePager : true,
			url : 'queryHtcgChargeCostDept.do',
			width : '100%',
			height : '100%',
			checkbox : true,
			rownumbers : true,
	...
	function configure() {
		$.ligerDialog.open({
			url : 'htcgChargeCostSchemeRelaPage.do?isCheck=false',
			height : 500,
			width : 1200,
			title : '方案对应关系',
			modal : true,
	...
	function init() {
		...
		ajaxJsonObjectByUrl("initHtcgChargeCostDept.do?isCheck=false", formPara,
		...
		if (data.length == 0) {
			...
			$(data).each(function() {
				ParamVo.push(this.group_id + '@' 
						    ...
						    + this.source_id);//实际代码中temp替换主键
			});
			$.ligerDialog.confirm('确定删除?', function(yes) {
				if (yes) {
					ajaxJsonObjectByUrl("deleteHtcgChargeCostDept.do", {
...
<body style="padding: 0px; overflow: hidden;">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit">
           <tr>
            ...
            <td align="left" class="l-table-edit-td"><input  class="Wdate" name="acc_year"  style="width:160px;" type="text" id="acc_year" ltype="text" onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy'})"/></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="proj_dept_code" type="text" id="proj_dept_code"  style="width:160px;" ltype="text"  /></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">项目名称：</td>
            <td align="left" class="l-table-edit-td"><input name="charge_item_code" type="text" id="charge_item_code" style="width:160px;" ltype="text" /></td>
            <td align="left"></td>
        </tr> 
	</table>
	<div id="maingrid"></div>
