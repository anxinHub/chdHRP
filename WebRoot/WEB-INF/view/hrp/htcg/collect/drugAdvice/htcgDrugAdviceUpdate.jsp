...
<html style="overflow:hidden;">
  <head>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcgDrugAdvice.do",formPara,function(responseData){
    ...
    function loadDict(){
		...
		liger.get("drug_code").setValue('${drug_code}');
	 	liger.get("drug_code").setText('${drug_name}');
		...
		liger.get("recipe_type_code").setValue('${recipe_type_code}');
         ...
         $("#advice_date").ligerTextBox({disabled:true});
         $("#order_by_code").ligerTextBox({disabled:true});
         $("#perform_by_code").ligerTextBox({disabled:true});
