...
<script type="text/javascript">
	...
	function save() {
		var formPara = {
				...
				charge_item_code : liger.get("charge_item_code").getValue(),
				amount : $("#amount").val(),
				price : $("#price").val(),
				recipe_type_code : liger.get("recipe_type_code").getValue(),
				place : $("#place").val()
		};
		ajaxJsonObjectByUrl("updateHtcgMedicalAdvice.do", formPara, function(responseData) {
	...
	function loadDict() {
		...
		liger.get("perform_by_code").setValue('${perform_by_id}.${perform_by_no}');
		liger.get("perform_by_code").setText('${perform_by_name}');
		autocomplete("#charge_item_code","../../base/queryCostChargeItemArrtDict.do?isCheck=false", "id", "text", true,true);
		liger.get("charge_item_code").setValue('${charge_item_code}');
		liger.get("charge_item_code").setText('${charge_item_name}');
...
<body>
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				<td align="left" class="l-table-edit-td" style="padding-left: 20px;">诊疗项目：</td>
				<td align="left" class="l-table-edit-td"><input name="charge_item_code" type="text" id="charge_item_code" ltype="text" validate="{required:true}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
