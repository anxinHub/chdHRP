...
<script type="text/javascript">
	...
	function save() {
		...
		ajaxJsonObjectByUrl("addHtcgMaterialAdvice.do", formPara, function(
				responseData) {
	...
	function loadDict() {
		...
		autocomplete("#mate_code","../../base/queryhtcMaterialDict.do?isCheck=false", "id", "text", true,true);
