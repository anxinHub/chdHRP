...
<html style="overflow:hidden;">
  <head>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcgIcd9Info.do",formPara,function(responseData){
    ...
    function loadDict(){
        ...
        autocomplete("#icd9_code","../../base/queryHtcgIcd9Dict.do?isCheck=false","id","text",true,true);
 		liger.get("icd9_code").setValue('${icd9_code}');
 		liger.get("icd9_code").setText('${icd9_name}'); 
    	autocomplete("#anest_type_code","../../base/queryHtcgAnestTypeDict.do?isCheck=false","id","text",true,true);
  		liger.get("anest_type_code").setValue('${anest_type_code}');
 		liger.get("anest_type_code").setText('${anest_type_name}'); 
       ...
       <table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<td align="left" class="l-table-edit-td" style="padding-left: 20px;">手术时间：</td>
				<td align="left" class="l-table-edit-td"><input class="Wdate" 
					name="icd9_date" type="text" id="icd9_date" ltype="text" value='${icd9_date}' onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd'})" 
					validate="{required:true}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="left" class="l-table-edit-td" style="padding-left: 20px;">手术时长：</td>
				<td align="left" class="l-table-edit-td"><input name="icd9_time" type="text" id="icd9_time" ltype="text" value='${icd9_time}'  validate="{required:true}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="left" class="l-table-edit-td" style="padding-left: 20px;">术者：</td>
				<td align="left" class="l-table-edit-td"><input name="icd9_oper" type="text" id="icd9_oper" ltype="text" value='${icd9_oper}' validate="{required:true}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
			...
			<td align="left" class="l-table-edit-td"><input name="anest_oper" type="text" id="anest_oper" ltype="text" value='${anest_oper}' validate="{required:true}" /></td>
			<td align="left"></td>
			</tr>
		</table>
    </form>
