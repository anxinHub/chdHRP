...
<script type="text/javascript">
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
			...
			dataType : 'server',
			usePager : true,
			url : 'queryHtcgDrugAdviceDgroup.do',
			width : '100%',
			height : '100%',
			checkbox : true,
			rownumbers : true,
	...
	function init() {
		...
		ajaxJsonObjectByUrl("initHtcgDrugAdviceDgroup.do?isCheck=false", formPara,
	...
	function calculate() {
		...
		ajaxJsonObjectByUrl("calculateHtcgDrugAdviceDgroup.do?isCheck=false",
	...
	function admittance() {
		...
		ajaxJsonObjectByUrl("admittanceHtcgDrugAdviceDgroup.do?isCheck=false",
				formPara, function(WorkponseData) {
					if (WorkponseData.state == "true") {
						query();
					}
	...
	function remove(){
		...
		if (data.length == 0) {
			...
			$.ligerDialog.confirm('确定删除?', function(yes) {
				if (yes) {
					ajaxJsonObjectByUrl("deleteHtcgDrugAdviceDgroup.do", {
