...
<script type="text/javascript">
				...
				.ligerGrid(
						{
							...
							dataType : 'server',
							usePager : true,
							url : 'queryHtcgMaterialAdviceStep.do',
							width : '100%',
							height : '100%',
							checkbox : true,
							rownumbers : true,
	...
	function init() {
		...
		ajaxJsonObjectByUrl("initHtcgMaterialAdviceStep.do?isCheck=false",
	...
	function remove(){
		...
		if (data.length == 0) {
			...
			$.ligerDialog.confirm('确定删除?', function(yes) {
				if (yes) {
					ajaxJsonObjectByUrl("deleteHtcgMaterialAdviceStep.do",
							{
...
<body style="padding: 0px; overflow: hidden;">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit">
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="mate_code" style="width:160px;" type="text" id="mate_code" ltype="text" /></td>
            <td align="left"></td>
        </tr>
	</table>
	<div id="maingrid"></div>
