...
<script type="text/javascript">
		...
		grid = $("#maingrid").ligerGrid(
				{
					...
					dataType : 'server',
					usePager : true,
					url : 'queryHtcgSchemeMrSampleData.do',
					width : '100%',
					height : '100%',
					checkbox : true,
					delayLoad:true,
	...
	function init(){
			...
			ajaxJsonObjectByUrl("initHtcgSchemeMrSampleData.do?isCheck=false", formPara, function(WorkponseData) {
	...
	function remove(){
		...
		if (data.length == 0) {
			...
			$.ligerDialog.confirm('确定删除?', function(yes) {
				if (yes) {
					ajaxJsonObjectByUrl("deleteHtcgSchemeMrSampleData.do",
							{
	...
	function loadDict() {
		//字典下拉框
    	 ...
    	 $("#drgs_code").ligerTextBox({width:160});
    	 $("#mr_no").ligerTextBox({width:160});
	}
</script>
</head>
<body style="padding: 0px; overflow: hidden;">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit">
		<tr>
			...
			<td align="left" class="l-table-edit-td"><input name="scheme_code" type="text" id="scheme_code" style="width:160px;" ltype="text"/></td>
			<td align="left"></td>
			...
			<td align="left" class="l-table-edit-td"><input class="Wdate"
				name="acc_year" type="text" id="acc_year" style="width:160px;" ltype="text"
			...
			<td align="left" class="l-table-edit-td"><input name="period_type_code" type="text" id="period_type_code"
				ltype="text"   onchange="chargePeriodType()"/></td>
			<td align="left"></td>
		</tr>
		<tr>
			...
			<td align="left" class="l-table-edit-td"><input name="drgs_code" style="width:160px;"
				type="text" id="drgs_code" ltype="text" /></td>
			<td align="left"></td>
			<td align="right" class="l-table-edit-td" style="padding-left: 20px;">病案号码：</td>
			<td align="left" class="l-table-edit-td"><input name="mr_no" style="width:160px;"
				type="text" id="mr_no" ltype="text" /></td>
			<td align="left"></td>
		</tr>
	</table>
	<div id="maingrid"></div>
