...
<script type="text/javascript">
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
							...
							dataType : 'server',
							usePager : true,
							url : 'queryHtcgDrugAdviceGroup.do',
							width : '100%',
							height : '100%',
							checkbox : true,
							delayLoad : true,
	...
	function init() {
		...
		ajaxJsonObjectByUrl("initHtcgDrugAdviceGroup.do?isCheck=false", formPara,
	   ...
	   var data = gridManager.getCheckedRows();
		if (data.length == 0) {
			...
			$.ligerDialog.confirm('确定删除?', function(yes) {
				if (yes) {
					ajaxJsonObjectByUrl("deleteHtcgDrugAdviceGroup.do", {
...
<body style="padding: 0px; overflow: hidden;">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit">
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input class="Wdate"  name="advice_date" style="width:160px;" type="text" id="advice_date" ltype="text" validate="{required:true,maxlength:20}" onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd'})"/></td>
            <td align="left"></td>
            ...
            <td align="left" class="l-table-edit-td"><input name="drug_code" style="width:160px;" type="text" id="drug_code" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
	</table>
	<div id="maingrid"></div>
