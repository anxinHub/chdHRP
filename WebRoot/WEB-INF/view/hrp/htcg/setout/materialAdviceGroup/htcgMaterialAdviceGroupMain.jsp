...
<script type="text/javascript">
				...
				.ligerGrid(
						{
							...
							dataType : 'server',
							usePager : true,
							url : 'queryHtcgMaterialAdviceGroup.do',
							width : '100%',
							height : '100%',
							checkbox : true,
							rownumbers : true,
	...
	function init() {
		...
		ajaxJsonObjectByUrl("initHtcgMaterialAdviceGroup.do?isCheck=false",
	...
	function remove(){
		...
		if (data.length == 0) {
			...
			$.ligerDialog.confirm('确定删除?', function(yes) {
				if (yes) {
					ajaxJsonObjectByUrl("deleteHtcgMaterialAdviceGroup.do",
							{
