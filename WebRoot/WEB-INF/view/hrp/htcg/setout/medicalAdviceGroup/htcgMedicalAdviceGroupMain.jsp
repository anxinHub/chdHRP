...
<script type="text/javascript">
		...
		grid = $("#maingrid").ligerGrid(
						{
							...
							dataType : 'server',
							usePager : true,
							url : 'queryHtcgMedicalAdviceGroup.do',
							width : '100%',
							height : '100%',
							checkbox : true,
							delayLoad : true,
	...
	function init() {
		...
		ajaxJsonObjectByUrl("initHtcgMedicalAdviceGroup.do?isCheck=false",
	...
	function remove(){
		...
		if (data.length == 0) {
			...
			$.ligerDialog.confirm('确定删除?', function(yes) {
				if (yes) {
					ajaxJsonObjectByUrl("deleteHtcgMedicalAdviceGroup.do",
							{
...
<body style="padding: 0px; overflow: hidden;">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit">
       <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="scheme_code" type="text" style="width:160px;" id="scheme_code" ltype="text" /></td>
            <td align="left"></td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input class="Wdate"  name="advice_date" type="text" style="width:160px;" id="advice_date" ltype="text"  onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd'})"/></td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">病种名称：</td>
            <td align="left" class="l-table-edit-td"><input name="drgs_code" type="text" style="width:160px;" id="drgs_code" ltype="text"  /></td>
            <td align="left"></td>
