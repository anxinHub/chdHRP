...
<html style="overflow:hidden;">
  <head>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcgRecipeType.do",formPara,function(responseData){
    ...
    function loadDict(){
        //字典下拉框
    	  $("#recipe_type_code").ligerTextBox({disabled:true}); 
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="recipe_type_code" type="text" id="recipe_type_code" ltype="text"  value="${recipe_type_code}" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">医嘱时效分类名称：</td>
                <td align="left" class="l-table-edit-td"><input name="recipe_type_name" type="text" id="recipe_type_name" ltype="text"  value="${recipe_type_name}" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
