...
<html style="overflow:hidden;">
  <head>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcgClpStepDict.do",formPara,function(responseData){
    ...
    function loadDict(){
        //字典下拉框
        $("#clp_step_code").ligerTextBox({disabled:true}); 
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="clp_step_name" type="text" id="clp_step_name" ltype="text"  value="${clp_step_name}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
