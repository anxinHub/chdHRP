...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addHtcgIdentityType.do",formPara,function(responseData){
            if(responseData.state=="true"){
				 $("input[name='identity_code']").val('');
				 $("input[name='identity_name']").val('');
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="identity_code" type="text" id="identity_code" ltype="text" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">医保类型名称：</td>
                <td align="left" class="l-table-edit-td"><input name="identity_name" type="text" id="identity_name" ltype="text" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
