...
<html style="overflow:hidden;">
  <head>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcgDrugDict.do",formPara,function(responseData){
    ...
    function loadDict(){
        //字典下拉框
        $("#drug_code").ligerTextBox({disabled:true});
    	autocomplete("#drug_type_code","../../base/queryHtcgDrugTypeDict.do?isCheck=false","id","text",true,true);
        liger.get("drug_type_code").setValue("${drug_type_code}");
   		liger.get("drug_type_code").setText("${drug_type_name}");
    	autocomplete("#fac_code","../../base/queryHosFacDict.do?isCheck=false","id","text",true,true);
    	liger.get("fac_code").setValue("${fac_id}.${fac_no}");
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
             <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="drug_code" type="text" id="drug_code" ltype="text"  value="${drug_code}" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">药品名称：</td>
                <td align="left" class="l-table-edit-td"><input name="drug_name" type="text" id="drug_name" ltype="text" value="${drug_name}"  validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="mode_code" type="text" id="mode_code" ltype="text" value="${mode_code}"  validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">计量单位：</td>
                <td align="left" class="l-table-edit-td"><input name="unit_code" type="text" id="unit_code" ltype="text" value="${unit_code}"  validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
