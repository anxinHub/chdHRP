  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addHtcgIcd9.do",formPara,function(responseData){
            if(responseData.state=="true"){
				 $("input[name='icd9_code']").val('');
				 $("input[name='icd9_name']").val('');
				 $("textarea[name='icd9_note']").val('');
                parent.query();
            }
        });
    }
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="icd9_name" type="text" id="icd9_name" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">手术描述：</td>
                <td align="left" class="l-table-edit-td"><textarea name="icd9_note"  id="icd9_note"  cols="30" rows="4"></textarea></td>
                <td align="left"></td>
            </tr> 
        </table>
    </form>
