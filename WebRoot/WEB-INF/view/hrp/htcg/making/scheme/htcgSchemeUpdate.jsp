...
<html style="overflow:hidden;">
  <head>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateHtcgScheme.do?isCheck=false",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><textarea name="scheme_note" cols="30" rows="4" id="scheme_note" ltype="text" >${ scheme_note}</textarea></td>
                <td align="left"></td>
            </tr> 
        </table>
    </form>
