...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateCostEmpBonusDetail.do?isCheck=false",formPara,function(responseData){
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <%for(int i = 0 ; i < list.size(); i ++ ){ %>
	            <tr>
	                ...
	                <td align="left" class="l-table-edit-td"><input name="<%=list.get(i).getBonus_column() %>" type="text" id="<%=list.get(i).getBonus_column() %>" value="<%=request.getAttribute(list.get(i).getBonus_column()) %>" ltype="text" validate="{required:true,maxlength:20}" /></td>
	                <td align="left"></td>
	            </tr> 
            <%} %>
        </table>
