...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateCostChargeKindArrt.do",formPara,function(responseData){
    ...
    function loadDict(){
        ...
        liger.get("income_type_id").setValue('${income_type_id}');
        liger.get("income_type_id").setText('${income_type_name}');
        
		autocomplete("#income_item_id_in","../queryIncomeItemArrt.do?isCheck=false","id","text",true,true);
		liger.get("income_item_id_in").setValue('${income_item_id_in}');
	    liger.get("income_item_id_in").setText('${income_item_name_in}');
	    
		autocomplete("#income_item_id_out","../queryIncomeItemArrt.do?isCheck=false","id","text",true,true);
		liger.get("income_item_id_out").setValue('${income_item_id_out}');
	    liger.get("income_item_id_out").setText('${income_item_name_out}');
	    $("#charge_kind_code").ligerTextBox({ disabled: true });
     }   
    </script>
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="charge_kind_code" disabled="disabled" type="text" id="charge_kind_code" ltype="text"  value="${charge_kind_code}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">收费类别名称：</td>
                <td align="left" class="l-table-edit-td"><input name="charge_kind_name" type="text" id="charge_kind_name" ltype="text"  value="${charge_kind_name}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
             <tr>
