...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readCostEmpTypeAttrFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
				...
				columns : [
							 ...
							 { display: '分类名称', name: 'emp_kind_name', align: 'left',editor:{type:'text'}},
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addBatchCostEmpTypeAttr.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
