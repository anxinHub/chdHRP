...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addCostMedicalTechnologyWork.do",formPara,function(responseData){
            if(responseData.state=="true"){
				$("input[name='dept_code']").val('');
				$("input[name='medical_num']").val('');
                parent.query();
            }
        });
    }
 ...
 function loadForm(){
    ...
    function loadDict(){
    	 ...
    	 var param = {
           ...
           //字典下拉框
   	   autocomplete("#dept_code","../queryDeptDictNo.do?isCheck=false","id","text",true,true,param);
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="medical_num" type="text" id="medical_num" ltype="text" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
        </table>
    </form>
