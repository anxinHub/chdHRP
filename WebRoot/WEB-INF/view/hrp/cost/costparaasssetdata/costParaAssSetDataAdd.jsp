...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addCostParaAssSetData.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function saveCostParaAssSetData(){
        if($("form").valid()){
            save();
        }
   }
...
<tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="total_value" type="text" id="total_value" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
