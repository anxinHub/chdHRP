...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readCostChargeItemArrtFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
				...
				columns : [
							 ...
							 { display: '收费项目编码', name: 'charge_item_code', align: 'left',editor:{type:'text'}},
							 { display: '收费项目名称', name: 'charge_item_name', align: 'left',editor:{type:'text'}},
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addBatchCostChargeItemArrt.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
