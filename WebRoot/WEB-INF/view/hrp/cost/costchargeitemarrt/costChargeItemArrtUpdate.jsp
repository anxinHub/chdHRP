...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateCostChargeItemArrt.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="charge_item_name" type="text" id="charge_item_name" ltype="text"  value="${charge_item_name}" validate="{required:true,maxlength:100}" /></td>
                <td align="left"></td>
            </tr> 
             <tr>
