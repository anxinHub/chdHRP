...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readCostServeItemDictFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
					{
				columns : [
							 { display: '内部服务项目编码', name: 'server_item_code', align: 'left',editor:{type:'text'}},
							 { display: '内部服务项目名称', name: 'server_item_name', align: 'left',editor:{type:'text'}},
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addImportCostServeItemDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
