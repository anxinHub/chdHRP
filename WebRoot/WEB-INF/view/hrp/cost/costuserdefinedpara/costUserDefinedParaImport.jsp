...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readCostUserDefinedParaFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
	...
	grid = $("#maingrid").ligerGrid(
				...
				columns : [
							{ display: '统计年月', name: 'year_month', align: 'left',editor:{type:'text'}},
							 ...
							 { display: '自定义分摊参数编码', name: 'para_code', align: 'left',editor:{type:'text'}},
							 { display: '自定义分摊参数名称', name: 'para_name', align: 'left',editor:{type:'text'}},
							 { display: '统计值', name: 'para_value', align: 'left',editor:{type:'text'}},
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addBatchCostUserDefinedPara.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
