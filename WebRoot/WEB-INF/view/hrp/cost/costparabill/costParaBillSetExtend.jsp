...
<script type="text/javascript">
	...
	function  save(){
	   ...
	   var formPara={
	      ...
	      acc_year_new:$("#end_year_month").val().substring(0,4),
      	
	      acc_month_new:$("#end_year_month").val().substring(4,6),
	       
	    };
	   
	   ajaxJsonObjectByUrl("inheritance.do?isCheck=false",formPara,function(responseData){
