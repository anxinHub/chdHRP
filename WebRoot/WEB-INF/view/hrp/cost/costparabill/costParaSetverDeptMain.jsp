...
<script type="text/javascript">
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
			...
			dataType : 'server',
			usePager : true,
			url : 'queryCostParaServerDeptDict.do?isCheck=false',
			width : '100%',
			height : '100%',
			checkbox : true,
			rownumbers : true,
    ...
    function saveServerDeptDict(){
        ...
        if (data.length == 0){
            ...
            ajaxJsonObjectByUrl("addCostParaServerDept.do?isCheck=false",{ParamVo : ParamVo.toString()},function (responseData){
