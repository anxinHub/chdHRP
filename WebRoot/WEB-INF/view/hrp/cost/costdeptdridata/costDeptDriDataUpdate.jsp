...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateCostDeptDriData.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">科室变更ID：</td>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="dir_amount" type="text" id="dir_amount" ltype="text"  value="${amount}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
        </table>
    </form>
