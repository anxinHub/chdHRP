...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
				...
				columns : [
							 ...
							 { display: '奖金项编码', name: 'bonus_item_code', align: 'left',editor:{type:'text'}},
							 { display: '奖金项名称', name: 'bonus_item_name', align: 'left',editor:{type:'text'}},
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addBatchCostBonusCostRela.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
