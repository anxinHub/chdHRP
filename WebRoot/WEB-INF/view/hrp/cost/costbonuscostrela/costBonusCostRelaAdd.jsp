...
<script type="text/javascript">
     ...
     function  save(){
		...
		var bonus_item_code = liger.get("bonus_item_code").getValue()
        ...
        ajaxJsonObjectByUrl("addCostBonusCostRela.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	bonusitemcodeBox = $("#bonus_item_code").ligerListBox({
			url : '../queryBonusItemArrt.do?isCheck=false',
			valueField : 'id',
			textField : 'text',
			isShowCheckBox : true,
			isMultiSelect : true,
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
           ...
           <tr>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td">奖金项目(不选择为全部)：</td>
