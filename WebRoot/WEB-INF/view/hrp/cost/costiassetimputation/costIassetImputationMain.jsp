...
<script type="text/javascript">	
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostIassetImputation.do',
  ...
  //打印数据
	 function printDate(){
		...
		ajaxJsonObjectByUrl("queryCostIassetImputation.do",printPara,function (responseData){
