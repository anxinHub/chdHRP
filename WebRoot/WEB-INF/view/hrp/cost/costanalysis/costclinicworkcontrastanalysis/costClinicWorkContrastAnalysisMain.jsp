    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
    		 columns: [ 
                       ...
                       { display: '本期',columns:[{
                      	 display: '门诊人次', name: 'clinic_num1', align: 'left'
                       },{
                      	 display: '单位收入', name: 'money1', align: 'left'
                       },{
                      	 display: '单位成本', name: 'amount1', align: 'left'
                       },{
                      	 display: '单位收益', align: 'left',render:function(rowdata){
                      		return rowdata.money1-rowdata.amount1>0?rowdata.money1-rowdata.amount1:'0';
                      	 }
                       }]
  					 },
  					 { display: '上期',columns:[{
                      	 display: '门诊人次', name: 'clinic_num2', align: 'left'
                     },{
                    	 display: '单位收入', name: 'money2', align: 'left'
                     },{
                    	 display: '单位成本', name: 'amount2', align: 'left'
                     },{
                    	 display: '单位收益', align: 'left',render:function(rowdata){
  					 ...
  					 { display: '本期平均',columns:[{
                      	 display: '门诊人次', name: 'clinic_num3', align: 'left'
                     },{
                    	 display: '单位收入', name: 'money3', align: 'left'
                     },{
                    	 display: '单位成本', name: 'amount3', align: 'left'
                     },{
                    	 display: '单位收益', align: 'left',render:function(rowdata){
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostClinicWorkContrastAnalysis.do',
