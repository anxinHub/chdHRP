...
<script type="text/javascript">	
    ...
    function loadHead(){
		...
		ajaxJsonObjectByUrl("../costcompositionanalysis/loadIncomeStructureTitle.do?isCheck=false",null,function (responseData){
			...
			grid = $("#maingrid").ligerGrid({
		          columns: eval("["+columnses+"]"),
		                    dataAction: 'server',dataType: 'server',usePager:true,url:'../costcompositionanalysis/queryExecuteRevenueStructureAnalysis.do?isCheck=false',
  ...
  //打印数据
	 function printDate(){
		...
		ajaxJsonObjectByUrl("../costcompositionanalysis/queryExecuteRevenueStructureAnalysis.do",printPara,function (responseData){
			...
			$.each(responseData.Rows,function(idx,item){ 
				 var trHtml="<tr>";
					 ...
					 var num = formatNumber((item.PRICE_1 / item.PRICE_TOTAL) * 100)
					 trHtml+="<td>" +num+ "%</td>"; 
...
<form name="form1" method="post"  id="form1" >
	...
	<div id="resultPrint" style="display:none">
	   	<table width="100%">
			   	<thead>
				<tr>
					<th width="200"  rowspan="2">科室编码</th>
					<th width="200"  rowspan="2">科室名稱</th>
					<th width="200" colspan="2">門診</th>
					<th width="200" colspan="2">住院</th>
					<th width="200" colspan="2">其他</th>
					<th width="200" colspan="2">門診</th>
				 </tr>
