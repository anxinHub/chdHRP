...
<script type="text/javascript">	
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '住院收入', name: 'hospitalization_income', align: 'left'
					 },
                     { display: '住院床日', name: 'bed_use_day_num', align: 'left'
					 },
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryInpatientVolumeAnalysis.do',
  ...
  //打印数据
	 function printDate(){
		...
		ajaxJsonObjectByUrl("queryInpatientVolumeAnalysis.do",printPara,function (responseData){
			$.each(responseData.Rows,function(idx,item){ 
				 var trHtml="<tr>";
				     //trHtml+="<td>"+item.year_month+"</td>"; 
					 trHtml+="<td>"+item.dept_code+"</td>"; 
					 trHtml+="<td>"+item.dept_name+"</td>"; 
					 trHtml+="<td>"+item.hospitalization_income+"</td>"; 
					 trHtml+="<td>"+item.bed_use_day_num+"</td>"; 
					 trHtml+="<td>"+item.unit_income+"</td>"; 
					 trHtml+="<td>"+item.fixed_cost+"</td>"; 
					 trHtml+="<td>"+item.variable_cost+"</td>"; 
					 trHtml+="<td>"+item.break_even_point+"</td>"; 
					 trHtml+="<td>"+item.break_even_income+"</td>"; 
				 trHtml+="</tr>";
	...
	<div id="resultPrint" style="display:none">
	   	<table width="100%">
				...
				<tr>
					...
					<th width="200">住院收入</th>
					<th width="200">住院床日</th>
