...
<script type="text/javascript">	
		...
		ajaxJsonObjectByUrl("loadIncomeStructureTitle.do?isCheck=false",null,function (responseData){
			...
			grid = $("#maingrid").ligerGrid({
		          columns: eval("["+columnses+"]"),
		                    dataAction: 'server',dataType: 'server',usePager:true,url:'queryExecuteRevenueStructureAnalysis.do',
  ...
  //打印数据
	 function printDate(){
		...
		ajaxJsonObjectByUrl("queryExecuteRevenueStructureAnalysis.do",printPara,function (responseData){
			$.each(responseData.Rows,function(idx,item){ 
				 var trHtml="<tr>";
