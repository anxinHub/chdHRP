...
<script type="text/javascript">	
    	...
    	ajaxJsonObjectByUrl("../costcompositionanalysis/loadIncomeStructureTitle.do?isCheck=false",null,function (responseData){
    		...
    		grid = $("#maingrid").ligerGrid({
    	           columns: eval("["+columnses+"]"),
    	                     dataAction: 'server',dataType: 'server',usePager:true,url:'../costcompositionanalysis/queryBillingRevenueStructureAnalysis.do?isCheck=false',
  ...
  //打印数据
	 function printDate(){
		...
		ajaxJsonObjectByUrl("../costcompositionanalysis/queryBillingRevenueStructureAnalysis.do",printPara,function (responseData){
			$.each(responseData.Rows,function(idx,item){ 
				 var trHtml="<tr>";
