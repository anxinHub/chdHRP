    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
    		 columns: [ 
                       ...
                       { display: '本期',columns:[{
                      	 display: '住院人次', name: 'clinic_num1', align: 'left'
                       },{
  					 ...
  					 { display: '上期',columns:[{
                      	 display: '住院人次', name: 'clinic_num2', align: 'left'
                     },{
  					 ...
  					 { display: '本期平均',columns:[{
                      	 display: '住院人次', name: 'clinic_num3', align: 'left'
                     },{
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostInhosWorkContrastAnalysis.do',
