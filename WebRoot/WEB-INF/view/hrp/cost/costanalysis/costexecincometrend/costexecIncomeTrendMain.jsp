...
<script type="text/javascript">	
    ...
    function loadHead(){
    	...
    	+"{ display: '科室名称', name: 'dept_name', align: 'left'},";
    	 $.post("queryExecIncomeTitle.do?isCheck=false",para,function(data){
			 ...
			 columns=columns+"{ display: '科室收入',columns: ["+colu+"]}";
			    	...
			    	columns: eval("["+columns+"]"),
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostExecIncomeTrend.do?isCheck=false',
