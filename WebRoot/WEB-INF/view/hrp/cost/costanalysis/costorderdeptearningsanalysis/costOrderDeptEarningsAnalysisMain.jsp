...
<script type="text/javascript">	
    ...
    function loadHead(){
    	...
    	+"{ display: '科室名称', name: 'dept_name', align: 'left'},";
    	 $.post("queryCostOrderEarningsTitle.do?isCheck=false",para,function(data){
    	...
    	grid = $("#maingrid").ligerGrid({
    		columns: eval("["+columns+"]"),
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostOrderDeptEarningsAnalysis.do',
