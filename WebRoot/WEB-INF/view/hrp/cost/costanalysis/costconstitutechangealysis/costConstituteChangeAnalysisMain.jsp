...
<script type="text/javascript">	
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
    		 columns: [ 
    					 { display: '年度', name: 'dept_name', align: 'left'
    					 },
                         { display: '科室编码', name: 'year_month', align: 'left'
    					 },
    					 { display: '科室名称', name: 'dept_code', align: 'left'
    					 },
                         { display: '人员经费',columns:[{
                        	 display: '金额', name: 'cost_emp_amount', align: 'left'
                         },{
                        	 display: '占比',align: 'left',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'../costcompositionanalysis/queryCostStructureAnalysis.do?isCheck=false',
