...
<script type="text/javascript">	
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '床日数', name: 'bed_use_day_num', align: 'left'
					 },
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryOnTheBedCostAnalysis.do',
  ...
  //打印数据
	 function printDate(){
		...
		ajaxJsonObjectByUrl("queryOnTheBedCostAnalysis.do",printPara,function (responseData){
			$.each(responseData.Rows,function(idx,item){ 
				 var trHtml="<tr>";
					 trHtml+="<td>"+item.dept_code+"</td>"; 
					 trHtml+="<td>"+item.dept_name+"</td>"; 
					 trHtml+="<td>"+item.bed_use_day_num+"</td>"; 
					 trHtml+="<td>"+item.income_total+"</td>"; 
					 trHtml+="<td>"+item.cost_total+"</td>"; 
					 trHtml+="<td>"+item.profit_total+"</td>"; 
					 trHtml+="<td>"+item.unit_income+"</td>"; 
					 trHtml+="<td>"+item.unit_cost+"</td>"; 
					 trHtml+="<td>"+item.unit_profit+"</td>"; 
				 trHtml+="</tr>";
