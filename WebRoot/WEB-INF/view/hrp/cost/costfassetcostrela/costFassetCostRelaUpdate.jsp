...
<script type="text/javascript">
    ...
    function save(){
         ...
         var formPara={
            ...
            cost_item_code:cost_item
             
          };
        ajaxJsonObjectByUrl("updateCostFassetCostRela.do",formPara,function(responseData){
    ...
    function saveCostFassetCostRela(){
        if($("form").valid()){
            save();
        }
    }
   ...
   <input name="id" type="hidden" id="id" value="${id}"/>
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input disabled="disabled" name="asset_type_code" type="text" id="asset_type_code" ltype="text"  value="${asset_type_name}" validate="{required:true}" /></td>
                <td align="left"></td>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">成本项目：</td>
                <td align="left" class="l-table-edit-td"><input name="cost_item_code" type="text" id="cost_item_code" ltype="text"  value="${cost_item_name}" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
