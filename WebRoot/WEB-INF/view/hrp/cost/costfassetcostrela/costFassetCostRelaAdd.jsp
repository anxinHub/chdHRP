...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addCostFassetCostRela.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	//2016/11/4 lxj 查询末级固定资产分类
    	var is_last = {is_last:'1'};
            //字典下拉框
        autocomplete("#asset_type_code","../queryFassetTypeArrt.do?isCheck=false","id","text",true,true,is_last);
