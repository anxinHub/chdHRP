    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostExecDept.do',
    ...
    function loadDict(){
	    ...
	    function print(){
 	       ...
 	       var printPara={
 	      		...
 	      		class_name: "com.chd.hrp.cost.service.CostExecDeptService",
 	   			method_name: "queryCostExecDeptPrint",
 	   			bean_name: "costExecDeptService",
