...
<script type="text/javascript">
     ...
     function  save(){
         ...
         var formPara={
        	  ...
        	  acc_year:$("#year_month").val().substring(0,4),
       	      ...
       	      end_year:$("#end_year_month").val().substring(0,4),
             	
       	      end_month:$("#end_year_month").val().substring(4,6),

         };

        ajaxJsonObjectByUrl("extendCostDeptPeople.do?isCheck=false",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function saveCostDeptPeopleExtend(){
        if($("form").valid()){
            save();
        }
   }
