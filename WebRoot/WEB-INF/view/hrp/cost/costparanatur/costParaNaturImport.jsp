...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readCostParaNaturFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '分摊性质编码', name: 'para_code', align: 'left',editor:{type:'text'}},
				{ display: '分摊性质名称', name: 'para_name', align: 'left',editor:{type:'text'}},
				{ display: '默认分摊参数', name: 'para_value', align: 'left',editor:{type:'text'}},
				{ display: '分摊级次', name: 'bill_type', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchCostParaNatur.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
