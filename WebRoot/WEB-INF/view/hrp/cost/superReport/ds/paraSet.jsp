...
var dialog = frameElement.dialog; //调用页面的dialog对象(ligerui对象)
  ...
  //修改
    ...
    function getPataJson(){
    	//拼装列表数据其他字段
    	var dictText="";
    	var paraStr="\"col_code\":\""+$("#col_code").val()+"\",\"para_type\":"+$("#para_type").val()+",\"col_name\":\""+$("#col_name").val()+"\",\"col_type\":"+parseInt($("#col_type").val())+",\"col_length\":"+parseInt($("#col_length").val())+",\"is_stop\":0,\"sort_code\":0";
...
<body style="padding: 0px; overflow: hidden;">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit" style="font-size:15px">
        ...
        <tr>
           <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b><font color="red">*</font></b>数据列类型：</td>
           <td align="left" class="l-table-edit-td">
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td">
            	<input name="col_length" type="text" id="col_length" ltype="text" title="单位px"/>
            </td>
        </tr>
	</table>
    </form>
