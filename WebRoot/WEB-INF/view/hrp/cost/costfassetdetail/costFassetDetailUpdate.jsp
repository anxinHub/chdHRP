...
<script type="text/javascript">
	...
	function save() {
		...
		ajaxJsonObjectByUrl("updateCostFassetDetail.do", formPara, function(
				responseData) {
	...
	function loadDict() {
		//字典下拉框
		autocomplete("#dept_code", "../queryDeptDictCodeLast.do?isCheck=false",
				"id", "text", true, true);

		autocomplete("#asset_type_code",
				"../queryFassetTypeArrt.do?isCheck=false", "id", "text", true,
				true);
		...
		liger.get("asset_type_code").setValue("${asset_type_id}");
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input
					...
					disabled="disabled" value="${year_month}"
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="dept_code"
					type="text" id="dept_code" ltype="text" disabled="disabled"
					validate="{required:true}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td"
					style="padding-left: 20px;">资产分类编码：</td>
				<td align="left" class="l-table-edit-td"><input
					name="asset_type_code" type="text" id="asset_type_code" ltype="text"
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input
					name="source_id" type="text" id="source_id" ltype="text"
					disabled="disabled" validate="{required:true}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input
					...
					value="${depre_amount}" validate="{required:true,maxlength:20}" /></td>
				<td align="left"></td>
			</tr>
		</table>
	</form>
