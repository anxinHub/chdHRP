...
<script type="text/javascript">	
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostMaterialImputation.do',
  ...
  //打印数据
	 function printDate(){
		...
		ajaxJsonObjectByUrl("queryCostMaterialImputation.do",printPara,function (responseData){
