...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateCostIassetTypeArrt.do",formPara,function(responseData){
    ...
    */
 		...
 		autocomplete("#supper_code","../queryIassetTypeSupperCode.do?isCheck=false","id","text",true,true,params,'','${supper_code}');
     }   
    </script>
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="asset_type_code" type="hidden" id="asset_type_code" ltype="text"  value="${asset_type_code}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
