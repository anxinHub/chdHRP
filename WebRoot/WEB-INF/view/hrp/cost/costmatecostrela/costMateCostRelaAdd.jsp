...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addCostMateCostRela.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	var is_last = {is_last:'1'};
            //字典下拉框
        autocomplete("#mate_type_code","../queryMateTypeArrt.do?isCheck=false","id","text",true,true,is_last);
