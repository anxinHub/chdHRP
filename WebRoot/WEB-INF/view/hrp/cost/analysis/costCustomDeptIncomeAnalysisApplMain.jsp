...
<script type="text/javascript">
      ...
      function query(){
     	 ...
     	 grid.options.parms.push({name:'appl_dept_code',value:$("#appl_dept").val().split(" ")[0]}); 
     	grid.options.parms.push({name:'income_type',value:liger.get("income_type").getValue()}); 
	       	//加载查询条件
      ...
      function loadDict(){
  		 ...
  		 autocomplete("#appl_dept","../costhrpdeptref/queryCostCustomDept.do?isCheck=false","id","text",true,true);
  		autoCompleteByData("#income_type", [{"id" : "0","text" : "直接收入"	}, {"id" : "1","text" : "间接收入"}],"id", "text", true, true);
		...
		function initGrid(){
				grid =  $("#maingrid").ligerGrid({
			           dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostCustomDeptIncomeAnalysisAppl.do',
		...
		function print(){
	        ...
	        if(grid.getData().length==0){
	    	 ...
	    	 var heads={
	 	       ...
	 	       var printPara={
	 	      		title: "临床科室收入分析构成表(自定义科室)",//标题
	 	      		columns: JSON.stringify(grid.getPrintColumns()),//表头
	 	      		class_name: "com.chd.hrp.cost.service.analysis.AnalysisService",
	 	   			method_name: "queryCostCustomDeptIncomeAnalysisApplPrint",
...
<body style="padding: 0px; overflow: hidden;">
	 ...
	 <table cellpadding="0" cellspacing="0" class="l-table-edit" >
	 	<tr>
           ...
           <td align="right" class="l-table-edit-td"  style="padding-left:20px;">开单科室(自定义)：</td>
           ...
           <td align="left" class="l-table-edit-td"><input name="income_type" type="text" id="income_type" /></td>
