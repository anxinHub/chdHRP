      ...
      function loadDict(){
		...
		function initGrid(){
				grid =  $("#maingrid").ligerGrid({
			           dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostClinicalDeptIncomeAnalysisExec.do',
		...
		function loadColumns(){
			  ...
			  columns = [{ display: '执行科室编码', name: 'exec_dept_code', align: 'left',frozen:true,minWidth:120,
				              render:function(rowdata, rowindex,value) {
					            return rowdata.exec_dept_code==9999?"":rowdata.exec_dept_code
							 }
				          },
		...
		function print(){
	        ...
	        if(grid.getData().length==0){
	    	 ...
	    	 var heads={
	 	       ...
	 	       var printPara={
	 	      		title: "临床科室收入分析构成表(执行科室)",//标题
	 	      		columns: JSON.stringify(grid.getPrintColumns()),//表头
	 	      		class_name: "com.chd.hrp.cost.service.analysis.AnalysisService",
	 	   			method_name: "queryCostClinicalDeptIncomeAnalysisExecPrint",
