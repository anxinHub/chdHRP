    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '门诊收入', name: '', align: 'center',width:'20%',
                    	 columns:[
                    	          {display:'医保收入',name:'t_1',align:'right',formatter:'###,##0.00',
						 			...
						 			{display:'其他收入',name:'t_3',align:'right',formatter:'###,##0.00',
                        			 render : function(rowdata, rowindex,
										value) {
					 ...
					 { display: '住院收入', name: '', align: 'center',width:'20%',
						 columns:[
                    	          {display:'医保收入',name:'t_4',align:'right',formatter:'###,##0.00',
	                    	 			render : function(rowdata, rowindex,
												value) {
						 			...
						 			{display:'其他收入',name:'t_6',align:'right',formatter:'###,##0.00',
                        			 render : function(rowdata, rowindex,
										value) {
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0306.do',
...
//  								{ x: 2, y: 1, rowSpan: 1, colSpan: 1, displayName: "医保收入", name: "t_1", formatter: "#,##0.00",size:90 },
//  								{ x: 3, y: 1, rowSpan: 1, colSpan: 1, displayName: "药品收入" , name: "t_2", formatter: "#,##0.00",size:90 },
//  								{ x: 4, y: 1, rowSpan: 1, colSpan: 1, displayName: "其他收入", name: "t_3", formatter: "#,##0.00",size:90 },
//  								{ x: 5, y: 0, rowSpan: 1, colSpan: 3, displayName: "住院收入" },
//  								{ x: 5, y: 1, rowSpan: 1, colSpan: 1, displayName: "医保收入", name: "t_4", formatter: "#,##0.00",size:90 },
//  								{ x: 6, y: 1, rowSpan: 1, colSpan: 1, displayName: "药品收入" , name: "t_5", formatter: "#,##0.00",size:90 },
//  								{ x: 7, y: 1, rowSpan: 1, colSpan: 1, displayName: "其他收入", name: "t_6", formatter: "#,##0.00",size:90 },
//  					    ],
//  					    rows: res.Rows
//  			   }
