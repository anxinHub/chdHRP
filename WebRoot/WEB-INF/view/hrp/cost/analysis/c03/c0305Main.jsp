    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '收入', name: '', align: 'center',width:'20%',
                    	 columns:[
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0305.do',
...
//  			   var data={
//  					   headers:[
//  								{ x: 0, y: 0, rowSpan: 2, colSpan: 1, displayName: "收入项目", name: "item_name",size:130 },
//  								{ x: 1, y: 0, rowSpan: 2, colSpan: 1, displayName: "行次", name: " " ,size:40},
//  								{ x: 2, y: 0, rowSpan: 1, colSpan: 3, displayName: "收入" },
