		...
		function loadHead(){
			grid =  $("#maingrid").ligerGrid({
		           columns: [
						...
						{ display: '基本数字', name: 'item_code2', minWidth: 60, width: '25%',align:'left' },
						{ display: '单位', name: 'uint_name', minWidth: 60, width: '25%' },
						{ display: '期初值', name: 't_2', minWidth: 60, width: '25%',align:'right',formatter:'###,##0.00',render:function(rowdata){
		            		return formatNumber(rowdata.t_2 ==null ? 0 : rowdata.t_2,2,1);}
						},
						{ display: '期末值', name: 't_3', minWidth: 60, width: '25%',formatter:'###,##0.00',formatter:'###,##0.00',align:'right',
							render:function(rowdata){
		            		return formatNumber(rowdata.t_2 ==null ? 0 : rowdata.t_2,2,1);
		            		}
						}
		                     ], pageSize: 10, 
		           dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0802.do',
		           width: '100%', height: '50%', checkbox: true,rownumbers:true,delayLoad :true,
...
//     	 			   var data={
//     	 					   headers:[
//     	 								{ x: 0, y: 0, rowSpan: 1, colSpan: 1, displayName: "基本数字", name: "item_code2",size:110 },
//     	 								{ x: 1, y: 0, rowSpan: 1, colSpan: 1, displayName: "单位", name: "uint_name",size:90 },
//     	 								{ x: 2, y: 0, rowSpan: 1, colSpan: 1, displayName: "期初值", name: "t_2", formatter: "#,##0.00",size:110 },
//     	 								{ x: 3, y: 0, rowSpan: 1, colSpan: 1, displayName: "期末值", name: "t_3", formatter: "#,##0.00",size:110 },
//     	 					    ],
//     	 					    rows: res.Rows
//     	 			   }
    	 			  
//     	 			   viewPrint(data, "成本控制指标分析");
//     	 		   },
//     	 		   error: function (res) {
//     						console.error(res);
//     					}
