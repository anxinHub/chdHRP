      ...
      function loadDict(){
		...
		function loadHead(){
			grid =  $("#maingrid").ligerGrid({
		           columns: [
						{ display: '基本数字', name:'item_code1',minWidth: 60, width: '25%',align:'left' },
						{ display: '单位', name: 'uint_name', minWidth: 60, width: '25%',align:'center'},
						{ display: '期初值', name: 't_2', minWidth: 60, width: '25%',align:'right',formatter:'###,##0.00',
							render:function(rowdata){
		            		   return formatNumber(rowdata.t_2 ==null ? 0 : rowdata.t_2,2,1);
		            		}
						},
						{ display: '期末值', name: 't_3', minWidth: 60, width: '25%',align:'right',formatter:'###,##0.00',
							render:function(rowdata){
		            		   return formatNumber(rowdata.t_2 ==null ? 0 : rowdata.t_2,2,1);
		            		}
						}
		                     ], pageSize: 10, 
		           dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0801.do',
...
//     	 			   var data={
//     	 					   headers:[
//     	 								{ x: 0, y: 0, rowSpan: 1, colSpan: 1, displayName: "基本数字", name: "item_code1",size:110 },
