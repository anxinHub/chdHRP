      ...
      function loadDict(){
		...
		function initGrid(){
				grid =  $("#maingrid").ligerGrid({
			           dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostClinicalDeptIncomeAnalysis.do',
		...
		function loadColumns(){
			  ...
			  columns = [{ display: '开单科室编码', name: 'appl_dept_code', align: 'left',frozen:true,minWidth:120},
				         ...
				         { display: '执行科室编码', name: 'exec_dept_code', align: 'left',frozen:true,minWidth:120},
	    	 ...
	    	 var heads={
	 	       ...
	 	       var printPara={
	 	      		...
	 	      		class_name: "com.chd.hrp.cost.service.analysis.AnalysisService",
	 	   			method_name: "queryCostClinicalDeptIncomeAnalysisPrint",
