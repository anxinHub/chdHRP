...
<script type="text/javascript">
      ...
      function loadDict(){
  		 ...
  		 autocomplete("#appl_dept","../queryDeptDictCode.do?isCheck=false","id","text",true,true);
  		 autocomplete("#exec_dept","../queryDeptDictCode.do?isCheck=false","id","text",true,true);  
		...
		function initGrid(){
				grid =  $("#maingrid").ligerGrid({
			           dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostDeptIncomeAnalysisAchievementsAppl.do',
		...
		function loadColumns(){
			  ...
			  columns = [{ display: '开单科室编码', name: 'appl_dept_code', align: 'left',frozen:true,minWidth:120,
				         ...
				         {display: '级次', name: 'dept_level', align: 'left',frozen:true,minWidth:120}
					         ]
              var para = {}
		...
		function print(){
	    	 ...
	    	 var heads={
	 	       ...
	 	       var printPara={
	 	      		title: "科室收入分析构成表(绩效开单科室)",//标题
	 	      		columns: JSON.stringify(grid.getPrintColumns()),//表头
	 	      		class_name: "com.chd.hrp.cost.service.analysis.AnalysisService",
	 	   			method_name: "queryCostDeptIncomeAnalysisAchievementsApplPrint",
