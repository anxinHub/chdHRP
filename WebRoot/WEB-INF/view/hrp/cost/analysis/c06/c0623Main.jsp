    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '本期', name: '', align: 'center',
                    	 columns:[
									{display:'医疗收入',name:'t_1',align:'right',formatter:'###,##0.00',
                      				...
                      				{display:'医疗成本',name:'t_2',align:'right',formatter:'###,##0.00',
                      	        	  render : function(rowdata, rowindex,
  												value) {
  									 	return formatNumber(rowdata.t_2,2,1);
  									}},
  									{display:'医疗收益',name:'t_3',align:'right',formatter:'###,##0.00',
                        	        	  render : function(rowdata, rowindex,
    												value) {
                     ...
                     { display: '累计', name: '', align: 'center',
                    	 columns:[
									{display:'医疗收入',name:'t_4',align:'right',formatter:'###,##0.00',
                      				...
                      				{display:'医疗成本',name:'t_5',align:'right',formatter:'###,##0.00',
                      	        	  render : function(rowdata, rowindex,
  												value) {
  									 	return formatNumber(rowdata.t_2,5,1);
  									}},
  									{display:'医疗收益',name:'t_6',align:'right',formatter:'###,##0.00',
                        	        	  render : function(rowdata, rowindex,
    												value) {
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0623.do',
