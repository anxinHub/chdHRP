    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '环比', name: '', align: 'center',
                    	 columns:[
                    	          {display:'医院名称',name:'hos_name_hb',align:'left'},
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0624.do',
