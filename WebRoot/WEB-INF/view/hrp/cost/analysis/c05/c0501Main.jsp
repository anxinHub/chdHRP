    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                    ...
                    /*  { display: '行次', name: 'id', align: 'center',width:'5%'}, */
                     ...
                     { display: '与上年同期比较', name: '', align: 'center',
                    	 columns:[
                    	          {display:'上年同期',name:'',align:'right',columns:[
				                    	          {display:'2',name:'t_2',align:'right',formatter:'###,##0.00',formatter:'###,##0.00',
					                    	 			render : function(rowdata, rowindex,
																value) {
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0501.do',
...
// 		$.ajax({
// 			url: "queryAnalysisC0501.do?isCheck=false",
// 			type: "post",
// 			dataType: "JSON",
// 			data: printPara,
...
// 				var data = {
// 					headers: [
// 						{ x: 0, y: 0, rowSpan: 3, colSpan: 1, displayName: "项目编码", name: "item_code",size:100},
	...
	<div id="maingrid"></div>
		<div id="resultPrint" style="display:none">
	   	<table width="100%">
			   	<thead>
			   	    <tr>
			   	     <th width="200" colspan="4" ></th>
				     <th width="200" colspan="4">与上年同期比较</th>
			   	    </tr>
			   	    <tr>
