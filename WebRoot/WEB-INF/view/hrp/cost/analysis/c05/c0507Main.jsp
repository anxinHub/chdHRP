    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0507.do',
...
// 		$.ajax({
// 			url: "queryAnalysisC0507.do?isCheck=false",
// 			type: "post",
// 			dataType: "JSON",
// 			data: printPara,
