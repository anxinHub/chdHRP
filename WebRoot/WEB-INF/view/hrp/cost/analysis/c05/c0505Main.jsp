    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                    ...
                    /*  { display: '行次', name: '', align: 'center',width:'5%'}, */
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0505.do',
...
// 		$.ajax({
// 			url: "queryAnalysisC0505.do?isCheck=false",
// 			type: "post",
// 			dataType: "JSON",
// 			data: printPara,
...
// 				viewPrint(data, "科室医疗业务成本差异比较分析表");
// 			},
// 			error: function (res) {
// 				console.error(res);
// 			}
