    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                   ...
                   /*   { display: '行次', name: '', align: 'center',width:'5%'}, */
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0513.do',
...
// 		$.ajax({
// 			url: "queryAnalysisC0513.do?isCheck=false",
// 			type: "post",
// 			dataType: "JSON",
// 			data: printPara,
