...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     { display: '成本项目', name: 'item_name', align: 'center'},
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0510.do',
