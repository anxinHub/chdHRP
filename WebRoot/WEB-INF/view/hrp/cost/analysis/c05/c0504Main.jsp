...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     { display: '成本项目', name: 'item_name', align: 'left',width:'10%'},
                    /*  { display: '行次', name: '', align: 'center',width:'5%'}, */
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0504.do',
...
// 			};
// 		$.ajax({
// 			url: "queryAnalysisC0504.do?isCheck=false",
// 			type: "post",
// 			dataType: "JSON",
// 			data: printPara,
...
// 					headers: [
// 						{ x: 0, y: 0, rowSpan: 3, colSpan: 1, displayName: "成本项目", name: "item_code",size:150},
// 						{ x: 1, y: 0, rowSpan: 3, colSpan: 1, displayName: "本期",name: 't_1',formatter: "#,##0.00",size:110},
						
// 						{ x: 2, y: 0, rowSpan: 1, colSpan: 3, displayName: "与上年同期比较"},
// 						{ x: 2, y: 1, rowSpan: 1, colSpan: 1, displayName: "上年同期"},
// 						{ x: 3, y: 1, rowSpan: 1, colSpan: 1, displayName: "差异"},
// 						{ x: 4, y: 1, rowSpan: 1, colSpan: 1, displayName: "差异率"},
// 						{ x: 2, y: 2, rowSpan: 1, colSpan: 1, displayName: "2", name: "t_2",formatter: "#,##0.00",size:100},
// 						{ x: 3, y: 2, rowSpan: 1, colSpan: 1, displayName: "3", name: "t_3",formatter: "#,##0.00",size:100},
// 						{ x: 4, y: 2, rowSpan: 1, colSpan: 1, displayName: "4", name: "t_4",formatter: "#,##0.00",size:60},
						
// 						{ x: 5, y: 0, rowSpan: 1, colSpan: 3, displayName: "与上期比较"},
// 						{ x: 5, y: 1, rowSpan: 1, colSpan: 1, displayName: "上期"},
// 						{ x: 6, y: 1, rowSpan: 1, colSpan: 1, displayName: "差异"},
// 						{ x: 7, y: 1, rowSpan: 1, colSpan: 1, displayName: "差异率"},
// 						{ x: 5, y: 2, rowSpan: 1, colSpan: 1, displayName: "5", name: "t_5",formatter: "#,##0.00",size:100},
// 						{ x: 6, y: 2, rowSpan: 1, colSpan: 1, displayName: "6", name: "t_6",formatter: "#,##0.00",size:100},
// 						{ x: 7, y: 2, rowSpan: 1, colSpan: 1, displayName: "7", name: "t_7",formatter: "#,##0.00",size:60},
						
						
// 						{ x: 8, y: 0, rowSpan: 1, colSpan: 3, displayName: "与预算比较"},
// 						{ x: 8, y: 1, rowSpan: 1, colSpan: 1, displayName: "预算"},
// 						{ x: 9, y: 1, rowSpan: 1, colSpan: 1, displayName: "差异"},
// 						{ x: 10, y: 1, rowSpan: 1, colSpan: 1, displayName: "差异率"},
// 						{ x: 8, y: 2, rowSpan: 1, colSpan: 1, displayName: "8", name: "t_8",formatter: "#,##0.00",size:100},
// 						{ x: 9, y: 2, rowSpan: 1, colSpan: 1, displayName: "9", name: "t_9",formatter: "#,##0.00",size:100},
// 						{ x: 10, y: 2, rowSpan: 1, colSpan: 1, displayName: "10", name: "t_10",formatter: "#,##0.00",size:60},
						
// 						{ x: 11, y: 0, rowSpan: 1, colSpan: 3, displayName: "与平均比较"},
// 						{ x: 11, y: 1, rowSpan: 1, colSpan: 1, displayName: "平均"},
// 						{ x: 12, y: 1, rowSpan: 1, colSpan: 1, displayName: "差异"},
// 						{ x: 13, y: 1, rowSpan: 1, colSpan: 1, displayName: "差异率"},
// 						{ x: 11, y: 2, rowSpan: 1, colSpan: 1, displayName: "11", name: "t_11",formatter: "#,##0.00",size:100},
// 						{ x: 12, y: 2, rowSpan: 1, colSpan: 1, displayName: "12", name: "t_12",formatter: "#,##0.00",size:100},
// 						{ x: 13, y: 2, rowSpan: 1, colSpan: 1, displayName: "13", name: "t_13",formatter: "#,##0.00",size:60}
// 					],
// 					rows: res.Rows
// 				}

// 				viewPrint(data, "医院全成本比较分析表");
// 			},
// 			error: function (res) {
// 				console.error(res);
// 			}
