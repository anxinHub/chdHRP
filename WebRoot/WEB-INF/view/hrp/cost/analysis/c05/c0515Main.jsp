...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     { display: '医院', name: '', align: 'center',
                    	 columns:[
									{display:'医院编码',name:'hos_code',align:'left',width:'10%'},
									{display:'医院名称',name:'hos_name',align:'left',width:'10%'}
                    	          ]},
                   /*   { display: '行次', name: '', align: 'center',width:'5%'}, */
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0515.do',
...
//     	var printPara = {
// 			/* 	usePager: true,
// 				acc_year: date.substring(0,4),
// 				acc_month: date.substring(4,6) */
// 				usePager:false,	   		
...
// 		$.ajax({
// 			url: "queryAnalysisC0515.do?isCheck=false",
// 			type: "post",
// 			dataType: "JSON",
// 			data: printPara,
...
// 				var data = {
// 					headers: [
// 						{ x: 0, y: 0, rowSpan: 1, colSpan: 2, displayName: "医院"},
// 						{ x: 0, y: 1, rowSpan: 2, colSpan: 1, displayName: "医院编码", name: "hos_code",size:80 },
// 						{ x: 1, y: 1, rowSpan: 2, colSpan: 1, displayName: "医院名称", name: "hos_name",size:220 },
// 						{ x: 2, y: 0, rowSpan: 3, colSpan: 1, displayName: "本期",name: 't_1',formatter: "#,##0.00",size:110 },
						
// 						{ x: 3, y: 0, rowSpan: 1, colSpan: 3, displayName: "与上期比较"},
// 						{ x: 3, y: 1, rowSpan: 1, colSpan: 1, displayName: "上期"},
...
// 						{ x: 5, y: 2, rowSpan: 1, colSpan: 1, displayName: "4", name: "t_4",formatter: "#,##0.00",size:85 },
						
						
// 						{ x: 6, y: 0, rowSpan: 1, colSpan: 3, displayName: "与上年同期比较"},
// 						{ x: 6, y: 1, rowSpan: 1, colSpan: 1, displayName: "上年同期"},
