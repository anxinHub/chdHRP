    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0516.do',
...
// 		$.ajax({
// 			url: "queryAnalysisC0516.do?isCheck=false",
// 			type: "post",
// 			dataType: "JSON",
// 			data: printPara,
