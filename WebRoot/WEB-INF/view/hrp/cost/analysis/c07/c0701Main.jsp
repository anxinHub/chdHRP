...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     { display: '门诊科室', name: 'dept_name', align: 'left',width:'20%'},
                    	 ...
                    	 columns:[
                    	          {display:'收入',name:'t_1',align:'right',formatter:'###,##0.00',
									...
									{display:'成本',name:'t_2',align:'right',formatter:'###,##0.00',
                      				...
                      				{display:'诊次数',name:'t_4',align:'right'
                      	        	}
                    	         ]
					 },
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0701.do',
    ...
    function printData(){
    	 ...
    	 $("#resultPrint > table > tbody").empty();
  		...
  		if($("#resultPrint > table > tbody").html()!=""){
  			lodopPrinterTable("resultPrint","开始打印","诊次成本分析",true);
  			return;
  		}
  		//重新查询数据，避免分页导致打印数据不全
  		...
  		ajaxJsonObjectByUrl("queryAnalysisC0701.do",printPara,function (responseData){
...
<body style="padding: 0px; overflow: hidden;">
	...
	<div id="resultPrint" style="display:none">
	   	<table width="100%">
			   	<thead>
			   		<tr>
			   	    <th width="200" rowspan = "2">门诊科室</th>
