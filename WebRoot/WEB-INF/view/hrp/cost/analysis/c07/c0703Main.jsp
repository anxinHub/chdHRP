...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0703.do',
    ...
    function printData(){
    	 ...
    	 $("#resultPrint > table > tbody").empty();
   		...
   		ajaxJsonObjectByUrl("queryAnalysisC0703.do",printPara,function (responseData){
