...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     { display: '住院科室', name: 'dept_name', align: 'left',width:'20%'},
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0702.do',
    ...
    function printData(){
		...
		ajaxJsonObjectByUrl("queryAnalysisC0702.do",printPara,function (responseData){
	...
	<div id="maingrid"></div>
		<div id="resultPrint" style="display:none">
	   	<table width="100%">
			   	<thead>
			   		<tr>
			   	    <th width="200" rowspan = "2">住院科室</th>
