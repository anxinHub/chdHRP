      ...
      $(function(){
		...
		function loadHead(){
			grid =  $("#maingrid").ligerGrid({
		           columns: [
                  { display: '医院编码', name: 'hos_code', minWidth: 60, width: '10%', align: 'left' },
                  { display: '医院名称', name: 'hos_name', minWidth: 60, width: '10%', align: 'left' },
                  { display: '合计', columns:
   	               [
                  ...
                  { display: '固定成本', columns:
		           ...
		           dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0403.do',
...
//    			   var data={
//    					   headers:[
//    								{ x: 0, y: 0, rowSpan: 3, colSpan: 1, displayName: "医院编码", name: "hos_code",size:90 },
//    								{ x: 1, y: 0, rowSpan: 3, colSpan: 1, displayName: "医院名称", name: "hos_name",size:140 },
