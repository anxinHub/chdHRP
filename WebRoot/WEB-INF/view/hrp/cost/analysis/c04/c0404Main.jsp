      ...
      $(function(){
		...
		function loadHead(){
			grid =  $("#maingrid").ligerGrid({
		           columns: [
                  { display: '医院', name: 'CompanyName', minWidth: 60, width: '10%', align: 'left' },
                  { display: '合计', columns:
   	               [
                  ...
                  { display: '固定成本', columns:
		           ...
		           dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0404.do',
