...
{ display: '合计', name: 't_8',align:'right',formatter:'###,##0.00',
		           ...
		           dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0212.do',
