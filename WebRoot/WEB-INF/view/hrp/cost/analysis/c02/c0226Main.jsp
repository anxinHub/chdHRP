      ...
      function loadDict(){
		...
		function loadHead(){
			grid =  $("#maingrid").ligerGrid({
		           columns: [{ display: '收入构成分析表', columns: columns}], pageSize: 10, 
		           dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0226.do',
...
//       			   var data={
//       					   headers:[
//       								{ x: 0, y: 0, rowSpan: 1, colSpan: 4, displayName: "收入构成分析表", name: " " },
//       								{ x: 0, y: 1, rowSpan: 1, colSpan: 1, displayName: "项目名称",name: "item_name",size:130  },
//       								{ x: 1, y: 1, rowSpan: 1, colSpan: 1, displayName: "本期", name: "t_1", formatter: "#,##0.00",size:100  },
//       								{ x: 2, y: 1, rowSpan: 1, colSpan: 1, displayName: "累计", name: "t_2", formatter: "#,##0.00",size:110  },
//       					    ],
//       					    rows: res.Rows
//       			   }
      			  
//       			   viewPrint(data, "收入构成分析表");
//       		   },
//       		   error: function (res) {
//   					console.error(res);
//   				}
