		...
		function loadHead(){
			grid =  $("#maingrid").ligerGrid({
				...
				width : 90
		           ...
		           dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0217.do',
...
//        };
    	...
    	var printPara={
   		...
   		ajaxJsonObjectByUrl("queryAnalysisC0217	.do?isCheck=false", selPara, function (responseData) {
