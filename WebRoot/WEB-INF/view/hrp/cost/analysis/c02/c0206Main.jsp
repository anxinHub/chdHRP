			...
			grid =  $("#maingrid").ligerGrid({
		           columns: [
		               ...
		               { display: '医疗业务成本', columns:
			               [
			                   { display: '金额', name: 't_1', align:'right',formatter:'###,##0.00',
                 	        	  render : function(rowdata, rowindex,
											value) {
								 	return formatNumber(rowdata.t_1,2,1);
								} }, 
			                   { display: '比重', name: 't_2',align:'right',formatter:'###,##0.00',
                  	        	  render : function(rowdata, rowindex,
											value) {
		               ...
		               { display: '医疗成本', columns:
		                   [
		                       { display: '金额', name: 't_3',align:'right',formatter:'###,##0.00',
                 	        	  render : function(rowdata, rowindex,
											value) {
								 	return formatNumber(rowdata.t_3,2,1);
								} }, 
		                       { display: '比重', name: 't_4',align:'right',formatter:'###,##0.00',
                  	        	  render : function(rowdata, rowindex,
											value) {
		                ...
		                { display: '医疗全成本', columns:
		                    [
		                        { display: '金额', name: 't_5',align:'right',formatter:'###,##0.00',
                  	        	  render : function(rowdata, rowindex,
											value) {
								 	return formatNumber(rowdata.t_5,2,1);
								} }, 
		                        { display: '比重', name: 't_6',align:'right',formatter:'###,##0.00',
                  	        	  render : function(rowdata, rowindex,
											value) {
		                 ...
		                 { display: '医院全成本', columns:
		                     [
		                         { display: '金额', name: 't_7',align:'right',formatter:'###,##0.00',
                   	        	  render : function(rowdata, rowindex,
											value) {
								 	return formatNumber(rowdata.t_7,2,1);
								} }, 
		                         { display: '比重', name: 't_8',align:'right',formatter:'###,##0.00',
                  	        	  render : function(rowdata, rowindex,
											value) {
		           ...
		           dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0206.do',
