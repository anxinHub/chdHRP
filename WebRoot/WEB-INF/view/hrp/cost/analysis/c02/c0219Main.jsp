		           ...
		           columns: [
{
	...
	width : 90
		           ...
		           dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0219.do',
...
//        };
       function print(){
    	...
    	var printPara={
   		...
   		ajaxJsonObjectByUrl("queryAnalysisC0219	.do?isCheck=false", selPara, function (responseData) {
