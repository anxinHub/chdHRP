		...
		function loadHead(){
			grid =  $("#maingrid").ligerGrid({
				...
				width : 90
		           ...
		           dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0223.do',
