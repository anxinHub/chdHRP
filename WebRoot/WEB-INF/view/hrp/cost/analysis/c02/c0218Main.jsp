		           ...
		           columns: [
{
	...
	width : 90
		           ...
		           dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0218.do',
...
//        };
    	...
    	var printPara={
   		...
   		ajaxJsonObjectByUrl("queryAnalysisC0218	.do?isCheck=false", selPara, function (responseData) {
