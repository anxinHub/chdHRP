      ...
      function loadDict(){
		...
		function loadHead(){
			grid =  $("#maingrid").ligerGrid({
		           ...
		           dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0229.do',
...
//     			   var data={
//     					   headers:[
//     								{ x: 0, y: 0, rowSpan: 1, colSpan: 5, displayName: "收入构成分析明细表" },
//     								{ x: 0, y: 1, rowSpan: 2, colSpan: 1, displayName: "科室编码",name: "hos_code" ,size:100},
//     								{ x: 1, y: 1, rowSpan: 2, colSpan: 1, displayName: "科室名称", name: "hos_name" ,size:120},
//     								{ x: 2, y: 1, rowSpan: 1, colSpan: 3, displayName: "医疗收入", name: "" },
//     								{ x: 2, y: 2, rowSpan: 1, colSpan: 1, displayName: "医保收入", name: "t_1", formatter: "#,##0.00",size:100 },
//     								{ x: 3, y: 2, rowSpan: 1, colSpan: 1, displayName: "药品收入", name: "t_2", formatter: "#,##0.00" ,size:100},
//     								{ x: 4, y: 2, rowSpan: 1, colSpan: 1, displayName: "其他收入", name: "t_3", formatter: "#,##0.00",size:100 },
//     					    ],
//     					    rows: res.Rows
//     			   }
    			  
//     			   viewPrint(data, "收入构成分析明细表");
//     		   },
//     		   error: function (res) {
// 					console.error(res);
// 				}
