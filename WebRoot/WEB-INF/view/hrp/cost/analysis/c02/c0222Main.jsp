		...
		function loadHead(){
			grid =  $("#maingrid").ligerGrid({
				...
				width : 90
		           ...
		           dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0222.do',
...
//        			   var data={
//        					   headers:[
//        								{ x: 0, y: 0, rowSpan: 1, colSpan: 1, displayName: "医院名称", name: "hos_name",size:120   },
