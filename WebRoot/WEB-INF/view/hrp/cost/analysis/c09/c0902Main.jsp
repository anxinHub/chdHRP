...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                    {display:'住院科室',name:'dept_name',align:'left'},
					{display:'实际床日数',name:'t_1',align:'right',type:'int'},
					{ display: '单位收入', name: 't_2', align: 'right',formatter:'###,##0.00',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0902.do',
    ...
    function printData(){
    	 $("#resultPrint > table > tbody").empty();
   		...
   		if($("#resultPrint > table > tbody").html()!=""){
   			lodopPrinterTable("resultPrint","开始打印","住院盈亏平衡分析",true);
   			return;
   		}
   		//重新查询数据，避免分页导致打印数据不全
   		...
   		ajaxJsonObjectByUrl("queryAnalysisC0902.do",printPara,function (responseData){
...
//      			   var data={
//      					   headers:[
//      								{ x: 0, y: 0, rowSpan: 1, colSpan: 1, displayName: "住院科室", name: "dept_name",size:130 },
//      								{ x: 1, y: 0, rowSpan: 1, colSpan: 1, displayName: "实际床日数",name: "t_1", formatter: "#,##0.00",size:110 },
	...
	<div id="maingrid"></div>
		<div id="resultPrint" style="display:none">
	   	<table width="100%">
			   	<thead>
			   	    <tr>
			   	     <th width="200">住院科室</th>
				     <th width="200">实际床日数</th>
