...
<script type="text/javascript">
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					...
					{ display: '单位收入', name: 't_2', align: 'right',formatter:'###,##0.00',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0904.do',
    ...
    function printData(){
 		...
 		ajaxJsonObjectByUrl("queryAnalysisC0904.do",printPara,function (responseData){
