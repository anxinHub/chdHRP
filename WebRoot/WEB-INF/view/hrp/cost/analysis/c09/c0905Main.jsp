...
<script type="text/javascript">
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					...
					{ display: '单位收入', name: 't_2', align: 'right',formatter:'###,##0.00',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0905.do',
    ...
    function printData(){
    	 $("#resultPrint > table > tbody").empty();
  		...
  		ajaxJsonObjectByUrl("queryAnalysisC0905.do",printPara,function (responseData){
...
//   								{ x: 4, y: 0, rowSpan: 1, colSpan: 1, displayName: "医疗收益", name: "t_4", formatter: "#,##0.00",size:110 },
