...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                    {display:'医技科室',name:'dept_name',align:'left'},
					{display:'实际工作量',name:'t_1',align:'right',formatter:'###,##0.00',
					...
					{ display: '单位收入', name: 't_2', align: 'right',formatter:'###,##0.00',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0903.do',
    ...
    function printData(){
    	 $("#resultPrint > table > tbody").empty();
    		...
    		ajaxJsonObjectByUrl("queryAnalysisC0903.do",printPara,function (responseData){
...
//   			   var data={
//   					   headers:[
//   								{ x: 0, y: 0, rowSpan: 1, colSpan: 1, displayName: "医技科室", name: "dept_name",size:130 },
//   								{ x: 1, y: 0, rowSpan: 1, colSpan: 1, displayName: "实际工作量",name: "t_1", formatter: "#,##0.00",size:110 },
...
<body style="padding: 0px; overflow: hidden;">
	...
	<div id="resultPrint" style="display:none">
	   	<table width="100%">
			   	<thead>
			   	    <tr>
			   	     <th width="200">医技科室</th>
				     <th width="200">实际工作量</th>
