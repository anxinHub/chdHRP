...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0109.do',
    ...
    function printData(){
    	 $("#resultPrint > table > tbody").empty();
	 		...
	 		ajaxJsonObjectByUrl("queryAnalysisC0109.do",printPara,function (responseData){
...
//       								{ x: 0, y: 1, rowSpan: 2, colSpan: 1, displayName: "科室编码",name: "dept_code"},
...
//       								{ x: 2, y: 2, rowSpan: 1, colSpan: 1, displayName: "1", name: "t_1", formatter: "#,##0.00",size:80},
//       								{ x: 3, y: 2, rowSpan: 1, colSpan: 1, displayName: "2", name: "t_2", formatter: "#,##0.00",size:90},
...
//       								{ x: 4, y: 2, rowSpan: 1, colSpan: 1, displayName: "3", name: "t_3", formatter: "#,##0.00",size:80},
//       								{ x: 5, y: 2, rowSpan: 1, colSpan: 1, displayName: "4", name: "t_4", formatter: "#,##0.00",size:90},
...
//       								{ x: 6, y: 2, rowSpan: 1, colSpan: 1, displayName: "5", name: "t_5", formatter: "#,##0.00",size:80},
//       								{ x: 7, y: 2, rowSpan: 1, colSpan: 1, displayName: "6", name: "t_6", formatter: "#,##0.00",size:90},
