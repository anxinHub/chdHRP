...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0105.do',
    ...
    function printData(){
   	 ...
   	 $("#resultPrint > table > tbody").empty();
	 		...
	 		ajaxJsonObjectByUrl("queryAnalysisC0105.do",printPara,function (responseData){
...
//   								{ x: 0, y: 1, rowSpan: 2, colSpan: 1, displayName: "医院编码", name: "dept_code" ,size:100},
