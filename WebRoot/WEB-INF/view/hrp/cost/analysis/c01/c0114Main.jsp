...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0114.do',
    ...
    function printData(){
    	...
    	$("#resultPrint > table > tbody").empty();
 		...
 		ajaxJsonObjectByUrl("queryAnalysisC0114.do",printPara,function (responseData){
	...
	<div id="resultPrint" style="display:none">
		<table width="100%">
			   	<thead>
				     ...
				     <th width="100" colspan="2" align="center">医疗业务成本</th>
