...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0103.do',
    ...
    function printData(){
    	 $("#resultPrint > table > tbody").empty();
	 		...
	 		ajaxJsonObjectByUrl("queryAnalysisC0103.do",printPara,function (responseData){
...
//     								{ x: 1, y: 1, rowSpan: 2,colSpan: 1 ,displayName: "科室名称",name: "dept_name",size:130 },
...
//     								{ x: 2, y: 2, rowSpan: 1,colSpan: 1 ,displayName: "1",name: "t_1",size:110},
//     								{ x: 3, y: 2, rowSpan: 1,colSpan: 1 ,displayName: "2",name:"t_2",size:120 },
...
//     								{ x: 4, y: 2, rowSpan: 1,colSpan: 1 ,displayName: "3",name:"t_3",size:110 },
//     								{ x: 5, y: 2, rowSpan: 1,colSpan: 1 ,displayName: "4",name:"t_4",size:120 },
...
//     								{ x: 6, y: 2, rowSpan: 1,colSpan: 1 ,displayName: "5",name:"t_5",size:110 },
//     								{ x: 7, y: 2, rowSpan: 1,colSpan: 1 ,displayName: "6",name:"t_6",size:120 }
//     								],
//     					    rows: res.Rows
//     			   }
//     			   viewPrint(data, "医疗业务收益成本明细表");
//     		   },
//     		   error: function (res) {
//     					console.error(res);
//     				}
