...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '医疗收入(本科开单本科执行)', name: '', align: 'center',width:'20%',
                    	 columns:[
					 ...
					 { display: '直接成本', name: '', align: 'center',width:'20%',
                    	 columns:[
                    	          {display:'本期',name:'',align:'right',columns:[
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0107.do',
    ...
    function printData(){
   	 ...
   	 $("#resultPrint > table > tbody").empty();
	 		...
	 		ajaxJsonObjectByUrl("queryAnalysisC0107.do",printPara,function (responseData){
...
//   								{ x: 2, y: 0, rowSpan: 1, colSpan: 2, displayName: "医疗收入(本科开单本科执行)" },
	...
	<div id="resultPrint" style="display:none">
		<table width="100%">
			   	<thead>
				     ...
				     <th width="100" colspan="2" align="center">医疗收入(本科开单本科执行)</th>
