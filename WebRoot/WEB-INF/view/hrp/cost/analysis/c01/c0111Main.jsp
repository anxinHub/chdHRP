...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '医院全成本', name: '', align: 'center',width:'20%',
                    	 columns:[
                    	          {display:'本期',name:'',align:'right',columns:[
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0111.do',
    ...
    function printData(){
    	...
    	$("#resultPrint > table > tbody").empty();
 		...
 		ajaxJsonObjectByUrl("queryAnalysisC0111.do",printPara,function (responseData){
...
//       								{ x: 0, y: 1, rowSpan: 2, colSpan: 1, displayName: "科室编码",name: "dept_code",size:90},
...
//       								{ x: 4, y: 0, rowSpan: 1, colSpan: 2, displayName: "医院全成本"},
	...
	<div id="resultPrint" style="display:none">
		<table width="100%">
			   	<thead>
				     ...
				     <th width="100" colspan="2" align="center">医院全成本</th>
