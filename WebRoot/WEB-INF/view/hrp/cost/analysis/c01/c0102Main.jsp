...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0102.do',
    ...
    function printData(){
    	 $("#resultPrint > table > tbody").empty();
	 		...
	 		ajaxJsonObjectByUrl("queryAnalysisC0102.do",printPara,function (responseData){
...
//     			   var data={
//     					   headers:[
//     								{ x: 0, y: 0, rowSpan: 3, colSpan: 1, displayName: "项目", name: "item_name",size:120 },
...
//     								{ x:2,y :2,rowSpan:1,colSpan:1,displayName:"1",name:"t_1" ,formatter: "#,##0.00",size:120},
...
//     								{ x:4,y :2,rowSpan:1,colSpan:1,displayName:"3",name:"t_3" ,formatter: "#,##0.00",size:120},
...
//     								{ x:6,y :2,rowSpan:1,colSpan:1,displayName:"5",name:"t_5" ,formatter: "#,##0.00",size:120},
...
//      								{ x:8,y :2,rowSpan:1,colSpan:1,displayName:"7",name:"t_7" ,formatter: "#,##0.00",size:120},
//      								{ x:9,y :2,rowSpan:1,colSpan:1,displayName:"8",name:"t_8" ,formatter: "#,##0.00",size:120}
//     								],
//     					    rows: res.Rows
//     			   }
