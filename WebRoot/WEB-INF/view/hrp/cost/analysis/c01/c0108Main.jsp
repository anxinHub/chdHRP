    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0108.do',
    ...
    function printData(){
    	 ...
    	 $("#resultPrint > table > tbody").empty();
	 		...
	 		if($("#resultPrint > table > tbody").html()!=""){
	 			lodopPrinterTable("resultPrint","开始打印","医疗业务成本收益明细表",true);
	 			return;
	 		}
	 		//重新查询数据，避免分页导致打印数据不全
	 		...
	 		ajaxJsonObjectByUrl("queryAnalysisC0108.do",printPara,function (responseData){
...
//      								{ x: 1, y: 1, rowSpan: 2, colSpan: 1, displayName: "科室名称",name: "dept_name",size:120},
...
//      								{ x: 4, y: 0, rowSpan: 1, colSpan: 2, displayName: "医疗业务成本"},
	...
	<div id="resultPrint" style="display:none">
	   	<table width="100%">
			   	<thead>
				     ...
				     <th width="100" colspan="2" align="center">医疗业务 成本</th>
