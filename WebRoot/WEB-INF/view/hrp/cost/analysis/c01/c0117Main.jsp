    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0117.do',
    ...
    function printData(){
    	...
    	$("#resultPrint > table > tbody").empty();
 		...
 		if($("#resultPrint > table > tbody").html()!=""){
 			lodopPrinterTable("resultPrint","开始打印","医院全成本收益明细表",true);
 			return;
 		}
 		//重新查询数据，避免分页导致打印数据不全
 		...
 		ajaxJsonObjectByUrl("queryAnalysisC0117.do",printPara,function (responseData){
 			$.each(responseData.Rows,function(idx,item){ 
 				 var trHtml="<tr>";
                  trHtml+="<td>"+item.hos_code+"</td>"; 
...
//   								{ x: 0, y: 1, rowSpan: 2, colSpan: 1, displayName: "医院编码", name: "hos_code" ,size:100},
//   								{ x: 1, y: 1, rowSpan: 2, colSpan: 1, displayName: "医院名称", name: "hos_name",size:130  },
  								
//   								{ x: 2, y: 1, rowSpan: 0, colSpan: 2, displayName: "医疗收入" },
...
<body style="padding: 0px; overflow: hidden;">
	...
	<div id="resultPrint" style="display:none">
		<table width="100%">
			   	<thead>
			   	     <tr>
			   	     <th width="100" rowspan="3">医院编码</th>
				     <th width="100" rowspan="3">医院名称</th>
