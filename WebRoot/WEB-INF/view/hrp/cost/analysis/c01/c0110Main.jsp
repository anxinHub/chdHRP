    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 ...
					 { display: '医疗全成本', name: '', align: 'center',width:'20%',
                    	 columns:[
                    	          {display:'本期',name:'',align:'right',columns:[
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0110.do',
    ...
    function printData(){
    	 ...
    	 $("#resultPrint > table > tbody").empty();
	 		...
	 		if($("#resultPrint > table > tbody").html()!=""){
	 			lodopPrinterTable("resultPrint","开始打印","医疗全成本收益明细表",true);
	 			return;
	 		}
	 		//重新查询数据，避免分页导致打印数据不全
	 		...
	 		ajaxJsonObjectByUrl("queryAnalysisC0110.do",printPara,function (responseData){
...
//       			   var data={
//       					   headers:[
//       								{ x: 0, y: 0, rowSpan: 1, colSpan: 2, displayName: "科室"},
//       								{ x: 0, y: 1, rowSpan: 2, colSpan: 1, displayName: "科室编码",name: "dept_code",size:80},
//       								{ x: 1, y: 1, rowSpan: 2, colSpan: 1, displayName: "科室名称",name: "dept_name",size:110},
...
//       								{ x: 2, y: 2, rowSpan: 1, colSpan: 1, displayName: "1", name: "t_1", formatter: "#,##0.00",size:90},
//       								{ x: 3, y: 2, rowSpan: 1, colSpan: 1, displayName: "2", name: "t_2", formatter: "#,##0.00",size:100},
      								
//       								{ x: 4, y: 0, rowSpan: 1, colSpan: 2, displayName: "医疗全成本"},
//       								{ x: 4, y: 1, rowSpan: 1, colSpan: 1, displayName: "本期"},
//       								{ x: 5, y: 1, rowSpan: 1, colSpan: 1, displayName: "累计"},
//       								{ x: 4, y: 2, rowSpan: 1, colSpan: 1, displayName: "3", name: "t_3", formatter: "#,##0.00",size:90},
//       								{ x: 5, y: 2, rowSpan: 1, colSpan: 1, displayName: "4", name: "t_4", formatter: "#,##0.00",size:100},
...
//       								{ x: 6, y: 2, rowSpan: 1, colSpan: 1, displayName: "5", name: "t_5", formatter: "#,##0.00",size:90},
//       								{ x: 7, y: 2, rowSpan: 1, colSpan: 1, displayName: "6", name: "t_6", formatter: "#,##0.00",size:100},
      								
//       					    ],
//       					    rows: res.Rows
//       			   }
      			  
//       			   viewPrint(data, "医疗全成本收益明细表");
//       		   },
//       		   error: function (res) {
//   					console.error(res);
//   				}
	...
	<div id="resultPrint" style="display:none">
		<table width="100%">
			   	<thead>
				     ...
				     <th width="100" colspan="2" align="center">医疗全成本</th>
