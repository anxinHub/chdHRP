...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addCostIassetArrt.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
            ...
            /*2016/10/24:lxj
            	增加条件&is_last=1
            */
    	autocomplete("#asset_type_id","../queryIassetTypeArrt.do?isCheck=false&is_last=1","id","text",true,true);
     } 
    </script>
