...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readCostIassetArrtFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
				...
				columns : [
							 ...
							 { display: '资产原值', name: 'prim_value', align: 'left',editor:{type:'text'}},
							 { display: '启用年月', name: 'start_date', align: 'left',editor:{type:'text'}},
							 { display: '结束年月', name: 'end_date', align: 'left',editor:{type:'text'}},
							 { display: '折旧年限', name: 'dep_year', align: 'left',editor:{type:'text'}},
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addBatchCostIassetArrt.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
