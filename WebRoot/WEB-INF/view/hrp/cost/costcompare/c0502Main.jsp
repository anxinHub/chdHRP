    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                    ...
                    /*  { display: '行次', name: '', align: 'center',width:'5%'}, */
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0502.do?isCheck=false',
...
//     }
       ...
       function printData(){
    	...
    	var printPara={
   		...
   		ajaxJsonObjectByUrl("queryAnalysisC0502	.do?isCheck=false", selPara, function (responseData) {
