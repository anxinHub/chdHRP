    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                    ...
                    /*  { display: '行次', name: '', align: 'center',width:'5%'}, */
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0506.do?isCheck=false',
...
// 		$.ajax({
// 			url: "queryAnalysisC0506.do?isCheck=false",
// 			type: "post",
// 			dataType: "JSON",
// 			data: printPara,
...
// 						{ x: 1, y: 1, rowSpan: 2, colSpan: 1, displayName: "科室名称", name: "dept_name",size:220},
...
//     }
     ...
     function printData(){
    	...
    	var printPara={
   		...
   		ajaxJsonObjectByUrl("queryAnalysisC0506	.do?isCheck=false", selPara, function (responseData) {
