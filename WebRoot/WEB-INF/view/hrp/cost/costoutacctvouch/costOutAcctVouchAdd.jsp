...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addCostOutAcctVouch.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	autocomplete("#dept_id","../queryDeptDictNoLast.do?isCheck=false","id","text",true,true,dept_param);
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
             ...
             <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="source" type="text" id="source" ltype="text"  /></td>
                <td align="left"></td>
            </tr> 
            <tr>
