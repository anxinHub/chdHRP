    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '会计科目编码', name: 'subj_code', align: 'left'},
                     { display: '会计科目名称', name: 'subj_name', align: 'left'},
                     { display: '成本项目编码', name: 'cost_item_code', align: 'left'},
                     { display: '成本项目编码', name: 'cost_item_name', align: 'left'},
                     { display: '金额', name: 'debit', align: 'right',
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'checkCostOutAcctVouch.do?isCheck=false',
