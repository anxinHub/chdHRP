                    	         ...
                    	         { display: '医疗收入', name: '', align: 'center',width:'20%',
                                	 columns:[
                                	          {display:'本期',name:'',align:'right',columns:[
            				                    	          {display:'1',name:'t_1',align:'right',
     ...
     function loadDict(){
       ...
       function print(){
	     ...
	     var heads={
	    		...
	    		"rows": [
		           {"cell":0,"value":"期间："+$("#begin_date").val()+"至"+$("#end_date").val(),"colSpan":"5"} 
	    	]};
	       var printPara={
	      		title: "临床服务类科室医疗收益明细表",//标题
	      		columns: JSON.stringify(grid.getPrintColumns()),//表头
	      		class_name: "com.chd.hrp.cost.service.CostEarningsService", 
	   			method_name: "queryAnalysisC0103print",
	   			bean_name: "costEarningsService", 
