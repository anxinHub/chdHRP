...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readCostParaAssSetFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
				...
				columns : [
							 ...
							 { display: '服务科室编码', name: 'dept_code', align: 'left',editor:{type:'text'}},
							 { display: '服务科室名称', name: 'dept_name', align: 'left',editor:{type:'text'}},
							 { display: '受益科室编码', name: 'server_dept_code', align: 'left',editor:{type:'text'}},
							 { display: '受益科室名称', name: 'server_dept_name', align: 'left',editor:{type:'text'}},
							 ...
							 { display: '分摊参数编码', name: 'para_code', align: 'left',editor:{type:'text'}},
							 { display: '分摊参数名称', name: 'para_name', align: 'left',editor:{type:'text'}}
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addBatchCostParaAssSet.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
