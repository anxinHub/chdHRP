...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readCostIassetDetailFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
				...
				columns : [
							 ...
							 { display: '资产编码', name: 'asset_code', align: 'left',editor:{type:'text'}},
							 { display: '资产名称', name: 'asset_name', align: 'left',editor:{type:'text'}},
							 ...
							 { display: '折旧额', name: 'depre_amount', align: 'left',editor:{type:'text'}}
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addBatchCostIassetDetail.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
