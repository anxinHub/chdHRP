...
<script type="text/javascript">
    ...
    $(function (){
        ...
        listbox1 = $("#listbox_ok").ligerListBox({
			parms : para,
			url : 'queryCostWageMap.do?isCheck=false',
			valueField : 'id',
			textField : 'text',
			isShowCheckBox : true,
			isMultiSelect : true,
        ...
        listbox2 =$("#listbox_no").ligerListBox({
 			parms : para,
			url : 'queryCostWageItemList.do?isCheck=false', 
			valueField : 'id',
			textField : 'text',
			isShowCheckBox : true,
			isMultiSelect : true,
    ...
    var box1 = liger.get("listbox_ok"), box2 = liger.get("listbox_no");
       ...
       var formPara={
        ...
        ajaxJsonObjectByUrl("updateCostWageSchemeSet.do?isCheck=false",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="order_no" type="text" id="order_no" value="${order_no}" validate="{maxlength:4}" /></td>
                <td align="left"></td>
            </tr> 
        </table>
    </form>
