...
<script type="text/javascript">
	...
	var width = 310;
     ...
     function  save(){
        ...
        var formPara={
         ...
         ajaxJsonObjectByUrl("addCostWageSchemeSet.do?isCheck=false",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	$("#order_no").ligerTextBox({width:80});
     } 
    ...
    function changeEmp(){
		...
		para = {
		 ...
		 $("#listbox_ok").ligerListBox({
			parms : para,
			url : 'queryCostWageList.do?isCheck=false',
			valueField : 'id',
			textField : 'text',
			isShowCheckBox : true,
			isMultiSelect : true,
  ...
  <style type="text/css">
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:15px;">方案名称：</td>
                ...
                <!-- 2016/10/27 lxj
                		修改:去掉  validate="{maxlength:6}"
                 -->
                <td align="left" class="l-table-edit-td"><input name="emp_kind_code" type="text" id="emp_kind_code" ltype="text"  onblur="changeEmp();"  /></td>
                <td align="left"></td>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">显示顺序：</td>
                <td align="left" class="l-table-edit-td"><input name="order_no" type="text" id="order_no"  validate="{maxlength:4}" /></td>
                <td align="left"></td>
            </tr> 
        </table>
    </form>
