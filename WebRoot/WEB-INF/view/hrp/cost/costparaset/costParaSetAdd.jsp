...
<html style="overflow:hidden;">
    ...
    <script type="text/javascript">
     ...
     $(function (){
        ...
        loadForm();
         ...
         $("#natur_code").ligerTextBox({width:160});
         $("#type_code").ligerTextBox({width:160});
         $("#para_value").ligerTextBox({width:160});
     });  
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addCostParaSet.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	autocomplete("#natur_code","../queryParaNaturLast.do?isCheck=false","id","text", true, true);
    	autocomplete("#para_value","../queryDeptParaDict.do?isCheck=false","id","text",true,true);
    	autocomplete("#type_code","../queryParaTypeLast.do?isCheck=false","id","text",true,true);
     } 
    </script>
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;">统计年份：</td>
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="para_value" type="text" id="para_value" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
    </table>
    </form>
