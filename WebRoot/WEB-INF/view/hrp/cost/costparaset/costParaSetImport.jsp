...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readCostParaSetFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '统计年份', name: 'acc_year', align: 'left',editor:{type:'text'}},
				{ display: '统计月份', name: 'acc_month', align: 'left',editor:{type:'text'}},
				{ display: '科室性质', name: 'natur_code', align: 'left',editor:{type:'text'}},
				{ display: '分摊类型', name: 'type_code', align: 'left',editor:{type:'text'}},
				{ display: '分摊参数', name: 'para_value', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchCostParaSet.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
