...
<script type="text/javascript">
	...
	function save() {
		...
		ajaxJsonObjectByUrl("updateCostParaSet.do", formPara, function(
				responseData) {
	...
	function loadDict() {
		autocomplete("#natur_code", "../queryParaNaturLast.do?isCheck=false",
				"id", "text", true, true,'', false, '${natur_code}');
		//字典下拉框
		autocomplete("#para_value", "../queryDeptParaDict.do?isCheck=false",
				"id", "text", true, true, '', false, '${para_value}');
		autocomplete("#type_code", "../queryParaTypeLast.do?isCheck=false", "id",
				"text", true, true, '', false, '${type_code}');
...
<body>
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				<td align="right" class="l-table-edit-td"
					style="padding-left: 20px;">分摊性质：</td>
				<td align="left" class="l-table-edit-td"><input
					name="natur_code" type="text" id="natur_code" ltype="text"
					value="${natur_code}" validate="{required:true,maxlength:20}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td"
				...
				<td align="left" class="l-table-edit-td"><input
					...
					value="${type_code}" validate="{required:true,maxlength:20}" /></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td"
					style="padding-left: 20px;">分摊参数：</td>
				<td align="left" class="l-table-edit-td"><input
					name="para_value" type="text" id="para_value" ltype="text"
					value="${para_value}" validate="{required:true,maxlength:20}" /></td>
				<td align="left"></td>
			</tr>
