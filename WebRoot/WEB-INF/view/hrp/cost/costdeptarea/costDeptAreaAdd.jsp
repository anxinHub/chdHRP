...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addCostDeptArea.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
            	$("input[name='year_month']").val('');
				 $("input[name='dept_id']").val('');
				 $("input[name='dept_no']").val('');
				 $("input[name='arear']").val('');
                parent.query();
            }
        });
    }
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="arear" type="text" id="arear" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
