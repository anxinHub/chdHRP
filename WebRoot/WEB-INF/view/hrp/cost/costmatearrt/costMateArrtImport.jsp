...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readCostMateArrtFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
				...
				columns : [
							 ...
							 { display: '材料分类名称', name: 'mate_type_name', align: 'left',editor:{type:'text'}},
							 { display: '型号', name: 'mate_mode', align: 'left',editor:{type:'text'}},
							 { display: '单位', name: 'meas_code', align: 'left',editor:{type:'text'}},
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addBatchCostMateArrt.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
