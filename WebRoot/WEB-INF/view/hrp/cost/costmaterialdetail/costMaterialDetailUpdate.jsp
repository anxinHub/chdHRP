...
<script type="text/javascript">
    ...
    function save(){
        ...
        var formPara={
                ...
                amount:$("#sum_money").val()
        };
        ajaxJsonObjectByUrl("updateCostMaterialDetail.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input disabled="disabled" name="year_month" type="text" id="year_month" ltype="text"  value="${year_month}" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">科室编码：</td>
                <td align="left" class="l-table-edit-td"><input disabled="disabled" name="dept_code" type="text" id="dept_code" ltype="text" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">材料分类编码：</td>
                <td align="left" class="l-table-edit-td"><input disabled="disabled" name="mate_type_code" type="text" id="mate_type_code" ltype="text" onchange="chargematetype()" validate="{required:true}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="sum_money" type="text" id="sum_money" ltype="text"  value="${sum_money}" validate="{required:true,maxlength:30}" /></td>
                <td align="left"></td>
            </tr> 
        </table>
    </form>
