...
,
							...
							dataType : 'server',
							usePager : true,
							url : 'queryCostFLCost.do?isCheck=false',
							width : '100%',
							height : '100%',
							checkbox : true,
							rownumbers : true,
	    	...
	    	var heads={
	 	       ...
	 	       var printPara={
	 	      		...
	 	      		class_name: "com.chd.hrp.cost.service.analysis.AnalysisService", 
	 	   			method_name: "queryCostFLCostprint",
