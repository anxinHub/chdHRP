...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateCostFassetArrt.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input disabled="disabled" name="asset_code" type="text" id="asset_code" ltype="text"  value="${asset_code}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
