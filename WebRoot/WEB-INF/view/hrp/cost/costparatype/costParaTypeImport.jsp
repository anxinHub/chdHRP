...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readCostParaTypeFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '分摊类型编码', name: 'type_code', align: 'left',editor:{type:'text'}},
				{ display: '分摊类型名称', name: 'type_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchCostParaType.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
