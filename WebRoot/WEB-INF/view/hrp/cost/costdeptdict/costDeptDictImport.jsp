...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readCostDeptDictFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
					{
				columns : [
							 { display: '部门编码', name: 'dept_code', align: 'left',editor:{type:'text'}},
							 { display: '部门名称', name: 'dept_name', align: 'left',editor:{type:'text'}},
							 { display: '部门类型编码', name: 'type_code', align: 'left',editor:{type:'text'}},
							 { display: '部门类型名称', name: 'type_name', align: 'left',editor:{type:'text'}},
							 { display: '部门性质编码', name: 'natur_code', align: 'left',editor:{type:'text'}},
							 { display: '部门性质名称', name: 'natur_name', align: 'left',editor:{type:'text'}},
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addBatchCostDeptDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
