...
// 	    	  $.ligerDialog.error("部门性质不能为空");
//     		 return false;
//     	   }
	 
// 	      if(liger.get("out_code").getValue()==""){
// 	    	  $.ligerDialog.error("支出性质不能为空");
// 		   return false;
// 	      }
        var formPara={
        	//is_stop:$("#is_stop").val(),
...
//             is_stock:$("#is_stock").val()  
        ...
        ajaxJsonObjectByUrl("../costdeptdict/addAccDeptAttr.do?isCheck=false",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
            ...
            autocomplete("#type_code","../../acc/queryDeptType.do?isCheck=false","id","text",true,true,'',false);
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        	...
        	<tr>
       		...
       		<tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="para_code" type="text"  id="para_code" ltype="text"/></td>
                <td align="left"></td>
        	</tr>
