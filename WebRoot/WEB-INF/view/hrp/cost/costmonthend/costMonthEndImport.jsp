...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readCostMonthEndFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
					{
				columns : [
							 { display: '会计年度', name: 'acc_year', align: 'left',editor:{type:'text'}},
							 { display: '会计期间', name: 'acc_month', align: 'left',editor:{type:'text'}},
							 { display: '是否月结', name: 'is_end', align: 'left',editor:{type:'text'}}
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addBatchCostMonthEnd.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
