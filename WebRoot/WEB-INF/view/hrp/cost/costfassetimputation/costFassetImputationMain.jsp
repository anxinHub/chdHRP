    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostFassetImputation.do',
  ...
  //打印数据
	 function printDate(){
		...
		if($("#resultPrint > table > tbody").html()!=""){
			lodopPrinterTable("resultPrint","开始打印","材料支出归集",true);
			return;
		}
		...
		ajaxJsonObjectByUrl("queryCostFassetImputation.do",printPara,function (responseData){
	 ...
	 function exportExcel(){
		...
		//有数据直接导出
		if($("#resultPrint > table > tbody").html()!=""){
			lodopExportExcel("resultPrint","导出Excel","材料支出归集.xls",true);
			return;
		}
		...
		ajaxJsonObjectByUrl("queryCostFassetImputation.do",printPara,function (responseData){
			...
			manager.close();
			lodopExportExcel("resultPrint","导出Excel","固定资产折旧归集.xls",true);
	    },true,manager);
		return;
	 }		 
    </script>
