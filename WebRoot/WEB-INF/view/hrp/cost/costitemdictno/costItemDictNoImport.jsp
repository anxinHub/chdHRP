...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readCostItemDictNoFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
				...
				columns : [
							 ...
							 { display: '成本分类ID', name: 'cost_type_id', align: 'left',editor:{type:'text'}},
							 { display: '成本分类变更ID', name: 'cost_type_no', align: 'left',editor:{type:'text'}},
							 ...
							 { display: '变更人', name: 'user_code', align: 'left',editor:{type:'text'}},
							 { display: '变更时间', name: 'create_date', align: 'left',editor:{type:'text'}},
							 { display: '变更原因', name: 'note', align: 'left',editor:{type:'text'}},
							 { display: '0启用，1停用', name: 'is_stop', align: 'left',editor:{type:'text'}},
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addBatchCostItemDictNo.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
