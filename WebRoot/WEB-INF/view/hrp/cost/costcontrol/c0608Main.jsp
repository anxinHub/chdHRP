    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0608.do?isCheck=false',
    ...
    function itemclick(item){ 
     ...
     function print(){
     	...
     	var printPara={
    		...
    		ajaxJsonObjectByUrl("queryAnalysisC0608	.do?isCheck=false", selPara, function (responseData) {
