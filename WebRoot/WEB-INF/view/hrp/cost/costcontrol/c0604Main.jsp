    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0604.do?isCheck=false',
...
function printData(){
    	...
    	var printPara={
   		...
   		ajaxJsonObjectByUrl("queryAnalysisC0604	.do?isCheck=false", selPara, function (responseData) {
