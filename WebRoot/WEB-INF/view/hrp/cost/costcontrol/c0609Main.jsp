    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0609.do?isCheck=false',
...
function print(){
     	...
     	var printPara={
    		...
    		ajaxJsonObjectByUrl("queryAnalysisC0609	.do?isCheck=false", selPara, function (responseData) {
