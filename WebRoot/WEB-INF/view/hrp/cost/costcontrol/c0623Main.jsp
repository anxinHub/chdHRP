    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0623.do?isCheck=false',
    ...
    function printData(){
     ...
     function print(){
      	...
      	var printPara={
     		...
     		ajaxJsonObjectByUrl("queryAnalysisC0623	.do?isCheck=false", selPara, function (responseData) {
