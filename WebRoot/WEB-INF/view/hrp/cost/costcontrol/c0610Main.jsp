    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0610.do?isCheck=false',
...
function print(){
     	...
     	var printPara={
    		...
    		ajaxJsonObjectByUrl("queryAnalysisC0610	.do?isCheck=false", selPara, function (responseData) {
