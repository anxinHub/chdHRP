    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '同比', name: '', align: 'center',
                    	 columns:[
                    	          {display:'科室名称',name:'dept_name',align:'left'},
									{display:'本期',name:'t_1',align:'right',
	                    	        	  render : function(rowdata, rowindex,
													value) {
										 	return formatNumber(rowdata.t_1,2,1);
										}
                      				},
                      				{display:'上年同期',name:'t_2',align:'right',
                      	        	  render : function(rowdata, rowindex,
  												value) {
  									 	return formatNumber(rowdata.t_2,2,1);
  									}},
  									{display:'增长率',name:'t_3',align:'right',
                        	        	  render : function(rowdata, rowindex,
    												value) {
					 ...
					 { display: '环比', name: '', align: 'center',
                    	 columns:[
                    	          {display:'科室名称',name:'dept_name_hb',align:'left'},
									{display:'本期',name:'t_4',align:'right',
	                    	        	  render : function(rowdata, rowindex,
													value) {
										 	return formatNumber(rowdata.t_4,2,1);
										}
                      				},
                      				{display:'上期',name:'t_5',align:'right',
                      	        	  render : function(rowdata, rowindex,
  												value) {
  									 	return formatNumber(rowdata.t_5,2,1);
  									}},
  									{display:'增长率',name:'t_6',align:'right',
                        	        	  render : function(rowdata, rowindex,
    												value) {
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryAnalysisC0605.do?isCheck=false',
...
function printData(){
    	...
    	var printPara={
   		...
   		ajaxJsonObjectByUrl("queryAnalysisC0605	.do?isCheck=false", selPara, function (responseData) {
