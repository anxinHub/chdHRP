...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addCostBusiSourecDict.do",formPara,function(responseData){
            if(responseData.state=="true"){
				 $("input[name='busi_data_source_type']").val('');
				 $("input[name='busi_data_source_code']").val('');
				 $("input[name='busi_data_source_name']").val('');
                parent.query();
            }
        });
    }
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
           ...
           <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="busi_data_source_name" type="text" id="busi_data_source_name" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
        </table>
    </form>
