...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateCostMateTypeArrt.do",formPara,function(responseData){
    ...
    function loadDict(){
	 ...
	 var params = {is_last:'0'};
        //字典下拉框
	 autocomplete("#supper_code","../queryMateTypeSupperCode.do?isCheck=false","id","text",true,true,params,'','${supper_code}');
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="mate_type_code" type="hidden" id="mate_type_code" ltype="text"  value="${mate_type_code}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">材料分类名称：</td>
                <td align="left" class="l-table-edit-td"><input name="mate_type_name" type="text" id="mate_type_name" ltype="text"  value="${mate_type_name}" validate="{required:true,maxlength:100}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">上级编码：</td>
                <td align="left" class="l-table-edit-td"><input name="supper_code" type="text" id="supper_code" ltype="text"  value="${supper_code}" validate="{required:true}"/></td>
                <td align="left"></td>
            </tr> 
            <tr>
