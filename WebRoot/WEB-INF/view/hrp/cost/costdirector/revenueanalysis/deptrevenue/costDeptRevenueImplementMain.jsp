       ...
       function query(){
		...
		function loadHead(){
			grid =  $("#maingrid").ligerGrid({
	           ...
	           dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostDeptRevenueImplement.do?isCheck=false',
	    ...
	    function loadDict(){
	    	  ...
	    	  autocomplete("#exec_dept_code","../../queryDeptDictCode.do?isCheck=false","id","text",true,true);
	    	    ...
	    	    $("#state").ligerComboBox({
	                width : 180,
	                data: [
	                    { text: '本科开单本科医技执行', id: 1 },
	                    { text: '它科开单本科医技执行', id: 2 }
	                ],  
