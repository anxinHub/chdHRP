       ...
       function print(){
	    	...
	    	var heads={
	 	       ...
	 	       var printPara={
	 	      		...
	 	      		class_name: "com.chd.hrp.cost.service.director.CostBreakevenPointAnalysisService",
	 	   			method_name: "queryCostBreakevenPointInhosPrint",
		...
		function loadHead(){
			grid =  $("#maingrid").ligerGrid({
	           ...
	           dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostBreakevenPointInhos.do?isCheck=false',
		...
		function open(obj){
			...
			parent.$.ligerDialog.open({
					...
					height : '500',
					width : '500',
					url : 'hrp/cost/director/breakevenpointanalysis/costBreakevenPointInhosChartMainPage.do?isCheck=false' + parm,
					modal : true,
					showToggle : false,
					showMax : true,
					showMin : true,
		 ...
		 function openCalculation(obj){
				var vo = obj.split("|");
				var parm ='&'+ "year_month_begin="+vo[0] + "&year_month_end="+vo[1] +"&dept_code="+vo[2];
				   $.ligerDialog.open({ url : 'costBreakevenPointInhosCalculationMainPage.do?isCheck=false&' + parm,
					   data:{}, 
					   height: 500,
					   width: 920,
					   title:'测算',
