       ...
       function print(){
	    	...
	    	var heads={
	 	       ...
	 	       var printPara={
	 	      		...
	 	      		class_name: "com.chd.hrp.cost.service.director.CostComprehensiveAnalysisService",
	 	   			method_name: "queryCostDirectPrint",
		...
		function loadHead(){
			grid =  $("#maingrid").ligerGrid({
	        		...
	        		columns:[{
					 ...
					 render: function(rowdata, rowindex, value) {
						 return "<a href=javascript:open('" +
							...
							rowdata.dept_code+ "|" +
							1 +
						  "')>" + formatNumber(rowdata.t_1, 2, 1) + "</a>";
					 }
		           },{
        			  display: '累计',
        			  name: 't_2',
	           ...
	           dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostDirect.do?isCheck=false',
		...
		function open(obj){ 
			var vo = obj.split("|");
			 var parm ='&'+ "year_month_begin="+vo[0] + "&year_month_end="+vo[1] +"&dept_code="+vo[2]+"&state="+vo[3];
			 parent.$.ligerDialog.open({
					title : '本量利分析',
					height : '500',
					width : '500',
					url : 'hrp/cost/director/comprehensiveanalysis/costDirectIncomeKindMainPage.do?isCheck=false' + parm,
					modal : true,
					showToggle : false,
					showMax : true,
					showMin : true,
