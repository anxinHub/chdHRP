      ...
      function loadDict(){
		...
		function loadHead(){
			grid =  $("#maingrid").ligerGrid({
	           ...
	           dataAction: 'server',dataType: 'server',usePager:true,url:'queryCostGeneralMessageProfitInhos.do?isCheck=false',
		...
		function open(obj){
			...
			parent.$.ligerDialog.open({
					...
					height : '500',
					width : '500',
					url : 'hrp/cost/director/comprehensiveanalysis/costGeneralMessageProfitInhosChartMainPage.do?isCheck=false' + parm,
					modal : true,
					showToggle : false,
					showMax : true,
					showMin : true,
		...
		function openCost(obj){
			...
			parent.$.ligerDialog.open({
				...
				height : '500',
				width : '500',
				url : 'hrp/cost/director/comprehensiveanalysis/costGeneralMessageProfitInhosCostMainPage.do?isCheck=false' + parm,
				modal : true,
				showToggle : false,
				showMax : true,
				showMin : true,
