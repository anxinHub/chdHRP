      ...
      function myChargShow(){
    	  ...
    	  var Gdata = [];  //固定成本data
      	  ...
      	  var para={      	   
       	   ...
       	   ajaxJsonObjectByUrl("queryCostGeneralMessageProfit.do?isCheck=false",para,function(responseData){
   				$.each(responseData.Rows,function(i,obj){
			    	   ...
			    	   workload = obj.t_3
			    	   t_workload = obj.t_7
			    	   unit_income_money = obj.t_4
			    	   unit_change_cost = obj.t_5 
			    	   xAxis = obj.t_7
			    	   yAxis = obj.t_8 
   				});	
         ...
         incomedata.push([1,unit_income_money],[t_workload + workload,unit_income_money * (t_workload + workload)]);
           ...
           var obj = {
            		  xAxis:xAxis, //X轴 
            		  yAxis:yAxis, //Y轴
            		  title:'${year_month_begin}' + '--'+'${year_month_end}' + '本量利分析图',  //标题
