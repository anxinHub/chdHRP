...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readCostDeptTypeDictFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
					{
				columns : [
							 { display: '成本类型编码', name: 'cost_type_code', align: 'left',editor:{type:'text'}},
							 { display: '成本类型名称', name: 'cost_type_name', align: 'left',editor:{type:'text'}},
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addBatchCostDeptTypeDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
