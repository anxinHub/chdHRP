...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readCostEmpAttrFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
				...
				columns : [
							 ...
							 { display: '分类编码', name: 'emp_kind_code', align: 'left',editor:{type:'text'}},
							 { display: '职工编码', name: 'emp_code', align: 'left',editor:{type:'text'}},
							 { display: '职工姓名', name: 'emp_name', align: 'left',editor:{type:'text'}},
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addBatchCostEmpAttr.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
