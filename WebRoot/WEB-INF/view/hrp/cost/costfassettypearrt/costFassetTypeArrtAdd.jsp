...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addCostFassetTypeArrt.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
         ...
         //字典下拉框
 	 autocomplete("#supper_code","../queryFassetTypeSupperCode.do?isCheck=false","id","text",true,true,params);
   ...
   <form name="form1" method="post"  id="form1" >
   		<input name="asset_type_id" type="hidden" id="asset_type_id" value=""/>
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="supper_code" type="text" id="supper_code" ltype="text" validate="{required:true,maxlength:100}"/></td>
                <td align="left"></td>
            </tr> 
            <tr>
