...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readCusFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '客户编码', name: 'cus_code', align: 'left',editor:{type:'text'}},
				{ display: '类型编码', name: 'type_code', align: 'left',editor:{type:'text'}},
				{ display: '类型名称', name: 'type_name', align: 'left',editor:{type:'text'}},
				{ display: '客户名称', name: 'cus_name', align: 'left',editor:{type:'text'}},
				/*{ display: '排序号', name: 'sort_code', align: 'left',editor:{type:'text'}},
				 { display: '变更时间', name: 'create_date', align: 'left',editor:{type:'date'}},
				{ display: '变更人', name: 'user_code', align: 'left',editor:{type:'text'}},
				{ display: '原因', name: 'dlog', align: 'left',editor:{type:'text'}}, */
		...
		ajaxJsonObjectByUrl("addImportCus.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
