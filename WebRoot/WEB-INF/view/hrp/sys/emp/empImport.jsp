...
var grid=dialog.get("data").grid;
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(2, "250"); sheet.setText(0, 2, "科室编码或科室名称");
    	sheet.setColumnWidth(3, "250"); sheet.setText(0, 3, "职工分类编码或职工分类名称");
    	sheet.setColumnWidth(4, "250"); sheet.setText(0, 4, "备注");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("importEmp.do?isCheck=false", para, function(responseData){	
