...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readUnitFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '计量编码', name: 'unit_code', align: 'left',editor:{type:'text'}},
				{ display: '计量名称', name: 'unit_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addImportUnit.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
