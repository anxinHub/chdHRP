    ...
    function save(){
        if($("#codeTable").is(':hidden') && $("#nameTable").is(':show')){//名称变更
        	var formPara2 = {
        			...
        			hos_id:'${hos_id}',
        			fac_code:'${fac_code}',
        			fac_name:$("#new_fac_name").val(),
                    is_stop:0,
                    note:$("#note2").val(),
                    dict_type:"1"
            };
        	ajaxJsonObjectByUrl("addFacDict.do",formPara2,function (responseData){
        	...
        	var formPara1 = {
    		        ...
    		        group_id:'${group_id}',
    		        hos_id:'${hos_id}',
    		        fac_code:$("#new_fac_code").val(),
    		        fac_name:'${fac_name}',
    		        is_stop:0,
    		        note:$("#note1").val(),
    		        dict_type:"0"
            };
        	ajaxJsonObjectByUrl("addFacDict.do",formPara1,function (responseData){
        		if(responseData.state=="true"){
        			parent.query();
        		}
     		});
   ...
   <form name="form" method="post"  id="form" >
        <table cellpadding="0" cellspacing="0" id="codeTable" class="l-table-edit" style="display: inline;">
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="fac_code" type="text" disabled="disabled" id="fac_code" ltype="text"  value="${fac_code}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
             <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">新编码：</td>
                <td align="left" class="l-table-edit-td"><input name="new_fac_code" type="text" id="new_fac_code" ltype="text"  /></td>
                <td align="left"></td>
            </tr> 
            <tr>
        ...
        <table cellpadding="0" cellspacing="0" id="nameTable" class="l-table-edit" style="display: none;">
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="fac_name" disabled="disabled" type="text" id="fac_name" ltype="text"  value="${fac_name}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
             <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">新名称：</td>
                <td align="left" class="l-table-edit-td"><input name="new_fac_name"  type="text" id="new_fac_name" ltype="text"  /></td>
                <td align="left"></td>
            </tr> 
           <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">变更原因：</td>
