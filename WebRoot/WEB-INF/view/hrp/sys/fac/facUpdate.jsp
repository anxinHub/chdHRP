...
<script type="text/javascript">
  ...
  //查询
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
              ...
              dataAction: 'server',dataType: 'server',usePager:true,url:'../facdict/queryFacDict.do?isCheck=false&group_id=${group_id}&hos_id=${hos_id}&fac_id=${fac_id}',
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateFac.do",formPara,function(responseData){
