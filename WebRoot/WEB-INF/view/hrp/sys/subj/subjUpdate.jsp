...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateSubj.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="hrp_year" type="text" id="hrp_year" ltype="text"  value="${hrp_year}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="subj_name_all" type="text" id="subj_name_all" ltype="text"  value="${subj_name_all}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">subj_type_code：</td>
                <td align="left" class="l-table-edit-td"><input name="subj_type_code" type="text" id="subj_type_code" ltype="text"  value="${subj_type_code}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">subj_nature_code：</td>
                <td align="left" class="l-table-edit-td"><input name="subj_nature_code" type="text" id="subj_nature_code" ltype="text"  value="${subj_nature_code}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
        </table>
    </form>
