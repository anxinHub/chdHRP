...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addHosUserPerm.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='group_id']").val('');
				 $("input[name='hos_id']").val('');
				 $("input[name='user_id']").val('');
				 $("input[name='perm_code']").val('');
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="perm_code" type="text" id="perm_code" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
