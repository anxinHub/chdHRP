...
<script type="text/javascript">
    ...
    function save(){
        ...
        hos_id:$("#hos_id").val(),
        role_id:$("#role_id").val(),
        perm_code:$("#perm_code").val(),
        mod_code:$("#mod_code").val()
        };
        ajaxJsonObjectByUrl("updateHosRolePerm.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="role_id" type="text" id="role_id" ltype="text"  value="${role_id}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">perm_code：</td>
                <td align="left" class="l-table-edit-td"><input name="perm_code" type="text" id="perm_code" ltype="text"  value="${perm_code}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
