    ...
    function save(){
        if($("#codeTable").is(':hidden') && $("#nameTable").is(':show')){//名称变更
        	var formPara2 = {
        			...
        			hos_id:'${hos_id}',
        			proj_code:'${proj_code}',
        			proj_name:$("#new_proj_name").val(),
                    is_stop:0,
                    note:$("#note2").val(),
                    dictType:1
            };
        	ajaxJsonObjectByUrl("addProjDict.do",formPara2,function (responseData){
        	...
        	var formPara1 = {
    		        ...
    		        group_id:'${group_id}',
    		        hos_id:'${hos_id}',
    		        proj_code:$("#new_proj_code").val(),
    		        proj_name:'${proj_name}',
    		        is_stop:0,
    		        note:$("#note1").val(),
                    dictType:0
            };
        	ajaxJsonObjectByUrl("addProjDict.do",formPara1,function (responseData){
        		if(responseData.state=="true"){
        			parent.query();
        		}
     		});
   ...
   <form name="form" method="post"  id="form" >
        <table cellpadding="0" cellspacing="0" id="codeTable" class="l-table-edit" style="display: inline;">
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="proj_code" type="text" disabled="disabled" id="proj_code" ltype="text"  value="${proj_code}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
             <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">新编码：</td>
                <td align="left" class="l-table-edit-td"><input name="new_proj_code" type="text" id="new_proj_code" ltype="text"  /></td>
                <td align="left"></td>
            </tr> 
            <tr>
        ...
        <table cellpadding="0" cellspacing="0" id="nameTable" class="l-table-edit" style="display: none;">
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="proj_name" disabled="disabled" type="text" id="proj_name" ltype="text"  value="${proj_name}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
             <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">新名称：</td>
                <td align="left" class="l-table-edit-td"><input name="new_proj_name"  type="text" id="new_proj_name" ltype="text"  /></td>
                <td align="left"></td>
            </tr> 
           <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">变更原因：</td>
