...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'querySysPara.do',
    ...
    function add_open(){
    	...
    	if(ParamVo.toString().length >0 ){
    		ajaxJsonObjectByUrl("saveBatchSysPara.do?isCheck=false",{ParamVo : ParamVo.toString()},function (responseData){
	...
	function save(group_id,hos_id,copy_code,para_code,rowindex){
		...
		var formPara = {
		 ...
		 ajaxJsonObjectByUrl("updateSysPara.do",formPara,function(responseData){
	            if(responseData.state=="true"){
	                query();
	            }
	      });
