...
<script src="<%=path%>/lib/json2.js"></script></script>
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateDuty.do",formPara,function(responseData){
    ...
    function loadDict(){
    	...
    	$("#duty_code").ligerTextBox({disabled:true});
     }   
    </script>
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="duty_code" type="text" disabled="disabled" id="duty_code" ltype="text"  value="${duty_code}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
