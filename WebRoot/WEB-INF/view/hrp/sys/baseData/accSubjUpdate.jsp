...
// var dialog = frameElement.dialog; //调用页面的dialog对象(ligerui对象)
    ...
    function loadDict(){
        ...
        if('${isSubjNote}'=='' && '${is_last}'=='1'){
          //科目没有使用,同时为末级科目，可以编辑
          autocomplete("#subj_type_code","../queryAccSubjTypeSelect.do?isCheck=false","id","text",true,true);
          autocomplete("#subj_nature_code","../querySubjNature.do?isCheck=false","id","text",true,true);
          autocomplete("#cur_code","../queryGroupCur.do?isCheck=false","id","text",true,true);
        ...
        liger.get("cur_code").setText("${cur_code}");
        ...
        /* if("${is_pact}" == 1){
        	$("#is_pact").prop("checked",true);
        } */

      //初始化下拉框
      $("#check_type1").ligerComboBox({selectBoxWidth: 178,isShowCheckBox: true,isMultiSelect: true,});

      $("#check_type2").ligerComboBox({selectBoxWidth: 178,isShowCheckBox: true,isMultiSelect: true,});

      $("#check_type3").ligerComboBox({selectBoxWidth: 178,isShowCheckBox: true,isMultiSelect: true,});

      $("#check_type4").ligerComboBox({selectBoxWidth: 178,isShowCheckBox: true,isMultiSelect: true,});
   ...
   <div id="panel1-1" >
         <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td" style="padding-top:5px;"><input name="subj_code" type="text" value="${subj_code }" id="subj_code" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
        ...
        <td align="right" class="l-table-edit-td"  style="padding-left:20px;padding-top:10px;">凭证类型：</td>
            ...
            <tr>
              <td align="right" class="l-table-edit-td" colspan="2" style="padding-left:20px;padding-top:10px;">
                 ...
                 <!--  <input name="is_pact" type="checkbox" id="is_pact"  />是否展示合同 -->
                </td>
            </tr>
           </table>
   </div>
