...
<script type="text/javascript">
     ...
     function  save(){
        ...
        */
        ...
        ajaxJsonObjectByUrl("../../acc/accprojattr/updateAccProjAttr.do",formPara,function(responseData){
 ...
 function loadForm(){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="type_code" type="text" value="${type_name }" disabled="disabled" id="type_code" ltype="text" validate="{required:false,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">项目名称：</td>
                <td align="left" class="l-table-edit-td"><input name="proj_name" type="text" value="${proj_name }" disabled="disabled" id="proj_name" ltype="text" validate="{required:true,maxlength:200}" /></td>
                <td align="left" width="150"></td>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input class="Wdate" name="app_date" value="${app_date }" type="text" id="app_date" ltype="text" validate="{required:false,maxlength:20}" onFocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy'})" /></td>
                <td align="left" width="150"></td>
