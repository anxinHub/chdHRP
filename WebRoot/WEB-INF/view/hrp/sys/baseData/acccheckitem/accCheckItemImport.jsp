...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readAccCheckItemFiles.do?isCheck=false&check_type_id=${check_type_id}",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '核算项编码', name: 'check_item_code', align: 'left',editor:{type:'text'}},
				{ display: '核算项名称', name: 'check_item_name', align: 'left',editor:{type:'text'}},
				{ display: '核算分类编码', name: 'type_code', align: 'left',editor:{type:'text'}},
		...
		switch (item.id)
		{
			...
			ajaxJsonObjectByUrl("addBatchDeptGroupDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
