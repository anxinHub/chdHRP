...
<script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addAccCheckItem.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='check_item_code']").val('');
				 $("input[name='check_item_name']").val('');
				 $("input[name='type_code']").val('');
				 $("input[name='is_stop']").val(0);
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	autocomplete("#type_code","../queryCheckItemType.do?isCheck=false","id","text",true,true,{check_type_id : '${check_type_id}'},false,'',178);
     } 
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="check_item_code" type="text" id="check_item_code" ltype="text" validate="{required:true,maxlength:50}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">核算项名称<font color="red">*</font>:</td>
                <td align="left" class="l-table-edit-td"><input name="check_item_name" type="text" id="check_item_name" ltype="text" validate="{required:true,maxlength:100}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="sort_code" type="text" id="sort_code" ltype="text" disabled value="系统生成" validate="{required:true,maxlength:10}" /></td>
                <td align="left"></td>
            </tr> 
             <tr>
