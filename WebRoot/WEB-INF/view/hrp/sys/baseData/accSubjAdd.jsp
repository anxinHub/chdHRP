...
<script type="text/javascript">
     ...
     $(function (){
		 ...
		 $("#check_type1").ligerComboBox({isShowCheckBox: true,isMultiSelect: true,selectBoxWidth: 178});
    	 $("#check_type2").ligerComboBox({isShowCheckBox: true,isMultiSelect: true,selectBoxWidth: 178});
    	 $("#check_type3").ligerComboBox({isShowCheckBox: true,isMultiSelect: true,selectBoxWidth: 178});
    	 $("#check_type4").ligerComboBox({isShowCheckBox: true,isMultiSelect: true,selectBoxWidth: 178});
     ...
     function  save(){
        ...
        var formPara={
           ...
           subj_type_code:liger.get("subj_type_code").getValue(),
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	autocomplete("#subj_type_code","../queryAccSubjTypeSelect.do?isCheck=false","id","text",true,true,'',false);
        ...
        autocomplete("#cur_code","../queryGroupCur.do?isCheck=false","id","text",true,true,'',true);
        ...
        $("#check1").ligerComboBox({ disabled: false,cancelable: true});
        $("#check2").ligerComboBox({ disabled: true,cancelable: true });
		$("#check3").ligerComboBox({ disabled: true,cancelable: true });
    	$("#check4").ligerComboBox({ disabled: true,cancelable: true });
    	
    	$("#subj_name_all").ligerTextBox({disabled:true});
    	
    	//初始化下拉框
    	$("#check_type1").ligerComboBox({});
    	
        $("#check_type2").ligerComboBox({});
        
		$("#check_type3").ligerComboBox({});
		
    	$("#check_type4").ligerComboBox({});
    ...
    function on_change(){
        $("#subj_code").change(function(){
        	...
        	if(first_str=='1'){
        		//科目类别
            	liger.get("subj_type_code").setValue('01');
     	     ...
     	     //余额方向
        		...
        		//科目类别
            	liger.get("subj_type_code").setValue('02');
     	     ...
     	     //余额方向
        		...
        		//科目类别
            	liger.get("subj_type_code").setValue('03');
        		...
        		//科目类别
            	liger.get("subj_type_code").setValue('04');
        		...
        		//科目类别
            	liger.get("subj_type_code").setValue('05');
     	...
     	$("#check1").change(function(){
     		 ...
     		 if(this.value==""){
     	        ...
     	        liger.get("check4").setValue('');
     	     	...
     	     	$("#check_type2").ligerComboBox({ disabled: true,cancelable: true });
     	     	liger.get("check_type2").setValue('');
     	     	liger.get("check_type2").setText('');
     	     	$("#check_type3").ligerComboBox({ disabled: true,cancelable: true });
     	     	liger.get("check_type3").setValue('');
     	     	liger.get("check_type3").setText('');
     	       	$("#check_type4").ligerComboBox({ disabled: true,cancelable: true });
     	        liger.get("check_type4").setValue('');
     	     	liger.get("check_type4").setText('');
     		 }else{
     			 
     			 $("#check2").ligerComboBox({ disabled: false,cancelable: true });
     	    	 $("#check3").ligerComboBox({ disabled: true,cancelable: true });
     	         $("#check4").ligerComboBox({ disabled: true,cancelable: true });
     	         
     	        $("#check_type2").ligerComboBox({ disabled: false,cancelable: true });
         	...
         	if(this.value==""){
	 	        ...
	 	        liger.get("check_type4").setValue('');
	 	     	liger.get("check_type4").setText('');
	           		...
	           		$("#check3").ligerComboBox({ disabled: false,cancelable: true });
	               	$("#check4").ligerComboBox({ disabled: true,cancelable: true });
	               	
	               	$("#check_type3").ligerComboBox({ disabled: false,cancelable: true });
         	...
         	if(this.value==""){
	 	        ...
	 	        liger.get("check_type4").setValue('');
	 	     	liger.get("check_type4").setText('');
           		...
           		$("#check4").ligerComboBox({ disabled: false,cancelable: true });
           	
           		$("#check_type4").ligerComboBox({ disabled: false,cancelable: true });
   ...
   <div id="panel1-1" >
         <table cellpadding="0" cellspacing="0" class="l-table-edit">
            ...
            <tr>
            	<td align="right" class="l-table-edit-td" colspan="2" style="padding-left:20px;padding-top:10px;">
