...
%>
		...
		<head>
			...
			<script type="text/javascript">
				...
				$(function () {
					...
					ajaxJsonObjectByUrl("../queryAccSubjType.do?isCheck=false", {}, function (responseData) {
						...
						columns: [
							{
								...
								render: function (rowdata, rowindex,
									...
									return "<a href=javascript:openUpdate('" + rowdata.subj_id + "|" + rowdata.group_id + "|" + rowdata.hos_id + "|" + rowdata.copy_code + "|" + rowdata.subj_code + "|" + rowdata.__id + "')>" + rowdata.subj_code + "</a>";
								}                                                
							},
							{
				...
				function add_open() {
					...
					$.ligerDialog.open({
						url: 'accSubjAddPage.do?isCheck=false&subj_type_code=' + subj_type + '&subj_type_name=' + subj_type_name+ '&acc_year='+ $("#acc_year").val(), height: 500, width: 700, title: '添加会计科目', modal: true,
				...
				function downTemplate() {
					...
					location.href = "downTemplateAccSubj.do";
				...
				function openUpdate(obj) {
					...
					$.ligerDialog.open({
						url: 'accSubjUpdatePage.do?isCheck=false&' + parm, data: {}, height: 500, width: 700,
				...
				function extend(obj) {
					...
					$.ligerDialog.open({ url: 'accSubjExtendPage.do?isCheck=false&acc_year='+ $("#acc_year").val(), data: {}, height: 400, width: 500, title: '继承', modal: true, showToggle: false, showMax: false, showMin: false, isResize: true, buttons: [{ text: '确定', onclick: function (item, dialog) { dialog.frame.save(); }, cls: 'l-dialog-btn-highlight' }, { text: '取消', onclick: function (item, dialog) { dialog.close(); } }] });
		...
		var heads={
			...
			var printPara={
				...
				class_name: "com.chd.hrp.sys.service.baseData.SysAccSubjService",
				method_name: "queryAccSubjPrint",
				bean_name: "sysAccSubjService",
		...
		<body style="padding: 0px; overflow: hidden;">
			...
			<table cellpadding="0" cellspacing="0" class="l-table-edit">
				...
				<tr>
					...
					<td align="left" class="l-table-edit-td"><input name="acc_year" type="text" id="acc_year" class="Wdate" onFocus="WdatePicker({isShowClear:false,readOnly:false,dateFmt:'yyyy'})" /></td>
					<td align="left"></td>
