...
function loadHead(){
	grid = $("#maingrid").ligerGrid({
       columns: [ 
                 ...
                 dataAction: 'server',dataType: 'server',usePager:true,url:'../storedict/queryStoreDict.do?isCheck=false,group_id=${group_id}&hos_id=${hos_id}&store_id=${store_id}',
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateStore.do?isCheck=false",formPara,function(responseData){
    ...
    function storeChange(){
    	...
    	$.ligerDialog.open({ url : 'storeChangePage.do?isCheck=false'+param,data:{}, 
