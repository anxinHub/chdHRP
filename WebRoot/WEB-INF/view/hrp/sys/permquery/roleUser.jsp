...
<script type="text/javascript">
    ...
    $(function ()
    {
    	...
    	/* ajaxJsonObjectByUrl("../../sys/hosrole/queryUserByRole.do?param="+param,''function (responseData){
                            		if(responseData.state=="true"){
                            			query();
                            		}
                            	}); */
 		//ajaxJsonObjectByUrl("../../sys/hosrole/queryUserByRole.do?role_id=${role_id}",'',function (responseData){
    ...
    function  query(){
        ...
        //根据表字段进行添加查询条件
    	grid.options.parms.push({name:'user_code',value:liger.get("user_code").getValue().toUpperCase()}); 
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ { display: '用户ID', name: 'user_id', align: 'left'
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'../../sys/hosuser/queryUserByRole.do?isCheck=false&role_id=${role_id}',
