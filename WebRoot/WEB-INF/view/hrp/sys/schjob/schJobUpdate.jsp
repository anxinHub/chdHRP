...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateSchJob.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="job_id" type="text" id="job_id" ltype="text"  value="${job_id}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="table_code" type="text" id="table_code" ltype="text"  value="${table_code}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">job_name：</td>
                <td align="left" class="l-table-edit-td"><input name="job_name" type="text" id="job_name" ltype="text"  value="${job_name}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">job_expression：</td>
                <td align="left" class="l-table-edit-td"><input name="job_expression" type="text" id="job_expression" ltype="text"  value="${job_expression}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">job_run_time：</td>
                <td align="left" class="l-table-edit-td"><input name="job_run_time" type="text" id="job_run_time" ltype="text"  value="${job_run_time}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">job_proc：</td>
                <td align="left" class="l-table-edit-td"><input name="job_proc" type="text" id="job_proc" ltype="text"  value="${job_proc}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
