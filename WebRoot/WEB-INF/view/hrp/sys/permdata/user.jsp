...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'../user/queryAllUser.do?isCheck=false&type_code=2',
    ...
    function loadDict(){
    	...
    	autocomplete("#user_code","../queryUserDictBySys.do?isCheck=false&type_code=2","id","text",true,true,{});    
         }   
