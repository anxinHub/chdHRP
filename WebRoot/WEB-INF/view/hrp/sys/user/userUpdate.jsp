...
<script type="text/javascript">
    ...
    function save(){
        ...
        emp_code:liger.get("emp_code").getValue().split(".")[0],
        is_stop:$("#is_stop").val(),
        note:$("#note").val(),
        phone:$("#phone").val(),
        };
        ajaxJsonObjectByUrl("updateUser.do",formPara,function(responseData){
    ...
    function loadDict(){
    	$("#user_code").ligerTextBox({width:180,disabled: true });
    	$("#sj_user").ligerTextBox({width:180,disabled: true });
    	autocomplete("#emp_code","../queryEmp.do?isCheck=false","id","text",true,true);	
    ...
    function rePassword(){
   	 $.ligerDialog.confirm('确定要重置密码：123456?', function(yes) {
			if (yes) {
				var formPara={ParamVo : '${user_id}'};
		     	ajaxJsonObjectByUrl("updateBatchUserPwd.do",formPara);
			}
   	 });		
    }
    </script>
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="user_code" value="${user_code }" type="text" id="user_code" ltype="text" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
            ...
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">上级用户：</td>
                <td align="left" class="l-table-edit-td"><input name="sj_user" type="text" id="sj_user" ltype="text" value="${sj_user }" validate="{required:false,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
