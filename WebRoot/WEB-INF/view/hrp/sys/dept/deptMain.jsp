	...
	<script type="text/javascript">
       ...
       function addDept(){
    	   parent.$.ligerDialog.open({
    		   url: 'hrp/sys/dept/deptAddPage.do?isCheck=false',
    				   height: 585,width: 700, title:'新增部门',modal:true,showToggle:false,showMax:false,showMin: true,isResize:true ,
       ...
       function updateDept(rowStr){
    	   var rowArr=rowStr.split("|");
    		parent.$.ligerDialog.open(
    			   {url : 'hrp/sys/dept/deptUpdatePage.do?isCheck=false&dept_id=' + rowArr[2]+'&hos_id='+rowArr[1]+'&group_id='+rowArr[0], 
    			    height: 585,width: 700,  title:'部门修改', modal:true,showToggle:false, showMax:false,showMin: true,isResize:true ,   parentframename: window.name,
    		   buttons: [ 
       ...
       function openOrg(){
       	parent.$.etDialog.open({
               url: 'hrp/sys/dept/deptOrgPage.do?isCheck=false',
               title: '组织架构图',
               width: $(window).width(),
