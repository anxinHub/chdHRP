...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readEmpKindFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
					{
				columns : [
							 { display: '职工类别编码', name: 'kind_code', align: 'left',editor:{type:'text'}},
							 { display: '职工类别名称', name: 'kind_name', align: 'left',editor:{type:'text'}},
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addImportEmpKindDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
