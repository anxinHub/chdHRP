    	...
    	if(mat=='0' && med=='0' && ass=='0' && sup=='0'){
    	 ...
    	 if(is_auto=="0"){
    		 if($("#sup_code").val()==""){
     	        ...
     	        ajaxJsonObjectByUrl("addSup.do",formPara,function(responseData){
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" border="0">
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td" colspan="3">
                	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                	<input name="is_delivery"  id ="is_delivery" type="checkbox" />是否允许自制送货
                </td> 
            </tr> 
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td" colspan="4">
                	<textarea rows="3" cols="75" id="note" name="note" ltype="text" validate="{maxlength:50}"></textarea>
                </td>
                <td align="left"></td>
            </tr> 
        </table>
