    ...
    function save(){
        if($("#codeTable").is(':hidden') && $("#nameTable").is(':show')){//名称变更
        	var formPara2 = {
        			...
        			hos_id:'${hos_id}',
        			sup_code:'${sup_code}',
        			sup_name:$("#new_sup_name").val(),
                    is_stop:0,
                    note:$("#note2").val(),
                    dict_type:"1"
            };
        	ajaxJsonObjectByUrl("addSupDict.do",formPara2,function (responseData){
        	...
        	var formPara1 = {
    		        ...
    		        group_id:'${group_id}',
    		        hos_id:'${hos_id}',
    		        sup_code:$("#new_sup_code").val(),
    		        sup_name:'${sup_name}',
    		        is_stop:0,
    		        note:$("#note1").val(),
    		        dict_type:"0"
            };
        	ajaxJsonObjectByUrl("addSupDict.do",formPara1,function (responseData){
        		if(responseData.state=="true"){
        			parent.query();
        		}
     		});
        ...
        <table cellpadding="0" cellspacing="0" id="codeTable" class="l-table-edit" style="display: inline;">
            <tr>
             ...
             <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="new_sup_code" type="text" id="new_sup_code" ltype="text"  /></td>
                <td align="left"></td>
            </tr> 
            <tr>
        ...
        <table cellpadding="0" cellspacing="0" id="nameTable" class="l-table-edit" style="display: none;">
            <tr>
             ...
             <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="new_sup_name"  type="text" id="new_sup_name" ltype="text"  /></td>
                <td align="left"></td>
            </tr> 
           <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">变更原因：</td>
