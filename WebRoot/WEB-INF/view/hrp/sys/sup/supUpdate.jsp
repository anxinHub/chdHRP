...
<script type="text/javascript">
    ...
    $(function (){
        ...
        if("${is_delivery}" == 1){
        	liger.get("is_delivery").setValue(true)
		}
  ...
  //查询
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'../supdict/querySupDict.do?isCheck=false&group_id=${group_id}&hos_id=${hos_id}&sup_id=${sup_id}',
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateSup.do",formPara,function(responseData){
    ...
    function loadDict(){
        //字典下拉框
    		autocomplete("#sup_type","../querySupTypeDict.do?isCheck=false","id","text",true,true);
		      liger.get("sup_type").setValue('${type_code}');
		      liger.get("sup_type").setText('${type_name}');
		      // 判断前缀是否有类型 如果有则 设置不可用
		      liger.get("sup_type").setDisabled('${sup_code}'.includes('-'));
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" border="0">
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="sup_type" type="text" id="sup_type" ltype="text" validate="{required:true}" />
                </td>
                <td align="left"></td>
            </tr> 
             <tr>
			...
			<tr>
            	<td align="left" class="l-table-edit-td" ></td>
             	<td align="left" class="l-table-edit-td" colspan="3" >
             		...
             		<input name="is_delivery"  id ="is_delivery" type="checkbox" />是否自制送货
             	</td>
            </tr>
        </table>
    </form>
