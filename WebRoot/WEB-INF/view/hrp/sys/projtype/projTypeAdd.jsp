...
<script type="text/javascript">
     ...
     function  save(){
        var formPara={
           ...
           attr_code:$("#attr_code").val(),
           
           note:$("#note").val()
            
         };
        
        ajaxJsonObjectByUrl("addProjType.do",formPara,function(responseData){
 ...
 function loadForm(){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">项目属性：</td>
                <td align="left" class="l-table-edit-td">
                	<select id="attr_code" name="attr_code">
                	    <option value="01">财政</option>
                		<option value="02">科教</option>
