...
$(function(){
	...
	function plupload(){  
		$("#uploader").pluploadQueue({           
	       	...
	       	url : "readStoreTypeFiles.do?isCheck=false",    
	       	chunk_size : '2mb',           
	       	filters : {                
	           mime_types: [  
...
function loadHead() {
	grid = $("#maingrid").ligerGrid(
					{
				columns : [
							 { display: '生产厂商分类编码', name: 'type_code', align: 'left',editor:{type:'text'}},
							 { display: '生产厂商分类名称', name: 'type_name', align: 'left',editor:{type:'text'}},
        ...
        switch (item.id)
        {
            case "save":
            	var data = gridManager.getData();
           	 	ajaxJsonObjectByUrl("addImportStoreTypeDict.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
