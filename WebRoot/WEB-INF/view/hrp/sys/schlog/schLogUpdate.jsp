...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateSchLog.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="job_start_time" type="text" id="job_start_time" ltype="text"  value="${job_start_time}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">job_end_time：</td>
                <td align="left" class="l-table-edit-td"><input name="job_end_time" type="text" id="job_end_time" ltype="text"  value="${job_end_time}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">job_user_code：</td>
                <td align="left" class="l-table-edit-td"><input name="job_user_code" type="text" id="job_user_code" ltype="text"  value="${job_user_code}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
            <tr>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;">job_exception：</td>
                <td align="left" class="l-table-edit-td"><input name="job_exception" type="text" id="job_exception" ltype="text"  value="${job_exception}" validate="{required:true,maxlength:20}" /></td>
                <td align="left"></td>
            </tr> 
        </table>
    </form>
