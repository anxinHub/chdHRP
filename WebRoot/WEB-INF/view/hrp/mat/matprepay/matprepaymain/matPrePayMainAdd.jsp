     ...
     function loadHead(){
     	 inMainGrid = $("#maingrid").ligerGrid({
            columns: [ 
                      ...
                      dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatCommonIn.do?isCheck=false',  
                      ...
                      toolbar: { items: [
     	               ...
     	               /*  { text: '删除（<u>D</u>）', id:'delete', click: remove,icon:'delete' },
 						{ line:true }, */
     	                { text: '保存（<u>S</u>）', id:'save', click: saveMatPrePayMain,icon:'save' },
						{ line:true },
			...
			if(str != ''){
				 ...
				 if(error != ''){
		        	 ...
		        	 $.ligerDialog.confirm('确定要保存预付款单及预付款单明细信息吗?', function (yes){
				           	if(yes){
				           		 ajaxJsonObjectByUrl("addMatPrePayMain.do?isCheck=false",formPara,function(responseData){
			          	            if(responseData.state=="true"){
			          	                parent.query();
			          	                ajaxJsonObjectByUrl("addMatPrePayDetail.do?isCheck=false",{ParamVo : ParamVo.toString()},function (responseData){
			                          		if(responseData.state=="true"){
			                          		}
			                          	});
			          	            }
			     ...
			     <table cellpadding="0" cellspacing="0" class="l-table-edit" >
					<tr>
			            ...
			            <td align="left" class="l-table-edit-td">
			            	<input class="Wdate" name="pay_date" type="text" id="pay_date" ltype="text" onChange="setMatPrePayMainNo()" style="width: 200px;" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" validate="{required:true,maxlength:20}" />
			            </td>
			            <td align="left"></td>
			        </tr> 
					<tr>
			            ...
			            <td align="left" class="l-table-edit-td">
				            <select name="pay_bill_type" id="pay_bill_type" style="width: 135px;" onChange="setMatPrePayMainNo()">
