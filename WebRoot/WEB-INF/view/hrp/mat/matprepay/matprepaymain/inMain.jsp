...
<script type="text/javascript">
    ...
    function inDetail(row, detailPanel,callback)
    {
        ...
        grid = $(detailGrid).css('margin',10).ligerGrid({
            	columns:[
        			...
        			//url:'queryMatInDetail.do?isCheck=false&in_id='+row.in_id+'&bill_id='+row.bill_id+'&init='+row.init,
    ...
    function loadDict(){
		...
		//业务类型下拉框
		autocomplete("#bus_type_code", "../../queryMatBusType.do?isCheck=false", "id", "text", true, true);
		//仓库下拉框
		autocomplete("#store_id", "../../queryMatStore.do?isCheck=false", "id", "text", true, true,'',false,'',240);
