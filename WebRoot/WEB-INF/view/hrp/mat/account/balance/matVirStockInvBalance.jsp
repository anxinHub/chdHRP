...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatAccountBalanceVirStockInvBalance.do',
    ...
    function lodopPrint(){
    	var head="<table class='head' width='100%'><tr><td>单位：${hos_name}</td></tr>";
 		...
 		grid.options.lodop.title="库存材料收发账表(虚仓)";
    }
...
//		autocomplete("#mat_type_code", "../../queryMatTypeDict.do?isCheck=false", "id", "text", true, true, {is_last : 1},false,'',240);
	...
	function print(){
    	...
    	var printPara={
          		title: "库存材料收发账表(虚仓)",//标题
          		columns: JSON.stringify(grid.getPrintColumns()),//表头
          		class_name: "com.chd.hrp.mat.service.account.balance.MatAccountBalanceVirStockInvBalanceService",
       			method_name: "queryMatAccountBalanceVirStockInvBalancePrint",
       			bean_name: "matAccountBalanceVirStockInvBalanceService",
