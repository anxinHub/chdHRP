...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatAccountBalanceChargeInv.do',
    ...
    function lodopPrint(){
    	var head="<table class='head' width='100%'><tr><td>单位：${hos_name}</td></tr>";
 		...
 		grid.options.lodop.title= liger.get("store_code").getText() + "计费材料使用查询";
    }
	...
	if(liger.get("store_code").getValue()== " "){ 
    	...
    	var printPara={
          		...
          		class_name: "com.chd.hrp.mat.service.account.balance.MatAccountBalanceChargeInvService",
       			method_name: "queryMatAccountBalanceChargeInvPrint",
