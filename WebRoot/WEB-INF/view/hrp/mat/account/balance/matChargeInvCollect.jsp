...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatAccountBalanceChargeInvCollect.do',
    ...
    function lodopPrint(){
    	var head="<table class='head' width='100%'><tr><td>单位：${hos_name}</td></tr>";
 		...
 		grid.options.lodop.title= liger.get("set_code").getText() + "计费材料汇总查询";
    }
    ...
    function loadDict(){
		//字典下拉框
		autocompleteAsync("#set_code", "../../queryMatVirStore.do?isCheck=false", "id", "text", true, true, "", true);
	...
	function print(){
    	...
    	var printPara={
          		...
          		class_name: "com.chd.hrp.mat.service.account.balance.MatAccountBalanceChargeInvService",
       			method_name: "queryMatAccountBalanceChargeInvCollectPrint",
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%" style="padding: 10px" border="0">
		<tr>
        	...
        	<td align="left" class="l-table-edit-td" width="30%">
    			<input id="is_bar" type="checkbox" name="is_bar"  checked="checked"/>只显示条码材料
    			&nbsp;&nbsp;&nbsp;&nbsp;
