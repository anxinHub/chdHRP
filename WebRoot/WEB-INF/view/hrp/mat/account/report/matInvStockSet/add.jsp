...
<script type="text/javascript">
     ...
     function  save(){
 		if($("form").valid()){
 			...
 			ajaxJsonObjectByUrl("addMatShowSet.do", formPara, function(responseData){
    ...
    function loadDict(){
    	...
    	autoCompleteByData("#direction_flag", matShowSet_directionFlag.Rows, "id", "text", true, true, "", true);
        //格式化按钮
