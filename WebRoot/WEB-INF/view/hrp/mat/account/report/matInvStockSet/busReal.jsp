...
<script type="text/javascript">
    ...
    function loadHead(){
		grid = $("#maingrid").ligerGrid({
			...
			dataAction: 'server',dataType: 'server',usePager: false,url:'queryMatShowDetailByCode.do?isCheck=false',
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("addMatShowDetail.do?isCheck=false",formPara,function(responseData){
