...
/* 				autocompleteAsync("#store_code", "../../queryMatStoreByRead.do?isCheck=false", "id", "text", true, true, "", true); */
    ...
    function loadHead(){
		...
		//获取本期增加、减少查询字段
    	ajaxJsonObjectByUrl("queryMatAccountReportInvStockColumns.do?isCheck=false", "", function (responseData){
    	...
    	grid = $("#maingrid").ligerGrid({
    		columns : columns, 
			dataAction: 'server', dataType: 'server', usePager: false, url: 'queryMatAccountReportInvStock.do', 
	...
	function print(){
    	...
    	var printPara={
      		...
      		class_name: "com.chd.hrp.mat.service.account.report.MatAccountReportInvStockService",
   			method_name: "collectMatAccountReportInvStockPrint",
   			bean_name: "matAccountReportInvStockService",
	...
	//	autoCompleteByData("#show_last", yes_or_no.Rows, "id", "text", true, true, "", true);
		autocomplete("#is_charge", "../../queryMatYearOrNo.do?isCheck=false", "id", "text", true, true, "", true);
		$("#is_charge").ligerTextBox({cancelable : false});
	}  
