...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			columns: [],
			dataAction: 'server',dataType: 'server',usePager:false,url:'queryMatDeptCount.do',width: '100%', height: '100%',rownumbers:true,
    ...
    function lodopPrint(){
    	var head="<table class='head' width='100%'><tr><td>单位：${hos_name}</td></tr>";
 		...
 		grid.options.lodop.title="科室领用汇总表";
    }
...
/* 		autocomplete("#store_code", "../../../queryMatStoreByRead.do?isCheck=false", "id", "text", true, true);
		...
		autocomplete("#dept_code", "../../../queryMatAppDept.do?isCheck=false", "id", "text", true, true, {is_last : 1},'', false, 280); */
		...
		autocompleteAsyncMulti("#bus_type_code", "../../../queryMatBusType.do?isCheck=false", "id", "text", true, true,{codes :'3,21,49,50'},true,true,280);
	...
	if(grid.getData().length==0){
    	...
    	var heads={
        		...
        		"rows": [
    	          {"cell":0,"value":"统计年月："},
    	          {"cell":1,"value":""+$("#begin_date").val()+"至"+$("#begin_date").val(),"colSpan":"2"},
    	          {"cell":3,"value":"仓库："},
