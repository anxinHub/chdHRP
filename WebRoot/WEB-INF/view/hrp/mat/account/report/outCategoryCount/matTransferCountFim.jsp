...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			columns: [
						{display: '仓库名称', name: 'store_name', align: 'left', minWidth: '120'}, 
						{display: '财务分类编码', name: 'fim_type_code', align: 'left', minWidth: '100'},
						{display: '财务分类', name: 'fim_type_name', align: 'left', minWidth: '120'}, 
						{display:'汇总金额', id:'', name:'amount_money', align:'right', minWidth:'80', type:'float',
			    			render: function (rowdata, rowindex, value) {
								return formatNumber(value ? value : 0, '${p04005}', 1);
						},formatter:"###,##0.00"
			    		},
			...
			dataAction: 'server',dataType: 'server',usePager:false,url:'queryMatTransferCountFim.do',width: '100%', height: '100%',rownumbers:true,
	...
	function f_setColumns(){ 
		...
		var para={
			...
			//fim_type_id : liger.get("fim_type_code").getValue().split(",")[0],
		};
    ...
    function lodopPrint(){
    	var head="<table class='head' width='100%'><tr><td>单位：${hos_name}</td></tr>";
 		...
 		grid.options.lodop.title="移库分类汇总表(财务)";
    }
...
/* 		autocompleteAsync("#mat_type_code", "../../../queryMatTypeDict.do?isCheck=false", "id", "text", true, true, {is_last : 1}); */
	...
	function print(){
    	...
    	var printPara={
          		title: ""+liger.get("store_code").getText().split(" ")[1]+"移库分类汇总表(财务)",//标题
          		columns: JSON.stringify(grid.getPrintColumns()),//表头
          		class_name: "com.chd.hrp.mat.service.account.report.outCategoryCount.MatAccountReportDeptCountFimService",
       			method_name: "queryMatTransferCountFimprint",
       			bean_name: "matAccountReportDeptCountFimService",
