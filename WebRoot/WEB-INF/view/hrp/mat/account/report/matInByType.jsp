...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			columns: [],
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatInByType.do',
    ...
    function loadDict(){
		//字典下拉框
		autocompleteAsyncMulti("#bus_type_code", "../../queryMatBusType.do?isCheck=false", "id", "text", true, true,{codes : '8,10'},true, false, 180);
//		autocomplete("#store_code", "../../queryMatStoreByRead.do?isCheck=false", "id", "text", true, true,"", false, false, 180);
		...
		//autocompleteAsync("#mat_type_code", "../../queryMatTypeDict.do?isCheck=false", "id", "text", true, true, {is_last : 1}, false, false, 180);
		autocomplete("#type_level", "../../queryMatTypeLevel.do?isCheck=false", "id", "text", true, true,'',true, false, 180);
		autocomplete("#set_code", "../../queryMatVirStore.do?isCheck=false", "id", "text", true, true,"", false, false, 180);<%-- 虚仓 --%>
		autocomplete("#is_charge", "../../queryMatYearOrNo.do?isCheck=false", "id", "text", true, true,"", false, false, 180);
	...
	function print(){
    	...
    	var printPara={
          		...
          		class_name: "com.chd.hrp.mat.service.account.report.MatAccountReportDeptOutService",
       			method_name: "queryMatInByTypePrint",
