...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			...
			usePager:true,
			url:'queryMatChoiceInvBySup.do?isCheck=false',
			width: '100%', 
			height: '100%', 
			checkbox: true, 
			rownumbers:true,
			...
			toolbar: { items: [
				...
				{ line : true},
				{ text: '生成调价单（<u>A</u>）', id:'add', click: imp, icon:'add' },
				{ line : true},
    ...
    function loadDict(){
    	...
    	//字典下拉框
		autocomplete("#sup_code", "../../queryHosSupDictDisable.do?isCheck=false", "id", "text", true, true,null, false);
