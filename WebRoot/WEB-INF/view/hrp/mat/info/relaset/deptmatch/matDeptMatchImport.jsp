...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMatDeptMatchFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '配套表ID', name: 'store_match_id', align: 'left',editor:{type:'text'}},
				{ display: '配套表名称', name: 'store_match_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchMatDeptMatch.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
