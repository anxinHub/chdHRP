...
<html style="overflow:hidden;">
  <head>
    ...
    function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
		  					     ...
		  					     editor :{
										...
										grid : {
											columns : [ {
												...
												display : '单价', name : 'price', align : 'left', width : '60'
											} , { 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:false,//东阳需求
                     url:'queryMatDeptDetailByCode.do?isCheck=false&dept_match_id='+'${dept_match_id}',
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateMatDeptMatch.do",formPara,function(responseData){
    ...
    function loadDict(){
		...
		//autocomplete("#dept_name","../../queryMatDept.do?isCheck=false","id","text",true,true,dept_para,false,'${dept_id},${dept_no}',"","",200);//科室信息
		autocomplete("#dept_name", "../../queryMatDept.do?isCheck=false","id","text",true,true,dept_para,false,"",200,"",200);
	...
	function deleteRow(){
        ...
        if (data.length == 0){
           ...
           $.ligerDialog.confirm('确定删除?', function (yes){
        	   if(yes){
        		   if(is_delete){
	                	ajaxJsonObjectByUrl("deleteMatDeptMatchDetail.do?isCheck=false",{ParamVo : ParamVo.toString()},function (responseData){
	                		if(responseData.state=="true"){
	                			parentFrameUse().query();
