  ...
  <head>
   ...
   <script src="<%=path%>/lib/stringbuffer.js"></script>
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
	                     { display: '交易编码', name: 'bid_code', align: 'left',width:150
		  					     ...
		  					     editor :{
										...
										grid : {
											...
											url : '../../queryMatInvList.do?isCheck=false&store_id=' + liger.get("store_name").getValue().split(",")[0],
											//delayLoad:true,
											usePager:true,
											pageSize : 30,
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatSmmDetailByCode.do?isCheck=false&store_match_id='+'${store_match_id}',
                     width: '100%', height: '100%', checkbox: true,rownumbers:true,enabledEdit:true,
                     alternatingRow : true,onBeforeEdit : f_onBeforeEdit,pageSize:500,
                ...
                case "delete":
                    ...
                    if (data.length == 0){
                       ...
                       $.ligerDialog.confirm('确定删除?', function (yes){
                        	if(yes){
                            	ajaxJsonObjectByUrl("deleteMatStoreMatch.do?isCheck=false&paramVo="+Param,{},function (responseData){
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateMatStoreMatch.do",formPara,function(responseData){
    ...
    function loadDict(){
		...
		autocomplete("#store_name","../../queryMatStore.do?isCheck=false","id","text",true,true,'',false,"","","",220);//仓库信息
