...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMatStoreMatchFiles.do?isCheck=false",    
		...
		ajaxJsonObjectByUrl("addBatchMatStoreMatch.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
