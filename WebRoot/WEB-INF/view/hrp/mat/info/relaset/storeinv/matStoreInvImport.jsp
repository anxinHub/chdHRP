...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMatStoreInvFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '仓库ID', name: 'store_id', align: 'left',editor:{type:'text'}},
				{ display: '物资材料ID', name: 'inv_id', align: 'left',editor:{type:'text'}},
				{ display: '最低库存', name: 'low_limit', align: 'left',editor:{type:'text'}},
				{ display: '库存基数', name: 'stock_secu', align: 'left',editor:{type:'text'}},
				{ display: '最高库存', name: 'high_limit', align: 'left',editor:{type:'text'}},
				{ display: '是否自动补货', name: 'is_auto_supply', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchMatStoreInv.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
