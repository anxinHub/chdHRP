...
<html style="overflow:auto;">
  <head>
			...
			columns: [ { 
				...
				editor :{
					...
					grid : {
						...
						url : 'queryMatInvSupList.do?isCheck=false',
						//delayLoad:true,
						usePager: true,
						pageSize : 5,
					},
	...
	function loadDict(){
		...
		autocomplete("#price_type", "../../../queryMatSysList.do?isCheck=false", "id", "text", true, true, {field_code : "price_type"}, false, "${matInv.price_type}");
		autocomplete("#amortize_type", "../../../queryMatSysList.do?isCheck=false", "id", "text", true, true, {field_code : "amortize_type"}, false, "${matInv.amortize_type}");
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%" style="padding: 10px"  >
	        <tr>
	          ...
	          <td align="right" class="l-table-edit-td"  width="10%">
	            ...
	            <td align="left" class="l-table-edit-td" width="20%">
	            	<input name="alias" type="text" id="alias" ltype="text"  value="${matInv.alias}"  validate="{required:false,maxlength:100}"  onmouseover="showTip(event, this)" onmouseout="hideTip(event)"/>
	            </td>
	        </tr> 
	        <tr>
			...
			<tr>
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="inv_model" type="text" id="inv_model" ltype="text" value="${matInv.inv_model}" validate="{required:false,maxlength:200}"  onmouseover="showTip(event, this)" onmouseout="hideTip(event)"/>
	            </td>
	            <td align="right" class="l-table-edit-td" >
	        ...
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input class="Wdate" name="bid_date" id="bid_date" type="text" value="${matInv.bid_date}" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"/>
	            </td> 
	            <td align="right" class="l-table-edit-td"  >
	            	项目中标编码：
	            </td>
	            <td align="left" class="l-table-edit-td">
	            	<input name="bid_code" type="text" id="bid_code" ltype="text" value="${matInv.bid_code}" validate="{required:false,maxlength:50}" />
	            </td>
	        </tr>
	        <tr>
	            <td align="right" class="l-table-edit-td"  >
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="memory_encoding" type="text" id="memory_encoding" ltype="text" value="${matInv.memory_encoding}" validate="{required:false,maxlength:50}" />
	            </td>
                <td align="right" class="l-table-edit-td"  >
	            	计划来源：
	            </td>
