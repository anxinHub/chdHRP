...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMatStoreTypeFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '物资类别ID', name: 'mat_type_id', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchMatStoreType.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
