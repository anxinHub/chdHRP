...
<html style="overflow:hidden;">
  <head>
    ...
    function validate(){
		...
		ajaxJsonObjectByUrl("existsMatInvInStore.do?isCheck=false", para, function (responseData) {
			if (responseData.state == "false") {
				msg += "材料" + responseData.inv_ids + "已经存在于该仓库中！<br>";
			}
		}, false);
    	...
    	if(validate()){
    		...
    		$.each(allData,function(i,v){
    			if(typeof(v.inv_id) != 'undefined' && v.inv_id != null && v.inv_id != ''){
	    			...
	    			//避免location_id不填时,添加报错
	    			if(isHide){
	    				param = param + inv_id + ','+ is_apply +','+ location_id + '@'
	    			}else{
        	...
        	ajaxJsonObjectByUrl("addMatStoreInvCert.do?isCheck=false",formPara,function(responseData){
                     ...
                     { display: '材料名称',
 					     ...
 					     editor :{
								...
								grid : {
									...
									//url : 'queryMatInvAllList.do?isCheck=false&store_id='+'${store_id}',
									url : 'queryMatInvAllList.do?isCheck=false&store_id='+'${store_id}',
									usePager:true,
...
<body style="padding: 0px; overflow: hidden;">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
    	<tr>
            ...
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><font color="red" size="2">注：已设置申领仓库的材料不能再次勾选!</font></td>
        </tr>
    </table>
	<div id="maingrid"></div>
</body>
