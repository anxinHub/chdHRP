...
<script type="text/javascript">
    ...
    var userUpdateStr;
    var checkedCustomer = [];
    var isHide = '${sessionScope.mat_para_map["04035"] }' == 1 ? false : true;
    $(function ()
    {
        loadDict();//加载下拉框
    	//加载数据
           ...
           columns: [ 
					 ...
					 { display: '货位', name: 'location_id',textField : 'location_name', align: 'left',hide:isHide,
		                    editor : {
		     						...
		     						valueField : 'id',
		     						textField : 'text',
		     						url : '../../../../queryMatLocation.do?isCheck=false&store_id='+liger.get("store_id").getValue().split(",")[0],
		     						keySupport : true,
		     						autocomplete : true,
		     				},
                     ...
                     url:'queryMatInv.do',delayLoad:true,enabledEdit : true,
    ...
    function add_open(){
    	...
    	if (checkedCustomer.length==0){
		  alert("请选择要保存的材料！");
	        ...
	        ajaxJsonObjectByUrl("addMatStoreInv.do?isCheck=false", {ParamVo : checkedCustomer.toString()},function(responseData){
	            if(responseData.state=="true"){
	            	checkedCustomer=[];
	            	query();
	            	parent.query();
