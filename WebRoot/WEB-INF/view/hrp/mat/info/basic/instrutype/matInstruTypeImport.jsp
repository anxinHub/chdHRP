...
var columns = "";
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnCount(3);  //默认最大20列如超过20列则需设置具体的最大列数
    	sheet.setColumnWidth(0, "140"); sheet.setText(0, 0, "医疗器械分类编码");
    	sheet.setColumnWidth(1, "200"); sheet.setText(0, 1, "医疗器械分类名称");
