...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMatInvCertTypeFiles.do?isCheck=false",    
		...
		ajaxJsonObjectByUrl("addBatchMatInvCertType.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
