...
<html style="overflow:hidden;">
  <head>
    ...
    function save(){
    	...
    	if(validateGrid()){
            ...
            var formPara={
    		 ...
    		 ajaxJsonObjectByUrl("updateMatInvCert.do",formPara,function(responseData){
    		 	if(responseData.state=="true"){
				   //  设置数据加载完事件 使它渲染完页面后滚动条滚动到指定位置和选择该数据
					parentFrameUse().grid.set('onAfterShowData',afterShowData);
					var changepage = parentFrameUse().grid.options.page;
					parentFrameUse().query(changepage);
    		 		loadHead();
    		    	grid.reRender();
    ...
    function loadHead(){
   	 grid = $("#maingrid").ligerGrid({
            columns: [
                      ...
                      { display: '材料名称',
 					     ...
 					     editor :{
								...
								grid : {
									...
									url : 'queryMatCertInvList.do?isCheck=false&cert_id='+'${cert_id}',
									//delayLoad:true,
									usePager:true,
									pageSize : 30,
                      ...
                      url:'queryMatInvCertDetail.do?isCheck=false&cert_id='+'${cert_id}',
      	 ...
      	 gridSup = $("#maingridSup").ligerGrid({
               columns: [
				   ...
				   { display: '供应商名称', name: 'sup_name', align: 'left'}
	                ...
	                url:'queryMatCerSup.do?isCheck=false&cert_id='+'${cert_id}',
    ...
    function loadDict(){
    	...
    	$("#cert_code").ligerTextBox({disabled:true});
     }
     function this_close(){
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" border="0" width="100%">
		 	<tr>
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="cert_code" type="text" id="cert_code" value="${cert_code}" disabled="disabled" ltype="text" validate="{required:true,maxlength:100}" />
	            </td>
	        ...
	        <tr>
	            ...
	            <td align="left"  class="l-table-edit-td" >
	            	<input name="sup_id" type="text" id="sup_id" value="${sup_id}" ltype="text" validate="{required:false}" />
	            </td>
