...
<script type="text/javascript">
		...
		function plupload(){
			...
			$("#uploader").pluploadQueue({
					...
					url : "upLodeFile.do?isCheck=false&sup_id=${sup_id}&cert_code=${cert_code}",
					...
					{title : "doc files", extensions : "bmp,gif,jpg,pic,png,tif,pdf,doc,docx,zip"}
						...
						FileUploaded: function(uploader,file,responseObject) {
							...
							var json = eval('(' + res + ')') ;
							 ...
							 if(json.state == "true"){
								...
								//$(parentFrameUse().document).find('#file_path').val('');
