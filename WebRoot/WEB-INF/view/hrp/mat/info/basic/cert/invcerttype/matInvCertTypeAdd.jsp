...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addMatInvCertType.do",formPara,function(responseData){
 ...
 function loadForm(){
	...
	function loadDict(){
		//字典下拉框
		autoCompleteByData("#validity_type", matInvCertType_validityType.Rows, "id", "text", true, true, "", true);
