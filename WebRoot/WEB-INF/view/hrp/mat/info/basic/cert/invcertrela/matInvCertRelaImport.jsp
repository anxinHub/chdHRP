...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMatInvCertRelaFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '材料ID', name: 'inv_id', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchMatInvCertRela.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
