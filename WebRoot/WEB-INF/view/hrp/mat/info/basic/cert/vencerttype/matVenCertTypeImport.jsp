...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMatVenCertTypeFiles.do?isCheck=false",    
		...
		ajaxJsonObjectByUrl("addBatchMatVenCertType.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
