...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			columns: [
				{ display: '证件号', name: 'cert_code', align: 'left'},
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatInvCertQuery.do',
  ...
  //打印
	function print(){
    	...
    	var colspan_num = grid.getColumns(1).length-1;
   		...
   		ajaxJsonObjectByUrl("queryMatInvCertQuery.do?isCheck=false", selPara, function (responseData) {
    ...
    function loadDict(){
	 	//证件编码下拉框
		autocomplete("#cert_id", "../../../../queryMatInvCert.do?isCheck=false", "id", "text", true, true,'',false,'','160');
		//物资类别下拉框
		...
		//物资材料 下拉框 
		autocomplete("#inv_code", "../../../../queryMatInvDict.do?isCheck=false", "id", "text", true, true,'',false,'','160');
...
<body style="padding: 0px; overflow: hidden;">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
        ...
        <tr>
        	<td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>物资材料:</b></td>
            ...
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>证件号:</b></td>
