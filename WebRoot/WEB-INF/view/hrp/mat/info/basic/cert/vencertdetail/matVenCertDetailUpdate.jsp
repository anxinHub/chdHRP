...
<html style="overflow:hidden;">
  <head>
   ...
   <jsp:include page="${path}/inc_jquery_1.9.0.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateMatVenCertDetail.do",formPara,function(responseData){
  ...
  //附件上传
    ...
    function loadDict(){
        ...
        //证件编码
  	/* 	autocomplete("#cert_code", "../../../../queryMatInvCert.do?isCheck=false", "id", "text", true, true,'',false,'',400);
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td" colspan="4">
            	<textarea rows="4" class="liger-textarea" id="file_path" name="file_path" style="width:580px" disabled="disabled" validate="{maxlength:200}" >${file_path}</textarea>
            </td>
            <td align="left"></td>
        </tr> 
        <tr>
            ...
            <td align="left" class="l-table-edit-td">
            	<div class='l-button' style='width: 60px; margin-top:1px; margin-left: 40px;' ligeruiid='Button1004' onclick=deleteFile("${sup_id}")><span>删除</span></div>
            </td>
        </tr> 
    </table>
    </form>
