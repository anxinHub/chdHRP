...
<jsp:include page="${path}/inc_jquery_1.9.0.jsp" />
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateMatVenCertType.do",formPara,function(responseData){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="war_days" type="text" id="war_days" ltype="text" value="${war_days}" validate="{digits:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
        <tr>
