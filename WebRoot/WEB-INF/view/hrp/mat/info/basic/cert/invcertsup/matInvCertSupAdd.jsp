     ...
     function  save(){
    	 if(validateGrid()){
			...
			var supData = gridManagerSup.getData();
   	        ...
   	        ajaxJsonObjectByUrl("addMatInvCertSup.do",formPara,function(responseData){
   	            if(responseData.state=="true"){
   					 $("input[name='sup_cert_code']").val('');
   					 $("input[name='sup_cert_inv_name']").val('');
     ...
     function loadHead(){
       	 grid = $("#maingrid").ligerGrid({
                columns: [
                          ...
                          width: '100%', height: '65%', checkbox : true,isAddRow:false ,
     ...
     function loadHeadSup(){
		...
		//选择材料页面跳转
    	 function choice_inv(){
    		...
    		$.ligerDialog.open({url: "matInvCertSupChoiceInvPage.do?isCheck=false",
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" border="0" width="100%">
		 	<tr>
	            ...
	            <td align="left" class="l-table-edit-td" >
	            	<input name="sup_cert_code" type="text" id="sup_cert_code"  ltype="text" validate="{required:true,maxlength:100}" />
				</td>
				
	            <td align="right" class="l-table-edit-td" ><b><font color ="red">*</font>证件产品名称:</b></td>
	            <td align="left" class="l-table-edit-td" >
	            	<input name="sup_cert_inv_name" type="text" id="sup_cert_inv_name"  ltype="text" validate="{required:true,maxlength:100}" />
				</td>
	        </tr>
	        <tr>
