    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        var formPara={
 		...
 		ajaxJsonObjectByUrl("addMatLocationDict.do",formPara,function(responseData){   
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	$("#location_type_id").ligerComboBox({
           	url: '../../../../queryMatLocationType.do?isCheck=false',
           	valueField: 'id',
            textField: 'text', 
            selectBoxWidth: 160,
           	autocomplete: true,
    	...
    	$("#is_stop").ligerComboBox({
           	url: '../../../../queryMatYearOrNo.do?isCheck=false',
           	valueField: 'id',
            textField: 'text', 
            selectBoxWidth: 160,
           	autocomplete: true,
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr></tr> 
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><span style="color:red">*</span>货位编码：</td>
            <td align="left" class="l-table-edit-td">
            	<input name="location_code" type="text" id="location_code" ltype="text" required="true" validate="{required:true,maxlength:20}" />
            </td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><span style="color:red">*</span>货位名称：</td>
            <td align="left" class="l-table-edit-td">
        ...
        <tr>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><span style="color:red">*</span>排位编号：</td>
            <td align="left" class="l-table-edit-td">
            	<input name="grid_no" type="text" id="grid_no" ltype="text" required="true" validate="{required:true,maxlength:20}" />
            </td>
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><span style="color:red">*</span>货位分类：</td>
            <td align="left" class="l-table-edit-td">
        ...
        <tr>
            ...
            <td align="left"></td>
            <td align="right" class="l-table-edit-td" style="padding-left: 20px;"><span style="color:red">*</span>所属库房：</td>
			<td align="left" class="l-table-edit-td">
        ...
        <tr>
            ...
            <td align="left"></td>
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><span style="color:red">*</span>拣货员：</td>
            <td align="left" class="l-table-edit-td">
