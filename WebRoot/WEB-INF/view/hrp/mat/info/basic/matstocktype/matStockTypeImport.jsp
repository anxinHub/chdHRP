...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMatStockTypeFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '采购类型编码', name: 'stock_type_code', align: 'left',editor:{type:'text'}},
				{ display: '采购类型名称', name: 'stock_type_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchMatStockType.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
