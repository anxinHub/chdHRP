  ...
  <head>
    ...
    <script type="text/javascript">
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addMatInvUnitMap.do",formPara,function(responseData){
            
            if(responseData.state=="true"){
				 $("input[name='inv_id']").val('');
				 $("input[name='pack_code']").val('');
				 $("input[name='unit_code']").val('');
				 $("input[name='map_amount']").val('');
                parent.query();
            }
        });
    }
 ...
 function loadForm(){
   ...
   <form name="form1" method="post"  id="form1" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="map_amount" type="text" id="map_amount" ltype="text" validate="{required:true,maxlength:20}" /></td>
            <td align="left"></td>
        </tr> 
    </table>
    </form>
