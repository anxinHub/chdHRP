...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMatInvUnitMapFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				{ display: '包装单位', name: 'pack_code', align: 'left',editor:{type:'text'}},
				{ display: '计量单位', name: 'unit_code', align: 'left',editor:{type:'text'}},
				{ display: '转换数量', name: 'map_amount', align: 'left',editor:{type:'text'}}
		...
		ajaxJsonObjectByUrl("addBatchMatInvUnitMap.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
