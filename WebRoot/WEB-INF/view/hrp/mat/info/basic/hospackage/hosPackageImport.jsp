...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readHosPackageFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: '包装单位编码', name: 'pack_code', align: 'left',editor:{type:'text'}},
				{ display: '包装单位名称', name: 'pack_name', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addBatchHosPackage.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
