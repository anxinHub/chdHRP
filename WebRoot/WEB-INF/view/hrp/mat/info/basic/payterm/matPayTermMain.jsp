...
<script type="text/javascript">
    ...
    function add_open(){
    	...
    	var index = layer.open({
					...
					area : [ '893px', '500px' ],
					content : 'matPayTermAddPage.do?isCheck=false'
				});
				layer.full(index);
    	}
    	...
    	var data = gridManager.getCheckedRows();
                    if (data.length == 0){
                        ...
                        $.ligerDialog.confirm('确定删除?', function (yes){
                        	if(yes){
                            	ajaxJsonObjectByUrl("deleteMatPayTerm.do",{ParamVo : ParamVo},function (responseData){
    ...
    function imp(){
    	...
    	var index = layer.open({
					...
					maxmin : true, //开启最大化最小化按钮
					area : [ '893px', '500px' ],
					content : 'matPayTermImportPage.do?isCheck=false'
				});
				layer.full(index);
    	}	
    ...
    var index = layer.open({
					...
					maxmin : true, //开启最大化最小化按钮
					area : [ '893px', '500px' ],
					content : 'matPayTermImportPage.do?isCheck=false&' + parm
				});
				layer.full(index);	
