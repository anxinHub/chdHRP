...
var columns = "";
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnCount(6);  //默认最大20列如超过20列则需设置具体的最大列数
    	sheet.setColumnWidth(0, "140"); sheet.setText(0, 0, "物资类别编码");
    	sheet.setColumnWidth(1, "200"); sheet.setText(0, 1, "物资类别名称");
    	sheet.setColumnWidth(2, "100"); sheet.setText(0, 2, "是否停用");
    	sheet.setColumnWidth(3, "110"); sheet.setText(0, 3, "是否自动有效期");
    	sheet.setColumnWidth(4, "140"); sheet.setText(0, 4, "物资财务分类");
    	sheet.setColumnWidth(5, "180"); sheet.setText(0, 5, "备注");
