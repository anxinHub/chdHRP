...
<script type="text/javascript">
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("extendMatPayType.do",formPara,function(responseData){
    ...
    function extendMatPayType(){
       save();
    }
    function loadDict(){
        //字典下拉框
        autocomplete("#hos_code","../../../../acc/queryHosInfoDict.do?isCheck=false","id","text",true,true);
        autocomplete("#copy_code","../../../../acc/queryCopyDict.do?isCheck=false","id","text",true,true);
        autocomplete("#year_month","../../../../acc/queryAcctYearDict.do?isCheck=false","id","text",true,true);
     }   
    </script>
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit"  style="margin-left: 120px">
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="hos_code" type="text" id="hos_code" ltype="text"  validate="{required:true,maxlength:20}" />
                </td>
                <td align="left"></td>
            </tr> 
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="year_month" type="text" id="year_month" ltype="text"  validate="{required:true,maxlength:20}" />
                </td>
                <td align="left"></td>
            </tr> 
        </table>
