  ...
  <head>
   ...
   <jsp:include page="${path}/inc.jsp"/>
    ...
    function save(){
        ...
        ajaxJsonObjectByUrl("updateMatStoreEmp.do?isCheck=true",formPara,function(responseData){
    ...
    function loadDict(){
    	...
    	autocomplete("#emp_id","../../../../queryMatStockEmp.do?isCheck=false","id","text",true,true,'',false,'${emp_id}');   
