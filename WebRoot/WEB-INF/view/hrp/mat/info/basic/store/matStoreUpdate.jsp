...
<script type="text/javascript">
    ...
    function save(){
        ...
        var formPara={
	        ...
	        examiner : liger.get("examiner").getValue(),
        ...
        ajaxJsonObjectByUrl("updateMatStore.do",formPara,function(responseData){
    ...
    function loadDict(){
    	...
    	//从表  是否是采购库房
    	autocomplete("#is_purchase","../../../queryMatYearOrNo.do?isCheck=false","id","text",true,true);
    	...
    	//是否代销库房
    	autocomplete("#is_control","../../../queryMatYearOrNo.do?isCheck=false","id","text",true,true);
    	...
    	//是否是货位管理
    	autocomplete("#is_location","../../../queryMatYearOrNo.do?isCheck=false","id","text",true,true);
    	...
    	//是否配送
    	autocomplete("#is_add","../../../queryMatYearOrNo.do?isCheck=false","id","text",true,true);
        liger.get("is_add").setValue("${is_add}");
    	if('${is_add}'==0){
    		liger.get("is_add").setText("否");
    	}else{
    		liger.get("is_add").setText("是");
    	}
    	
    	//主管部门
    	autocomplete("#dept_id","../../../queryMatDeptIsManager.do?isCheck=false","id","text",true,true);
        liger.get("dept_id").setValue("${dept_id}");
        liger.get("dept_id").setText("${dept_name}");
        
    	//会计
    	autocomplete("#acc_emp","../../../queryMatEmp.do?isCheck=false","id","text",true,true);  
        liger.get("acc_emp").setValue("${acc_emp}");
        liger.get("acc_emp").setText("${acc_emp_name}");
        
    	//采购人
    	autocomplete("#stock_emp","../../../queryMatStockEmp.do?isCheck=false","id","text",true,true);  
        liger.get("stock_emp").setValue("${stock_emp}");
        liger.get("stock_emp").setText("${stock_emp_name}");
        
    	//库房管理员
    	autocomplete("#manager","../../../queryMatManagerEmp.do?isCheck=false","id","text",true,true);  
        liger.get("manager").setValue("${manager}");
        liger.get("manager").setText("${manager_name}");
        
        //验收员
    	autocomplete("#examiner", "../../../queryMatStockEmp.do?isCheck=false", "id", "text", true, true);  
        liger.get("examiner").setValue("${examiner}");
        liger.get("examiner").setText("${emp_code} ${emp_name}");
    ...
    function deptChange(){
    	...
    	function openUpdate(){
        	...
        	$.ligerDialog.open({ url : 'matStoreUpdateDictPage.do?isCheck=false&' + parm,data:{}, height: 350,width: 800, 
   ...
   <form name="form1" method="post"  id="form1" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" border="0">
			...
			<tr>
				<td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>是否配送：</b></td>
                <td align="left" class="l-table-edit-td">
                	<input name="is_add" type="text" id="is_add"  ltype="text"  validate="{required:false,maxlength:20}"/>
                </td>
                <td align="left"></td>
                <td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>配送地址：</b></td>
                <td align="left" class="l-table-edit-td">
                	<input name="address" type="text" id="address" value="${address}" ltype="text" validate="{required:false,maxlength:100}"/>
                </td>
                <td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td"  style="padding-left:20px;"><b>验收员：</b></td>
                <td align="left" class="l-table-edit-td">
