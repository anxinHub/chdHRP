...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ { display: '库房ID', name: 'store_id', hide : true },
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatStore.do',
                     width: '100%', height: '100%',delayLoad : true, checkbox: true,rownumbers:true,
                ...
                case "delete":
                    ...
                    if (data.length == 0){
                        ...
                        $.ligerDialog.confirm('确定删除?', function (yes){
                        	if(yes){
                            	ajaxJsonObjectByUrl("deleteMatStore.do",{ParamVo : ParamVo.toString()},function (responseData){
    ...
    function openUpdate(obj){
    	...
    	$.ligerDialog.open({ url : 'matStoreUpdatePage.do?isCheck=false&' + parm,data:{}, height: 600,width: 800, title:'修改',modal:true,showToggle:false,showMax:false,showMin: false,isResize:true,
    			buttons: [ 
