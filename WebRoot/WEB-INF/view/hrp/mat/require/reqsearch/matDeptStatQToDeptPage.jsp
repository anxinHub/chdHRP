...
<script type="text/javascript">
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid( { 
			columns: [ { 
				...
				display: '需求数量', name: 'amount', align: 'right' 
			}, { 
				display: '单价', name: 'price', align: 'right' 
			}, { 
				display: '金额', name: 'amount_money', align: 'right' 
			} ],
			dataAction: 'server', dataType: 'server', usePager:true, url:'queryMatDeptStatQToDept.do',
	...
	function print(){
		...
		var printPara={
			...
			class_name: "com.chd.hrp.mat.service.requrie.reqsearch.MatRequireReqSearchService",
			method_name: "printMatDeptStatQToDept",
			bean_name: "matRequireReqSearchService",
