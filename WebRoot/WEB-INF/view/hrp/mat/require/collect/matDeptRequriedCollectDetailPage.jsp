...
<script type="text/javascript">
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
		       columns: [ 
		                 ...
		                 dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatCollectDetail.do?isCheck=false',
	...
	function openUpdate(obj) {
		...
		$.ligerDialog.open({ 
			url : 'queryMatDeptCollectDetailPlan.do?isCheck=false&'+parm,data:{}, 
