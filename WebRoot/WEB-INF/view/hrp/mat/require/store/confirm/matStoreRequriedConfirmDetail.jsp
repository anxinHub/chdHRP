...
<script type="text/javascript">
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
		       columns: [ 
		                 ...
		                 url:'queryMatDeptConfirmDetail.do?isCheck=false',
		                 width: '100%', height: '80%', 
	...
	function audit(){
        ...
        $.ligerDialog.confirm('确定要审核吗?', 
        	function (yes){
                if(yes){
                    ajaxJsonObjectByUrl("submitMatDeptRequriedConfirm.do",{ParamVo : ParamVo.toString()},
	...
	function unaudit(){
        ...
        $.ligerDialog.confirm('确定要销审吗?', 
        	function (yes){
                if(yes){
                    ajaxJsonObjectByUrl("unSubmitMatDeptRequriedConfirm.do",{ParamVo : ParamVo.toString()},
                    	function (responseData){
                            if(responseData.state=="true"){
