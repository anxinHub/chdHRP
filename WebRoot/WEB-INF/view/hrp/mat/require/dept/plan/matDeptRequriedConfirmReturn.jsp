...
<script type="text/javascript">
	...
	function saveMatDepartRequriedConfirmReturn(){
		
		ajaxJsonObjectByUrl("returnMatDeptRequriedConfirms.do?isCheck=true&reqIds="+'${reqIds}'+'&return_reason='+$("#return_reason").val(),function(responseData) {
