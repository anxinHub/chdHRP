...
<html style="overflow:hidden;">
  <head>
	...
	function save(){
		if(validateGrid()){
			...
			var formPara = {
		        ...
		        ajaxJsonObjectByUrl("updateMatDeptRequriedPlan.do?isCheck=true", formPara, function(responseData) {
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
		       columns: [ 
						 ...
						 url:'queryMatDeptRequriedDetail.do?isCheck=false',
		                 checkbox : true,
	...
	function loadDict() {
		...
		autocomplete("#dept_code","../../../queryMatDeptDictDate.do?isCheck=false", "id", "text", true, true, {is_last: '1', read_or_write: '1'},false, false,'160');//部门
		...
		autocomplete("#store_code","../../../queryMatStoreDictDate.do?isCheck=false", "id", "text", true, true, "",false,false,'160');//仓库
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
		...
		<tr>
	        ...
	        <td align="left" class="l-table-edit-td"  colspan="8">
	            <textarea name="other_inv" type="text" style="width:680px;" id="other_inv" rows="3">${matDeptMain.other_inv}</textarea>
	        </td>
	       <td align="left"></td>     
