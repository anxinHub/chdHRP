...
<script type="text/javascript">
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
			columns: [{ 
		 		...
		 		, { 
		 			display: '金额', name: 'sum_money', align: 'right', type: 'float'
		 		}
		    ],
		    dataAction: 'server',dataType: 'server',
		    usePager:true,
		    url:'queryMatDeptSupport.do?isCheck=false',
	...
	function addNew(){
    	...
    	/* 	alert(JSON.stringify(parent.grid.getData())); */
	...
	function loadDict() {
        ...
        autocomplete("#dept_code","../../../queryMatDept.do?isCheck=false","id","text",true,true);//仓库
        ...
        $("#dept_code").ligerComboBox({disabled:true,cancelable: false});
   		...
   		//autocomplete("#store_match", "../../queryMatStoreMatch.do?isCheck=false", "id", "text", true, true, "", true);
   		autocomplete("#store_match", "../../../queryMatDeptMatch.do?isCheck=false", "id", "text", true, true,param,true);
...
<body style="padding: 0px; overflow: hidden;">
	...
	<table cellpadding="0" cellspacing="0" class="l-table-edit">
		...
		<tr>
			...
			<td align="right" class="l-table-edit-td"  style="padding-left:10px;"><font color="red">*</font>物资科室：</td>
	        <td align="left" class="l-table-edit-td"  >
