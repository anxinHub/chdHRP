...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatPurMainByCollect.do',
                ...
                case "produce":
                    ...
                    if (data.length == 0){
                       ...
                       $.ligerDialog.confirm('计划汇总后，医院采购计划将被执行，确定汇总吗?', function (yes){
                        	if(yes){
                        		ajaxJsonObjectByUrl("collectMatPurMain.do?Param="+Param,{},function (responseData){
    ...
    function openUpdate(obj){
		...
		$.ligerDialog.open({ url : 'matPurReqDetailPage.do?isCheck=false&pur_id='+pur_id,data:{}, height: 380,width: 1100, top:1,title:'请购计划单明细',modal:true,showToggle:false,showMax:true,showMin: false,isResize:true,buttons: [ { text: '关闭', onclick: function (item, dialog) { dialog.close(); } } ] });
    
    }
   
	 function loadDict(){
         //字典下拉框
        autocomplete("#pur_hos_id","../../queryMatHosInfoDict.do?isCheck=false","id","text",true,true,"",false,'${pur_hos_id}');//采购单位下拉框 
