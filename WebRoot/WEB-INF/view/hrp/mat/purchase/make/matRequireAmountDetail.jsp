...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     url:'queryMatRequireAmountDetail.do?isCheck=false&req_rela='+'${req_rela}',
    ...
    function loadDict(){    	
    	autocomplete("#inv_code", "../../queryMatInvDict.do?isCheck=false", "id", "text", true, true,{inv_id:'${inv_id}'},true);//状态 下拉框
