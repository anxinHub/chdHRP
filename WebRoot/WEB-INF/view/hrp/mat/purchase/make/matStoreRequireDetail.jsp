     ...
     function loadHead(){
    	 ...
    	 grid = $("#maingrid").ligerGrid({
             columns: [ 
                       ...
                       url:'../../require/store/plan/queryMatStoreRequriedDetail.do?isCheck=false&req_id='+'${req_id}',
		...
		//加载字典下拉框
		function loadDict() {		
			autocomplete("#stock_id","../../queryMatStore.do?isCheck=false","id","text",true,true);//仓库信息
