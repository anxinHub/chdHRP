...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			columns: [{ 
		 		 ...
		 		 { 
		 			display: '开单日期', name: 'in_date', align: 'left',formatter:'yyyy-MM-dd'
		 		},
		 		{ display: '入库',
		 		 columns : [{
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatAffiStorageQueryStockDetail.do',
			...
			toolbar: { items: [
								...
								{ line:true },
								{ text: '打印', id:'print', click: newPrint, icon:'print' },
				   				{ line:true }
			]}
		});
    ...
    function newPrint(){
    	...
    	var printPara={
    			...
    			method_name:'queryMatAffiStorageQueryStockDetailPrint',
	...
	function print(){
    	...
    	var colspan_num = grid.getColumns(1).length-1;
   		...
   		ajaxJsonObjectByUrl("queryMatAffiStorageQueryStockDetail.do?isCheck=false", selPara, function (responseData) {
...
/* 		autocomplete("#mat_type_code", "../../queryMatTypeDict.do?isCheck=false", "id", "text", true, true, {is_last : 1},false); */
	...
	/* 	autocomplete("#inv_code", "../../queryMatInv.do?isCheck=false", "id", "text", true, true,'',false,'',200); */
		autocomplete("#sup_id", "../../queryHosSup.do?isCheck=false", "id", "text", true, true,'',false,'',200);
