...
<script type="text/javascript">
    ...
    function loadDict(){
    	...
    	autocomplete("#inv_id", "../../queryMatInvDict.do?isCheck=false", "id", "text", true, true,"",false,false,'180');
    	autocomplete("#dept_id", "../../queryMatDeptDict.do?isCheck=false", "id", "text", true, true,"",false,'${dept_id}','180');
    ...
    function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [
				{ display: '材料编码', name: 'inv_code', minWidth: 100},
                { display: '材料名称', name: 'inv_name', minWidth: 140},
    		    ...
    		    { display: '有效日期', name: 'inva_date', minWidth: 50},
	 			...
	 			url : 'queryMatAffiOutDetailHistory.do?isCheck=false',parms :para,
