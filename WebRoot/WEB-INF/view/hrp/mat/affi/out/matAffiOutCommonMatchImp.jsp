...
<script type="text/javascript">
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
		       columns: [ {display: '材料ID', name: 'inv_id', align: 'left'},
		                 ...
		                 url:'queryMatAffiOutMatchDetail.do?isCheck=false',
	...
	function addNew(){
        ...
        ajaxJsonObjectByUrl("queryMatAffiOutDetailByMatch.do?isCheck=false",para,function(responseData){
	...
	function loadDict() {
		...
		autocomplete("#store_match", "../../queryMatDeptMatch.do?isCheck=false", "id", "text", true, true,"",true);
