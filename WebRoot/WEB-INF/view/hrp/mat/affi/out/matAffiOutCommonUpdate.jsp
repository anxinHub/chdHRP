  ...
  <head>
   ...
   //键盘事件
	...
	function loadDict(){
    	...
    	//autocomplete("#bus_type_code", "../../queryMatBusType.do?isCheck=false", "id", "text", true, true,{codes:'5,7,9,28,30,32,33,34'},false,'${bus_type_code}','180');
    	autocomplete("#bus_type_code", "../../queryMatBusType.do?isCheck=false", "id", "text", true, true,{codes:'5,7,9,28,32,33,34'},false,'${bus_type_code}','180');
    	...
    	autocomplete("#dept_emp", "../../queryMatEmpDict.do?isCheck=false", "id", "text", true, true,"",false,'${dept_emp}',180);
	...
	function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
			...
			url:'queryMatAffiOutDetaillByCode.do?isCheck=false&out_id=${out_id}&store_id='+store_id,
