...
<head>
    ...
    function checkMatOutFifo(){
    	...
    	if(gridFifo ==null){//没有点击加号的情况下
    		...
    		ajaxJsonObjectByUrl("queryMatAffiOutByFifoBalance.do?isCheck=false",para,function(responseData){
    ...
    function loadDict(){
    	...
    	autocomplete("#inv_id", "../../queryMatInvDict.do?isCheck=false", "id", "text", true, true,{is_com : '1'},false,false,'280');   	
    ...
    function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [
				...
				url:'queryMatAffiOutByInvHold.do?isCheck=false',enabledEdit : true,fixedCellHeight:true,
         ...
         gridFifo = $(eleFifo).css('margin',1).ligerGrid({
             columns:
						...
						dataAction : 'server',dataType : 'server',usePager : false,checkbox: true,
			 			parms :para,
			 			url : 'queryMatAffiOutByFifoBalance.do?isCheck=false',enabledEdit : true,fixedCellHeight:true,
			 			width: '100%',height : '90%',
			 			frozen:false
         });  
     }
