...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	...
	$("#dept_id").bind("change",function(){
     ...
     function  save(){
    	...
    	if(validateGrid()){
	        ...
	        ajaxJsonObjectByUrl("addMatAffiOutBackCommon.do?isCheck=true",formPara,function(responseData){
    ...
    function loadDict(){
    	...
    	autocomplete("#bus_type_code", "../../queryMatBusType.do?isCheck=false", "id", "text", true, true, {codes:'30'},true,'28');
    ...
    function loadHead() {
		grid = $("#maingrid").ligerGrid({
			columns : [{
		         		...
		         		grid : {
		         			columns : [ 
		         				...
		         				{display: '单价', name: 'price', align: 'right', width:140,
		         					...
		         					display : '出库数量', name : 'cur_amount', width : 100, align : 'right'
		         				}, {
		         			...
		         			url : '../../queryMatAffiOutBackInvList.do?isCheck=false&store_id=' 
		         					...
		         					+ liger.get("dept_id").getValue().split(",")[0] ,
		         			pageSize : 500,
				...
				}, {display : '出库数量', name : 'cur_amount', minWidth : 140, align : 'right'	
