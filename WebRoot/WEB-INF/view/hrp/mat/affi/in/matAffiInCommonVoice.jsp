...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     ...
     function loadHead(){
    	 var matInMainList = ${matAffiInMain};
       	 ...
       	 grid =$(detailGrid).css('margin',10).ligerGrid({
             columns:
                    ...
                    width:'98%',height:'auto',isScoll:true ,allowAdjustColWidth : false , frozen : false ,isAddRow:false,
			 		url : '../../bill/matbillmain/queryMatInDetail.do?isCheck=false&flag=1&in_id='+row.in_id+'&bill_id='+row.bill_id+'&init='+row.init ,
                    	...
                    	if(yes){
                    		 ajaxJsonObjectByUrl("../../bill/matbillmain/addMatBillMain.do?isCheck=false",formPara,function(responseData){
                   	            if(responseData.state=="true"){
                   	                ajaxJsonObjectByUrl("../../bill/matbillmain/addMatBillDetail.do?isCheck=false",{bill_id:responseData.bill_id,bill_no:responseData.bill_no,ParamVo : ParamVo.toString()},function (responseData){
                                   		if(responseData.state=="true"){
