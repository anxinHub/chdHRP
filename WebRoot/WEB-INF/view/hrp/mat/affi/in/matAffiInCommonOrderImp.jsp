...
<script type="text/javascript">
	...
	function loadHead() {
		grid = $("#maingrid").ligerGrid({
		       columns: [ 
		                 ...
		                 dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatAffiInOrder.do?isCheck=false',
	...
	function update_open(obj){
		...
		$.ligerDialog.open({
			...
			height: 550,
			width: 1000,
			url: 'matAffiInCommonOrderImpDetail..do?isCheck=false&' + paras.toString(),
