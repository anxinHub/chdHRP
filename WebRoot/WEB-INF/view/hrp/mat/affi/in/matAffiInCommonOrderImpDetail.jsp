...
<html style="overflow:hidden;">
  <head>
    ...
    function loadDict(){
    	//字典下拉框
    	alert('${matOrderMain.sup_id}');
    	alert('${matOrderMain.sup_no}');
    	autocomplete("#sup_code", "../../queryHosSupDict.do?isCheck=false", "id", "text", true, true, "", false, '${matOrderMain.sup_id},${matOrderMain.sup_no}');//供应商
    	...
    	autocomplete("#pay_type", "../../queryMatPayType.do?isCheck=false", "id", "text", true, true, "", false, '${matOrderMain.pay_code}');//付款方式
		autocomplete("#dept_code", "../../queryPurDept.do?isCheck=false", "id", "text", true, true, "", false, '${matOrderMain.dept_id},${matOrderMain.dept_no}');//采购部门
    ...
    function loadHead() {
		grid = $("#maingrid").ligerGrid({
			columns : [
			           ...
			           {display : '材料名称(E)',name : 'inv_name',minWidth : 120,align : 'left'}, 
			...
			dataType : 'server',
			usePager : false,
			url : 'queryMatAffiInOrderImpDetail.do?isCheck=false',
			width : '90%',
			height : '67%',
			alternatingRow : true,			
			isScroll : true,
