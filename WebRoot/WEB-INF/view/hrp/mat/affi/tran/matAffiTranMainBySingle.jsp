...
<script type="text/javascript">
 ...
 function loadForm(){
    ...
    function checkMatOutFifo(){
		...
		ajaxJsonObjectByUrl("queryMatAffiTranDetailBySingle.do?isCheck=false",para,function (responseData){
    ...
    function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [
                ...
                { display: '制单人', name: 'maker_user', width: 80},
                { display: '入库日期', name: 'in_date', width: 80 },
                { display: '确认人', name: 'confirmer_user', width: 80},
                { display: '确认日期', name: 'confirm_date', width: 80}
				],
					dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatInMainBySingle.do?isCheck=false',fixedCellHeight:true,
					isScroll : true,selectRowButtonOnly:true,isSingleCheck:true,heightDiff: 10,checkbox: true,
         ...
         gridDetail = $(ele).css({'margin-top':10, 'margin-left':60}).ligerGrid({
             columns:
						...
						dataAction : 'server',dataType : 'server',usePager : false,
			 			parms :para,
			 			url : 'queryMatInDetailBySingle.do?isCheck=false',fixedCellHeight:true,
			 			width: '80%',height : '100%',
			 			frozen:false
         });  
     }
				...
				<form name="form1" method="post"  id="form1" >
			        ...
			        <tr>
			           ...
			           <td align="right" class="l-table-edit-td"  style="padding-left:20px;">入库日期：</td>
			            <td align="left" class="l-table-edit-td"><input name="in_date_start" type="text" id="in_date_start" ltype="text" class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"/></td>
			            <td align="left"></td>
			           <td align="right" class="l-table-edit-td"  style="padding-left:20px;">至：</td>
			            <td align="left" class="l-table-edit-td"><input name="in_date_end" type="text" id="in_date_end" ltype="text" class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"/></td>
			            <td align="left"></td>
