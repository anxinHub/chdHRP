...
<html style="overflow:hidden;">
    ...
    <script type="text/javascript">
     ...
     function  save(){
    	if(validateGrid()){
            ...
            ajaxJsonObjectByUrl("addMatInitAffiIn.do?isCheck=true",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
		...
		autocomplete("#store_code", "../../queryMatStoreDictDate.do?isCheck=false", "id", "text", true, true, {is_com : '1',is_write:'1'}, true);
