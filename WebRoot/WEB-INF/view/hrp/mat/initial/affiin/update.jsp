...
<html style="overflow:hidden;">
  <head>
   ...
   //验证
     ...
     function  save(){
    	if(validateGrid){
    		...
    		var formPara={
    	        ...
    	        ajaxJsonObjectByUrl("updateMatInitAffiIn.do?isCheck=true",formPara,function(responseData){
    ...
    function loadDict(){
    	//字典下拉框
    	autocomplete("#bus_type_code", "../../queryMatBusType.do?isCheck=false", "id", "text", true, true, {sel_flag : 'init'}, false, '${matInMain.bus_type_code}');//业务类型
		autocomplete("#store_code", "../../queryMatStoreDictDate.do?isCheck=false", "id", "text", true, true, {is_com : 1,is_write:'1'}, false, '${matInMain.store_id},${matInMain.store_no}');//仓库
    ...
    function loadHead() {
    	grid = $("#maingrid").ligerGrid({
				...
				hide: true
					...
					editor : {
						...
						grid : {
							...
							url : '../../queryMatInvList.do?isCheck=false&is_com=1&store_id=' 
			...
			dataType : 'server',
			usePager : false,
			url : 'queryMatInitAffiInDetail.do?isCheck=false',
			width : '100%',
			height : '93%',
			checkbox : true,
			...
			toolbar : {
				items : [ { 
					...
					text : '入库确认（<u>F</u>）', id : 'confirm', click : confirm_in, icon : 'up'
				}, */ {
    ...
    function printDate(){
		...
		var para={
				template_code:'04009',
				class_name:"com.chd.hrp.mat.serviceImpl.initial.MatInitAffiInServiceImpl",
  ...
  //打印设置
	function printSet(){
		...
		officeFormTemplate({template_code:"04009",use_id:useId});
	}
	...
	function imp(){
		...
		$.ligerDialog.open({
			...
			url: 'matInitAffiInImprotPage.do?isCheck=false', 
	...
	function confirmData(confirmDate){
		...
		$.ligerDialog.confirm('确定入库确认?', function (yes){
			if(yes){
				ajaxJsonObjectByUrl("confirmMatInitAffiIn.do?isCheck=true",formPara,function (responseData){
					if(responseData.state=="true"){
						query();
					}
				});
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
	        ...
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="in_no" type="text" id="in_no" value="${matInMain.in_no}" ltype="text" />
	            </td>
	        ...
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input class="Wdate" name="in_date" id="in_date" type="text" value="${matInMain.in_date}" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})"/>
	            </td>
	            <td align="right" class="l-table-edit-td"  ><font color="red">*</font>供应商：</td>
	            <td align="left" class="l-table-edit-td">
	            	<input name="sup_code" type="text" id="sup_code" ltype="text" validate="{required:true}" />
	            </td>
	        </tr> 
	        <tr>
	            <td align="right" class="l-table-edit-td" >
	            ...
	            <td align="left" class="l-table-edit-td" colspan="5">
	            	<input name="brief" type="text" id="brief" ltype="text" value="${matInMain.brief}" validate="{required:true,maxlength:50}" />
	            </td>
	        </tr>
	    </table>
    </form>
