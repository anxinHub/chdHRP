...
<html style="overflow: hidden;"  xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	function  save(){
		...
		if($("#store_code").val() == $("#in_store_code").val()){
			$.ligerDialog.warn('移出库房和移入库房不能相同！');
            return false;
		}
		...
		if(liger.get("store_code").getValue() == liger.get("in_store_code").getValue()){
			$.ligerDialog.warn('移出库房与移入库房不能一致！');
			return false;
		}
        ...
        ajaxJsonObjectByUrl("addMatDuraTranStoreStore.do", formPara, function(responseData){
	...
	function loadDict(){
		...
		autocompleteAsync("#in_store_code", "../../../queryMatStoreAll.do?isCheck=false", "id", "text", true, true, "", true);
