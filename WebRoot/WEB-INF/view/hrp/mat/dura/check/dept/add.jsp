...
<html style="overflow: hidden;"  xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	function  save(){
        ...
        ajaxJsonObjectByUrl("addMatDuraCheckDept.do", formPara, function(responseData){
	...
	function loadHead(){
		grid = $("#maingrid").ligerGrid({
			...
			toolbar: { items: [ 
								...
								{ line:true } ,
         						{ text: '导入当前库存', id:'imp', click: importInv,icon:'up' } 
			 ] }, 
		});
	...
	function importInv(){
		...
		ajaxJsonObjectByUrl("queryMatInvByBalance.do?isCheck=false", {dept_id : dept_id},
