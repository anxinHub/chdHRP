...
<html style="overflow: hidden;"  xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	var state = "${matDuraStoreScrap.state}";
	...
	function  save(){
        ...
        ajaxJsonObjectByUrl("updateMatDuraScrapStore.do", formPara, function(responseData){
	...
	function loadDict(){
    	...
    	if('${matDuraStoreScrap.store_id}'){
			liger.get("store_code").setValue('${matDuraStoreScrap.store_id},${matDuraStoreScrap.store_no}');
			liger.get("store_code").setText('${matDuraStoreScrap.store_code} ${matDuraStoreScrap.store_name}');
    	}
 	...
 	function queryDetail(){
 		...
 		grid.options.parms.push({
 			name: 'scrap_id', 
 			value: '${matDuraStoreScrap.scrap_id}'
 		});
 		grid.options.parms.push({
 			name: 'store_id', 
 			value: '${matDuraStoreScrap.store_code}'.split(",")[0]
 		});
    ...
    function loadHead(){
		grid = $("#maingrid").ligerGrid({
			...
			dataAction: 'server', dataType: 'server', url: 'queryMatDuraScrapStoreDetailByCode.do?isCheck=false', delayLoad: true, //初始化明细数据
	...
	function printDate(){
		...
		printTemplate("hrp/mat/dura/scrap/store/queryDataByPrintTemlate.do", para); */
	}
	...
	function printSet(){
		...
		officeFormTemplate({template_code:"041323",use_id:useId});
		/* parent.parent.$.ligerDialog.open({url: 'hrp/mat/dura/scrap/store/printSetPage.do?template_code=041309&use_id='+useId, 
	...
	<input name="hos_id"  type="hidden" id="hos_id" value="${matDuraStoreScrap.hos_id}" />
	<input name="group_id"  type="hidden" id="group_id" value="${matDuraStoreScrap.group_id}" />
	<input name="copy_code"  type="hidden" id="copy_code" value="${matDuraStoreScrap.copy_code}" />
	<input name="scrap_id"  type="hidden" id="scrap_id" value="${matDuraStoreScrap.scrap_id}" />
	<div id="layout1">
		<div position="top">
				...
				<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
					<tr>
						...
						<td align="left" class="l-table-edit-td">
							<input name="scrap_no" type="text" id="scrap_no" disabled="disabled" ltype="text" value="${matDuraStoreScrap.scrap_no}"/>
						</td>
						...
						<td align="left" class="l-table-edit-td">
							<input name="make_date" type="text" id="make_date" ltype="text"  validate="{required: true}"  value="${matDuraStoreScrap.make_date}" class="Wdate" onFocus="WdatePicker({isShowClear: true, readOnly: false, dateFmt: 'yyyy-MM-dd'})"/>
						</td>
					...
					<tr>
						...
						<td align="left" class="l-table-edit-td" colspan="3">
							<textarea class="l-textarea" name="brief" id="brief" rows="3" style="width: 380px;">${matDuraStoreScrap.brief}</textarea>
						</td>
					</tr>
				</table>
			</form>
