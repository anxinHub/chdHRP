...
<body>
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
        <tr>
            ...
            <td align="right" class="l-table-edit-td table-star">仓库：</td>
            <td align="left" class="l-table-edit-td">
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td">
                <table>
                    <tr>
                        <td align="left">
                            <input id="begin_dura_date" class="Wdate" name="begin_dura_date" type="text" ltype="text"/>
                        </td>
                        <td align="left" class="l-table-edit-td">至：</td>
                        <td align="left" class="l-table-edit-td">
                            <input id="end_dura_date" class="Wdate" name="end_dura_date" type="text" ltype="text"/>
                        </td>
                    </tr>
                </table>
            </td>

            <td align="right" class="l-table-edit-td">资金标注：</td>
            <td align="left" class="l-table-edit-td">
                <input id="" name="" type="text" ltype="text" />
            </td>
        </tr>
    </table>
    ...
    <script>
        ...
        var loadHead = function () {
            grid = $("#mainGrid").ligerGrid({
                columns: [
                    { display: "单据号", name: "", width : 140 },
                    { display: "科室", name: "", width: 120 },
                    { display: "日期", name: "", width: 120 },
                    { display: "摘要", name: "", width: 120 },
                    { display: "金额", name: "", width: 120 },
                    { display: "制单人", name: "", width: 100 },
                    { display: "确认人", name: "", width: 100 },
                    { display: "状态", name: "", width: 100 }
                ],
                toolbar: {
                    items: [
                        { text: "确认（<u>S</u>）", id: "audit", click: audit, icon: "audit" },
                        { line: true },
                        { text: "取消确认（<u>U</u>）", id: "unaudit", click: unAudit, icon: "unaudit" },
                        { line: true },
