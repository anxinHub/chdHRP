...
<html style="overflow: hidden;"  xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	function  save(){
        ...
        ajaxJsonObjectByUrl("addMatDuraScrapDept.do", formPara, function(responseData){
            if(responseData.state=="true"){
            	parentFrameUse().query();
            	$.ligerDialog.confirm('是否继续添加报废单?', function (yes){
            		if(yes){
            			$("#brief").val("");
            			loadDict();
                        grid.reload();
				...
				<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
			       <tr>
			            ...
			            <td align="left" class="l-table-edit-td">
			            	<input name="scrap_no" type="text" id="scrap_no" disabled="disabled" ltype="text" value="自动生成"/>
			            </td>
