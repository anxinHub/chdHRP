...
<script type="text/javascript">
	...
	function  save(){
        ...
        ajaxJsonObjectByUrl("addMatCheckMain.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	//autocompleteAsync("#dept_id", "../../queryMatPDDeptDict.do?isCheck=false", "id", "text", true, true,{is_last : 1},true,false,'180');
    	autocompleteAsync("#dept_id", "../../queryMatDeptDictDate.do?isCheck=false", "id", "text", true, true,{is_last : 1,is_write:1},false,false,'180');
    	//autocompleteAsync("#emp_id", "../../queryMatEmpDict.do?isCheck=false", "id", "text", true, true,{dept_id: liger.get("dept_id").getValue().split(",")[0]},true,false,'180');
    	autocompleteAsync("#emp_id", "../../queryMatEmp.do?isCheck=false", "id", "text", true, true,{is_last : 1},false,false,'180');
    } 
		...
		if (selectData != "" || selectData != null) {
			if (column_name == "inv_id") {
				grid.updateRow(rowindex_id, {
				    ...
				    inv_msg:data.inv_msg == null ? "" : data.inv_msg
				});
			}
		}
		return true;
