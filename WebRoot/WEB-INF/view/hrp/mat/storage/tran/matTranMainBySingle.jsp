...
<script type="text/javascript">
 ...
 function loadForm(){
    ...
    function checkMatOutFifo(){
		...
		ajaxJsonObjectByUrl("queryMatTranDetailBySingle.do?isCheck=false",para,function (responseData){
    ...
    function loadDict(){
    	...
    	autocomplete("#store_id", "../../queryMatStoreDictDate.do?isCheck=false", "id", "text", true, true, {store_id:'${store_id}'}, false,"","","",200);
  		liger.get("store_id").setValue("${store_id}");
  		liger.get("store_id").setText("${store_code} ${store_name}");
  		
    	 
    	/*  autocomplete("#store_id", "../../queryMatStore.do?isCheck=false", "id", "text", true, true,"",true,'${store_id}','180');
                ...
                { display: '金额', name: 'money', width: 80,
					...
					isScroll : true,selectRowButtonOnly:true,isSingleCheck:false,heightDiff: 10,checkbox: true,
                     ...
                     toolbar: { items: [
				                     	...
				                     	{ line:true },
				                     	{ text: '生成调拨单', id:'add', click: checkMatOutFifo,icon:'add' },
				                     	{ line:true },
