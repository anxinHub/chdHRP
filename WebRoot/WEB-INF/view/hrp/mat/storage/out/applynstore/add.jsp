...
<html style="overflow:hidden;">
  <head>
    ...
    <script type="text/javascript">
     var grid; 
     var gridManager;
     var isAutoCheck = '${p04016 }' == 1 ? true : false;
     var cur_date = '';
     var is_zero =0;
     var is_apply = 1;
     $(function (){
     ...
     function  save(){
    	 if(validateGrid()){
 	        ...
 	        ajaxJsonObjectByUrl("addMatCommonOutApplyN.do",formPara,function(responseData){
...
function loadForm(){
    ...
    function loadDict(){
    	//字典下拉框
		autocompleteAsync("#store_code", "../../../queryMatStoreDictDate.do?isCheck=false", "id", "text", true, true, {is_read:'1'}, false);
    	...
    	autocomplete("#apply_dept", "../../../queryMatDept.do?isCheck=false", "id", "text", true, true, {is_last: 1,read_or_write:'1'},true, true, 250, true, 220);	
    /* 	autocomplete("#apply_dept", "../../../queryMatDeptDictDate.do?isCheck=false", "id", "text", true, true, {is_last : 1,is_write:'1'}, false, false, 250, false, 250);
    	...
    	//autocomplete("#app_emp", "../../../queryMatEmp.do?isCheck=false", "id", "text", true, true, {dept_id : liger.get("apply_dept").getValue().split(",")[0]}, false);
    	//科室绑定change事件
		/* $("#apply_dept").bind("change",function(){
			if(liger.get("apply_dept").getValue()){
		    	...
		    	autocomplete("#app_emp", "../../../queryMatEmp.do?isCheck=false", "id", "text", true, true, para, false);
			}
		}) */
		
		//台州医院要求领料人不绑定仓库
		autocomplete("#app_emp", "../../../queryMatEmp.do?isCheck=false", "id", "text", true, true, "", false);
		if("${user_msg.emp_id}"){
				...
				editor : {
					...
					grid : {
						...
						onSelectRow: function (data) {
		         		...
		         		gid: 'invGrid', 
						url : liger.get("store_code").getValue() ? '../../../queryMatInvList.do?isCheck=false&store_id='+ liger.get("store_code").getValue().split(",")[0]+'&cur_date='+cur_date+ '&is_zero=' + is_zero+ '&is_apply=' + is_apply
							: '../../../queryMatInvListNotStore.do?isCheck=false&cur_date='+cur_date+ '&is_zero=' + is_zero,
						pageSize : 200,
		...
		if (selectData != "" || selectData != null) {
			if (column_name == "inv_id") {
				grid.updateRow(rowindex_id, {
					...
					inv_structure : data.num_exchange == null ? "" : data.num_exchange+""+data.unit_name+"/"+data.pack_name
	...
	<form name="form1" method="post"  id="form1" >
		<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input class="Wdate" name="app_date" id="app_date" type="text" required="true" value="${app_date}" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd HH:mm:ss'})" validate="{required:true}" />
	            </td>
	            <td align="right" class="l-table-edit-td"  >
			...
			<tr>
			  <td align="right" class="l-table-edit-td">不显示零库存材料：</td>
                <td align="left" class="l-table-edit-td">
                    <input name="is_zero" type="checkbox" id="is_zero" ltype="text" onclick="changeColumn()"  />
