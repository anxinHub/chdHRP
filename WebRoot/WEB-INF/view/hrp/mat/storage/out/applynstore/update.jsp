    ...
    <script type="text/javascript">
     ...
     function  save(){
    	 if(validateGrid()){
 	        ...
 	        ajaxJsonObjectByUrl("updateMatCommonOutApplyN.do",formPara,function(responseData){
...
function loadForm(){
    ...
    function loadDict(){
		...
		autocompleteAsync("#apply_dept", "../../../queryMatDeptDictDate.do?isCheck=false", "id", "text", true, true, {is_last: 1,is_write:'1'}, false, false, 250, false, 250);
