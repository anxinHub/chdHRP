...
<script type="text/javascript">
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	if(parentData.matOutMain.stock_id){
	    	liger.get("store_id").setValue(parentData.matOutMain.stock_id+","+parentData.matOutMain.store_no);
    	...
    	if(parentData.matOutMain.dept_emp){
	    	liger.get("dept_emp").setValue(parentData.matOutMain.dept_emp+","+matOutMain.emp_no);
	    	liger.get("dept_emp").setText(matOutMain.emp_code+" "+parentData.matOutMain.emp_name);
    	}
    	...
    	if(parentData.matOutMain.proj_id){
        	...
        	liger.get("proj_code").setText(parentData.matOutMain.proj_code+" "+matOutMain.proj_name);
    	} 
	...
	function loadHead(){
		...
		grid = $("#maingrid").ligerGrid({
			...
			//url : 'queryMatDeptRequireDetail.do?isCheck=false&req_ids='+'${mainMap.req_ids}'+'&req_detail_ids='+'${mainMap.req_detail_ids}',
			data: matOutDetail, 
