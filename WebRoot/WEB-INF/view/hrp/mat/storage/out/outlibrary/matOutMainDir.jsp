 ...
 function loadForm(){
    ...
    function checkMatOutFifo(){
    	...
    	var para={
         ...
         ajaxJsonObjectByUrl("queryMatOutDetailByIsDir.do?isCheck=false",para,function (responseData){
         	...
         	if(dept_id){
	         	parent.liger.get("dept_id").setValue(dept_id+","+dept_no);
	         	parent.liger.get("dept_id").setText(dept_code+" "+dept_name);
         	}
         	parent.$("#is_dir").val('1');
         	dialog.close();
     	});
    ...
    function loadDict(){
       ...
       var id=dept.split(",")[0];
       console.log(dept)
    	autocomplete("#store_id", "../../../queryMatStoreDictDate.do?isCheck=false", "id", "text", true, true,"",false,'${store_id}','180');
    	autocomplete("#dept_id", "../../../queryMatDeptDict.do?isCheck=false", "id", "text", true, true,{is_last: 1},false,'${dept_id}','180');
    ...
    function loadHead(){
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [
                ...
                { display: '领料科室', name: 'dept_name', align: 'left', width: 160},
                ...
                { 
					...
					dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatInMainByIsDir.do?isCheck=false',fixedCellHeight:true,
         ...
         gridDetail = $(ele).css({'margin-top':10, 'margin-left':60}).ligerGrid({
             columns:
						...
						dataAction : 'server',dataType : 'server',usePager : false,
			 			parms :para,
			 			url : 'queryMatInDetailByIsDir.do?isCheck=false',fixedCellHeight:true,
			 			width : '90%',
			 			frozen:false
         });  
     }
