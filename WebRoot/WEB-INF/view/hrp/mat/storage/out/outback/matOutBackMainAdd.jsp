...
<script type="text/javascript">
    ...
    //已选中的材料,下拉框中不再显示,不可重复选择
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addMatOutBackMain.do",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
    	...
    	autocompleteAsync("#bus_type_code", "../../../queryMatBusType.do?isCheck=false", "id", "text", true, true,bus_type_code_paras,true);
    ...
    function loadDictDeptId (value) {
    	autocompleteAsync("#dept_id", "../../../queryMatDeptDictDate.do?isCheck=false", "id", "text", true, true, {is_last: 1,is_write:"1"}, true, value);
    }
		...
		grid = $("#maingrid").ligerGrid({
			columns: [ { 
				...
				display: '生产厂商', name: 'fac_name', align: 'left', width: 120
	         	...
	         	display: '出库数量', name: 'cur_amount', align: 'right', width: 90
	         }/* , { 
