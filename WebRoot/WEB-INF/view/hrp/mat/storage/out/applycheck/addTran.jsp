...
<script type="text/javascript">
	...
	var apply_id = "${matTranMain.apply_id}";
	var is_add = "${matTranMain.is_add}";
	...
	function  save(){
        ...
        //ajaxJsonObjectByUrl("../../../tran/addMatTranMain.do",formPara,function(responseData){
		ajaxJsonObjectByUrl("addMatTranMainByApp.do?isCheck=true",formPara,function(responseData){
 ...
 function loadForm(){
    ...
    function loadDict(){
		...
		if("${matTranMain.tran_no}"){
			$("#tran_no").val("${matTranMain.tran_no}");
		}
		...
		autocompleteAsync("#out_store_id", "../../../queryMatStore.do?isCheck=false", "id","text", true, true, {hos_id : "${matTranMain.out_hos_id}",is_com:'0'}, false, false, '180');
		...
		if("${matTranMain.tran_date}"){
			$("#tran_date").val("${matTranMain.tran_date}");
		}else{
			autodate("#tran_date");
		}
	} 
								    ...
								    keySupport:true,
							      	...
							      	grid :{
								    	columns : [ 
				        	         		...
				        	         		url : '../../../queryMatStockInvList.do?isCheck=false&is_com=0&store_id=' 
