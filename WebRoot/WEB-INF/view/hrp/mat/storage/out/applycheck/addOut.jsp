	...
	<div id="layout1">
		<div position="top">
				<form name="form1" method="post"  id="form1" >
		            ...
		            <td align="left" class="l-table-edit-td">
		            	<input class="Wdate" name="app_date" id="app_date" type="text" value="${matOutMain.app_date}" required="true" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" validate="{required:true}"  disabled="disabled"/>
		            </td>
			        </tr> 
