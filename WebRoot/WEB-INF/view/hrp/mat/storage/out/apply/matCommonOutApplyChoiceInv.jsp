...
<script type="text/javascript">
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					{ display: '交易编码', name: 'bid_code', align: 'left', width: '120'},
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'../../../queryMatInvListApply.do?isCheck=false',
  ...
  //确定添加
    ...
    function loadDict(){ 
        //字典下拉框
        autocompleteAsync("#sup_id", "../../../queryHosSupDict.do?isCheck=false", "id", "text", true, true);
    	autocompleteAsync("#store_id", "../../../queryMatStore.do?isCheck=false", "id", "text", true, true,{store_id : '${store_id}'},true,'${store_id}');
...
//     	$("#is_stop").prop("checked",true);
    	...
    	$("#sup_id").ligerComboBox({width:180}); 
...
<body style="padding: 0px; overflow: hidden;">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit">
        ...
        <tr>
			...
			<td align="left" class="l-table-edit-td" style="width:200px;"><input name="sup_id" type="text" id="sup_id" ltype="text"/></td>
			<td align="left"></td>
		</tr> 
		<tr>
		...
		<td>不显示停用材料<input name="is_stop" type="checkbox" id="is_stop" ltype="text" /></td>
