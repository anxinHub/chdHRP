...
<head>
    ...
    function save() {
        ...
        if (validateGrid()) {
            ...
            ajaxJsonObjectByUrl("addMatCommonOutApply.do", formPara, function(responseData) {
                if (responseData.state == "true") {
    ...
    function loadDict() {
        ...
        autocompleteAsync("#apply_dept", "../../../queryMatDeptDictDate.do?isCheck=false", "id", "text", true, true, { is_last: 1 ,is_write:'1'}, true, true);
		...
		//申领人
        autocomplete("#app_emp", "../../../queryMatEmp.do?isCheck=false", "id", "text", true, true,"",false,'${empCode}');
        //autocompleteAsync("#app_emp", "../../../queryMatEmp.do?isCheck=false", "id", "text", true, true, {dept_id : liger.get("apply_dept").getValue().split(",")[0]}, true,true);
    ...
    function choice_inv() {
        ...
        $.ligerDialog.open({
            url: "matCommonOutApplyChoiceInvPage.do?isCheck=false&store_id=" + store_id + "&store_no=" + store_no,
            height: 500,
            width: 900,
            title: '选择材料',
            modal: true,
    ...
    function history_imp() {
        ...
        $.ligerDialog.open({
            ...
            width: $(window).width(),
            url: 'historyImpPage.do?isCheck=false&' + para,
            modal: true,
            showToggle: false,
            showMax: true,
            showMin: false,
