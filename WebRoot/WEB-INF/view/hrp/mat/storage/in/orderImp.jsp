...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatStorageInOrder.do?isCheck=false',
    ...
    function imp(){
		...
		if (data.length == 0){
			...
			$.ligerDialog.confirm('确定生成入库单?', function (yes){
				if(yes){
					ajaxJsonObjectByUrl("queryMatStorageInOrderDetail.do?isCheck=false",{ParamVo : ParamVo.toString()},function (responseData){
