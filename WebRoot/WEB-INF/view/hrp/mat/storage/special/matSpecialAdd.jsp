     ...
     $(function (){
		...
		$("#store_id").bind("change",function(){
	    	...
	    	liger.get("store_id").reload();
 			...
 			grid.columns[4].editor.grid.url = '../../queryMatInvListSpecial.do?isCheck=false&store_id='+ liger.get("store_id").getValue().split(",")[0]+'&sup_id=' + liger.get("sup_id").getValue().split(",")[0];
	    	
	    	store_id = liger.get("store_id").getValue().split(",")[0]; 
			autocomplete("#stocker", "../../queryMatStockEmpByStore.do?isCheck=false", "id", "text", true, true,{store_id:store_id}, true,'',180);
 			//loadHead();
	    	grid.reRender();
		})
...
// 				} 
		...
		if(msg != ""){
 		...
 		var protocolCode =liger.get("protocol_code").getValue() == null ? "" : liger.get("protocol_code").getValue().split(",")[0];
     ...
     function  save(){
    	...
    	if(validateGrid()){
	        ...
	        ajaxJsonObjectByUrl("addMatSpecial.do?isCheck=false",formPara,function(responseData){
		...
		grid = $("#maingrid").ligerGrid({
			columns : [ {
						...
						editor : {
							...
							grid : {
								columns : [ 
										...
										{display : '转换量', name : 'num_exchange', width : 60, align : 'left'
											}, 
						...
						display : '金额', name : 'amount_money', width : 90, type : 'number', align : 'right',
							render : function(rowdata, rowindex, value) {
								rowdata.amount_money = value == null ? "" : formatNumber(value, '${p04006}', 0);
								return value == null ? "" : formatNumber(value, '${p04006 }', 1);
							},
							totalSummary:{render: function (suminf, column, cell){
								
		                            return '<div>'+formatNumber(suminf.sum, '${p04006}', 1)+'</div>';
		                    	},align: 'left'},
					}, {
  ...
  //批量添加材料
    function invBatch(){
    	...
    	$.ligerDialog.open({
			...
			height: 550,
			width: 1000,
			url: 'matSpecailInvBatchImpPage.do?isCheck=false&' + para,
    ...
    function sup_imp(){
    	...
    	parent.$.ligerDialog.open({ url:'hrp/mat/storage/special/sup_ImpPage.do?isCheck=false&'+para,
    ...
    function downTemplate(){
    	location.href = "downTemplateMatCommonIn.do?isCheck=false";
    	return;
    }
...
// 		}
	...
	function loadDict(){
    	...
    	//仓库下拉框
		autocompleteAsync("#store_id", "../../queryMatStore.do?isCheck=false", "id", "text", true, true, {is_purchase:1}, true,'',180);
		//供应商
		...
		//采购类型
		autocomplete("#stock_type_code", "../../queryMatStockType.do?isCheck=false", "id", "text", true, true,'', true,'',180);
		...
		//采购类型
		autocomplete("#examiner", "../../queryMatStockEmp.do?isCheck=false", "id", "text", true, true,'', false,'',180);
        ...
        $("#patient_sex").ligerTextBox({width:280});
	...
	<form name="form1" method="post"  id="form1" >
		<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td" width="20%">
	            	<input class="Wdate" name="make_date" id="make_date" type="text"  onchange="changeIndate()" onFocus="WdatePicker({isShowClear:true,readOnly:false,dateFmt:'yyyy-MM-dd'})" validate="{required:true}" />
	            </td>
    ...
    <table>
    	<tr>
			  <td align="right" class="l-table-edit-td" width="10%"><b>病人姓名:</b></td>
	            <td align="left" class="l-table-edit-td" width="20%">
	            	<input name="patient_name" type="text" id="patient_name" ltype="text" validate="{maxlength:100}" />
	            </td>
	            
	             <td align="right" class="l-table-edit-td" width="10%"><b>住院号:</b></td>
	            <td align="left" class="l-table-edit-td" width="20%">
	            	<input name="hospital_no" type="text" id="hospital_no" ltype="text" validate="{maxlength:100}" />
	            </td>
			
			
			   <td align="right" class="l-table-edit-td" width="10%"><b>床位号:</b></td>
	            <td align="left" class="l-table-edit-td" width="20%">
	            	<input name="beds_no" type="text" id="beds_no" ltype="text" validate="{maxlength:100}" />
	            </td>
			</tr>
			...
			<tr>
			 <!--  <td align="right" class="l-table-edit-td" width="10%"><b>病人性别:</b></td>
	            <td align="left" class="l-table-edit-td" width="20%">
	            	<input name="patient_sex" type="text" id="patient_sex" ltype="text" validate="{maxlength:100}" />
	            </td> -->
	           <td align="right" class="l-table-edit-td"  style="padding-left:20px;">病人性别:</td>
	            ...
	            <td align="left" class="l-table-edit-td" width="20%">
	            	<input name="patient_age" type="text" id="patient_age" ltype="text" validate="{maxlength:100}" />
	            </td>
			
			   <td align="right" class="l-table-edit-td" width="10%"><b>医嘱医生:</b></td>
	            <td align="left" class="l-table-edit-td" width="20%">
	            	<input name="physician" type="text" id="physician" ltype="text" validate="{maxlength:100}" />
	            </td>
			</tr>
			...
			<tr>
			  <td align="right" class="l-table-edit-td" width="10%"><b>执行科室:</b></td>
	            <td align="left" class="l-table-edit-td" width="20%">
	            	<input name="execution_dept" type="text" id="execution_dept" ltype="text" validate="{maxlength:100}" />
	            </td>
	            
	             <td align="right" class="l-table-edit-td" width="10%"><b>医嘱类别:</b></td>
	            <td align="left" class="l-table-edit-td" width="20%">
	            	<input name="advice_class" type="text" id="advice_class" ltype="text" validate="{maxlength:100}" />
	            </td>
			</tr>
    	</table>
    </div>
