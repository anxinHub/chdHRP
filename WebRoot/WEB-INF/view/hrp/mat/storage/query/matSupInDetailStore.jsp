...
//     	    			{display: '供应商编码', name: 'sup_code', align: 'left', minWidth: '120' },
//     	    			{display: '供应商名称', name: 'sup_name', align: 'left', minWidth: '150'}, 
//     	    			{display: '仓库名称', name: 'store_name', align: 'left', minWidth: '130'},
...
//     					align:'left',
//     					minWidth:'100', render:function(rowddata,rowindex,value){
//         					return formatNumber(value,2,1);
//         				}
//     				});
...
// 		}); 
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			columns: [
				...
				{display: '会计科目', name: 'subj_name', align: 'left', Width: '120' },
				{display:'金  额', id:'', name:'money', align:'right', Width:'80',type:'float',
   					render: function (rowdata, rowindex, value) {
						return formatNumber(value == null ? 0 : value, 2, 1);
					},formatter:'###,##0.00'
			...
			dataAction: 'server',dataType: 'server',usePager:false,url:'queryMatSupInDetailStore.do',
    ...
    function lodopPrint(){
    	var head="<table class='head' width='100%'><tr><td>单位：${sessionScope.hos_name}</td></tr>";
 		...
 		grid.options.lodop.title="供应商入库单明细汇总表";
    }
	...
	function print(){
    	...
    	var heads={
        		...
        		"rows": [
    	          {"cell":0,"value":"统计年月："},
    	          {"cell":1,"value":""+$("#begin_confirm_date").val()+"至" +$("#end_confirm_date").val() },
    	          {"cell":3,"value":"仓库："},
...
//     	          {"cell":7,"value":""+liger.get("set_code").getText()==''?'空':liger.get("set_code").getText().split(" ")[1]+""}
		...
		var foots = {
			rows: [
				...
				{"cell":2,"value":"验收:"},
				{"cell":0,"br":"true"},
				{"cell":0,"value":'记账:',"br":"true"},
				{"cell":2,"value":'采购部门负责人:'}
				
			]
		}; 
    	var printPara={
          		title: "供应商入库单明细汇总表",//标题
          		columns: JSON.stringify(grid.getPrintColumns()),//表头
          		class_name: "com.chd.hrp.mat.service.storage.query.MatSupInDetailStoreService",
       			method_name: "queryMatSupInDetailStorePrint",
       			bean_name: "matSupInDetailStoreService",
	...
	/* 	var dates = getCurrentDate();
    	...
    	//alert(colspan_num);
   		...
   		ajaxJsonObjectByUrl("queryMatStorageQueryMatInSupCount.do?isCheck=false", selPara, function (responseData) {
...
/* 		autocomplete("#store_code", "../../queryMatStoreByRead.do?isCheck=false", "id", "text", true, true);
		autocomplete("#mat_type_code", "../../queryMatTypeDict.do?isCheck=false", "id", "text", true, true,'',false,'',220); */
