...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatAffiOutCertDetail.do',
	...
	function print(){
    	...
    	var printPara={
          		...
          		class_name: "com.chd.hrp.mat.service.affi.query.MatAffiStockSearchService",
       			method_name: "queryMatAffiOutCertDetailPrint",
   	...
   	/* 	var printPara={
   		...
   		ajaxJsonObjectByUrl("queryMatAffiOutCertDetail.do?isCheck=false", selPara, function (responseData) {
