...
<script type="text/javascript">
					...
					.ligerGrid(
							{
								...
								dataType : 'server',
								usePager : true,
								url : 'queryMatStorageQueryMatOutDeptNew.do',
								width : '100%',
								height : '100%',
								rownumbers : true,
	...
	function print() {
		...
		var printPara = {
			...
			method_name : "queryMatStorageQueryOutDetailPrintNew",
	...
	function loadDict() {
		...
		autocompleteAsyncMulti("#bus_type_code",
				"../../queryMatBusType.do?isCheck=false", "id", "text", true,
				true, {
					codes : '3, 21, 9,11,13,23,49,50,15'
				}, true, false, 247);
