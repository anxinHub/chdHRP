...
<script type="text/javascript">
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			columns: [{ 
		 			display: '财务类别编码', name: 'fim_type_code', align: 'left'
		 		}, { 
		 			display: '财务类别名称', name: 'fim_type_name', align: 'left'
		 		},{ 
		 			display: '医疗', name: 'one_kind', align: 'right' ,
		 			render : function(rowdata, rowindex, value) {
						return formatNumber(value ==null ? 0 : value, '${p04005 }', 1);
					}
		 		}, { 
		 			display: '管理', name: 'two_kind', align: 'right' ,
		 			render : function(rowdata, rowindex, value) {
						return formatNumber(value ==null ? 0 : value, '${p04005 }', 1);
					} 
		 		},  { 
		 			display: '制剂', name: 'three_kind', align: 'right' ,
		 			render : function(rowdata, rowindex, value) {
						return formatNumber(value ==null ? 0 : value, '${p04005 }', 1);
					} 
		 		}, { 
			...
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatDeptOutReport.do',
  ...
  //键盘事件
	...
	function print(){
    	...
    	var heads={
        		...
        		"rows": [
    	          {"cell":0,"value":"单位："},
    	          {"cell":1,"value":"${sessionScope.hos_name}"},
    	          {"cell":0,"value":"统计年月：","br":"true","hr":"true"},
    	          {"cell":1,"value":""+$("#begin_confirm_date").val()+"至"+$("#end_confirm_date").val()},
    	          {"cell":4,"value":"仓库：","align":"right"},
    	          {"cell":5,"value":storeName}
        	]};
    	//表尾 
		...
		var foots = {
			rows: [
				...
				{"cell":3,"value":"负责人:"} ,
				{"cell":4,"value":""} ,
				{"cell":4,"value":"制表日期:","br":"true","align":"right"} ,
				{"cell":5,"value":formDate} ,
    	...
    	var printPara={
          		...
          		class_name: "com.chd.hrp.mat.service.storage.query.MatDeptOutReportService",
       			method_name: "queryMatDeptOutReportPrint",
