...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMatInvRelaFiles.do?isCheck=false",    
		...
		function loadHead() {
				...
				columns: [ 
				{ display: 'HRP材料编码', name: 'inv_code', align: 'left',editor:{type:'text'}},
				{ display: 'HRP材料名称', name: 'inv_name', align: 'left',editor:{type:'text'}},
				{ display: '省平台材料编码', name: 'goodsid', align: 'left',editor:{type:'text'}},
				{ display: '省平台材料名称', name: 'goodsname', align: 'left',editor:{type:'text'}},
		...
		ajaxJsonObjectByUrl("addMatInvRelaFiles.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
