...
/* 		grid.options.parms.push({name : 'mat_type_id',value : liger.get("mat_type_code").getValue().split(",")[0]}); 
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
			columns: [],
			dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatPurCollectMain.do',
    ...
    function f_setColumns(){
    	...
    	if(show_store){
	    	columns = [
				...
				{display: '交易编码', name: 'bid_code', align: 'left', minWidth: '100'},
				...
				{display: '单价', name: 'price', align: 'right', minWidth: '70',formatter:"###,##0.00",
					...
					return formatNumber(rowdata.price, '${p04005 }', 1);
					}
				},  
    ...
    function lodopPrint(){
    	var head="<table class='head' width='100%'><tr><td>单位：${sessionScope.hos_name}</td></tr>";
 		...
 		grid.options.lodop.title="材料采购汇总查询";
    }
...
//		autocomplete("#store_code", "../queryMatStoreByRead.do?isCheck=false", "id", "text", true, true);
	...
	function print(){
    	...
    	var heads={
        		...
        		"rows": [
    	          {"cell":0,"value":"统计年月："},
    	          {"cell":1,"value":""+$("#begin_in_date").val()+"至"+$("#end_in_date").val()},
    	          {"cell":3,"value":"仓库："},
    	...
    	var printPara={
          		...
          		class_name: "com.chd.hrp.mat.service.matpur.MatPurCollectService",
       			method_name: "queryMatPurCollectPrint",
