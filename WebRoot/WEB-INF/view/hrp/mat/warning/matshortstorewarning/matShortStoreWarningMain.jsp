...
<script type="text/javascript">
    ...
    function  query(){
    	...
    	grid.options.parms.push({name:'type_id',value:liger.get("type_id").getValue().split(",")[2]}); 
    	...
    	grid.options.parms.push({
			name : 'is_zero',//
			value : liger.get("is_zero").getValue()
		});
    	//加载查询条件
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					 { display: '仓库名称', name: 'store_name', align: 'left',width:130},
                     ...
                     { display: '单  价', name: 'plan_price', align: 'left',width:110},
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatShortStoreWarning.do?isCheck=false',
...
/* 		autocomplete("#type_id", "../../queryMatType.do?isCheck=false", "id", "text", true, true,'',false,false,200); */
		...
		autocomplete("#is_zero", "../../queryMatYearOrNo.do?isCheck=false", "id", "text", true, true,'',true,false,200);
	...
	//打印
		function print(){
	    	...
	    	var colspan_num = grid.getColumns(1).length-1;
	   		...
	   		ajaxJsonObjectByUrl("queryMatShortStoreWarning.do?isCheck=false", selPara, function (responseData) {
...
<body style="padding: 0px; overflow: hidden;">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        ...
        <tr>
         <td align="right" class="l-table-edit-td"  style="padding-left:20px;">是否零库存：</td>
            <td align="left" class="l-table-edit-td">
            	<input name="is_zero" type="text" id="is_zero" ltype="text" type="text" />
            </td>
        </tr>
    </table>
	<div id="maingrid"></div>
