    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '规格型号', name: 'inv_model', align: 'left',width:280},
					 { display: '计量单位', name: 'unit_name', align: 'left',width:105},
                     { display: '结存数量', name: 'cur_amount', align: 'left',width:105},
                     { display: '高限库存量', name: 'high_limit', align: 'left',width:100},
                     { display: '超储量', name: 'diff', align: 'left',width:100}
                     ],
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatHighStoreWarning.do?isCheck=false',
	...
	//打印
		function print(){
	    	...
	    	var colspan_num = grid.getColumns(1).length-1;
	   		...
	   		ajaxJsonObjectByUrl("queryMatHighStoreWarning.do?isCheck=false", selPara, function (responseData) {
