    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
					...
					/*  { display: '状态1', name: 'state_name', align: 'center',width:60,hide:true
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatBatchWarning.do?isCheck=false',
...
/* 		autocomplete("#store_id", "../../queryMatStore.do?isCheck=false", "id", "text", true, true); */
    	...
    	//物资类别下拉框
	/* 	autocomplete("#type_id", "../../queryMatType.do?isCheck=false", "id", "text", true, true); */
		autocomplete("#type_id", "../../queryMatTypeDictDate.do?isCheck=false", "id", "text", true, true,{read_or_write:1});
	...
	//打印
		function print(){
	    	...
	    	var colspan_num = grid.getColumns(1).length-1;
	   		...
	   		ajaxJsonObjectByUrl("queryMatBatchWarning.do?isCheck=false", selPara, function (responseData) {
