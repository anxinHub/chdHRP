...
<script type="text/javascript">
    ...
    function  query(){
        ...
        //货位
        grid.options.parms.push({name:'location_id',value:liger.get("location_id").getValue().split(",")[0]});
    	...
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     { display: '包装规格', name: 'inv_structure', align: 'left'},
				 	 { display: '转换量', name: 'num_exchange', align: 'left',width:100},
				 	 { display: '预警周期', name: 'period_num', align: 'left',width:100},
				 	 { display: '货位', name: 'location_name', align: 'left',width:100},
                     { display: '结存数量', name: 'cur_amount', align: 'left',width:60},
                     { display: '安全库存量', name: 'secu_limit', align: 'left',width:80},
                     { display: '差量', name: 'diff', align: 'left',width:80},
					 { display: '包装差量', name: '', align: 'center',width:80,
	                    	 render:function(rowdata,rowindex,value){
	                    		 if(rowdata.package_code != null || rowdata.package_code != '' || rowdata.package_code != 'undifined'){
	                    			 return Math.abs(rowdata.diff)/rowdata.num_exchange;
	                    		 }else{
	                    			 return "";
	                    		 }
	                    	 }
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatSafeStoreWarning.do?isCheck=false',
    ...
    function loadDict(){
       //字典下拉框
    	 ...
    	 //仓库下拉框
/* 		autocomplete("#store_id", "../../queryMatStore.do?isCheck=false", "id", "text", true, true,'',false,false,200); */
		autocomplete("#store_id", "../../queryMatStoreDictDate.do?isCheck=false", "id", "text", true, true,{read_or_write:1},false,false,200);
    	//货位
    	autocomplete("#location_id","../../queryMatLocationDict.do?isCheck=false","id","text",true,true,'',false,false,200);
    	//物资类别下拉框
/* 		autocomplete("#type_id", "../../queryMatType.do?isCheck=false", "id", "text", true, true,'',false,false,200); */
		autocomplete("#type_id", "../../queryMatTypeDictDate.do?isCheck=false", "id", "text", true, true,{read_or_write:1},false,false,200);
    	
		//物资类别下拉框
	/* 	autocomplete("#inv_id", "../../queryMatInv.do?isCheck=false", "id", "text", true, true,'',false,false,240); */
	...
	//打印
		function print(){
	    	...
	    	var colspan_num = grid.getColumns(1).length-1;
	   		...
	   		ajaxJsonObjectByUrl("queryMatSafeStoreWarning.do?isCheck=false", selPara, function (responseData) {
...
<body style="padding: 0px; overflow: hidden;">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        ...
        <tr>
        	<td align="right" class="l-table-edit-td"  style="padding-left:20px;">货&nbsp;&nbsp;位：</td>
            <td align="left" class="l-table-edit-td">
            	<input name="location_id" type="text" id="location_id" ltype="text" /></td>
            <td align="left"></td>
	...
	<div id="resultPrint" style="display:none">
	   	<table width="100%">
			...
			<tr>
                ...
                <th width="200">包装规格</th>
                <th width="200">转换量</th>
                <th width="200">预警周期</th>
                <th width="200">结存数量</th>	
                <th width="200">安全库存量</th>	
                <th width="200">差量</th>		
                <th width="200">包装差量</th>	
			</tr>
			   	</thead>
			   	<tbody></tbody>
	   	</table>
