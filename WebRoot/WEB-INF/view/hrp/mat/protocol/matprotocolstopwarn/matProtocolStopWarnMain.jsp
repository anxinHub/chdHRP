    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatProtocolStopWarn.do?isCheck=true',
...
// 								{ line:true },
    ...
    function openUpdate(obj){
		...
		var parm = 
			...
			"copy_code="+vo[2]   +"&"+ 
			"protocol_id="+vo[3] 
		$.ligerDialog.open({ url : 'matProtocolStopWarnUpdatePage.do?isCheck=false&'+parm,data:{}, 
    ...
    function loadDict(){
       //字典下拉框
		...
		//甲方负责人（职工下拉框）
		autocomplete("#first_man", "../../queryMatEmpDict.do?isCheck=false", "id", "text", true, true,'',false,'',160);
	  ...
	  function loadHotkeys() {
		...
		function print(){
	    	...
	    	var colspan_num = grid.getColumns(1).length-1;
	   		...
	   		ajaxJsonObjectByUrl("queryMatProtocolStopWarn.do?isCheck=false", selPara, function (responseData) {
...
/*   //打印数据
	 function printDate(){
		...
		ajaxJsonObjectByUrl("queryMatProtocolStopWarn.do",printPara,function (responseData){
			 var trHtml='';
	 ...
	 function exportExcel(){
		...
		ajaxJsonObjectByUrl("queryMatProtocolStopWarn.do",exportPara,function (responseData){
			 var trHtml='';
			$.each(responseData.Rows,function(idx,item){ 
				trHtml+="<tr>";
				 trHtml+="<td>"+item.protocol_code+"</td>"; 
