    		 ...
    		 if(!flag){
                 ...
                 if (data.length == 0){
                     ...
                     $(data).each(function (){					
                       	...
                       	ajaxJsonObjectByUrl("../matprotocolmain/addMatProtocolDetail.do",{ParamVo : ParamVo.toString()},function (responseData){
   			 ...
   			 $.ligerDialog.error('请先添加采购协议，再点击');
	             ...
	             if (data.length == 0){
	                 ...
	                 $(data).each(function (){					
	                   	...
	                   	ajaxJsonObjectByUrl("../matprotocolmain/addMatProtocolFile.do",{ParamVo : ParamVo.toString()},function (responseData){
	                   		if(responseData.state=="true"){
   ...
   <body>
   		<div class="l-layout" id="layout1" style="height: 100%;" ligeruiid="layout1">
	        ...
	        <div title="" class="l-layout-content" style="" position="centerbottom">
	        	...
	        	<input class="liger-button" name="inv"  id="inv"  type="button" width="200" value="选择材料" />
