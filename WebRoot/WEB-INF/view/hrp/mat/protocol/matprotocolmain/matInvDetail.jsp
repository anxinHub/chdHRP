...
<script type="text/javascript">
    ...
    function  query(){
        ...
        //根据表字段进行添加查询条件
    	  invGrid.options.parms.push({name:'mat_type_id',value:liger.get("mat_type_id").getValue().split(",")[0]}); 
    ...
    function loadHead(){
    	invGrid = $("#maingrid").ligerGrid({
              ...
              dataAction: 'server',dataType: 'server',usePager:true,url:'../matprotocolmain/queryMatInvDetail.do?isCheck=false',
