    ...
    <script type="text/javascript">
	 ...
	 function addInv(){
		 if(!$("#detailgrid").is(":hidden")){
			 $.ligerDialog.open({url: 'matInvDetailPage.do?isCheck=false',height: 530,width: 900, top:0,
     ...
     function  save(){
        ...
        ajaxJsonObjectByUrl("addMatProtocolMain.do",formPara,function(responseData){
