...
//	     })
    ...
    function loadHead(){
    	grid = $("#maingrid").ligerGrid({
           columns: [ 
                     ...
                     dataAction: 'server',dataType: 'server',usePager:true,url:'queryMatProtocolMain.do?isCheck=false',
    ...
    function add_open(){
    	$.ligerDialog.open({ url : 'matProtocolMainAddPage.do?isCheck=false',data:{}, 
    	...
    	var data = gridManager.getCheckedRows();
                    if (data.length == 0){
                        ...
                        $.ligerDialog.confirm('确定删除?', function (yes){
                        	if(yes){
                            	ajaxJsonObjectByUrl("deleteMatProtocolMain.do?isCheck=true",{ParamVo : ParamVo.toString()},function (responseData){
    ...
    function openUpdate(obj){
		...
		var parm = 
			...
			"protocol_id="+vo[3] +"&"+ 
			"state="+vo[4]
		$.ligerDialog.open({ url : 'matProtocolMainUpdatePage.do?isCheck=false&'+parm,data:{}, 
    ...
    function loadDict(){
		...
		//甲方负责人（职工下拉框）
		autocomplete("#first_man", "../../queryMatEmpDict.do?isCheck=false", "id", "text", true, true,'',false,false,160);
  ...
  //打印数据
	 function printDate(){
		...
		ajaxJsonObjectByUrl("queryMatProtocolMain.do",printPara,function (responseData){
			 var trHtml='';
	 ...
	 function exportExcel(){
		...
		ajaxJsonObjectByUrl("queryMatProtocolMain.do",exportPara,function (responseData){
			 var trHtml='';
			$.each(responseData.Rows,function(idx,item){ 
				 	 trHtml+="<tr>";
				 	trHtml+="<td>"+item.protocol_code+"</td>"; 
...
<body style="padding: 0px; overflow: hidden;">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        <tr>
            ...
            <td align="right" class="l-table-edit-td"  style="padding-left:20px;"  >协议类别：</td> 
