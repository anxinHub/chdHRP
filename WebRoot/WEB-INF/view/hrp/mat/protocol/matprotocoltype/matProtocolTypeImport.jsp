...
<script type="text/javascript">
		...
		function plupload(){  
			...
			$("#uploader").pluploadQueue({    
					...
					url : "readMatProtocolTypeFiles.do?isCheck=false",    
		...
		ajaxJsonObjectByUrl("addBatchMatProtocolType.do?isCheck=false",{ParamVo : JSON.stringify(data)},function (responseData){
