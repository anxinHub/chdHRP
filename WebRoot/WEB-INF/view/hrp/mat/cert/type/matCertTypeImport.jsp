...
var columns = "";
    ...
    function initSpreadData(){
    	...
    	sheet.suspendPaint();
    	//设置列
    	sheet.setColumnCount(7);  //默认最大20列如超过20列则需设置具体的最大列数
    	sheet.setColumnWidth(0, "100"); sheet.setText(0, 0, "证件类型编码");
    	sheet.setColumnWidth(1, "140"); sheet.setText(0, 1, "证件类型名称");
    	sheet.setColumnWidth(2, "140"); sheet.setText(0, 2, "证件类别");
    	sheet.setColumnWidth(3, "140"); sheet.setText(0, 3, "是否需经营范围");
    	sheet.setColumnWidth(4, "140"); sheet.setText(0, 4, "是否需证件名称");
    	sheet.setColumnWidth(5, "90"); sheet.setText(0, 5, "是否停用");
    	sheet.setColumnWidth(6, "90"); sheet.setText(0, 6, "排序号");
    	sheet.setColumnWidth(7, "180"); sheet.setText(0, 7, "备注");
    ...
    function mySave(){
    	...
    	ajaxJsonObjectBylayer("addMatCertTypeByImp.do?isCheck=false", para, function(responseData){	
