...
var columns = "";
    ...
    function initSpreadData(){
    	...
    	sheet.setColumnWidth(2, "140"); sheet.setText(0, 2, "是否需经营范围");
    	sheet.setColumnWidth(3, "140"); sheet.setText(0, 3, "是否需证件名称");
    	sheet.setColumnWidth(4, "90"); sheet.setText(0, 4, "是否停用");
    	sheet.setColumnWidth(5, "90"); sheet.setText(0, 5, "排序号");
    	sheet.setColumnWidth(6, "180"); sheet.setText(0, 6, "备注");
