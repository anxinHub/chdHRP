...
<script type="text/javascript">
	...
	function save(){
		...
		ajaxLigerPostFormData({
			url: "saveMatSupCert.do?isCheck=false", 
			para: formData, 
	...
	<form name="form" method="post" id="form" >
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%" style="margin-top: 5px;">
	        ...
	        <tr>
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="cert_code" type="text" id="cert_code" type="text" validate="{required:true,maxlength:50}" />
	            </td>
	            <td align="left"></td>
	        </tr> 
	        <tr id="nameTr">
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="cert_name" type="text" id="cert_name" type="text" validate="{required:true,maxlength:200}" />
	            </td>
	            <td align="left"></td>
	        </tr> 
	        <tr>
	        ...
	        <tr id="busiTr">
	            ...
	            <td align="left" class="l-table-edit-td">
	            	<input name="cert_busi" type="text" id="cert_busi" type="text"  validate="{required:true,maxlength:500}" />
	            </td>
	            <td align="left"></td>
	        </tr>
	      	<tr>
