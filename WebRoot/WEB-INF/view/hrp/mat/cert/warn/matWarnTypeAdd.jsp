	...
	<table class="table-layout" style="margin-top:10px;" width="100%">
		<tr>
			...
			<td align="left" class="l-table-edit-td">
				<input type="text" id="warn_type_code" validate="{required:true}" />
			</td>
			...
			<td align="left" class="l-table-edit-td">
				<input type="text" id="warn_type_name" validate="{required:true}" />
			</td>
		</tr>
		<tr>
			<td align="right" class="l-table-edit-td">
			...
			<td align="left" class="l-table-edit-td">
				<input type="text" id="days" validate="{required:true}" />
			</td>
		</tr>
		<tr>
			<td align="right" class="l-table-edit-td">
		...
		<tr>
			...
			<td align="left" class="l-table-edit-td">
				...
				<i style="display:inline-block"><img id="showImg" /></i>
			</td>
		</tr>
	</table>
