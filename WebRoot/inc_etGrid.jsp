...
<script src="<%=path%>/lib/My97DatePicker/WdatePicker.js"
	type="text/javascript"></script>
<script src="<%=path%>/lib/layer-v2.3/layer/layer.js"
	type="text/javascript"></script>
<script src="<%=path%>/lib/hotkeys/jquery.hotkeys.js"
	type="text/javascript"></script>
...
<link rel="stylesheet" type="text/css"
	href="<%=path%>/lib/plupload-2.1.3/js/jquery.plupload.queue/css/jquery.plupload.queue.css">
<script type="text/javascript"
	src="<%=path%>/lib/plupload-2.1.3/js/plupload.full.min.js"></script>
<script type="text/javascript"
	src="<%=path%>/lib/plupload-2.1.3/js/jquery.plupload.queue/jquery.plupload.queue.js"></script>
...
<link rel="stylesheet" href="<%=path%>/lib/et_components/etGrid/css/pqgrid.min.css" />
