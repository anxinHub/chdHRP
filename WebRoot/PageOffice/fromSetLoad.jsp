...
<html>
  ...
  <script type="text/javascript">
  	...
  	function init(){
		...
		window.location.href = "printFormSet.do?isCheck=false"+paraStr;
		/* $.ajax({
			type: "post",
			url: "printFormSetData.do?isCheck=false",
			...
			success: function (responseData) {
				...
				if(!responseData.docPath){
					alert("数据处理异常！");
					return;
				}
				
				var resPara="&group_id="+responseData.group_id+"&hos_id="+responseData.hos_id+"&hos_copy="+responseData.copy_code;
				resPara=resPara+"&mod_code="+responseData.mod_code+"&template_code="+responseData.template_code;
				resPara=resPara+"&use_id="+responseData.use_id+"&docPath="+responseData.docPath;
				
				window.location.href = "printFormSet.do?isCheck=false&"+resPara;
			},
